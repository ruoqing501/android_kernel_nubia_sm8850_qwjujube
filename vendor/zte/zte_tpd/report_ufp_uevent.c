...
void report_ufp_uevent(unsigned int val)
{
    ...
    if (val != 0 && !(field_a1 & 1)) {
        ...
        if (current_lcd_state != 0) {
            ...
            char *envp[3] = { "aod_areameet_down=true", (char *)lcd_state_strings[current_lcd_state], NULL };
            ...
            char *envp[3] = { "areameet_down=true", (char *)lcd_state_strings[current_lcd_state], NULL };
            kobject_uevent_env(&ufp_tp_ops.pdev->dev.kobj, KOBJ_CHANGE, envp);
        }
        ufp_tp_ops.field_a1 = 1;
    }
        ...
        if (ufp_tp_ops.pdev == NULL) {
            ...
            char *envp[3] = { "areameet_up=true", (char *)lcd_state_strings[current_lcd_state], NULL };
            kobject_uevent_env(&ufp_tp_ops.pdev->dev.kobj, KOBJ_CHANGE, envp);
        }
