__int64 __fastcall cnss_get_audio_shared_iommu_group_cap(__int64 a1, __int64 a2)
{
  __int64 v3; // x0
  __int64 v4; // x6
  __int64 v5; // x7
  ...
  if ( !v3 )
  {
    ...
    v20 = "plat priv is not available";
    goto LABEL_34;
  }
  v6 = v3;
  ...
  if ( !compatible_node )
  {
    ...
    v20 = "Unable to get direct link node";
    goto LABEL_34;
  }
  v45 = 0;
  v46 = 0;
  ...
  if ( (unsigned int)_of_parse_phandle_with_args(compatible_node, "qcom,iommu-group", 0, 0, 0, &v37) || (v8 = v37) == 0 )
  {
    ...
    v20 = "Unable to get direct link iommu group phandle";
    goto LABEL_34;
  }
  v9 = *(_QWORD *)(a1 + 744);
  v45 = 0;
...
LABEL_34:
    cnss_debug_ipc_log_print(v14, v15, "cnss_get_audio_shared_iommu_group_cap", 3u, 3u, v20, v4, v5, v36);
    v28 = 0;
    goto LABEL_35;
  }
  if ( v37 == v8 )
  {
    *(_BYTE *)(v6 + 7552) = 1;
    ...
    v33 = "CNSS and direct link share IOMMU group";
  }
  else
  {
    ...
    v33 = "CNSS and direct link do not share IOMMU group";
  }
  cnss_debug_ipc_log_print(v11, v12, "cnss_get_audio_shared_iommu_group_cap", 6u, 6u, v33, v4, v5, v36);
  v28 = *(_BYTE *)(v6 + 7552);
LABEL_35:
