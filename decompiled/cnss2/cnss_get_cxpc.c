__int64 __fastcall cnss_get_cxpc(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        __int64 a8)
{
  ...
  cnss_debug_ipc_log_print(cnss_ipc_log_context, v11, "cnss_get_cxpc", 6u, 6u, "Entering cnss_get_cxpc\n", a7, a8, v19);
  if ( a1 )
  {
  ...
  else
  {
    ...
    cnss_debug_ipc_log_print(cnss_ipc_log_context, v17, "cnss_get_cxpc", 3u, 3u, "plat priv is null\n", v12, v13, v20);
    result = 4294967277LL;
  }
