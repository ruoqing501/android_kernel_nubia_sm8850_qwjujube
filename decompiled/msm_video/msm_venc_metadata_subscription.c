__int64 __fastcall msm_venc_metadata_subscription(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v5; // x4
  _BYTE *v6; // x12
  __int64 v7; // x8
  ...
  {
    v12 = a1;
    printk(&unk_9602D, "high", a1 + 340, "msm_venc_metadata_subscription", a5);
    a1 = v12;
  }
  v5 = 0;
  v6 = (_BYTE *)(a1 + 4536);
  ...
  while ( 1 )
  {
    v9 = *v8;
    v8 += 168;
    if ( (v9 & 0x80) == 0 || (~*((_DWORD *)v6 - 4) & 0x11LL) != 0 )
      goto LABEL_5;
    v10 = v5 + 1;
...
LABEL_5:
    ...
    if ( !v7 )
    {
      result = msm_vidc_session_command(
                 ...
                 &v13,
                 (unsigned int)(4 * v5 + 4),
                 "msm_venc_metadata_subscription");
      goto LABEL_11;
    }
  }
  if ( a1 && (msm_vidc_debug & 1) != 0 )
  {
    printk(&unk_92230, "err ", a1 + 340, "msm_venc_metadata_subscription", v5);
    result = 4294967274LL;
  }
  else
  {
