__int64 __fastcall msm_vidc_init_platform_alor(__int64 a1)
{
  ...
  if ( (msm_vidc_debug & 2) != 0 )
    printk(&unk_8280D, "high", 0xFFFFFFFFLL, "codec", "msm_vidc_init_platform_alor");
  ...
  *(_QWORD *)(a1 + 6568) = mem_ops_ext;
  if ( !mem_ops_ext )
  {
    if ( (msm_vidc_debug & 1) != 0 )
    {
      v7 = &unk_848DD;
LABEL_17:
      printk(v7, "err ", 0xFFFFFFFFLL, "codec", "msm_vidc_init_platform_alor");
    }
LABEL_20:
    result = 4294967274LL;
    goto LABEL_21;
  ...
  *(_QWORD *)(a1 + 6552) = res_ops_ext;
  ...
  {
    if ( (msm_vidc_debug & 1) != 0 )
      printk(&unk_87C3D, "err ", 0xFFFFFFFFLL, "codec", "msm_vidc_alor_check_ddr_type");
    goto LABEL_20;
  }
  if ( (msm_vidc_debug & 2) != 0 )
    printk(&unk_7F411, "high", 0xFFFFFFFFLL, "codec", "msm_vidc_alor_check_ddr_type");
  result = 0;
LABEL_21:
