size_t __fastcall inline_copy_from_user(__int64 a1, unsigned __int64 a2)
{
  ...
  if ( v4 > 0x7FFFFFFFF0LL )
  {
    v12 = 16;
LABEL_8:
    memset((void *)(a1 - v12 + 16), 0, v12);
    return v12;
  }
  ...
  v12 = _arch_copy_from_user(a1, a2 & 0xFF7FFFFFFFFFFFFFLL, 16);
