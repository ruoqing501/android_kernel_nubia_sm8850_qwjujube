__int64 __fastcall lpass_cdc_tx_macro_dec_mode_put(__int64 a1, __int64 a2)
{
  __int64 v5; // x0
  int v6; // w20
  __int64 result; // x0
  ...
  v15[0] = 0;
  v13 = 0;
  if ( (lpass_cdc_tx_macro_get_data(v5, &v14, v15, (__int64)"lpass_cdc_tx_macro_dec_mode_put") & 1) == 0 )
  {
    result = 4294967274LL;
    goto LABEL_6;
  }
...
LABEL_6:
  ...
  {
    result = 0;
    *(_DWORD *)(v15[0] + 4LL * v13 + 2648) = v6;
    goto LABEL_6;
  }
  __break(0x5512u);
  __asm { SM3TT2A         V13.4S, V13.4S, V11.S[1] }
  return lpass_cdc_tx_macro_get_bcs();
}
