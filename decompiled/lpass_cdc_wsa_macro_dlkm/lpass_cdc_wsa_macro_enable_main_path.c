__int64 __fastcall lpass_cdc_wsa_macro_enable_main_path(__int64 a1, __int64 a2, int a3)
{
  __int64 v3; // x20
  ...
  v8 = v3 - 208;
  v9 = device_ptr;
  v10 = (*(unsigned __int8 *)(a1 + 76) << 7) + 9216;
  ...
  v12 = snd_soc_component_read(v8, (unsigned int)(v11 + 8448));
  v13 = snd_soc_component_read(v8, (unsigned int)(v11 + 8452));
