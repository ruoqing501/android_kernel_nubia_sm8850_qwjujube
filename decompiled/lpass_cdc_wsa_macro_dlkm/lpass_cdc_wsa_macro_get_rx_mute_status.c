__int64 __fastcall lpass_cdc_wsa_macro_get_rx_mute_status(__int64 a1, __int64 a2)
{
  __int64 v4; // x20
  __int64 v6; // x21
  ...
  if ( (unsigned int)v6 >= 9 )
  {
    ...
    return lpass_cdc_wsa_macro_set_rx_mute_status();
  }
  else
  {
    *(_QWORD *)(a2 + 72) = *(int *)(v8 + 4 * v6 + 640);
    return 0;
  }
}
