__int64 __fastcall lpass_cdc_wsa_macro_cps_feed_mixer_get(__int64 a1, __int64 a2)
{
  __int64 v6; // x0
  __int64 v7; // x8
  __int64 v8; // x20
  ...
  device_ptr = lpass_cdc_get_device_ptr(*(_QWORD *)(v8 - 184), 2);
  if ( !device_ptr )
  {
  ...
  if ( (unsigned int)v9 > 8 )
  {
    ...
    return lpass_cdc_wsa_macro_cps_feed_mixer_put();
  }
  else
  {
    result = 0;
    *(_QWORD *)(a2 + 72) = ((*(_QWORD *)(v12 + 8 * v9 + ((v10 >> 3) & 0x1FFFFFF8) + 376) >> v10) & 1) != 0;
  }
  return result;
}
