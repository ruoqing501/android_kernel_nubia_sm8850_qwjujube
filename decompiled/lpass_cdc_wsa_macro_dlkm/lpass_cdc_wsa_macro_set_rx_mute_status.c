__int64 __fastcall lpass_cdc_wsa_macro_set_rx_mute_status(__int64 a1, __int64 a2)
{
  __int64 v4; // x20
  int v5; // w21
  __int64 v6; // x19
...
LABEL_15:
    updated = __ratelimit(&lpass_cdc_wsa_macro_set_rx_mute_status__rs, "lpass_cdc_wsa_macro_set_rx_mute_status");
    if ( (_DWORD)updated )
      updated = printk(&unk_F5C4, "lpass_cdc_wsa_macro_set_rx_mute_status");
    v14 = -22;
    goto LABEL_21;
  }
  if ( !(_DWORD)v6 )
...
LABEL_21:
  ...
  *(_QWORD *)(v15 + 520) = ktime_get_mono_fast_ns(updated);
  ...
  if ( (unsigned int)v6 > 8 )
  {
    ...
    return lpass_cdc_wsa_macro_get_compander(v16);
  }
  else
  {
    *((_DWORD *)v8 + v6 + 160) = v5;
