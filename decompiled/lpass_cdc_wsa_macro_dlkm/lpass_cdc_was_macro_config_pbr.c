  ...
  if ( result )
  {
    ...
    if ( v10 && *(_QWORD *)(v10 + 360) )
    {
      ...
      if ( *(_BYTE *)(v10 + 728) == 1 )
      {
        ...
        {
          __break(0x5512u);
          return lpass_cdc_wsa_macro_enable_softclip_clk(result, v7, v8, v9);
        }
        else if ( *(_DWORD *)(v10 + 4LL * a2 + 748) <= 3u && *(_DWORD *)(v10 + 8LL * a2 + 732) <= 6u )
        {
          v16 = v11 ^ 1;
          if ( *(_DWORD *)(v10 + 596) )
            v16 = 1;
          if ( (v16 & 1) == 0 )
          {
            if ( (a3 & 3) != 0 )
            {
              ...
              result = lpass_cdc_wsa_macro_enable_softclip_clk(a1, v10, v15, 1);
              v17 = *(_DWORD *)(v10 + 780);
              if ( !v17 )
              {
                result = snd_soc_component_update_bits(a1, 11008, 1, 1);
                v17 = *(_DWORD *)(v10 + 780);
              }
              *(_DWORD *)(v10 + 780) = v17 + 1;
            }
            if ( (a3 & 0xC) != 0 )
            {
              if ( *(_DWORD *)(v10 + 780) == 1 )
                snd_soc_component_update_bits(a1, 11008, 1, 0);
              lpass_cdc_wsa_macro_enable_softclip_clk(a1, v10, v15, 0);
              ...
              *(_DWORD *)(v10 + 780) = (*(_DWORD *)(v10 + 780) - 1) & ~((*(_DWORD *)(v10 + 780) - 1) >> 31);
            }
          }
        }
      }
