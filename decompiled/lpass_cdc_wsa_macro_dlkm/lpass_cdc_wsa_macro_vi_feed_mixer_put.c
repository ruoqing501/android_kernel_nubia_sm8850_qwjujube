__int64 __fastcall lpass_cdc_wsa_macro_vi_feed_mixer_put(__int64 a1, __int64 a2)
{
  __int64 v4; // x0
  __int64 v5; // x23
  __int64 v6; // x20
  ...
  *(_DWORD *)(v10 + 156) = *(_QWORD *)(a2 + 72);
  if ( !v7 )
  {
    if ( v8 == 1 )
    {
      if ( (*(_QWORD *)(v10 + 400) & 2) == 0 )
        goto LABEL_23;
      _X9 = (unsigned __int64 *)(v10 + 400);
      __asm { PRFM            #0x11, [X9] }
      do
        v28 = __ldxr(_X9);
