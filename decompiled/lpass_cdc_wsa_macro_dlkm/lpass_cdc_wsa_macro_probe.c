__int64 __fastcall lpass_cdc_wsa_macro_probe(__int64 a1)
{
  __int64 v1; // x19
  __int64 v3; // x0
  __int64 v4; // x21
  ...
  {
    dev_err(v1, "%s: va-macro not registered yet, defer\n", "lpass_cdc_wsa_macro_probe");
LABEL_43:
    result = 4294966779LL;
    goto LABEL_57;
  }
  v3 = devm_kmalloc(v1, 792, 3520);
  if ( !v3 )
  {
    result = 4294967284LL;
    goto LABEL_57;
  ...
  *(_QWORD *)v4 = v1;
  ...
  if ( (variable_u32_array & 0x80000000) != 0 )
  {
    ...
    dev_err(v1, "%s: could not find %s entry in dt\n", "lpass_cdc_wsa_macro_probe", "reg");
    result = v25;
    goto LABEL_57;
  }
  of_property_read_variable_u32_array(*(_QWORD *)(a1 + 760), "wsa_data_fs_ctl_reg", v4 + 764, 1, 0);
  if ( !*(_QWORD *)(v4 + 784) )
  {
    v7 = *(unsigned int *)(v4 + 764);
    if ( (_DWORD)v7 )
      *(_QWORD *)(v4 + 784) = devm_ioremap(v1, v7, 4096);
  }
  ...
  {
    dev_err(v1, "%s: error reading %s in dt\n", "lpass_cdc_wsa_macro_probe", "qcom,is-used-swr-gpio");
    v31 = 1;
  }
  v8 = *(_QWORD *)(a1 + 760);
  memset(v48, 0, 80);
  if ( (unsigned int)_of_parse_phandle_with_args(v8, "qcom,wsa-swr-gpios", 0, 0, 0, v48) )
    v9 = 0;
  else
    v9 = v48[0];
  *(_QWORD *)(v4 + 352) = v9;
...
LABEL_45:
  ...
  msm_cdc_pinctrl_set_wakeup_capable(*(_QWORD *)(v4 + 352), 0);
  ...
  if ( of_find_property(v12, "qcom,wsa-rloads", v48) )
  {
    ...
    {
      if ( (of_property_read_variable_u32_array(*(_QWORD *)(a1 + 760), "qcom,wsa-rloads", v4 + 756, 2, 0) & 0x80000000) == 0 )
        goto LABEL_21;
  ...
  dev_info(v1, v26, "lpass_cdc_wsa_macro_read_array", "qcom,wsa-rloads");
LABEL_21:
  v13 = *(_QWORD *)(a1 + 760);
  LODWORD(v48[0]) = 0;
  if ( of_find_property(v13, "qcom,wsa-system-gains", v48) )
  {
    ...
    {
      if ( (of_property_read_variable_u32_array(*(_QWORD *)(a1 + 760), "qcom,wsa-system-gains", v4 + 732, 4, 0)
          & 0x80000000) == 0 )
        goto LABEL_24;
  ...
  dev_info(v1, v27, "lpass_cdc_wsa_macro_read_array", "qcom,wsa-system-gains");
LABEL_24:
  v14 = *(_QWORD *)(a1 + 760);
  LODWORD(v48[0]) = 0;
  if ( !of_find_property(v14, "qcom,wsa-bat-cfgs", v48) )
  {
    v28 = "%s: missing %s\n";
LABEL_63:
    dev_info(v1, v28, "lpass_cdc_wsa_macro_read_array", "qcom,wsa-bat-cfgs");
    goto LABEL_27;
  }
  if ( (v48[0] & 0xFFFFFFFC) != 8 )
  {
  ...
  if ( (of_property_read_variable_u32_array(*(_QWORD *)(a1 + 760), "qcom,wsa-bat-cfgs", v4 + 748, 2, 0) & 0x80000000) != 0 )
  {
...
LABEL_27:
  *(_QWORD *)(v4 + 560) = v11;
  *(_BYTE *)(v4 + 155) = 1;
  *(_QWORD *)(v4 + 320) = 0xFFFFFFFE00000LL;
  *(_QWORD *)(v4 + 328) = v4 + 328;
  *(_QWORD *)(v4 + 336) = v4 + 328;
  *(_QWORD *)(v4 + 344) = lpass_cdc_wsa_macro_add_child_devices;
  *(_QWORD *)(v4 + 696) = 0xFFFFFFFE00000LL;
  *(_QWORD *)(v4 + 704) = v4 + 704;
  *(_QWORD *)(v4 + 712) = v4 + 704;
  v15 = *(_QWORD *)(a1 + 760);
  *(_QWORD *)(v4 + 720) = lpass_cdc_wsa_macro_cooling_adjust_gain;
  *(_QWORD *)(v4 + 264) = v4;
  *(_QWORD *)(v4 + 272) = 0;
  *(_QWORD *)(v4 + 280) = 0;
  *(_QWORD *)(v4 + 288) = 0;
  *(_QWORD *)(v4 + 296) = wsa_swrm_clock;
  *(_QWORD *)(v4 + 304) = lpass_cdc_wsa_macro_core_vote;
  *(_QWORD *)(v4 + 312) = 0;
  if ( (of_property_read_variable_u32_array(v15, "qcom,default-clk-id", &v33, 1, 0) & 0x80000000) != 0 )
  {
    dev_err(v1, "%s: could not find %s entry in dt\n", "lpass_cdc_wsa_macro_probe", "qcom,mux0-clk-id");
    v16 = 2;
    LODWORD(v33) = 2;
  }
  else
  ...
  *(_WORD *)(v4 + 632) = v16;
  *(_QWORD *)(a1 + 168) = v4;
  _mutex_init(v4 + 160, "&wsa_priv->mclk_lock", &lpass_cdc_wsa_macro_probe___key_18);
  _mutex_init(v4 + 208, "&wsa_priv->swr_clk_lock", &lpass_cdc_wsa_macro_probe___key_20);
  v36 = 0;
  v37 = 0;
  v34 = &lpass_cdc_wsa_macro_init;
  v35 = lpass_cdc_wsa_macro_deinit;
  v38 = &lpass_cdc_wsa_macro_dai;
  v39 = 0;
  v17 = *(_WORD *)(v4 + 632);
  LOWORD(v36) = 7;
  v40 = lpass_cdc_wsa_macro_event_handler;
  v41 = 0;
  v44 = 0;
  v45 = 0;
  v46 = v11;
  v42 = lpass_cdc_wsa_macro_set_port_map;
  v43 = 0;
  v47 = v17;
  WORD1(v47) = v17;
  v18 = lpass_cdc_register_macro(v1, 2, &v34);
  if ( (v18 & 0x80000000) == 0 )
  {
    if ( of_find_property(*(_QWORD *)(*(_QWORD *)v4 + 744LL), "#cooling-cells", 0) )
    {
      ...
      {
        dev_info(v1, "%s: could not find %s entry in dt\n", "lpass_cdc_wsa_macro_probe", "qcom,thermal-max-state");
        v19 = 11;
      }
      else
      {
      ...
      v20 = *(_QWORD *)v4;
      *(_DWORD *)(v4 + 692) = v19;
      v21 = devm_thermal_of_cooling_device_register(v1, *(_QWORD *)(v20 + 744), "wsa", v4, wsa_cooling_ops);
      *(_QWORD *)(v4 + 680) = v21;
      if ( v21 >= 0xFFFFFFFFFFFFF001LL )
      {
        dev_err(v1, "%s: failed to register wsa macro as cooling device\n", "lpass_cdc_wsa_macro_probe");
        *(_QWORD *)(v4 + 680) = 0;
      }
    }
    ...
    if ( v22 < 0 )
    {
      dev_info(v1, "%s: could not find %s entry in dt\n", "lpass_cdc_wsa_macro_probe", "qcom,noise-gate-mode");
    }
    else if ( v30 <= 3 )
    {
      *(_DWORD *)(v4 + 772) = v30;
LABEL_56:
      ...
      *(_WORD *)(a1 + 504) |= 0x100u;
      ...
      queue_work_on(32, system_wq, v4 + 320);
      result = v23;
      goto LABEL_57;
    }
    *(_DWORD *)(v4 + 772) = 0;
