__int64 __fastcall ipclite_register_test_client_v0(
        void *a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        __int64 a8)
{
  ...
  if ( a1 )
  {
    ...
    if ( (ipclite_debug_level & 0x10) != 0 )
    {
      ...
      {
        printk(&unk_10835, "ipclite", "ipclite_register_test_client_v0");
      ...
      if ( (ipclite_debug_control & 4) != 0 )
LABEL_5:
        ipclite_inmem_log("APPS:%s:Test Client Registration Completed\n", (__int64)"LOW", a3, a4, a5, a6, a7, a8, v9);
    }
    return 0;
  }
  if ( (ipclite_debug_level & 1) != 0 )
  {
    if ( (ipclite_debug_control & 1) != 0 )
    {
      printk(&unk_F777, "ipclite", "ipclite_register_test_client_v0");
      if ( (ipclite_debug_control & 4) == 0 )
        return 4294967274LL;
      goto LABEL_10;
    }
