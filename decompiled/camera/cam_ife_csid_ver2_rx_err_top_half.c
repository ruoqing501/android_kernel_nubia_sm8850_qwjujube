__int64 __fastcall cam_ife_csid_ver2_rx_err_top_half(__int64 a1, __int64 *a2)
{
  __int64 v2; // x20
  unsigned int v4; // w0
  unsigned int v5; // w19
  ...
  if ( v2 )
  {
    v4 = cam_ife_csid_ver2_rx_err_process_top_half(v2, a2[2], 0, &v16);
    if ( v4 )
    {
      v5 = v4;
    ...
    else
    {
      ...
      {
        v9 = evt_payload;
        if ( (unsigned int)__ratelimit(&cam_ife_csid_ver2_rx_err_top_half__rs_299, "cam_ife_csid_ver2_rx_err_top_half") )
          v10 = 3;
        else
          v10 = 2;
  ...
  {
    if ( (unsigned int)__ratelimit(&cam_ife_csid_ver2_rx_err_top_half__rs, "cam_ife_csid_ver2_rx_err_top_half") )
      v7 = 3;
    else
      v7 = 2;
