__int64 __fastcall cam_ife_csid_ver2_top_err_irq_top_half(__int64 a1, __int64 *a2)
{
  __int64 v3; // x21
...
LABEL_9:
  ...
  if ( !evt_payload )
    goto LABEL_9;
LABEL_4:
  if ( (unsigned int)__ratelimit(&cam_ife_csid_ver2_top_err_irq_top_half__rs, "cam_ife_csid_ver2_top_err_irq_top_half") )
    v5 = 3;
  else
    v5 = 2;
