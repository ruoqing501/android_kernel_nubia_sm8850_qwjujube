__int64 __fastcall cam_req_mgr_link(unsigned int *a1)
{
  unsigned int v1; // w6
  __int64 result; // x0
  int *session_priv; // x0
  ...
  unsigned int *v23; // [xsp+30h] [xbp-90h]
...
LABEL_24:
    ...
    if ( session_priv )
    {
      ...
      {
        v7 = session_priv;
        v8 = (unsigned int *)_cam_req_mgr_reserve_link();
        if ( v8 )
        {
          v9 = v8;
          ...
          *v9 = link_hdl;
          if ( (link_hdl & 0x80000000) != 0 )
          {
            ...
            v18 = *v9;
LABEL_35:
            mutex_unlock(v9 + 8292);
            _cam_req_mgr_unreserve_link(v7, v9);
          ...
          *((_QWORD *)v9 + 4158) = 0;
          ...
          if ( mem_trace_en == 1 )
          {
            ...
            *((_QWORD *)v9 + 5) = v13;
            ...
            {
LABEL_16:
              v14 = ((__int64 (__fastcall *)(unsigned int *, unsigned int *))_cam_req_mgr_setup_link_info)(v9, a1);
              if ( (v14 & 0x80000000) != 0 )
              {
                v18 = v14;
              }
              ...
              {
                raw_spin_lock_bh(v9 + 8304);
                v9[8288] = 2;
                raw_spin_unlock_bh(v9 + 8304);
                snprintf(s, 0x80u, "%x-%x", a1[1], *v9);
                v15 = cam_req_mgr_workq_create(s, 60, v9 + 6, 0, 3, cam_req_mgr_process_workq_link_worker);
                if ( (v15 & 0x80000000) != 0 )
                {
                  v18 = v15;
                  ((void (__fastcall *)(__int64, __int64, __int64, const char *, __int64, const char *))cam_print_log)(
                  ...
                  _cam_req_mgr_destroy_link_info(v9);
                }
                else
                {
                  ...
                  v18 = v16;
                  _cam_req_mgr_destroy_link_info(v9);
                  cam_req_mgr_workq_destroy(v9 + 6);
                }
              }
              _cam_req_mgr_destroy_subdev(v9 + 10);
              goto LABEL_34;
            }
          }
          else
