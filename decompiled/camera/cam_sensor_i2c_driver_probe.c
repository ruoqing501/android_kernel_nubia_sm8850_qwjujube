__int64 __fastcall cam_sensor_i2c_driver_probe(__int64 a1)
{
  __int64 (*v2)(void); // x8
  __int64 result; // x0
  unsigned int v4; // w19
    ...
    if ( (v2() & 1) != 0 )
    {
      if ( (debug_mdl & 0x20) != 0 && !debug_priority )
        ((void (__fastcall *)(__int64, __int64, __int64, const char *, __int64, const char *))cam_print_log)(
          ...
          debug_mdl & 0x20,
          4,
          "cam_sensor_i2c_driver_probe",
          507,
          "Adding sensor component");
      cam_soc_util_initialize_power_domain(a1 + 32);
      result = component_add(a1 + 32, cam_sensor_i2c_component_ops);
      if ( (_DWORD)result )
      {
        v4 = result;
