_QWORD *__fastcall cam_sfe_component_unbind(__int64 a1)
{
  _QWORD *v1; // x19
  __int64 v2; // x8
  _QWORD *v3; // x20
  ...
  if ( (debug_mdl & 0x40000000) != 0 && !debug_priority )
    ((void (*)(__int64, __int64, __int64, const char *, __int64, const char *, ...))cam_print_log)(
      ...
      "cam_sfe_component_unbind",
      188,
      "SFE component unbound type %d index %d",
      *(_DWORD *)v1,
      *((_DWORD *)v1 + 1));
  v2 = *((unsigned int *)v1 + 1);
  if ( (unsigned int)v2 <= 2 )
    cam_sfe_hw_list[4 * v2] = 0;
  v3 = (_QWORD *)v1[14];
  if ( !v3 )
  {
  ...
  v8 = cam_sfe_deinit_soc_resources((__int64)(v3 + 12));
  if ( v8 < 0 )
    ((void (*)(__int64, __int64, __int64, const char *, __int64, const char *, ...))cam_print_log)(
      3,
      0x40000000,
