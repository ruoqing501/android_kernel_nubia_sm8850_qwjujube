__int64 __fastcall cam_jpeg_dma_component_bind(_QWORD *a1)
{
  __int64 v2; // x0
  __int64 v3; // x19
  _QWORD *v4; // x0
  ...
  if ( mem_trace_en == 1 )
    v2 = cam_mem_trace_alloc(120, 0xCC0u, 0, "cam_jpeg_dma_component_bind", 0x53u);
  else
  ...
  if ( v2 )
  {
    while ( 1 )
    {
      ...
      if ( mem_trace_en == 1 )
        v4 = (_QWORD *)cam_mem_trace_alloc(3688, 0xCC0u, 0, "cam_jpeg_dma_component_bind", 0x5Au);
      else
      ...
      v4[12] = a1 - 2;
      v4[15] = *(a1 - 2);
      *(_QWORD *)(v3 + 16) = &cam_jpeg_dma_init_hw;
      *(_QWORD *)(v3 + 24) = cam_jpeg_dma_deinit_hw;
      *(_QWORD *)(v3 + 56) = cam_jpeg_dma_start_hw;
      *(_QWORD *)(v3 + 64) = cam_jpeg_dma_stop_hw;
      *(_QWORD *)(v3 + 32) = cam_jpeg_dma_reset_hw;
      *(_QWORD *)(v3 + 88) = &cam_jpeg_dma_process_cmd;
      *(_QWORD *)(v3 + 104) = cam_jpeg_dma_test_irq_line;
      *(_QWORD *)(v3 + 112) = v4;
      *(_DWORD *)v3 = 1;
      a1[19] = v3;
      if ( mem_trace_en == 1 )
        v6 = cam_mem_trace_alloc(136, 0xCC0u, 0, "cam_jpeg_dma_component_bind", 0x6Fu);
      else
      ...
      if ( !matched )
      {
        ((void (__fastcall *)(__int64, __int64, __int64, const char *, __int64, const char *))cam_print_log)(
          ...
          512,
          1,
          "cam_jpeg_dma_component_bind",
          122,
          " No jpeg_dma hardware info");
        v11 = -22;
        goto LABEL_19;
      }
      ...
      *(_DWORD *)v7 = 0;
      *(_QWORD *)(v7 + 8) = v9;
      _mutex_init(v7 + 64, "&core_info->core_mutex", &cam_jpeg_dma_component_bind___key);
      inited = cam_jpeg_dma_init_soc_resources(v5 + 12, cam_jpeg_dma_irq, v5);
      if ( inited )
      {
        v11 = inited;
      ...
      *(_DWORD *)(v7 + 16) = v27;
      *((_DWORD *)v5 + 23) = 0;
      _mutex_init(v5, "&jpeg_dma_dev->hw_mutex", &cam_jpeg_dma_component_bind___key_14);
      *((_DWORD *)v5 + 12) = 0;
      *((_DWORD *)v5 + 14) = 0;
      _init_swait_queue_head(v5 + 8, "&x->wait", &init_completion___key_16);
      if ( (debug_mdl & 0x200) != 0 && !debug_priority )
        ((void (__fastcall *)(__int64, __int64, __int64, const char *, __int64, const char *))cam_print_log)(
          ...
          "cam_jpeg_dma_component_bind",
          149,
          "JPEG-DMA component bound successfully");
      v15 = (int *)v5[424];
      v16 = *v15;
      *(_DWORD *)(v7 + 112) = *v15;
      if ( !v16
      ...
      *(_QWORD *)(StatusReg + 80) = &cam_jpeg_dma_component_bind__alloc_tag;
