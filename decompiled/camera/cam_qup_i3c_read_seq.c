__int64 __fastcall cam_qup_i3c_read_seq(__int64 a1, int a2, __int64 a3, int a4, int a5)
{
  unsigned int v6; // w21
...
LABEL_37:
    ...
    *(_QWORD *)(StatusReg + 80) = &cam_qup_i3c_read_seq__alloc_tag;
    v11 = v12;
    v13 = (_BYTE *)_kmalloc_noprof(v10, 3520);
  ...
  *v13 = HIBYTE(a2);
  ...
  v13[3] = a2;
LABEL_23:
  v15 = cam_qup_i3c_rxdata(v14, (__int64)v13, v11, v6);
  if ( !v15 )
  {
    v16 = v6;
    v17 = v6 - 1LL;
