__int64 __fastcall cam_cpas_set_addr_trans(unsigned int a1, __int64 a2)
{
  __int64 v2; // x9
  _DWORD *v3; // x8
  __int64 v4; // x0
...
LABEL_12:
  ...
  if ( *(v3 - 1) != -1055839300 )
    __break(0x8228u);
  result = ((__int64 (__fastcall *)(__int64, __int64, _QWORD *, __int64))v3)(v4, 2, v9, 16);
  if ( (_DWORD)result )
  {
    v6 = result;
