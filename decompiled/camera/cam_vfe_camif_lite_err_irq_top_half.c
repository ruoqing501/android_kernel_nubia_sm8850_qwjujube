__int64 __fastcall cam_vfe_camif_lite_err_irq_top_half(__int64 a1, __int64 *a2)
{
  int *v3; // x9
  __int64 v4; // x23
  int v5; // w7
  ...
  if ( v6 || (*(_DWORD *)(v7[4] + 24LL) & v5) != 0 )
  {
    ...
    ((void (*)(__int64, __int64, __int64, const char *, __int64, const char *, ...))cam_print_log)(
      ...
      *(_DWORD *)(*(_QWORD *)(v4 + 16) + 4LL));
    cam_irq_controller_disable_all(v7[10]);
  }
  else
  {
    v8 = 0;
  ...
  v18[0] = 0;
  evt_payload = cam_vfe_camif_lite_get_evt_payload(v7, v18);
  if ( evt_payload )
  {
    if ( (unsigned int)__ratelimit(&cam_vfe_camif_lite_err_irq_top_half__rs, "cam_vfe_camif_lite_err_irq_top_half") )
      v10 = 3;
    else
      v10 = 2;
    ...
    if ( (unsigned int)__ratelimit(&cam_vfe_camif_lite_err_irq_top_half__rs_15, "cam_vfe_camif_lite_err_irq_top_half") )
      v11 = 3;
    else
      v11 = 2;
...
LABEL_34:
  ...
  if ( v8 )
  {
    v7[2830] = *(__int64 *)((char *)&qword_28 + v12);
    v7[2831] = *(__int64 *)((char *)&_ksymtab_cam_cdm_get_iommu_handle + v12);
  }
  if ( *((_DWORD *)a2 + 2) )
  {
...
LABEL_35:
  __break(0x5512u);
  return cam_vfe_camif_lite_get_evt_payload(timestamp, v14);
}
