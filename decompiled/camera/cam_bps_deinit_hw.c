__int64 __fastcall cam_bps_deinit_hw(__int64 a1)
{
  __int64 v1; // x20
  __int64 v3; // x1
  int v4; // w21
  ...
  *(_DWORD *)(v1 + 12) = v4;
  ...
  if ( v4 )
  {
    ...
    if ( (debug_mdl & 0x100) != 0 && !debug_priority )
    {
      ...
      v8 = "BPS%u power on reference still held %u";
      v9 = debug_mdl & 0x100;
      v10 = 166;
LABEL_22:
  ...
  {
    v11 = cam_bps_disable_soc_resources(a1 + 96, *(unsigned __int8 *)(v1 + 17));
    if ( v11 )
      ((void (*)(__int64, __int64, __int64, const char *, __int64, const char *, ...))cam_print_log)(
        3,
        256,
