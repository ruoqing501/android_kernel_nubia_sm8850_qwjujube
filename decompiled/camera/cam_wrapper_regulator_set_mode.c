__int64 __fastcall cam_wrapper_regulator_set_mode(__int64 a1, __int64 a2)
{
  __int64 v2; // x21
  unsigned int v3; // w22
  __int64 result; // x0
  ...
  else
  {
    ...
    result = regulator_set_mode(a1, a2);
    if ( clk_rgltr_bus_ops_profiling == 1 )
    {
      v5 = result;
