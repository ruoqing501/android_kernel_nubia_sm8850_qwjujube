__int64 __fastcall cam_jpeg_enc_init_hw(__int64 a1)
{
  __int64 v2; // x20
  int v3; // w8
  bool v4; // nf
  ...
  *(_DWORD *)(v2 + 56) = v3;
  if ( v4 != __OFSUB__(v3, 2) )
  {
    ...
    *(_QWORD *)((char *)&s[6] + 4) = 0x10000000001LL;
    ...
    LODWORD(v12) = 2;
    LODWORD(s[0]) = 2;
    v7 = cam_cpas_start(v6, (__int64)&v11, (__int64)s);
    if ( v7 )
    {
      v8 = v7;
      ((void (*)(__int64, __int64, __int64, const char *, __int64, const char *, ...))cam_print_log)(
    ...
    {
      v9 = cam_jpeg_enc_enable_soc_resources(a1 + 96);
      if ( !v9 )
      {
        v10 = raw_spin_lock_irqsave(a1 + 48);
        *(_DWORD *)(a1 + 92) = 1;
        raw_spin_unlock_irqrestore(a1 + 48, v10);
        goto LABEL_4;
      }
      v8 = v9;
      ((void (*)(__int64, __int64, __int64, const char *, __int64, const char *, ...))cam_print_log)(
