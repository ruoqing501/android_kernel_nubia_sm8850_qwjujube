__int64 __fastcall tpg_1_4_layer_init(int *a1)
{
  int v2; // w3
  __int64 dir; // x0
  __int64 v4; // x20
  ...
  *(_QWORD *)s = 0;
  ...
  {
    v4 = dir;
    debugfs_create_file("tpg_xcfa_test", 420, dir, a1, &tpg_1_4_xcfa_test);
    debugfs_create_file("tpg_shdr_overlap_test", 420, v4, a1, &tpg_1_4_shdr_overlap_test);
    debugfs_create_file("tpg_shdr_offset_num_batch", 420, v4, a1, &tpg_1_4_shdr_offset_num_batch);
    debugfs_create_file("tpg_shdr_line_offset0", 420, v4, a1, &tpg_1_4_shdr_line_offset0);
    debugfs_create_file("tpg_shdr_line_offset1", 420, v4, a1, &tpg_1_4_shdr_line_offset1);
