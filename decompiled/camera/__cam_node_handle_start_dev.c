__int64 __fastcall _cam_node_handle_start_dev(const char *a1, int *a2)
{
  unsigned int v4; // w0
  const char *v5; // x5
  unsigned int v6; // w19
...
LABEL_7:
  ...
  if ( device_priv )
  {
    ...
    {
      result = cam_context_handle_start_dev((__int64)v11, (__int64)a2);
      if ( (_DWORD)result )
      {
        v12 = result;
