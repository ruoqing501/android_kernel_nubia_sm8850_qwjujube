__int64 __fastcall cam_icp_v1_cpas_cb(__int64 a1, __int64 a2, unsigned int *a3)
{
  unsigned int *v3; // x19
  int v4; // w0
  __int64 v5; // x6
  ...
  if ( a3 )
  {
    if ( *a3 == 14 )
    {
      v10 = __ratelimit(&cam_icp_v1_cpas_cb__rs_8, "cam_icp_v1_cpas_cb");
      v5 = *v3;
      v6 = v3[1];
    ...
    else
    {
      ...
      v4 = __ratelimit(&cam_icp_v1_cpas_cb__rs, "cam_icp_v1_cpas_cb");
      v5 = *v3;
      v6 = v3[1];
