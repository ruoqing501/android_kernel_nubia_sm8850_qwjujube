__int64 __fastcall trace_event_raw_event_cam_buf_done(__int64 a1, const char *a2, __int64 a3, __int64 a4)
{
  __int64 v7; // x8
  const char *v8; // x22
  int v9; // w23
    ...
    || (v15 = a2, result = _trace_trigger_soft_disabled(a1), a2 = v15, (result & 1) == 0) )
  {
    if ( a2 )
      ...
      v8 = "(null)";
    v9 = strlen(v8) + 1;
    result = trace_event_buffer_reserve(v16, a1, v9 + 40LL);
    if ( result )
    {
      v11 = result + 40;
      v12 = (v9 << 16) | 0x28;
      ...
      *(_BYTE *)(v11 + v13) = 0;
      *(_QWORD *)(v14 + 16) = a3;
      *(_DWORD *)(v14 + 24) = *(_DWORD *)(a3 + 64);
      *(_QWORD *)(v14 + 32) = *(_QWORD *)(a4 + 24);
