__int64 __fastcall cam_bps_init_soc_resources(__int64 a1, __int64 a2, __int64 a3)
{
  char *j; // x25
  __int64 v7; // x0
  __int64 i; // x22
  ...
  if ( mem_trace_en == 1 )
    v7 = cam_mem_trace_alloc(16, 0xCC0u, 0, "cam_bps_init_soc_resources", 0x48u);
  else
    ...
    *(_QWORD *)(a1 + 3296) = i;
    ...
    if ( (dt_properties & 0x80000000) != 0 )
    {
      ...
      ((void (__fastcall *)(__int64, __int64, __int64, const char *, __int64, const char *))cam_print_log)(
        ...
        256,
        1,
        "cam_bps_get_dt_properties",
        26,
        "get bps dt prop is failed");
      result = v14;
      goto LABEL_29;
    }
    ...
    if ( j[2904] == 1 )
    {
      v13 = cam_mem_trace_alloc(4 * v12, 0xCC0u, 0, "cam_bps_get_dt_properties", 0x24u);
      *(_QWORD *)(i + 8) = v13;
      if ( !v13 )
        goto LABEL_27;
    }
    else
    {
      ...
      *(_QWORD *)(i + 8) = v16;
      ...
      {
LABEL_27:
        v21 = "cam_bps_get_dt_properties";
        v22 = "Failed at allocating memory for BPS hw pids";
        v23 = 256;
        v24 = 1;
        v25 = 38;
LABEL_28:
...
LABEL_17:
    ...
    *(_QWORD *)(StatusReg + 80) = &cam_bps_init_soc_resources__alloc_tag;
    i = _kvmalloc_node_noprof(16, 0, 3520, 0xFFFFFFFFLL);
  }
  result = 4294967284LL;
  if ( (debug_mdl & 0x100) != 0 && !debug_priority )
  {
    v21 = "cam_bps_init_soc_resources";
    v22 = "Failed at allocating BPS soc_private";
    v23 = debug_mdl & 0x100;
    v24 = 4;
    v25 = 74;
    goto LABEL_28;
