__int64 __fastcall cam_actuator_construct_default_power_setting(__int64 a1)
{
  int v2; // w8
  _DWORD *v3; // x0
  int v4; // w8
  ...
  *(_WORD *)(a1 + 16) = 1;
  if ( v2 == 1 )
  {
    v3 = (_DWORD *)cam_mem_trace_alloc(112, 0xCC0u, 0, "cam_actuator_construct_default_power_setting", 0x18u);
    *(_QWORD *)(a1 + 8) = v3;
    if ( !v3 )
      return 4294967284LL;
  }
  ...
  *(_WORD *)(a1 + 32) = 1;
  if ( v4 == 1 )
    v5 = (_DWORD *)cam_mem_trace_alloc(112, 0xCC0u, 0, "cam_actuator_construct_default_power_setting", 0x24u);
  else
