__int64 __fastcall ulog_level_set(__int64 a1, int a2, __int64 a3)
{
  __int64 result; // x0
  __int64 v6; // x8
  unsigned int v7; // w0
  ...
  if ( *(_BYTE *)(a1 + 8432) == 1 )
  {
    printk(&unk_6CF2, "ulog_level_set", a3);
    result = 4294967274LL;
    goto LABEL_7;
  }
  if ( *(_DWORD *)(a1 + 8424) != a2 )
  {
    v10 = 0x10000800ALL;
    v11 = 0;
    v6 = *(_QWORD *)(a1 + 8416);
    ...
    *(_DWORD *)(a1 + 88) = 0;
    ...
    mutex_unlock(a1 + 40);
    printk(&unk_6E5D, "ulog_level_set", v9);
    result = v9;
    goto LABEL_7;
  }
  result = 0;
