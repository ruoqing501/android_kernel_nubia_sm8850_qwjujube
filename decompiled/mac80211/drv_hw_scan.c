__int64 __fastcall drv_hw_scan(__int64 a1, __int64 a2)
{
  int v2; // w8
  __int64 v4; // x10
  __int64 v5; // x19
  ...
  if ( (*(_BYTE *)(*(_QWORD *)(a2 + 1616) + 1471LL) & 1) != 0
    ...
    || (drv_hw_scan___already_done & 1) != 0 )
  {
  ...
  v8 = *(__int64 (**)(void))(*(_QWORD *)(a1 + 464) + 184LL);
  if ( *((_DWORD *)v8 - 1) != -766401689 )
    __break(0x8228u);
  return v8();
}
