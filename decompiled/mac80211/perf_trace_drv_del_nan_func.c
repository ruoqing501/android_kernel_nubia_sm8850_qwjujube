size_t __fastcall perf_trace_drv_del_nan_func(__int64 a1, __int64 a2, __int64 a3, char a4)
{
  __int64 v4; // x30
  __int64 v6; // x26
  size_t result; // x0
  ...
  result = perf_trace_buf_alloc(v14, v31, &v30);
  if ( !result )
    goto LABEL_12;
  v15 = (_QWORD *)v31[0];
  v16 = result;
...
LABEL_12:
  ...
  v28 = MEMORY[0x298DFAC](v27);
  return trace_event_raw_event_drv_set_default_unicast_key(v28);
}
