__int64 __fastcall drv_set_tsf(__int64 result, __int64 a2)
{
  int v2; // w8
  void (*v3)(void); // x8
  __int64 v4; // x19
  ...
  if ( (*(_BYTE *)(*(_QWORD *)(a2 + 1616) + 1471LL) & 1) != 0
    ...
    || (drv_set_tsf___already_done & 1) != 0 )
  {
  ...
  v3 = *(void (**)(void))(*(_QWORD *)(result + 464) + 352LL);
  if ( v3 )
  {
    v4 = result;
    if ( *((_DWORD *)v3 - 1) != -1003313279 )
      __break(0x8228u);
    v3();
    return v4;
  }
