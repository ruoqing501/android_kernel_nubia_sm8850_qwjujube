__int64 __fastcall trace_event_raw_event_drv_ampdu_action(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v7; // x8
  int v8; // w23
  __int64 result; // x0
      ...
      *(_DWORD *)(result + 60) = (v8 << 16) | 0x56;
      ...
      else
      {
        ...
        if ( v14 < 0x21 )
        {
          ...
          *(_WORD *)(v10 + 72) = v20;
          *(_DWORD *)(v10 + 68) = v19;
          *(_WORD *)(v10 + 74) = *(_WORD *)(a4 + 16);
          *(_WORD *)(v10 + 76) = *(_WORD *)(a4 + 18);
          *(_WORD *)(v10 + 78) = *(_WORD *)(a4 + 20);
          *(_BYTE *)(v10 + 80) = *(_BYTE *)(a4 + 22);
          *(_WORD *)(v10 + 82) = *(_WORD *)(a4 + 24);
          *(_WORD *)(v10 + 84) = *(_DWORD *)a4;
