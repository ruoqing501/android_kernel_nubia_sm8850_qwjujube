__int64 __fastcall perf_trace_drv_return_int(__int64 result, __int64 a2, int a3)
{
  __int64 v3; // x30
  __int64 v4; // x23
  __int64 v6; // x19
  ...
  if ( !*(_QWORD *)(result + 112) && !*(_QWORD *)(StatusReg + v8) )
    goto LABEL_12;
  result = perf_trace_buf_alloc(44, v22, &v21);
  if ( !result )
    goto LABEL_12;
  v10 = (_QWORD *)v22[0];
  v11 = result;
...
LABEL_12:
  ...
  if ( v19 )
    JUMPOUT(0xC4D88);
  return trace_event_raw_event_drv_return_bool(v18);
}
