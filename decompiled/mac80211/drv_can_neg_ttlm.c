__int64 __fastcall drv_can_neg_ttlm(__int64 a1, __int64 a2)
{
  int v2; // w8
  __int64 v4; // x10
  __int64 v5; // x19
  ...
  if ( (*(_BYTE *)(*(_QWORD *)(a2 + 1616) + 1471LL) & 1) != 0
    ...
    || (drv_can_neg_ttlm___already_done & 1) != 0 )
  {
  ...
  {
    v4 = *(_QWORD *)(a2 + 1608);
    drv_can_neg_ttlm___already_done = 1;
    v5 = a1;
    if ( v4 )
  ...
  v8 = *(__int64 (**)(void))(*(_QWORD *)(a1 + 464) + 960LL);
  if ( !v8 )
    return 1;
  if ( *((_DWORD *)v8 - 1) != 786236422 )
    __break(0x8228u);
  return v8();
}
