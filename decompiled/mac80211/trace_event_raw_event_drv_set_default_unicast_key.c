__int64 __fastcall trace_event_raw_event_drv_set_default_unicast_key(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  __int64 v7; // x8
  int v8; // w23
  __int64 result; // x0
...
LABEL_11:
  ...
  v19 = _fortify_panic(7);
  v20 = MEMORY[0x298E128](v19);
  return perf_trace_drv_set_default_unicast_key(v20);
}
