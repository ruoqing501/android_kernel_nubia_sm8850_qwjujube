__int64 __fastcall wsa883x_codec_info_create_codec_entry(__int64 a1, __int64 a2)
{
  __int64 result; // x0
  _QWORD *v4; // x21
  __int64 v5; // x20
  ...
  if ( a1 && a2 )
  {
    ...
    if ( !v4[19] )
    {
      ...
      *(_QWORD *)s = 0;
      v13 = 0;
      snprintf(s, 0x50u, "%s.%llx", "wsa883x", *(_QWORD *)(v6 + 984));
      module_entry = snd_info_create_module_entry(*(_QWORD *)(a1 + 56), s, a1);
      v4[19] = module_entry;
      if ( module_entry )
      {
        *(_WORD *)(module_entry + 8) = 16749;
        if ( (snd_info_register(v4[19]) & 0x80000000) == 0 )
        {
          card_entry = snd_info_create_card_entry(*(_QWORD *)(v5 + 80), "version", v4[19]);
          if ( card_entry )
          {
            v9 = card_entry;
            ...
            *(_QWORD *)(card_entry + 32) = &wsa883x_codec_info_ops;
            if ( (snd_info_register(card_entry) & 0x80000000) == 0 )
            {
              v4[20] = v9;
              v10 = snd_info_create_card_entry(*(_QWORD *)(v5 + 80), "variant", v4[19]);
              if ( v10 )
              {
                v11 = v10;
                *(_QWORD *)(v10 + 16) = 32;
                *(_QWORD *)(v10 + 64) = v4;
                *(_WORD *)(v10 + 24) = 1;
                *(_QWORD *)(v10 + 32) = &wsa883x_variant_ops;
