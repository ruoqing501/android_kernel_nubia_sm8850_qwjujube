__int64 __fastcall lpass_cdc_va_macro_add_child_devices(__int64 a1)
{
  __int64 *v1; // x26
  __int64 v3; // x0
  __int64 result; // x0
  ...
  if ( a1 == 1424 )
  {
    v21 = &unk_11B36;
LABEL_29:
    result = printk(v21, "lpass_cdc_va_macro_add_child_devices");
    goto LABEL_38;
  }
  v3 = *v1;
  if ( !*v1 )
  ...
  if ( !*(_QWORD *)(v3 + 744) )
  {
    result = dev_err(v3, "%s: DT node for va_priv does not exist\n", "lpass_cdc_va_macro_add_child_devices");
    goto LABEL_38;
  }
  *(_DWORD *)(a1 + 32) = 0;
  ...
  if ( result )
  {
    ...
    do
    {
      v8 = strnstr(*v5, "va_swr_master", 13);
      if ( v8 )
      {
        strcpy((char *)v22, "va_swr_ctrl");
      }
      else
      {
        v9 = *v5;
      ...
      *(_QWORD *)(v12 + 760) = v5;
      if ( v8 )
      {
        ...
        {
          result = dev_err(v12 + 16, "%s: cannot add plat data ctrl:%d\n", "lpass_cdc_va_macro_add_child_devices", v7);
LABEL_34:
          if ( *(int *)(a1 + 32) >= 1 )
          {
            result = platform_device_put(*(_QWORD *)(a1 + 56));
            if ( *(int *)(a1 + 32) >= 2 )
            {
              result = platform_device_put(*(_QWORD *)(a1 + 64));
              if ( *(int *)(a1 + 32) >= 3 )
              {
                result = platform_device_put(*(_QWORD *)(a1 + 72));
                if ( *(int *)(a1 + 32) > 3 )
                {
LABEL_39:
                  __break(0x5512u);
