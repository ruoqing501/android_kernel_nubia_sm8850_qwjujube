__int64 __fastcall lpass_cdc_va_macro_tx_mixer_get(__int64 a1, __int64 a2)
{
  __int64 v6; // x0
  __int64 v7; // x8
  __int64 v8; // x20
  ...
  if ( (unsigned int)v9 > 4 )
  {
    ...
    return lpass_cdc_va_macro_tx_mixer_put();
  }
  else
  {
    result = 0;
    *(_QWORD *)(a2 + 72) = ((*(_QWORD *)(v12 + 8 * v9 + ((v10 >> 3) & 0x1FFFFFF8) + 1256) >> v10) & 1) != 0;
  }
  return result;
}
