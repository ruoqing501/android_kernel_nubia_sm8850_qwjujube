__int64 __fastcall wcd939x_slave_bind(__int64 a1)
{
  __int64 v2; // x20
  ...
  {
    if ( (unsigned int)__ratelimit(&wcd939x_slave_bind__rs, "wcd939x_slave_bind") )
      printk(&unk_6DEB, "wcd939x_slave_bind");
    result = 4294967274LL;
  }
  else
  {
