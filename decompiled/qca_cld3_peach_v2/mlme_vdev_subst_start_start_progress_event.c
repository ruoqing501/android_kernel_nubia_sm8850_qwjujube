        ...
        double a12)
{
  ...
  if ( a2 > 4u )
  {
    switch ( a2 )
    {
      ...
      case 0xCu:
        v33 = a1;
        wlan_sm_transition_to(*(_QWORD *)(a1 + 504), 0xAu, a5, a6, a7, a8, a9, a10, a11, a12);
        v34 = *(_QWORD *)(v33 + 528);
        if ( v34 )
        {
          v35 = *(_DWORD **)(v34 + 32);
        ...
        return 1;
      case 0x17u:
        wlan_sm_transition_to(*(_QWORD *)(a1 + 504), 8u, a5, a6, a7, a8, a9, a10, a11, a12);
        return 1;
    }
  }
  else
  {
    ...
    {
      v15 = a1;
      wlan_sm_transition_to(*(_QWORD *)(a1 + 504), 9u, a5, a6, a7, a8, a9, a10, a11, a12);
      v24 = *(_QWORD *)(v15 + 504);
      v25 = 8;
LABEL_20:
