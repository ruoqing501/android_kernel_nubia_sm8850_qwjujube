__int64 __fastcall lim_abort_channel_change(__int64 a1, char a2)
{
  __int64 v4; // x0
  double v5; // d0
  double v6; // d1
    ...
    *(_WORD *)(v24 + 152) = 3;
    ...
    if ( sap_ch_sw_info )
    {
      *sap_ch_sw_info = *(_DWORD *)(v24 + 284);
      ...
      wlan_vdev_mlme_sm_deliver_evt(*(_QWORD *)(v24 + 16), 0x1Eu, 0x36B0u, v24, v5, v6, v7, v8, v9, v10, v11, v12);
