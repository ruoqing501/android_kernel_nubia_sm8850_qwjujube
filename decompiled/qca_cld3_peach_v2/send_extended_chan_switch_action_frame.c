__int64 __fastcall send_extended_chan_switch_action_frame(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v11 = v10;
  result = wlan_reg_freq_to_chan(*(_QWORD *)(a1 + 21632), (unsigned __int16)v7, v9, v12, v13, v14, v15, v16, v17, v18);
  v20 = *(_DWORD *)(a4 + 88);
  v26 = result;
  if ( v20 == 2 )
    return lim_send_extended_chan_switch_action_frame(a1, a4 + 24, 0, v11, (unsigned int)result, v4[3122], a4);
  if ( v20 == 1 )
  {
    if ( *(_BYTE *)(a1 + 14883) )
      v21 = 0;
    ...
    do
    {
      v23 = (_WORD *)(*(_QWORD *)(a4 + 368) + 1272LL * v22);
      if ( v23 )
      {
        if ( (*v23 & 8) != 0 )
        {
          v24 = lim_calculate_peer_ch_width(a4, v23 + 175, v6);
          lim_op_class_from_bandwidth(a1, v7, v24, v4[3115]);
          result = lim_send_extended_chan_switch_action_frame(a1, v23 + 175, v21, v25, v26, v4[3122], a4);
        }
      }
      ++v22;
    }
