...
LABEL_11:
    ...
    if ( v34 )
    {
      if ( (*(_WORD *)v34 & 0x400) == 0 )
      {
        ...
        {
          v35 = *(unsigned __int16 *)(v34 + 348);
          v36 = v34 + 350;
          if ( (unsigned __int8)a3 == 1 )
          {
            lim_send_assoc_rsp_mgmt_frame(a1, 12, v35, v36, 1, v34, a4, 0, v34 + 1080);
            v33 = "%s: Rejecting reassoc req from STA";
            goto LABEL_11;
          }
          lim_send_assoc_rsp_mgmt_frame(a1, 0, v35, v36, a3, v34, a4, 0, v34 + 1080);
          v43 = *(unsigned __int16 *)(a4 + 8);
          v44 = *(unsigned int *)(a4 + 88);
          if ( v16 == -10 )
          {
    ...
    else
    {
      ...
      if ( (result & 1) != 0 )
      {
        ...
        if ( (result & 1) == 0 )
        {
          result = _qdf_mem_malloc(0xEB8u, "lim_process_assoc_req_frame", 3177);
          if ( result )
          {
