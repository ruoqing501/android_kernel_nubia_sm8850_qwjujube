...
LABEL_20:
  ...
  {
    raw_spin_lock(v16 + 2560);
  }
  else
  {
    raw_spin_lock_bh(v16 + 2560);
    *(_QWORD *)(v16 + 2568) |= 1uLL;
  }
  if ( *(_DWORD *)(v16 + 2368) == 6 && !*(_BYTE *)(v16 + 2576) )
  {
    if ( (unsigned int)dp_tx_desc_pool_alloc(a1, a2, a3, 0, v19, v20, v21, v22, v23, v24, v25, v26) )
    {
      ...
      if ( (v27 & 1) != 0 )
      {
        *(_QWORD *)(v16 + 2568) = v27 & 0xFFFFFFFFFFFFFFFELL;
        raw_spin_unlock_bh(v16 + 2560);
      }
      else
      {
        raw_spin_unlock(v16 + 2560);
      }
    ...
    else
    {
      if ( !(unsigned int)dp_tx_desc_pool_init(a1, a2, a3, 0) )
      {
        ...
        *(_DWORD *)(v16 + 2368) = 0;
        dp_tx_initialize_threshold(
          ...
          a3);
        ++*(_BYTE *)(v16 + 2576);
        qdf_spin_unlock_bh_24(v16 + 2560);
        return v17;
      }
      ...
      if ( (v46 & 1) != 0 )
      {
        *(_QWORD *)(v16 + 2568) = v46 & 0xFFFFFFFFFFFFFFFELL;
        raw_spin_unlock_bh(v16 + 2560);
      }
      else
      {
  ...
  qdf_trace_msg(
    ...
    *(unsigned __int8 *)(v16 + 2576));
  v28 = *(_BYTE *)(v16 + 2576);
  v29 = *(_QWORD *)(v16 + 2568);
  *(_DWORD *)(v16 + 2368) = 7;
  *(_BYTE *)(v16 + 2576) = v28 + 1;
  if ( (v29 & 1) != 0 )
  {
    *(_QWORD *)(v16 + 2568) = v29 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(v16 + 2560);
  }
  else
  {
