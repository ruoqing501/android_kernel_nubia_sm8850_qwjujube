...
LABEL_35:
    if ( *(_BYTE *)(v11 + 2638) != 1 )
      goto LABEL_39;
    result = sme_update_beacon_country_ie(v9[2], *(unsigned __int8 *)(a1[6604] + 8LL), 0);
    if ( !(_DWORD)result )
    {
      *(_BYTE *)(v11 + 2638) = 0;
      goto LABEL_39;
...
LABEL_12:
  ...
  if ( (*(_BYTE *)(v11 + 2638) & 1) == 0 )
  {
    if ( (unsigned int)sme_update_beacon_country_ie(v9[2], *(unsigned __int8 *)(a1[6604] + 8LL), 1) )
      qdf_trace_msg(
        0x33u,
        2u,
