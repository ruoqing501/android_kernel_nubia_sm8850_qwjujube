        ...
        double a9)
{
  ...
  *(_QWORD *)s = 0;
  ...
  if ( (unsigned __int8)v19 >= 0x31u
    || (v20 = v19,
        v21 = snprintf(&s[v19 & 0x3F], 48 - (v19 & 0x3Fu), " %d", a1[909]),
        (unsigned __int8)(v21 + v20) > 0x30u)
    || (v22 = v21
            + v20
            + snprintf(&s[(unsigned __int8)(v21 + v20)], 48LL - (unsigned __int8)(v21 + v20), " %d", a1[910]),
        (unsigned __int8)v22 > 0x30u)
    || (v23 = v22 + snprintf(&s[(unsigned __int8)v22], 48LL - (unsigned __int8)v22, " %d", a1[911]),
        (unsigned __int8)v23 > 0x30u)
    || (v24 = v23 + snprintf(&s[(unsigned __int8)v23], 48LL - (unsigned __int8)v23, " %d", a1[912]),
        (unsigned __int8)v24 > 0x30u)
    || (v25 = v24 + snprintf(&s[(unsigned __int8)v24], 48LL - (unsigned __int8)v24, " %d", a1[913]),
        (unsigned __int8)v25 > 0x30u)
    || (v26 = v25 + snprintf(&s[(unsigned __int8)v25], 48LL - (unsigned __int8)v25, " %d", a1[914]), v26 > 0x30u) )
  {
    __break(0x5512u);
  }
  snprintf(&s[v26], 48LL - v26, " %d", a1[915]);
  ...
  DP_PRINT_STATS("Number of Msdu's Part of Ampdus = %d", v116, v117, v118, v119, v120, v121, v122, v123, a1[983]);
  DP_PRINT_STATS(
