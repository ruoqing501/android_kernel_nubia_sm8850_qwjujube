        ...
        double a11)
{
  ...
  if ( cmpt_obj )
  {
    v23 = (unsigned __int16 *)((char *)cmpt_obj + 481);
    v24 = cmpt_obj;
    cmpt_obj[114] = *a2;
    cmpt_obj[115] = a2[1];
    qdf_mem_copy((char *)cmpt_obj + 481, a2 + 2, 6u);
    qdf_mem_copy((char *)v24 + 487, a2 + 8, 6u);
    qdf_mem_copy(v29, v24 + 46, 6u);
    if ( a3 && !v24[114] && !(*(_DWORD *)v23 | v23[2]) )
    {
      v25 = *(_QWORD *)(a1 + 216);
      if ( v25 )
        v26 = *(_QWORD *)(v25 + 80);
