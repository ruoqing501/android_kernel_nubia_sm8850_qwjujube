__int64 __fastcall _dp_ipa_handle_buf_smmu_mapping(__int64 a1, __int64 a2, unsigned int a3, char a4)
{
  ...
  {
    if ( (*(_BYTE *)(a1 + 20806) & 1) != 0 )
    {
      v28 = (*(_QWORD *)(a2 + 40) - *(_QWORD *)(a1 + 20784)) >> 12;
      v29 = v28 >> *(_WORD *)(a1 + 20804);
      if ( (unsigned int)v29 > *(unsigned __int16 *)(a1 + 20746) )
      {
        qdf_trace_msg(
          0x45u,
          2u,
      ...
      v31 = *(_QWORD *)(*(_QWORD *)(a1 + 20760) + 8LL * (unsigned int)v29);
      v32 = 4LL * (*(_DWORD *)(a1 + 20800) & (unsigned int)v28);
      if ( (a4 & 1) != 0 )
      {
