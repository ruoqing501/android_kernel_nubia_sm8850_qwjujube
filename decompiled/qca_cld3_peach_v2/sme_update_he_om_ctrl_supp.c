        ...
        double a11)
{
  ...
  {
    *(_QWORD *)(a1[1] + 1309LL) = *(_QWORD *)(a1[1] + 1309LL) & 0xFFFFFFFFFDFFFFFFLL
                                | ((unsigned __int64)(a3 & 1) << 25);
    v11 = *(_QWORD *)((char *)a1 + 21849) & 0xFFFFFFFFFDFFFFFFLL | ((unsigned __int64)(a3 & 1) << 25);
    *(_QWORD *)((char *)a1 + 21789) = *(_QWORD *)((char *)a1 + 21789) & 0xFFFFFFFFFDFFFFFFLL
                                    | ((unsigned __int64)(a3 & 1) << 25);
