        ...
        unsigned int a5)
{
  ...
  {
    raw_spin_lock(v8 + 13304);
  }
  else
  {
    raw_spin_lock_bh(v8 + 13304);
    *(_QWORD *)(v8 + 13312) |= 1uLL;
  }
  if ( *(_DWORD *)(v8 + 13324) > v6 )
  {
    v10 = *(_QWORD *)(*(_QWORD *)(v8 + 13136) + 8LL * v6);
    if ( v10 )
    {
      if ( *(unsigned __int8 *)(v10 + 388) <= 2u )
      {
        ...
        while ( v12 )
        {
          ...
          if ( _ZF )
          {
            ...
            if ( (v24 & 1) != 0 )
            {
              *(_QWORD *)(v8 + 13312) = v24 & 0xFFFFFFFFFFFFFFFELL;
  ...
  if ( (v11 & 1) != 0 )
  {
    *(_QWORD *)(v8 + 13312) = v11 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(v8 + 13304);
  }
  else
  {
