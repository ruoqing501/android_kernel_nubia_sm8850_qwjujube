__int64 __fastcall dp_rx_mon_dest_process(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  unsigned __int8 *v241; // [xsp+58h] [xbp-148h]
...
LABEL_248:
    qdf_trace_msg(
      ...
      697,
      a2);
    result = qdf_spin_unlock_bh_16(v237 + 32);
    goto LABEL_246;
  }
  if ( *(_BYTE *)(v18 + 804) != 1 )
  {
...
LABEL_14:
  ...
  while ( 2 )
  {
    ...
    if ( !v242 )
      goto LABEL_235;
    LOBYTE(v267[0]) = 0;
    v28 = *((_QWORD *)v240 + 12057) + 18528LL * v243;
    if ( *(_DWORD *)(v28 + 32) == 3 )
    {
LABEL_29:
      a3 = v238;
    ...
    *(_BYTE *)(v55 + 3229) = 0;
    ...
    do
    {
      ...
      else if ( v73 < *(unsigned __int16 *)(v72 + 1914) )
      {
        v76 = (_QWORD *)(v72 + 1920);
LABEL_76:
...
LABEL_80:
        ...
        if ( (v81 & 0xF0000) == 0 )
        {
          v82 = *(_QWORD *)(*(_QWORD *)(v3 + 11480) + 8LL * (unsigned __int8)BYTE1(*((_DWORD *)v268 + v79)))
              + (unsigned __int8)*((_DWORD *)v268 + v79) * (unsigned int)*(unsigned __int16 *)(v3 + 11460);
          if ( v82 )
            goto LABEL_89;
        }
LABEL_85:
