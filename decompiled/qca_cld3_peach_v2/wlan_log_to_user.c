...
LABEL_15:
    if ( (unsigned int)(a1 - 1) <= 3 )
      printk(*(&off_AD8580 + (unsigned int)(a1 - 1)), v30, a2, v12);
    goto LABEL_17;
  }
  v13 = v11;
  v14 = raw_spin_lock_irqsave((char *)&qword_826BF0 + 4);
  v15 = qword_826C70;
  v16 = v14;
  if ( !qword_826C70 )
  {
    raw_spin_unlock_irqrestore((char *)&qword_826BF0 + 4, v14);
    result = 4294967291LL;
    goto LABEL_18;
  }
  v17 = (unsigned int *)(qword_826C70 + 24);
  v18 = a3 + v13 + 2;
  v19 = 2024LL - *(unsigned int *)(qword_826C70 + 24);
  if ( v19 < v18 )
  {
  ...
  else
  {
    ...
    *(_BYTE *)(v20 + v21) = 10;
    ++*v17;
    raw_spin_unlock_irqrestore((char *)&qword_826BF0 + 4, v16);
    if ( v19 >= v18 )
      goto LABEL_14;
  }
  _X8 = &qword_826C78;
  __asm { PRFM            #0x11, [X8] }
  do
    v29 = __ldxr((unsigned __int64 *)&qword_826C78);
  while ( __stxr(v29 | 2, (unsigned __int64 *)&qword_826C78) );
