__int64 __fastcall dp_rx_defrag_waitlist_flush(__int64 a1)
{
  ...
  {
    raw_spin_lock(a1 + 13184);
    v12 = *(_QWORD *)(a1 + 13160);
    if ( v12 )
      goto LABEL_8;
    goto LABEL_15;
  }
  raw_spin_lock_bh(a1 + 13184);
  *(_QWORD *)(a1 + 13192) |= 1uLL;
  v12 = *(_QWORD *)(a1 + 13160);
  if ( !v12 )
  {
LABEL_15:
    v15 = *(_DWORD *)(a1 + 13176) + v2;
    goto LABEL_16;
  }
LABEL_8:
  while ( 1 )
...
LABEL_16:
  ...
  *(_DWORD *)(a1 + 13180) = v15;
  if ( (v18 & 1) != 0 )
  {
    *(_QWORD *)(a1 + 13192) = v18 & 0xFFFFFFFFFFFFFFFELL;
    result = raw_spin_unlock_bh(a1 + 13184);
    v20 = v47;
    if ( v47 )
      goto LABEL_18;
  }
  ...
  {
    result = raw_spin_unlock(a1 + 13184);
    v20 = v47;
    if ( v47 )
    {
LABEL_18:
