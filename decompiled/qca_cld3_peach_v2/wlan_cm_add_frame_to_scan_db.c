__int64 __fastcall wlan_cm_add_frame_to_scan_db(__int64 a1, unsigned __int8 *a2)
{
  ...
  double v102; // d6
  double v103; // d7
  int v104; // [xsp+0h] [xbp-10h] BYREF
  __int16 v105; // [xsp+4h] [xbp-Ch]
...
LABEL_35:
      ...
      wlan_objmgr_vdev_release_ref(v14, 0x4Du, v95, v96, v97, v98, v99, v100, v101, v102, v103);
      result = 16;
      goto LABEL_36;
    }
    v19 = *((_QWORD *)a2 + 1);
    ...
    {
      v23 = ie_ptr_from_eid;
      qdf_mem_copy(&v104, (const void *)(*((_QWORD *)a2 + 1) + 10LL), 6u);
      qdf_trace_msg(
        0x68u,
        8u,
      ...
      wlan_cm_set_roam_offload_bssid(v14, (unsigned __int16 *)&v104, v61, v62, v63, v64, v65, v66, v67, v68);
    }
    ...
    cm_inform_bcn_probe(v21, *((_BYTE **)a2 + 1), *((_DWORD *)a2 + 1), v85, *((_DWORD *)a2 + 4), *(_DWORD *)(v21 + 88));
    wlan_objmgr_vdev_release_ref(v14, 0x4Du, v86, v87, v88, v89, v90, v91, v92, v93, v94);
    result = 0;
  }
  else
  {
