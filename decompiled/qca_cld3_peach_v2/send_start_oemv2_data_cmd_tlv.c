        ...
        double a10)
{
  ...
  if ( a2 && *((_QWORD *)a2 + 3) )
  {
    ...
    {
      v12 = jiffies;
      if ( send_start_oemv2_data_cmd_tlv___last_ticks_162 - jiffies + 125 < 0 )
      {
        qdf_trace_msg(
          0x31u,
          2u,
        ...
        send_start_oemv2_data_cmd_tlv___last_ticks_162 = v12;
        return 16;
      }
      return 16;
    }
    ...
    {
      v16 = jiffies;
      if ( send_start_oemv2_data_cmd_tlv___last_ticks_164 - jiffies + 125 < 0 )
      {
        qdf_trace_msg(
          0x31u,
          2u,
          ...
          a10,
          "send_start_oemv2_data_cmd_tlv");
        send_start_oemv2_data_cmd_tlv___last_ticks_164 = v16;
        return 16;
      }
      return 16;
    }
    ...
    if ( v19 )
    {
      ...
      *v20 = 53608464;
      ...
      if ( (_DWORD)result )
      {
        v44 = result;
        v45 = jiffies;
        if ( send_start_oemv2_data_cmd_tlv___last_ticks_166 - jiffies + 125 < 0 )
        {
          qdf_trace_msg(
            0x31u,
            2u,
            ...
            "send_start_oemv2_data_cmd_tlv",
            (unsigned int)result);
          send_start_oemv2_data_cmd_tlv___last_ticks_166 = v45;
        }
        wmi_buf_free();
        return v44;
      }
