...
LABEL_13:
    ...
    v15 = result;
    v16 = a2;
    v17 = mac_trace_getcsr_roam_sub_state(*(_DWORD *)(result + 4 * v14 + 17268));
    qdf_trace_msg(
      0x34u,
      8u,
  ...
  if ( v10 != 5129 )
  {
    if ( v10 == 5133 )
    {
      ...
      if ( v11 <= 5 )
      {
        if ( *(_DWORD *)(result + 4 * v11 + 17268) == 4 )
...
LABEL_25:
  ...
  if ( v26 >= 6 )
    goto LABEL_25;
  if ( *(_DWORD *)(result + 4 * v26 + 17268) == 2 )
  {
    v27 = result;
    v28 = a2;
    ...
    {
      result = v27;
      if ( *(_QWORD *)(v27 + 17296) + 96LL * *((unsigned __int8 *)v28 + 4) )
        return csr_roam_complete(result, a3, a4, a5, a6, a7, a8, a9, a10);
    }
