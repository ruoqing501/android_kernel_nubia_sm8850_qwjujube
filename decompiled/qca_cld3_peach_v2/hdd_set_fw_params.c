    ...
    *((_DWORD *)v39 + 1) = v38;
    ...
    if ( !*(_DWORD *)(a1 + 40) )
    {
      if ( (unsigned int)ucfg_get_upper_brssi_thresh(*v20, &v69) )
        goto LABEL_31;
      sme_set_smps_cfg(*(unsigned __int8 *)(*(_QWORD *)(a1 + 52832) + 8LL), 3, v69);
      if ( (unsigned int)ucfg_get_lower_brssi_thresh(*v20, v68) )
        goto LABEL_31;
      sme_set_smps_cfg(*(unsigned __int8 *)(*(_QWORD *)(a1 + 52832) + 8LL), 4, v68[0]);
      if ( (unsigned int)ucfg_get_enable_dtim_1chrx(*v20, v67) )
        goto LABEL_31;
      sme_set_smps_cfg(*(unsigned __int8 *)(*(_QWORD *)(a1 + 52832) + 8LL), 5, (unsigned __int8)v67[0]);
    ...
    if ( v66[0] )
    {
      qdf_trace_msg(
        ...
        v47,
        "hdd_set_fw_params");
      v48 = sme_set_cck_tx_fir_override(v20[2], *(unsigned __int8 *)(*(_QWORD *)(a1 + 52832) + 8LL));
      if ( v48 )
      {
        v57 = v48;
    ...
    else
    {
      qdf_trace_msg(
        ...
        v47,
        "hdd_set_fw_params");
      v59 = sme_cli_set_command(*(unsigned __int8 *)(*(_QWORD *)(a1 + 52832) + 8LL), 139266, 2684354560LL, 1);
      if ( v59 )
      {
        v57 = v59;
    ...
    v60 = sme_set_enable_mem_deep_sleep(v20[2], *(unsigned __int8 *)(*(_QWORD *)(a1 + 52832) + 8LL));
    if ( !v60 )
    {
      if ( (v20[882] & 1) == 0 )
      {
        hdd_set_fw_log_params(v20, *(unsigned __int8 *)(*(_QWORD *)(a1 + 52832) + 8LL));
        *((_BYTE *)v20 + 7056) = 1;
      }
