        ...
        double a9)
{
  ...
  WORD2(v55) = 0;
  LODWORD(v55) = 0;
  qdf_trace_msg(0x33u, 8u, "%s: enter", v11, v12, v13, v14, v15, v16, v17, v18, "hdd_ndi_set_mode", v55, v56);
  if ( (hdd_is_max_ndi_count_reached(context) & 1) == 0 )
  {
    ...
    {
      if ( (unsigned int)hdd_get_random_nan_mac_addr(context, &v55) )
      {
        qdf_trace_msg(
          0x33u,
          2u,
      ...
      ucfg_dp_update_intf_mac(
        *context,
        ...
        (unsigned __int8 *)&v55,
        *(_QWORD *)(*(_QWORD *)(v29 + 52832) + 32LL));
      hdd_update_dynamic_mac((__int64)context, (const void *)(v29 + 1617), &v55, v46, v47, v48, v49, v50, v51, v52, v53);
      qdf_mem_copy((void *)(v29 + 1617), &v55, 6u);
      dev_addr_mod(*(_QWORD *)(v29 + 32), 0, &v55, 6);
    }
    v54 = *(_DWORD *)(v29 + 52800) & 0xFFFFFFFE;
    *(_DWORD *)(v29 + 40) = 11;
    *(_DWORD *)(v29 + 52800) = v54;
    qdf_trace_msg(
      0x33u,
      8u,
