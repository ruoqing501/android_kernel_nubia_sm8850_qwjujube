__int64 __fastcall hal_read32_mb_0(__int64 a1, unsigned int a2)
{
  __int64 result; // x0
  char v5; // w22
  double v6; // d0
  ...
  if ( a2 <= 0xFDF )
  {
    result = readl_7(*(_QWORD *)(a1 + 16) + a2);
    goto LABEL_20;
  }
  v5 = *(_BYTE *)(a1 + 74400);
...
LABEL_19:
  ...
  writel_6(v25, *(_QWORD *)(a1 + 16) + 12920LL);
  v26 = *(_QWORD *)(a1 + 16);
  *(_DWORD *)(a1 + 74228) = (a2 >> 19) & 0x3F;
  v27 = readl_7(v26 + 12920);
  if ( v27 != v25 )
  {
  ...
  v28 = readl_7(*(_QWORD *)(a1 + 16) + (a2 & 0x7FFFF) + 0x80000LL);
