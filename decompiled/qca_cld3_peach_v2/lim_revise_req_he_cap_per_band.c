        ...
        double a10)
{
  ...
  if ( v10 && (v11 = *(_QWORD *)(v10 + 80)) != 0 )
  {
    ...
    v16 = *(_DWORD *)(cfg_psoc_get_values(v11) + 7640);
    v17 = a1 + 23896;
    if ( wlan_reg_is_24ghz_ch_freq(*(_DWORD *)(a2 + 284)) )
    {
      v26 = *(_QWORD *)(v12 + 3417);
      v27 = (unsigned __int64 *)(v12 + 3425);
      *(_WORD *)(v12 + 3438) = *(_WORD *)(v15 + 1330);
      *(_WORD *)(v12 + 3436) = *(_WORD *)(v15 + 1328);
      v28 = (*(_DWORD *)(v15 + 1309) >> 27) & 3;
      if ( v16 < v28 )
        v28 = v16 & 3;
    ...
    {
      v32 = (_QWORD *)(v15 + 1377);
      *(_WORD *)(v12 + 3438) = *(_WORD *)(v15 + 1390);
      *(_WORD *)(v12 + 3436) = *(_WORD *)(v15 + 1388);
      v33 = (unsigned __int64 *)(v12 + 3425);
      v34 = *(_QWORD *)(v12 + 3425) & 0xFFFFFFFFC7FFFFFFLL | (((*(_QWORD *)(v15 + 1377) >> 27) & 7LL) << 27);
      *(_QWORD *)(v12 + 3425) = v34;
      v35 = (*(_DWORD *)(v15 + 1369) >> 27) & 3;
      ...
      *v36 = v38;
      if ( !v37 )
      {
        ...
        *v33 = v34;
        *v36 = v38 & 0xFFFFEFFFFFFFFFFFLL | (((*(_QWORD *)(v15 + 1369) >> 44) & 1LL) << 44);
      }
