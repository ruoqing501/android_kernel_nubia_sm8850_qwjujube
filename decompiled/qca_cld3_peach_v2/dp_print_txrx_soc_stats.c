        ...
        double a9)
{
  ...
  if ( *(_BYTE *)(result + 1120) )
  {
    ...
    DP_PRINT_STATS("Invalid release source: %u", v19, v20, v21, v22, v23, v24, v25, v26, *(unsigned int *)(v9 + 13548));
    DP_PRINT_STATS(
    ...
    DP_PRINT_STATS(
      ...
      v49,
      v50,
      *(unsigned int *)(*(_QWORD *)(v10 + 8) + 13588LL));
    DP_PRINT_STATS(
      ...
      v57,
      v58,
      *(unsigned int *)(*(_QWORD *)(v10 + 8) + 13620LL));
    ...
    for ( i = 3458; i != 3490; ++i )
    {
      if ( *(_DWORD *)(*(_QWORD *)(v10 + 8) + 4 * i) )
        result = DP_PRINT_STATS("Rxdma error number (%u): %u msdus", a2, a3, a4, a5, a6, a7, a8, a9, i - 3458);
    }
