__int64 __fastcall hdd_update_acs_timer_reason(__int64 a1, unsigned __int8 a2)
{
  ...
  _X9 = (unsigned __int64 *)(*(_QWORD *)(a1 + 52832) + 5968LL);
  __asm { PRFM            #0x11, [X9] }
  do
    v29 = __ldxr(_X9);
  while ( __stxr(v29 | 8, _X9) );
  v4 = *(_QWORD *)(a1 + 52832);
  if ( (unsigned int)qdf_mc_timer_get_current_state(v4 + 2440) == 21 )
    qdf_mc_timer_stop(v4 + 2440);
  **(_BYTE **)(v4 + 2512) = a2;
  if ( (unsigned int)qdf_mc_timer_start(v4 + 2440, 0x3E8u) )
  {
    qdf_trace_msg(
      0x33u,
      2u,
