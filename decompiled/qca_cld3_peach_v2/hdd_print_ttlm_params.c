__int64 __fastcall hdd_print_ttlm_params(
        __int64 a1,
        double a2,
        double a3,
        double a4,
        ...
        double a9)
{
  ...
  qdf_trace_msg(0x33u, 8u, "%s: Userspace TTLM mapping", a2, a3, a4, a5, a6, a7, a8, a9, "hdd_print_ttlm_params");
  if ( *(_BYTE *)(a1 + 4) == 1 )
    qdf_trace_msg(
      0x33u,
      8u,
