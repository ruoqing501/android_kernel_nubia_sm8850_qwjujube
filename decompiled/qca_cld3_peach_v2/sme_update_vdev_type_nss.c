        ...
        double a11)
{
  ...
  else
  {
    ...
    if ( a3 == 1 )
      v15 = 21594;
    v17 = (_BYTE *)(a1 + v15);
    v18 = *(_DWORD *)(v16 + 3468) & 7;
    if ( v18 >= a2 )
      v19 = a2;
    else
      v19 = v18;
    *v17 = v19;
    if ( ((*(_DWORD *)(v16 + 3468) >> 3) & 7u) >= a2 )
      v20 = a2;
    else
      v20 = (*(_DWORD *)(v16 + 3468) >> 3) & 7;
    v17[1] = v20;
    v21 = (*(_DWORD *)(v16 + 3468) >> 6) & 7;
    if ( v21 >= a2 )
      v21 = a2;
    v17[2] = v21;
    v22 = (*(_DWORD *)(v16 + 3468) >> 9) & 7;
    if ( v22 > a2 )
      LOBYTE(v22) = a2;
    v17[3] = v22;
    v23 = (*(_DWORD *)(v16 + 3468) >> 18) & 7;
    if ( v23 > a2 )
      LOBYTE(v23) = a2;
    v17[4] = v23;
    v24 = (*(_DWORD *)(v16 + 3468) >> 15) & 7;
    if ( v24 > a2 )
      LOBYTE(v24) = a2;
    v17[5] = v24;
    v25 = (*(_DWORD *)(v16 + 3468) >> 12) & 7;
    if ( v25 > a2 )
      LOBYTE(v25) = a2;
    v17[6] = v25;
    v26 = (*(_DWORD *)(v16 + 3468) >> 21) & 7;
    if ( v26 > a2 )
      LOBYTE(v26) = a2;
    v17[7] = v26;
    v27 = *(_BYTE *)(v16 + 3471) & 7;
    if ( v27 > a2 )
      LOBYTE(v27) = a2;
    v17[8] = v27;
    v28 = *(_BYTE *)(v16 + 3471) & 7;
    if ( v28 > a2 )
      LOBYTE(v28) = a2;
    v17[9] = v28;
