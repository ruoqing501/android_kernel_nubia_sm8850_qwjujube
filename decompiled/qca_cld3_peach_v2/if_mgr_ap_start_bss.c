__int64 __fastcall if_mgr_ap_start_bss(__int64 a1)
{
  ...
  if ( (*(_DWORD *)(a1 + 16) | 2) == 3 )
  {
    if ( (wlan_mlme_is_aux_emlsr_support(v2) & 1) != 0 )
      ml_nlink_conn_change_notify(v2, *(unsigned __int8 *)(a1 + 168), 10, 0);
    else
  ...
  {
    v13 = "%s: qdf wait for event failed!!";
LABEL_14:
    qdf_trace_msg(0x78u, 2u, v13, v5, v6, v7, v8, v9, v10, v11, v12, "if_mgr_ap_start_bss");
    return 16;
  }
  if ( (policy_mgr_is_chan_switch_in_progress(v2) & 1) != 0
    && (unsigned int)policy_mgr_wait_chan_switch_complete_evt(v2) )
  {
    v13 = "%s: qdf wait for csa event failed!!";
    goto LABEL_14;
  }
