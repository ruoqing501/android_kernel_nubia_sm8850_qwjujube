...
LABEL_18:
  ...
  if ( BYTE2(v3) == 1 )
  {
    ...
    if ( (unsigned int)(v32 - 9) <= 4 )
      *(_BYTE *)(*((_QWORD *)v30 + 12057) + 37093LL) = 1;
    v61 = a2[4];
    qdf_trace_msg(
      0x45u,
      1u,
...
LABEL_127:
      ...
      v134 += 80;
      v102 = v135;
      if ( v133 >= *(unsigned __int8 *)(v132 + 7201) )
        goto LABEL_145;
      continue;
    }
    break;
...
LABEL_145:
  ...
  while ( 2 )
  {
    if ( v135 > 0x40 )
      goto LABEL_348;
    v145 = *((_QWORD *)v30 + 1);
    if ( !v145 || (v146 = (__int64 *)(v145 + v144 + 7368), v145 + v144 == -7368) )
    {
LABEL_147:
      v144 += 80;
      if ( v144 == 400 )
...
LABEL_255:
      ...
      if ( (*(_BYTE *)(v70 + 20120) & 1) != 0 || !*(_BYTE *)(*(_QWORD *)(v70 + 40) + 804LL) )
        goto LABEL_350;
      v282 = *((_QWORD *)v30 + 1);
      v283 = *v30;
...
LABEL_350:
          *(_DWORD *)(v342 + 4) = v176;
          ...
          {
            raw_spin_lock(v30 + 96424);
            v321 = v343;
          }
          else
          {
            raw_spin_lock_bh(v30 + 96424);
            v321 = v343;
            *((_QWORD *)v343 + 278) |= 1uLL;
          }
          *(_DWORD *)v342 = *((_DWORD *)v321 + 552);
          v322 = v321[2212];
          if ( v322 >= 0x10 )
          {
            v323 = *((_QWORD *)v321 + 279);
            if ( v323 )
            {
            ...
            else
            {
              v330 = printk(
                       ...
                       "../vendor/qcom/opensource/wlan/qcacld-3.0/cmn/dp/wifi3.0/dp_internal.h");
              dump_stack(v330);
              LOBYTE(v322) = v321[2212];
            }
          }
          v321[2212] = v322 + 1;
          *(_QWORD *)(v342 + 1288) = 0;
          v327 = *((__int64 **)v321 + 280);
          *(_QWORD *)(v342 + 1296) = v327;
          *v327 = v342;
          v328 = *((_DWORD *)v321 + 552);
          v329 = *((_QWORD *)v321 + 278);
          *((_QWORD *)v321 + 280) = v342 + 1288;
          *((_DWORD *)v321 + 552) = v328 + 1;
          if ( (v329 & 1) != 0 )
          {
            *((_QWORD *)v321 + 278) = v329 & 0xFFFFFFFFFFFFFFFELL;
            raw_spin_unlock_bh(v30 + 96424);
          }
          else
          {
            raw_spin_unlock(v30 + 96424);
          }
          return (unsigned int *)queue_work_on(32, *((_QWORD *)v321 + 275), v30 + 96360);
        }
      }
LABEL_349:
      v311 = printk(
