__int64 __fastcall csr_continue_peer_disconnect_after_get_stats(__int64 a1)
{
  ...
  v14 = v11 + 4096;
  v15 = *(unsigned __int8 *)(v11 + 7656);
  active_cmd = wlan_serialization_get_active_cmd(*(_QWORD *)(a1 + 21624), v15, 3u, v3, v4, v5, v6, v7, v8, v9, v10);
  if ( !active_cmd )
  {
    ...
    if ( !active_cmd )
    {
      ...
      if ( !active_cmd )
      {
        qdf_trace_msg(
          ...
          v24,
          "csr_continue_peer_disconnect_after_get_stats");
        return sme_release_global_lock(a1 + 12840);
      }
    }
  }
  _X9 = (unsigned int *)(v14 + 3564);
  __asm { PRFM            #0x11, [X9] }
  do
  {
    v52 = __ldxr(_X9);
