__int64 __fastcall dp_print_rx_soc_fw_refill_ring_empty_tlv_v(unsigned int *a1)
{
  unsigned int v2; // w21
  __int64 v3; // x0
  double v4; // d0
  ...
  v2 = *a1;
  v3 = _qdf_mem_malloc(0x3E8u, "dp_print_rx_soc_fw_refill_ring_empty_tlv_v", 4161);
  if ( !v3 )
    return qdf_trace_msg(
             ...
             v10,
             v11,
             "dp_print_rx_soc_fw_refill_ring_empty_tlv_v");
  v12 = (char *)v3;
  v13 = (v2 >> 14) & 0x3FF;
  DP_PRINT_STATS("HTT_RX_SOC_FW_REFILL_RING_EMPTY_TLV_V:", v4, v5, v6, v7, v8, v9, v10, v11);
  if ( v13 )
  {
