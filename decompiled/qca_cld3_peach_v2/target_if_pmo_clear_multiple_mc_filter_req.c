__int64 __fastcall target_if_pmo_clear_multiple_mc_filter_req(
        __int64 a1,
        __int64 a2,
        double a3,
        double a4,
...
LABEL_12:
    qdf_trace_msg(0x49u, 2u, v43, a3, a4, a5, a6, a7, a8, a9, a10, "target_if_pmo_clear_multiple_mc_filter_req");
    return 4;
  }
  v13 = (_DWORD *)_qdf_mem_malloc(0x5A8u, "target_if_pmo_clear_multiple_mc_filter_req", 190);
  if ( !v13 )
  {
    qdf_trace_msg(
      0x49u,
