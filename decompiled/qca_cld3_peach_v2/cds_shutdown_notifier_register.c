__int64 __fastcall cds_shutdown_notifier_register(__int64 a1, __int64 a2)
{
  ...
  else
  {
    v5[2] = a1;
    v5[3] = a2;
    v8 = (__int64 **)qword_8D5790;
    if ( v5 == &shutdown_notifier_head
      || (__int64 *)qword_8D5790 == v5
      || *(__int64 **)qword_8D5790 != &shutdown_notifier_head )
    {
      _list_add_valid_or_report(v5, qword_8D5790);
    }
    else
    {
      qword_8D5790 = (__int64)v5;
