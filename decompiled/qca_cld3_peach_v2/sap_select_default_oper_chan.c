...
LABEL_23:
          ...
          qdf_trace_msg(
            ...
            v22);
LABEL_29:
          v23 = wlan_ll_lt_sap_override_freq(a1[2703], *(unsigned __int8 *)(a2 + 12), v17);
          if ( (unsigned int)policy_mgr_mode_specific_connection_count(a1[2703], 5, nullptr)
            && (wlan_nan_is_sta_sap_nan_allowed(a1[2703]) & 1) != 0 )
          {
            return wlan_nan_sap_override_freq(a1[2703], *(unsigned __int8 *)(a2 + 12), v23);
          }
          else
          {
            return v23;
