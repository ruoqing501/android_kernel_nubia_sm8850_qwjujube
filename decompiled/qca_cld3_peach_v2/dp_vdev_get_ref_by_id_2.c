__int64 __fastcall dp_vdev_get_ref_by_id_2(__int64 a1, unsigned __int8 a2)
{
  ...
  if ( a2 <= 5u )
  {
    ...
    if ( v5 )
    {
      ...
      while ( v6 )
      {
        ...
        if ( _ZF )
        {
          ...
          if ( (v19 & 1) != 0 )
          {
            *(_QWORD *)(a1 + 18992) = v19 & 0xFFFFFFFFFFFFFFFELL;
    ...
    if ( (v15 & 1) != 0 )
    {
      *(_QWORD *)(a1 + 18992) = v15 & 0xFFFFFFFFFFFFFFFELL;
      raw_spin_unlock_bh(a1 + 18984);
    }
    else
    {
