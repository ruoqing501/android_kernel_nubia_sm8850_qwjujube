        ...
        double a10)
{
  ...
  *(_BYTE *)(a1 + 684) = a2;
  ...
  if ( a2 )
  {
    result = qdf_get_time_of_the_day_in_hr_min_sec_usec(a1 + 892, 24);
    if ( ((*(_BYTE *)(a1 + 693) & 1) != 0 || !*(_DWORD *)(a1 + 680)) && (*(_DWORD *)(*(_QWORD *)a1 + 40LL) | 2) == 2 )
    {
  ...
  {
    result = (__int64)qdf_mem_set((void *)(a1 + 892), 0x18u, 0);
  }
