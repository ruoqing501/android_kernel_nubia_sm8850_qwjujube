__int64 __fastcall wlan_green_ap_start(
        __int64 a1,
        double a2,
        double a3,
        double a4,
        ...
        double a9)
{
  ...
  if ( a1 )
  {
    ...
    if ( comp_private_obj )
    {
      ...
      else if ( *(_DWORD *)(v18 + 24) == 1 && *(_BYTE *)(v18 + 8) )
      {
        v38 = *(_QWORD *)(v18 + 96);
        if ( (v38 & 1) != 0 )
        {
        ...
        return wlan_green_ap_state_mc((__int64 *)v18, 1u, v39, v40, v41, v42, v43, v44, v45, v46);
      }
      else
      {
        v47 = *(_QWORD *)(v18 + 96);
        if ( (v47 & 1) != 0 )
        {
          *(_QWORD *)(v18 + 96) = v47 & 0xFFFFFFFFFFFFFFFELL;
          raw_spin_unlock_bh(v18 + 88);
        }
        else
        {
  ...
  {
    qdf_trace_msg(0x5Du, 2u, "%s: pdev context passed is NULL", a2, a3, a4, a5, a6, a7, a8, a9, "wlan_green_ap_start");
    return 4;
  }
}
