__int64 __fastcall wma_process_update_opmode(__int64 *a1, unsigned int *a2)
{
  ...
  {
    raw_spin_lock(peer + 96);
    v24 = *(_QWORD *)(v13 + 776);
    v25 = *(_DWORD *)(v13 + 72);
    if ( (v24 & 1) == 0 )
    {
LABEL_9:
      raw_spin_unlock(v13 + 768);
      goto LABEL_10;
    }
  }
  else
  {
    raw_spin_lock_bh(peer + 96);
    v24 = *(_QWORD *)(v13 + 776) | 1LL;
    *(_QWORD *)(v13 + 776) = v24;
    v25 = *(_DWORD *)(v13 + 72);
    if ( (v24 & 1) == 0 )
      goto LABEL_9;
  }
  *(_QWORD *)(v13 + 776) = v24 & 0xFFFFFFFFFFFFFFFELL;
  raw_spin_unlock_bh(v13 + 768);
LABEL_10:
  ...
  if ( ch_width_from_phy_mode < v36 )
  {
    ...
    if ( v54 )
    {
      ...
      if ( v56 - 6 >= 0xFFFFFFFE )
      {
        v66 = *(unsigned __int16 **)(*(_QWORD *)(v13 + 96) + 40LL);
...
LABEL_19:
          ...
          {
            raw_spin_lock_bh(v13 + 768);
            v68 = *(_QWORD *)(v13 + 776) | 1LL;
            *(_QWORD *)(v13 + 776) = v68;
            v69 = *(_DWORD *)(v13 + 72);
            if ( (v68 & 1) == 0 )
              goto LABEL_18;
          }
          *(_QWORD *)(v13 + 776) = v68 & 0xFFFFFFFFFFFFFFFELL;
          raw_spin_unlock_bh(v13 + 768);
          goto LABEL_19;
        }
      }
