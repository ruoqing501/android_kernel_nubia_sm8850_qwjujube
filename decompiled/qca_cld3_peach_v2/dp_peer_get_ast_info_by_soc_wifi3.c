__int64 __fastcall dp_peer_get_ast_info_by_soc_wifi3(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( *(_DWORD *)(a1 + 13324) > v9 )
  {
    v11 = *(_QWORD *)(*(_QWORD *)(a1 + 13136) + 8LL * v9);
    if ( !v11 )
      goto LABEL_17;
...
LABEL_33:
    ...
    if ( (v32 & 1) != 0 )
    {
      *(_QWORD *)(a1 + 17640) = v32 & 0xFFFFFFFFFFFFFFFELL;
...
LABEL_19:
  ...
  *(_WORD *)(a3 + 14) = *(_WORD *)(v8 + 2);
  ...
  if ( (v21 & 1) != 0 )
  {
    *(_QWORD *)(a1 + 17640) = v21 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(a1 + 17632);
  }
  else
  {
