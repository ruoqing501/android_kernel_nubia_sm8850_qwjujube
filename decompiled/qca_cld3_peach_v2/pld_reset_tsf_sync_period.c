__int64 __fastcall pld_reset_tsf_sync_period(__int64 a1)
{
  __int64 v2; // x20
  __int64 v3; // x0
  __int64 v4; // x21
  ...
  if ( a1 && pld_ctx )
  {
    ...
    do
    {
      ...
      if ( v4 == v2 + 16 )
      {
        ...
        return printk(&unk_9C3340, "pld_reset_tsf_sync_period", 2895, v6);
      }
    }
    ...
    if ( (unsigned int)(v7 - 1) >= 7 )
    {
      if ( v7 )
        return printk(&unk_9C3340, "pld_reset_tsf_sync_period", 2895, v6);
      return cnss_reset_time_sync_period(a1);
    }
  }
  else
  {
