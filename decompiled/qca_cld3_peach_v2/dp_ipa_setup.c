        ...
        unsigned int a15)
{
  ...
  *(_BYTE *)(v20 + 857) = 1;
  if ( (a11 & 1) != 0 )
  {
    ...
    *(_DWORD *)(v22 + 192) = v23;
LABEL_30:
    qdf_mem_copy((void *)(v22 + 200), (const void *)(a1 + 18320), 0x10u);
    *(_DWORD *)(v22 + 216) = *(_QWORD *)(a1 + 18296);
    *(_QWORD *)(v22 + 224) = *(_QWORD *)(a1 + 18104);
    *(_BYTE *)(v22 + 232) = (unsigned int)pld_get_pci_slot(*(_QWORD *)(*(_QWORD *)(a1 + 24) + 40LL)) == 0;
    qdf_mem_copy((void *)(v22 + 240), (const void *)(a1 + 18248), 0x10u);
    *(_DWORD *)(v22 + 256) = *(_QWORD *)(a1 + 18224);
    *(_QWORD *)(v22 + 264) = *(_QWORD *)(a1 + 18064);
    *(_BYTE *)(v22 + 272) = (unsigned int)pld_get_pci_slot(*(_QWORD *)(*(_QWORD *)(a1 + 24) + 40LL)) == 0;
    v39 = *(_DWORD *)(a1 + 18272);
    *(_WORD *)(v22 + 276) = 0;
    *(_WORD *)(v22 + 274) = v39;
    v40 = *(__int64 (__fastcall **)(_QWORD))(a1 + 1696);
    if ( v40 )
    {
  ...
  *(_DWORD *)(v21 + 192) = v25;
  if ( *(_BYTE *)(*(_QWORD *)(a1 + 24) + 608LL) )
    ...
    v26 = 0;
  *(_QWORD *)(v21 + 200) = *(_QWORD *)(a1 + v26 + 18280);
  *(_DWORD *)(v21 + 208) = *(_QWORD *)(a1 + 18296);
  *(_QWORD *)(v21 + 216) = *(_QWORD *)(a1 + 18104);
  *(_BYTE *)(v21 + 224) = (unsigned int)pld_get_pci_slot(*(_QWORD *)(*(_QWORD *)(a1 + 24) + 40LL)) == 0;
  if ( *(_BYTE *)(*(_QWORD *)(a1 + 24) + 608LL) )
    v27 = 8;
  else
    v27 = 0;
  *(_QWORD *)(v21 + 232) = *(_QWORD *)(a1 + 18208 + v27);
  *(_DWORD *)(v21 + 240) = *(_QWORD *)(a1 + 18224);
  *(_QWORD *)(v21 + 248) = *(_QWORD *)(a1 + 18064);
  *(_BYTE *)(v21 + 256) = (unsigned int)pld_get_pci_slot(*(_QWORD *)(*(_QWORD *)(a1 + 24) + 40LL)) == 0;
  v28 = *(_DWORD *)(a1 + 18272);
  *(_WORD *)(v21 + 260) = 0;
  *(_WORD *)(v21 + 258) = v28;
  v29 = *(__int64 (__fastcall **)(_QWORD))(a1 + 1696);
  if ( v29 )
  {
...
LABEL_34:
  ...
  *(_BYTE *)(v20 + 1273) = 1;
  if ( (a11 & 1) == 0 )
  {
    ...
    *(_DWORD *)(v51 + 192) = v55;
    if ( *(_BYTE *)(*(_QWORD *)(a1 + 24) + 608LL) )
      ...
      v56 = 0;
    *(_QWORD *)(v51 + 200) = *(_QWORD *)(a1 + v56 + 18344);
    *(_DWORD *)(v51 + 208) = *(_QWORD *)(a1 + 18360);
    *(_QWORD *)(v51 + 216) = *(_QWORD *)(a1 + 18160);
    *(_BYTE *)(v51 + 224) = (unsigned int)pld_get_pci_slot(*(_QWORD *)(*(_QWORD *)(a1 + 24) + 40LL)) == 0;
    if ( *(_BYTE *)(*(_QWORD *)(a1 + 24) + 608LL) )
      v57 = 8;
    else
      v57 = 0;
    *(_QWORD *)(v51 + 232) = *(_QWORD *)(a1 + v57 + 18408);
    *(_DWORD *)(v51 + 240) = *(_QWORD *)(a1 + 18424);
    v58 = *(_QWORD *)(a1 + 18192);
    *(_BYTE *)(v51 + 256) = 0;
    *(_QWORD *)(v51 + 248) = v58;
  ...
  if ( a15 <= 2 )
  {
    v54 = dword_B2D774[a15];
LABEL_57:
    *(_DWORD *)(v52 + 192) = v54;
  }
  qdf_mem_copy((void *)(v52 + 200), (const void *)(a1 + 18384), 0x10u);
  *(_DWORD *)(v52 + 216) = *(_QWORD *)(a1 + 18360);
  *(_QWORD *)(v52 + 224) = *(_QWORD *)(a1 + 18160);
  *(_BYTE *)(v52 + 232) = (unsigned int)pld_get_pci_slot(*(_QWORD *)(*(_QWORD *)(a1 + 24) + 40LL)) == 0;
  qdf_mem_copy((void *)(v52 + 240), (const void *)(a1 + 18448), 0x10u);
  *(_DWORD *)(v52 + 256) = *(_QWORD *)(a1 + 18424);
  v59 = *(_QWORD *)(a1 + 18192);
  *(_BYTE *)(v52 + 272) = 0;
  *(_QWORD *)(v52 + 264) = v59;
