...
LABEL_14:
  ...
  v20 = context;
  v21 = *(unsigned __int8 *)(context[1] + 5936LL);
  wlm_multi_client_ll_caps = wlan_mlme_get_wlm_multi_client_ll_caps(context[2703]);
  qdf_trace_msg(
    0x36u,
    8u,
  ...
  qdf_trace_msg(
    ...
    "wma_latency_level_event_handler",
    v37);
  v34 = (void (__fastcall *)(__int64 *, __int64))v20[1833];
