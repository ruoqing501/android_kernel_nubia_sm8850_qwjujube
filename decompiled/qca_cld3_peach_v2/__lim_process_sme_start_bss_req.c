__int64 __fastcall _lim_process_sme_start_bss_req(__int64 a1, __int64 a2)
{
  ...
  double v162; // d6
  double v163; // d7
  _BYTE v164[4]; // [xsp+Ch] [xbp-14h] BYREF
  int v165; // [xsp+10h] [xbp-10h] BYREF
  __int16 v166; // [xsp+14h] [xbp-Ch]
  __int64 v167; // [xsp+18h] [xbp-8h]
  ...
  if ( v4 )
  {
    ...
    v6 = *v5;
    opmode_from_vdev_id = wlan_get_opmode_from_vdev_id(*(_QWORD *)(a1 + 21632), *v5);
    if ( opmode_from_vdev_id == 11 )
      v8 = 4;
    else
      v8 = 1;
    wlan_mlme_get_mac_vdev_id(*(_QWORD *)(a1 + 21632), v6, &v165);
    ...
    v25 = wlan_reg_freq_to_chan(*(_QWORD *)(a1 + 21632), *((_DWORD *)v5 + 92), v17, v18, v19, v20, v21, v22, v23, v24);
    if ( pe_find_session_by_bssid(a1, &v165, v164) )
    {
      qdf_trace_msg(
        0x35u,
        3u,
...
LABEL_13:
    ...
    *(_DWORD *)(v45 + 284) = v55;
    ...
    {
      v58 = cmpt_obj;
      if ( (policy_mgr_is_dbs_enable(*(_QWORD *)(a1 + 21624)) & 1) != 0 )
      {
        v67 = *(_DWORD *)(v58 + 48);
      }
      else
      {
        ...
        v69 = *(_DWORD *)(v58 + 48);
        v70 = *(_DWORD *)(v58 + 60);
        if ( (*(_WORD *)(*(_QWORD *)(a1 + 8) + 1288LL) & 1) != 0 && (wma_is_rx_ldpc_supported_for_channel(v68) & 1) != 0 )
        {
          v67 = v69 | 0x10;
          qdf_trace_msg(
            0x34u,
      ...
      v72 = *(_QWORD *)(a1 + 8);
      if ( *(_BYTE *)(v72 + 2827) == 1 )
        v73 = *(unsigned __int8 *)(v72 + 2879) << 12;
      else
        v73 = 0;
      v74 = *(_DWORD *)(v45 + 284);
    ...
    v86 = v165;
    *(_BYTE *)(v45 + 31) = BYTE1(v165);
    v87 = BYTE2(v165);
    *(_BYTE *)(v45 + 30) = v86;
    *(_WORD *)(v45 + 32) = __PAIR16__(HIBYTE(v165), v87);
    *(_WORD *)(v45 + 34) = v166;
...
LABEL_48:
        ...
        if ( (param & 0x669E) == 0 )
          v106 = 0;
        *(_BYTE *)(*(_QWORD *)(a1 + 8) + 5602LL) = v106;
        v107 = (param & 0x669E) != 0;
        if ( !v103 )
          v107 = 0;
        if ( v104 )
          v107 = 1;
        *(_BYTE *)(*(_QWORD *)(a1 + 8) + 5652LL) = v107;
        *(_BYTE *)(*(_QWORD *)(a1 + 8) + 5656LL) = 0;
        v108 = *(_DWORD *)(v45 + 284);
        v46[261] = *(_BYTE *)(a1 + 17229);
        ...
        v46[1628] = v112;
        v46[1611] = v112;
        if ( !*(_BYTE *)(*(_QWORD *)(a1 + 8) + 2871LL) || policy_mgr_is_vdev_ll_lt_sap(*(_QWORD *)(a1 + 21624), v6) )
          v46[1611] = 1;
...
LABEL_75:
            v128 = *(unsigned __int8 *)(v45 + 154);
            if ( v128 <= 0xD && ((1 << v128) & 0x3001) != 0 )
            {
              lim_update_session_eht_capable(v45, 1);
              lim_copy_bss_eht_cap(v45);
            }
            else
            {
              lim_strip_eht_ies_from_add_ies(a1, v45);
            }
            v129 = *(_QWORD *)(v45 + 16);
            v46[212] = *(_BYTE *)(*(_QWORD *)(a1 + 8) + 1303LL);
            *v46 = ((unsigned int)wlan_crypto_get_param(v129, 5u) >> 3) & 0x10 | *v46 & 0xEF;
            qdf_mem_copy((void *)(v45 + 252), v5 + 384, 0xDu);
            qdf_mem_copy((void *)(v45 + 265), v5 + 397, 0xDu);
            if ( opmode_from_vdev_id == 11 )
              goto LABEL_83;
            v130 = _qdf_mem_malloc(8LL * *(unsigned __int16 *)(v45 + 376), "__lim_handle_sme_start_bss_request", 1122);
            *(_QWORD *)(v45 + 384) = v130;
            if ( !v130 )
            {
              v140 = 0;
...
LABEL_115:
            ...
            {
LABEL_83:
              if ( *(_BYTE *)(a1 + 17230) == 1 && !policy_mgr_is_vdev_ll_lt_sap(*(_QWORD *)(a1 + 21624), v6) )
                v139 = *(_BYTE *)(v45 + 155);
              else
                v139 = v5[375] != 0;
              *(_BYTE *)(v45 + 160) = v139;
              ...
              v142 = v5[375];
              *(_DWORD *)(v45 + 164) = v142;
              *(_BYTE *)(v45 + 161) = v142 != 0;
              if ( (v141 & 1) != 0 || (v46[3047] & 1) != 0 || v46[146] || *(_BYTE *)(v45 + 155) )
              {
                *(_DWORD *)(v45 + 7176) = v5[372];
                v46[150] = v5[373];
                v46[162] = v5[374];
                lim_update_he_bw_cap_mcs(v45, 0);
                lim_update_eht_bw_cap_mcs(v45, 0);
              }
              ...
              v144 = (_BYTE *)_qdf_mem_malloc(1u, "__lim_handle_sme_start_bss_request", 1175);
              v140 = (__int64)v144;
              if ( v144 )
              {
                *v144 = *(_BYTE *)(v45 + 8);
                ...
                *(_DWORD *)(v45 + 168) = rf_band;
                if ( !rf_band )
                  goto LABEL_103;
                v146 = *(unsigned __int8 *)(*(_QWORD *)(a1 + 8) + 1061LL);
                *(_DWORD *)(v45 + 7028) = v146;
                if ( v146 == 1 && *(_DWORD *)(v45 + 92) == 1 )
                {
                  v146 = *(unsigned __int8 *)(*(_QWORD *)(a1 + 8) + 3368LL);
                  *(_DWORD *)(v45 + 7028) = v146;
                }
                if ( !v146 )
LABEL_103:
                  *(_BYTE *)(*(_QWORD *)(a1 + 8) + 4627LL) = 0;
                v147 = *(_DWORD *)(v45 + 80);
                *(_DWORD *)(v45 + 80) = 14;
                *(_DWORD *)(v45 + 84) = v147;
                lim_dump_session_info(a1, v45);
                lim_dump_he_info(a1, v45);
                lim_dump_eht_info(v45);
...
LABEL_114:
          ...
          if ( policy_mgr_is_vdev_ll_lt_sap(*(_QWORD *)(a1 + 21624), *(unsigned __int8 *)(v45 + 10)) )
          {
            qdf_trace_msg(
              0x35u,
              8u,
