        ...
        double a11)
{
  ...
  qdf_trace_msg(
    ...
    v37,
    "sap_get_freq_list",
    *(unsigned int *)(*(_QWORD *)(a1 + 1544) + 8LL),
    *(unsigned int *)(*(_QWORD *)(a1 + 1544) + 12LL),
    v28,
    *(unsigned int *)(*(_QWORD *)(a1 + 1544) + 4LL),
    v161,
    v159,
    v160,
    v158);
  v38 = *(unsigned __int8 *)(v29[1] + 3408LL);
      ...
      || !sap_dfs_is_channel_in_nol_list(a1, v56, 0, v88, v89, v90, v91, v92, v93, v94, v95) )
    {
      ...
      if ( (wlan_reg_is_dsrc_freq() & 1) == 0
        && (wlansap_is_channel_present_in_acs_list(
              v56,
              *(_QWORD *)(*(_QWORD *)(a1 + 1544) + 16LL),
              *(unsigned __int8 *)(*(_QWORD *)(a1 + 1544) + 24LL))
          & 1) != 0 )
      {
        v96 = v29[2704];
        ...
        if ( (wlan_reg_is_dfs_in_secondary_list_for_freq(v96, v97, v98, v99, v100, v101, v102, v103, v104, v105) & 1) != 0 )
        {
          ...
          if ( (policy_mgr_disallow_mcc(v106, v107) & 1) != 0 )
            goto LABEL_20;
          v151 = *(unsigned __int8 *)(v29[1] + 5588LL);
          v152 = 1;
        }
        wlan_mlme_get_srd_master_mode_for_vdev(v29[2703], *(_DWORD *)(*(_QWORD *)(a1 + 16) + 16LL), &v157);
        if ( v157
          || (v108 = v29[2704],
              ...
              (wlan_reg_is_etsi_srd_chan_for_freq(v108, v109, v110, v111, v112, v113, v114, v115, v116, v117) & 1) == 0) )
        {
          ...
          if ( *(_WORD *)(v118 + 5584) )
          {
            ...
            while ( *(unsigned __int16 *)(v118 + 5584) > (unsigned int)v119 );
          }
          if ( *(_WORD *)(v118 + 5460) )
          {
            v122 = 0;
            ...
            while ( *(unsigned __int16 *)(v29[1] + 5460LL) > (unsigned int)v122 );
          }
          if ( (v152 & 1) == 0 || v151 )
          {
...
LABEL_62:
  ...
  if ( v45 )
  {
    ...
    *v148 = v40;
    do
    {
      *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 1544) + 16LL) + v135) = *(_DWORD *)(v40 + v135);
      v135 += 4;
    }
    while ( 4LL * v45 != v135 );
    *(_BYTE *)(*(_QWORD *)(a1 + 1544) + 24LL) = v45;
    sap_dump_acs_channel(*(_QWORD *)(a1 + 1544));
  }
  else
  {
    qdf_trace_msg(
