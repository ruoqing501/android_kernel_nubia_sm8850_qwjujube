  ...
  if ( tso_num_seg )
  {
    ...
    while ( 1 )
    {
      if ( *(unsigned __int8 *)(a3 + 4) >= 6uLL )
        goto LABEL_41;
      v3 = v7 + 4896 + 72LL * *(unsigned __int8 *)(a3 + 4);
          ...
          if ( v61 )
          {
            ...
            if ( v62 )
            {
              if ( (*(_BYTE *)(a2 + 68) & 4) != 0 )
                ...
                v63 = 0;
              *(_QWORD *)(v62 + 92264) += (unsigned int)(*(_DWORD *)(a2 + 112) + v63);
            }
          }
          goto LABEL_38;
        }
...
LABEL_42:
  ...
  {
    raw_spin_lock(v29 + 5384);
    v31 = *(_QWORD **)(v29 + 5336);
    if ( !v31 )
      goto LABEL_23;
    goto LABEL_22;
  }
  raw_spin_lock_bh(v29 + 5384);
  *(_QWORD *)(v29 + 5392) |= 1uLL;
  v31 = *(_QWORD **)(v29 + 5336);
  if ( v31 )
  {
LABEL_22:
...
LABEL_23:
  ...
  if ( (v32 & 1) != 0 )
  {
    *(_QWORD *)(v29 + 5392) = v32 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(v29 + 5384);
    v3 = a2;
    if ( v31 )
      goto LABEL_25;
  }
