__int64 __fastcall tgt_vdev_mgr_stop_response_handler(
        __int64 a1,
        unsigned __int8 *a2,
        double a3,
        double a4,
        ...
        double a10)
{
  ...
  if ( !a1 || !a2 )
  {
    qdf_trace_msg(0x68u, 2u, "%s: Invalid input", a3, a4, a5, a6, a7, a8, a9, a10, "tgt_vdev_mgr_stop_response_handler");
    return 4;
  }
  ...
  if ( cmpt_obj )
  {
    v31 = *(_QWORD *)(cmpt_obj + 528);
    if ( v31 )
    {
      v31 = *(_QWORD *)(v31 + 144);
      if ( v31 )
      {
        if ( *(_DWORD *)(v31 - 4) != 652336743 )
          __break(0x8228u);
