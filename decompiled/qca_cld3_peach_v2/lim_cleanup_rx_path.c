        ...
        double a12)
{
  ...
  *v17 = 0;
  ...
  if ( *((_DWORD *)a2 + 2) != 15
    || (lim_deactivate_and_change_per_sta_id_timer(a1, 8, (unsigned __int16)a2[174]), (a2[16] & 2) != 0) )
  {
    lim_admit_control_delete_sta(a1, a2[174], v18, v19, v20, v21, v22, v23, v24, v25);
    v35 = *a2;
    v42 = 0;
    v43 = 0;
    v40 = 0;
...
LABEL_16:
  ...
  else
  {
    if ( *(_DWORD *)(a3 + 88) == 1 )
      ...
      lim_delete_dph_hash_entry(a1, a2 + 175, (unsigned __int16)a2[174], a3);
    result = 0;
  }
