        ...
        double a11)
{
  ...
  if ( a2 <= 5u )
  {
      ...
      while ( v17 )
      {
        ...
        if ( _ZF )
        {
          ...
          *(_BYTE *)(v16 + 62) = a3;
          ...
          {
            v42 = *(_QWORD *)(v16 + 24);
            if ( v42 && a3 <= 1u && (v43 = *(_QWORD *)(v42 + 96456)) != 0 )
            {
              v44 = v43 + 18528LL * a3;
              ...
              *(_QWORD *)(v44 + 16) = v16;
              *(_BYTE *)(v44 + 8) = v45;
              v46 = *(unsigned int *)(*(_QWORD *)(v16 + 43520) + 16LL);
              *(_DWORD *)(v44 + 32) = v46;
              *(_DWORD *)(v44 + 28) = *(_DWORD *)(*(_QWORD *)(v16 + 43520) + 12LL);
              *(_DWORD *)(v44 + 24) = *(_DWORD *)(*(_QWORD *)(v16 + 43520) + 8LL);
              ...
              *(_BYTE *)(*(_QWORD *)(v16 + 43520) + 20LL) = *(_BYTE *)(v16 + 62);
              qdf_trace_msg(
                0x45u,
                5u,
    ...
    if ( (v47 & 1) != 0 )
    {
      *(_QWORD *)(a1 + 18992) = v47 & 0xFFFFFFFFFFFFFFFELL;
      raw_spin_unlock_bh(a1 + 18984);
    }
    else
    {
