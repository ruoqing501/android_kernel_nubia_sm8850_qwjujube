...
LABEL_351:
  ...
  comp_private_obj = wlan_objmgr_psoc_get_comp_private_obj(*(_QWORD *)(*(_QWORD *)(*v9 + 216LL) + 80LL), 3u);
  if ( !comp_private_obj )
  {
    qdf_trace_msg(
      0x15u,
...
LABEL_187:
  qdf_trace_msg(
    ...
    "scm_scan_req_update_params",
    *((unsigned int *)v9 + 518));
  v101 = *(unsigned __int8 *)(*(_QWORD *)(v28 + 216) + 40LL);
...
LABEL_350:
  ...
  if ( *(_BYTE *)(v247 + 2482) == 1 )
    LODWORD(v253) = 0;
  qdf_mtrace(21, 76, 0, *(_BYTE *)(v201 + 168), v199);
