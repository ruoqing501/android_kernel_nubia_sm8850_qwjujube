__int64 __fastcall wlan_dp_lapb_handle_frame(__int64 result, __int64 a2, _DWORD *a3, __int64 a4)
{
  ...
  if ( (v4 & 0xF000000) == 0xB000000 )
  {
    ...
    if ( (v4 & 0x10000000) != 0 )
    {
      ...
      {
        if ( (*(_BYTE *)(result + 19928) & 1) != 0 && *(_QWORD *)(*(_QWORD *)(result + 19920) + 24LL) != v10 )
        {
          v11 = a3;
          result = hrtimer_cancel(result + 19872);
          a3 = v11;
        }
        *a3 = 1;
      }
    ...
    else
    {
      ...
      *(_DWORD *)(StatusReg + 16) += 512;
      ...
      {
        if ( (*(_BYTE *)(v5 + 3544) & 1) == 0 || (result = _hrtimer_get_remaining(v17, 0), result / 1000000 > v14) )
        {
          if ( *(_DWORD *)(v5 + 3552) == 1 )
            v18 = 5;
          else
