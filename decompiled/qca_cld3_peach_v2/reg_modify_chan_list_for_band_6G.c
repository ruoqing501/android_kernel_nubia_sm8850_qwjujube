unsigned __int16 *__fastcall reg_modify_chan_list_for_band_6G(
        __int64 a1,
        __int64 a2,
        double a3,
        double a4,
        ...
        double a10)
{
  ...
  unsigned int chan_enum_for_freq; // w21
  ...
  {
    result = (unsigned __int16 *)_qdf_mem_malloc(4u, "reg_modify_inactive_6g_channels", 881);
    if ( result )
    {
      v21 = result;
      ...
      if ( *v21 && v21[1] )
      {
        chan_enum_for_freq = reg_get_chan_enum_for_freq(*v21);
        v23 = reg_get_chan_enum_for_freq(v21[1]);
      }
      else
      {
      ...
      for ( i = 42; i != 102; ++i )
      {
        if ( chan_enum_for_freq > 0x65 || i > v23 || v23 > 0x65 || i < chan_enum_for_freq )
        {
          v38 = *v36 | 1;
          *(v36 - 1) = 0;
          *v36 = v38;
