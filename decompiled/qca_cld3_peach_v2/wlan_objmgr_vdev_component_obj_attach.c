__int64 __fastcall wlan_objmgr_vdev_component_obj_attach(__int64 a1, unsigned int a2, __int64 a3, int a4)
{
  ...
  if ( !*(_QWORD *)(a1 + 688 + 8LL * a2) )
  {
    *(_QWORD *)(a1 + 688 + 8LL * a2) = a3;
    *(_DWORD *)(a1 + 4LL * a2 + 1120) = a4;
    v11 = *(_QWORD *)(a1 + 1352);
    if ( (v11 & 1) != 0 )
    {
      *(_QWORD *)(a1 + 1352) = v11 & 0xFFFFFFFFFFFFFFFELL;
...
LABEL_18:
        ...
        *(_DWORD *)(a1 + 1336) = v13;
        ...
        do
        {
          v16 = *(_DWORD **)(v15 + v14 + 7824);
          if ( v16 )
          {
            v17 = *(_QWORD *)(v15 + v14 + 8256);
            if ( *(v16 - 1) != -1188329905 )
              __break(0x8229u);
