__int64 __fastcall policy_mgr_get_connection_info(__int64 a1, __int64 a2)
{
  ...
  if ( context )
  {
    ...
    {
      *(_BYTE *)(a2 + 1) = qword_8D4F00;
      *(_BYTE *)a2 = BYTE4(qword_8D4EF0);
    ...
    {
      v22 = a2 + 8LL * v21;
      *(_BYTE *)(v22 + 1) = qword_8D4F24;
      *(_BYTE *)v22 = BYTE4(qword_8D4F14);
      *(_BYTE *)(v22 + 2) = wlan_reg_freq_to_chan(
                              *(_QWORD *)(v12 + 8),
                              ...
                              v20);
      ++v21;
      *(_DWORD *)(v22 + 4) = HIDWORD(qword_8D4F0C);
    }
    if ( BYTE4(qword_8D4F48) == 1 )
    {
      v23 = a2 + 8LL * v21;
      *(_BYTE *)(v23 + 1) = qword_8D4F48;
      *(_BYTE *)v23 = BYTE4(qword_8D4F38);
      *(_BYTE *)(v23 + 2) = wlan_reg_freq_to_chan(
                              *(_QWORD *)(v12 + 8),
                              ...
                              v20);
      ++v21;
      *(_DWORD *)(v23 + 4) = HIDWORD(qword_8D4F30);
    }
    if ( BYTE4(qword_8D4F6C) == 1 )
    {
      v24 = a2 + 8LL * v21;
      *(_BYTE *)(v24 + 1) = qword_8D4F6C;
      *(_BYTE *)v24 = BYTE4(qword_8D4F5C);
      *(_BYTE *)(v24 + 2) = wlan_reg_freq_to_chan(
                              *(_QWORD *)(v12 + 8),
                              ...
                              v20);
      ++v21;
      *(_DWORD *)(v24 + 4) = HIDWORD(qword_8D4F54);
    }
    if ( BYTE4(qword_8D4F90) == 1 )
    {
      v25 = a2 + 8LL * v21;
      *(_BYTE *)(v25 + 1) = qword_8D4F90;
      *(_BYTE *)v25 = BYTE4(qword_8D4F80);
      *(_BYTE *)(v25 + 2) = wlan_reg_freq_to_chan(
                              *(_QWORD *)(v12 + 8),
                              ...
                              v20);
      ++v21;
      *(_DWORD *)(v25 + 4) = HIDWORD(qword_8D4F78);
    }
