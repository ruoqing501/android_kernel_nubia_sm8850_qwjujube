__int64 __fastcall mlo_mlme_bridge_peer_create(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 result; // x0
  __int64 v9; // x8
  ...
  if ( result )
  {
    ...
    if ( v9 )
    {
      v10 = *(__int64 (__fastcall **)(__int64, __int64, __int64, __int64))(v9 + 24);
      if ( v10 )
      {
