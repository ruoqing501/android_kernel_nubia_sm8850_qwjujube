        ...
        double a10)
{
  ...
  double v48; // d6
  double v49; // d7
  int v50; // [xsp+0h] [xbp-10h] BYREF
  __int16 v51; // [xsp+4h] [xbp-Ch]
  ...
  if ( !(_DWORD)result )
  {
    ...
    if ( v14 && *v14 && (v40 = *(_QWORD *)(*v14 + 72LL)) != 0 )
    {
      ...
      if ( v41 )
      {
        if ( *(v41 - 1) != 454466150 )
          __break(0x8228u);
        if ( (((__int64 (__fastcall *)(_QWORD *, _QWORD, int *))v41)(v14, 0, &v50) & 1) != 0 )
        {
          wma_delete_peer_mlo(a1[3], &v50);
          result = wma_remove_peer(a1, &v50, a2, 0, v42, v43, v44, v45, v46, v47, v48, v49);
          goto LABEL_12;
        }
      }
    }
