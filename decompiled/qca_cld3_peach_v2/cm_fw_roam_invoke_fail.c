        ...
        if ( psoc_ext_obj_fl )
        {
          ...
          if ( rso_config_fl )
          {
            ...
            qdf_trace_msg(
              ...
              v44,
              v56,
              *(unsigned int *)(rso_config_fl + 964),
              *(unsigned __int8 *)(rso_config_fl + 974));
            if ( *(_DWORD *)(v57 + 968) == -1 && *(__int16 *)(v57 + 972) == -1 )
            {
              v13 = (unsigned int *)(v57 + 968);
              *(_WORD *)(v57 + 972) = 0;
              *(_DWORD *)(v57 + 968) = 0;
            }
            else
            {
              v13 = (unsigned int *)*(unsigned int *)(v57 + 964);
              if ( (_DWORD)v13 == 1
                || (_DWORD)v13 == 4
                || (_DWORD)v13 == 2
                && ((v56 & 1) != 0 || (v13 = (unsigned int *)*(unsigned __int8 *)(v57 + 974), (_DWORD)v13 == 1)) )
              {
                v59 = *(unsigned __int8 *)(v57 + 974);
                *(_DWORD *)(v57 + 964) = 21;
                if ( v59 == 1 )
                  *(_BYTE *)(v57 + 974) = 0;
                mlo_disconnect(v11, 10, 65534, 0);
              }
            }
          }
          else
