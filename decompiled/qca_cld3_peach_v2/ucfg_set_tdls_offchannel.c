__int64 __fastcall ucfg_set_tdls_offchannel(__int64 a1, __int16 a2)
{
  __int64 v4; // x0
  double v5; // d0
  double v6; // d1
  ...
  v42 = 0;
  v43 = 0;
  v4 = _qdf_mem_malloc(0x18u, "ucfg_set_tdls_offchannel", 1135);
  if ( v4 )
  {
    v13 = v4;
    ...
    {
      v23 = ref;
      qdf_trace_msg(0, 2u, "%s: can't get vdev", v15, v16, v17, v18, v19, v20, v21, v22, "ucfg_set_tdls_offchannel");
LABEL_7:
      _qdf_mem_free(v13);
      result = v23;
      goto LABEL_8;
    ...
    *(_QWORD *)v13 = a1;
    ...
    result = scheduler_post_message_debug(
               ...
               0x481u,
               (__int64)"ucfg_set_tdls_offchannel");
    if ( (_DWORD)result )
    {
      v23 = result;
      qdf_trace_msg(
        0,
        2u,
        "%s: post set tdls offchannel msg fail",
        v25,
        v26,
        v27,
        v28,
