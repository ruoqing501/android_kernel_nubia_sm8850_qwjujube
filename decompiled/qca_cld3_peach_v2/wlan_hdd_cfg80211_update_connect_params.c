...
LABEL_38:
    ...
    qdf_trace_msg(
      ...
      *v33,
      *((unsigned int *)v33 + 1));
    updated = ucfg_cm_update_fils_config(*v17, *(unsigned __int8 *)(*(_QWORD *)(a2 + 55520) + 8LL), (__int64)v33);
    if ( updated )
      qdf_trace_msg(
        0x33u,
        2u,
...
LABEL_45:
      if ( !a4 )
        goto LABEL_32;
      v57 = sme_send_rso_connect_params(v19, *(unsigned __int8 *)(*(_QWORD *)(a2 + 55520) + 8LL));
      if ( !v57 )
        goto LABEL_32;
      v58 = v57;
