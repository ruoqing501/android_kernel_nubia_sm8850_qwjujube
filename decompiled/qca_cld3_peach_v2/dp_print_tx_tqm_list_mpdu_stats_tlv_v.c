__int64 __fastcall dp_print_tx_tqm_list_mpdu_stats_tlv_v(unsigned int *a1)
{
  unsigned int v2; // w20
  __int64 v3; // x0
  double v4; // d0
  ...
  v2 = *a1;
  v3 = _qdf_mem_malloc(0x3E8u, "dp_print_tx_tqm_list_mpdu_stats_tlv_v", 2540);
  if ( !v3 )
  ...
  DP_PRINT_STATS("HTT_TX_TQM_LIST_MPDU_STATS_TLV_V:", v4, v5, v6, v7, v8, v9, v10, v11);
  if ( (_DWORD)v13 )
  {
    v22 = 0;
    v23 = 0;
