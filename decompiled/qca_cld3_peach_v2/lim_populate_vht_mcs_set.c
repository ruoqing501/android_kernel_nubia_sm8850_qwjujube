        ...
        __int64 a6)
{
  ...
  v26 = bw_for_mcs_set;
  v27 = -1LL << (2 * a5);
  v28 = v27 | *(_DWORD *)(v25 + 2836);
  a2[21] = v28;
  v29 = (unsigned __int16)v28;
  LODWORD(v27) = v27 | *(_DWORD *)(v25 + 2840);
...
LABEL_48:
    ...
    *(_BYTE *)(v49 + 461) = (unsigned __int16)a2[23] > 0xFFFBu;
    if ( !a6 || v26 < 3 )
      return 0;
    *(_BYTE *)(a6 + 370) = (*(_WORD *)(a3 + 12) & 0x2000) != 0;
...
LABEL_89:
                qdf_trace_msg(
                  ...
                  v57,
                  "lim_get_vht_gt80_nss",
                  *(unsigned __int8 *)(a6 + 368),
                  *(unsigned __int8 *)(a6 + 369));
                if ( *(unsigned __int8 *)(a6 + 368) >= (unsigned int)*(unsigned __int8 *)(v49 + 443) )
                  v73 = *(_BYTE *)(v49 + 443);
                else
                  v73 = *(_BYTE *)(a6 + 368);
                v74 = *(unsigned __int8 *)(a6 + 369);
                *(_BYTE *)(a6 + 368) = v73;
...
LABEL_63:
          ...
          *(_BYTE *)(a6 + 368) = v59;
          ...
          if ( v62 != 3 )
          {
            if ( v62 == 2 )
            {
              *(_BYTE *)(a6 + 369) = (unsigned __int8)(3 * v59) >> 2;
              goto LABEL_89;
            }
            if ( v62 != 1 )
            {
...
LABEL_79:
        ...
        if ( v64 != 2 && *(_BYTE *)(*(_QWORD *)(a1 + 8) + 2871LL) )
          *(_BYTE *)(v49 + 443) = 2 * v64;
        goto LABEL_89;
      }
    }
