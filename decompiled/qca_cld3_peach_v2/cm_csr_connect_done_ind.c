...
LABEL_44:
      ...
      v18 = policy_mgr_mode_specific_connection_count(*(_QWORD *)(v14 + 21624), 0, nullptr);
      qdf_trace_msg(
        0x34u,
        8u,
      ...
      {
        if ( (policy_mgr_current_concurrency_is_mcc(*(_QWORD *)(v14 + 21624)) & 1) != 0 )
        {
          policy_mgr_get_mcc_adaptive_sch(*(_QWORD *)(v14 + 21624), v93);
          if ( v93[0] == 1 )
          {
            qdf_trace_msg(
              0x34u,
              ...
              v35,
              "cm_csr_connect_done_ind");
            policy_mgr_set_dynamic_mcc_adaptive_sch(*(_QWORD *)(v14 + 21624), 0);
...
LABEL_20:
          ...
          mcc_duty_cycle_percentage = (unsigned int)wlan_mlme_get_mcc_duty_cycle_percentage(*(_QWORD *)(v14 + 21632));
          v63 = v12;
          goto LABEL_27;
        }
        v27 = v17[1104];
      }
      if ( v18 == 2 && v27 == 1 && (policy_mgr_current_concurrency_is_mcc(*(_QWORD *)(v14 + 21624)) & 1) != 0 )
      {
        policy_mgr_get_mcc_adaptive_sch(*(_QWORD *)(v14 + 21624), v93);
        if ( v93[0] == 1 )
        {
          qdf_trace_msg(
            ...
            v52,
            "cm_csr_connect_done_ind");
          policy_mgr_set_dynamic_mcc_adaptive_sch(*(_QWORD *)(v14 + 21624), 1);
...
LABEL_28:
      ...
      user_mcc_duty_cycle_percentage = wlan_mlme_get_user_mcc_duty_cycle_percentage(*(_QWORD *)(v14 + 21624));
