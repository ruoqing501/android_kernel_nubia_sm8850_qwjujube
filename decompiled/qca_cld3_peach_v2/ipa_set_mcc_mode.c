__int64 __fastcall ipa_set_mcc_mode(
        __int64 a1,
        char a2,
        double a3,
        double a4,
        ...
        double a10)
{
  ...
  if ( !g_ipa_config || (*(_BYTE *)g_ipa_config & 1) == 0 )
  {
    ...
    v11 = 8;
    return qdf_trace_msg(0x61u, v11, v10, a3, a4, a5, a6, a7, a8, a9, a10, "ipa_set_mcc_mode");
  }
  v13 = *(_QWORD *)(a1 + 80);
  ...
  if ( (result & 1) != 0 )
  {
    ...
    if ( comp_private_obj )
      return wlan_ipa_set_mcc_mode(comp_private_obj, a2 & 1);
