        ...
        double a10)
{
  ...
  if ( *((_DWORD *)a2 + 2) != 1 )
  {
    ...
    *(_QWORD *)(a1 + 1336) = v15;
    ...
    v16 = _qdf_mem_malloc(14000LL * *(unsigned __int16 *)(a1 + 3992), "pe_open", 1048);
    *(_QWORD *)(a1 + 12264) = v16;
    if ( v16 )
    {
      if ( !(unsigned int)lim_initialize(a1) )
      {
        ...
        v37 = wlan_scan_register_mbssid_cb(*(_QWORD *)(a1 + 21624), (__int64)lim_handle_frame_genby_mbssid);
        if ( v37 )
          qdf_trace_msg(
            0x35u,
            2u,
            ...
            v37,
            v37);
        v46 = ucfg_scan_register_bcn_cb(*(_QWORD *)(a1 + 21624), (__int64)lim_handle_sap_beacon, 1u);
        if ( v46 )
          qdf_trace_msg(
            0x35u,
            2u,
            ...
            v46,
            v46);
        wlan_reg_register_ctry_change_callback(*(_QWORD *)(a1 + 21624), (__int64)lim_update_tx_pwr_on_ctry_change_cb);
        wlan_reg_register_c2c_detect_callback(*(_QWORD *)(a1 + 21624), (__int64)lim_update_tpc_bcn_on_c2c_detect_cb);
        wlan_reg_register_is_chan_connected_callback(*(_QWORD *)(a1 + 21624), (__int64)lim_get_connected_chan_for_mode);
        v55 = *(_QWORD *)(a1 + 21624);
        v72 = nullptr;
        v73 = nullptr;
