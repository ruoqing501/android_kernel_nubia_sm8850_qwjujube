__int64 __fastcall sme_rrm_issue_scan_req(__int64 a1, unsigned int a2)
{
  ...
  v6 = v5 + 17490;
  v4 = v5 + 17488;
  if ( (unsigned int)csr_roam_get_session_id_from_bssid(a1, (int *)(v5 + 17490), &v132) )
  {
    if ( v6 )
    {
...
LABEL_69:
  ...
  scan_id = wlan_scan_get_scan_id(*(_QWORD *)(v3 + 21624), v44, v45, v46, v47, v48, v49, v50, v51);
  ...
  *(_DWORD *)(v4 + 140) = scan_id;
  ...
  if ( v31 != 1 )
    ++v62;
  *(_DWORD *)(v33 + 92) = v62;
  *(_DWORD *)(v33 + 16) = *(unsigned __int8 *)(v43 + 168);
