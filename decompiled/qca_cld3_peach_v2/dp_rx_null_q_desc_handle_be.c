        ...
        unsigned int a7)
{
  ...
  __int64 *v111; // x28
  int v112; // w8
  unsigned __int8 (__fastcall *v113)(_QWORD); // x8
  int v114; // w8
  ...
  __int64 v126; // x0
  __int64 v127; // x0
  unsigned __int16 (__fastcall *v128)(_QWORD); // x8
  int v129; // w8
  __int64 v130; // x0
  __int64 v131; // [xsp+8h] [xbp-18h]
  _QWORD v132[2]; // [xsp+10h] [xbp-10h] BYREF

  v132[1] = *(_QWORD *)(_ReadStatusReg(SP_EL0) + 1808);
  v13 = *(_QWORD *)(a1 + 40);
  v132[0] = 0;
  ...
  *(_BYTE *)(a2 + 84) = *(_BYTE *)(a2 + 84) & 0xBF | ((v19(a3) & 1) << 6);
  ...
  if ( *(v22 - 1) != -177782713 )
    __break(0x8228u);
  ((void (__fastcall *)(__int64, _QWORD *))v22)(a3, v132);
  ...
  {
    v25 = LOWORD(v132[0]) + v24 + *(unsigned __int16 *)(a1 + 1138);
...
LABEL_40:
      ...
      {
        v42 = *(_QWORD *)(a2 + 40);
        v43 = LOWORD(v132[0]) + (unsigned __int64)*(unsigned __int16 *)(a1 + 1138);
        if ( v42 )
      ...
      if ( (*(_BYTE *)(a2 + 68) & 4) != 0 )
        ...
        v59 = 0;
      *(_QWORD *)(v41 + 2856) += (unsigned int)(*(_DWORD *)(a2 + 112) + v59);
      if ( (dp_rx_err_drop_3addr_mcast(v41, a3) & 1) != 0 )
      {
        ++LODWORD(a5[509 * (unsigned __int8)a7 + 412]);
LABEL_19:
        if ( a2 )
          _qdf_nbuf_free(a2);
        goto LABEL_21;
          ...
          if ( (v64(a3) & 1) == 0 )
          {
            ...
            if ( dp_rx_null_q_desc_handle_be___last_ticks_38 - jiffies + 125 < 0 )
            {
              qdf_trace_msg(
                ...
                v72,
                "dp_rx_null_q_desc_handle_be");
              dp_rx_null_q_desc_handle_be___last_ticks_38 = v124;
            }
            ++LODWORD(a5[509 * (unsigned __int8)a7 + 390]);
            goto LABEL_19;
          }
        }
      }
      if ( !(unsigned int)dp_wds_rx_policy_check(a3, v41, a5) )
      {
        ...
        ++LODWORD(a5[509 * (unsigned __int8)a7 + 407]);
        goto LABEL_19;
      }
      ...
      if ( (v81(a3) & 1) != 0 )
      {
        ...
        {
          v83 = ref_by_id;
          v131 = (unsigned __int8)v21;
          v84 = *(_QWORD *)(ref_by_id + 88) + 144 * v131;
          qdf_spin_lock_bh_8(v84 + 88);
          if ( !*(_QWORD *)(*(_QWORD *)(v83 + 88) + 144 * v131 + 32) )
          {
            if ( *(_DWORD *)(v41 + 64) || (a5[11] & 1) != 0 )
            {
              v128 = *(unsigned __int16 (__fastcall **)(_QWORD))(*(_QWORD *)(*(_QWORD *)(a1 + 1128) + 74392LL) + 1160LL);
              if ( *((_DWORD *)v128 - 1) != 769334334 )
                __break(0x8228u);
              v85 = v128(v131);
              v87 = v83;
              v86 = (unsigned int)(1LL << v131);
            }
            else
            {
              v85 = 1;
      ...
      if ( !(unsigned int)qdf_mem_cmp(v88 + 6, (const void *)(v41 + 96), 6u)
        || !(unsigned int)qdf_mem_cmp(v88 + 6, (const void *)(v41 + 104), 6u) )
      {
        ++a5[509 * (unsigned __int8)a7 + 391];
        if ( (*(_BYTE *)(a2 + 68) & 4) != 0 )
          v122 = *(unsigned __int16 *)(a2 + 66);
        else
          v122 = 0;
        a5[509 * (unsigned __int8)a7 + 392] += (unsigned int)(*(_DWORD *)(a2 + 112) + v122);
        goto LABEL_19;
      }
      if ( !*(_DWORD *)(v41 + 44) )
      {
      ...
      *(_QWORD *)a2 = 0;
      ...
      ++a5[509 * (unsigned __int8)a7 + 410];
      if ( (*(_BYTE *)(a2 + 68) & 4) != 0 )
        v112 = *(unsigned __int16 *)(a2 + 66);
      else
        v112 = 0;
      v111[509 * (unsigned __int8)a7 + 125] += (unsigned int)(*(_DWORD *)(a2 + 112) + v112);
      v113 = *(unsigned __int8 (__fastcall **)(_QWORD))(*(_QWORD *)(*(_QWORD *)(a1 + 1128) + 74392LL) + 496LL);
      if ( *((_DWORD *)v113 - 1) != -1147376687 )
        __break(0x8228u);
      if ( v113(a3) && *(_DWORD *)(v41 + 44) == 2 )
      {
        ++v111[509 * (unsigned __int8)a7 + 98];
        if ( (*(_BYTE *)(a2 + 68) & 4) != 0 )
          v125 = *(unsigned __int16 *)(a2 + 66);
        else
          v125 = 0;
        v111[509 * (unsigned __int8)a7 + 99] += (unsigned int)(*(_DWORD *)(a2 + 112) + v125);
        if ( *v88 != 255 || v88[1] != 255 || v88[2] != 255 || v88[3] != 255 || v88[4] != 255 || v88[5] != 255 )
          goto LABEL_149;
        ++v111[509 * (unsigned __int8)a7 + 100];
        if ( (*(_BYTE *)(a2 + 68) & 4) != 0 )
          v129 = *(unsigned __int16 *)(a2 + 66);
        else
          v129 = 0;
        v115 = *(_DWORD *)(a2 + 112) + v129;
        v116 = &v111[509 * (unsigned __int8)a7 + 101];
      }
      else
      {
        ++v111[509 * (unsigned __int8)a7 + 96];
        if ( (*(_BYTE *)(a2 + 68) & 4) != 0 )
          v114 = *(unsigned __int16 *)(a2 + 66);
        else
          v114 = 0;
        v115 = *(_DWORD *)(a2 + 112) + v114;
        v116 = &v111[509 * (unsigned __int8)a7 + 97];
      }
      *v116 += v115;
LABEL_149:
      *(_DWORD *)(a2 + 48) |= 0x80u;
      ...
      ++LODWORD(v111[509 * (unsigned __int8)a7 + 120]);
      goto LABEL_19;
    }
  }
  ...
  if ( a1 )
  {
    ...
    if ( (*(_BYTE *)(a2 + 68) & 4) != 0 )
      ...
      v56 = 0;
    *(_QWORD *)(a1 + 13784) += (unsigned int)(*(_DWORD *)(a2 + 112) + v56);
  }
  if ( *(_BYTE *)(a1 + 18774) == 1 )
  {
    *(_QWORD *)a2 = 0;
...
LABEL_155:
          **(_QWORD **)(v103 + 376) = a2;
          v117 = *(_QWORD *)(v103 + 368);
          v119 = *(_QWORD *)(v117 + 72);
          v118 = (unsigned __int64 *)(v117 + 72);
          v120 = v119 & 0xFFFFFFFF00FFFFFFLL;
          v121 = ((_DWORD)v119 + 0x1000000) & 0xFF000000;
          goto LABEL_172;
        }
LABEL_171:
        *(_QWORD *)(v103 + 368) = a2;
        v120 = 0x1000000;
        v118 = (unsigned __int64 *)(a2 + 72);
        v121 = *(_QWORD *)(a2 + 72) & 0xFFFFFFFF00FFFFFFLL;
LABEL_172:
        *v118 = v121 | v120;
        *(_QWORD *)(v103 + 376) = a2;
        *(_QWORD *)a2 = 0;
