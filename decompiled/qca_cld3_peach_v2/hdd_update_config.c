__int64 __fastcall hdd_update_config(__int64 *a1)
{
  ...
  double v111; // d6
  double v112; // d7
  _QWORD v113[2]; // [xsp+8h] [xbp-28h] BYREF
  _BYTE v114[4]; // [xsp+18h] [xbp-18h] BYREF
  _BYTE v115[4]; // [xsp+1Ch] [xbp-14h] BYREF
  _BYTE v116[4]; // [xsp+20h] [xbp-10h] BYREF
  _BYTE v117[4]; // [xsp+24h] [xbp-Ch] BYREF
  __int64 v118; // [xsp+28h] [xbp-8h]
  ...
  {
    if ( (unsigned int)wlan_mlme_get_self_recovery(*a1, v113) )
      qdf_trace_msg(
        0x33u,
        2u,
  ...
  {
    v35 = (__int64)context;
    if ( (unsigned int)wlan_mlme_get_prevent_link_down(*a1, v117) )
      qdf_trace_msg(
        0x33u,
        2u,
    ...
    if ( (unsigned int)wlan_mlme_get_self_recovery(*a1, v116) )
      qdf_trace_msg(
        0x33u,
        2u,
        "%s: Failed to get self recovery ini config",
    ...
    v52 = *a1;
    v53 = *(_BYTE *)(a1[13] + 123);
    LOBYTE(v113[0]) = v116[0];
    BYTE1(v113[0]) = v53;
    runtime_pm_delay = ucfg_pmo_get_runtime_pm_delay(v52);
    v55 = *a1;
    HIDWORD(v113[0]) = runtime_pm_delay;
    v113[1] = ucfg_dp_get_rx_softirq_yield_duration(v55);
    hif_init_ini_config(v35, (int)v113);
  ...
  *(_DWORD *)(v57 + 8) = 0;
  ...
  if ( (unsigned int)wlan_mlme_get_crash_inject(*a1, v116) )
  {
...
LABEL_27:
  ...
  if ( (unsigned int)wlan_mlme_get_fw_timeout_crash(*a1, v114) )
  {
    v67 = "%s: Failed to get fw timeout crash ini config";
    goto LABEL_27;
  }
  if ( (unsigned int)wlan_mlme_get_ito_repeat_count(*a1, v117) )
  {
    v67 = "%s: Failed to get ITO repeat count ini config";
    goto LABEL_27;
  }
  *(_BYTE *)(v58 + 121) = v116[0];
  wlan_mlme_get_sap_max_offload_peers(*a1, v113);
  *(_BYTE *)(v58 + 12) = v113[0];
  sap_max_offload_reorder_buffs = wlan_mlme_get_sap_max_offload_reorder_buffs(*a1, v113);
  v99 = v113[0];
  *(_BYTE *)(v58 + 14) = 1;
  *(_BYTE *)(v58 + 13) = v99;
  *(_BYTE *)(v58 + 15) = ucfg_ipa_uc_is_enabled(sap_max_offload_reorder_buffs) & 1;
  *(_BYTE *)(v58 + 16) = ucfg_dp_is_rx_common_thread_enabled(*a1) & 1;
  wlan_mlme_get_sap_max_peers(*a1, v113);
  *(_WORD *)v58 = v113[0];
  *(_DWORD *)(v58 + 32) = *(_DWORD *)(a1[13] + 208);
  values = cfg_psoc_get_values(*a1);
  v101 = v114[0];
  v102 = *(_DWORD *)(values + 4256);
  *(_BYTE *)(v58 + 37) = v115[0];
  v103 = v117[0];
  *(_BYTE *)(v58 + 38) = v101;
  *(_BYTE *)(v58 + 36) = v102;
  ...
  *(_BYTE *)(v58 + 146) = ucfg_pmo_is_fw_debug_enable(*a1) & 1;
  v104 = ucfg_cp_stats_is_bcn_rssi_history_report_cfg_enable(*a1);
  *(_BYTE *)(v58 + 147) = v105 & 1;
  cds_init_ini_config(v58, v104, v106, v107, v108, v109, v110, v111, v112);
LABEL_28:
  v68 = *a1;
  LODWORD(v113[0]) = 0;
  v117[0] = 0;
  if ( (unsigned int)wlan_mlme_get_band_capability(v68, v113) )
  {
    v69 = -5;
  }
  else
  {
    ...
    if ( v70 )
    {
      ...
      *(_BYTE *)(v70 + 2) = *(_DWORD *)a1[13];
      if ( (unsigned int)wlan_mlme_is_11d_enabled(*a1, v117) )
        qdf_trace_msg(
          0x33u,
          2u,
      ...
      *v71 = v117[0];
      v80 = *a1;
      v117[0] = 0;
      if ( (unsigned int)wlan_mlme_is_11h_enabled(v80, v117) )
        qdf_trace_msg(
          0x33u,
          2u,
          ...
          "hdd_update_user_config");
      v71[1] = v117[0];
      v71[3] = wlan_reg_band_bitmap_to_band_info(v113[0]);
