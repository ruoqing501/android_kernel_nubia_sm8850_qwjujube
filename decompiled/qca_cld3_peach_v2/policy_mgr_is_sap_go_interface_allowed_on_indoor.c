...
LABEL_21:
    ...
    if ( opmode_from_vdev_id == 3 )
    {
      ...
      {
        v29 = jiffies;
        if ( policy_mgr_is_sap_go_interface_allowed_on_indoor___last_ticks_243 - jiffies + 125 < 0 )
        {
          qdf_trace_msg(
            0x4Fu,
            8u,
            ...
            "policy_mgr_is_sap_go_interface_allowed_on_indoor");
          result = 0;
          policy_mgr_is_sap_go_interface_allowed_on_indoor___last_ticks_243 = v29;
          goto LABEL_15;
        }
        goto LABEL_21;
      }
    ...
    else
    {
      ...
      {
        v28 = jiffies;
        if ( policy_mgr_is_sap_go_interface_allowed_on_indoor___last_ticks_245 - jiffies + 125 < 0 )
        {
          qdf_trace_msg(
            0x4Fu,
            8u,
            ...
            "policy_mgr_is_sap_go_interface_allowed_on_indoor");
          result = 0;
          policy_mgr_is_sap_go_interface_allowed_on_indoor___last_ticks_245 = v28;
          goto LABEL_15;
        }
        goto LABEL_21;
      }
      ...
      {
        v19 = jiffies;
        if ( policy_mgr_is_sap_go_interface_allowed_on_indoor___last_ticks_241 - jiffies + 125 < 0 )
        {
          qdf_trace_msg(
            0x4Fu,
            8u,
            ...
            "policy_mgr_is_sap_go_interface_allowed_on_indoor");
          result = 0;
          policy_mgr_is_sap_go_interface_allowed_on_indoor___last_ticks_241 = v19;
          goto LABEL_15;
        }
        goto LABEL_21;
      }
