__int64 __fastcall target_if_reg_set_disable_upper_6g_edge_ch_info(
        __int64 a1,
        double a2,
        double a3,
        double a4,
        ...
        double a9)
{
  ...
  {
    v10 = *(void (__fastcall **)(__int64, __int64))(v9 + 624);
    if ( v10 )
    {
      v11 = *(_QWORD *)(a1 + 2800);
      if ( v11 )
      {
        ...
        {
          v12 = a1;
          LOBYTE(v11) = wmi_service_enabled(v11, 239);
          a1 = v12;
        }
      }
  ...
  else
  {
    ...
    qdf_trace_msg(
      ...
      v20,
      v21,
      "target_if_reg_set_disable_upper_6g_edge_ch_info");
    return 16;
  }
}
