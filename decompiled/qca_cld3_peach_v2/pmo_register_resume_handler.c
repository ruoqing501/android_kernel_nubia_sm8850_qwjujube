__int64 __fastcall pmo_register_resume_handler(
        unsigned int a1,
        __int64 a2,
        __int64 a3,
        double a4,
        ...
        double a11)
{
  ...
  qdf_trace_msg(0x4Du, 8u, "%s: enter", a4, a5, a6, a7, a8, a9, a10, a11, "pmo_register_resume_handler");
  ...
  qdf_trace_msg(0x4Du, 8u, "%s: exit", v23, v24, v25, v26, v27, v28, v29, v30, "pmo_register_resume_handler");
  return v31;
}
