...
LABEL_8:
  ...
  if ( (int)v17 > 1 )
  {
    if ( v17 == 2 )
    {
      if ( (unsigned __int16)a8 != 1 && (dword_7F76A0 & 0x10) != 0 )
      {
        v22 = a3;
    ...
    else if ( v17 == 7 && (unsigned __int16)a8 != 1 && (dword_7F76A0 & 1) != 0 )
    {
      v22 = a3;
...
LABEL_28:
  ...
  else if ( byte_7F7656 == 2 )
  {
    if ( a2 >= 0x17 )
      goto LABEL_46;
  }
  else if ( byte_7F7656 != 4 && (byte_7F7656 != 3 || a2 >= 0x23) )
  {
    goto LABEL_46;
  }
