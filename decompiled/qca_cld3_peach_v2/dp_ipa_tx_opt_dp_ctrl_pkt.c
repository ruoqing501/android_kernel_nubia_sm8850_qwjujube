...
LABEL_16:
  ...
  *(_QWORD *)(a1 + 17912) = v43 & 0xFFFFFFFFFFFFFFFELL;
  raw_spin_unlock_bh(a1 + 17904);
  if ( !v41 )
    goto LABEL_15;
LABEL_12:
  v52 = a1 + 12416 + 120LL * (unsigned int)v8;
  v205 = 0;
  v206 = 0;
...
LABEL_48:
  ...
  *((_BYTE *)v41 + 30) |= 0x21u;
  if ( v139 <= 3 )
  {
    ...
    v142 = *((_DWORD *)v41 + 5);
    v141 = *((_DWORD *)v41 + 6);
    v143 = *(unsigned __int8 *)(a1 + 12416 + 120LL * (unsigned int)v139 + 72);
    v203 = *(_BYTE *)(a1 + 12416 + 120LL * (unsigned int)v139 + 72);
    qdf_trace_msg(
      0x45u,
      5u,
...
LABEL_64:
        ...
        LOBYTE(v220) = 1;
        BYTE5(v208) = 1;
        v169 = dp_tx_send_msdu_single(v7, a3, (__int64)&v207, 0xFFFF, 0, v160, v161, v162, v163, v164, v165, v166, v167);
        if ( !v169 )
        {
...
LABEL_21:
    ...
    if ( (wlan_cfg_is_lapb_enabled(v158) & 1) != 0 )
    {
      ...
      if ( (*(_DWORD *)(a3 + 168) & 0xF000000) == 0xB000000 )
        LOBYTE(v168) = *(_BYTE *)(*(_QWORD *)(v168 + 8) + 7201LL) - 1;
      else
        LODWORD(v168) = *(unsigned __int16 *)(a3 + 124) % (*(unsigned __int8 *)(*(_QWORD *)(v168 + 8) + 7201LL) - 1);
    }
    else
    {
      LOWORD(v168) = (unsigned int)*(_WORD *)(a3 + 124)
                   % *(unsigned __int8 *)(*(_QWORD *)(*(_QWORD *)(v7 + 24) + 8LL) + 7201LL);
    }
    goto LABEL_64;
  }
LABEL_85:
