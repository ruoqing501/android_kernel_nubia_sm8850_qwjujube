...
LABEL_9:
        ...
        v34 = BYTE4(qword_8D4F00) == 1
           && (pm_conc_connection_list & 0xFFFFFFFE) != 4
           && wlan_reg_is_24ghz_ch_freq(HIDWORD(pm_conc_connection_list));
        if ( BYTE4(qword_8D4F24) == 1 && (qword_8D4F0C & 0xFFFFFFFE) != 4 )
          v34 += wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_8D4F0C));
        if ( BYTE4(qword_8D4F48) == 1 && (qword_8D4F30 & 0xFFFFFFFE) != 4 )
          v34 += wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_8D4F30));
        if ( BYTE4(qword_8D4F6C) == 1 && (qword_8D4F54 & 0xFFFFFFFE) != 4 )
          v34 += wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_8D4F54));
        if ( BYTE4(qword_8D4F90) == 1 && (qword_8D4F78 & 0xFFFFFFFE) != 4 )
          v34 += wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_8D4F78));
        ...
        if ( a4 != 2 )
        {
          if ( a4 == 3 )
          {
            v44 = ((__int64 (__fastcall *)(__int64, _QWORD, _QWORD, _QWORD))policy_mgr_allow_4th_new_freq)(
                    a1,
                    a3,
                    a2,
                    a6);
...
LABEL_80:
          ...
          {
            if ( (qword_8D4F00 & 0x6000000000000LL) != 0 )
            {
              v55 = jiffies;
              if ( policy_mgr_allow_new_home_channel___last_ticks_68 - jiffies + 125 < 0 )
              {
                qdf_trace_msg(
                  0x4Fu,
                  8u,
                ...
                v22 = 0;
                policy_mgr_allow_new_home_channel___last_ticks_68 = v55;
                goto LABEL_80;
              }
              goto LABEL_49;
            }
        ...
        v45 = policy_mgr_2_freq_always_on_same_mac(a1, HIDWORD(pm_conc_connection_list), HIDWORD(qword_8D4F0C));
        if ( v33 == 5
          && (a5 & 1) != 0
          && ((qword_8D4F00 & 0x6000000000000LL) != 0 || (qword_8D4F24 & 0x6000000000000LL) != 0) )
        {
          v54 = jiffies;
        ...
        {
          v56 = HIDWORD(pm_conc_connection_list) != HIDWORD(qword_8D4F0C) || v33 == 5;
          v57 = v56;
          if ( (v57 & v45) != 1 )
          {
            if ( (v45 & 1) != 0 )
          ...
          {
            v22 = 1;
            if ( HIDWORD(pm_conc_connection_list) == a3 || HIDWORD(qword_8D4F0C) == a3 )
              goto LABEL_80;
            v66 = jiffies;
          ...
          if ( (policy_mgr_3_freq_always_on_same_mac(a1, a3, HIDWORD(pm_conc_connection_list), HIDWORD(qword_8D4F0C)) & 1) == 0 )
          {
LABEL_79:
            v22 = 1;
            goto LABEL_80;
          ...
          v75 = jiffies;
          if ( policy_mgr_allow_same_mac_diff_freq___last_ticks_190 - jiffies + 125 < 0 )
          {
            qdf_trace_msg(
              0x4Fu,
              8u,
              ...
              "policy_mgr_allow_same_mac_diff_freq");
            v22 = 0;
            policy_mgr_allow_same_mac_diff_freq___last_ticks_190 = v75;
            goto LABEL_80;
          }
        }
LABEL_49:
