__int64 __fastcall drv_cmd_get_wes_mode(__int64 a1, __int64 *a2, const char *a3, __int64 a4, __int64 a5)
{
  char wes_mode; // w0
  ...
  wes_mode = ucfg_cm_get_wes_mode(*a2);
  memset(v33, 0, 32);
  scnprintf(v33, 32, "%s %d", a3, wes_mode & 1);
  v9 = *(_DWORD *)(a5 + 12);
  if ( v9 > v8 )
    LOBYTE(v9) = v8 + 1;
