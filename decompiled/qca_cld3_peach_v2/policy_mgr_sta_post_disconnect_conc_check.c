__int64 __fastcall policy_mgr_sta_post_disconnect_conc_check(__int64 a1)
{
  ...
  if ( (policy_mgr_is_sap_mode((unsigned int)pm_conc_connection_list) & 1) == 0
    || (v12 = &pm_conc_connection_list, (qword_8D4F00 & 0x100000000LL) == 0) )
  {
    if ( (policy_mgr_is_sap_mode((unsigned int)qword_8D4F0C) & 1) == 0
      || (v12 = &qword_8D4F0C, (qword_8D4F24 & 0x100000000LL) == 0) )
    {
      if ( (policy_mgr_is_sap_mode((unsigned int)qword_8D4F30) & 1) == 0
        || (v12 = &qword_8D4F30, (qword_8D4F48 & 0x100000000LL) == 0) )
      {
        if ( (policy_mgr_is_sap_mode((unsigned int)qword_8D4F54) & 1) == 0
          || (v12 = &qword_8D4F54, (qword_8D4F6C & 0x100000000LL) == 0) )
        {
          if ( (policy_mgr_is_sap_mode((unsigned int)qword_8D4F78) & 1) == 0
            || (v12 = &qword_8D4F78, (qword_8D4F90 & 0x100000000LL) == 0) )
          {
