__int64 __fastcall dp_reo_status_ring_handler(__int64 a1, __int64 a2)
{
  ...
  if ( !(unsigned int)dp_srng_access_start(a1, a2, v4) )
  {
    ...
    if ( (_DWORD)v15 == *(_DWORD *)(v14 + 136) )
    {
      v13 = 0;
LABEL_45:
      dp_srng_access_end(a1, a2, *(char **)(a2 + 6640), v5, v6, v7, v8, v9, v10, v11, v12);
      goto LABEL_46;
    }
    v16 = *(_QWORD *)(v14 + 16);
    v17 = *(_BYTE *)(v14 + 78);
    ...
    while ( 1 )
    {
      ...
      if ( *(_QWORD *)(v30 + 1648) )
      {
        ...
        if ( !v31() )
        {
          ...
          {
            raw_spin_lock_bh(a2 + 13224);
            *(_QWORD *)(a2 + 13232) |= 1uLL;
            v32 = *(_QWORD *)(a2 + 13208);
            if ( v32 )
            {
LABEL_23:
              ...
              *(_QWORD *)(v32 + 32) = 0;
              ...
              if ( (v38 & 1) != 0 )
              {
                *(_QWORD *)(a2 + 13232) = v38 & 0xFFFFFFFFFFFFFFFELL;
                raw_spin_unlock_bh(a2 + 13224);
              }
              else
              {
                raw_spin_unlock(a2 + 13224);
              }
              v39 = *(_QWORD *)(v32 + 8);
              v40 = *(_DWORD **)(v32 + 16);
              if ( *(v40 - 1) != -1114182658 )
...
LABEL_25:
          ...
          if ( (v34 & 1) != 0 )
          {
            *(_QWORD *)(a2 + 13232) = v34 & 0xFFFFFFFFFFFFFFFELL;
            raw_spin_unlock_bh(a2 + 13224);
          }
          else
          {
