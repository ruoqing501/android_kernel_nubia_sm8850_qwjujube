        ...
        double a11)
{
  ...
  if ( a2 <= 5u )
  {
    ...
    v15 = *(unsigned int **)(a1 + 8LL * a2 + 12960);
    if ( v15 )
    {
      _X24 = v15 + 10846;
      v17 = v15[10846];
      while ( v17 )
      {
        ...
        if ( _ZF )
        {
          ...
          *a3 = 1000 * v15[11532] / (1000 * v15[11533]);
          qdf_trace_msg(
            0x45u,
            8u,
          ...
          dp_print_tsf_tx_delay_hist(v15 + 1340, 1);
          v15[11532] = 0;
          v15[11533] = 0;
          qdf_mem_set(v15 + 1340, 0x80u, 0);
    ...
    if ( (v42 & 1) != 0 )
    {
      *(_QWORD *)(a1 + 18992) = v42 & 0xFFFFFFFFFFFFFFFELL;
      raw_spin_unlock_bh(a1 + 18984);
    }
    else
    {
