__int64 __fastcall wlansap_get_safe_channel_from_pcl_and_acs_range(__int64 a1, __int64 a2)
{
  ...
  v13 = context;
  if ( (unsigned int)policy_mgr_get_connection_count(context[2703]) != 1 )
  {
    v17 = policy_mgr_qdf_opmode_to_pm_con_mode(v13[2703], 1, *(_BYTE *)(a1 + 12), v4, v5, v6, v7, v8, v9, v10, v11);
                          ...
                          *(unsigned __int8 *)(a1 + 12)) )
    {
      ...
      hdd_remove_vlp_depriority_channels(v13[2704], (__int64)s, (unsigned int *)&v35, v4, v5, v6, v7, v8, v9, v10, v11);
