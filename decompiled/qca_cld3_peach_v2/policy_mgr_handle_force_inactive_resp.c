__int64 __fastcall policy_mgr_handle_force_inactive_resp(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  int v7; // w8
  __int64 v9; // x3
  __int64 result; // x0
  ...
  if ( v7 == 1 )
  {
    if ( *(_BYTE *)(a3 + 101) )
      ...
      v9 = 2;
    ml_nlink_set_curr_force_inactive_state(a1, a2, *(unsigned __int16 *)(a3 + 114), v9);
...
LABEL_47:
  ...
  ml_nlink_convert_vdev_bitmap_to_linkid_bitmap(a1, a2, *(unsigned int *)(a3 + 44), a3 + 84, a4 + 44, &v17);
  result = ml_nlink_set_curr_force_inactive_state(a1, a2, *(unsigned int *)(a4 + 44), 2);
  v14 = *(_DWORD *)(a4 + 20);
  if ( !v14 )
    goto LABEL_47;
  v15 = *(_DWORD *)(a4 + 24);
  ...
  if ( v14 <= 2 )
    goto LABEL_47;
  __break(0x5512u);
  return policy_mgr_handle_force_active_num_resp(result, v11, v12, v13);
}
