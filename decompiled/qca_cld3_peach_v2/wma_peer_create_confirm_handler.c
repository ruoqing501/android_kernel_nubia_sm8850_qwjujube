        ...
        double a10)
{
  ...
  double v74; // d6
  double v75; // d7
  __int64 v76; // [xsp+8h] [xbp-28h] BYREF
  __int64 v77; // [xsp+10h] [xbp-20h]
  int v78; // [xsp+18h] [xbp-18h] BYREF
  unsigned __int16 v79; // [xsp+1Ch] [xbp-14h]
  ...
  v78 = v31;
  v79 = v32;
  if ( !(v31 | (unsigned __int16)v32) || !(v79 ^ 0xFFFF | ~v78) || (v31 & 1) != 0 )
  {
    v46 = "%s: Invalid bssid";
LABEL_12:
...
LABEL_9:
        _qdf_mem_free(v43);
        _qdf_mem_free(v45);
        wma_pasn_handle_peer_create_conf(a1, &v78, v44, *(unsigned int *)(v30 + 16), *(unsigned int *)(v30 + 4));
LABEL_17:
    ...
    if ( !*(_DWORD *)(v30 + 16) )
    {
      if ( v33 )
      {
        peer_by_mac = wlan_objmgr_get_peer_by_mac(a1[3], &v78, 8u);
        if ( peer_by_mac )
        {
          v59 = (__int64)peer_by_mac;
          wma_peer_setup_fill_info(a1[3], (__int64)peer_by_mac, (__int64)&v76);
          wma_peer_tbl_trans_add_entry(v59, 1, (__int64)&v76);
          wma_cdp_peer_setup(
            v33,
            v60,
            v61,
            ...
            *(unsigned int *)(v30 + 4),
            v59,
            (__int64)&v76);
          wlan_objmgr_peer_release_ref(v59, 8u, v68, v69, v70, v71, v72, v73, v74, v75);
          result = 0;
          v56 = 0;
          if ( !context )
            goto LABEL_14;
    ...
    wma_remove_peer(a1, &v78, *(_DWORD *)(v30 + 4), *(_DWORD *)(v30 + 16) != 0, v48, v49, v50, v51, v52, v53, v54, v55);
    v56 = 16;
    result = 4294967274LL;
    if ( !context )
      goto LABEL_14;
LABEL_20:
    v57 = result;
    lim_send_peer_create_resp((__int64)context, *(unsigned int *)(v30 + 4), v56, (unsigned __int8 *)&v78);
    result = v57;
    goto LABEL_14;
  }
  qdf_trace_msg(
