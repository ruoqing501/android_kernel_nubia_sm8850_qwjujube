        ...
        double a11)
{
  ...
  if ( !a1 || a2 > 5 || (v12 = *(_QWORD *)(a1 + 17296)) == 0 || (*(_BYTE *)(v12 + 96LL * a2 + 1) & 1) == 0 )
  {
    qdf_trace_msg(
      0x34u,
      2u,
...
LABEL_27:
  ...
  if ( !v55 )
    goto LABEL_27;
  v56 = a1 + 192LL * a2 + 13192;
  if ( *(_BYTE *)(a1 + 192LL * a2 + 13212) )
  {
    v57 = 2;
    *(_DWORD *)v55 = 1;
