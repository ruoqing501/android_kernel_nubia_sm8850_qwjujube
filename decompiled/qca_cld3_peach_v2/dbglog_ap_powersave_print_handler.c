    ...
    case 9:
      if ( a5 == 4 )
      {
        ...
        if ( a6[1] )
          ...
          v25 = (const char *)&unk_98C763;
        v26 = *a6;
        if ( a6[2] )
          v27 = "(pending usp) ";
        else
          v27 = (const char *)&unk_98C763;
        if ( v24 )
          v28 = "(pending poll response)";
        else
          v28 = (const char *)&unk_98C763;
