__int64 __fastcall policy_mgr_psoc_disable(__int64 a1)
{
  ...
  if ( context )
  {
    ...
    target_if_mlo_register_trace_link_set_active_cb(*(_QWORD *)v12, 0);
    *(_DWORD *)(v12 + 2664) = 0;
    if ( (unsigned int)qdf_event_destroy(v12 + 2672, v40) )
    {
      qdf_trace_msg(
        0x4Fu,
        2u,
        "%s: deinit event failed for set_link_update_done_evt",
        v41,
        v42,
        v43,
        v44,
        ...
        v47,
        v48,
        "policy_mgr_deinit_ml_link_update");
      v22 = 16;
    }
