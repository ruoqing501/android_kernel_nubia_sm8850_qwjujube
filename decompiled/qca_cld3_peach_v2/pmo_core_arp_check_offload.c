__int64 __fastcall pmo_core_arp_check_offload(__int64 a1, unsigned int a2, unsigned int a3)
{
  __int64 v6; // x0
  double v7; // d0
  double v8; // d1
  ...
  if ( v6 )
  {
    ...
    if ( *(_DWORD *)(v6 + 16) == 11 )
    {
      v16 = "%s: ARP offload is not supported in NaN mode";
LABEL_4:
      qdf_trace_msg(0x4Du, 8u, v16, v7, v8, v9, v10, v11, v12, v13, v14, "pmo_core_arp_check_offload");
LABEL_8:
    ...
    if ( (wlan_vdev_mlme_get_is_mlo_link(a1, a3) & 1) != 0 )
    {
      qdf_trace_msg(
        0x4Du,
        8u,
        "%s: ARP offload not supported for MLO partner link with vdev_id[%d]",
        v26,
        v27,
        v28,
        v29,
...
LABEL_19:
  ...
  qdf_trace_msg(0x4Du, 2u, "%s: vdev is NULL", v7, v8, v9, v10, v11, v12, v13, v14, "pmo_core_arp_check_offload");
  return 4;
}
