__int64 __fastcall dp_txrx_path_stats(__int64 a1)
{
  ...
  if ( *(_BYTE *)(a1 + 1120) )
  {
    ...
    DP_PRINT_STATS("Invalid release source: %u", v44, v45, v46, v47, v48, v49, v50, v51, *(unsigned int *)(a1 + 13548));
    DP_PRINT_STATS(
    ...
    DP_PRINT_STATS("mpdu age out: %u", v180, v181, v182, v183, v184, v185, v186, v187, *(unsigned int *)(v11 + 3784));
    DP_PRINT_STATS(
      ...
      *(_QWORD *)(v11 + 3744),
      *(_QWORD *)(v11 + 3752));
    DP_PRINT_STATS("firmware removed tx: %llu", v196, v197, v198, v199, v200, v201, v202, v203, *(_QWORD *)(v11 + 3768));
    DP_PRINT_STATS(
    ...
    DP_PRINT_STATS(
      ...
      v226,
      v227,
      *(unsigned int *)(*(_QWORD *)(v11 + 8) + 13588LL));
    DP_PRINT_STATS(
      ...
      v234,
      v235,
      *(unsigned int *)(*(_QWORD *)(v11 + 8) + 13620LL));
    DP_PRINT_STATS(
      "SW tso pkt cnt: %u",
      v236,
      v237,
      ...
      v242,
      v243,
      *(unsigned int *)(*(_QWORD *)(v11 + 8) + 13632LL));
    DP_PRINT_STATS(
      "SW tso fail cnt: %u",
      v244,
      v245,
      ...
      v250,
      v251,
      *(unsigned int *)(*(_QWORD *)(v11 + 8) + 13636LL));
    DP_PRINT_STATS(
    ...
    v277 = v276;
    scnprintf(&s[v276], 283LL - v276, "1: %u, ", *(_DWORD *)(v11 + 7528));
    v279 = v277 + v278;
    scnprintf(&s[v279], 283 - v279, "2-20: %u, ", *(_DWORD *)(v11 + 7532));
    v281 = v279 + v280;
    scnprintf(&s[v281], 283 - v281, "21-40: %u, ", *(_DWORD *)(v11 + 7536));
    v283 = v281 + v282;
    scnprintf(&s[v283], 283 - v283, "41-60: %u, ", *(_DWORD *)(v11 + 7540));
    v285 = v283 + v284;
    scnprintf(&s[v285], 283 - v285, "61-80: %u, ", *(_DWORD *)(v11 + 7544));
    v287 = v285 + v286;
    scnprintf(&s[v287], 283 - v287, "81-100: %u, ", *(_DWORD *)(v11 + 7548));
    v289 = v287 + v288;
    scnprintf(&s[v289], 283 - v289, "101-200: %u, ", *(_DWORD *)(v11 + 7552));
    v291 = v289 + v290;
    scnprintf(&s[v291], 283 - v291, "201+: %u", *(_DWORD *)(v11 + 7556));
    ...
    v318 = *(_QWORD *)(v11 + 5752);
    v319 = v317;
    if ( v318 )
    {
      scnprintf(&v466[v317], 283LL - v317, "%d %llu %llu, ", 0, v318, *(_QWORD *)(v11 + 5760));
      v319 += v320;
    }
    v321 = *(_QWORD *)(v11 + 5768);
    if ( v321 )
    {
      scnprintf(&v466[v319], 283 - v319, "%d %llu %llu, ", 1, v321, *(_QWORD *)(v11 + 5776));
      v319 += v322;
    }
    v323 = *(_QWORD *)(v11 + 5784);
    if ( v323 )
    {
      scnprintf(&v466[v319], 283 - v319, "%d %llu %llu, ", 2, v323, *(_QWORD *)(v11 + 5792));
      v319 += v324;
    }
    v325 = *(_QWORD *)(v11 + 5800);
    if ( v325 )
    {
      scnprintf(&v466[v319], 283 - v319, "%d %llu %llu, ", 3, v325, *(_QWORD *)(v11 + 5808));
      v319 += v326;
    }
    v327 = *(_QWORD *)(v11 + 5816);
    if ( v327 )
    {
      scnprintf(&v466[v319], 283 - v319, "%d %llu %llu, ", 4, v327, *(_QWORD *)(v11 + 5824));
      v319 += v328;
    }
    v329 = *(_QWORD *)(v11 + 5832);
    if ( v329 )
    {
      scnprintf(&v466[v319], 283 - v319, "%d %llu %llu, ", 5, v329, *(_QWORD *)(v11 + 5840));
      v319 += v330;
    }
    v331 = *(_QWORD *)(v11 + 5848);
    if ( v331 )
    {
      scnprintf(&v466[v319], 283 - v319, "%d %llu %llu, ", 6, v331, *(_QWORD *)(v11 + 5856));
      v319 += v332;
    }
    v333 = *(_QWORD *)(v11 + 5864);
    if ( v333 )
    {
      scnprintf(&v466[v319], 283 - v319, "%d %llu %llu, ", 7, v333, *(_QWORD *)(v11 + 5872));
      v319 += v334;
    }
    ...
    DP_PRINT_STATS(
      ...
      *(_QWORD *)(v11 + 5976),
      *(_QWORD *)(v11 + 5984));
    DP_PRINT_STATS("Rx BAR frames:%d", v391, v392, v393, v394, v395, v396, v397, v398, *(unsigned int *)(a1 + 13704));
    dp_print_rx_err_stats(a1, v11);
    for ( i = 3458; i != 3490; ++i )
    {
      if ( *(_DWORD *)(*(_QWORD *)(v11 + 8) + 4 * i) )
        DP_PRINT_STATS("Rxdma error number (%u): %u msdus", v399, v400, v401, v402, v403, v404, v405, v406, i - 3458);
    }
    scnprintf(s, 283, "%s", "Rx/IRQ [Range:Pkts] [");
    v409 = v408;
    scnprintf(&s[v408], 283LL - v408, "1: %u, ", *(_DWORD *)(v11 + 7560));
    v411 = v409 + v410;
    scnprintf(&s[v411], 283 - v411, "2-20: %u, ", *(_DWORD *)(v11 + 7564));
    v413 = v411 + v412;
    scnprintf(&s[v413], 283 - v413, "21-40: %u, ", *(_DWORD *)(v11 + 7568));
    v415 = v413 + v414;
    scnprintf(&s[v415], 283 - v415, "41-60: %u, ", *(_DWORD *)(v11 + 7572));
    v417 = v415 + v416;
    scnprintf(&s[v417], 283 - v417, "61-80: %u, ", *(_DWORD *)(v11 + 7576));
    v419 = v417 + v418;
    scnprintf(&s[v419], 283 - v419, "81-100: %u, ", *(_DWORD *)(v11 + 7580));
    v421 = v419 + v420;
    scnprintf(&s[v421], 283 - v421, "101-200: %u, ", *(_DWORD *)(v11 + 7584));
    v423 = v421 + v422;
    scnprintf(&s[v423], 283 - v423, "201+: %u", *(_DWORD *)(v11 + 7588));
