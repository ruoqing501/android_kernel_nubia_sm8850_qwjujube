__int64 __fastcall dp_aggregate_vdev_stats(__int64 result, __int64 a2, unsigned int a3)
{
  ...
  if ( result )
  {
    ...
    if ( *(_QWORD *)(result + 24) )
    {
      ...
      dp_copy_vdev_stats_to_tgt_buf(a2, v3 + 51, a3);
      v6 = v3[3];
      if ( !v6 )
        return dp_update_vdev_rate_stats(a2, v3 + 51);
      v7 = *(_QWORD *)(v6 + 8);
      if ( !v7 )
        return dp_update_vdev_rate_stats(a2, v3 + 51);
...
LABEL_9:
      ...
      if ( (v30 & 1) != 0 )
      {
        v3[19] = v30 & 0xFFFFFFFFFFFFFFFELL;
        raw_spin_unlock_bh(v3 + 18);
      }
      else
      {
        raw_spin_unlock(v3 + 18);
      }
      return dp_update_vdev_rate_stats(a2, v3 + 51);
    }
  }
