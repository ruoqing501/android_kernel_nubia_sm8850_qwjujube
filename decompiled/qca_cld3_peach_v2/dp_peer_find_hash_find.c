        ...
        unsigned int a5)
{
  ...
  v9 = v8[1] ^ *v8 ^ v8[2];
  v10 = ((v9 >> *(_DWORD *)(a1 + 13148)) ^ v9) & *(_DWORD *)(a1 + 13144);
  if ( (_ReadStatusReg(DAIF) & 0x80) != 0
    || (StatusReg = _ReadStatusReg(SP_EL0), (*(_DWORD *)(StatusReg + 16) & 0xF0000) != 0)
    || (*(_DWORD *)(StatusReg + 16) & 0xFF00) != 0 )
  {
    raw_spin_lock(a1 + 13288);
  }
  else
  {
    raw_spin_lock_bh(a1 + 13288);
    *(_QWORD *)(a1 + 13296) |= 1uLL;
  }
  v12 = *(_QWORD *)(*(_QWORD *)(a1 + 13152) + 16LL * v10);
  if ( !v12 )
  {
LABEL_24:
    v21 = *(_QWORD *)(a1 + 13296);
    if ( (v21 & 1) != 0 )
    {
      *(_QWORD *)(a1 + 13296) = v21 & 0xFFFFFFFFFFFFFFFELL;
      raw_spin_unlock_bh(a1 + 13288);
    }
    else
    {
      raw_spin_unlock(a1 + 13288);
    }
LABEL_26:
    result = 0;
    goto LABEL_27;
  ...
  if ( a5 >= 3 )
  {
    if ( a5 >= 0x20 )
      ...
      _X9 = (unsigned int *)(v12 + 4LL * a5 + 264);
    __asm { PRFM            #0x11, [X9] }
    do
      v26 = __ldxr(_X9);
...
LABEL_31:
  ...
  if ( (v24 & 1) != 0 )
  {
    *(_QWORD *)(a1 + 13296) = v24 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(a1 + 13288);
  }
  else
  {
