        ...
        double a10)
{
  ...
  *(_QWORD *)(a2 + 1656) = v17;
  if ( v17 )
  {
    v26 = _qdf_mem_malloc(0x100u, "wlan_hdd_iftype_data_alloc", 25515);
    *(_QWORD *)(a2 + 1664) = v26;
    if ( !v26 )
    {
LABEL_29:
    ...
    v27 = (__int64 *)(a2 + 1664);
    v28 = _qdf_mem_malloc(0x100u, "wlan_hdd_iftype_data_alloc", 25522);
    *(_QWORD *)(a2 + 1672) = v28;
    if ( !v28 )
    {
      _qdf_mem_free(*v27);
LABEL_28:
    ...
    v29 = _qdf_mem_malloc(0x100u, "wlan_hdd_iftype_data_alloc_6ghz", 25483);
    *(_QWORD *)(a2 + 1680) = v29;
    if ( !v29 )
    {
      v35 = *(_QWORD *)(a2 + 1672);
...
LABEL_16:
        ...
        *(_WORD *)(a2 + 9864) = 260;
        ...
        v38 = *(unsigned __int8 *)(values + 8632);
        if ( *(_BYTE *)(values + 8632) )
          v39 = 96;
        else
          v39 = 80;
        ...
        *(_QWORD *)(a2 + 9912) = v40;
        if ( v40 )
        {
          ...
          if ( v38 )
            qdf_mem_copy((void *)(*(_QWORD *)(a2 + 9912) + 80LL), &hdd_sta_fils_akm_suites, 0x10u);
          *(_QWORD *)(a2 + 9872) = *(_QWORD *)(a2 + 9912);
          *(_DWORD *)(a2 + 9880) = v39 >> 2;
