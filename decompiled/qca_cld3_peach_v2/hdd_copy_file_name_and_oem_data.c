        ...
        double a10)
{
  ...
  if ( v10 > 0x400 || v11 >= 0x41 )
    return (void *)qdf_trace_msg(
                     ...
                     a10,
                     "hdd_copy_file_name_and_oem_data");
  qdf_mem_set(a1 + 7124, 0x400u, 0);
  qdf_mem_set(a1 + 8149, 0x40u, 0);
  qdf_mem_copy(a1 + 7124, *(const void **)(a2 + 24), *(unsigned int *)(a2 + 8));
  a1[8148] = *(_QWORD *)(a2 + 8);
  return qdf_mem_copy(a1 + 8149, *(const void **)(a2 + 40), *(unsigned int *)(a2 + 32));
}
