__int64 __fastcall lim_get_ht_capability(__int64 a1, int a2, __int64 a3)
{
  ...
  switch ( a2 )
  {
    case 0:
      ...
      break;
    case 1:
      result = (*(unsigned __int16 *)(v3 + 1288) >> 14) & 1;
      break;
    case 2:
    ...
    case 3:
      ...
      break;
    case 4:
      result = (*(unsigned __int16 *)(v3 + 1288) >> 11) & 1;
      break;
    case 5:
    ...
    case 8:
      if ( (*(_WORD *)(a3 + 7266) & 0x40) == 0 )
        goto LABEL_28;
      result = (*(unsigned __int8 *)(v3 + 1288) >> 6) & 1;
      break;
    case 9:
      if ( (*(_WORD *)(a3 + 7266) & 0x20) == 0 )
        goto LABEL_28;
      result = (*(unsigned __int8 *)(v3 + 1288) >> 5) & 1;
      break;
    case 10:
      result = (*(unsigned __int8 *)(v3 + 1288) >> 4) & 1;
      break;
    case 11:
    ...
    case 15:
      ...
      break;
    case 16:
      result = *(_BYTE *)(v3 + 1291) & 1;
      break;
    case 17:
      result = (*(unsigned __int8 *)(v3 + 1291) >> 1) & 3;
      break;
    case 18:
      result = *(_BYTE *)(v3 + 1292) & 3;
      break;
    case 19:
      result = *(_BYTE *)(v3 + 2881) & 1;
      break;
    case 20:
      result = *(_BYTE *)(v3 + 2882) & 1;
      break;
    case 21:
