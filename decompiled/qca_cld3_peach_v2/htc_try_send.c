...
LABEL_342:
        ...
        LODWORD(v210) = v210 - 1;
        if ( !v141 )
          printk(&unk_94DB9D, "../vendor/qcom/opensource/wlan/qcacld-3.0/cmn/htc/htc_send.c", 796, "netbuf");
        if ( *((_BYTE *)a2 + 300) == 1 )
        {
          v142 = 72;
          ...
          if ( !v143 )
          {
            ...
            printk(&unk_94DB9D, "../vendor/qcom/opensource/wlan/qcacld-3.0/cmn/htc/htc_send.c", 811, "pHtcHdr");
