        ...
        double a12)
{
  ...
  double v93; // d6
  double v94; // d7
  __int64 v96; // [xsp+0h] [xbp-50h]
  __int64 v97; // [xsp+8h] [xbp-48h]

  _ReadStatusReg(SP_EL0);
  if ( (*a3 & 0x100) != 0 )
  {
    v54 = *(_DWORD *)(a2 + 1244) != 2;
LABEL_141:
    _ReadStatusReg(SP_EL0);
    return v54;
  }
  ...
  {
LABEL_30:
    if ( (((__int64 (__fastcall *)(_QWORD))util_scan_is_hidden_ssid)(*(_QWORD *)(a2 + 1344)) & 1) != 0 )
    {
      if ( *((_DWORD *)a3 + 16) | a3[34] || (a3[23] & 0x40) != 0 )
      {
        if ( !(*((_DWORD *)a3 + 16) | a3[34]) )
          goto LABEL_45;
        if ( *((_DWORD *)a3 + 16) == -1 && (__int16)a3[34] == -1 )
          goto LABEL_45;
        if ( *((_DWORD *)a3 + 16) == *(_DWORD *)(a2 + 1) && a3[34] == *(unsigned __int16 *)(a2 + 5) )
          goto LABEL_45;
      }
      if ( *((_DWORD *)a3 + 16) | a3[34] )
        qdf_trace_msg(
...
LABEL_85:
          if ( (*a3 & 0x20) != 0 && wlan_reg_is_6ghz_chan_freq(*(_DWORD *)(a2 + 1192)) )
          {
            if ( !*((_BYTE *)a3 + 16) && !*((_BYTE *)a3 + 17) )
              goto LABEL_140;
            v49 = *(unsigned __int8 *)(a2 + 1);
...
LABEL_90:
          ...
          pdev_by_id = wlan_objmgr_get_pdev_by_id(a1, *(_BYTE *)(a2 + 1904), 0xCu);
          if ( !pdev_by_id )
            goto LABEL_129;
          v74 = (unsigned int *)*a3;
          v75 = pdev_by_id;
          if ( ((unsigned __int8)v74 & 0x10) != 0
            && (utils_dfs_is_freq_in_nol(pdev_by_id, *(unsigned int *)(a2 + 1192)) & 1) != 0 )
          {
            wlan_objmgr_pdev_release_ref(v75, 0xCu, v74, v26, v27, v28, v29, v30, v31, v32, v33);
            v49 = *(unsigned __int8 *)(a2 + 1);
            v50 = *(unsigned __int8 *)(a2 + 2);
...
LABEL_122:
            ...
            if ( (scm_mlo_filter_match(v75, a3, a2) & 1) != 0 )
            {
              v83 = wlan_objmgr_get_pdev_by_id(a1, *(_BYTE *)(a2 + 1904), 0xCu);
              if ( v83 )
              {
                v84 = v83;
                v85 = scm_eht_puncture_valid(v83, a2);
                v54 = v86;
                wlan_objmgr_pdev_release_ref(v84, 0xCu, v87, v85, v88, v89, v90, v91, v92, v93, v94);
                goto LABEL_141;
              }
LABEL_129:
              v49 = *(unsigned __int8 *)(a2 + 1);
