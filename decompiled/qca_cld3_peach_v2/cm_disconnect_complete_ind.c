  ...
  if ( v27 )
  {
    ...
    if ( v28 )
    {
      ...
      if ( psoc_ext_obj_fl )
      {
        ...
        qdf_mem_copy(v38, (const void *)(v30 + 3546), 0x29u);
        v32 = a2[3];
        BYTE2(v39) = *(_BYTE *)(v30 + 3529);
        LOBYTE(v38[0]) = 1;
        if ( v32 == 14 )
        {
          LOBYTE(v32) = 2;
...
LABEL_23:
  ...
  if ( a2[2] != 18 )
  {
    wlan_clear_mlo_sta_link_removed_flag(a1);
    ml_nlink_conn_change_notify(v22, v21, 9, 0);
    result = 0;
  }
LABEL_25:
