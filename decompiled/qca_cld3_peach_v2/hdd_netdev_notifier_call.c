        ...
        __int64 *a11)
{
  ...
  qdf_trace_msg(
    ...
    *(unsigned int *)(v12 + 176),
    ...
    (_DWORD)v48,
    v155);
  if ( !(unsigned int)qdf_mem_cmp(context + 1029, *(const void **)(v12 + 1008), 6u) )
    goto LABEL_3;
  if ( a10 != 8 )
  {
    if ( a10 == 6 )
    {
      *((_WORD *)context + 4118) = 0;
      *((_DWORD *)context + 2058) = 0;
      goto LABEL_3;
    }
    if ( a10 != 5 )
      goto LABEL_3;
  }
  qdf_mem_copy(context + 1029, *(const void **)(v12 + 1008), 6u);
          ...
          else if ( v71 < 6 )
          {
            if ( !(unsigned int)wlan_objmgr_vdev_try_get_ref(
                                  *(_QWORD *)(v70 + 32),
                                  ...
                                  v68) )
            {
              ucfg_pmo_set_vdev_bridge_addr(*(_QWORD *)(*(_QWORD *)(v58 + 52832) + 32LL), context + 1029);
              ucfg_pmo_del_wow_pattern(*(_QWORD *)(*(_QWORD *)(v58 + 52832) + 32LL));
              v73 = ucfg_pmo_register_wow_default_patterns(*(_QWORD *)(*(_QWORD *)(v58 + 52832) + 32LL));
              wlan_objmgr_vdev_release_ref(
                *(_QWORD *)(*(_QWORD *)(v58 + 52832) + 32LL),
                5u,
                *(unsigned int **)(v58 + 52832),
                v73,
                v74,
                v75,
                v76,
        ...
        else
        {
          if ( (cds_get_driver_state(v38, v39, v40, v41, v42, v43, v44, v45) & 0x10) == 0 )
          {
            ...
            if ( a10 > 9 )
            {
              if ( a10 == 10 )
              {
                vdev_by_user = _hdd_objmgr_get_vdev_by_user(*(_QWORD *)(v122 + 52832), 79, "__hdd_netdev_notifier_call");
                if ( vdev_by_user )
                {
                  v141 = vdev_by_user;
                  if ( (unsigned int)ucfg_scan_get_vdev_status(
                                       ...
                                       v139,
                                       v140) )
                    wlan_abort_scan(v54[1], -1, *(unsigned __int8 *)(*(_QWORD *)(v122 + 52832) + 8LL), 0xFFFFFFFF, 1);
              ...
              else if ( a10 == 12 )
              {
                qdf_trace_msg(
                  ...
                  v131,
                  "__hdd_netdev_notifier_call",
                  *(unsigned __int8 *)(*(_QWORD *)(v122 + 52832) + 8LL),
                  *(_QWORD *)(v12 + 184));
              }
            }
            else if ( a10 == 1 )
