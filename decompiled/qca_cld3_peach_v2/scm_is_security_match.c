      ...
      if ( (v15 & 0x6C0) == 0 )
      {
        if ( v14 == 5 )
        {
          if ( *(_QWORD *)(a2 + 1400) )
          {
            ...
            {
              v36 = (_DWORD *)v99;
              v100 = wlan_crypto_wpaie_check(v99, *(_QWORD *)(a2 + 1400), nullptr);
              if ( !v100 )
              {
...
LABEL_248:
        ...
        if ( v14 == 8 )
        {
          if ( *(_QWORD *)(a2 + 1512) )
          {
            ...
            if ( !v17 )
              goto LABEL_250;
            v18 = wlan_crypto_wapiie_check(v17, *(_QWORD *)(a2 + 1512));
            if ( v18 )
            {
