__int64 __fastcall populate_dot11f_qcn_ie(__int64 a1, __int64 a2, __int64 a3, unsigned __int8 a4)
{
  ...
  *(_BYTE *)a3 = 0;
  if ( *(_BYTE *)(*(_QWORD *)(a1 + 8) + 3536LL) == 1 && (a4 == 255 || a4 == 1) )
    *(_DWORD *)a3 = 65793;
  if ( *(_BYTE *)(a2 + 7170) && *(_BYTE *)(*(_QWORD *)(a1 + 8) + 2884LL) == 1 )
  {
    *(_BYTE *)a3 = 1;
    *(_WORD *)(a3 + 4) = 257;
  }
...
LABEL_18:
  result = policy_mgr_is_vdev_ll_lt_sap(*(_QWORD *)(a1 + 21624), *(unsigned __int8 *)(a2 + 10));
  if ( (result & 1) != 0 )
  {
    qdf_trace_msg(
      0x35u,
