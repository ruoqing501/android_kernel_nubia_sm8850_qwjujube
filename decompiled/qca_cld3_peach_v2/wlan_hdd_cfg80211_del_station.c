__int64 __fastcall wlan_hdd_cfg80211_del_station(__int64 a1, __int64 a2, __int64 *a3)
{
  ...
  if ( a3 )
  {
    ...
    if ( !(_DWORD)result )
    {
      ...
      v9 = *(unsigned __int8 *)(*(_QWORD *)(a2 + 55520) + 8LL);
...
LABEL_9:
      ...
      if ( (*(_DWORD *)(a2 + 2728) | 2) == 3 )
      {
        ...
        {
          vdev_by_user = _hdd_objmgr_get_vdev_by_user(*(_QWORD *)(a2 + 55520), 6, "__wlan_hdd_cfg80211_del_station");
          if ( vdev_by_user )
          {
            v43 = *(unsigned __int16 *)(vdev_by_user + 224);
            _hdd_objmgr_put_vdev_by_user(vdev_by_user, 6, "__wlan_hdd_cfg80211_del_station");
            if ( v43 >= 2 && policy_mgr_is_vdev_ll_lt_sap(*v20, *(unsigned __int8 *)(*(_QWORD *)(a2 + 55520) + 8LL)) )
              v35 = wlan_ll_sap_switch_bearer_on_stop_ap(*v20, *(unsigned __int8 *)(*(_QWORD *)(a2 + 55520) + 8LL));
          }
