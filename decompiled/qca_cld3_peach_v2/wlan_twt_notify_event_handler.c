...
LABEL_25:
    ...
    v24 = wlan_twt_set_peer_capabilities(a1, (unsigned __int8 *)&v60, v48);
    qdf_trace_msg(
      0x96u,
      8u,
  ...
  v14 = v27;
  if ( (wlan_vdev_mlme_is_mlo_vdev(v27, v28, v29, v30, v31, v32, v33, v34, v35) & 1) == 0 )
  {
LABEL_22:
  ...
  v24 = wlan_twt_set_wait_for_notify(a1, *(unsigned __int8 *)(v46 + 168), 0);
  v36 = *(_QWORD *)(v45 + 32);
  if ( v36 )
  {
LABEL_21:
    v26 = *(unsigned __int8 *)(v36 + 168);
    goto LABEL_22;
  }
LABEL_27:
  wlan_objmgr_vdev_release_ref(v14, 0x5Eu, (unsigned int *)v36, v37, v38, v39, v40, v41, v42, v43, v44);
  if ( !v24 )
  {
