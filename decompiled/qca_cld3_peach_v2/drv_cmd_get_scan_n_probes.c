__int64 __fastcall drv_cmd_get_scan_n_probes(__int64 a1, __int64 a2, const char *a3, __int64 a4, __int64 a5)
{
  __int64 v8; // x0
  __int64 v9; // x1
  unsigned int roam_scan_n_probes; // w0
  double v11; // d0
  double v12; // d1
  double v13; // d2
  double v14; // d3
  ...
  v44[0] = 0;
  memset(v45, 0, 32);
  roam_scan_n_probes = sme_get_roam_scan_n_probes(v8, v9, v44);
  if ( roam_scan_n_probes )
  {
    result = qdf_status_to_os_return(roam_scan_n_probes);
  }
  else
  {
    qdf_trace_msg(
