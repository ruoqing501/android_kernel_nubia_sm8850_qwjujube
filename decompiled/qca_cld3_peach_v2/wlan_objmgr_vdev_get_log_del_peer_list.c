...
LABEL_6:
  if ( a1 )
  {
    ...
    if ( a2 < 0x6E )
      _X8 = (unsigned int *)(a1 + 4LL * a2 + 244);
    else
      __break(0x5512u);
    __asm { PRFM            #0x11, [X8] }
    do
  ...
  if ( !v22 )
    goto LABEL_36;
  v31 = *(unsigned __int16 *)(a1 + 232);
  *(_QWORD *)v22 = v22;
  *(_QWORD *)(v22 + 8) = v22;
  *(_DWORD *)(v22 + 16) = 0;
  *(_DWORD *)(v22 + 20) = v31;
  v68[0] = 0;
  if ( (unsigned int)qdf_list_peek_front((_QWORD *)(a1 + 192), v68) )
    goto LABEL_34;
  v32 = v68[0] - 16LL;
  if ( v68[0] == 16 )
    goto LABEL_34;
  ...
  while ( 1 )
  {
    ...
    {
      raw_spin_lock(v32 + 768);
    }
    else
    {
      raw_spin_lock_bh(v32 + 768);
      *(__int64 *)((char *)&qword_308 + v32) |= 1uLL;
    }
    v68[0] = 0;
    v34 = qdf_list_peek_next((_QWORD *)(a1 + 192), (_QWORD *)(v32 + 16), v68);
    v43 = v68[0];
    v44 = v34;
    if ( *(_DWORD *)((char *)&qword_2F8 + v32) == 6 )
    {
      if ( *(int *)((char *)&dword_68 + v32) )
        break;
    }
    v55 = *(__int64 *)((char *)&qword_308 + v32);
    if ( (v55 & 1) != 0 )
    {
      *(__int64 *)((char *)&qword_308 + v32) = v55 & 0xFFFFFFFFFFFFFFFELL;
      raw_spin_unlock_bh(v32 + 768);
      if ( v44 )
        goto LABEL_34;
    }
    else
    {
      raw_spin_unlock(v32 + 768);
      if ( v44 )
        goto LABEL_34;
    }
LABEL_16:
  ...
  v45 = *(__int64 *)((char *)&qword_308 + v32);
  if ( (v45 & 1) != 0 )
  {
    *(__int64 *)((char *)&qword_308 + v32) = v45 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(v32 + 768);
  }
  else
  {
...
LABEL_36:
  ...
  if ( (v56 & 1) != 0 )
  {
    *(_QWORD *)(a1 + 1352) = v56 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(a1 + 1344);
  }
  else
  {
