__int64 __fastcall dfs_deinit(double a1, double a2, double a3, double a4, double a5, double a6, double a7, double a8)
{
  double v8; // d0
  double v9; // d1
  double v10; // d2
  ...
  if ( (unsigned int)wlan_objmgr_unregister_psoc_create_handler(
    ...
    qdf_trace_msg(
      0x27u,
      2u,
      "WLAN_DEBUG_DFS_ALWAYS : %s: Failed to deregister dfs psoc obj create",
      v8,
      v9,
      v10,
      v11,
  ...
  if ( (unsigned int)wlan_objmgr_unregister_psoc_destroy_handler(
    ...
    qdf_trace_msg(
      0x27u,
      2u,
      "WLAN_DEBUG_DFS_ALWAYS : %s: Failed to deregister dfs psoc obj destroy",
      v16,
      v17,
      v18,
      v19,
  ...
  if ( (unsigned int)wlan_objmgr_unregister_pdev_create_handler(
    ...
    qdf_trace_msg(
      0x27u,
      2u,
      "WLAN_DEBUG_DFS_ALWAYS : %s: Failed to deregister dfs pdev obj create",
      v24,
      v25,
      v26,
      v27,
  ...
  if ( (unsigned int)wlan_objmgr_unregister_pdev_destroy_handler(
    ...
    qdf_trace_msg(
      0x27u,
      2u,
      "WLAN_DEBUG_DFS_ALWAYS : %s: Failed to deregister dfs pdev obj destroy",
      v32,
      v33,
      v34,
      v35,
