    ...
    if ( (_BYTE)v26 )
    {
      ...
      do
      {
        if ( wlan_reg_is_5ghz_ch_freq(*a4)
          && (((__int64 (__fastcall *)(__int64, _QWORD))wlan_roam_is_channel_valid)(v22 + 5972, *a4) & 1) != 0
...
LABEL_38:
  ...
  if ( (_BYTE)v26 )
  {
    ...
    do
    {
      if ( (((__int64 (__fastcall *)(__int64, _QWORD))wlan_roam_is_channel_valid)(v22 + 5972, *a4) & 1) != 0
