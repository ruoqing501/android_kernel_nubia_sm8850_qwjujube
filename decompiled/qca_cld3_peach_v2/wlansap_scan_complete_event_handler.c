        ...
        double a11)
{
  ...
  *(_QWORD *)v74 = 0;
  ...
  if ( (result & 1) == 0 )
    goto LABEL_23;
  vdev_by_id_from_pdev = wlan_objmgr_get_vdev_by_id_from_pdev(*(_QWORD *)(v15 + 21632), *(_BYTE *)(a3 + 12), 0x2Cu);
...
LABEL_15:
    ...
    if ( v73[0] && *(_QWORD *)v74 )
    {
      ...
      *(_BYTE *)(a3 + 1496) = v44;
      v45 = _qdf_mem_malloc(0x2D8u, "wlansap_scan_complete_event_handler", 480);
      if ( !v45 )
        goto LABEL_15;
      v46 = *(const void **)v74;
      v47 = v45;
      ...
      *(_WORD *)(v45 + 18) = v73[0];
      ...
      scan_result = scm_get_scan_result(*(_QWORD *)(v15 + 21632), v47, v49, v50, v51, v52, v53, v54, v55, v56);
      _qdf_mem_free(v47);
      if ( scan_result )
      {
