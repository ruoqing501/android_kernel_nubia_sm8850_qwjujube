...
LABEL_7:
    ...
    *(_BYTE *)(v5 + 7119) = v10;
    ...
    if ( (wlan_mlme_is_primary_interface_configured(*(_QWORD *)v5) & 1) != 0
      && ((ucfg_mlme_get_dual_sta_roaming_enabled(*(_QWORD *)v5) & 1) != 0
       && (policy_mgr_concurrent_sta_on_different_mac(*(_QWORD *)v5) & 1) == 0
       || (ucfg_mlme_get_dual_sta_roaming_enabled(*(_QWORD *)v5) & 1) == 0) )
    {
      qdf_trace_msg(
        0x33u,
      ...
      qdf_trace_msg(
        ...
        "hdd_set_primary_interface",
        *((unsigned __int8 *)v7 + 8));
      wlan_cm_roam_state_change(*(_QWORD *)(v5 + 8), *((unsigned __int8 *)v7 + 8), 2u, 0x36u);
    }
    if ( (policy_mgr_current_concurrency_is_mcc(*(_QWORD *)v5) & 1) == 0 )
    {
      qdf_trace_msg(
        0x33u,
        8u,
    ...
    dual_sta_policy = wlan_mlme_get_dual_sta_policy(*(_QWORD *)v5, (_BYTE *)&v83 + 4);
    if ( dual_sta_policy )
    {
      v20 = dual_sta_policy;
    ...
    if ( v6 && !BYTE4(v83) )
    {
      qdf_trace_msg(
        ...
        v64,
        "hdd_set_primary_interface");
      ucfg_policy_mgr_get_mcc_adaptive_sch(*(_QWORD *)v5, &v83);
      if ( (unsigned __int8)v83 == 1
        && (ucfg_policy_mgr_set_dynamic_mcc_adaptive_sch(*(_QWORD *)v5, 0), (unsigned int)sme_set_mas(0)) )
      {
        v73 = "%s: Fail to disable mcc adaptive sched.";
      }
      else
      {
        mcc_duty_cycle_percentage = wlan_mlme_get_mcc_duty_cycle_percentage(*(_QWORD *)(v5 + 8));
...
LABEL_19:
    ...
    ucfg_policy_mgr_set_dynamic_mcc_adaptive_sch(*(_QWORD *)v5, 1);
