void *__fastcall hdd_copy_he_caps(_BYTE *a1, __int64 a2)
{
  ...
  result = qdf_mem_set(a1 + 723, 0x11u, 0);
  v5 = a1[723];
  a1[723] = v5 & 0xFE;
  ...
  v70 = *(_DWORD *)(a2 + 9);
  a1[732] = v64 & 0xF8;
  a1[731] = (v70 >> 1) & 0xC0 | v69;
  v71 = *(_DWORD *)(a2 + 9);
  a1[732] = v64 & 0xC0 | (v71 >> 9) & 7;
  ...
  v75 = *(_DWORD *)(a2 + 9);
  a1[733] = v74 & 0xFE;
  a1[732] = (v75 >> 9) & 0x80 | v71;
  v76 = *(_DWORD *)(a2 + 9);
  a1[733] = v74 & 0xFC | ((v76 & 0x20000) != 0);
  ...
  a1[737] = v79;
  a1[737] = (*(_QWORD *)(a2 + 9) >> 51) & 0xC0 | v79;
  a1[738] = v86 & 0xFE;
  ...
  a1[738] = v85;
  a1[738] = v85 & 0xDF | (32 * (*(_BYTE *)(a2 + 17) & 1));
  return result;
}
