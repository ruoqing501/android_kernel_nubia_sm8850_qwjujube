__int64 __fastcall wma_update_bss_peer_phy_mode(unsigned __int16 *a1, __int64 a2)
{
  ...
  v17 = wma_peer_phymode(v16, 1, v14 - 5 < 6, *((unsigned int *)a1 + 6), v14 - 11 < 0xA, v14 - 21 < 0xA, v14 - 31 < 0xA);
  if ( v17 == v14 )
  {
    qdf_trace_msg(
      0x36u,
  ...
  if ( (v47 & 1) != 0 )
  {
    *(_QWORD *)(v13 + 776) = v47 & 0xFFFFFFFFFFFFFFFELL;
  ...
  *(_DWORD *)(v45 + 192) = wmi_host_to_fw_phymode(v35);
  *((_DWORD *)a1 + 7) = v35;
  return 0;
}
