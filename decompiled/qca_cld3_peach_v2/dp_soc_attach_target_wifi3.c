...
LABEL_63:
  ...
  qdf_mem_set(a1 + 1671, 0x1078u, 0);
  hif_rtpm_register(4u, 0);
  hif_rtpm_register(5u, 0);
  *((_DWORD *)v2 + 900) = 0;
  a1[2247] = htt_t2h_stats_handler;
  a1[2243] = 0xFFFFFFFE00000LL;
  a1[2248] = a1;
  a1[2244] = a1 + 2244;
  a1[2245] = a1 + 2244;
  v93 = a1[5];
  v94 = a1[2];
  a1[2246] = _qdf_defer_func;
  ...
  v57 = 0;
  *((_BYTE *)v2 + 3712) = v2[464] & 0xFE | (unsigned __int8)v100;
LABEL_87:
