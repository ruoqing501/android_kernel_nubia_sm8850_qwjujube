        ...
        double a10)
{
  ...
  if ( a2 < 5u )
  {
    ...
    if ( !(unsigned int)dp_srng_alloc(a1, (__int64)&a1[10 * a2 + 850], 5u, v18, 0) )
    {
      ...
      {
        v24 = &a1[10 * a2];
        if ( (unsigned int)dp_srng_alloc(a1, (__int64)(v24 + 921), 0xDu, v23, 0) )
        {
        ...
        if ( v25 )
        {
          if ( *(v25 - 1) != -920731029 )
            __break(0x8228u);
          ((void (__fastcall *)(_QWORD *, _QWORD *))v25)(a1, v24 + 921);
        }
      }
      return 0;
    }
