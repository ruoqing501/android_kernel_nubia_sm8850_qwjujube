...
LABEL_7:
  ...
  if ( *(_DWORD *)(a4 + 88) == 1 )
  {
    ...
    if ( (*(_WORD *)v17 & 0x10) == 0 )
    {
      ...
      for ( i = 0; i != 384; i += 12 )
      {
        if ( *(_BYTE *)(a4 + i + 452) && !(unsigned int)qdf_mem_cmp((const void *)(a4 + i + 453), v17 + 350, 6u) )
        {
          v35 = *(_BYTE *)(a4 + 448);
          *(_BYTE *)(a4 + i + 452) = 0;
          *(_BYTE *)(a4 + 448) = --v35;
...
LABEL_27:
    ...
    qdf_trace_msg(
      ...
      *(unsigned __int8 *)(a1 + 4452),
      ...
      v17[352],
      v51);
    v37 = *(unsigned __int8 *)(*(_QWORD *)(a1 + 8) + 5604LL);
    if ( *(_DWORD *)(a4 + 88) == 1 )
    {
      v38 = *(unsigned __int8 *)(a4 + 836);
      v39 = 0;
      v36 = (_BYTE *)(a4 + 836);
      while ( !*(_BYTE *)(a4 + v39 + 840) || (unsigned int)qdf_mem_cmp((const void *)(a4 + v39 + 841), v17 + 350, 6u) )
      {
        v39 += 12;
        if ( v39 == 384 )
          goto LABEL_34;
...
LABEL_34:
    ...
    else
    {
      ...
      v40 = 32;
      v41 = (char *)(a1 + 4457);
      while ( !*(v41 - 1) || (unsigned int)qdf_mem_cmp(v41, v17 + 350, 6u) )
      {
        --v40;
        v41 += 12;
        if ( !v40 )
...
LABEL_47:
    qdf_trace_msg(
      ...
      "lim_delete_dph_hash_entry",
      HIWORD(v53));
    if ( HIWORD(v53) && !*(_BYTE *)(a1 + 14881) )
    {
      sch_set_fixed_beacon_fields(a1, a4);
    ...
    if ( (*(_WORD *)v17 & 0x400) != 0 )
    {
      ...
      qdf_trace_msg(
        ...
        v31,
        "lim_delete_dph_hash_entry",
        *((unsigned __int16 *)v17 + 174),
        v17[350],
        v17[351],
        v17[352],
        v51);
      v24 = tx_timer_delete(v17 + 376);
    }
  }
