__int64 __fastcall hdd_lte_coex_restart_sap(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a2 + 1620) = 0;
  ...
  wlan_hdd_set_sap_csa_reason(*(_QWORD *)a2, *(_BYTE *)(*(_QWORD *)(a1 + 52832) + 8LL), 7u);
  return hdd_switch_sap_channel(*(_QWORD *)(a1 + 52832), v22, 1, v23, v24, v25, v26, v27, v28, v29, v30);
}
