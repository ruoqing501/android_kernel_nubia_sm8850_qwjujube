        ...
        double a10)
{
  ...
  int v142; // w8
  _BOOL4 v143; // [xsp+8h] [xbp-38h]
  _QWORD v144[3]; // [xsp+18h] [xbp-28h] BYREF
  _QWORD v145[2]; // [xsp+30h] [xbp-10h] BYREF

  v145[1] = *(_QWORD *)(_ReadStatusReg(SP_EL0) + 1808);
  v145[0] = 0;
...
LABEL_9:
    ...
    policy_mgr_get_sta_sap_scc_allowed_on_indoor_chnl(*(_QWORD *)(v29 + 21624));
    ...
    if ( !v33 && (v145[0] & 0x200000000LL) != 0 && (v80 = a1[381]) != 0 )
    {
      is_disable_in_secondary_list_for_freq = wlan_reg_is_disable_in_secondary_list_for_freq(
                                                *(_QWORD *)(v29 + 21632),
                                                ...
                                                v68,
                                                v69);
      _2g_first_safe_chan_freq = a1[381];
    ...
    else
    {
      ...
      if ( !v92 || *(_BYTE *)(v92 + 41) != 1 )
      {
        if ( wlan_reg_is_disable_in_secondary_list_for_freq(
               ...
               *a1,
               ...
               v68,
               v69)
          && (utils_dfs_is_freq_in_nol(*(_QWORD *)(v29 + 21632), *a1) & 1) == 0 )
        {
          qdf_trace_msg(
            0x39u,
            8u,
        ...
        {
          if ( (wlan_reg_is_passive_for_freq(*(_QWORD *)(v29 + 21632), *a1, v94, v95, v96, v97, v98, v99, v100, v101) & 1) != 0 )
          {
            v110 = a1[375];
            a1[381] = *a1;
            a1[382] = v110;
          ...
          if ( (policy_mgr_is_sap_freq_allowed(*(_QWORD *)(v29 + 21624), *(_DWORD *)(*((_QWORD *)a1 + 2) + 16LL), *a1)
              & 1) != 0 )
          {
            if ( v33 != 2
              || (wlan_reg_get_keep_6ghz_sta_cli_connection(
                    *(_QWORD *)(v29 + 21632),
                    ...
                    v126)
                & 1) == 0
              || (v127 = *(_QWORD *)(v29 + 21632),
                  v128 = *a1,
                  LODWORD(v144[0]) = a1[375],
      ...
      wlansap_get_valid_freq(*(_QWORD *)(v29 + 21624), a1, v145);
      _2g_first_safe_chan_freq = v145[0];
      if ( !LODWORD(v145[0]) )
        goto LABEL_10;
    }
...
LABEL_37:
    ...
    *a2 = 9;
    v130 = a1[371];
    v131 = *(unsigned __int8 *)(*((_QWORD *)a1 + 2) + 168LL);
