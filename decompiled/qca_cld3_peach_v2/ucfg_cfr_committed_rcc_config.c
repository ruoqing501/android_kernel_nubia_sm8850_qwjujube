...
LABEL_60:
    ...
    v21 = v79[0];
    *((_BYTE *)&qword_94 + v79[0] + 5) = *(_BYTE *)(a1 + 168);
    if ( a1 )
      wlan_vdev_mlme_get_cmpt_obj(a1, v11, v12, v13, v14, v15, v16, v17, v18);
    if ( (*((_BYTE *)&qword_AC + v21 + 4) & 0x3F) == 0 )
    {
      v32 = *(_QWORD *)(v20 + 2808);
      if ( v32 && *(_QWORD *)v32 )
      {
...
LABEL_55:
    ...
    if ( (*((_BYTE *)&qword_AC + v21 + 4) & 2) != 0 )
    {
      LODWORD(v77) = 536870915;
      WORD4(v77) = 0x2000;
      if ( (*((_BYTE *)&qword_AC + v21 + 4) & 8) == 0 )
      {
LABEL_19:
        if ( (*((_BYTE *)&qword_AC + v21 + 4) & 0x20) == 0 )
          goto LABEL_20;
        goto LABEL_34;
      }
    }
    else if ( (*((_BYTE *)&qword_AC + v21 + 4) & 8) == 0 )
    {
      goto LABEL_19;
    }
    LOWORD(v77) = v77 | 3;
    ...
    {
LABEL_20:
      if ( (*((_BYTE *)&qword_AC + v21 + 4) & 0x10) == 0 )
        goto LABEL_21;
      goto LABEL_35;
    }
LABEL_34:
