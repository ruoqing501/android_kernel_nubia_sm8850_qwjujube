__int64 __fastcall lim_update_tx_pwr_on_ctry_change_cb(
        unsigned __int8 a1,
        double a2,
        double a3,
        double a4,
  ...
  if ( wlan_reg_is_6ghz_chan_freq(*(_DWORD *)(session_by_vdev_id + 284)) )
  {
    if ( (unsigned int)wlan_reg_get_best_6g_power_type(
                         ...
                         *(_DWORD *)(v21 + 284),
                         ...
                         v29) )
    {
      result = lim_is_sb_disconnect_allowed_fl(v21, (__int64)"lim_update_tx_pwr_on_ctry_change_cb", 0x2F8Bu);
      if ( (result & 1) != 0 )
      {
        qdf_trace_msg(
          0x35u,
          ...
          v46,
          "lim_update_tx_pwr_on_ctry_change_cb");
        lim_send_deauth_mgmt_frame(v19, 0xAu, (void *)(v21 + 24), v21, 0, v47, v48, v49, v50, v51, v52, v53, v54);
    ...
    v57 = *(_QWORD *)(v21 + 16);
    *(_BYTE *)(v21 + 10069) = v60;
    mlme_set_best_6g_power_type(v57, v56, v30, v31, v32, v33, v34, v35, v36, v37);
  }
  v58 = *(_QWORD *)(v21 + 112);
  if ( v58 )
    v59 = v58 + 4548;
    ...
    v59 = 0;
  result = lim_set_tpc_power(v19, v21, v59, 0, v22, v23, v24, v25, v26, v27, v28, v29);
LABEL_15:
