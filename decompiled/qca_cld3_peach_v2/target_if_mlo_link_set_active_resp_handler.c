__int64 __fastcall target_if_mlo_link_set_active_resp_handler(
        __int64 a1,
        __int64 a2,
        double a3,
        double a4,
...
LABEL_13:
  ...
  if ( (unsigned int)wmi_extract_mlo_link_set_active_resp(v22, a2, &v29) )
  {
    v24 = "%s: Unable to extract mlo link set active resp";
LABEL_15:
    qdf_trace_msg(
      0x49u,
      2u,
  ...
  if ( v26 )
  {
    if ( *(v26 - 1) != -1560588644 )
      __break(0x8228u);
    ((void (__fastcall *)(__int64, _QWORD, __int64 *))v26)(v23, 0, &v29);
  }
  v27 = *(__int64 (__fastcall **)(__int64, __int64 *))(v20 + 1232);
  if ( *((_DWORD *)v27 - 1) != -1862838523 )
    __break(0x8228u);
  v28 = v27(v23, &v29);
