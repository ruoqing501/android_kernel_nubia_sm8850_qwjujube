        ...
        __int64 a5)
{
  ...
  __int16 v56; // w10
  __int64 result; // x0
  size_t v58; // [xsp+0h] [xbp-10h] BYREF
  ...
  if ( v24 >= *(unsigned __int8 *)(a1 + 21668) )
    v25 = *(unsigned __int8 *)(a1 + 21668);
  else
    v25 = v24;
  ...
  v26 = *(_QWORD *)(a1 + 8);
  v58 = 16;
  wlan_mlme_get_cfg_str(a3 + 4, v26 + 3056, &v58, v27, v28, v29, v30, v31, v32, v33, v34);
  if ( !wlan_reg_is_5ghz_ch_freq(*(_DWORD *)(a5 + 284))
    || (wlan_reg_is_dfs_for_freq(*(_QWORD *)(a1 + 21632), *(_DWORD *)(a5 + 284), v15, v16, v17, v18, v19, v20, v21, v22)
      & 1) != 0
    || ((v13 ^ 1) & 1) != 0 )
  {
    if ( *(_DWORD *)(a5 + 7176) )
...
LABEL_18:
  qdf_trace_msg(
    ...
    *a3,
    ...
    v58,
    v59);
  if ( (!wlan_reg_is_24ghz_ch_freq(*(_DWORD *)(a5 + 284)) || (*(_BYTE *)(v12 + 2875) & 1) == 0)
  ...
  *((_WORD *)a4 + 3) = v51;
  v52 = *((_WORD *)a4 + 6);
  *((_WORD *)a4 + 4) = v49 & 0xE000 | *(_WORD *)(v12 + 2844) & 0x1FFF;
  v53 = *(_WORD *)(v12 + 2840);
  *((_WORD *)a4 + 5) = v53;
  v54 = *(_WORD *)(v12 + 2848);
  *((_WORD *)a4 + 5) = v53 | v48;
  *((_WORD *)a4 + 3) = v51 | v48;
  *((_WORD *)a4 + 6) = v52 & 0xE000 | v54 & 0x1FFF;
  if ( (unsigned int)(v50 - 1) <= 3 )
  {
    v55 = *a4;
    v56 = vht_supported_datarate_bw80_gi400ns[v50 - 1] & 0x1FFF;
    *((_WORD *)a4 + 6) = v56 | v52 & 0xE000;
    *((_WORD *)a4 + 4) = v56 | v49 & 0xE000;
LABEL_33:
  ...
  __break(0x5512u);
  return lim_ieee80211_pack_ehtcap_tdls(v44, v45, v46);
}
