...
LABEL_61:
    ...
    v25 = ext_hdl + 20480;
    qdf_mem_copy((void *)(ext_hdl + 23896), (const void *)(*(_QWORD *)(a1 + 8) + 1308LL), 0x3Cu);
    *(_BYTE *)(v25 + 3416) = 1;
    v26 = *(_DWORD *)(v14 + 16);
    if ( v26 != 3 )
    {
...
LABEL_10:
      ...
      {
        v29 = 25;
        qdf_mem_copy((void *)(v25 + 3449), (const void *)(*(_QWORD *)(a1 + 8) + 1453LL), 0x19u);
        if ( !*(_BYTE *)(v25 + 3473) )
        {
          if ( *(_BYTE *)(v25 + 3472) )
          {
      ...
      *(_BYTE *)(v25 + 3448) = v29;
      v16 = (unsigned int *)*(unsigned int *)(*(_QWORD *)(a1 + 8) + 1488LL);
