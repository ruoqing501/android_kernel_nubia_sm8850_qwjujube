        ...
        double a11)
{
  ...
  __int64 *v86; // x21
  char v87[4]; // [xsp+8h] [xbp-38h] BYREF
  int v88; // [xsp+Ch] [xbp-34h] BYREF
  __int64 v89; // [xsp+10h] [xbp-30h] BYREF
  __int64 v90; // [xsp+18h] [xbp-28h] BYREF
  __int64 v91; // [xsp+20h] [xbp-20h]
  __int64 v92; // [xsp+28h] [xbp-18h]
  char v93[4]; // [xsp+34h] [xbp-Ch] BYREF
  ...
  if ( (*(_QWORD *)(*(_QWORD *)(v15 + 52832) + 5968LL) & 2) != 0 )
  {
    if ( !v16[2] )
    {
...
LABEL_30:
    ...
    else
    {
      ...
      if ( (v88 & 0xFFFFFFFD) == 9 )
      {
        queue_work_on(32, system_wq, v19 + 757);
        wlansap_context_put(v18);
    ...
    ucfg_policy_mgr_get_mcc_scc_switch(*v16, v93);
    policy_mgr_get_chan_by_session_id(a1, a2, (_DWORD *)&v89 + 1);
    if ( (policy_mgr_is_restart_sap_required(*v16, a2, HIDWORD(v89), (unsigned __int8)v93[0], v18[378]) & 1) != 0 )
    {
