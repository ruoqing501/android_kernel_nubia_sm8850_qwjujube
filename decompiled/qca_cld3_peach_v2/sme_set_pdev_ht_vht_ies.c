__int64 __fastcall sme_set_pdev_ht_vht_ies(__int64 result, char a2)
{
  ...
  {
    v6 = result;
    result = qdf_mutex_acquire(result + 12848);
    if ( !(_DWORD)result )
    {
      ...
      if ( v8 )
      {
        ...
        *(_DWORD *)(v8 + 4) = 0;
        *(_DWORD *)(v8 + 8) = v10;
        v11 = csr_translate_to_wni_cfg_dot11_mode(v6, *(unsigned int *)(v6 + 17204));
      ...
      return qdf_mutex_release(v6 + 12848);
    }
  }
  return result;
}
