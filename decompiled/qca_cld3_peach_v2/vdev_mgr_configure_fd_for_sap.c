__int64 __fastcall vdev_mgr_configure_fd_for_sap(__int64 a1)
{
  ...
  if ( v2 && (wlan_reg_is_6ghz_chan_freq(*v2) & 1) != 0 && (!*(_DWORD *)(a1 + 456) || !*(_DWORD *)(a1 + 460)) )
  {
    v13 = *(_DWORD *)(*(_QWORD *)(a1 + 520) + 56LL);
    qdf_trace_msg(
      0x68u,
      8u,
      "%s: SAP FD enabled %d",
      ...
      v13 >> 31);
    LOBYTE(v22) = *(_BYTE *)(*(_QWORD *)(a1 + 520) + 168LL);
    if ( (wlan_mlme_is_fd_disabled_in_6ghz_band() & 1) == 0 )
    {
      ...
      else if ( (*(_BYTE *)(*(_QWORD *)(a1 + 520) + 60LL) & 8) != 0 )
      {
        LOBYTE(v23) = 1;
        HIDWORD(v22) = 20;
      }
