__int64 __fastcall hdd_get_sap_tx_nss(
        _DWORD *a1,
        _BYTE *a2,
        double a3,
        double a4,
...
LABEL_11:
    qdf_trace_msg(0x33u, 8u, v37, a3, a4, a5, a6, a7, a8, a9, a10, "hdd_get_sap_tx_nss");
    result = 4;
    goto LABEL_15;
  }
  ...
  {
    vdev_by_user = _hdd_objmgr_get_vdev_by_user(a1, 6, "hdd_get_sap_tx_nss");
    if ( vdev_by_user )
    {
      v17 = vdev_by_user;
      ...
      if ( dynamic_vdev_config )
      {
        ...
        {
          v35 = *(_DWORD *)(dynamic_vdev_config + 20);
        }
        else
        {
          ...
          v35 = *(_DWORD *)(dynamic_vdev_config + 16);
        }
LABEL_13:
        *a2 = v35;
LABEL_14:
        _hdd_objmgr_put_vdev_by_user(v17, 6, "hdd_get_sap_tx_nss");
        result = 0;
        goto LABEL_15;
      }
      _hdd_objmgr_put_vdev_by_user(v17, 6, "hdd_get_sap_tx_nss");
