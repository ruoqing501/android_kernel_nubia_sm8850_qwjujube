__int64 __fastcall lim_handle80211_frames(__int64 a1, unsigned __int16 *a2, _BYTE *a3)
{
  ...
  __int64 preauth_vdev_session; // x0
  double v117; // d0
  double v118; // d1
  double v119; // d2
  double v120; // d3
  ...
  const char *v129; // x2
  char v130; // w22
  unsigned __int16 *v131; // [xsp+28h] [xbp-78h]
  unsigned int v132; // [xsp+34h] [xbp-6Ch]
  unsigned int v133; // [xsp+38h] [xbp-68h]
  unsigned __int8 v134; // [xsp+3Ch] [xbp-64h]
  unsigned __int8 *v135; // [xsp+40h] [xbp-60h]
  unsigned __int16 *v136; // [xsp+48h] [xbp-58h]
  unsigned __int8 *v137; // [xsp+50h] [xbp-50h]
  _BYTE v138[4]; // [xsp+5Ch] [xbp-44h] BYREF
  unsigned int *v139; // [xsp+60h] [xbp-40h] BYREF
  _QWORD *v140; // [xsp+68h] [xbp-38h] BYREF
  _QWORD *v141; // [xsp+70h] [xbp-30h] BYREF
  __int64 v142; // [xsp+78h] [xbp-28h] BYREF
  __int64 v143; // [xsp+80h] [xbp-20h]
  __int64 v144; // [xsp+88h] [xbp-18h]
  __int64 v145; // [xsp+90h] [xbp-10h]
  __int64 v146; // [xsp+98h] [xbp-8h]
  ...
  *a3 = 0;
  ...
  v139 = nullptr;
  v138[0] = 0;
  lim_get_b_dfrom_rx_packet(a1, v5, &v139);
  v6 = *(unsigned __int8 **)((char *)&off_10 + (_QWORD)v139);
  v7 = *v139;
  v8 = *(unsigned __int16 *)v6;
  is_hw_sbs_capable = policy_mgr_is_hw_sbs_capable(*(_QWORD *)(a1 + 21624));
  if ( wlan_reg_is_5ghz_ch_freq(v7)
    && ((is_hw_sbs_capable & 1) == 0
     || (wlan_reg_is_dfs_for_freq(*(_QWORD *)(a1 + 21632), v7, v11, v12, v13, v14, v15, v16, v17, v18) & 1) != 0) )
  {
    if ( *(_BYTE *)(a1 + 14881) )
    {
      session_by_bssid = pe_find_session_by_bssid(a1, v6 + 16, v138);
      if ( session_by_bssid )
      {
  ...
  v21 = pe_find_session_by_bssid(a1, v6 + 16, v138);
  if ( !v21 )
  {
    ...
    if ( v30 <= 0xD )
    {
      ...
      if ( v30 == 11 )
      {
        ...
        qdf_trace_msg(
          ...
          v68,
          v69);
        if ( !(unsigned int)lim_process_auth_frame_no_session(a1, v139, v87, v88, v89, v90, v91, v92, v93, v94) )
          goto LABEL_114;
      }
    }
    session_by_peer_sta = pe_find_session_by_peer_sta(a1, v6 + 10, v138);
    ...
    if ( v30 == 13 )
LABEL_16:
      v21 = pe_find_session_by_bssid(a1, v6 + 4, v138);
  }
LABEL_17:
  v134 = v8;
  v31 = v139;
  ...
  v141 = nullptr;
  v32 = v21;
  v33 = *(unsigned __int16 *)((char *)&qword_28 + (_QWORD)v139);
  v135 = v6;
  v136 = v3;
  v131 = *(unsigned __int16 **)((char *)&off_10 + (_QWORD)v139);
  v137 = *(unsigned __int8 **)((char *)&off_10 + (_QWORD)v139 + 8);
  v133 = *v131;
  qdf_mutex_acquire(a1 + 12280);
  qdf_list_peek_front((_QWORD *)(a1 + 12344), &v141);
...
LABEL_28:
  ...
  while ( 1 )
  {
    ...
    if ( (v44 & 0xC) == 0 && !v43 && v45 == 15 )
      break;
    if ( v44 == (v133 & 0xF0 | (4 * ((v133 >> 2) & 3))) )
    {
      v47 = *((unsigned __int16 *)v42 + 9);
      if ( !*((_WORD *)v42 + 9) || v33 >= (unsigned int)v47 && !(unsigned int)qdf_mem_cmp((char *)v42 + 22, v137, v47) )
      {
        v48 = v45 != 15;
        goto LABEL_39;
      }
    ...
    qdf_mutex_acquire(a1 + 12280);
    qdf_list_peek_next((_QWORD *)(a1 + 12344), v141, &v140);
    qdf_mutex_release(a1 + 12280);
    v42 = v140;
    v140 = nullptr;
    v141 = v42;
...
LABEL_39:
  ...
  if ( v32 )
  {
    if ( *(_DWORD *)(v32 + 88) == 2 )
    {
      ...
      v142 = 0;
      v143 = 0;
      wlan_cm_roam_cfg_get_value(v55, v54, 0x1Fu, &v142);
      if ( (unsigned __int8)v143 == 1 )
      {
...
LABEL_58:
      ...
      {
LABEL_96:
        if ( v137 && v33 >= 2 && (v133 & 0xFC) == 0xD0 && *v137 == 10 && (unsigned int)v137[1] - 6 <= 2 )
        {
          if ( v33 < 3 )
            v125 = 0;
          else
          ...
          if ( is_mbo_ap_without_pmf )
            v129 = "%s: Drop the BTM frame as it's received from MBO AP without PMF, vdev %d";
          else
            v129 = "%s: Drop the BTM frame as p2p session is active, vdev %d";
          if ( is_mbo_ap_without_pmf )
            v130 = 1;
          else
            v130 = 2;
          qdf_trace_msg(0x35u, 8u, v129, v71, v72, v73, v74, v75, v76, v77, v78, "lim_is_ignore_btm_frame", v54);
          wlan_cm_roam_btm_block_event(v54, v125, v130);
          goto LABEL_114;
        }
      }
    }
...
LABEL_29:
  if ( (v51 & 3) != 0 )
  {
    qdf_trace_msg(
      ...
      "lim_handle80211_frames",
      v51 & 3);
    lim_pkt_free(a1, 3, v139, *((_QWORD *)v3 + 1));
    goto LABEL_114;
  }
  if ( v132 )
    goto LABEL_114;
  ...
  if ( v52 > 4 )
  {
    if ( (unsigned __int8)(v51 >> 4) > 0xAu )
    {
      switch ( v52 )
      {
        case 0xBu:
          ...
          if ( preauth_vdev_session )
            v50 = preauth_vdev_session;
          lim_process_auth_frame(a1, (__int64)v139, v50, v117, v118, v119, v120, v121, v122, v123, v124);
          break;
        case 0xCu:
          lim_process_deauth_frame(a1, (__int64)v139, v50, v34, v35, v36, v37, v38, v39, v40, v41);
          break;
        case 0xDu:
          qdf_trace_msg(
            0x35u,
          ...
          if ( v50 )
          {
            if ( (*(_BYTE *)(*(_QWORD *)(a1 + 8) + 1060LL) & 8) != 0 )
              v79 = ((double (__fastcall *)(__int64, __int64, unsigned __int8 *, _QWORD))qdf_trace_hex_dump)(
                      ...
                      8,
                      v49,
                      (unsigned int)(*(_DWORD *)((char *)&qword_28 + (_QWORD)v139) + 24));
            lim_process_action_frame(a1, (__int64)v139, v50, v79, v80, v81, v82, v83, v84, v85, v86);
          }
          else
          {
            lim_process_action_frame_no_session(a1, v139, v79, v80, v81, v82, v83, v84, v85, v86);
          }
          break;
      }
    }
    else
    {
      switch ( v52 )
      {
        case 5u:
          if ( v50 )
            lim_process_probe_rsp_frame(a1, v139, v50);
          break;
        case 8u:
          _lim_handle_beacon(a1, v3, v50);
          break;
        case 0xAu:
          lim_process_disassoc_frame(a1, (__int64)v139, v50, v34, v35, v36, v37, v38, v39, v40, v41);
          break;
      }
    }
    goto LABEL_111;
  ...
  if ( (unsigned __int8)(v51 >> 4) > 1u )
  {
    if ( v52 != 2 )
    {
      ...
      {
        if ( v52 == 4 )
          lim_process_probe_req_frame_multiple_bss(a1, v139, v50);
        goto LABEL_111;
      }
      v109 = v139;
      v110 = a1;
...
LABEL_114:
  result = lim_pkt_free(a1, 3, v139, *((_QWORD *)v3 + 1));
