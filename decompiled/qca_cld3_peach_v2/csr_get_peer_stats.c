__int64 __fastcall csr_get_peer_stats(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  __int16 v58; // [xsp+14h] [xbp-3Ch]
  _QWORD v59[2]; // [xsp+18h] [xbp-38h] BYREF
  int v60; // [xsp+28h] [xbp-28h]
  int v61; // [xsp+2Ch] [xbp-24h]
  _QWORD v62[4]; // [xsp+30h] [xbp-20h] BYREF

  v62[3] = *(_QWORD *)(_ReadStatusReg(SP_EL0) + 1808);
  v5 = *(_QWORD *)(a1 + 21624);
  v57 = a3;
  v58 = WORD2(a3);
  memset(v62, 0, 24);
    ...
    *(_DWORD *)(psoc_ext_obj_fl + 7660) = 0;
    ...
    if ( v16 )
    {
      ...
      *(_BYTE *)(v15 + 7656) = v60;
      ...
      if ( !v29 )
      {
        qdf_mc_timer_start(v15 + 7664, 0xC8u);
