__int64 __fastcall lim_del_sta(__int64 a1, __int64 a2, char a3, __int64 a4)
{
  ...
  if ( v8 )
  {
    ...
    *((_BYTE *)v9 + 8) = v28;
    lim_mlo_notify_peer_disconn(a4, a2);
    lim_mlo_delete_link_peer(a4, a2);
    *((_BYTE *)v9 + 9) = *(_BYTE *)(a4 + 8);
    *((_BYTE *)v9 + 10) = *(_BYTE *)(a4 + 10);
    *((_BYTE *)v9 + 11) = *(_BYTE *)(a2 + 356);
    qdf_mem_copy(v9 + 6, (const void *)(a2 + 350), 6u);
    *((_DWORD *)v9 + 1) = 0;
    v50 = v9;
    v30 = *(unsigned __int8 *)(a2 + 350);
    v49 = 4131;
    qdf_trace_msg(
      0x35u,
      8u,
