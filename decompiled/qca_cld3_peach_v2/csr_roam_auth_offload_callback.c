__int64 __fastcall csr_roam_auth_offload_callback(_QWORD *a1, unsigned int a2, __int64 a3, int a4)
{
  ...
  result = sme_acquire_global_lock((__int64)(a1 + 1605));
  if ( !(_DWORD)result )
  {
    v32 = a3;
    v33 = WORD2(a3);
    ...
    if ( (unsigned __int8)a2 <= 5u && a1[2162] + 96LL * (unsigned __int8)a2 )
    {
      ...
      if ( v17 )
      {
        ...
        *(_QWORD *)(v18 + 328) = &v34;
        if ( a1 && (v28 = a1[2162]) != 0 && (*(_BYTE *)(v28 + 96LL * (unsigned __int8)a2 + 1) & 1) != 0 )
        {
          wlan_get_operation_chan_freq_vdev_id(a1[2704], a2);
          v29 = (_DWORD *)a1[2755];
          if ( v29 )
          {
            v30 = a1[2703];
