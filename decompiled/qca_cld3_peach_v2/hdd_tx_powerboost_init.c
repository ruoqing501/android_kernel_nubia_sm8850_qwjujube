...
LABEL_10:
    ...
    qdf_trace_msg(
      ...
      v39,
      "hdd_tx_powerboost_init_dma");
    _qdf_wake_lock_create((_QWORD *)(a1 + 8616), (__int64)"txpb_wake_lock");
    _qdf_runtime_lock_init((__int64 *)(a1 + 8816), "&hdd_ctx->tx_pb.txpb_runtime_lock");
    qdf_mutex_create(a1 + 8848);
    *(_QWORD *)(a1 + 8824) = a1 + 8824;
    *(_QWORD *)(a1 + 8832) = a1 + 8824;
    v60 = *(_QWORD *)a1;
    *(_QWORD *)(a1 + 8840) = 0x500000000LL;
