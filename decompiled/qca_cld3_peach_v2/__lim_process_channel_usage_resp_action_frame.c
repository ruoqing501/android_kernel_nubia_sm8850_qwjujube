  ...
  if ( *(_DWORD *)(a3 + 7036) == 2 )
  {
    ...
    if ( (*(_BYTE *)(a3 + 13288) & 2) != 0 )
    {
      ...
      else if ( v9 >= 0x1D )
      {
        ...
        if ( v9 >= v23 + 32 )
        {
          qdf_mem_set((void *)(a3 + 13740), 0x104u, 0);
          v24 = dot11f_unpack_channel_usage_resp(v8, v6, (unsigned int)(v23 + 29), a3 + 13740, 0);
          if ( (v24 & 0x10000000) != 0 )
          {
            return qdf_trace_msg(
                     0x35u,
          ...
          else
          {
            if ( v24 )
              qdf_trace_msg(
                ...
                v3,
                v35);
            if ( v5[1456] == v5[1020] && v5[1454] == v5[1018] )
            {
              v33 = (unsigned __int8)v5[1457];
              v5[1000] &= ~2u;
              if ( !v33 || (v33 & 1) != 0 )
              {
