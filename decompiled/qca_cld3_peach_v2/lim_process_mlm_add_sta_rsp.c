__int64 __fastcall lim_process_mlm_add_sta_rsp(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        double a4,
        ...
        double a11)
{
  ...
  *(_QWORD *)(a1 + 8888) = "lim_process_mlm_add_sta_rsp";
  *(_BYTE *)(a1 + 8885) = 1;
  ...
  if ( *(_DWORD *)(a3 + 88) == 1 )
    result = lim_process_ap_mlm_add_sta_rsp(a1, a2, a3);
  else
    result = lim_process_sta_mlm_add_sta_rsp(a1, a2, a3);
