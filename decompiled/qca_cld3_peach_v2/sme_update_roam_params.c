...
LABEL_30:
  ...
  if ( a5 > 26 )
  {
    if ( a5 == 27 )
    {
      qdf_mem_set((void *)(v11 + 2569), 0x60u, 0);
      v43 = *a3;
      *(_BYTE *)(v11 + 2568) = v43;
      if ( v43 )
      {
        ...
        {
          v46 = v11 + v44;
          v47 = *(_DWORD *)&a3[v44 - 2568];
          *(_WORD *)(v46 + 4) = *(_WORD *)&a3[v44 - 2564];
          *(_DWORD *)v46 = v47;
          if ( v44 == 2665 )
            goto LABEL_16;
          v48 = v45 - 2664;
          v44 += 6;
          *(_BYTE *)(v11 + v45) = a3[v45 - 2568];
          ++v45;
          if ( v48 >= *(unsigned __int8 *)(v11 + 2568) )
            goto LABEL_27;
        }
      }
    }
    ...
    {
      *(_DWORD *)(v11 + 2684) = *((_DWORD *)a3 + 29);
    }
    goto LABEL_27;
  }
  if ( a5 == 25 )
  {
    *(_DWORD *)(*(_QWORD *)(a1 + 8) + 1872LL) = *((_DWORD *)a3 + 32);
    *(_DWORD *)(*(_QWORD *)(a1 + 8) + 1884LL) = *((_DWORD *)a3 + 33);
    *(_DWORD *)(*(_QWORD *)(a1 + 8) + 1876LL) = a3[136];
    *(_DWORD *)(*(_QWORD *)(a1 + 8) + 1888LL) = a3[137];
    *(_DWORD *)(*(_QWORD *)(a1 + 8) + 1880LL) = *((_DWORD *)a3 + 35);
    *(_DWORD *)(v11 + 2688) = *((_DWORD *)a3 + 30);
    *(_DWORD *)(v11 + 2692) = *((_DWORD *)a3 + 31);
    *(_BYTE *)(*(_QWORD *)(a1 + 8) + 1765LL) = 1;
LABEL_27:
    if ( !(unsigned int)qdf_mutex_acquire(a1 + 12848) )
    {
      wlan_roam_update_cfg(*(_QWORD *)(a1 + 21624), a2, a5);
