__int64 __fastcall policy_mgr_is_sta_present_on_freq(__int64 a1, _BYTE *a2, int a3, _DWORD *a4)
{
  ...
  if ( context )
  {
    ...
    if ( BYTE4(qword_8D4F00) == 1
      ...
      && (v17 = &qword_8D4F0C, HIDWORD(qword_8D4F0C) == a3)
      || BYTE4(qword_8D4F48) == 1
      && ((unsigned int)qword_8D4F30 | 2) == 2
      && (v17 = &qword_8D4F30, HIDWORD(qword_8D4F30) == a3)
      || BYTE4(qword_8D4F6C) == 1
      && ((unsigned int)qword_8D4F54 | 2) == 2
      && (v17 = &qword_8D4F54, HIDWORD(qword_8D4F54) == a3)
      || BYTE4(qword_8D4F90) == 1
      && ((unsigned int)qword_8D4F78 | 2) == 2
      && (v17 = &qword_8D4F78, HIDWORD(qword_8D4F78) == a3) )
    {
      *a2 = *((_DWORD *)v17 + 6);
      *a4 = *((_DWORD *)v17 + 2);
      v18 = 1;
