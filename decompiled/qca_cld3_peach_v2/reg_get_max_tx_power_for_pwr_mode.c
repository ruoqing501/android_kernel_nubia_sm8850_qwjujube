        ...
        double a10)
{
  ...
  {
    v31 = jiffies;
    if ( reg_get_max_tx_power_for_pwr_mode___last_ticks_77 - jiffies + 125 < 0 )
    {
      qdf_trace_msg(
        0x51u,
        2u,
      ...
      reg_get_max_tx_power_for_pwr_mode___last_ticks_77 = v31;
      return 4;
    }
    return 4;
  }
  ...
  {
    v30 = jiffies;
    if ( reg_get_max_tx_power_for_pwr_mode___last_ticks_78 - jiffies + 125 < 0 )
    {
      qdf_trace_msg(
        0x51u,
        2u,
        ...
        v19,
        "reg_get_max_tx_power_for_pwr_mode");
      reg_get_max_tx_power_for_pwr_mode___last_ticks_78 = v30;
    }
    return 0;
  }
  return result;
