__int64 __fastcall dp_txrx_nss_request(__int64 a1, unsigned __int8 a2, _DWORD **a3)
{
  ...
  v6 = _qdf_mem_malloc(0xA758u, "dp_txrx_nss_request", 11526);
  if ( v6 )
  {
    v7 = (_DWORD *)v6;
    v8 = 1;
      ...
      if ( *(_BYTE *)(a1 + 20103) == 1 )
      {
        ...
        else
        {
          if ( a2 <= 5u )
          {
            ...
            if ( v19 )
            {
              ...
              while ( v21 )
              {
                ...
                if ( _ZF )
                {
                  ...
                  if ( (v43 & 1) != 0 )
                  {
                    *(_QWORD *)(a1 + 18992) = v43 & 0xFFFFFFFFFFFFFFFELL;
                  ...
                  *(_BYTE *)(v17 + 96312) = 1;
                  ...
                  if ( !v8 )
                  {
                    v8 = qdf_wait_single_event(v17 + 96272, 0x64u);
                    if ( !v8 )
                    {
                      **a3 = v19[11553];
                      v28 = (unsigned int *)(unsigned int)v19[11554];
                      *a3[1] = (_DWORD)v28;
                    }
                  }
            ...
            if ( (v37 & 1) != 0 )
            {
              *(_QWORD *)(a1 + 18992) = v37 & 0xFFFFFFFFFFFFFFFELL;
              raw_spin_unlock_bh(a1 + 18984);
            }
            else
            {
