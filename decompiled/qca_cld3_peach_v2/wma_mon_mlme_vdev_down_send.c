        ...
        double a9)
{
  ...
  if ( context )
  {
    v19 = *(unsigned __int8 *)(*(_QWORD *)(a1 + 520) + 168LL);
    v20 = *(_QWORD *)(context[65] + 488LL * *(unsigned __int8 *)(*(_QWORD *)(a1 + 520) + 168LL));
...
LABEL_10:
    qdf_trace_msg(
      ...
      v19);
LABEL_11:
    wlan_vdev_mlme_sm_deliver_evt(*(_QWORD *)(a1 + 520), 0x1Bu, 0, 0, v31, v32, v33, v34, v35, v36, v37, v38);
    return v30;
  }
  return 4;
}
