__int64 __fastcall ucfg_dp_update_config(__int64 a1, unsigned __int8 *a2)
{
  ...
  if ( comp_private_obj )
  {
    ...
    *(_DWORD *)(comp_private_obj + 1196) = *((_DWORD *)a2 + 1);
    ...
    v15 = *(_BYTE *)(cfg_psoc_get_values(a1) + 410);
    v16 = *(_BYTE *)(cfg_psoc_get_values(a1) + 411);
    v17 = v15 | (2 * v16);
    v13[216] = v16;
    v47 = *(_DWORD *)(cfg_psoc_get_values(a1) + 564);
    v48 = *(_DWORD *)(cfg_psoc_get_values(a1) + 560);
    v18 = (unsigned __int8)(v17 | (8 * *(_BYTE *)(cfg_psoc_get_values(a1) + 4252))) | ((unsigned __int8)v13[372] << 8);
    v19 = 16 * (*(_BYTE *)(cfg_psoc_get_values(a1) + 431) & 1);
    v20 = 32 * (*(_BYTE *)(cfg_psoc_get_values(a1) + 430) & 1);
    values = cfg_psoc_get_values(a1);
    v22 = *a2;
    v23 = (*(_BYTE *)(values + 429) & 1) << 6;
    v13[217] = *(_DWORD *)(cfg_psoc_get_values(a1) + 416) != 0;
    v24 = cfg_psoc_get_values(a1);
    v25 = 4 * (v13[217] & 1);
    v13[221] = *(_BYTE *)(v24 + 4126);
    v46 = v18 | v19 | v20 | v23 | (v22 << 9) | v25;
    cfg_psoc_get_values(a1);
    cfg_psoc_get_values(a1);
    cfg_psoc_get_values(a1);
    v49 = *(_DWORD *)(cfg_psoc_get_values(a1) + 4084);
    v50 = *(_DWORD *)(cfg_psoc_get_values(a1) + 4088);
    v51 = *(_DWORD *)(cfg_psoc_get_values(a1) + 4092);
    if ( context && *context )
    {
      v34 = **context;
