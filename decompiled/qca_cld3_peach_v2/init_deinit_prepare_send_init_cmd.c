        ...
        double a10)
{
  ...
  __int64 v61; // x8
  unsigned int v62; // w8
  __int64 v63; // [xsp+20h] [xbp-50h] BYREF
  __int64 v64; // [xsp+28h] [xbp-48h]
  __int64 v65; // [xsp+30h] [xbp-40h]
  __int64 v66; // [xsp+38h] [xbp-38h]
  __int64 v67; // [xsp+40h] [xbp-30h]
  __int64 v68; // [xsp+48h] [xbp-28h]
  __int64 v69; // [xsp+50h] [xbp-20h]
  __int64 v70; // [xsp+58h] [xbp-18h]
  __int64 v71; // [xsp+60h] [xbp-10h]
...
LABEL_6:
  ...
  else
  {
    ...
    if ( !v24 )
      v24 = 11;
    LODWORD(v66) = v24;
    init_deinit_derive_band_to_mac_param(v14, v15, v16, v17, v18, v19, v20, v21, a1, a2, (__int64)&v63);
  }
  v25 = *(_QWORD *)(a2 + 5792);
  if ( !v25 )
    goto LABEL_21;
...
LABEL_21:
      ...
      *(_DWORD *)(a2 + 404) = *(_DWORD *)(a2 + 996);
      ...
      if ( (wmi_service_enabled(v11, 290) & 1) != 0 )
        v47 = 2;
      else
        v47 = *(_BYTE *)(a2 + 1000);
      *(_BYTE *)(a2 + 433) = v47;
      ...
      if ( (wmi_service_enabled(v11, 244) & 1) != 0 )
        *(_DWORD *)(v63 + 180) = 2;
      v59 = *(_DWORD ***)(a2 + 5792);
      if ( v59 )
      {
      ...
      *(_BYTE *)(a2 + 421) = 0;
      if ( a1 )
      {
        ...
        if ( v61 )
        {
          ...
          if ( v62 )
          {
            if ( v62 >= *(_DWORD *)(a2 + 428) )
              LOWORD(v62) = *(_DWORD *)(a2 + 428);
      ...
      wmi_unified_init_cmd_send(v11, &v63);
