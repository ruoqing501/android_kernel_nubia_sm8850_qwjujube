__int64 __fastcall drv_cmd_get_linkspeed(__int64 a1, __int64 a2, const char *a3, __int64 a4, __int64 a5)
{
  __int64 result; // x0
  ...
  v32 = 0;
  memset(v33, 0, 32);
  result = wlan_hdd_get_link_speed(a1, &v32);
  if ( !(_DWORD)result )
  {
    scnprintf(v33, 32, "%s %d", a3, v32);
    v9 = *(_DWORD *)(a5 + 12);
    if ( v9 > v8 )
      LOBYTE(v9) = v8 + 1;
