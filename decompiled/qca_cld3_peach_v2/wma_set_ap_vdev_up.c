        ...
        double a10)
{
  ...
  v12 = *(_QWORD *)(a1[65] + 488LL * (unsigned __int8)a2);
  ...
  if ( cmpt_obj )
  {
    ...
    *(_WORD *)(cmpt_obj + 42) = 0;
    ...
    {
      wma_set_sap_keepalive((__int64)a1, a2, v24, v25, v26, v27, v28, v29, v30, v31);
      ...
      if ( *(_DWORD *)(v12 + 16) == 1
        && (wlan_vdev_mlme_is_mlo_vdev(v12, v50, v51, v52, v53, v54, v55, v56, v57) & 1) != 0 )
      {
        wmi_unified_send_vdev_tsf_tstamp_action_cmd(*a1);
      }
      return 0;
    }
  }
