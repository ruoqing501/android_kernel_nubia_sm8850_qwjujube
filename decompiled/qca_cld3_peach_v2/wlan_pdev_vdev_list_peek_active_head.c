_QWORD *__fastcall wlan_pdev_vdev_list_peek_active_head(__int64 a1, _QWORD *a2, unsigned int a3)
{
...
LABEL_6:
    ...
    if ( (v15 & 1) != 0 )
    {
      *(_QWORD *)(a1 + 1256) = v15 & 0xFFFFFFFFFFFFFFFELL;
  ...
  else
  {
    ...
    {
      v16 = v19[0];
      if ( !(unsigned int)wlan_objmgr_vdev_try_get_ref((__int64)v19[0], a3, v7, v8, v9, v10, v11, v12, v13, v14) )
        break;
