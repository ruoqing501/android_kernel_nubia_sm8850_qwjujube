        ...
        double a9)
{
  ...
  if ( v10 )
  {
    ...
    result = _qdf_delayed_work_create((_QWORD *)(a1 + 4048), (__int64)hdd_sar_unsolicited_work_cb, a1);
    if ( (_DWORD)result )
    {
    ...
    *(_DWORD *)(a1 + 4208) = 1;
    if ( *(_DWORD *)(*(_QWORD *)(a1 + 104) + 160LL) )
    {
      ...
      do
      {
        ...
        if ( !(unsigned int)qdf_wait_for_event_completion(a1 + 4168, *(_DWORD *)(*(_QWORD *)(a1 + 104) + 156LL)) )
          break;
