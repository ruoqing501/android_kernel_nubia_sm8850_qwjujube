...
LABEL_10:
  ...
  {
    v46 = v37;
    if ( !(unsigned int)qdf_list_peek_front((_QWORD *)(a1 + 1648), v64) )
    {
      for ( i = v64[0]; i; v64[0] = i )
      {
        qdf_list_peek_next((_QWORD *)(a1 + 1648), i, &v63);
        v53 = v64[0];
        if ( (unsigned int)qdf_list_remove_node(a1 + 1648, v64[0]) )
        {
          qdf_trace_msg(
            0x39u,
            2u,
...
LABEL_13:
  if ( *(_DWORD *)(a1 + 1664) )
    qdf_trace_msg(
      ...
      v45,
      "qdf_list_destroy");
  wlan_scan_unregister_requester(v19[2703], *(unsigned __int16 *)(a1 + 1640), v38, v39, v40, v41, v42, v43, v44, v45);
  v51 = *(_QWORD *)(a1 + 1488);
  if ( v51 )
  {
    _qdf_mem_free(v51);
