...
LABEL_7:
          ...
          *((_BYTE *)v12 + 944) = 0;
          v16 = *(__int64 *)((char *)&qword_168 + v11);
          if ( (v16 & 1) != 0 )
          {
            *(__int64 *)((char *)&qword_168 + v11) = v16 & 0xFFFFFFFFFFFFFFFELL;
...
LABEL_88:
      ...
      else
      {
        ...
        *(__int64 *)((char *)&qword_168 + v11) |= 1uLL;
        v14 = *((unsigned __int8 *)v12 + 944);
        if ( *((_BYTE *)v12 + 944) )
          goto LABEL_7;
      }
      v30 = *(__int64 *)((char *)&qword_168 + v11);
      if ( (v30 & 1) != 0 )
      {
        *(__int64 *)((char *)&qword_168 + v11) = v30 & 0xFFFFFFFFFFFFFFFELL;
        raw_spin_unlock_bh(v11 + 352);
      }
      else
      {
          ...
          while ( 1 )
          {
            ...
            if ( v46 == 1 )
            {
              if ( *(unsigned __int16 *)(v85 + 46) | *(unsigned __int16 *)(v85 + 44) )
              {
                ...
                LODWORD(v82) = *(unsigned __int8 *)(*(_QWORD *)v84 + 168LL);
...
LABEL_82:
              ...
              {
                if ( (*(_BYTE *)(v43 + 489) & 1) == 0 && (*((_BYTE *)&dword_9C + v45) & 0x80) != 0
                  || *(unsigned __int16 *)(v43 + 46) + (unsigned int)*(unsigned __int16 *)(v43 + 44) < *((_DWORD *)v44 + 184) )
                {
                  goto LABEL_35;
                }
                if ( *(unsigned __int16 *)((char *)&qword_C4 + v45 + 6) < 9u )
                {
                  qdf_trace_msg(
                    0,
                    4u,
...
LABEL_35:
          ...
          if ( (*(_BYTE *)(v85 + 489) & 1) == 0 && (*((_BYTE *)&dword_9C + v83) & 0x80) != 0 )
            goto LABEL_35;
          if ( *(unsigned __int16 *)(v85 + 46) | *(unsigned __int16 *)(v85 + 44) )
          {
            LODWORD(v80) = *(unsigned __int16 *)(v85 + 46);
            LODWORD(v81) = *(unsigned __int8 *)(*(_QWORD *)v84 + 168LL);
            LODWORD(v79) = *(unsigned __int16 *)(v85 + 44);
            LODWORD(v78) = 0;
            LODWORD(v77) = *(_DWORD *)(v85 + 36);
            qdf_trace_msg(
