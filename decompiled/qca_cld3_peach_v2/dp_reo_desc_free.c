        ...
        double a11)
{
  ...
  if ( *(_DWORD *)(a1 + 56) )
  {
    ...
    if ( v16 )
    {
      ...
      *(_QWORD *)(v16 + 16) = 1000 * (jiffies / 0xFAuLL) + 4 * (jiffies % 0xFAuLL);
      ...
      if ( (*(_BYTE *)(a1 + 20056) & 1) != 0 )
      {
        qdf_list_insert_back((_QWORD *)(a1 + 20016), v17);
        v19 = *(_QWORD *)(a1 + 20048);
        if ( (v19 & 1) != 0 )
        {
          *(_QWORD *)(a1 + 20048) = v19 & 0xFFFFFFFFFFFFFFFELL;
      ...
      if ( (v20 & 1) != 0 )
      {
        *(_QWORD *)(a1 + 20048) = v20 & 0xFFFFFFFFFFFFFFFELL;
        raw_spin_unlock_bh(a1 + 20040);
      }
      else
      {
  ...
  if ( (_DWORD)v21 )
  {
    v22 = 56LL * *(unsigned int *)(a1 + 20224);
    *(_QWORD *)(*(_QWORD *)(a1 + 20208) + v22) = 1000 * (jiffies / 0xFAuLL) + 4 * (jiffies % 0xFAuLL);
    *(_QWORD *)(*(_QWORD *)(a1 + 20208) + v22 + 8) = *(_QWORD *)(a2 + 80);
    *(_QWORD *)(*(_QWORD *)(a1 + 20208) + v22 + 16) = *(_QWORD *)(a2 + 64);
    *(_QWORD *)(*(_QWORD *)(a1 + 20208) + v22 + 24) = *(_QWORD *)(a2 + 56);
    v23 = *(_QWORD *)(a1 + 20224);
    if ( v23 + 1 == v21 )
      v24 = 0;
    else
