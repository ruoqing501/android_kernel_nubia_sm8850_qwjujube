__int64 __fastcall dp_peer_get_ref_by_id(__int64 a1, unsigned __int16 a2, unsigned int a3)
{
  ...
  {
    v7 = *(_QWORD *)(*(_QWORD *)(a1 + 13136) + 8LL * a2);
    if ( v7 )
    {
      if ( *(unsigned __int8 *)(v7 + 388) <= 2u )
      {
        v10 = *(_DWORD *)(v7 + 40);
        while ( v10 )
        {
          ...
          if ( _ZF )
          {
            if ( a3 >= 3 )
            {
              _X9 = (unsigned int *)(v7 + 4LL * a3 + 264);
              __asm { PRFM            #0x11, [X9] }
              do
                v22 = __ldxr(_X9);
            ...
            if ( (v20 & 1) != 0 )
            {
              *(_QWORD *)(a1 + 13312) = v20 & 0xFFFFFFFFFFFFFFFELL;
  ...
  if ( (v8 & 1) != 0 )
  {
    *(_QWORD *)(a1 + 13312) = v8 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(a1 + 13304);
  }
  else
  {
