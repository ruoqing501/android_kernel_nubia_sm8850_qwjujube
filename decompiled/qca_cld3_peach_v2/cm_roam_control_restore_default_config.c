__int64 __fastcall cm_roam_control_restore_default_config(__int64 a1, unsigned int a2)
{
  ...
  if ( !psoc_ext_obj_fl )
    goto LABEL_18;
  if ( (*(_BYTE *)(psoc_ext_obj_fl + 1912) & 1) == 0 )
  {
    qdf_trace_msg(
      0x68u,
      2u,
...
LABEL_18:
  ...
  mlme_reinit_control_config_lfr_params(v2, v14 + 1684);
  v58 = 7;
  v38 = wlan_cm_get_rso_config_fl(v24, "cm_restore_default_roaming_params", 5800);
  if ( v38 )
  {
    v48 = v38;
    *(_BYTE *)(v38 + 188) = *(_BYTE *)(v14 + 3624);
    *(_WORD *)(v38 + 146) = *(_DWORD *)(v14 + 1948);
    *(_DWORD *)(v38 + 184) = *(_DWORD *)(v14 + 2148);
    *(_DWORD *)(v38 + 104) = *(_DWORD *)(v14 + 1916);
    *(_BYTE *)(v38 + 128) = *(_DWORD *)(v14 + 1924);
    *(_BYTE *)(v38 + 129) = *(_DWORD *)(v14 + 1924);
    *(_BYTE *)(v38 + 189) = *(_BYTE *)(v14 + 1908);
    *(_BYTE *)(v38 + 190) = *(_BYTE *)(v14 + 1909);
    *(_BYTE *)(v38 + 224) = *(_BYTE *)(v14 + 1910);
    *(_BYTE *)(v38 + 191) = *(_BYTE *)(v14 + 1911);
    *(_DWORD *)(v38 + 136) = *(unsigned __int16 *)(v14 + 1938);
    *(_DWORD *)(v38 + 140) = *(_DWORD *)(v14 + 1940);
    *(_WORD *)(v38 + 192) = *(_WORD *)(v14 + 1982);
    *(_BYTE *)(v38 + 194) = *(_DWORD *)(v14 + 1984);
    *(_DWORD *)(v38 + 196) = *(_DWORD *)(v14 + 2136);
    *(_DWORD *)(v38 + 200) = *(_DWORD *)(v14 + 2140);
    wlan_mlme_reinit_real_time_roam_parms();
    ucfg_reg_get_band(*(_QWORD *)(v24 + 216), &v58, v49, v50, v51, v52, v53, v54, v55, v56);
