__int64 __fastcall dp_rx_deliver_to_stack(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  else
  {
    ...
    v11 = *(__int64 (__fastcall **)(__int64, __int64, __int64))(a2 + 184);
    if ( v11 )
    {
...
LABEL_17:
        ...
        do
        {
          ...
          if ( v15 )
          {
            if ( ((*(_QWORD *)(v16 + 72) >> 18) & 0xFuLL) > 7 || (*(_BYTE *)(v16 + 87) & 0xFu) >= 0xA )
              __break(0x5512u);
            v18 = v15 + 42680 + 5472 * ((*(_QWORD *)(v16 + 72) >> 18) & 0xFLL) + 608LL * (*(_BYTE *)(v16 + 87) & 0xF);
    ...
    v13 = *(__int64 (__fastcall **)(__int64, __int64))(a2 + 168);
    if ( !v13 )
      goto LABEL_17;
    v14 = *(_QWORD *)(a2 + 88);
