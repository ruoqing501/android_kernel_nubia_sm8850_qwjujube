...
LABEL_56:
      *(_QWORD *)(a1 + 13312) = v66 & 0xFFFFFFFFFFFFFFFELL;
  ...
  if ( (v26 & 1) != 0 )
  {
    *(_QWORD *)(a1 + 13312) = v26 & 0xFFFFFFFFFFFFFFFELL;
...
LABEL_24:
  ...
  {
    v28 = *(_QWORD *)(*(_QWORD *)(a1 + 13136) + 8LL * (unsigned __int16)a3);
    if ( v28 )
    {
      if ( *(unsigned __int8 *)(v28 + 388) <= 2u )
      {
        v76 = *(_DWORD *)(v28 + 40);
        while ( v76 )
        {
...
LABEL_25:
  ...
  if ( (v29 & 1) != 0 )
  {
    *(_QWORD *)(a1 + 13312) = v29 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(a1 + 13304);
    if ( !v28 )
      goto LABEL_60;
LABEL_27:
    ...
    if ( *(_QWORD *)(v56 + 8LL * (unsigned __int16)a3) )
    {
      ...
      if ( (v57 & 1) != 0 )
      {
        *(_QWORD *)(a1 + 13312) = v57 & 0xFFFFFFFFFFFFFFFELL;
        raw_spin_unlock_bh(a1 + 13304);
      }
      else
      {
    ...
    *(_QWORD *)(v56 + 8LL * (unsigned __int16)a3) = a2;
    ...
    if ( (v80 & 1) != 0 )
    {
      *(_QWORD *)(a1 + 13312) = v80 & 0xFFFFFFFFFFFFFFFELL;
