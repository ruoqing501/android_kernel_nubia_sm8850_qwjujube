...
LABEL_139:
  ...
  if ( (wmi_service_enabled(v20, 250) & 1) != 0 )
    *(_DWORD *)(v16 + 20) |= 0x4000000u;
  v30 = wmi_service_enabled(v20, 251);
  v39 = *(_DWORD *)(v16 + 20);
  if ( (v30 & 1) != 0 )
  {
    v39 |= 0x8000000u;
...
LABEL_65:
  ...
  if ( (wmi_service_enabled(v20, 277) & 1) != 0 )
    *(_DWORD *)(v16 + 24) |= 8u;
  init_deinit_update_wifi_pos_caps(v20, v16);
  if ( (wmi_service_enabled(v20, 282) & 1) != 0 )
    *(_DWORD *)(v16 + 24) |= 0x100u;
  init_deinit_mlo_tsf_sync_support(v20, v16);
  ...
  *(_DWORD *)(v16 + 20) = *(_DWORD *)(v16 + 20) & 0xFFFFF7FF | v61;
  ...
  if ( !(_DWORD)result )
  {
    ...
    if ( (wmi_service_enabled(v20, 268) & 1) != 0 )
    {
    ...
    if ( (wmi_service_enabled(v20, 261) & 1) != 0 )
    {
    ...
    if ( (wmi_service_enabled(v20, 278) & 1) != 0 )
      *(_DWORD *)(v16 + 24) |= 0x10u;
    if ( (wmi_service_enabled(v20, 279) & 1) != 0 )
      *(_DWORD *)(v16 + 24) |= 0x20u;
    if ( (wmi_service_enabled(v20, 294) & 1) != 0 )
      *(_DWORD *)(v16 + 24) |= 0x400u;
    if ( (wmi_service_enabled(v20, 295) & 1) != 0 )
      *(_DWORD *)(v16 + 24) |= 0x800u;
    if ( (wmi_service_enabled(v20, 327) & 1) != 0 )
    ...
    if ( (wmi_service_enabled(v20, 307) & 1) == 0 )
      return 0;
