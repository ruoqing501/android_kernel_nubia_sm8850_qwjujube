__int64 __fastcall pre_cac_init(double a1, double a2, double a3, double a4, double a5, double a6, double a7, double a8)
{
  ...
  handler = wlan_objmgr_register_psoc_create_handler(
              0x2Du,
              (__int64)pre_cac_psoc_create_notification,
              0,
              a1,
              a2,
              a3,
  ...
  if ( !handler )
  {
    v18 = wlan_objmgr_register_psoc_destroy_handler(
            0x2Du,
            (__int64)pre_cac_psoc_destroy_notification,
            0,
            v9,
            v10,
            v11,
    ...
    else
    {
      v35 = wlan_objmgr_register_pdev_create_handler(
              0x2Du,
              (__int64)pre_cac_pdev_create_notification,
              0,
              v19,
              v20,
              v21,
      ...
      else
      {
        v52 = wlan_objmgr_register_pdev_destroy_handler(
                0x2Du,
                (__int64)pre_cac_pdev_destroy_notification,
                0,
                v36,
                v37,
                v38,
        ...
        if ( v52 )
        {
          ...
          qdf_trace_msg(
            0x98u,
            2u,
            "%s: Failed to register pdev delete handler",
            v53,
            v54,
            v55,
            v56,
        ...
        else
        {
          v69 = wlan_objmgr_register_vdev_create_handler(
                  0x2Du,
                  (__int64)pre_cac_vdev_create_notification,
                  0,
                  v53,
                  v54,
                  v55,
          ...
          else
          {
            v17 = wlan_objmgr_register_vdev_destroy_handler(
                    0x2Du,
                    (__int64)pre_cac_vdev_destroy_notification,
                    0,
                    v70,
                    v71,
                    v72,
