__int64 __fastcall drv_cmd_get_roam_scan_period(__int64 a1, __int64 *a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v7; // x0
  unsigned int v8; // w1
  unsigned int empty_scan_refresh_period; // w0
  double v10; // d0
  double v11; // d1
  double v12; // d2
  double v13; // d3
  ...
  unsigned __int16 v43; // [xsp+4h] [xbp-2Ch] BYREF
  ...
  v43 = 0;
  memset(v44, 0, 32);
  empty_scan_refresh_period = ucfg_cm_get_empty_scan_refresh_period(v7, v8, &v43);
  if ( empty_scan_refresh_period )
  {
    result = qdf_status_to_os_return(empty_scan_refresh_period);
  }
  else
  {
    qdf_trace_msg(
      0x33u,
      8u,
      "%s: vdev_id: %u, empty_scan_refresh_period: %u",
      v10,
      v11,
      v12,
      v13,
      ...
      v16,
      v17,
      "drv_cmd_get_roam_scan_period",
      *(unsigned __int8 *)(a1 + 8),
      v43);
    qdf_mtrace(51, 51, 8u, *(_BYTE *)(a1 + 8), v43);
    scnprintf(v44, 32, "%s %d", "GETROAMSCANPERIOD", (unsigned int)(8389 * (v43 >> 3)) >> 20);
    v20 = *(_DWORD *)(a5 + 12);
    if ( v20 > v19 )
      LOBYTE(v20) = v19 + 1;
