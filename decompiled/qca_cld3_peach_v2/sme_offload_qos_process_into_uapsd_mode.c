        ...
        double a10)
{
  ...
  v12 = csr_ll_peek_head((__int64)&unk_91F2E0, 0, a3, a4, a5, a6, a7, a8, a9, a10);
  if ( v12 )
  {
    v21 = v12;
    while ( 1 )
    {
      result = csr_ll_next((__int64)&unk_91F2E0, v21, 0, v13, v14, v15, v16, v17, v18, v19, v20);
        ...
        && *(_DWORD *)(v21 + 20) == 4 )
      {
        ...
        v28 = result;
        v29 = qword_91F2D8 + 3040LL * *(unsigned __int8 *)(v21 + 16) + 728LL * v23 + 76LL * (int)v24 + 16;
