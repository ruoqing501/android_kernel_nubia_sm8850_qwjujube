        ...
        double a11)
{
  ...
  qdf_trace_msg(
    ...
    a11,
    "rrm_process_neighbor_report_response");
  if ( *(unsigned __int8 *)(a1 + 20226) != *(unsigned __int8 *)(a2 + 2) )
  {
  ...
  if ( *(_WORD *)(a2 + 4) )
  {
    ...
    while ( 1 )
    {
      ...
      *((_DWORD *)v32 + 7) = v41 & 0xFFFFFBFF | (((*v27 >> 10) & 1) << 10);
      if ( (wlan_reg_is_6ghz_supported(*(_QWORD *)(a1 + 21624), v42, v43, v44, v45, v46, v47, v48, v49) & 1) == 0
        && wlan_reg_is_6ghz_op_class(*(_QWORD *)(a1 + 21632), *((_BYTE *)v27 + 5)) )
      {
        break;
      }
      v29 = &v25[v26];
