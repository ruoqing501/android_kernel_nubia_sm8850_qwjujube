        ...
        _DWORD *a11)
{
  ...
  double v62; // d6
  double v63; // d7
  _QWORD v64[2]; // [xsp+8h] [xbp-38h] BYREF
  unsigned __int64 v65; // [xsp+18h] [xbp-28h]
  ...
  {
    v22 = context;
    if ( (mlme_is_chan_switch_in_progress(*(_QWORD *)(a1 + 520), v14, v15, v16, v17, v18, v19, v20, v21) & 1) != 0 )
      mlme_set_chan_switch_in_progress(*(_QWORD *)(a1 + 520), 0, v23, v24, v25, v26, v27, v28, v29, v30);
    mac_id = (unsigned __int8)target_if_mc_cp_get_mac_id(a1);
    v32 = wma_cli_set_command(*(unsigned __int8 *)(*(_QWORD *)(a1 + 520) + 168LL), 30, 0, 2);
    if ( v32 )
      qdf_trace_msg(
        0x35u,
        2u,
    ...
    if ( v46 )
      qdf_trace_msg(
        ...
        "wma_mon_mlme_vdev_start_continue",
        v46);
    v55 = wma_cli_set2_command(*(unsigned __int8 *)(*(_QWORD *)(a1 + 520) + 168LL), 30, 2000, mac_id, 2);
    if ( v55 )
      qdf_trace_msg(
        0x35u,
        2u,
