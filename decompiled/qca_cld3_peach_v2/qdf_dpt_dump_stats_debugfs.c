        ...
        double a10)
{
  ...
  if ( dword_7F7648 >= (unsigned int)(unsigned __int16)dword_7F7652 )
    v12 = dword_7F7652;
  else
    v12 = dword_7F7648;
...
LABEL_44:
          ...
          if ( (unsigned int)LOBYTE(v69[0]) - 1 <= 0x29 )
            v40 = off_AD04A8[(unsigned __int8)(LOBYTE(v69[0]) - 1)];
          scnprintf(
            &v89,
            100,
            "%s DPT: %04d:%02d%s %s",
        ...
        v24 = "Invalid";
        if ( (unsigned int)LOBYTE(v69[0]) - 1 <= 0x29 )
          v24 = off_AD04A8[(unsigned __int8)(LOBYTE(v69[0]) - 1)];
        scnprintf(
          &v89,
          100,
          "%s DPT: %04d:%02d%s %s",
...
LABEL_49:
            ...
            v44 = "Invalid";
            if ( (unsigned int)LOBYTE(v69[0]) - 1 <= 0x29 )
              v44 = off_AD04A8[(unsigned __int8)(LOBYTE(v69[0]) - 1)];
            v45 = scnprintf(
                    &v76,
                    100,
                    "%s DPT: %04d:%02d%s %s",
...
LABEL_35:
          ...
          v37 = "Invalid";
          if ( (unsigned int)LOBYTE(v69[0]) - 1 <= 0x29 )
            v37 = off_AD04A8[(unsigned __int8)(LOBYTE(v69[0]) - 1)];
          v38 = scnprintf(
                  &v76,
                  100,
                  "%s DPT: %04d:%02d%s %s",
        ...
        v60 = "Invalid";
        if ( (unsigned int)LOBYTE(v69[0]) - 1 <= 0x29 )
          v60 = off_AD04A8[(unsigned __int8)(LOBYTE(v69[0]) - 1)];
        scnprintf(
          &v89,
          100,
          "%s DPT: %04d:%02d%s %s",
        ...
        if ( *(_DWORD *)((char *)v69 + 5) == 3 )
        {
          ...
          if ( *(_DWORD *)((char *)v69 + 1) <= 4u )
            v61 = off_AD0430[*(unsigned int *)((char *)v69 + 1)];
          qdf_debugfs_printf(
            a1,
            "%s [%s] [T: %d G0: %d G1: %d]\n",
            (const char *)&v89,
        ...
        else
        {
          v62 = "invalid";
          if ( *(_DWORD *)((char *)v69 + 1) <= 4u )
            v62 = off_AD0430[*(unsigned int *)((char *)v69 + 1)];
          v63 = "invalid";
          if ( *(_DWORD *)((char *)v69 + 5) <= 2u )
            v63 = off_AD0458[*(unsigned int *)((char *)v69 + 5)];
          qdf_debugfs_printf(
            a1,
...
LABEL_61:
      ++HIWORD(dword_7F7652);
      if ( HIWORD(dword_7F7652) == v12 )
      {
        result = 0;
        HIWORD(dword_7F7652) = 0;
        goto LABEL_80;
      }
      raw_spin_lock_bh(&l_dp_trace_lock);
      if ( v67 )
