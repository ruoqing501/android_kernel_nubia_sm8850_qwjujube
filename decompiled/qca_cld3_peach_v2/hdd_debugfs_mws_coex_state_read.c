__int64 __fastcall hdd_debugfs_mws_coex_state_read(__int64 a1, __int64 a2)
{
  __int64 v4; // x8
  __int64 v5; // x0
  ...
  double v38; // d7
  __int64 result; // x0
  __int64 v40[2]; // [xsp+10h] [xbp-10h] BYREF

  v40[1] = *(_QWORD *)(_ReadStatusReg(SP_EL0) + 1808);
  v4 = *(_QWORD *)(a2 + 24);
  v40[0] = 0;
  v5 = _osif_psoc_sync_op_start(*(_QWORD *)(v4 + 488), v40, (__int64)"hdd_debugfs_mws_coex_state_read");
  if ( !(_DWORD)v5 )
  {
    ...
    if ( first_valid_adapter )
    {
      if ( (*((_QWORD *)first_valid_adapter + 203) & 4) != 0 )
      {
        ...
        v17 = osif_request_alloc(_hdd_debugfs_mws_coex_state_read_params);
        if ( v17 )
        {
          v18 = v17;
          ...
          mws_coex_info = sme_get_mws_coex_info(
                            *(_QWORD *)(a2 + 16),
                            *(unsigned __int8 *)(*((_QWORD *)v16 + 6604) + 8LL),
                            1,
          ...
          {
            qdf_debugfs_printf(a1, "Timedout while retrieving MWS coex state", v22, v23, v24, v25, v26, v27, v28, v29);
            v21 = -110;
          }
          else
          {
    ...
    qdf_trace_msg(0x33u, 2u, v15, v7, v8, v9, v10, v11, v12, v13, v14, "__hdd_debugfs_mws_coex_state_read");
LABEL_16:
    _osif_psoc_sync_op_stop(v40[0], (__int64)"hdd_debugfs_mws_coex_state_read");
    v5 = 0;
  }
