__int64 __fastcall wlan_mlme_get_sta_num_tx_chains(__int64 a1, __int64 a2, _BYTE *a3)
{
  double v5; // d0
  double v6; // d1
  double v7; // d2
      ...
      else
      {
        if ( connected_band != 1 )
        {
          qdf_trace_msg(
            ...
            v40,
            v41,
            "wlan_mlme_get_sta_num_tx_chains",
            connected_band);
          goto LABEL_4;
        }
        v42 = *(_DWORD *)(v32 + 12);
  ...
  qdf_trace_msg(0x68u, 2u, v13, v5, v6, v7, v8, v9, v10, v11, v12, "wlan_mlme_get_sta_num_tx_chains");
LABEL_4:
  result = 4;
LABEL_5:
