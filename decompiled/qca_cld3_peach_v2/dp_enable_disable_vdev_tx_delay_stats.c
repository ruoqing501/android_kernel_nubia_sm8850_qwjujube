__int64 __fastcall dp_enable_disable_vdev_tx_delay_stats(__int64 result, unsigned __int8 a2, char a3)
{
  ...
  if ( a2 <= 5u )
  {
    ...
    else
    {
      ...
      *(_QWORD *)(v5 + 18992) |= 1uLL;
    }
    v7 = *(_QWORD *)(v5 + 8LL * a2 + 12960);
    if ( v7 )
    {
      _X23 = (unsigned int *)(v7 + 43384);
      v9 = *(_DWORD *)(v7 + 43384);
      while ( v9 )
      {
        __asm { PRFM            #0x11, [X23] }
        ...
        if ( _ZF )
        {
          ...
          if ( (v29 & 1) != 0 )
          {
            *(_QWORD *)(v5 + 18992) = v29 & 0xFFFFFFFFFFFFFFFELL;
            raw_spin_unlock_bh(v5 + 18984);
          }
          else
          {
            raw_spin_unlock(v5 + 18984);
          }
          *(_BYTE *)(v7 + 46141) = a3;
    ...
    if ( (v25 & 1) != 0 )
    {
      *(_QWORD *)(v5 + 18992) = v25 & 0xFFFFFFFFFFFFFFFELL;
      return raw_spin_unlock_bh(v5 + 18984);
    }
    else
    {
      return raw_spin_unlock(v5 + 18984);
    }
  }
  return result;
}
