__int64 __fastcall pe_deregister_mgmt_rx_frm_callback(
        __int64 a1,
        double a2,
        double a3,
        double a4,
        ...
        double a9)
{
  ...
  v20[0] = 122;
  v10 = wlan_mgmt_txrx_deregister_rx_cb(v9, 0, (__int64)v20, 1u, a2, a3, a4, a5, a6, a7, a8, a9);
  if ( (_DWORD)v10 )
    v10 = qdf_trace_msg(
            0x35u,
            2u,
  ...
  result = wma_de_register_mgmt_frm_client(v10);
