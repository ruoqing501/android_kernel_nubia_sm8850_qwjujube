__int64 __fastcall ucfg_dp_del_latency_critical_client(
        __int64 a1,
        int a2,
        double a3,
        double a4,
        ...
        double a10)
{
  ...
  if ( !a1 )
  {
    ...
    return qdf_trace_msg(
             ...
             v19,
             v20,
             "dp_del_latency_critical_client",
             a1);
  }
  ...
  if ( (a2 | 2) == 3 )
  {
    ...
    qdf_trace_msg(
      0x45u,
      5u,
      "%s: Removing latency critical connection for vdev %d",
      v13,
      v14,
      v15,
      v16,
    ...
    result = _cds_get_context(71, "dp_del_latency_critical_client");
