__int64 __fastcall dp_soc_detach_wifi3(__int64 *a1)
{
  ...
  if ( (wlan_cfg_is_ipa_enabled(a1[5]) & 1) != 0 )
    dp_srng_free((__int64)a1, (__int64)(a1 + 2318), v12, v13, v14, v15, v16, v17, v18, v19);
  if ( *(_DWORD *)(a1[5] + 132) )
  {
    _qdf_mem_free(a1[2524]);
    _qdf_mem_free(a1[2525]);
    _qdf_mem_free(a1[2526]);
    _qdf_mem_free(a1[2527]);
  }
