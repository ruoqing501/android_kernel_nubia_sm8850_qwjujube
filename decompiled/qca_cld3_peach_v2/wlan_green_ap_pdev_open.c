...
LABEL_13:
  ...
  *(_BYTE *)(v20 + 8) = *(_BYTE *)(cfg_psoc_get_values(v9) + 764);
  *(_BYTE *)(v20 + 137) = *(_BYTE *)(cfg_psoc_get_values(v9) + 765);
  *(_DWORD *)(v20 + 140) = *(_DWORD *)(cfg_psoc_get_values(v9) + 768);
  *(_DWORD *)(v20 + 144) = *(_DWORD *)(cfg_psoc_get_values(v9) + 772);
  *(_DWORD *)(v20 + 148) = *(_DWORD *)(cfg_psoc_get_values(v9) + 776);
  v30 = *(_QWORD *)(a1 + 80);
  if ( !v30 )
  {
    v34 = "%s: psoc is NULL";
LABEL_17:
  ...
  *(_DWORD *)(v31 + 104) = *(_DWORD *)(cfg_psoc_get_values(v30) + 780);
LABEL_18:
  *(_DWORD *)(v20 + 112) = 0;
  *(_DWORD *)(v20 + 108) = 1;
  v35 = *(_QWORD *)(v20 + 96);
