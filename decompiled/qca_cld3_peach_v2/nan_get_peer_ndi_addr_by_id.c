__int64 __fastcall nan_get_peer_ndi_addr_by_id(__int64 a1, int a2, void *a3)
{
  ...
  v6 = wlan_vdev_peer_list_peek_active_head(a1, (_QWORD *)(a1 + 192), 0x14u);
  if ( !v6 )
    return 16;
  v7 = (__int64)v6;
  while ( 1 )
...
LABEL_3:
    next_active_peer_of_vdev = wlan_peer_get_next_active_peer_of_vdev(a1, (_QWORD *)(a1 + 192), v7, 0x14u);
