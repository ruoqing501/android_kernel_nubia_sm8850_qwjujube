        ...
        double a9)
{
  ...
  if ( a1 )
  {
    ...
    {
      raw_spin_lock(a1 + 1264);
    }
    else
    {
      raw_spin_lock_bh(a1 + 1264);
      *(_QWORD *)(a1 + 1272) |= 1uLL;
    }
    if ( !qdf_list_empty((_QWORD *)(a1 + 1280)) )
    {
      v13 = _ReadStatusReg(SP_EL0);
      do
      {
        qdf_list_remove_front((_DWORD *)(a1 + 1280), v31);
        v14 = *(_QWORD *)(a1 + 1272);
        if ( (v14 & 1) != 0 )
        {
          *(_QWORD *)(a1 + 1272) = v14 & 0xFFFFFFFFFFFFFFFELL;
          raw_spin_unlock_bh(a1 + 1264);
        }
        else
        {
          raw_spin_unlock(a1 + 1264);
        }
        if ( v31[0] == -16 )
        {
          v25 = 0;
      ...
      while ( !qdf_list_empty((_QWORD *)(a1 + 1280)) );
    }
    v11 = *(_QWORD *)(a1 + 1272);
    --*(_DWORD *)(a1 + 1352);
    if ( (v11 & 1) != 0 )
    {
      *(_QWORD *)(a1 + 1272) = v11 & 0xFFFFFFFFFFFFFFFELL;
      result = raw_spin_unlock_bh(a1 + 1264);
    }
    else
    {
      result = raw_spin_unlock(a1 + 1264);
    }
  }
  else
  {
