__int64 __fastcall ucfg_mlme_cfg_chan_to_freq(__int64 a1)
{
  ...
  if ( result )
  {
    v3 = *(unsigned int *)(result + 4184);
    v4 = *(_QWORD *)(result + 4192);
    *(_QWORD *)(result + 3768) = 128;
    v5 = result;
    v6 = ucfg_mlme_convert_power_cfg_chan_to_freq(a1, v3, v4, result + 4200, result + 3784);
    if ( v6 )
    {
      v15 = *(unsigned int *)(v5 + 4328);
      v16 = *(_QWORD *)(v5 + 4336);
      *(_QWORD *)(v5 + 3776) = v6;
      *(_QWORD *)(v5 + 3912) = 256;
      result = ucfg_mlme_convert_power_cfg_chan_to_freq(a1, v15, v16, v5 + 4344, v5 + 3928);
      if ( (_DWORD)result )
      {
        *(_QWORD *)(v5 + 3920) = (unsigned int)result;
        return result;
      }
