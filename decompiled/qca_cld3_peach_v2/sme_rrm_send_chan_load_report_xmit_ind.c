__int64 __fastcall sme_rrm_send_chan_load_report_xmit_ind(__int64 a1, __int64 a2, unsigned int a3, char a4)
{
  ...
  if ( result )
  {
    ...
    *(_BYTE *)(result + 4) = v4;
    v19 = v17 + 17488;
    *(_WORD *)(result + 12) = *(_WORD *)(v17 + 17488);
    *(_WORD *)(result + 16) = *(_WORD *)(v17 + 17602);
    *(_BYTE *)(result + 14) = *(_BYTE *)(v17 + 17496);
    *(_BYTE *)(result + 15) = *(_BYTE *)(v17 + 17504);
    *(_QWORD *)(result + 24) = *(_QWORD *)(v17 + 17520);
    v20 = *(_DWORD *)(v17 + 17508);
    v21 = *(_DWORD *)(v17 + 17512);
    switch ( v21 )
    {
      case 0u:
        qdf_trace_msg(
        ...
        goto LABEL_17;
      case 7u:
        if ( (*(_BYTE *)(v17 + 17528) & 1) == 0 )
        {
          v22 = "%s: is_bw_ind_element is false";
          goto LABEL_23;
        }
        qdf_mem_copy((void *)(result + 36), (const void *)(v17 + 17528), 8u);
...
LABEL_23:
      ...
      default:
        if ( *(_BYTE *)(v17 + 17536) )
        {
          qdf_mem_copy((void *)(result + 44), (const void *)(v17 + 17536), 4u);
...
LABEL_17:
          ...
          do
          {
            rx_clear_count = wlan_cp_stats_get_rx_clear_count(*(_QWORD *)(a1 + 21624), a3, v40);
            v40 += 20;
