__int64 __fastcall lim_add_sta_self(__int64 a1, char a2, __int64 a3)
{
  ...
  *(_DWORD *)((char *)&v52 + 2) = v8;
  v10 = _qdf_mem_malloc(0x338u, "lim_add_sta_self", 2922);
  if ( v10 )
  {
    v11 = v10;
    ...
    *(_DWORD *)(v11 + 112) = 0;
    *(_WORD *)(v11 + 6) = v21;
    *(_BYTE *)(v11 + 124) = *(_BYTE *)(a3 + 8);
    *(_BYTE *)(v11 + 143) = *(_BYTE *)(a3 + 10);
    ...
    *(_BYTE *)(v11 + 132) = (*(_DWORD *)(a3 + 7268) & 0x1000) != 0;
    *(_BYTE *)(v11 + 133) = (*(_DWORD *)(a3 + 7268) & 0x800) != 0;
    if ( *(_BYTE *)(a3 + 7170) )
      *(_BYTE *)(v11 + 32) = *(_BYTE *)(*(_QWORD *)(a1 + 8) + 2877LL);
    *(_BYTE *)(v11 + 134) = (*(_DWORD *)(a3 + 7268) & 0x100000) != 0;
    *(_BYTE *)(v11 + 135) = *(_BYTE *)(a3 + 7187);
    *(_BYTE *)(v11 + 136) = *(_BYTE *)(a3 + 7192);
    if ( *(_BYTE *)(*(_QWORD *)(a1 + 8) + 1300LL) == 1 )
      v32 = *(_BYTE *)(a3 + 8653) ^ 1;
    else
      v32 = 0;
    *(_BYTE *)(v11 + 137) = v32 & 1;
    *(_BYTE *)(v11 + 138) = *(_BYTE *)(*(_QWORD *)(a1 + 8) + 1301LL);
    *(_BYTE *)(v11 + 139) = *(_BYTE *)(a3 + 7193);
    *(_BYTE *)(v11 + 140) = *(_BYTE *)(a3 + 7236) & 1;
    *(_BYTE *)(v11 + 141) = (*(_BYTE *)(a3 + 7236) & 2) != 0;
    *(_WORD *)(v11 + 16) = *(_WORD *)(*(_QWORD *)(a1 + 8) + 3404LL);
    if ( *(_DWORD *)(a3 + 7036) == 2 )
      *(_BYTE *)(v11 + 125) = 1;
    if ( *(_BYTE *)(a3 + 7864) == 1 )
    {
