__int64 __fastcall wlan_cm_update_roam_scan_scheme_bitmap(__int64 a1, __int64 a2, unsigned int a3)
{
    ...
    if ( ((unsigned int)ext_hdl_fl & 0xFFFFFFFD) != 0
      || (v16 = v5,
          ext_hdl_fl = (unsigned int *)cm_get_ext_hdl_fl(
                                         v5,
                                         (__int64)"wlan_cm_update_roam_scan_scheme_bitmap",
                                         0xA7Au,
                                         v6,
                                         v7,
                                         v8,
  ...
  else
  {
    qdf_trace_msg(
      ...
      v12,
      v13,
      "wlan_cm_update_roam_scan_scheme_bitmap",
      v4);
    return 16;
  }
}
