...
LABEL_72:
    ...
    if ( !(unsigned int)dp_rx_buffer_pool_nbuf_map(a1, a4, &v154) )
    {
      ...
      if ( *(_DWORD *)(a1 + 20264) && (*(_BYTE *)(*(_QWORD *)(a1 + 40) + 831LL) & 1) == 0 )
      {
        v91 = *(_DWORD *)(v155 + 48);
        if ( (v91 & 0x2000000) != 0 )
        {
...
LABEL_85:
  v121 = *(_QWORD *)(a1 + 18528);
  if ( (v121 & 1) != 0 )
  {
    *(_QWORD *)(a1 + 18528) = v121 & 0xFFFFFFFFFFFFFFFELL;
...
LABEL_94:
  ...
  if ( *(_BYTE *)(a1 + 18856) == 1 )
  {
    v132 = *(unsigned __int16 *)(a1 + 18860);
    v133 = *(unsigned __int16 *)(a1 + 18858);
    if ( v132 <= v133 )
    {
      v134 = ~(_WORD)v133;
      LOWORD(v132) = v132 + *(_WORD *)(a1 + 18872);
    }
    else
    {
      v134 = ~(_WORD)v133;
