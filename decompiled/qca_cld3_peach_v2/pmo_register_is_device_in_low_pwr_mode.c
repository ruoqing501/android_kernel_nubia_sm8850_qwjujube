__int64 __fastcall pmo_register_is_device_in_low_pwr_mode(
        __int64 a1,
        __int64 a2,
        double a3,
        double a4,
...
LABEL_15:
    ...
    v23 = "%s: pmo_get_pause_bitmap is null";
  }
  else
  {
    v23 = "%s: psoc is null";
  }
  qdf_trace_msg(0x4Du, 2u, v23, a3, a4, a5, a6, a7, a8, a9, a10, "pmo_register_is_device_in_low_pwr_mode");
  return 29;
}
