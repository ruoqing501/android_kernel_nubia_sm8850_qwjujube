__int64 __fastcall lim_send_chan_switch_action_frame(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v25 = v10;
  result = wlan_reg_freq_to_chan(*(_QWORD *)(a1 + 21632), v7, v9, v11, v12, v13, v14, v15, v16, v17);
  v19 = *(_DWORD *)(a4 + 88);
  v20 = result;
  if ( v19 == 2 )
    return lim_send_extended_chan_switch_action_frame(a1, a4 + 24, 0, v25, (unsigned int)result, v6[7], a4);
  if ( v19 == 1 )
  {
    if ( *(_BYTE *)(a1 + 14883) )
      v21 = 0;
    ...
    do
    {
      v24 = (_WORD *)(v5 + 1272LL * v23);
      if ( v24 && (*v24 & 8) != 0 )
      {
        if ( v6[1464] )
          result = lim_send_channel_switch_mgmt_frame(a1, v24 + 175, v21, v20, v22, a4);
        else
          result = lim_send_extended_chan_switch_action_frame(a1, v24 + 175, v21, v25, v20, v22, a4);
      }
      ++v23;
    }
