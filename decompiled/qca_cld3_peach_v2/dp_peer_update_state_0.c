__int64 __fastcall dp_peer_update_state_0(__int64 a1, unsigned int a2)
{
...
LABEL_9:
  ...
  *(_BYTE *)(a1 + 388) = a2;
  if ( (v14 & 1) != 0 )
  {
    *(_QWORD *)(a1 + 400) = v14 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(a1 + 392);
  }
  else
  {
