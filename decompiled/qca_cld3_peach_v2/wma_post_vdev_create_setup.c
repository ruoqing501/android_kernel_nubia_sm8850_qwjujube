        ...
        double a9)
{
  ...
  *(_QWORD *)(v29[65] + 488LL * *(unsigned __int8 *)(a1 + 168)) = a1;
  *(_BYTE *)(v29[65] + 488LL * v39 + 184) = 1;
  ...
  if ( cmpt_obj )
  {
    ...
    *(_DWORD *)(v29[65] + 488LL * v39 + 164) = *(unsigned __int8 *)(v49 + 179);
    *(_DWORD *)(v29[65] + 488LL * v39 + 168) = *(unsigned __int8 *)(v49 + 180);
    v68 = v19[2703];
    v208[0] = 0;
    ...
    {
      v80 = v19[1];
      v81 = wma_set_sta_keep_alive(v29, v39, v77, *(unsigned int *)(v80 + 3500), 0, 0, 0);
      if ( (wmi_service_enabled(*v29, 0x6Au, v81, v82, v83, v84, v85, v86, v87, v88) & 1) != 0 )
        wma_set_sta_sa_query_param(v29, v39);
      v89 = wma_set_sw_retry_threshold(v80 + 2892);
      if ( v89 )
        qdf_trace_msg(
          0x36u,
          2u,
          ...
          v89);
      v98 = wma_set_sw_retry_threshold_per_ac(v29, v39, v80 + 2892);
      if ( v98 )
        qdf_trace_msg(
          0x36u,
          2u,
    ...
    if ( (unsigned int)policy_mgr_get_dynamic_mcc_adaptive_sch(v19[2703], v207) )
    {
...
LABEL_38:
        ...
        if ( (unsigned int)(v134 - 4) >= 3 && v134 != 2 && (v134 != 1 || *(_BYTE *)(v49 + 180) != 1) )
          goto LABEL_70;
LABEL_60:
