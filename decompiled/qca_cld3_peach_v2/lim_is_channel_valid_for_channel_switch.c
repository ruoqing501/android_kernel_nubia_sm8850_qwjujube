...
LABEL_13:
  ...
  is_freq_enabled = wlan_reg_is_freq_enabled(*(_QWORD *)(a1 + 21632), a3, v15, v16, v17, v18, v19, v20, v21, v22);
  result = 0;
  if ( (is_freq_enabled & 1) != 0 )
  {
    ...
    {
      if ( (wlan_reg_is_dfs_for_freq(*(_QWORD *)(a1 + 21632), a3, v27, v28, v29, v30, v31, v32, v33, v34) & 1) != 0 )
      {
