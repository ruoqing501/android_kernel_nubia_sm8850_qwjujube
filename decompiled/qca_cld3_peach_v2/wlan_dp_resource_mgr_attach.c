__int64 __fastcall wlan_dp_resource_mgr_attach(__int64 *a1)
{
  ...
  *(_QWORD *)&v80[15] = *(_QWORD *)(_ReadStatusReg(SP_EL0) + 1808);
  ...
  if ( (*(_BYTE *)(cfg_psoc_get_values(v3) + 4239) & 1) == 0 )
  {
...
LABEL_19:
  ...
  if ( v24 )
    goto LABEL_18;
  if ( SLODWORD(v77[0]) <= (unsigned __int16)word_6A26E )
  {
  ...
  if ( LODWORD(v77[0]) - 1 != (unsigned __int16)word_6A276 )
  {
    qdf_trace_msg(
      0x45u,
      5u,
...
LABEL_34:
  ...
  *(_QWORD *)&v80[7] = 0;
  ...
  if ( !v59 )
  {
    ...
    *(_QWORD *)(v13 + 192) = v13;
    init_timer_key(v13 + 144, _os_timer_shim_19, 0x80000, 0, 0);
    *(_QWORD *)v13 = a1;
    a1[375] = v13;
