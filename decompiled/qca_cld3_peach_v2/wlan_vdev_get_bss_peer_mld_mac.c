__int64 __fastcall wlan_vdev_get_bss_peer_mld_mac(
        __int64 a1,
        void *a2,
        double a3,
        double a4,
        ...
        double a10)
{
  ...
  if ( !a1 )
  {
    qdf_trace_msg(0x57u, 2u, "%s: vdev is null", a3, a4, a5, a6, a7, a8, a9, a10, "wlan_vdev_get_bss_peer_mld_mac");
    return 4;
  }
  ...
  qdf_mem_copy(a2, (const void *)(v21 + 792), 6u);
  v23 = *(_QWORD *)(v21 + 776);
  if ( (v23 & 1) != 0 )
  {
