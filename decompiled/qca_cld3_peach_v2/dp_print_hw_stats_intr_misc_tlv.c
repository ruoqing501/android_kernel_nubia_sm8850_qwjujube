__int64 __fastcall dp_print_hw_stats_intr_misc_tlv(__int64 a1)
{
  __int64 v2; // x0
  double v3; // d0
  double v4; // d1
  ...
  v2 = _qdf_mem_malloc(0x3E8u, "dp_print_hw_stats_intr_misc_tlv", 765);
  if ( !v2 )
  ...
  v11 = (char *)v2;
  DP_PRINT_STATS("HTT_HW_STATS_INTR_MISC_TLV:", v3, v4, v5, v6, v7, v8, v9, v10);
  ...
  DP_PRINT_STATS("hw_intr_name = %s ", v18, v19, v20, v21, v22, v23, v24, v25, v11);
  DP_PRINT_STATS("mask = %u", v26, v27, v28, v29, v30, v31, v32, v33, *(unsigned int *)(a1 + 12));
  DP_PRINT_STATS("count = %u\n", v34, v35, v36, v37, v38, v39, v40, v41, *(unsigned int *)(a1 + 16));
