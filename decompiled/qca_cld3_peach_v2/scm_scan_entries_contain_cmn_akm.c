        ...
        double a10)
{
  ...
  if ( !v10 || !v11 )
    return v12;
  if ( *(unsigned __int8 *)(a1 + 1286) != *(unsigned __int8 *)(a2 + 1286) )
  {
...
LABEL_19:
  ...
  if ( ((*(unsigned __int16 *)(a2 + 1284) ^ *(unsigned __int16 *)(a1 + 1284)) & 0x80) != 0 )
  {
    v17 = "%s: MFPC capability is not equal 0x%x, 0x%x";
    goto LABEL_19;
  }
  if ( (*(_DWORD *)(a2 + 1272) & *(_DWORD *)(a1 + 1272)) == 0 )
  {
    v17 = "%s: Intersected UC cipher bitmap NULL 0x%x, 0x%x";
    goto LABEL_19;
  }
  if ( (*(_DWORD *)(a2 + 1276) & *(_DWORD *)(a1 + 1276)) == 0 )
  {
  ...
  if ( (*(_DWORD *)(a2 + 1268) & (1 << secure_akm_available)) == 0 )
  {
