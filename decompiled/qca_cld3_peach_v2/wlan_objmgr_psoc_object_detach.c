__int64 __fastcall wlan_objmgr_psoc_object_detach(__int64 a1)
{
  ...
  {
    raw_spin_lock(v3 + 11720);
  }
  else
  {
    v7 = v3;
    raw_spin_lock_bh(v3 + 11720);
    *(_QWORD *)(v7 + 11728) |= 1uLL;
  }
  *(_QWORD *)(g_umac_glb_obj + 8 * v1) = 0;
  v5 = g_umac_glb_obj;
  v6 = *(_QWORD *)(g_umac_glb_obj + 11728);
  if ( (v6 & 1) != 0 )
  {
    *(_QWORD *)(g_umac_glb_obj + 11728) = v6 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(v5 + 11720);
  }
  else
  {
