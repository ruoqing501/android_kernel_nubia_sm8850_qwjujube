__int64 __fastcall ucfg_mlme_get_acs_avoid_freq_list(__int64 a1, void *a2, _BYTE *a3)
{
  ...
  if ( psoc_ext_obj_fl )
  {
    v6 = *(unsigned __int8 *)(psoc_ext_obj_fl + 6598);
    *a3 = v6;
    qdf_mem_copy(a2, (const void *)(psoc_ext_obj_fl + 6398), (unsigned int)(2 * v6));
    result = 0;
  }
  else
  {
    qdf_uint16_array_parse(&unk_98C763, (__int64)a2, 100, v16);
    *a3 = v16[0];
    qdf_trace_msg(
      0x1Fu,
      2u,
