        ...
        double a10)
{
  ...
  if ( !mlme_get_psoc_ext_obj_fl(v13) )
    return 4;
  v15 = _qdf_mem_malloc(0x118u, "cm_handle_connect_req", 1414);
  if ( !v15 )
    return 2;
  v16 = v15;
  if ( (unsigned int)cm_copy_join_params(a1, v15, a2) )
  {
...
LABEL_22:
  ...
  ext_ie_ptr_from_ext_id = wlan_get_ext_ie_ptr_from_ext_id(&unk_969B80, 1u, a2[4], *((_DWORD *)a2 + 6));
  ...
  wlan_rec_debug_log(
    ...
    *(_BYTE *)a2,
    ...
    0,
    *(_DWORD *)(*((_QWORD *)a2[7] + 3) + 1268LL),
    *(_DWORD *)(*((_QWORD *)a2[7] + 3) + 1192LL));
