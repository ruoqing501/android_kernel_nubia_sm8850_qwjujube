__int64 __fastcall lim_add_sta(__int64 a1, unsigned __int16 *a2, char a3, __int64 a4)
{
  ...
  *(_DWORD *)((char *)&v152 + 2) = v9;
  v11 = _qdf_mem_malloc(0x338u, "lim_add_sta", 2309);
  if ( !v11 )
  {
    v15 = 2;
    goto LABEL_156;
  ...
  qdf_mem_copy((void *)(v13 + 146), a2 + 11, 2u);
  qdf_mem_copy((void *)(v13 + 36), a2 + 132, 0x4Cu);
  *(_WORD *)(v13 + 6) = a2[174];
  *(_BYTE *)(v13 + 18) = (*(_BYTE *)a2 & 2) != 0;
  *(_WORD *)(v13 + 16) = a2[10];
  if ( *(_DWORD *)(a4 + 88) == 1 && (a2[16] & 1) != 0 )
    *(_BYTE *)(v13 + 116) = (a2[16] & 2) != 0;
  v16 = *a2;
  v17 = *((_BYTE *)a2 + 356);
  *((_DWORD *)a2 + 2) = 21;
  *a2 = v16 & 0xFFFE;
  ...
  *(_BYTE *)(v13 + 127) = v19;
  ...
  lim_update_sta_eht_capable(a1, v13, a2, a4);
  lim_update_tdls_sta_eht_capable(a1, v13, a2, a4);
  lim_update_sta_mlo_info(a4, v13, a2);
  v29 = *(unsigned __int8 *)(v13 + 127);
  *(_BYTE *)(v13 + 33) = *((_BYTE *)a2 + 344) >> 5;
  *(_BYTE *)(v13 + 32) = a2[173] & 7;
  *(_BYTE *)(v13 + 35) = (a2[172] & 4) != 0;
  *(_BYTE *)(v13 + 34) = (a2[172] & 2) != 0;
  *(_DWORD *)(v13 + 24) = *((_DWORD *)a2 + 90);
  *(_DWORD *)(v13 + 28) = *((_DWORD *)a2 + 85);
  if ( v29 )
  {
    if ( *((_BYTE *)a2 + 357) )
      *(_DWORD *)(v13 + 24) = *((unsigned __int8 *)a2 + 357) + 1;
    v30 = *((unsigned __int8 *)a2 + 364);
    *(_BYTE *)(v13 + 128) = v30;
    v31 = *(_DWORD *)(a4 + 88);
    if ( v31 == 4 || v31 == 1 )
    {
    ...
    v32 = *((unsigned __int8 *)a2 + 356);
    if ( v32 == 4 || v32 == 1 )
      LOBYTE(v33) = *((_BYTE *)a2 + 365);
    else
      v33 = (*(_DWORD *)(a4 + 7268) >> 12) & 1;
    *(_BYTE *)(v13 + 132) = v33;
    *(_BYTE *)(v13 + 133) = *((_BYTE *)a2 + 366);
    *(_BYTE *)(v13 + 142) = *((_BYTE *)a2 + 367);
  }
  v34 = *((unsigned __int8 *)a2 + 356);
  if ( !*((_BYTE *)a2 + 356) )
  {
    *(_BYTE *)(v13 + 140) = *(_BYTE *)(a4 + 7236) & 1;
...
LABEL_55:
  ...
  if ( v34 == 4 || v34 == 1 )
  {
    if ( *(_BYTE *)(v13 + 132) && *(_BYTE *)(v10 + 2883) == 1 )
    {
      LOBYTE(v35) = 0;
      *(_BYTE *)(v13 + 140) = 0;
    }
...
LABEL_56:
  *(_BYTE *)(v13 + 124) = *(_BYTE *)(a4 + 8);
  *(_BYTE *)(v13 + 143) = *(_BYTE *)(a4 + 10);
  *(_BYTE *)(v13 + 160) = *(_BYTE *)(a4 + 7032);
  v37 = *(_QWORD *)(a4 + 384);
  if ( v37 )
  {
    v38 = *(_QWORD *)(v37 + 8LL * a2[174]);
    if ( v38 )
    {
      ...
      *(_BYTE *)(v13 + 125) = vendor_ie_ptr_from_oui != nullptr;
      if ( v40 )
        qdf_mem_copy((void *)(v13 + 148), (const void *)(v38 + 3161), 2u);
      if ( *(_BYTE *)(v13 + 127) )
      {
        if ( *(_BYTE *)(v38 + 3344) )
          v41 = 3344;
          ...
          v41 = 3296;
        v42 = *(_QWORD *)(v38 + v41);
        *(_DWORD *)(v13 + 152) = (unsigned __int16)((unsigned int)v42 >> 8)
    ...
    lim_add_eht_cap(a1, a4, v13, v38);
  }
  if ( *((_BYTE *)a2 + 356) == 4 )
  {
    v43 = *(unsigned __int8 *)(v13 + 127);
    *(_WORD *)(v13 + 148) = a2[324];
    v44 = *((_DWORD *)a2 + 163);
    *(_DWORD *)(v13 + 152) = v44;
    if ( v43 )
    ...
    qdf_mem_copy((void *)(v13 + 168), a2 + 432, 0x3Cu);
    if ( *(_BYTE *)(a4 + 8764) == 1 )
      lim_update_he_6ghz_band_caps(a1, a2 + 463, v13);
    if ( *(_BYTE *)(v13 + 256) == 1 )
    {
      qdf_trace_msg(
        0x35u,
        8u,
        "%s: Adding tdls eht capabilities",
        v21,
        v22,
        v23,
        v24,
        ...
        v27,
        v28,
        "lim_add_tdls_sta_eht_config");
      qdf_mem_copy((void *)(v13 + 260), a2 + 466, 0x5Cu);
      qdf_mem_copy((void *)(v13 + 352), a2 + 512, 0xCu);
    }
  }
  v45 = *a2;
  v46 = v45 >> 10;
  if ( (v45 & 0x40) != 0 && (*(_DWORD *)(a4 + 88) == 1 || *((_BYTE *)a2 + 356) == 4) )
  {
    *(_BYTE *)(v13 + 19) = 0;
    v47 = *((_BYTE *)a2 + 238);
    *(_BYTE *)(v13 + 19) = v47 & 1;
  ...
  *(_DWORD *)(v13 + 156) = *(_DWORD *)(a4 + 96);
  if ( v60 )
  {
    if ( (*(_WORD *)(a4 + 7266) & 0x80) != 0 )
      *(_BYTE *)(v13 + 252) = (*(_WORD *)(v13 + 149) & 0x300) != 0;
  }
  else
  {
    if ( *(_BYTE *)(v13 + 127) )
      goto LABEL_132;
    if ( (*(_BYTE *)(v13 + 164) & 1) == 0 && (*(_BYTE *)(v13 + 256) & 1) == 0 )
    {
      v61 = a2[136] & 0x7F;
...
LABEL_132:
    if ( *(_BYTE *)(v13 + 252) )
      *(_BYTE *)(v13 + 252) = (*(_WORD *)(v13 + 153) & 0x700) != 0;
  }
  if ( (*(_DWORD *)(a4 + 7036) | 2) == 3 )
  {
    ...
    if ( v69 )
    {
      v70 = *(_QWORD *)(v69 + 8LL * a2[174]);
      if ( v70 )
      {
        v71 = *(_BYTE *)(v70 + 3267);
        *(_BYTE *)(v13 + 144) = v71;
        *(_BYTE *)(v13 + 144) = v71 | (2 * *(_BYTE *)(v70 + 3266));
        if ( *(_BYTE *)(v70 + 3267) )
        {
          v72 = *(_DWORD *)(v70 + 3280);
          v73 = v72 - 4;
  ...
  if ( *(_BYTE *)(v13 + 164) == 1 && *(_BYTE *)(v13 + 252) )
    *(_BYTE *)(v13 + 252) = (*(_BYTE *)(v13 + 177) & 0x10) != 0;
  qdf_trace_msg(
    0x35u,
    8u,
    ...
    a2[462]);
  if ( a2[462] )
    *(_WORD *)(v13 + 250) = a2[462];
  v96 = *(unsigned __int8 *)(v13 + 116);
  v97 = *(unsigned __int8 *)(v13 + 18);
  v98 = *(unsigned __int16 *)(v13 + 16);
  *(_BYTE *)(v13 + 253) = *(_BYTE *)(a4 + 10045);
  ...
  *(_BYTE *)(v13 + 254) = v100;
  ...
  LODWORD(v136) = *(unsigned __int8 *)(v13 + 140);
  LODWORD(v138) = *(unsigned __int8 *)(v13 + 125);
  LODWORD(v137) = *(unsigned __int8 *)(v13 + 141);
  LODWORD(v135) = *(unsigned __int8 *)(v13 + 117);
  LODWORD(v134) = *(unsigned __int8 *)(v13 + 20);
  LODWORD(v132) = *(unsigned __int8 *)(v13 + 142);
  LODWORD(v131) = *(unsigned __int8 *)(v13 + 133);
  LODWORD(v130) = *(unsigned __int8 *)(v13 + 132);
