  ...
  if ( (_DWORD)result )
  {
    ...
    if ( hdd_monitor_mode_vdev_status___last_ticks - jiffies + 125 < 0 )
    {
      ...
      qdf_trace_msg(
        ...
        *(unsigned __int8 *)(*(_QWORD *)(v1 + 3680) + 8LL));
      result = v13;
    ...
    {
      v14 = jiffies;
      if ( hdd_monitor_mode_vdev_status___last_ticks_426 - jiffies + 125 < 0 )
      {
        v15 = result;
        qdf_trace_msg(
          0x33u,
          ...
          "hdd_monitor_mode_vdev_status");
        result = v15;
        hdd_monitor_mode_vdev_status___last_ticks_426 = v14;
      }
    }
    else
    {
      ...
      if ( (_DWORD)result == 15 )
      {
        if ( hdd_monitor_mode_vdev_status___last_ticks_428 - jiffies + 125 < 0 )
        {
          qdf_trace_msg(
            0x33u,
            2u,
            ...
            "hdd_monitor_mode_vdev_status");
          result = 15;
          hdd_monitor_mode_vdev_status___last_ticks_428 = v16;
        }
      }
      else if ( hdd_monitor_mode_vdev_status___last_ticks_430 - jiffies + 125 < 0 )
      {
        v17 = result;
        qdf_trace_msg(
          0x33u,
          ...
          (unsigned int)result);
        result = v17;
        hdd_monitor_mode_vdev_status___last_ticks_430 = v16;
      }
    }
    *(_BYTE *)(v1 + 3042) = 0;
  }
