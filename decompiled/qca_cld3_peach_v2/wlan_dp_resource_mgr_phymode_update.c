        ...
        double a10)
{
  ...
  if ( (v14 & 0xFFFFFFFD) == 1 )
  {
    v11 = *(_QWORD *)(*(_QWORD *)(v11 + 96) + 176LL);
    if ( !v11 )
    {
  ...
  if ( !v34 )
  {
    ...
    {
      *(_DWORD *)(v47 + 40) = v12;
      if ( (unsigned int)(v12 - 1) > 0x27 )
        v57 = 2400;
      else
        v57 = (__int64)*(&off_B345D0 + (unsigned int)(v12 - 1));
      *(_QWORD *)(v47 + 72) = v57;
      ext_hdl = wlan_vdev_mlme_get_ext_hdl(*(_QWORD *)(v11 + 96), v48, v49, v50, v51, v52, v53, v54, v55);
      if ( ext_hdl )
      {
        v87 = *(_DWORD *)(ext_hdl + 24924);
        if ( v87 >= 2 )
          v87 = 0;
      }
      else
  ...
  if ( *(_DWORD *)(v34 + 40) != v12 )
  {
    ...
    *(_DWORD *)(v34 + 40) = v12;
    if ( (unsigned int)(v12 - 1) > 0x27 )
      ...
      v59 = (__int64)*(&off_B345D0 + (unsigned int)(v12 - 1));
    v60 = *(_DWORD *)(v34 + 100);
    *(_QWORD *)(v34 + 72) = v59;
    if ( v60 >= 3
