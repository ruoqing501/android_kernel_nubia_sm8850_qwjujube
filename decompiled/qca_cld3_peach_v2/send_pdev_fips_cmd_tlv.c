  ...
  if ( (v2 & 0xF) == 0 && (unsigned int)(v2 - 1) <= 0x676 )
  {
    ...
    if ( v6 )
    {
      ...
      *v7 = 29884468;
      ...
      v10 = *(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)(a1 + 728) + 3680LL);
      ...
      if ( *(_QWORD *)a2 && *(_QWORD *)(a2 + 16) )
      {
        ...
        if ( v19 >= 2 )
          v19 = 0;
        v7[3] = v19;
        print_hex_dump(&unk_A60B46, "Key: ", 0, 16, 1, v7 + 5, v20, 1);
        v7[14] = *(unsigned __int16 *)(a2 + 24) | 0x110000;
        v21 = *(unsigned int *)(a2 + 24);
        if ( (_DWORD)v21 )
          qdf_mem_copy(v7 + 15, *(const void **)(a2 + 16), v21);
        print_hex_dump(&unk_A60B46, "Plain text: ", 0, 16, 1, v7 + 15, (unsigned int)v7[13], 1);
