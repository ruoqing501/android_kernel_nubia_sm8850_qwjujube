__int64 __fastcall wlan_cm_tgt_send_roam_rt_stats_config(__int64 a1, unsigned __int8 *a2)
{
  __int64 v3; // x0
  double v4; // d0
  double v5; // d1
...
LABEL_11:
  ...
  v16 = *(__int64 (__fastcall **)(__int64, __int64, __int64))(ext_hdl + 7432);
  if ( v16 )
  {
    v17 = a2[1];
    v18 = *a2;
    ...
    if ( v20 )
      qdf_trace_msg(
        0x68u,
        8u,
        "%s: vdev %d fail to send roam rt stats config",
        v21,
        v22,
        v23,
        v24,
        ...
        v27,
        v28,
        "wlan_cm_tgt_send_roam_rt_stats_config",
        *a2);
    goto LABEL_13;
  }
LABEL_12:
  qdf_trace_msg(
    0x68u,
    2u,
    "%s: vdev %d send_roam_rt_stats_config is NULL",
    v4,
    v5,
    v6,
    v7,
