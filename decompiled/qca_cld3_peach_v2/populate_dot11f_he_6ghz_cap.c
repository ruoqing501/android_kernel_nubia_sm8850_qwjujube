        ...
        double a11)
{
  ...
  if ( !a2 || *(_BYTE *)(a2 + 8764) == 1 )
  {
    ...
    *(_BYTE *)a3 = 1;
    v13 = v12 & 0xFFFFFFF8 | (*(unsigned __int8 *)(*(_QWORD *)(a1 + 8) + 1290LL) >> 2) & 7;
    v14 = v13 & 0xE7FF;
    *(_WORD *)(a3 + 1) = v13;
    if ( a2 )
    {
    ...
    {
      v18 = (*(_WORD *)(v11 + 1288) << 9) & 0x1800 | v14;
      *(_WORD *)(a3 + 1) = v18;
      LOWORD(v17) = v18 & 0xFFC7;
      v16 = 8 * (*(_BYTE *)(v11 + 2877) & 7);
    }
    v19 = v17 | v16;
    *(_WORD *)(a3 + 1) = v19;
    *(_WORD *)(a3 + 1) = v19 & 0x18FF | ((*(_BYTE *)(v11 + 2878) & 7) << 8);
