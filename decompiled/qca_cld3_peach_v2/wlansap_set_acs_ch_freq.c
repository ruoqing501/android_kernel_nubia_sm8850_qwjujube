        ...
        double a11)
{
  ...
  *(_DWORD *)(a2 + 8LL * (*(_DWORD *)(a2 + 728) == 2)) = a3;
  ...
  if ( a3 )
  {
    result = policy_mgr_is_vdev_ll_lt_sap(*(_QWORD *)(a1 + 21624), *(unsigned __int8 *)(a2 + 12));
    if ( (result & 1) != 0 )
    {
      v16 = *(unsigned __int8 *)(a2 + 12);
      cu_for_freq = wlan_ll_sap_get_cu_for_freq(*(_QWORD *)(a1 + 21632), a3);
      result = wlan_ll_sap_set_cur_freq_unused_cu(*(_QWORD *)(a1 + 21624), v16, cu_for_freq);
      if ( (_DWORD)result )
        return qdf_trace_msg(
                 0x39u,
                 8u,
