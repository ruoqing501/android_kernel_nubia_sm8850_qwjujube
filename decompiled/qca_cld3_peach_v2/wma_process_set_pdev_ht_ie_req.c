__int64 __fastcall wma_process_set_pdev_ht_ie_req(__int64 *a1, __int64 a2)
{
  int v4; // w22
  __int64 result; // x0
  double v6; // d0
  ...
  result = wmi_buf_alloc_fl(*a1, v4 + 24, "wma_process_set_pdev_ht_ie_req", 0x19Fu);
  if ( result )
  {
    ...
    *(_DWORD *)(v14 + 16) = *(unsigned __int8 *)(a2 + 2);
    qdf_trace_msg(
      0x36u,
      8u,
      "%s: Setting pdev HT ie with Nss = %u",
      v6,
      v7,
      v8,
      v9,
      ...
      v12,
      v13,
      "wma_process_set_pdev_ht_ie_req",
