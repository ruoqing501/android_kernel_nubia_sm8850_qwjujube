        ...
        double a10)
{
  ...
  if ( context )
  {
    ...
    if ( v22 )
    {
      v31 = *(unsigned __int16 *)(v22[1] + 1494LL);
    }
    else
    {
      qdf_trace_msg(
    ...
    values = cfg_psoc_get_values(v21[2703]);
    v34 = *(unsigned __int8 *)(values + 9814);
    result = qdf_trace_msg(
               ...
               *(unsigned __int8 *)(values + 9814),
               v31,
               a2 & 1,
               *(unsigned __int8 *)(a1 + 1645),
               *(_DWORD *)(a1 + 1500));
    if ( v34 == 1 && v31 )
    {
      if ( (a2 & 1) != 0 )
