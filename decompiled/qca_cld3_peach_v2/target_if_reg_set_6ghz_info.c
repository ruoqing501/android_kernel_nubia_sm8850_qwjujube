__int64 __fastcall target_if_reg_set_6ghz_info(
        __int64 a1,
        double a2,
        double a3,
        double a4,
        ...
        double a9)
{
  ...
  {
    v10 = *(void (__fastcall **)(__int64, __int64))(v9 + 472);
    if ( v10 )
    {
      v11 = *(_QWORD *)(a1 + 2800);
      if ( v11 )
      {
        ...
        {
          v12 = a1;
          LOBYTE(v11) = wmi_service_enabled(v11, 191);
          a1 = v12;
        }
      }
