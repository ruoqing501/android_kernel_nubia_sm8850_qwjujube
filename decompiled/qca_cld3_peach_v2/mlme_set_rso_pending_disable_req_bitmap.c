__int64 __fastcall mlme_set_rso_pending_disable_req_bitmap(__int64 a1, __int64 a2, unsigned int a3, char a4)
{
  ...
  if ( ext_hdl )
  {
    ...
    qdf_trace_msg(
      0x1Fu,
      8u,
      "%s: vdev[%d] req bitmap[0x%x], reqs: %d, clear: %d",
      v18,
      v19,
      v20,
      v21,
  ...
  return wlan_objmgr_vdev_release_ref(v16, 0x43u, v33, v34, v35, v36, v37, v38, v39, v40, v41);
}
