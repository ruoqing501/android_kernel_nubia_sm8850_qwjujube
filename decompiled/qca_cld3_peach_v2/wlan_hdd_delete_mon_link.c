__int64 __fastcall wlan_hdd_delete_mon_link(__int64 a1, unsigned __int8 *a2)
{
  ...
  if ( result )
  {
    ...
    {
      v40 = jiffies;
      if ( wlan_hdd_delete_mon_link___last_ticks_705 - jiffies + 125 < 0 )
      {
        qdf_trace_msg(
          0x33u,
          2u,
          ...
          v39,
          "wlan_hdd_delete_mon_link");
        wlan_hdd_delete_mon_link___last_ticks_705 = v40;
      }
    }
    ...
    {
      v50 = jiffies;
      if ( wlan_hdd_delete_mon_link___last_ticks_707 - jiffies + 125 < 0 )
      {
        qdf_trace_msg(
          0x33u,
          2u,
          ...
          *(unsigned __int8 *)(*(_QWORD *)(a1 + 52832) + 8LL),
          v41);
        wlan_hdd_delete_mon_link___last_ticks_707 = v50;
      }
    }
