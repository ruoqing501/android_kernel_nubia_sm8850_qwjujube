        ...
        double a11)
{
  ...
  v34 = wlan_objmgr_vdev_release_ref(v23, 0x1Bu, v25, v26, v27, v28, v29, v30, v31, v32, v33);
  if ( ch_width >= 8 )
  {
    qdf_trace_msg(
      0x56u,
    ...
    if ( a1 )
    {
      if ( *a1 )
      {
        ...
        if ( v37 )
        {
          ...
          result = *v41;
LABEL_30:
          if ( (*(_BYTE *)(v37 + 22) & 0x10) != 0 && (ch_width == 3 || ch_width == 4) )
          {
            if ( (a3 & 1) != 0 )
              return 4;
            else
...
LABEL_25:
  ...
  v44 = ch_width;
  v45 = dword_B354A8[v44];
  v46 = *(_DWORD *)((char *)a1 + v44 * 4 + 1976);
  v47 = (unsigned int *)((char *)&supported_sscan_bw_list + 4 * v45);
  while ( ((v46 >> v45) & 1) == 0 )
  {
    v42 = (int)v45 <= 0;
    LODWORD(v45) = v45 - 1;
...
LABEL_36:
  __break(0x5512u);
  return target_if_vdev_get_ch_width(v34);
}
