        ...
        unsigned int a6)
{
  ...
  dp_rx_nbuf_unmap_pool(a1, v8 + 12416, v6);
  *((_BYTE *)a3 + 30) |= 2u;
  v15 = *(_QWORD *)(a1 + 18528);
  if ( (v15 & 1) != 0 )
  {
    *(_QWORD *)(a1 + 18528) = v15 & 0xFFFFFFFFFFFFFFFELL;
  ...
  else
  {
    ...
    v30 = *(_QWORD *)(a1 + 40);
    v31 = (void (__fastcall *)(__int64, __int64, __int64, __int64, __int64, __int64))v29[12064];
    v55[0] = 0;
