...
LABEL_34:
    ...
    *(_QWORD *)(a1 + 18696) = v27;
    if ( v27 )
    {
      qdf_event_reset(a1 + 18632);
      if ( (_ReadStatusReg(DAIF) & 0x80) != 0
        || (StatusReg = _ReadStatusReg(SP_EL0), (*(_DWORD *)(StatusReg + 16) & 0xF0000) != 0)
        || (*(_DWORD *)(StatusReg + 16) & 0xFF00) != 0 )
      {
        raw_spin_lock(a1 + 18672);
      }
      else
      {
        raw_spin_lock_bh(a1 + 18672);
        *(_QWORD *)(a1 + 18680) |= 1uLL;
      }
      v45 = *(_DWORD *)(a1 + 18624);
      v46 = *(_DWORD *)(a1 + 18628);
      *(_QWORD *)(a1 + 18624) = 0;
      qdf_trace_msg(
        ...
        v44,
        "dp_request_rx_hw_stats");
      v47 = dp_peer_rxtid_stats(v26, dp_rx_hw_stats_cb, *(_QWORD *)(a1 + 18696));
      if ( v47 )
      {
        v56 = v47;
        **(_DWORD **)(a1 + 18696) = v47;
        *(_BYTE *)(*(_QWORD *)(a1 + 18696) + 4LL) = 0;
        v57 = *(_QWORD *)(a1 + 18680);
        *(_BYTE *)(a1 + 18688) = 1;
        if ( (v57 & 1) != 0 )
        {
          *(_QWORD *)(a1 + 18680) = v57 & 0xFFFFFFFFFFFFFFFELL;
          raw_spin_unlock_bh(a1 + 18672);
        }
        else
        {
          raw_spin_unlock(a1 + 18672);
        }
        v16 = qdf_wait_single_event(a1 + 18632, 0x64u);
        qdf_trace_msg(
          0x45u,
          8u,
...
LABEL_20:
        ...
        if ( (v76 & 1) != 0 )
        {
          *(_QWORD *)(a1 + 18680) = v76 & 0xFFFFFFFFFFFFFFFELL;
          raw_spin_unlock_bh(a1 + 18672);
        }
        else
        {
      ...
      qdf_trace_msg(
        ...
        v55,
        "dp_request_rx_hw_stats");
      _qdf_mem_free(*(_QWORD *)(a1 + 18696));
      v85 = *(_QWORD *)(a1 + 18680);
      *(_QWORD *)(a1 + 18696) = 0;
      if ( (v85 & 1) != 0 )
      {
        *(_QWORD *)(a1 + 18680) = v85 & 0xFFFFFFFFFFFFFFFELL;
        raw_spin_unlock_bh(a1 + 18672);
      }
      else
      {
