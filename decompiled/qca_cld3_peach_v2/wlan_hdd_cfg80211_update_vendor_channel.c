...
LABEL_121:
              v165 = jiffies;
              if ( hdd_extract_external_acs_frequencies___last_ticks_986 - jiffies + 125 < 0 )
              {
                qdf_trace_msg(
                  0x33u,
                  2u,
                  ...
                  v71,
                  "hdd_extract_external_acs_frequencies");
                hdd_extract_external_acs_frequencies___last_ticks_986 = v165;
              }
              _qdf_mem_free(v55);
              goto LABEL_33;
            }
          ...
          {
            v44 = jiffies;
            if ( hdd_extract_external_acs_frequencies___last_ticks_984 - jiffies + 125 < 0 )
            {
              qdf_trace_msg(
                0x33u,
                2u,
                ...
                "hdd_extract_external_acs_frequencies",
                102);
              hdd_extract_external_acs_frequencies___last_ticks_984 = v44;
            }
          }
          v36 = -12;
          goto LABEL_34;
...
LABEL_44:
  ...
  {
    v51 = jiffies;
    if ( hdd_extract_external_acs_channels___last_ticks_989 - jiffies + 125 < 0 )
    {
      qdf_trace_msg(
        0x33u,
        2u,
        ...
        "hdd_extract_external_acs_channels",
        102);
      hdd_extract_external_acs_channels___last_ticks_989 = v51;
    }
    goto LABEL_95;
  }
  v183 = v47;
...
LABEL_108:
  qdf_trace_msg(
    ...
    v114);
  v115 = *(__int64 **)(*v6 + 24);
  if ( (unsigned int)qdf_mc_timer_get_current_state((__int64)(v6 + 305)) == 21 )
    qdf_mc_timer_stop((__int64)(v6 + 305));
  v124 = *v113;
  if ( !*v113 )
  {
    v124 = 2437;
  ...
  else
  {
    ...
    else
    {
      ...
      *((_DWORD *)v6 + 188) = v147;
      *((_DWORD *)v6 + 497) = *(_DWORD *)(v91 + 4);
      *((_WORD *)v6 + 733) = hdd_map_nl_chan_width(*(unsigned __int8 *)(v91 + 20));
      *((_DWORD *)v6 + 499) = *(_DWORD *)(v91 + 12);
      *((_DWORD *)v6 + 500) = *(_DWORD *)(v91 + 16);
      *((_DWORD *)v6 + 498) = *(_DWORD *)(v91 + 8);
