...
LABEL_8:
  ...
  inited = hdd_init_nan_data_mode(adapter_by_iface_name, v22, v23, v24, v25, v26, v27, v28, v29);
  if ( inited )
  {
    qdf_trace_msg(
      0x33u,
...
LABEL_6:
  ...
  vdev_by_user = _hdd_objmgr_get_vdev_by_user(*(_QWORD *)(v30 + 52832), 0x52u, (__int64)"hdd_ndi_start");
  if ( !vdev_by_user )
  {
...
LABEL_16:
  v113 = *(_QWORD *)(v86 + 21632);
  v114 = *(_BYTE *)(*(_QWORD *)(v30 + 52832) + 8LL);
  HIDWORD(v173) = 1024;
  LODWORD(v174) = v96;
  LOBYTE(v173) = v114;
  ...
  v115 = *(_BYTE *)(*(_QWORD *)(v30 + 52832) + 8LL);
  ...
  started = sme_start_bss(v86, *(_BYTE *)(*(_QWORD *)(v30 + 52832) + 8LL), (__int64)v172);
  if ( started )
  {
    qdf_trace_msg(
      0x33u,
      ...
      v124,
      "hdd_ndi_start_bss",
      *(unsigned __int8 *)(*(_QWORD *)(v30 + 52832) + 8LL),
      started,
      v172[0]);
