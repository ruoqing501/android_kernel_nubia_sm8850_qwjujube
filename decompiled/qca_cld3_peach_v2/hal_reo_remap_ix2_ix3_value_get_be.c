...
LABEL_11:
    if ( (a2 & 0x80) == 0 )
      goto LABEL_12;
LABEL_19:
    *((_DWORD *)v26 + v4++) = dword_163DC;
    goto LABEL_20;
  }
LABEL_18:
  *((_DWORD *)v26 + v4++) = dword_163D8;
  if ( (a2 & 0x80) != 0 )
    goto LABEL_19;
LABEL_12:
  if ( !a2 )
