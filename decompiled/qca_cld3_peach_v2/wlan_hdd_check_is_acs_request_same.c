...
LABEL_4:
  ...
  if ( *((unsigned __int8 *)a1 + 2020) != *(unsigned __int8 *)(v40 + 4) )
  {
    v16 = jiffies;
  ...
  if ( (v41 != 0) != *((_BYTE *)a1 + 2021) )
  {
    ...
    if ( wlan_hdd_check_is_acs_request_same___last_ticks_242 - jiffies + 125 < 0 )
    {
      qdf_trace_msg(
        ...
        "wlan_hdd_check_is_acs_request_same");
      result = 0;
      wlan_hdd_check_is_acs_request_same___last_ticks_242 = v17;
      goto LABEL_5;
    }
    goto LABEL_4;
  }
  if ( (v42 != 0) != *((_BYTE *)a1 + 2022) )
  {
    v18 = jiffies;
    if ( wlan_hdd_check_is_acs_request_same___last_ticks_244 - jiffies + 125 < 0 )
    {
      qdf_trace_msg(
        ...
        "wlan_hdd_check_is_acs_request_same");
      result = 0;
      wlan_hdd_check_is_acs_request_same___last_ticks_244 = v18;
      goto LABEL_5;
    }
    goto LABEL_4;
  }
  if ( (v43 != 0) != *((_BYTE *)a1 + 2023) )
  {
    v19 = jiffies;
    if ( wlan_hdd_check_is_acs_request_same___last_ticks_246 - jiffies + 125 < 0 )
    {
      qdf_trace_msg(
        ...
        "wlan_hdd_check_is_acs_request_same");
      result = 0;
      wlan_hdd_check_is_acs_request_same___last_ticks_246 = v19;
      goto LABEL_5;
    }
    goto LABEL_4;
  }
  if ( (v56 != 0) != *((_BYTE *)a1 + 2024) )
  {
    v20 = jiffies;
    if ( wlan_hdd_check_is_acs_request_same___last_ticks_248 - jiffies + 125 < 0 )
    {
      qdf_trace_msg(
        0x33u,
        4u,
        ...
        "wlan_hdd_check_is_acs_request_same");
      result = 0;
      wlan_hdd_check_is_acs_request_same___last_ticks_248 = v20;
      goto LABEL_5;
    }
    goto LABEL_4;
  }
  if ( v44 )
    ...
    v15 = 0;
  if ( *((unsigned __int16 *)a1 + 1013) != v15 )
  {
    v27 = jiffies;
    if ( wlan_hdd_check_is_acs_request_same___last_ticks_250 - jiffies + 125 < 0 )
    {
      qdf_trace_msg(
        0x33u,
        4u,
        ...
        "wlan_hdd_check_is_acs_request_same");
      result = 0;
      wlan_hdd_check_is_acs_request_same___last_ticks_250 = v27;
      goto LABEL_5;
    }
    goto LABEL_4;
  }
  ...
  if ( *((_DWORD *)a1 + 504) != v38 )
  {
    v28 = jiffies;
    if ( wlan_hdd_check_is_acs_request_same___last_ticks_252 - jiffies + 125 < 0 )
    {
      qdf_trace_msg(
        0x33u,
        4u,
        ...
        "wlan_hdd_check_is_acs_request_same");
      result = 0;
      wlan_hdd_check_is_acs_request_same___last_ticks_252 = v28;
      goto LABEL_5;
    }
    goto LABEL_4;
  }
  if ( v48 )
  {
    ...
    if ( *((unsigned __int8 *)a1 + 1464) != (_DWORD)v22 )
    {
      v35 = jiffies;
      if ( wlan_hdd_check_is_acs_request_same___last_ticks_254 - jiffies + 125 < 0 )
      {
        qdf_trace_msg(
          0x33u,
          4u,
          ...
          "wlan_hdd_check_is_acs_request_same");
        result = 0;
        wlan_hdd_check_is_acs_request_same___last_ticks_254 = v35;
        goto LABEL_5;
      }
      goto LABEL_4;
    }
