__int64 __fastcall qdf_nbuf_map_nbytes_single_0(__int64 a1, __int64 a2, unsigned int a3)
{
  __int64 v6; // x22
  const char **v7; // x21
  char v8; // w0
  ...
  if ( (v8 & 1) != 0 && (dma_map_single_attrs___already_done_5 & 1) == 0 )
  {
    v10 = v8;
    dma_map_single_attrs___already_done_5 = 1;
