_QWORD *__fastcall lim_is_pkt_candidate_for_drop(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  switch ( a3 )
  {
    ...
    case 0xBu:
      v9 = *(_WORD **)(a2 + 16);
      result = wlan_objmgr_get_vdev_by_macaddr_from_pdev(*(_QWORD *)(a1 + 21632), v9 + 2, 7u);
      if ( !result )
        goto LABEL_48;
...
LABEL_37:
    ...
    if ( (_DWORD)v72 == 1 )
    {
      v73 = *((unsigned __int8 *)result + 168);
      wlan_objmgr_vdev_release_ref((__int64)result, 7u, v72, v64, v65, v66, v67, v68, v69, v70, v71);
      result = wlan_objmgr_pdev_get_roam_vdev(*(_QWORD *)(a1 + 21632), 7u);
      if ( result )
      {
        v82 = (__int64)result;
        qdf_trace_msg(
...
LABEL_19:
  peer_by_mac = wlan_objmgr_get_peer_by_mac(*(_QWORD *)(a1 + 21624), (_BYTE *)(*(_QWORD *)(a2 + 16) + 10LL), 7u);
  if ( !peer_by_mac )
    goto LABEL_45;
  v41 = peer_by_mac[12];
  if ( !v41 )
  ...
  if ( !*(_DWORD *)(v41 + 16) )
  {
    ...
    is_vdev_roam_started = wlan_cm_is_vdev_roam_started(peer_by_mac[12], v33, v34, v35, v36, v37, v38, v39, v40);
