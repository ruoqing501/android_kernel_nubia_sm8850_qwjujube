...
LABEL_12:
  ...
  else if ( hash_entry )
  {
    ...
    result = lim_send_assoc_rsp_mgmt_frame(a1, a8, 0, a2, a3, v44, a17, 0, v44 + 540);
    v46 = *(_QWORD *)(*(_QWORD *)(a17 + 384) + 8LL * (unsigned __int16)v44[174]);
    if ( v46 )
    {
      v47 = *(_QWORD *)(v46 + 3272);
      if ( v47 )
      ...
      *(_QWORD *)(*(_QWORD *)(a17 + 384) + 8LL * (unsigned __int16)v44[174]) = 0;
    }
  }
  else
  {
