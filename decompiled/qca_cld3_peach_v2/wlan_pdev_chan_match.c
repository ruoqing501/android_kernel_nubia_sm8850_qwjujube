...
LABEL_8:
    ...
    {
      qdf_mem_copy(&v52, v10, 0x28u);
      v11 = *(_QWORD *)(a2 + 1352);
      if ( (v11 & 1) != 0 )
      {
        *(_QWORD *)(a2 + 1352) = v11 & 0xFFFFFFFFFFFFFFFELL;
        raw_spin_unlock_bh(a2 + 1344);
      }
      else
      {
        raw_spin_unlock(a2 + 1344);
      }
      v12 = *(_QWORD *)(a3 + 8);
      if ( (_ReadStatusReg(DAIF) & 0x80) != 0
      ...
      {
        raw_spin_lock(v12 + 1344);
      }
      else
      {
        v51 = v12;
        raw_spin_lock_bh(v12 + 1344);
        *(_QWORD *)(v51 + 1352) |= 1uLL;
      }
      v22 = *(_QWORD *)(a3 + 8);
      v23 = (_BYTE *)a3;
      v24 = *(_QWORD *)(v22 + 40);
      if ( BYTE2(v52) != *(unsigned __int8 *)(v24 + 2)
        || BYTE4(v52) != *(unsigned __int8 *)(v24 + 4)
        || (unsigned __int16)v56 != *(unsigned __int16 *)(v24 + 32) )
      {
        *v23 = 1;
        v25 = v23;
        qdf_trace_msg(
        ...
        qdf_trace_msg(
          ...
          v41,
          "wlan_pdev_chan_match",
          *(unsigned __int8 *)(*((_QWORD *)v25 + 1) + 168LL),
      ...
      if ( (v50 & 1) != 0 )
      {
        *(_QWORD *)(v22 + 1352) = v50 & 0xFFFFFFFFFFFFFFFELL;
        raw_spin_unlock_bh(v22 + 1344);
        goto LABEL_26;
      }
      v7 = v22 + 1344;
    }
