                  ...
                  if ( *(_QWORD *)(adapter_by_macaddr + 32) )
                  {
                    if ( *(_DWORD *)adapter_by_macaddr == 1885692259 )
                    {
                      if ( a2 > 0x19 )
                      {
                        if ( a3[24] == 1 && a3[25] == 4 )
                          ((void (__fastcall *)(__int64, __int64, _QWORD))sme_update_dsc_pto_up_mapping)(
                            ...
                            *(unsigned __int8 *)(*(_QWORD *)(adapter_by_macaddr + 52832) + 8LL));
                      }
                      else
                      {
                        qdf_trace_msg(
                      ...
                      if ( v96 )
                      {
                        v105 = v96;
                        if ( *(_DWORD *)(v96 + 16) == 1
                          && (wlan_vdev_mlme_is_mlo_vdev(v96, v97, v98, v99, v100, v101, v102, v103, v104) & 1) != 0 )
                        {
                          LOBYTE(v142) = 1;
                          BYTE1(v142) = *(_BYTE *)(*(_QWORD *)(a1 + 32) + 93LL);
                        }
