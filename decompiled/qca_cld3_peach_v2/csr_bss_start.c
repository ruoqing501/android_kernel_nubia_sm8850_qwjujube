__int64 __fastcall csr_bss_start(_QWORD *a1, unsigned int a2, __int64 a3)
{
  ...
  unsigned int v78; // w8
  unsigned int v79; // w8
  _DWORD v80[2]; // [xsp+8h] [xbp-58h] BYREF
  __int64 (__fastcall *v81)(__int64, int, double, double, double, double, double, double, double, double); // [xsp+10h] [xbp-50h]
  __int64 v82; // [xsp+18h] [xbp-48h]
  __int64 v83; // [xsp+20h] [xbp-40h]
  __int64 v84; // [xsp+28h] [xbp-38h]
  __int64 v85; // [xsp+30h] [xbp-30h]
  __int64 v86; // [xsp+38h] [xbp-28h] BYREF
  __int64 v87; // [xsp+40h] [xbp-20h]
  __int64 v88; // [xsp+48h] [xbp-18h]
  __int64 v89; // [xsp+50h] [xbp-10h]
...
LABEL_14:
  ...
  *(_WORD *)(v3 + 48) = v33;
  *(_BYTE *)(a3 + 680) = policy_mgr_get_connection_count(a1[2703]);
  v34 = *(_DWORD *)(v28 + 4);
