...
LABEL_9:
  ...
  v34 = 0;
  v35 = 0;
  v36 = (unsigned __int8 *)&qword_8D4F00 + 4;
  while ( 1 )
  {
...
LABEL_15:
    ...
    if ( v34 == 5 )
    {
      if ( a2 )
        *a2 = 4;
      if ( dword_8D4EFC == 2 && BYTE4(qword_8D4F00) == 1
        || dword_8D4F20 == 2 && (qword_8D4F24 & 0x100000000LL) != 0
        || dword_8D4F44 == 2 && (qword_8D4F48 & 0x100000000LL) != 0
        || dword_8D4F68 == 2 && (qword_8D4F6C & 0x100000000LL) != 0
        || dword_8D4F8C == 2 && (qword_8D4F90 & 0x100000000LL) != 0 )
      {
