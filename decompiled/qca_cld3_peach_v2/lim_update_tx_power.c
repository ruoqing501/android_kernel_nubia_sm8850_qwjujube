        ...
        double a12)
{
  ...
  if ( cmpt_obj && v25 )
  {
    ...
    *(_BYTE *)(a3 + 10070) = 1;
    if ( *(unsigned __int8 *)(cmpt_obj + 548) == *(unsigned __int8 *)(v25 + 548) )
    {
      qdf_trace_msg(
        0x35u,
        2u,
    ...
    v53 = qdf_trace_msg(
            ...
            v42,
            "lim_update_tx_power");
    *(_BYTE *)(cmpt_obj + 548) = *(_BYTE *)(v25 + 548);
    v62 = *(unsigned __int8 *)(v25 + 549);
    if ( *(_BYTE *)(v25 + 549) )
    {
      v63 = *(_DWORD *)(a2 + 284);
      if ( *(_DWORD *)(v25 + 652) == v63 )
      {
        v64 = 0;
LABEL_14:
        v65 = *(_BYTE *)(v25 + 652 + 8 * v64 + 4);
LABEL_17:
        v66 = *(unsigned __int8 *)(cmpt_obj + 549);
        if ( !*(_BYTE *)(cmpt_obj + 549) )
          goto LABEL_34;
        ...
        *(_WORD *)(cmpt_obj + 704) = v65;
        if ( v66 == 7 )
          goto LABEL_34;
        *(_WORD *)(cmpt_obj + 712) = v65;
        if ( v66 == 8 )
          goto LABEL_34;
        *(_WORD *)(cmpt_obj + 720) = v65;
        if ( v66 == 9
          || (*(_WORD *)(cmpt_obj + 728) = v65, v66 == 10)
          || (*(_WORD *)(cmpt_obj + 736) = v65, v66 == 11)
          || (*(_WORD *)(cmpt_obj + 744) = v65, v66 == 12)
          || (*(_WORD *)(cmpt_obj + 752) = v65, v66 == 13)
          || (*(_WORD *)(cmpt_obj + 760) = v65, v66 == 14)
          || (*(_WORD *)(cmpt_obj + 768) = v65, v66 == 15)
          || (*(_WORD *)(cmpt_obj + 776) = v65, v66 == 16) )
        {
LABEL_34:
...
LABEL_82:
        __break(0x5512u);
        v67 = MEMORY[0xFFFFFFFFFE4D4084](v53);
