        ...
        double a9)
{
  ...
  while ( 1 )
  {
    v34 = *(_DWORD *)(a1 + 4 * v33 + 544);
    if ( v34 != 40 )
      break;
    if ( !*(_QWORD *)(a1 + 8 * v33 + 112) )
    {
      v35 = 40;
      v36 = *(_QWORD *)(a1 + 776);
      if ( (v36 & 1) != 0 )
...
LABEL_19:
  ...
  if ( (v36 & 1) == 0 )
    goto LABEL_27;
LABEL_33:
  *(_QWORD *)(a1 + 776) = v36 & 0xFFFFFFFFFFFFFFFELL;
  result = raw_spin_unlock_bh(a1 + 768);
  if ( v35 == 16 )
    return result;
LABEL_28:
  if ( v35 != 40 )
