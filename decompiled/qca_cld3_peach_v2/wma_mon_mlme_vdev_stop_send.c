        ...
        double a9)
{
  ...
  if ( context )
  {
    ...
    v21 = wma_send_vdev_stop_to_fw((__int64)context, *(_BYTE *)(v19 + 168), v11, v12, v13, v14, v15, v16, v17, v18);
    if ( v21 )
      qdf_trace_msg(
        0x36u,
        2u,
        ...
        v20);
    wlan_vdev_mlme_sm_deliver_evt(*(_QWORD *)(a1 + 520), 0x1Au, 0, 0, v22, v23, v24, v25, v26, v27, v28, v29);
  }
  else
  {
    return 4;
