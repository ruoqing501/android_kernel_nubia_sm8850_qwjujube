        ...
        double a9)
{
  ...
  if ( v9 )
  {
    ...
    if ( freq && freq != *(_DWORD *)(v11 + 2424) )
    {
      result = hdd_dcs_hostapd_set_chan((__int64)v9, *(unsigned __int8 *)(*(_QWORD *)(a1 + 52832) + 8LL), freq);
    }
    else
    {
      v13 = *(_QWORD *)(a1 + 52832);
      ...
      else
      {
        ...
        if ( link_info_by_vdev )
        {
          ...
          if ( (result & 1) != 0 )
          {
            result = wlan_reg_is_24ghz_ch_freq(*(_DWORD *)(v34 + 2424));
            if ( (result & 1) == 0 )
