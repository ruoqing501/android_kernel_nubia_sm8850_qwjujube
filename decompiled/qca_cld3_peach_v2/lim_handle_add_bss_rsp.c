    ...
    *(_BYTE *)(a1 + 8885) = 1;
    ...
    if ( session_by_vdev_id )
    {
      ...
      if ( *(_DWORD *)(session_by_vdev_id + 88) == 1
        && (wlan_reg_is_ext_tpc_supported(*(_QWORD *)(a1 + 21624), v23, v24, v25, v26, v27, v28, v29, v30) & 1) != 0 )
      {
        v32 = *(_QWORD *)(v31 + 16);
        LODWORD(v134[0]) = 0;
        ...
        {
          v42 = cmpt_obj;
          tx_ops = wlan_reg_get_tx_ops(*(_QWORD *)(a1 + 21624), v34, v35, v36, v37, v38, v39, v40, v41);
          if ( tx_ops )
          {
            v44 = tx_ops;
            ...
            if ( !policy_mgr_is_vdev_ll_lt_sap(*(_QWORD *)(a1 + 21624), *(unsigned __int8 *)(v31 + 10)) )
            {
LABEL_18:
...
LABEL_73:
        ...
        *(_DWORD *)(v77 + 88) = 1;
        ...
        if ( *(_BYTE *)(v77 + 1620) )
        {
          ...
          if ( !param || (param & 4) != 0 )
          {
            if ( *(unsigned __int8 *)(*(_QWORD *)(a1 + 8) + 3407LL) >= 0x11u )
            {
              qdf_trace_msg(
                0x35u,
                8u,
...
LABEL_66:
              ...
              v123 = *(_QWORD *)(a1 + 8);
              v124 = v114 ^ 1;
              if ( *(unsigned __int8 *)(v123 + 3407) < 0x11u )
                v124 = 1;
              if ( (v124 & 1) != 0 )
              {
                v78 = 0;
