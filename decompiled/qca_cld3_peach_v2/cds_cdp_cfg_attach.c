        ...
        double a9)
{
  ...
  HIDWORD(v62) = *(_DWORD *)(cfg_psoc_get_values(a1) + 1136);
  LODWORD(v63) = *(_DWORD *)(cfg_psoc_get_values(a1) + 568);
  HIDWORD(v63) = *(_DWORD *)(cfg_psoc_get_values(a1) + 576);
  LODWORD(v64) = *(_DWORD *)(cfg_psoc_get_values(a1) + 572);
  LOBYTE(v65) = ucfg_dp_is_rx_common_thread_enabled(a1) & 1;
  WORD2(v64) = *(_WORD *)(cfg_psoc_get_values(a1) + 429);
  BYTE6(v64) = *(_BYTE *)(cfg_psoc_get_values(a1) + 431);
  HIBYTE(v64) = *(_BYTE *)(cfg_psoc_get_values(a1) + 640);
  BYTE1(v65) = *(_BYTE *)(cfg_psoc_get_values(a1) + 4253);
  *(_WORD *)((char *)&v76 + 5) = *(_WORD *)(cfg_psoc_get_values(a1) + 410);
  HIBYTE(v76) = *(_BYTE *)(cfg_psoc_get_values(a1) + 412);
  LODWORD(v77) = *(_DWORD *)(cfg_psoc_get_values(a1) + 584);
  if ( (*(_BYTE *)(cfg_psoc_get_values(a1) + 416) & 1) != 0 )
    BYTE4(v76) = 1;
  BYTE4(v77) = *(_BYTE *)(cfg_psoc_get_values(a1) + 4252);
  BYTE5(v77) = *(_BYTE *)(cfg_psoc_get_values(a1) + 580);
  BYTE6(v77) = *(_DWORD *)(cfg_psoc_get_values(a1) + 608);
  if ( !v10 || !*(_QWORD *)v10 )
  {
  ...
  *(_QWORD *)(gp_cds_context + 72) = v23;
  ...
  if ( *(_QWORD *)v10 )
  {
    ...
    if ( v34 )
    {
      ...
      if ( v35 )
      {
        v36 = *(unsigned __int8 *)(values + 4252);
  ...
  HIDWORD(v65) = *(_DWORD *)(cfg_psoc_get_values(a1) + 564);
  LODWORD(v66) = *(_DWORD *)(cfg_psoc_get_values(a1) + 560);
  if ( *(_QWORD *)v10 )
  {
  ...
  if ( *(_QWORD *)v10 )
  {
    ...
    if ( v53 )
    {
      ...
      if ( v54 )
      {
        v55 = *(unsigned __int8 *)(result + 580);
