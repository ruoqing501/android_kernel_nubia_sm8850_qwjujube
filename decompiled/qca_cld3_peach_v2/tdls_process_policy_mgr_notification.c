          ...
          if ( v22 && (v23 = *(_QWORD *)(v22 + 80)) != 0 )
          {
            if ( wlan_objmgr_psoc_get_comp_private_obj(v23, 0xAu) && (*(_DWORD *)(v13 + 16) & 0xFFFFFFFD) == 0 )
            {
              ...
              qdf_trace_msg(
                ...
                v31,
                "tdls_process_policy_mgr_notification");
              if ( (wlan_vdev_mlme_is_mlo_vdev(v13, v61, v62, v63, v64, v65, v66, v67, v68) & 1) != 0 )
                tdls_process_enable_disable_for_ml_vdev(v13, 0);
              else
                tdls_disable_offchan_and_teardown_links(v13, v69, v70, v71, v72, v73, v74, v75, v76);
              goto LABEL_18;
            }
          }
          else
