__int64 __fastcall wlan_cm_tgt_send_roam_sync_complete_cmd(__int64 a1, __int64 a2)
{
...
LABEL_11:
  ...
  v16 = *(__int64 (__fastcall **)(_QWORD))(ext_hdl + 7424);
  if ( v16 )
  {
    if ( *((_DWORD *)v16 - 1) != 1263140689 )
      __break(0x8228u);
    v18 = v16(v13);
    if ( v18 )
      qdf_trace_msg(
        0x68u,
        8u,
        "%s: CM_RSO: vdev %d fail to send roam sync complete cmd",
        v19,
        v20,
        v21,
        v22,
        ...
        v25,
        v26,
        "wlan_cm_tgt_send_roam_sync_complete_cmd",
        v2);
    goto LABEL_13;
  }
LABEL_12:
  qdf_trace_msg(
    0x68u,
    2u,
    "%s: CM_RSO: vdev %d send_roam_sync_complete_cmd is NULL",
    v4,
    v5,
    v6,
    v7,
