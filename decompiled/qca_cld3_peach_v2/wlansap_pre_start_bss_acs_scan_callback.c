...
LABEL_71:
  ...
  vdev_by_id_from_pdev = wlan_objmgr_get_vdev_by_id_from_pdev(*(_QWORD *)(a1 + 21632), *((_BYTE *)a2 + 12), 0x2Cu);
  if ( vdev_by_id_from_pdev )
  {
    ...
    if ( *(_BYTE *)(v31 + 24) )
    {
      ...
      do
      {
        ...
        {
          v37 = v36++;
          *(_DWORD *)(*(_QWORD *)(*((_QWORD *)a2 + 193) + 16LL) + 4 * v37) = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)a2 + 193) + 16LL)
                                                                                       + 4 * v33);
        }
        else if ( v32 )
        {
...
LABEL_46:
      ...
      else
      {
        qdf_trace_msg(
          ...
          v58,
          "wlansap_pre_start_bss_acs_scan_callback");
        if ( policy_mgr_is_vdev_ll_lt_sap(*(_QWORD *)(v71 + 21624), *((unsigned __int8 *)a2 + 12)) && a2[182] == 2 )
        {
        ...
        {
          v81 = _qdf_mem_malloc(0x2D8u, "wlansap_calculate_chan_from_scan_result", 263);
          if ( v81 )
          {
            v90 = v81;
            if ( *((_BYTE *)a2 + 1777) == 1 )
              v91 = *(unsigned int *)(*((_QWORD *)a2 + 193) + 592LL);
            else
              v91 = qdf_get_time_of_the_day_ms() - *((_QWORD *)a2 + 194);
            *(_QWORD *)(v90 + 8) = v91;
            scan_result = scm_get_scan_result(*(_QWORD *)(v71 + 21632), v90, v82, v83, v84, v85, v86, v87, v88, v89);
            _qdf_mem_free(v90);
          }
          else
          {
            scan_result = scm_get_scan_result(*(_QWORD *)(v71 + 21632), 0, v82, v83, v84, v85, v86, v87, v88, v89);
          }
          if ( scan_result )
            qdf_trace_msg(
              0x39u,
...
LABEL_66:
      *(_DWORD *)(*((_QWORD *)a2 + 193) + 564LL) = valid_freq_for_csa;
      sap_config_acs_result(v71, (__int64)a2, *(_DWORD *)(*((_QWORD *)a2 + 193) + 568LL));
      *((_QWORD *)a2 + 202) = 21;
...
LABEL_68:
  ...
  sap_signal_hdd_event(a2, 0, a2[404], a2[405]);
  return 0;
}
