  ...
  else
  {
    ...
    qdf_trace_msg(
      ...
      *a1,
      ...
      v44,
      v45);
    qdf_mc_timer_init(v22 + 14712, 0, (__int64)sap_dfs_cac_timer_callback, v22);
    if ( (unsigned int)qdf_mc_timer_start(v22 + 14712, v42) )
    {
      qdf_trace_msg(
        0x39u,
        2u,
        ...
        "sap_start_dfs_cac_timer");
      *(_BYTE *)(v22 + 14881) = 0;
      qdf_mc_timer_destroy(v22 + 14712);
      goto LABEL_10;
    }
  }
  *(_BYTE *)(v22 + 14881) = 1;
