        ...
        double a8)
{
  ...
  while ( 1 )
  {
    if ( (qword_92E0A0 & 2) == 0 && (qword_92E0A0 & 4) == 0 )
    {
      memset(v30, 0, 40);
      init_wait_entry(v30, 0);
      while ( 1 )
      {
        v17 = prepare_to_wait_event(&unk_92E078, v30, 1);
        if ( (qword_92E0A0 & 2) != 0 || (qword_92E0A0 & 4) != 0 )
        {
          finish_wait(&unk_92E078, v30);
          goto LABEL_16;
        }
        if ( v17 )
          break;
...
LABEL_16:
    __asm { PRFM            #0x11, [X24] }
    do
      v21 = __ldxr((unsigned __int64 *)&qword_92E0A0);
    while ( __stlxr(v21 & 0xFFFFFFFFFFFFFFFBLL, (unsigned __int64 *)&qword_92E0A0) );
    __dmb(0xBu);
    if ( (v21 & 4) != 0 )
      goto LABEL_25;
    __asm { PRFM            #0x11, [X24] }
    do
      v27 = __ldxr((unsigned __int64 *)&qword_92E0A0);
    while ( __stlxr(v27 & 0xFFFFFFFFFFFFFFFDLL, (unsigned __int64 *)&qword_92E0A0) );
    __dmb(0xBu);
    if ( (v27 & 2) != 0 )
    {
