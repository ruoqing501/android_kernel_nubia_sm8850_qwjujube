__int64 __fastcall wlan_objmgr_trigger_peer_comp_priv_object_deletion(__int64 a1, unsigned int a2)
{
  __int64 v2; // x29
  __int64 v3; // x30
  __int64 result; // x0
  ...
  if ( !*(_QWORD *)(a1 + 8LL * a2 + 112) )
  {
    if ( (v8 & 1) != 0 )
    {
      *(_QWORD *)(a1 + 776) = v8 & 0xFFFFFFFFFFFFFFFELL;
  ...
  v11 = *(__int64 (__fastcall **)(__int64, __int64))(v10 + 9120);
  if ( !v11 )
    return 16;
  v12 = *(_QWORD *)(v10 + 9552);
...
LABEL_31:
  ...
  if ( (v27 & 1) != 0 )
  {
    *(_QWORD *)(a1 + 776) = v27 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(a1 + 768);
    result = v26;
    if ( v25 )
    {
