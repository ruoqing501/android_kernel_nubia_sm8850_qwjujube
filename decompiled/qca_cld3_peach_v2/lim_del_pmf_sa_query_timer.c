void __fastcall lim_del_pmf_sa_query_timer(__int64 a1, __int64 a2)
{
  ...
  if ( *(_BYTE *)(a1 + 12272) )
  {
    ...
    do
    {
      ...
      if ( hash_entry )
      {
        v15 = *(unsigned __int16 *)(hash_entry + 348);
        v16 = *(unsigned __int8 *)(hash_entry + 350);
        v17 = *(unsigned __int8 *)(hash_entry + 351);
        v18 = *(unsigned __int8 *)(hash_entry + 352);
        if ( (*(_WORD *)hash_entry & 0x400) != 0 )
        {
          v5 = hash_entry;
          LODWORD(v19) = *(unsigned __int8 *)(hash_entry + 355);
          qdf_trace_msg(
            0x35u,
            8u,
            ...
            v18,
            v19);
          tx_timer_deactivate(v5 + 376);
          tx_timer_delete(v5 + 376);
        }
        else
        {
          LODWORD(v19) = *(unsigned __int8 *)(hash_entry + 355);
