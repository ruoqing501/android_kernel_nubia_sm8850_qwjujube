        ...
        unsigned int a8)
{
  ...
  if ( (unsigned __int64)(v8 - 4194305) > 0xFFFFFFFFFFBFFFFFLL )
  {
    ...
    __asm { PRFM            #0x11, [X8] }
    do
      v36 = __ldxr((unsigned int *)&dword_7CF3B4);
    while ( __stxr(v36 + v8, (unsigned int *)&dword_7CF3B4) );
    *a3 = v20;
    v21 = a6 - 1;
    v22 = *a4;
    if ( (*a4 & v21) != 0 )
    {
      ...
      __asm { PRFM            #0x11, [X8] }
      do
        v39 = __ldxr((unsigned int *)&dword_7CF3B4);
      while ( __stxr(v39 - v23, (unsigned int *)&dword_7CF3B4) );
      dma_free_attrs();
...
LABEL_21:
      ...
      __asm { PRFM            #0x11, [X8] }
      do
        v42 = __ldxr((unsigned int *)&dword_7CF3B4);
      while ( __stxr(v42 + v24, (unsigned int *)&dword_7CF3B4) );
      *a3 = v28;
      *a2 = v24;
      v22 = *a4;
    }
