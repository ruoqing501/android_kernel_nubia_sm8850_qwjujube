        ...
        double a8)
{
  ...
  if ( *(_BYTE *)(*(_QWORD *)(result + 8) + 976LL) != 1
    || (unsigned int)policy_mgr_get_connection_count(*(_QWORD *)(result + 21624)) > 2 )
  {
    connection_count = policy_mgr_get_connection_count(*(_QWORD *)(v9 + 21624));
...
LABEL_19:
  ...
  while ( !v29 || !v28 )
  {
    v30 = *(_QWORD *)(v9 + 12264) + 14000LL * v27;
    if ( *(_BYTE *)(v30 + 70) )
    {
      v31 = *(_DWORD *)(v30 + 88);
      if ( v31 != 4 )
      {
        if ( v31 == 2 )
        {
          v29 = *(_QWORD *)(v9 + 12264) + 14000LL * v27;
          goto LABEL_9;
        }
        if ( v31 != 1 )
          goto LABEL_9;
      }
      v28 = *(_QWORD *)(v9 + 12264) + 14000LL * v27;
    }
LABEL_9:
...
LABEL_33:
    ...
    values = cfg_psoc_get_values(*(_QWORD *)(v9 + 21624));
    wma_cli_set_command(v59, 44, *(unsigned int *)(values + 1268), 1);
    if ( v58 )
      check_and_send_vendor_oui(v9, v29);
