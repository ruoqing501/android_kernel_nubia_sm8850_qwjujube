        ...
        double a12)
{
  ...
  if ( (mlme_get_user_ps(a1[2703], *a3) & 1) != 0 )
  {
    if ( (mlme_is_twt_notify_in_progress(a1[2703], *a3) & 1) != 0 )
    {
      qdf_trace_msg(
        0x34u,
        8u,
    ...
    else if ( _cds_get_context(54, (__int64)"sme_add_dialog_cmd", v33, v34, v35, v36, v37, v38, v39, v40) )
    {
      ...
      if ( v41 )
      {
        ...
        v43 = qdf_mutex_acquire((__int64)(a1 + 1606));
        if ( v43 )
        {
          v52 = v43;
          qdf_trace_msg(
        ...
        {
          mlme_add_twt_session(a1[2703], a3 + 1, a3[3]);
          mlme_set_twt_command_in_progress(a1[2703], a3 + 1, a3[3], 1);
          a1[1813] = a2;
          a1[1820] = a4;
          v64 = v42;
          LOWORD(v63) = 4545;
          ...
          if ( v53 )
          {
            ...
            ((void (__fastcall *)(_QWORD, unsigned int *, _QWORD))mlme_init_twt_context)(a1[2703], a3 + 1, a3[3]);
            _qdf_mem_free(v42);
          }
