__int64 __fastcall reg_process_c2c_detect_evt(__int64 a1, char a2)
{
  ...
  int v87; // [xsp+10h] [xbp-10h]
  char v88[4]; // [xsp+14h] [xbp-Ch] BYREF
...
LABEL_7:
  ...
  while ( 1 )
  {
    ...
    if ( v31 )
    {
      if ( *(v31 - 1) != 13449260 )
        __break(0x8228u);
      ((void (__fastcall *)(__int64, _QWORD, char *))v31)(a1, v17, v88);
      v32 = v88[0];
    }
    else
    {
    ...
    if ( !pdev_by_id )
      goto LABEL_13;
    v34 = pdev_by_id;
    pdev_obj = reg_get_pdev_obj(pdev_by_id);
    if ( !pdev_obj )
    {
      qdf_trace_msg(
        0x51u,
        ...
        v43,
        "reg_process_c2c_detect_evt");
      wlan_objmgr_pdev_release_ref(v34, v19, v66, v67, v68, v69, v70, v71, v72, v73, v74);
      result = 16;
      goto LABEL_48;
    }
    v44 = pdev_obj;
    ...
    {
      v75 = "%s: C2C is not supported.";
      v76 = 4;
      goto LABEL_46;
    }
    v53 = (_QWORD *)(v44 + 56728);
    if ( *(unsigned __int8 *)(v44 + 59010) == v87 )
      break;
    ...
    *(_DWORD *)(v44 + 58204) = v55;
    qdf_trace_msg(
      ...
      "reg_set_ap_pwr_type",
      v56);
    reg_compute_pdev_current_chan_list(v44, v57, v58, v59, v60, v61, v62, v63, v64);
    if ( (_ReadStatusReg(DAIF) & 0x80) != 0
      || (*(_DWORD *)(StatusReg + 16) & 0xF0000) != 0
      || (*(_DWORD *)(StatusReg + 16) & 0xFF00) != 0 )
    {
      raw_spin_lock(v13 + 93240);
      v65 = *(_QWORD *)(v13 + 93248);
    }
    else
    {
      raw_spin_lock_bh(v13 + 93240);
      v65 = *(_QWORD *)(v13 + 93248) | 1LL;
      *(_QWORD *)(v13 + 93248) = v65;
    }
    if ( *(_QWORD *)(v13 + 91672) )
      v16 = *(double (__fastcall **)(_QWORD))(v13 + 91672);
    if ( (v65 & 1) != 0 )
    {
      *(_QWORD *)(v13 + 93248) = v65 & 0xFFFFFFFFFFFFFFFELL;
...
LABEL_13:
  ...
  v75 = "%s: No change in is_indoor_ap_found";
  v76 = 8;
LABEL_46:
  qdf_trace_msg(0x51u, v76, v75, v45, v46, v47, v48, v49, v50, v51, v52, "reg_process_c2c_detect_evt");
  wlan_objmgr_pdev_release_ref(v34, v19, v77, v78, v79, v80, v81, v82, v83, v84, v85);
LABEL_47:
  result = 0;
LABEL_48:
