__int64 __fastcall tgt_vdev_mgr_peer_delete_all_send(
        __int64 a1,
        __int64 a2,
        double a3,
        double a4,
        ...
        double a10)
{
  ...
  if ( !a2 )
  {
    qdf_trace_msg(0x68u, 2u, "%s: Invalid input", a3, a4, a5, a6, a7, a8, a9, a10, "tgt_vdev_mgr_peer_delete_all_send");
    return 4;
  }
  v10 = *(_QWORD *)(a1 + 216);
