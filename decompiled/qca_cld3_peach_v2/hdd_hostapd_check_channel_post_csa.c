        ...
        double a10)
{
  ...
  if ( v13 == 10
    && (unsigned int)hdd_dcs_hostapd_set_chan(a1, *(unsigned __int8 *)(a2 + 8), *(unsigned int *)(a2 + 2424)) == 24 )
  {
    return qdf_trace_msg(
             0x33u,
             8u,
...
LABEL_13:
  ...
  if ( (result & 0xFE) != 0 )
  {
    policy_mgr_check_concurrent_intf_and_restart_sap(*a1, *(_BYTE *)(a2 + 1424) != 0);
