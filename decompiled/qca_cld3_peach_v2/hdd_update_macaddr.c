__int64 __fastcall hdd_update_macaddr(_DWORD *a1, __int64 a2, char a3)
{
  ...
  if ( (a3 & 1) != 0 )
  {
    v4 = (unsigned __int8 *)a1 + 3801;
    qdf_mem_copy((char *)a1 + 3801, &v39, 6u);
  ...
  {
    v4 = (unsigned __int8 *)a1 + 3759;
    qdf_mem_copy((char *)a1 + 3759, &v39, 6u);
  ...
  result = qdf_trace_msg(
             ...
             "hdd_update_macaddr",
             *v4,
             *((unsigned __int8 *)a1 + v15),
             *((unsigned __int8 *)a1 + v14),
             *((unsigned __int8 *)a1 + v16));
  v18 = *((unsigned __int8 *)a1 + 3848);
  v19 = (char)v18;
  if ( 7 - a1[961] > (unsigned int)(char)v18 )
  {
    if ( (unsigned int)v18 <= 7 )
      v20 = 7;
    else
      v20 = *((unsigned __int8 *)a1 + 3848);
    v21 = (unsigned __int8 *)a1 + 6 * *((unsigned __int8 *)a1 + 3848) + 3801;
    do
    {
      if ( v20 == v18 )
        __break(0x5512u);
