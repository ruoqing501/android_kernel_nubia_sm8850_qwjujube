__int64 __fastcall wlan_hdd_store_reassoc_sysfs(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( !v6 )
  {
                          ...
                          v14) )
    {
      ...
      {
        operation_chan_freq = (unsigned int)wlan_get_operation_chan_freq(*(unsigned __int16 **)(*(_QWORD *)(a1 + 54144)
                                                                                              + 32LL));
        wlan_mlme_get_bssid_vdev_id(*(_QWORD *)(v23 + 8), *(_BYTE *)(*(_QWORD *)(a1 + 54144) + 8LL), &v52);
        qdf_trace_msg(
          0x33u,
          8u,
