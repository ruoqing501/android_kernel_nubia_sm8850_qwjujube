__int64 __fastcall dp_vdev_print_tx_delay_stats(__int64 a1)
{
  __int64 result; // x0
  double v3; // d0
  double v4; // d1
  ...
  if ( a1 )
  {
    ...
    qdf_trace_msg(
      0x45u,
      5u,
      "%s: vdev_id: %d Per TID HW Tx completion latency Stats:",
      v3,
      v4,
      v5,
      v6,
      ...
      v9,
      v10,
      "dp_vdev_print_tx_delay_stats",
      v11);
    qdf_trace_msg(
      0x45u,
      5u,
      "%s:   Tid%32sPkts_per_delay_bucket%60s | Min | Max | Avg |",
      v12,
      v13,
      v14,
      v15,
      ...
      &unk_98C763,
      &unk_98C763);
    scnprintf(v94, 512, "%6s", (const char *)&unk_98C763);
    v21 = v20;
    scnprintf(&v94[v20], 512LL - v20, "%7s", fw_to_hw_delay_bkt_str[0]);
    v23 = v21 + v22;
    scnprintf(&v94[v23], 512 - v23, "%7s", off_162C0[0]);
    v25 = v23 + v24;
    scnprintf(&v94[v25], 512 - v25, "%7s", off_162C8[0]);
    v27 = v25 + v26;
    scnprintf(&v94[v27], 512 - v27, "%7s", off_162D0[0]);
    v29 = v27 + v28;
    scnprintf(&v94[v29], 512 - v29, "%7s", off_162D8[0]);
    v31 = v29 + v30;
    scnprintf(&v94[v31], 512 - v31, "%9s", off_162E0[0]);
    v33 = v31 + v32;
    scnprintf(&v94[v33], 512 - v33, "%9s", off_162E8[0]);
    v35 = v33 + v34;
    scnprintf(&v94[v35], 512 - v35, "%9s", off_162F0[0]);
    v37 = v35 + v36;
    scnprintf(&v94[v37], 512 - v37, "%9s", off_162F8[0]);
    v39 = v37 + v38;
    scnprintf(&v94[v39], 512 - v39, "%9s", off_16300[0]);
    v41 = v39 + v40;
    scnprintf(&v94[v41], 512 - v41, "%9s", off_16308[0]);
    v43 = v41 + v42;
    scnprintf(&v94[v43], 512 - v43, "%9s", off_16310[0]);
    v45 = scnprintf(&v94[v43 + v44], 512 - (v43 + v44), "%9s", off_16318);
    qdf_trace_msg(0x45u, 5u, "%s: %s", v45, v46, v47, v48, v49, v50, v51, v52, "dp_vdev_print_tx_delay_stats", v94);
    v53 = a1 + 9536;
    v54 = 0;
    v55 = a1 + 29840;
    v56 = a1 + 16304;
