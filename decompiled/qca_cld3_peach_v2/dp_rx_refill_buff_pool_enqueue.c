__int64 __fastcall dp_rx_refill_buff_pool_enqueue(__int64 result)
{
  ...
  v1 = result;
  v2 = result + 18856;
  if ( *(_BYTE *)(result + 18856) != 1 )
    return result;
  v3 = *(unsigned __int16 *)(result + 18858);
  v4 = *(unsigned __int16 *)(result + 18860);
  if ( v4 <= v3 )
  {
    v5 = v4 + *(_WORD *)(result + 18872) + ~(_WORD)v3;
    if ( v5 )
      goto LABEL_5;
  }
  else
...
LABEL_5:
      v6 = *(_QWORD *)(result + 24);
      v7 = (unsigned __int16 *)(result + 12490);
      v13 = 0;
      while ( 1 )
      {
        v8 = 0;
...
LABEL_13:
          ...
          {
            ++v8;
            *(_QWORD *)(*(_QWORD *)(v1 + 18880) + 8LL * (unsigned __int16)v3) = v10;
...
LABEL_16:
  ...
  v11 = 0;
  v12 = *(_QWORD *)(result + 18864);
  if ( v12 )
LABEL_19:
    *(_QWORD *)(v12 + 94368) += v11;
  return result;
}
