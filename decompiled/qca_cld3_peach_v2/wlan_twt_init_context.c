__int64 __fastcall wlan_twt_init_context(__int64 a1, unsigned __int8 *a2, unsigned __int8 a3)
{
  ...
  *(_BYTE *)(v24 + 65) = 1;
  if ( a3 == 0xFF || *(unsigned __int8 *)(v24 + 72) == a3 )
  {
    *(_BYTE *)(v24 + 74) = 0;
    *(_BYTE *)(v24 + 72) = -1;
    *(_DWORD *)(v24 + 76) = 0;
  ...
  qdf_trace_msg(0x96u, 8u, "%s: init done", v25, v26, v27, v28, v29, v30, v31, v32, "wlan_twt_init_context");
