        ...
        double a12)
{
  ...
  if ( (unsigned __int8)a2 <= 5u && a1[2162] + 96LL * (unsigned __int8)a2 )
  {
    v15 = (unsigned __int8)a2;
    v17 = ((__int64 (__fastcall *)(_QWORD, _QWORD, __int64))wlan_objmgr_get_vdev_by_id_from_psoc)(a1[2703], a2, 77);
    if ( v17 )
    {
      v26 = v17;
      if ( wlan_cm_is_vdev_roaming(v17, v18, v19, v20, v21, v22, v23, v24, v25) )
      {
        mlme_set_rso_pending_disable_req_bitmap(a1[2703], a2, a4, 0);
      ...
      else
      {
        ...
        return wlan_cm_disable_rso(a1[2704], a2, a4, a3, v46, v47, v48, v49, v50, v51, v52, v53);
      }
    }
    else
    {
