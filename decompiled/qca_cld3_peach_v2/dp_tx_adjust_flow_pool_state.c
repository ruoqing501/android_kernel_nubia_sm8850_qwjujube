__int64 __fastcall dp_tx_adjust_flow_pool_state(__int64 result, __int64 a2)
{
  ...
  if ( v2 <= *(unsigned __int16 *)(a2 + 72) )
  {
    ...
    if ( v2 <= *(unsigned __int16 *)(a2 + 74) )
    {
      if ( v2 <= *(unsigned __int16 *)(a2 + 76) )
      {
        if ( v2 <= *(unsigned __int16 *)(a2 + 78) )
        {
          ...
          *(_DWORD *)(a2 + 64) = 1;
          v6 = *(void (__fastcall **)(__int64, __int64, __int64))(v4 + 12920);
        ...
        v7 = *(void (__fastcall **)(__int64, __int64, __int64))(v4 + 12920);
      ...
      v9 = *(void (__fastcall **)(__int64, __int64, __int64))(v4 + 12920);
    ...
    v11 = *(__int64 (__fastcall **)(__int64, __int64, __int64))(v4 + 12920);
