__int64 __fastcall sme_set_addba_accept(__int64 a1, char a2, char a3)
{
  _BYTE *v5; // x0
  __int64 v6; // x19
  __int64 result; // x0
  ...
  v16 = 0;
  v17 = 0;
  v5 = (_BYTE *)_qdf_mem_malloc(2u, "sme_set_addba_accept", 8332);
  if ( !v5 )
    goto LABEL_4;
  v6 = (__int64)v5;
  *v5 = a2;
  ...
  result = scheduler_post_message_debug(
             ...
             0x2098u,
             (__int64)"sme_set_addba_accept");
  if ( (_DWORD)result )
  {
    qdf_trace_msg(
      0x34u,
      2u,
      "%s: Not able to post addba reject",
      v8,
      v9,
      v10,
      v11,
