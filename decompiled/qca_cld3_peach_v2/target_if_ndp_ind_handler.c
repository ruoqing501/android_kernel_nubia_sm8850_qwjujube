__int64 __fastcall target_if_ndp_ind_handler(__int64 a1)
{
...
LABEL_9:
    qdf_trace_msg(0x49u, 2u, v24, v2, v3, v4, v5, v6, v7, v8, v9, "target_if_ndp_ind_handler");
    goto LABEL_10;
  }
  v12 = _qdf_mem_malloc(0x358u, "target_if_ndp_ind_handler", 337);
  if ( !v12 )
  {
    result = 4294967284LL;
    goto LABEL_11;
  ...
  ndp_ind = wmi_extract_ndp_ind(v11);
  if ( ndp_ind )
  {
    qdf_trace_msg(
      0x49u,
