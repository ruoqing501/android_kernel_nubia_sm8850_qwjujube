__int64 __fastcall wlan_serialization_init(
        double a1,
        double a2,
        double a3,
        double a4,
        ...
        double a8)
{
  ...
  if ( !handler )
  {
    ...
    if ( v18 )
    {
      ...
      qdf_trace_msg(
        0x4Cu,
        2u,
        "%s: Failed to reg soc ser obj delete handler",
        v19,
        v20,
        v21,
        v22,
    ...
    else
    {
      ...
      if ( v35 )
      {
        ...
        qdf_trace_msg(
          0x4Cu,
          2u,
          "%s: Failed to reg pdev ser obj create handler",
          v36,
          v37,
          v38,
          v39,
      ...
      else
      {
        ...
        if ( v52 )
        {
          ...
          qdf_trace_msg(
            0x4Cu,
            2u,
            "%s: Failed to reg pdev ser obj delete handler",
            v53,
            v54,
            v55,
            v56,
        ...
        else
        {
          v69 = wlan_objmgr_register_vdev_create_handler(
                  2u,
                  (__int64)wlan_serialization_vdev_create_handler,
                  0,
                  v53,
                  v54,
                  v55,
          ...
          if ( v69 )
          {
            ...
            qdf_trace_msg(
              0x4Cu,
              2u,
              "%s: Failed to reg vdev ser obj create handler",
              v70,
              v71,
              v72,
              v73,
          ...
          else
          {
            v17 = wlan_objmgr_register_vdev_destroy_handler(
                    2u,
                    (__int64)wlan_serialization_vdev_destroy_handler,
                    0,
                    v70,
                    v71,
                    v72,
            ...
            qdf_trace_msg(
              0x4Cu,
              2u,
              "%s: Failed to reg vdev ser obj delete handler",
              v86,
              v87,
              v88,
              v89,
  ...
  qdf_trace_msg(
    0x4Cu,
    2u,
    "%s: Failed to reg soc ser obj create handler",
    v9,
    v10,
    v11,
    v12,
