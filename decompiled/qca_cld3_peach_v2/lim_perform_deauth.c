...
LABEL_61:
  v72 = *(_DWORD *)(result + 8);
  if ( v72 == 17 || v72 == 22 || *(_BYTE *)(result + 661) == 1 )
  {
    v28 = *(unsigned __int8 *)(result + 661);
    if ( a4 )
    {
      v68 = *a4;
      v50 = a4[1];
  ...
  *(_WORD *)(result + 34) = 5;
  *(_BYTE *)(result + 661) = 1;
  qdf_mem_copy(&v89, (const void *)(result + 350), 6u);
  v75 = *(unsigned __int8 *)(v74 + 24);
  v76 = *(unsigned __int8 *)(a1 + 12409);
  LOWORD(v90) = 5;
  HIWORD(v89) = v75;
  if ( v76 )
    *(_BYTE *)(a1 + 12409) = 0;
  if ( *(_DWORD *)(a2 + 88) == 2 )
    wma_tx_abort(*(unsigned __int8 *)(a2 + 10));
  v77 = lim_mlo_sta_notify_peer_disconn(a2);
  lim_update_lost_link_info((_DWORD *)a1, a2, a5, v77, v78, v79, v80, v81, v82, v83, v84);
  if ( *(_DWORD *)(a2 + 88) == 2 )
