        ...
        double a9)
{
  ...
  {
    *(_DWORD *)(a1 + 1264) = 0;
    *(_QWORD *)(a1 + 1336) = wlan_objmgr_peer_obj_free_work;
    *(_QWORD *)(a1 + 1304) = 0xFFFFFFFE00000LL;
    *(_QWORD *)(a1 + 1272) = 0;
    *(_QWORD *)(a1 + 1344) = a1;
    *(_QWORD *)(a1 + 1312) = a1 + 1312;
    *(_QWORD *)(a1 + 1320) = a1 + 1312;
    *(_QWORD *)(a1 + 1328) = _qdf_defer_func;
    *(_DWORD *)(a1 + 1352) = 0;
    *(_QWORD *)(a1 + 1280) = a1 + 1280;
    *(_QWORD *)(a1 + 1288) = a1 + 1280;
    *(_QWORD *)(a1 + 1296) = 0x4000000000LL;
    qdf_trace_msg(
      0x57u,
      8u,
