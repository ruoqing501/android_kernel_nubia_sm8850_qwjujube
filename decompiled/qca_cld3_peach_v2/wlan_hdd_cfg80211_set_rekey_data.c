__int64 __fastcall wlan_hdd_cfg80211_set_rekey_data(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( !(_DWORD)result )
  {
    ...
    {
      qdf_mtrace(51, 51, 0x3Au, *(_BYTE *)(*(_QWORD *)(a2 + 55520) + 8LL), *(_DWORD *)(a2 + 2728));
      ...
      if ( !v32 )
      {
        ...
        if ( v33 )
        {
          ...
          *(_BYTE *)(v34 + 126) = hdd_is_fils_connection(v14, a2 + 2688) & 1;
          vdev_by_user = _hdd_objmgr_get_vdev_by_user(*(_QWORD *)(a2 + 55520), 86, "__wlan_hdd_cfg80211_set_rekey_data");
          if ( vdev_by_user )
          {
            v36 = vdev_by_user;
