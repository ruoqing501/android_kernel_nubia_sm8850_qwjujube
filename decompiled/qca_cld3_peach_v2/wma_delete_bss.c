        ...
        double a10)
{
  ...
  double v138; // d6
  double v139; // d7
  __int64 *v140; // [xsp+18h] [xbp-38h]
  _BYTE v141[4]; // [xsp+24h] [xbp-2Ch] BYREF
  _QWORD v142[3]; // [xsp+28h] [xbp-28h] BYREF
  int v143; // [xsp+40h] [xbp-10h] BYREF
  __int16 v144; // [xsp+44h] [xbp-Ch]
  __int64 v145; // [xsp+48h] [xbp-8h]

  v145 = *(_QWORD *)(_ReadStatusReg(SP_EL0) + 1808);
  memset(v142, 0, sizeof(v142));
  context = _cds_get_context(71, (__int64)"wma_delete_bss", a3, a4, a5, a6, a7, a8, a9, a10);
  v21 = (__int64 *)(a1[65] + 488LL * (unsigned __int8)a2);
  v144 = 0;
  v143 = 0;
  if ( !v21 || !*v21 )
  {
  ...
  v22 = (__int64)context;
  bss_peer_mac = wlan_vdev_get_bss_peer_mac(*v21, &v143, v13, v14, v15, v16, v17, v18, v19, v20);
  if ( bss_peer_mac )
  {
...
LABEL_7:
    result = mlme_get_roam_state(a1[3], a2);
    if ( (_DWORD)result != 6 )
    {
...
LABEL_45:
  ...
  qdf_mem_set((void *)(cmpt_obj + 184), 6u, 0);
  ...
  if ( wlan_cm_is_roam_sync_in_progress(a1[3], a2)
    || (unsigned int)mlme_get_roam_state(a1[3], a2) == 6
    || (mlo_is_roaming_in_progress(a1[3], a2) & 1) != 0 )
  {
    qdf_trace_msg(
      0x36u,
      8u,
  ...
  v90 = mlme_set_vdev_stop_type(*v21, 4135, v61, v62, v63, v64, v65, v66, v67, v68);
  if ( v90 )
  {
    LODWORD(v32) = v90;
  ...
  if ( (unsigned int)wma_send_vdev_stop_to_fw(a1, a2) )
  {
    ...
    wlan_vdev_mlme_sm_deliver_evt(
      *(_QWORD *)(a1[65] + 488LL * (unsigned __int8)a2),
      0xEu,
      1u,
      (__int64)v141,
      v132,
