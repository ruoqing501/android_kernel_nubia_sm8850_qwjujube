        ...
        double a10)
{
  ...
  if ( a2 )
  {
    ...
    {
      v13 = v12;
      v14 = policy_mgr_validate_dbs_switch(*(_QWORD *)(a1 + 21624), *(_DWORD *)(a2 + 60));
      if ( v14 )
      {
        v23 = v14;
        qdf_trace_msg(
      ...
      v43 = policy_mgr_get_hw_mode_change_from_hw_mode_index(*(_QWORD *)(a1 + 21624), *(_DWORD *)(a2 + 32));
      if ( !v43 )
      {
        v24 = 2;
        qdf_trace_msg(
      ...
      policy_mgr_set_hw_mode_change_in_progress(*(_QWORD *)(a1 + 21624), v43);
      policy_mgr_reset_connection_update(*(_QWORD *)(a1 + 21624));
      if ( *(_DWORD *)(a2 + 48) == 4 )
      {
        v60 = *(_DWORD **)(a1 + 14400);
        if ( *(v60 - 1) != -1366728445 )
        ...
        if ( (((__int64 (__fastcall *)(_QWORD, _QWORD))v60)(0, 0) & 1) != 0 )
        {
          qdf_trace_msg(
            ...
            v59,
            "csr_process_set_hw_mode");
          policy_mgr_restart_opportunistic_timer(*(_QWORD *)(a1 + 21624), 0);
LABEL_19:
          policy_mgr_set_hw_mode_change_in_progress(*(_QWORD *)(a1 + 21624), 0);
          v24 = 2;
LABEL_7:
          _qdf_mem_free(v13);
          goto LABEL_10;
        ...
        if ( *(_DWORD *)(a2 + 48) == 4
          && !*(_DWORD *)(a2 + 32)
          && !(unsigned int)policy_mgr_need_opportunistic_upgrade(*(_QWORD *)(a1 + 21624), nullptr) )
        {
          qdf_trace_msg(
            0x34u,
            2u,
