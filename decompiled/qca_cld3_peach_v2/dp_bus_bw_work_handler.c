...
LABEL_159:
            ...
            v167 = v110;
            v168 = v109;
            v113 = _qdf_mem_malloc(0x11C0u, "dp_link_monitoring", 1905);
            if ( !v113 )
              goto LABEL_100;
            v114 = v113;
            v115 = *(_QWORD *)(*(_QWORD *)(v94 + 40) + 184LL);
            if ( !v115 )
            {
              v125 = v113;
              qdf_trace_msg(
...
LABEL_187:
              if ( (v65 & 1) != 0 )
              {
                ...
                if ( v173 )
                {
                  v165 = *(__int64 *)((char *)&qword_B48 + (_QWORD)v173) + (unsigned int)v182;
                  *(__int64 *)((char *)&qword_B50 + (_QWORD)v173) += HIDWORD(v182);
                  *(__int64 *)((char *)&qword_B48 + (_QWORD)v173) = v165;
                }
