__int64 __fastcall populate_dot11f_supp_channels(__int64 a1, _BYTE *a2, __int64 a3, __int64 a4)
{
  ...
  {
    wlan_add_supported_5ghz_channels(*(_QWORD *)(a1 + 21624), *(_QWORD *)(a1 + 21632), (__int64)v38 + 1, v38, 0);
  }
  else if ( wlan_reg_is_6ghz_chan_freq(*(_DWORD *)(a4 + 284)) )
  {
    wlan_add_supported_6ghz_channels(*(_QWORD *)(a1 + 21624), *(_QWORD *)(a1 + 21632), (__int64)v38 + 1, v38, 0);
  }
  a2[1] = v38[0];
  result = wlan_reg_read_current_country(*(_QWORD *)(a1 + 21624), &v36, v8, v9, v10, v11, v12, v13, v14, v15);
  if ( a2[1] )
  {
    v25 = 0;
    v26 = 0;
