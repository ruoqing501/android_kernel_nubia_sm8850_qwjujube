        ...
        double a9)
{
  ...
  *(_QWORD *)s = 0;
  ...
  dp_print_common_rates_info(a1 + 1539);
  v10 = snprintf(s, 0x30u, " %d", a1[1646]);
  if ( (unsigned __int8)v10 >= 0x31u
    || (v11 = v10,
        v12 = snprintf(&s[v10 & 0x3F], 48 - (v10 & 0x3Fu), " %d", a1[1647]),
        (unsigned __int8)(v11 + v12) > 0x30u)
    || (v13 = v11
            + v12
            + snprintf(&s[(unsigned __int8)(v11 + v12)], 48LL - (unsigned __int8)(v11 + v12), " %d", a1[1648]),
        (unsigned __int8)v13 > 0x30u)
    || (v14 = v13 + snprintf(&s[(unsigned __int8)v13], 48LL - (unsigned __int8)v13, " %d", a1[1649]),
        (unsigned __int8)v14 > 0x30u)
    || (v15 = v14 + snprintf(&s[(unsigned __int8)v14], 48LL - (unsigned __int8)v14, " %d", a1[1650]),
        (unsigned __int8)v15 > 0x30u)
    || (v16 = v15 + snprintf(&s[(unsigned __int8)v15], 48LL - (unsigned __int8)v15, " %d", a1[1651]),
        (unsigned __int8)v16 > 0x30u)
    || (v17 = v16 + snprintf(&s[(unsigned __int8)v16], 48LL - (unsigned __int8)v16, " %d", a1[1652]), v17 > 0x30u) )
  {
    __break(0x5512u);
  }
  snprintf(&s[v17], 48LL - v17, " %d", a1[1653]);
  ...
  DP_PRINT_STATS(
    ...
    a1[1644]);
  DP_PRINT_STATS(
    "BW Counts = 20MHz %d, 40MHz %d, 80MHz %d, 160MHz %d, 320MHz %d",
    v34,
    v35,
    v36,
    v37,
  ...
  DP_PRINT_STATS("Number of Msdu's Part of Ampdus = %d", v58, v59, v60, v61, v62, v63, v64, v65, a1[1748]);
  DP_PRINT_STATS(
    ...
    v73,
    a1[1747]);
  DP_PRINT_STATS("Number of Msdu's Part of Amsdu: %d", v74, v75, v76, v77, v78, v79, v80, v81, a1[1750]);
