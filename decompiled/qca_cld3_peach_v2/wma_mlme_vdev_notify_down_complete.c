        ...
        __int64 a11)
{
  ...
  if ( (mlme_is_connection_fail(v13, a2, a3, a4, a5, a6, a7, a8, a9) & 1) != 0
    || (mlme_get_vdev_start_failed(*(_QWORD *)(a1 + 520), v14, v15, v16, v17, v18, v19, v20, v21) & 1) != 0 )
  {
    qdf_trace_msg(
      0x36u,
      8u,
    ...
    mlme_set_connection_fail(*(_QWORD *)(a1 + 520), 0, v22, v23, v24, v25, v26, v27, v28, v29);
    mlme_set_vdev_start_failed(*(_QWORD *)(a1 + 520), 0, v30, v31, v32, v33, v34, v35, v36, v37);
    result = 0;
    goto LABEL_9;
  }
...
LABEL_8:
  ...
  if ( v66 == 4173 )
  {
    lim_join_result_callback(*(_QWORD *)(v48 + 16), *(unsigned __int8 *)(*(_QWORD *)(a1 + 520) + 168LL));
    v57 = 0;
    goto LABEL_8;
  }
  if ( v66 == 4174 )
