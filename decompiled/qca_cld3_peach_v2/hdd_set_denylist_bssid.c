        ...
        double a12)
{
  ...
  __int64 v58; // x7
  const char *v59; // x2
  _QWORD v61[11]; // [xsp+10h] [xbp-130h] BYREF
  __int64 v62; // [xsp+68h] [xbp-D8h]
  __int64 v63; // [xsp+70h] [xbp-D0h]
  _QWORD v64[20]; // [xsp+78h] [xbp-C8h] BYREF
  __int64 v65; // [xsp+118h] [xbp-28h]
  __int64 v66; // [xsp+120h] [xbp-20h]
  __int64 v67; // [xsp+128h] [xbp-18h]
  __int64 v68; // [xsp+130h] [xbp-10h]
      ...
      if ( (unsigned int)v28 >= 4 )
      {
        ...
        while ( 1 )
        {
          ...
          if ( v66 )
          {
            ...
            qdf_mem_set(v61, 0x68u, 0);
            nla_memcpy(v61, v65, 6);
            v34 = *(_QWORD *)(a1 + 8);
            v62 = 0x700000000LL;
            LODWORD(v63) = 1;
            ((void (__fastcall *)(__int64, _QWORD, _QWORD *))dlm_update_mlo_reject_ap_info)(v34, a4, v61);
            ucfg_dlm_add_bssid_to_reject_list(*(_QWORD *)(a1 + 8), v61);
          }
          else
          {
            v45 = v32;
