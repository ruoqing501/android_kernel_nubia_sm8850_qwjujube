        ...
        double a11)
{
  ...
  if ( !*(_DWORD *)(v13 + 39100) )
  {
    ...
    v19 = *(_QWORD *)(*(_QWORD *)(v11 + 8) + 20112LL);
    if ( v19 )
    {
      v20 = *(_QWORD *)(v19 + 416);
      if ( v20 )
...
LABEL_22:
  ...
  if ( !v15 )
    goto LABEL_28;
  v33 = *(_QWORD *)(v11 + 96456);
  *(_QWORD *)(v33 + 16) = 0;
  *(_BYTE *)(v33 + 9) = -1;
  if ( v15 == 1
    || (v34 = *(_QWORD *)(v11 + 96456), *(_QWORD *)(v34 + 18544) = 0, *(_BYTE *)(v34 + 18537) = -1, v15 == 2)
    || (v35 = *(_QWORD *)(v11 + 96456) + 36864LL, *(_QWORD *)(v35 + 208) = 0, *(_BYTE *)(v35 + 201) = -1, v15 == 3) )
  {
LABEL_28:
    *(_BYTE *)v13 = 0;
    return 0;
