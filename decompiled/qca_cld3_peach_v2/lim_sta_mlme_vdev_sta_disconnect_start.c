        ...
        double a9)
{
  ...
  v10 = *(unsigned __int8 *)(*(_QWORD *)(a1 + 520) + 168LL);
  ...
  if ( context )
  {
    ...
    if ( session_by_vdev_id )
    {
      ...
      {
        v40 = hash_entry;
        mlme_set_connection_fail(*(_QWORD *)(a1 + 520), 0, v32, v33, v34, v35, v36, v37, v38, v39);
        v41 = *(_DWORD *)(v30 + 80);
        *(_DWORD *)(v30 + 80) = 12;
        *(_DWORD *)(v30 + 84) = v41;
        *(_DWORD *)(v40 + 24) = 1;
        *(_WORD *)(v40 + 34) = 0;
        *(_DWORD *)(v40 + 8) = 22;
        wlan_vdev_mlme_sm_deliver_evt(*(_QWORD *)(v30 + 16), 0xDu, 0x36B0u, v30, v42, v43, v44, v45, v46, v47, v48, v49);
        return 0;
      }
    }
    else
