__int64 __fastcall wlan_hdd_cfg80211_coap_offload(__int64 a1, __int64 a2, __int64 a3, unsigned int a4)
{
  ...
  v8 = *(_QWORD *)(a2 + 32);
  v42[0] = nullptr;
  result = _osif_vdev_sync_op_start(v8, v42, (__int64)"wlan_hdd_cfg80211_coap_offload");
  if ( (_DWORD)result )
  {
LABEL_12:
  ...
  if ( a1 )
  {
    ...
    v41 = v27;
    _osif_vdev_sync_op_stop((__int64)v42[0], (__int64)"wlan_hdd_cfg80211_coap_offload");
    result = v41;
    goto LABEL_12;
  }
  __break(0x800u);
  __ldaxr((unsigned int *)v42);
