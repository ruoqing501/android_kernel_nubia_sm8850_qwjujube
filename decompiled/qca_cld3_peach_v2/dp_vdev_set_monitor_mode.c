__int64 __fastcall dp_vdev_set_monitor_mode(__int64 a1, __int64 a2, char a3)
{
  ...
  v16 = ref_by_id_4;
  if ( !v15 || (v6 = 96456, (v17 = *((_QWORD *)v15 + 12057)) == 0) )
  {
    v20 = 16;
    goto LABEL_7;
  }
  *(_DWORD *)(v17 + 18552) = 0xFFFF;
  v18 = *((_QWORD *)v15 + 12057);
  ...
  *(_BYTE *)(v18 + 9) = *(_BYTE *)(ref_by_id_4 + 59);
  ...
  if ( !a3 )
  {
    ...
    *(_BYTE *)(v17 + 39316) = v22(v19);
    v31 = *(_QWORD *)(*((_QWORD *)v15 + 1) + 20112LL);
    if ( v31 )
    {
      v32 = *(_QWORD *)(v31 + 416);
      if ( v32 && *(_QWORD *)(v32 + 984) )
      {
        ...
        if ( (v33(v15) & 1) != 0 )
          goto LABEL_5;
LABEL_24:
        v35 = *(_QWORD *)(*((_QWORD *)v15 + 1) + 20112LL);
        if ( v35 )
        {
          v36 = *(_QWORD *)(v35 + 416);
          if ( v36 )
...
LABEL_33:
              ...
              if ( *((_DWORD *)v42 - 1) != 1696218653 )
                __break(0x8228u);
              if ( v42(v38) || (v6 = *(unsigned __int8 *)(a1 + 20272), (v6 & 0x10) != 0) )
              {
LABEL_44:
