bool __fastcall policy_mgr_is_third_conn_sta_p2p_p2p_valid(__int64 a1, unsigned int a2)
{
  ...
  if ( v5 + v4 + (unsigned int)policy_mgr_mode_specific_connection_count(a1, 2, nullptr) != 2 || !a2 && v4 == 1 )
    return 1;
  if ( !(_DWORD)pm_conc_connection_list && (_DWORD)qword_8D4F0C == 3
    || ((_DWORD)qword_8D4F0C ? (v6 = (_DWORD)qword_8D4F0C == 3) : (v6 = 1),
        !v6 ? (v7 = 0) : (v7 = 1),
        (_DWORD)pm_conc_connection_list == 3 && (v7 & 1) != 0
     || !(_DWORD)pm_conc_connection_list && (_DWORD)qword_8D4F0C == 2
     || ((_DWORD)qword_8D4F0C == 2 ? (v9 = 1) : (v9 = (_DWORD)qword_8D4F0C == 0),
         (_DWORD)qword_8D4F0C == 2 ? (v10 = (_DWORD)pm_conc_connection_list == 3) : (v10 = 0),
  ...
  else if ( (_DWORD)pm_conc_connection_list != 2 || (_DWORD)qword_8D4F0C != 3 || v4 >= 2 )
  {
    return 1;
  }
