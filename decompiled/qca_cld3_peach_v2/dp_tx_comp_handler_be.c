...
LABEL_12:
  for ( i = 1 - v22; i != 1; ++i )
  {
    ...
    *(_DWORD *)(a3 + 120) = v33;
    ...
    {
      v41 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a2 + 22608) + 24LL * (v39[1] >> 21))
...
LABEL_24:
    ...
    v114 = *(_BYTE *)(v41 + 64);
    v115 = v39[2] & 7;
    *(_WORD *)(v41 + 50) = v39[7] & 0x1FFF | (((v39[7] >> 13) & 1) << *(_DWORD *)(a2 + 13328));
    *(_BYTE *)(v41 + 64) = v114 & 0xE3 | (4 * v115);
    if ( v115 == 3 )
    {
      v140 = 0;
      v139[0] = 0;
...
LABEL_61:
  ...
  {
    *(_DWORD *)(a2 + 4LL * (unsigned __int8)a4 + 13600) += v23;
    goto LABEL_63;
  }
  __break(0x5512u);
