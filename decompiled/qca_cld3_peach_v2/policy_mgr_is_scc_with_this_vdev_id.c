  ...
  if ( context )
  {
    ...
    else
    {
      ...
      if ( (_DWORD)qword_8D4F00 != (unsigned __int8)a2
        ...
        || (_DWORD)qword_8D4F24 != (unsigned __int8)a2 && BYTE4(qword_8D4F24) == 1 && HIDWORD(qword_8D4F0C) == v23
        || (_DWORD)qword_8D4F48 != (unsigned __int8)a2 && BYTE4(qword_8D4F48) == 1 && HIDWORD(qword_8D4F30) == v23
        || (_DWORD)qword_8D4F6C != (unsigned __int8)a2 && BYTE4(qword_8D4F6C) == 1 && HIDWORD(qword_8D4F54) == v23
        || (_DWORD)qword_8D4F90 != (unsigned __int8)a2 && BYTE4(qword_8D4F90) == 1 && HIDWORD(qword_8D4F78) == v23 )
      {
