      ...
      else
      {
        if ( !(unsigned int)qdf_list_peek_front(v8, v31) )
        {
          ...
          if ( v19 )
          {
            ...
            {
              if ( v18 )
                wlan_vendor_scan_callback(v30, (v29[0] & 1) == 0, *(unsigned __int8 *)(a1 + 93));
              else
                wlan_cfg80211_scan_done(v19, v30, (v29[0] & 1) == 0, v7);
              wlan_objmgr_vdev_release_ref(a1, 6);
              if ( v20 )
              {
                v21 = _qdf_mem_malloc(728, "wlan_scan_get_bss_count_for_scan", 1077);
                if ( v21
                  && (v22 = v21,
                      *(_WORD *)v21 |= 8u,
