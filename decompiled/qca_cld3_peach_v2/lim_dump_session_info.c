  ...
  if ( result )
  {
    if ( a2 )
    {
      ...
      qdf_trace_msg(
        ...
        *(unsigned __int8 *)(v11 + 1300),
        *(unsigned __int8 *)(v11 + 1301),
        *(unsigned __int8 *)(a2 + 7193),
      ...
      force_20mhz_in_24ghz = wlan_cm_get_force_20mhz_in_24ghz(
                               *(_QWORD *)(a2 + 16),
                               ...
                               v23,
                               v24);
      LODWORD(v34) = *(unsigned __int8 *)(*(_QWORD *)(v14 + 8) + 5652LL);
      return qdf_trace_msg(
               ...
               *(unsigned __int8 *)(*(_QWORD *)(v14 + 8) + 5655LL),
               v34);
    }
  }
  return result;
