__int64 __fastcall wlan_dp_lapb_flow_attach(__int64 a1)
{
  ...
  {
    *(_QWORD *)(a1 + 19856) = &dp_lapb_flow_ops;
    v11 = *(_BYTE *)(a1 + 7201);
    *(_QWORD *)(a1 + 19952) = dp_lapb_tcl_hp_update_timer_handler;
    *(_DWORD *)(a1 + 19936) = 1;
    *(_BYTE *)(a1 + 19849) = v11 - 1;
    *(_QWORD *)(a1 + 19944) = a1 + 19872;
    hrtimer_init(a1 + 19872, 1, 5);
    *(_QWORD *)(a1 + 19912) = _qdf_hrtimer_cb_2;
    *(_QWORD *)(a1 + 19864) = a1;
    *v2 = 1;
    qdf_mem_set((void *)(a1 + 19960), 0, 12);
