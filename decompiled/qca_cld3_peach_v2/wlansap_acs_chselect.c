...
LABEL_24:
  ...
  v14 = a1[182];
  *((_QWORD *)a1 + 193) = a3 + 1144;
  *((_WORD *)a1 + 749) = *(_WORD *)(a3 + 1186);
  if ( v14 != 2 )
    a1[371] = *(_DWORD *)(a3 + 1148);
  v107 = 0;
  v106[0] = 0;
  v105[0] = 0;
  v104[0] = 0;
  ...
  if ( a3 )
  {
    ...
    if ( context )
    {
      ...
      a1[409] = *(_DWORD *)(a3 + 1852);
      *((_BYTE *)a1 + 1560) = *(_BYTE *)(a3 + 1141);
      if ( (unsigned int)wlan_mlme_get_auto_channel_weight(v16[2703], (int *)&v107) )
        qdf_trace_msg(
          0x39u,
          2u,
      ...
      *((_WORD *)a1 + 749) = *(_WORD *)(a3 + 1186);
      ...
      if ( (unsigned int)wlan_mlme_get_acs_linear_bss_status(v16[2703], v106) )
        qdf_trace_msg(
          0x39u,
          2u,
          ...
          v33,
          "wlansap_set_scan_acs_channel_params");
      if ( (unsigned int)wlan_mlme_get_acs_linear_rssi_status(v16[2703], v105) )
        qdf_trace_msg(
          0x39u,
          2u,
          ...
          v41,
          "wlansap_set_scan_acs_channel_params");
      if ( (unsigned int)wlan_mlme_get_acs_rssi_threshold_score(v16[2703], v102) )
        qdf_trace_msg(
          0x39u,
          2u,
          ...
          v49,
          "wlansap_set_scan_acs_channel_params");
      if ( (unsigned int)wlan_mlme_get_acs_same_chan_weight_rand_status(v16[2703], v104) )
        qdf_trace_msg(
          0x39u,
          2u,
          ...
          v57,
          "wlansap_set_scan_acs_channel_params");
      if ( (unsigned int)wlan_mlme_get_acs_wifi_non_wifi_load_status(v16[2703], v103) )
        qdf_trace_msg(
          0x39u,
          2u,
          ...
          v65,
          "wlansap_set_scan_acs_channel_params");
      if ( (unsigned int)wlan_mlme_get_acs_early_terminate_status(v16[2703], v101) )
        qdf_trace_msg(
          0x39u,
          2u,
          ...
          v73,
          "wlansap_set_scan_acs_channel_params");
      *(_BYTE *)(*((_QWORD *)a1 + 193) + 604LL) = v106[0];
      *(_BYTE *)(*((_QWORD *)a1 + 193) + 605LL) = v105[0];
      *(_WORD *)(*((_QWORD *)a1 + 193) + 606LL) = v102[0];
      *(_BYTE *)(*((_QWORD *)a1 + 193) + 608LL) = v104[0];
      *(_BYTE *)(*((_QWORD *)a1 + 193) + 609LL) = v103[0];
      *(_BYTE *)(*((_QWORD *)a1 + 193) + 610LL) = v101[0];
      goto LABEL_29;
    }
