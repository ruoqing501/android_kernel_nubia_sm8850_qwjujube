        ...
        double a12)
{
  ...
  if ( (unsigned int)v16 >= 4 )
  {
    ...
    do
    {
      ...
      {
        v25 = jiffies;
        if ( hdd_tx_latency_enable___last_ticks_413 - jiffies + 125 < 0 )
        {
          qdf_trace_msg(
            0x33u,
            2u,
            ...
            a12,
            "hdd_tx_latency_enable");
          hdd_tx_latency_enable___last_ticks_413 = v25;
        }
        goto LABEL_32;
      }
      if ( !v35 )
      {
        v26 = jiffies;
        if ( hdd_tx_latency_enable___last_ticks_415 - jiffies + 125 < 0 )
        {
          qdf_trace_msg(
            0x33u,
            2u,
            ...
            a12,
            "hdd_tx_latency_enable");
          hdd_tx_latency_enable___last_ticks_415 = v26;
        }
        goto LABEL_32;
      }
      ...
      {
        v27 = jiffies;
        if ( hdd_tx_latency_enable___last_ticks_417 - jiffies + 125 < 0 )
        {
          qdf_trace_msg(
            0x33u,
            2u,
            ...
            a12,
            "hdd_tx_latency_enable");
          hdd_tx_latency_enable___last_ticks_417 = v27;
        }
        goto LABEL_32;
      }
      v20 = *(_DWORD *)(v35 + 4);
      *((_DWORD *)&v31 + *(unsigned __int8 *)(v34 + 4)) = v20;
      ...
      {
        v28 = jiffies;
        if ( hdd_tx_latency_enable___last_ticks_419 - jiffies + 125 < 0 )
        {
          qdf_trace_msg(
            0x33u,
            2u,
            ...
            a12,
            "hdd_tx_latency_enable");
          hdd_tx_latency_enable___last_ticks_419 = v28;
        }
        goto LABEL_32;
      }
  ...
  v29 = jiffies;
  if ( hdd_tx_latency_enable___last_ticks_421 - jiffies + 125 < 0 )
  {
    qdf_trace_msg(
      0x33u,
      2u,
      ...
      "hdd_tx_latency_enable",
      v23);
    hdd_tx_latency_enable___last_ticks_421 = v29;
  }
LABEL_32:
  result = 4294967274LL;
LABEL_33:
