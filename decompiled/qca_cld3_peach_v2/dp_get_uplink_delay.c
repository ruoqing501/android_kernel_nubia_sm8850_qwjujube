__int64 __fastcall dp_get_uplink_delay(__int64 a1, unsigned __int8 a2, unsigned int *a3)
{
  ...
  v15 = ref_by_id_1;
  v16 = (unsigned int *)(ref_by_id_1 + 43556);
  if ( !*(_DWORD *)(ref_by_id_1 + 43568) )
  {
    dp_vdev_unref_delete(a1, ref_by_id_1, 7u, v16, v7, v8, v9, v10, v11, v12, v13, v14);
    return 16;
  }
  v17 = *v16;
  v18 = *(_DWORD *)(ref_by_id_1 + 43560);
  v19 = *(_DWORD *)(ref_by_id_1 + 46232);
  if ( v18 < v19 )
    v20 = ~v19;
  else
    v20 = -v19;
  ...
  *a3 = v21;
  *(_DWORD *)(ref_by_id_1 + 46228) = v17;
  *(_DWORD *)(ref_by_id_1 + 46232) = v18;
  dp_print_tsf_tx_delay_hist((__int64 *)(ref_by_id_1 + 5104), 0);
  qdf_mem_set((void *)(v15 + 5104), 0x80u, 0);
