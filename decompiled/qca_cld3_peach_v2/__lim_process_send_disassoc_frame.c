        ...
        double a10)
{
  ...
  {
    v33 = "%s: NULL req";
    return qdf_trace_msg(0x35u, 2u, v33, a3, a4, a5, a6, a7, a8, a9, a10, "__lim_process_send_disassoc_frame");
  }
  v11 = (char *)a2 + 5;
  ...
  {
    v33 = "%s: received invalid SME_DISASSOC_REQ message";
    return qdf_trace_msg(0x35u, 2u, v33, a3, a4, a5, a6, a7, a8, a9, a10, "__lim_process_send_disassoc_frame");
  }
  ...
  lim_mlo_sap_validate_and_update_ra(session_by_vdev_id, v11);
  qdf_trace_msg(
    0x35u,
    8u,
  ...
  return lim_send_disassoc_mgmt_frame(a1, a2[6], v11, v23, *((_BYTE *)a2 + 14) != 0);
}
