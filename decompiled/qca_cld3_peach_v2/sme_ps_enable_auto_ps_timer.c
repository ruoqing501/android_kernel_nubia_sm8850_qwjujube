__int64 __fastcall sme_ps_enable_auto_ps_timer(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v3; // x29
  __int64 v4; // x30
  unsigned int v6; // w19
  ...
  {
    __break(0x5512u);
    return sme_ps_timer_flush_sync(a1, a2, a3, *(int *)(a3 + 96));
  }
  else
  {
    v29 = v3;
    ...
    v6 = a3;
    v7 = a2;
    user_ps = mlme_get_user_ps(*(_QWORD *)(a1 + 21624), a2);
    if ( !v6 && (user_ps & 1) == 0 )
    {
...
LABEL_5:
    ...
    v19 = a1 + 192LL * v7;
    current_state = qdf_mc_timer_get_current_state(v19 + 13216);
    ...
    else
    {
      ...
      qdf_trace_msg(
        ...
        v3,
        v30);
      result = qdf_mc_timer_start(v19 + 13216, v6);
      if ( (_DWORD)result )
      {
        if ( (_DWORD)result == 6 )
        {
