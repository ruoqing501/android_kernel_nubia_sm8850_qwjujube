__int64 __fastcall hdd_get_adapter_by_iface_name(__int64 a1, const char *a2)
{
...
LABEL_8:
  ...
  while ( 1 )
  {
    v20 = strcmp((const char *)(*(_QWORD *)(v6 + 32) + 296LL), a2);
    hdd_adapter_dev_put_debug(v6, 0x18u, v21, v22, v23, v24, v25, v26, v27, v28);
    if ( !v20 )
      break;
    if ( (_ReadStatusReg(DAIF) & 0x80) != 0
...
LABEL_19:
      ...
      if ( v7 == v46 )
      {
        ...
        hdd_adapter_dev_put_debug(v7, 0x18u, v10, v11, v12, v13, v14, v15, v16, v17);
        goto LABEL_12;
      }
      if ( v46 )
      {
...
LABEL_13:
  ...
  if ( v7 )
    hdd_adapter_dev_put_debug(v7, 0x18u, v29, v30, v31, v32, v33, v34, v35, v36);
LABEL_56:
