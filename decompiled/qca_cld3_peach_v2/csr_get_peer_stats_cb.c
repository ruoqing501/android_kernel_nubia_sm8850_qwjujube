        ...
        double a10)
{
  ...
  psoc_ext_obj_fl = mlme_get_psoc_ext_obj_fl(*(_QWORD *)(a2 + 21624));
  if ( !psoc_ext_obj_fl )
  {
    v23 = "%s: NULL mlme psoc object";
    return qdf_trace_msg(0x34u, 2u, v23, a3, a4, a5, a6, a7, a8, a9, a10, "csr_get_peer_stats_cb");
  }
  qdf_mc_timer_stop(psoc_ext_obj_fl + 7664);
  v21 = *(_QWORD *)(a1 + 40);
  if ( !v21 )
  {
    v25 = "%s: no peer stats";
LABEL_11:
  ...
  *(_DWORD *)(a2 + 21672) = *(char *)(v21 + 8);
  *(_DWORD *)(a2 + 21676) = **(_DWORD **)(a1 + 40);
  *(_DWORD *)(a2 + 21680) = *(_DWORD *)(*(_QWORD *)(a1 + 40) + 4LL);
  v22 = *(_QWORD *)(a1 + 72);
  if ( !v22 )
  {
...
LABEL_12:
  qdf_trace_msg(
    ...
    *(unsigned int *)(a2 + 21672),
    *(unsigned int *)(a2 + 21676),
    *(unsigned int *)(a2 + 21680),
    *(unsigned int *)(a2 + 21688));
