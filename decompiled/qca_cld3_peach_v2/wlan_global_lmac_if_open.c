__int64 __fastcall wlan_global_lmac_if_open(__int64 a1)
{
  ...
  v2 = _qdf_mem_malloc(2280, "wlan_global_lmac_if_open", 200);
  if ( !v2 )
  {
    v8 = 2;
  ...
  v3 = v2;
  v4 = _qdf_mem_malloc(1400, "wlan_global_lmac_if_open", 206);
  if ( !v4 )
  {
    v8 = 2;
  ...
  *(_QWORD *)(a1 + 2136) = v4;
  ...
  v7 = (void (__fastcall *)(__int64))off_75CB00;
  if ( *((_DWORD *)off_75CB00 - 1) != -1972930274 )
    __break(0x8228u);
  v7(v3);
