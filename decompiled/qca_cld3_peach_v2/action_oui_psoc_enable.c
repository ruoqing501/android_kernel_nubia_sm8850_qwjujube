...
LABEL_11:
  *((_BYTE *)v21 + 3296) = action_oui_v2_cap & 1;
  ...
  sized_strscpy((char *)v20 + 9, values + 11573, 840);
  v27 = cfg_psoc_get_values(v19);
  sized_strscpy((char *)v20 + 849, v27 + 14096, 840);
  v28 = cfg_psoc_get_values(v19);
  sized_strscpy((char *)v20 + 1689, v28 + 10732, 840);
  v29 = cfg_psoc_get_values(v19);
  sized_strscpy((char *)v20 + 2529, v29 + 13255, 840);
  v30 = cfg_psoc_get_values(v19);
  sized_strscpy((char *)v20 + 3369, v30 + 17460, 840);
  v31 = cfg_psoc_get_values(v19);
  sized_strscpy((char *)v20 + 4209, v31 + 12414, 840);
  v32 = cfg_psoc_get_values(v19);
  sized_strscpy((char *)v20 + 5049, v32 + 14937, 840);
  v33 = cfg_psoc_get_values(v19);
  sized_strscpy((char *)v20 + 18489, v33 + 15778, 840);
  v34 = cfg_psoc_get_values(v19);
  sized_strscpy((char *)v20 + 6729, v34 + 16619, 840);
  v35 = cfg_psoc_get_values(v19);
  sized_strscpy((char *)v20 + 5889, v35 + 19142, 840);
  v36 = cfg_psoc_get_values(v19);
  sized_strscpy((char *)v20 + 15969, v36 + 18301, 840);
  v37 = cfg_psoc_get_values(v19);
  sized_strscpy((char *)v20 + 16809, v37 + 19983, 840);
  v38 = cfg_psoc_get_values(v19);
  sized_strscpy((char *)v20 + 7569, v38 + 20824, 840);
  v39 = cfg_psoc_get_values(v19);
  sized_strscpy((char *)v20 + 8409, v39 + 21665, 840);
  v40 = cfg_psoc_get_values(v19);
  sized_strscpy((char *)v20 + 9249, v40 + 23347, 840);
  v41 = cfg_psoc_get_values(v19);
  sized_strscpy((char *)v20 + 19329, v41 + 22506, 840);
  v42 = cfg_psoc_get_values(v19);
  sized_strscpy((char *)v20 + 10089, v42 + 25029, 840);
  v43 = cfg_psoc_get_values(v19);
  sized_strscpy((char *)v20 + 13449, v43 + 24188, 840);
  v44 = cfg_psoc_get_values(v19);
  sized_strscpy((char *)v20 + 14289, v44 + 25870, 840);
  v45 = cfg_psoc_get_values(v19);
  sized_strscpy((char *)v20 + 17649, v45 + 26711, 840);
  v46 = cfg_psoc_get_values(v19);
  sized_strscpy((char *)v20 + 20169, v46 + 27552, 840);
  v47 = cfg_psoc_get_values(v19);
  sized_strscpy((char *)v20 + 10929, v47 + 28393, 840);
  v48 = cfg_psoc_get_values(v19);
  sized_strscpy((char *)v20 + 21009, v48 + 30075, 840);
  v49 = cfg_psoc_get_values(v19);
  sized_strscpy((char *)v20 + 21849, v49 + 30916, 840);
  v50 = *((unsigned __int8 *)v21 + 3296);
  v51 = cfg_psoc_get_values(v19);
  if ( v50 == 1 )
  {
    sized_strscpy((char *)v20 + 15129, v51 + 31764, 840);
    *((_BYTE *)v21 + 3315) = 1;
  }
  else
  {
    sized_strscpy((char *)v20 + 15129, v51 + 29234, 840);
  }
  v52 = 0;
  v53 = v20 + 2943;
  do
