        ...
        double a10)
{
  ...
  vdev_by_user = _hdd_objmgr_get_vdev_by_user(*(_QWORD *)(a1 + 52832), 0x56u, (__int64)"hdd_enable_host_offloads");
  if ( vdev_by_user )
  {
    v21 = vdev_by_user;
    if ( (ucfg_pmo_is_vdev_supports_offload() & 1) != 0 )
    {
      if ( (ucfg_pmo_is_vdev_connected(v21) & 1) != 0 )
      {
        ...
        if ( !(unsigned int)_wlan_hdd_validate_context(
                              ...
                              v53,
                              v54)
          && hdd_cm_is_vdev_associated(*(_DWORD **)(a1 + 52832)) )
        {
          v63 = ucfg_pmo_enable_mc_addr_filtering_in_fwr(*v46, *(unsigned __int8 *)(*(_QWORD *)(a1 + 52832) + 8LL), a2);
          if ( v63 )
            qdf_trace_msg(
              0x33u,
              8u,
