        ...
        unsigned int a5)
{
  ...
  v115 = 0;
  v114 = 0;
  result = _qdf_mem_malloc(0x2D8u, "sme_rrm_send_scan_result", 458);
  if ( !result )
    goto LABEL_63;
  v11 = result;
  ...
  {
    *(_BYTE *)(v11 + 16) = 0;
    if ( !*(_BYTE *)(a1 + 544LL * (unsigned __int8)a2 + 17561) )
      goto LABEL_12;
  }
  else
  {
    *(_BYTE *)(v11 + 16) = 1;
    qdf_mem_copy(v12, (const void *)(a1 + 544LL * (unsigned __int8)a2 + 17594), 6u);
    if ( !*(_BYTE *)(a1 + 544LL * (unsigned __int8)a2 + 17561) )
      goto LABEL_12;
  }
  *(_BYTE *)(v11 + 17) = 1;
  if ( *(unsigned __int8 *)(a1 + 544LL * (unsigned __int8)a2 + 17561) >= 0x20u )
    v14 = 32;
  else
    v14 = *(unsigned __int8 *)(a1 + 544LL * (unsigned __int8)a2 + 17561);
  *(_BYTE *)(v11 + 100) = v14;
  qdf_mem_copy((void *)(v11 + 101), (const void *)(a1 + 544LL * (unsigned __int8)a2 + 17562), v14);
LABEL_12:
  v15 = a3;
  if ( a3 >= 0x66u )
    v15 = 102;
  ...
  *(_WORD *)v11 |= 2u;
  if ( (*(_DWORD *)(a1 + 544LL * (unsigned __int8)a2 + 18024) | 2) != 3 )
  {
    v17 = (_BYTE *)(a1 + 544LL * (unsigned __int8)a2 + 17618);
    goto LABEL_18;
  }
  v16 = *(unsigned __int8 *)(a1 + 544LL * (unsigned __int8)a2 + 17560);
  if ( v16 > 7 )
LABEL_68:
    __break(0x5512u);
  v17 = (_BYTE *)(a1 + 544LL * (unsigned __int8)a2 + 17488 + v16 + 130);
LABEL_18:
  if ( *v17 == 2 )
    *(_QWORD *)(v11 + 8) = wlan_scan_get_aging_time(*(_QWORD *)(a1 + 21624));
  if ( (unsigned int)csr_roam_get_session_id_from_bssid(a1, (int *)(a1 + 544LL * (unsigned __int8)a2 + 17490), &v112) == 16 )
  {
    qdf_trace_msg(
      0x34u,
      8u,
  ...
  if ( v113 )
  {
    ...
    if ( (_BYTE)a5 && !first )
    {
      if ( *(_DWORD *)(a1 + 544LL * (unsigned __int8)a2 + 18024) == 3 )
...
LABEL_62:
    ...
    if ( (unsigned int)wlan_mlme_get_bssid_vdev_id(*(_QWORD *)(a1 + 21632), v112, &v114) )
    {
      v71 = v112;
...
LABEL_54:
    ...
    if ( !cm_is_vdevid_connected(*(_QWORD *)(a1 + 21632), v112) )
    {
      v71 = v112;
