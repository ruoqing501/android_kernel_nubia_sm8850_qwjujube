  ...
  if ( a2 > 0x17u )
  {
    switch ( a2 )
    {
      ...
      case 0x19u:
        ...
        {
          wlan_sm_transition_to(a1[63], 0xCu, a5, a6, a7, a8, a9, a10, a11, a12);
          v33 = a1[63];
          v34 = 32;
        }
        else
...
LABEL_23:
      ...
      case 0x1Eu:
        ...
        wlan_sm_transition_to(a1[63], 3u, v17, v18, v19, v20, v21, v22, v23, v24);
        v33 = a1[63];
        v34 = 20;
LABEL_25:
  ...
  if ( a2 == 12 )
  {
    v15 = a4;
    v16 = a3;
    wlan_sm_transition_to(a1[63], 0xBu, a5, a6, a7, a8, a9, a10, a11, a12);
    v33 = a1[63];
    v34 = 12;
    goto LABEL_25;
  }
