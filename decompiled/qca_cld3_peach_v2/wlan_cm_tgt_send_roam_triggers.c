__int64 __fastcall wlan_cm_tgt_send_roam_triggers(__int64 a1, __int64 a2, __int64 a3)
{
...
LABEL_11:
  ...
  v18 = *(__int64 (__fastcall **)(__int64, __int64))(ext_hdl + 7400);
  if ( !v18 )
  {
LABEL_12:
    v20 = 4;
    v21 = "%s: CM_RSO: vdev %d send_roam_triggers is NULL";
    goto LABEL_13;
  }
  if ( *((_DWORD *)v18 - 1) != -865713091 )
    __break(0x8228u);
  v20 = v18(v15, a3);
  if ( !v20 )
    goto LABEL_14;
  v21 = "%s: CM_RSO: vdev %d fail to send roamtrigger";
LABEL_13:
  qdf_trace_msg(0x68u, 2u, v21, v6, v7, v8, v9, v10, v11, v12, v13, "wlan_cm_tgt_send_roam_triggers", v4);
LABEL_14:
