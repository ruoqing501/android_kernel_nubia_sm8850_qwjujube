...
LABEL_17:
  ...
  *(_WORD *)(a1 + 18872) = rx_refill_buf_pool_size;
  ...
  else
  {
    ...
    do
    {
      ...
      if ( v31 )
      {
        ...
        {
          v30 = v29++;
          *(_QWORD *)(*(_QWORD *)(a1 + 18880) + 8 * v30) = v32;
        }
      }
      ++v28;
    }
    while ( v28 < *(unsigned __int16 *)(a1 + 18872) - 1 );
  }
  *(_WORD *)(a1 + 18858) = v29;
  qdf_trace_msg(
    0x45u,
