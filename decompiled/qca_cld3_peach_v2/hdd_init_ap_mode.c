...
LABEL_16:
  ...
  if ( (a2 & 1) == 0 )
  {
    ...
    *((_DWORD *)a1 + 533) = wlan_hdd_get_dfs_mode(*((unsigned int *)v13 + 404));
  }
  if ( *(_DWORD *)(v12 + 40) == 1 )
  {
...
LABEL_40:
  if ( (a2 & 1) == 0 )
  {
    *((_BYTE *)a1 + 1424) = 0;
    ...
    qdf_mem_set(a1 + 178, 0x268u, 0);
    *((_DWORD *)a1 + 661) = 0;
  }
  a1[757] = 0xFFFFFFFE00000LL;
  a1[758] = (__int64)(a1 + 758);
  a1[759] = (__int64)(a1 + 758);
  a1[760] = (__int64)hdd_stop_sap_due_to_invalid_channel;
LABEL_13:
