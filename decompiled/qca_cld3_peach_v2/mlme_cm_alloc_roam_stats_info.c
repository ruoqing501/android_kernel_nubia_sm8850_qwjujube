        ...
        double a9)
{
  ...
  v10 = *(_QWORD *)(*(_QWORD *)(a1 + 520) + 216LL);
...
LABEL_9:
  ...
  if ( *(_QWORD *)(*(_QWORD *)(a1 + 536) + 23592LL) )
  {
  ...
  *(_QWORD *)(*(_QWORD *)(a1 + 536) + 23592LL) = result;
  v16 = *(_QWORD *)(a1 + 536);
  if ( *(_QWORD *)(v16 + 23592) )
  {
    *(_DWORD *)(v16 + 23600) = v17;
    *(_DWORD *)(*(_QWORD *)(a1 + 536) + 23604LL) = 0;
    result = qdf_mutex_create(*(_QWORD *)(a1 + 536) + 23608LL);
  }
LABEL_10:
