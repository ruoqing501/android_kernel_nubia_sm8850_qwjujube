...
LABEL_9:
    ...
    {
      raw_spin_lock(v19 + 17632);
    }
    else
    {
      v26 = v19;
      raw_spin_lock_bh(v19 + 17632);
      *(_QWORD *)(v26 + 17640) |= 1uLL;
    }
    v21 = dp_peer_ast_hash_find_by_vdevid();
    v22 = *(_QWORD *)(*(_QWORD *)(v17 + 24) + 8LL);
    v23 = *(_QWORD *)(v22 + 17640);
    if ( (v23 & 1) != 0 )
    {
      *(_QWORD *)(v22 + 17640) = v23 & 0xFFFFFFFFFFFFFFFELL;
      raw_spin_unlock_bh(v22 + 17632);
      if ( v21 )
        goto LABEL_9;
    }
    else
    {
      raw_spin_unlock(v22 + 17632);
      if ( v21 )
        goto LABEL_9;
    }
    v25 = (unsigned int *)(unsigned int)(*(_DWORD *)(v17 + 772) + 1);
    *(_DWORD *)(v17 + 772) = (_DWORD)v25;
