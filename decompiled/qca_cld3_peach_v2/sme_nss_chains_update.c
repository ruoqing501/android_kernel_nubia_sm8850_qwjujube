__int64 __fastcall sme_nss_chains_update(__int64 a1, unsigned int *a2, unsigned int a3)
{
  ...
  {
    v15 = v6;
    if ( (unsigned __int8)wlan_policy_mgr_get_ll_lt_sap_vdev_id(*(_QWORD *)(a1 + 21624)) != 255 )
    {
      v24 = jiffies;
    ...
    {
      v26 = qdf_mutex_acquire(a1 + 12848);
      if ( !v26 )
      {
...
LABEL_61:
          v72 = *(_QWORD *)(a1 + 8);
          *((_BYTE *)a2 + 50) = *(_BYTE *)(v72 + 3494);
          a2[13] = *(_DWORD *)(v72 + 3496);
          qdf_trace_msg(
            0x34u,
            8u,
            "%s: dynamic_cfg",
          ...
          if ( (_DWORD)v54 )
          {
            if ( (unsigned int)qdf_mem_cmp(v44, a2, 0x38u) )
            {
              qdf_trace_msg(
                ...
                "sme_nss_chains_update",
                v4);
              v26 = wma_vdev_nss_chain_params_send(*(unsigned __int8 *)(v15 + 168), a2);
              if ( v26 )
              {
                qdf_trace_msg(
                  0x34u,
