__int64 __fastcall dlm_add_userspace_deny_list(__int64 a1, int *a2, char a3)
{
  ...
  double v74; // d6
  double v75; // d7
  unsigned __int8 *v76; // [xsp+0h] [xbp-80h] BYREF
  unsigned __int8 *v77; // [xsp+8h] [xbp-78h] BYREF
  _QWORD v78[11]; // [xsp+10h] [xbp-70h] BYREF
  __int64 v79; // [xsp+68h] [xbp-18h]
  __int64 v80; // [xsp+70h] [xbp-10h]
  __int64 v81; // [xsp+78h] [xbp-8h]
