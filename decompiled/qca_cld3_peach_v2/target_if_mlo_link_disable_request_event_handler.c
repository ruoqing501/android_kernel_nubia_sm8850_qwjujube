__int64 __fastcall target_if_mlo_link_disable_request_event_handler(
        __int64 a1,
        __int64 a2,
        double a3,
        double a4,
...
LABEL_15:
  ...
  if ( !v20 )
  {
    qdf_trace_msg(0x49u, 2u, "%s: rx_ops is NULL", v12, v13, v14, v15, v16, v17, v18, v19, "target_if_mlo_get_rx_ops");
    goto LABEL_13;
  }
  if ( !*(_QWORD *)(v20 + 1264) )
  {
LABEL_13:
  ...
  v24 = wmi_extract_mlo_link_disable_request_evt(v22, a2, &v37);
  if ( v24 )
  {
    v33 = v24;
    qdf_trace_msg(
  ...
  {
    v36 = *(__int64 (__fastcall **)(__int64, __int64 *))(v20 + 1264);
