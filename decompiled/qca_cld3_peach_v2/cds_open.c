...
LABEL_13:
  ...
  if ( gp_cds_context
    || (printk(&unk_A3062F, "cds_get_global_context", v18, v19), (v28 = (__int64 *)gp_cds_context) != nullptr) )
  {
            ...
            *(_QWORD *)(gp_cds_context + 72) = 0;
            if ( is_fw_down )
            {
              ...
              *(_BYTE *)(v29 + 7112) = 0;
              ...
              v125 = &dp_ol_if_ops;
              v126 = v90;
              is_fw_down = (__int64)ucfg_dp_txrx_soc_attach((__int64 *)&v125, (_BYTE *)(v29 + 7112));
              v91 = gp_cds_context;
