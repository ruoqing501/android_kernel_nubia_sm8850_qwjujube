        ...
        double a11)
{
  ...
  if ( a2 <= 5u && *(_QWORD *)(a1 + 17296) + 96LL * a2 )
  {
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 8) + 1317LL) = *(_QWORD *)(*(_QWORD *)(a1 + 8) + 1317LL) & 0xFFFFFFFFFFFFFE7FLL
                                              | ((unsigned __int64)(a3 & 3) << 7);
    v14 = *(_QWORD *)(v12 + 1377) & 0xFFFFFFFFFFFFFE7FLL | ((unsigned __int64)(a3 & 3) << 7);
    *(_QWORD *)(v12 + 1317) = *(_QWORD *)(v12 + 1317) & 0xFFFFFFFFFFFFFE7FLL | ((unsigned __int64)(a3 & 3) << 7);
    *(_QWORD *)(v12 + 1377) = v14;
