...
LABEL_10:
    ...
    *(_BYTE *)(a1 + 7218) = 0;
    *(_BYTE *)(a1 + 7284) = 0;
    if ( !(unsigned int)sch_set_fixed_beacon_fields(v10, a1) )
    {
  ...
  result = policy_mgr_is_vdev_ll_lt_sap(*(_QWORD *)(v10 + 21624), *(unsigned __int8 *)(a1 + 10));
  if ( (result & 1) != 0 )
    return (__int64)lim_send_csa_tx_complete(*(_BYTE *)(a1 + 10), v11, v12, v13, v14, v15, v16, v17, v18);
  if ( (*(_BYTE *)(*(_QWORD *)(v10 + 21624) + 23LL) & 2) == 0 )
  {
    qdf_mc_timer_stop(a1 + 8232);
    if ( *(_BYTE *)(a1 + 7218) )
      --*(_BYTE *)(a1 + 7218);
    ...
    else
    {
      ...
      if ( *(_BYTE *)(*(_QWORD *)(v10 + 8) + 3372LL) == 1 )
      {
        v39 = *(_DWORD *)(a1 + 7204);
