  ...
  switch ( a3 )
  {
    ...
    case 0xEu:
      qdf_trace_msg(
        ...
        v18,
        "wlan_cm_roam_cfg_get_value",
        *(unsigned __int8 *)(ext_hdl_fl + 1383),
        *(unsigned __int8 *)(ext_hdl_fl + 92),
        *(unsigned int *)(v9 + 2688));
      if ( *(_BYTE *)(ext_hdl_fl + 1383) == 1 && (*(_BYTE *)(ext_hdl_fl + 92) & 1) == 0 )
      {
        v23 = (unsigned int *)*(unsigned __int8 *)(v9 + 2772);
        v24 = 0;
        v10 = v21;
      }
      else
      {
        v23 = (unsigned int *)*(unsigned int *)(v9 + 2688);
        v10 = v21;
        v24 = 0;
        if ( !(_DWORD)v23 )
    ...
    case 0x1Eu:
      ...
      goto LABEL_50;
    case 0x1Fu:
      v23 = (unsigned int *)*(unsigned __int8 *)(ext_hdl_fl + 1382);
      goto LABEL_46;
    case 0x20u:
      v23 = (unsigned int *)*(unsigned __int8 *)(ext_hdl_fl + 1383);
      goto LABEL_46;
    case 0x21u:
      v23 = (unsigned int *)*(unsigned int *)(v9 + 3644);
      goto LABEL_50;
    case 0x22u:
      v23 = (unsigned int *)*(unsigned int *)(v9 + 3648);
      goto LABEL_50;
    case 0x23u:
      v23 = (unsigned int *)*(unsigned int *)(v9 + 2768);
LABEL_25:
      v24 = 0;
      a4[1] = (_DWORD)v23;
      break;
...
LABEL_51:
      *a4 = (_DWORD)v23;
      break;
    case 0x2Bu:
      v23 = (unsigned int *)*(unsigned __int8 *)(ext_hdl_fl + 1384);
LABEL_46:
      v24 = 0;
