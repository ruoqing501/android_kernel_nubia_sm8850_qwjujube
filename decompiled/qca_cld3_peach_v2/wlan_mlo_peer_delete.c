__int64 __fastcall wlan_mlo_peer_delete(__int64 result)
{
  __int64 v1; // x21
  double v2; // d0
  double v3; // d1
  ...
  if ( v10 )
  {
    if ( (unsigned int)wlan_objmgr_peer_try_get_ref(*(_QWORD *)(v1 + 16), 0x5Au, v2, v3, v4, v5, v6, v7, v8, v9) )
      v12 = 0;
    else
      v12 = v10;
    v13 = *(_QWORD *)(v1 + 56);
  ...
  *(_DWORD *)(v1 + 200) = 2;
  ...
  if ( v12 )
  {
    if ( *(_DWORD *)(*(_QWORD *)(v12 + 96) + 16LL) != 1
      || (v22[0] = v12, result = mlo_msgq_post(3, v11, v22), (_DWORD)result) )
    {
