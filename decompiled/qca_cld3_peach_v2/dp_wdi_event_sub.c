...
LABEL_8:
  ...
  v15 = *(_QWORD *)(*(_QWORD *)(v12 + 8) + 20112LL);
  if ( !v15 )
  {
    v20 = a4;
    v17 = a3;
...
LABEL_19:
  v30 = v20 - 256;
  v31 = *(_QWORD *)(*(_QWORD *)(v12 + 95928) + 8LL * (v20 - 256));
  if ( v31 )
  {
    v32 = *(_QWORD *)(*(_QWORD *)(v12 + 95928) + 8LL * v30);
    while ( v32 != v17 )
    {
      v32 = *(_QWORD *)(v32 + 16);
      if ( !v32 )
  ...
  else
  {
    ...
    *(_QWORD *)(v17 + 24) = 0;
LABEL_25:
    *(_QWORD *)(*(_QWORD *)(v12 + 95928) + 8LL * v30) = v17;
  }
  return result;
}
