__int64 __fastcall hdd_big_data_pack_resp_nlmsg(__int64 a1, __int64 a2)
{
  ...
  {
    if ( wlan_reg_is_5ghz_ch_freq(*(_DWORD *)(a2 + 1396)) )
    {
      roam_states = *(_DWORD *)(a2 + 4660);
    ...
    else if ( wlan_reg_is_24ghz_ch_freq(*(_DWORD *)(a2 + 1396)) )
    {
      roam_states = *(_DWORD *)(a2 + 4660);
