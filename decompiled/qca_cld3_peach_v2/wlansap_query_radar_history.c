__int64 __fastcall wlansap_query_radar_history(__int64 a1, __int64 *a2, _DWORD *a3)
{
  ...
  unsigned __int16 *v80[2]; // [xsp+20h] [xbp-10h] BYREF

  v80[1] = *(unsigned __int16 **)(_ReadStatusReg(SP_EL0) + 1808);
  v6 = _qdf_mem_malloc(0x268u, "wlansap_query_radar_history", 2562);
  if ( v6 )
  {
    v7 = (_DWORD *)v6;
    ucfg_dfs_getnol(*(_QWORD *)(a1 + 21632), v6);
...
LABEL_39:
    ...
    {
      v38 = v78;
      if ( (wlan_reg_is_dfs_for_freq(*(_QWORD *)(a1 + 21632), dword_91EFDC, v10, v11, v12, v13, v14, v15, v16, v17) & 1) != 0 )
      {
        if ( (_DWORD)v23 )
        {
...
LABEL_34:
    ...
    {
      v39 = *v80[0];
      if ( v39 <= *(unsigned __int16 *)((char *)v80[0] + (unsigned __int64)&off_0 + 2) )
      {
        v40 = v23;
        do
        {
...
LABEL_26:
        ...
        while ( *(unsigned __int16 *)((char *)v80[0] + (unsigned __int64)&off_0 + 2) >= (unsigned int)(unsigned __int16)v39 );
        goto LABEL_38;
      }
    }
    v40 = v23;
