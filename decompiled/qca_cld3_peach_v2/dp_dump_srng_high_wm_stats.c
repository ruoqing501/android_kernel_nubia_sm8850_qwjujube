unsigned __int8 *__fastcall dp_dump_srng_high_wm_stats(__int64 a1, __int64 a2)
{
  ...
  result = (unsigned __int8 *)qdf_trace_msg(
                                ...
                                "80-90",
                                "90-100");
  if ( (a2 & 1) != 0 && *(_BYTE *)(a1 + 12896) )
  {
    v21 = 0;
    v22 = (unsigned __int8 **)(a1 + 5760);
    do
    {
      if ( v21 == 8 )
LABEL_52:
    ...
    while ( v21 < *(unsigned __int8 *)(a1 + 12896) );
  }
  if ( (a2 & 0x2000) != 0 )
  {
    v32 = *(unsigned __int8 *)(a1 + 7201);
    if ( *(_BYTE *)(a1 + 7201) )
    {
      v33 = 0;
      v34 = (unsigned __int8 **)(a1 + 7368);
      v35 = 1;
      do
      {
