__int64 __fastcall target_if_cm_roam_rssi_diff_6ghz(
        __int64 a1,
        double a2,
        double a3,
        double a4,
...
LABEL_8:
  ...
  if ( (_DWORD)result )
  {
    v13 = "%s: Failed to set WMI_ROAM_PARAM_ROAM_RSSI_BOOST_FOR_6GHZ_CAND_AP";
    v14 = "target_if_cm_roam_rssi_diff_6ghz";
LABEL_9:
