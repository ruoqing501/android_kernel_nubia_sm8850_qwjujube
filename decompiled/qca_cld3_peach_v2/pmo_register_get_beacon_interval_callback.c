__int64 __fastcall pmo_register_get_beacon_interval_callback(
        __int64 a1,
        __int64 a2,
        double a3,
        double a4,
    ...
    if ( a2 )
    {
      ...
      if ( ref )
      {
        ...
        qdf_trace_msg(
          ...
          v19,
          v20,
          "pmo_register_get_beacon_interval_callback");
        return v21;
      }
...
LABEL_15:
    ...
    v23 = "%s: pmo_get_beacon_interval is null";
  }
  else
  {
    v23 = "%s: psoc is null";
  }
  qdf_trace_msg(0x4Du, 2u, v23, a3, a4, a5, a6, a7, a8, a9, a10, "pmo_register_get_beacon_interval_callback");
  return 29;
}
