  ...
  if ( a2 <= 16 )
  {
    if ( a2 <= 4 )
    {
      if ( a2 == 2 )
      {
        ...
        result = tx_timer_change(v2 + 1072, *(unsigned int *)(*(_QWORD *)(v2 + 8) + 3680LL) / 0xAuLL, 0);
        if ( !(_DWORD)result )
          return result;
      ...
      else
      {
        ...
        if ( (unsigned int)tx_timer_deactivate(result + 808) )
          qdf_trace_msg(
            ...
            v44,
            "lim_deactivate_and_change_timer");
        result = tx_timer_change(v2 + 808, *(unsigned int *)(*(_QWORD *)(v2 + 8) + 3692LL) / 0xAuLL, 0);
        if ( !(_DWORD)result )
          return result;
      ...
      if ( a2 == 5 )
      {
        if ( (unsigned int)tx_timer_deactivate(result + 280) )
          qdf_trace_msg(
            ...
            v76,
            "lim_deactivate_and_change_timer");
        result = tx_timer_change(v2 + 280, *(unsigned int *)(*(_QWORD *)(v2 + 8) + 3704LL) / 0xAuLL, 0);
        if ( (_DWORD)result )
        {
...
LABEL_57:
  ...
  if ( (unsigned int)tx_timer_deactivate(result + 2136) )
    qdf_trace_msg(
      ...
      v60,
      "lim_deactivate_and_change_timer");
  result = tx_timer_change(v2 + 2136, *(unsigned int *)(*(_QWORD *)(v2 + 8) + 3684LL) / 0xAuLL, 0);
  if ( (_DWORD)result )
  {
