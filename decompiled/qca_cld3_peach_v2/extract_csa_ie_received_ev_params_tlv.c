...
LABEL_8:
  ...
  v12 = *a2;
  *(_WORD *)(a4 + 28) = *(_DWORD *)(*a2 + 16);
  *(_BYTE *)(a4 + 30) = *(_WORD *)(v12 + 18);
  *(_BYTE *)(a4 + 31) = *(_BYTE *)(v12 + 19);
  *(_WORD *)(a4 + 32) = *(_DWORD *)(v12 + 20);
  if ( (wlan_get_connected_vdev_from_psoc_by_bssid(**(_QWORD **)(a1 + 760), (const void *)(a4 + 28), a3) & 1) == 0 )
  {
  ...
  v21 = *(unsigned __int8 *)(a4 + 28);
  v22 = *(unsigned __int8 *)(a4 + 29);
  v23 = *(unsigned __int8 *)(a4 + 30);
  v24 = *(unsigned __int8 *)(a4 + 33);
  v25 = *(_DWORD *)(a4 + 4);
  v26 = *(_DWORD *)(a4 + 12);
  v27 = *(unsigned __int8 *)(a4 + 19);
  v28 = *(unsigned __int8 *)(a4 + 20);
  *(_DWORD *)(a4 + 24) = v20;
  qdf_trace_msg(
    0x31u,
    8u,
