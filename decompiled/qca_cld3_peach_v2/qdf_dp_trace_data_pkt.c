...
LABEL_26:
  ...
  if ( (unsigned __int8)byte_7F7656 > 1u )
  {
    ...
    else if ( byte_7F7656 != 4 && (byte_7F7656 != 3 || a3 >= 0x23) )
    {
      goto LABEL_52;
    }
LABEL_40:
