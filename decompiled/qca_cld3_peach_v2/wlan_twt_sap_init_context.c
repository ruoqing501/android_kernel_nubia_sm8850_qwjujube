        ...
        double a12)
{
  ...
  if ( !v16 )
    return qdf_trace_msg(
             ...
             a4);
  v25 = v16;
  v26 = wlan_vdev_peer_list_peek_active_head(v16, (_QWORD *)(v16 + 192), 0x5Eu);
  if ( v26 )
  {
    v36 = (__int64)v26;
    do
    {
      ...
      next_active_peer_of_vdev = wlan_peer_get_next_active_peer_of_vdev(v25, (_QWORD *)(v25 + 192), v36, 0x5Eu);
