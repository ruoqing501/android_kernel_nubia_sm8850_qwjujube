__int64 __fastcall policy_mgr_is_any_nondfs_chnl_present(__int64 a1, _DWORD *a2, char a3, unsigned __int8 a4)
{
  ...
  if ( context )
  {
    ...
    if ( BYTE4(qword_8D4F24) == 1
      && (wlan_reg_is_dfs_for_freq(*(_QWORD *)(v17 + 8), HIDWORD(qword_8D4F0C), v18, v19, v20, v21, v22, v23, v24, v25)
        & 1) == 0
      && (!conc_ml_sap_link_freq || conc_ml_sap_link_freq != HIDWORD(qword_8D4F0C)) )
    {
      v27 = 1;
      *a2 = HIDWORD(qword_8D4F0C);
    }
    if ( BYTE4(qword_8D4F48) == 1
      && (wlan_reg_is_dfs_for_freq(*(_QWORD *)(v17 + 8), HIDWORD(qword_8D4F30), v18, v19, v20, v21, v22, v23, v24, v25)
        & 1) == 0
      && (!conc_ml_sap_link_freq || conc_ml_sap_link_freq != HIDWORD(qword_8D4F30)) )
    {
      v27 = 1;
      *a2 = HIDWORD(qword_8D4F30);
    }
    if ( BYTE4(qword_8D4F6C) == 1
      && (wlan_reg_is_dfs_for_freq(*(_QWORD *)(v17 + 8), HIDWORD(qword_8D4F54), v18, v19, v20, v21, v22, v23, v24, v25)
        & 1) == 0
      && (!conc_ml_sap_link_freq || conc_ml_sap_link_freq != HIDWORD(qword_8D4F54)) )
    {
      v27 = 1;
      *a2 = HIDWORD(qword_8D4F54);
    }
    if ( BYTE4(qword_8D4F90) == 1
      && (wlan_reg_is_dfs_for_freq(*(_QWORD *)(v17 + 8), HIDWORD(qword_8D4F78), v18, v19, v20, v21, v22, v23, v24, v25)
        & 1) == 0
      && (!conc_ml_sap_link_freq || conc_ml_sap_link_freq != HIDWORD(qword_8D4F78)) )
    {
      v27 = 1;
