void __fastcall lim_configure_ap_start_bss_session(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_BYTE *)(a2 + 1936) = v11[0];
  *(_BYTE *)(a2 + 428) = wlan_mlme_is_ap_prot_enabled(*(_QWORD *)(a1 + 21624)) & 1;
  wlan_mlme_get_ap_protection_mode(*(_QWORD *)(a1 + 21624), v10);
  qdf_mem_copy((void *)(a2 + 432), v10, 2u);
  wlan_mlme_get_vendor_vht_for_24ghz(*(_QWORD *)(a1 + 21624), (_BYTE *)(a2 + 8628));
  if ( *(_DWORD *)(a2 + 7036) == 3 )
  {
    *(_BYTE *)(v3 + 1605) = 1;
  }
