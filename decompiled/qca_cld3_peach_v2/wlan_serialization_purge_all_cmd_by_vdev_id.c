__int64 __fastcall wlan_serialization_purge_all_cmd_by_vdev_id(
        __int64 a1,
        char a2,
        double a3,
        double a4,
        ...
        double a10)
{
  ...
  if ( a1 )
  {
    ...
    if ( pdev_obj )
    {
      ...
      if ( vdev_by_id_from_pdev )
      {
        ...
        wlan_ser_cancel_scan_cmd(v13, a1, v15, 0, 0, 1);
        wlan_ser_cancel_non_scan_cmd(v13, a1, v15, 0, 1, 0, 0);
        wlan_ser_cancel_non_scan_cmd(v13, a1, v15, 0, 1, 1, 0);
  ...
  return qdf_trace_msg(0x4Cu, 2u, v26, a3, a4, a5, a6, a7, a8, a9, a10, "wlan_serialization_purge_all_cmd_by_vdev_id");
}
