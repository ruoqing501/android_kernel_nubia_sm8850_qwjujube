...
LABEL_9:
  ...
  v19 = *(_BYTE *)(comp_private_obj + 198);
  if ( (v19 & 2) != 0 )
  {
    if ( (*(_BYTE *)(comp_private_obj + 198) & 8) == 0 )
    {
      v26 = *a2;
      goto LABEL_46;
    }
  ...
  if ( (*(_BYTE *)(comp_private_obj + 198) & 4) != 0 )
  {
    v20 = wlan_objmgr_vdev_get_comp_private_obj(a1, 0);
    if ( v20 )
    {
      v21 = (char)(*(_BYTE *)(v20 + 199) - 82);
    }
    else
    {
      qdf_trace_msg(
...
LABEL_30:
    ...
    if ( v28 )
    {
      v29 = *(unsigned __int8 *)(v28 + 200) - 82;
      v30 = *(unsigned __int8 *)(v28 + 201) - 82;
LABEL_34:
