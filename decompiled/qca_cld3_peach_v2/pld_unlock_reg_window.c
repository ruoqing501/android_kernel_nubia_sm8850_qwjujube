__int64 __fastcall pld_unlock_reg_window(__int64 a1, __int64 a2)
{
  __int64 v3; // x21
  __int64 v5; // x0
  __int64 v6; // x22
  ...
  if ( a1 && pld_ctx )
  {
    ...
    do
    {
      ...
      if ( v6 == v3 + 16 )
      {
        ...
        return printk(&unk_9C3340, "pld_unlock_reg_window", 1531, v8);
      }
    }
    ...
    if ( (unsigned int)(v9 - 1) >= 7 )
    {
      if ( v9 )
        return printk(&unk_9C3340, "pld_unlock_reg_window", 1531, v8);
      return cnss_pci_unlock_reg_window(a1, a2);
    }
  }
  else
  {
