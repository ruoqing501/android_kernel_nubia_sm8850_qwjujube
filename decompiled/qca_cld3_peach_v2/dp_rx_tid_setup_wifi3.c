        ...
        double a12)
{
  ...
  unsigned __int8 v112; // [xsp+1Ch] [xbp-24h]
  __int64 v113; // [xsp+20h] [xbp-20h]
  __int64 v114; // [xsp+28h] [xbp-18h]
  unsigned int v115; // [xsp+34h] [xbp-Ch]
  unsigned int v116; // [xsp+38h] [xbp-8h]

  v12 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 24) + 24LL) + 8LL);
  if ( !*(_DWORD *)(a1 + 240) )
    return 16;
  v13 = a3;
  v14 = a1;
  v15 = a2;
  if ( *(_DWORD *)(a1 + 408) == 1 && *(_QWORD *)(a1 + 416) && (*(_BYTE *)(a1 + 128) & 1) == 0 )
  {
    qdf_trace_msg(
      0x81u,
      5u,
      "%s: skip rx tid setup for peer%02x:%02x:%02x:**:**:%02x",
      a5,
      a6,
      a7,
      a8,
  ...
  while ( 2 )
  {
    ...
    if ( ((1LL << v24) & v15) == 0 )
      goto LABEL_8;
    v26 = *(_QWORD *)(v14 + 88) + 144 * v24;
    v27 = *(_QWORD *)(v26 + 32);
    *(_WORD *)(v26 + 72) = v13;
    if ( v27 )
    {
      updated = dp_rx_tid_update_wifi3(v14, v24, v13, a4, 0, v16, v17, v18, v19, v20, v21, v22, v23);
      if ( !updated )
      {
        qdf_trace_msg(
          0x81u,
    ...
    v116 = v15;
    v37 = *(_QWORD *)(v14 + 88) + 144 * v24;
    v38 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v14 + 24) + 24LL) + 8LL);
    *(_BYTE *)(v37 + 108) = 0;
    *(_DWORD *)(v37 + 104) = 0;
    *(_QWORD *)(v37 + 112) = 0;
    *(_WORD *)(v37 + 78) = 0;
...
LABEL_33:
      ...
      *(_QWORD *)(v37 + 32) = 0;
      if ( !v41 )
      {
        ...
        v86 = 0;
        v87 = 0;
        v113 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v114 + 24) + 24LL) + 8LL);
        do
        {
          if ( (((unsigned __int64)(unsigned int)(1 << v24) >> v87) & 1) != 0 )
          {
            v88 = *(_QWORD *)(v114 + 88) + v86;
            if ( *(_QWORD *)(v88 + 32) )
            {
              v89 = *(int *)(v88 + 64);
              v90 = *(_QWORD *)(v88 + 56);
...
LABEL_38:
    ...
    *(_QWORD *)(v37 + 56) = v71;
    ...
    if ( (_DWORD)v74 )
    {
      v75 = 56LL * *(unsigned int *)(v38 + 20224);
      *(_QWORD *)(*(_QWORD *)(v38 + 20216) + v75 + 8) = *(_QWORD *)(v37 + 56);
      *(_QWORD *)(*(_QWORD *)(v38 + 20216) + v75) = 1000 * (v72 / 0xFA) + 4 * (v73 % 0xFA);
      *(_QWORD *)(*(_QWORD *)(v38 + 20216) + v75 + 16) = v51;
      *(_QWORD *)(*(_QWORD *)(v38 + 20216) + v75 + 24) = *(_QWORD *)(v37 + 32);
      *(_DWORD *)(*(_QWORD *)(v38 + 20216) + v75 + 32) = *(unsigned __int16 *)(v114 + 16);
      *(_DWORD *)(*(_QWORD *)(v38 + 20216) + v75 + 36) = *(_DWORD *)v37;
      v76 = *(_QWORD *)(v38 + 20232);
      if ( v76 + 1 == v74 )
        v77 = 0;
      else
        v77 = v76 + 1;
      *(_QWORD *)(v38 + 20232) = v77;
    }
    v13 = v115;
    v15 = v116;
LABEL_8:
  ...
  {
LABEL_52:
    if ( (dp_get_peer_vdev_roaming_in_progress(v14, v16, v17, v18, v19, v20, v21, v22, v23) & 1) != 0 )
    {
      v100 = 12;
      goto LABEL_58;
    }
    qdf_trace_msg(
      ...
      v14,
      v15,
      *(unsigned __int8 *)(v12 + 20100),
      a4,
      v13);
    v101 = *(_DWORD **)(v12 + 1616);
    if ( *(v101 - 1) != -1687924027 )
      __break(0x8228u);
    v100 = ((__int64 (__fastcall *)(__int64, __int64, _QWORD, _QWORD, _QWORD))v101)(v12, v14, v15, v13, 0);
    if ( v100 )
    {
LABEL_58:
      v102 = 0;
      v103 = 0;
      v104 = v15;
      v105 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v14 + 24) + 24LL) + 8LL);
      do
      {
        if ( ((v104 >> v103) & 1) != 0 )
        {
          v106 = *(_QWORD *)(v14 + 88) + v102;
          if ( *(_QWORD *)(v106 + 32) )
          {
            v107 = *(int *)(v106 + 64);
            v108 = *(_QWORD *)(v105 + 24);
