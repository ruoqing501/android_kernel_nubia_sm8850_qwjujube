        ...
        double a9)
{
  ...
  if ( (*(_BYTE *)(*(_QWORD *)(result + 104) + 172LL) & 1) != 0 )
  {
    ...
    qdf_mc_timer_init(v9 + 3880, 0, (__int64)hdd_sar_safety_timer_cb, v9);
    if ( (unsigned int)_qdf_delayed_work_create((_QWORD *)(v9 + 4048), (__int64)hdd_sar_unsolicited_work_cb, v9) )
    {
      qdf_trace_msg(
        0x33u,
        2u,
    ...
    {
      *(_DWORD *)(v9 + 4208) = 0;
      qdf_event_create((_DWORD *)(v9 + 4168));
    }
