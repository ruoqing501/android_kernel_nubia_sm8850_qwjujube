__int64 __fastcall sme_ps_set_powersave(__int64 a1, unsigned int a2, char a3, unsigned int a4, char a5)
{
  ...
  v76[0] = 0;
  v10 = sme_acquire_global_lock(a1 + 12840);
  if ( !v10 )
  {
    qdf_trace_msg(
      0x34u,
      ...
      a4,
      a5 & 1);
    mlme_set_user_ps(*(_QWORD *)(a1 + 21624), a2, a3 & 1);
    opmode_from_vdev_id = wlan_get_opmode_from_vdev_id(*(_QWORD *)(a1 + 21632), a2);
    ...
    if ( (a3 & 1) != 0 )
    {
      ...
      {
LABEL_13:
        wlan_mlme_is_bmps_enabled(*(_QWORD *)(a1 + 21624), v76);
        if ( v76[0] == 1 )
        {
          qdf_trace_msg(
            0x34u,
...
LABEL_25:
      ...
      {
        v37 = a1 + 13192 + 192LL * (unsigned __int8)a2;
...
LABEL_29:
    ...
    if ( sme_is_session_id_valid(a1, (unsigned __int8)a2, v57, v58, v59, v60, v61, v62, v63, v64) )
    {
      if ( (unsigned __int8)a2 >= 7u )
        goto LABEL_29;
      v65 = a1 + 13192 + 192LL * (unsigned __int8)a2;
