__int64 __fastcall mlme_get_rso_disabled_bitmap(__int64 a1, __int64 a2)
{
  ...
  v22 = *(unsigned __int8 *)(ext_hdl + 156);
  qdf_trace_msg(
    0x1Fu,
    8u,
    "%s: vdev[%d] bitmap[0x%x]",
    v14,
    v15,
    v16,
    v17,
