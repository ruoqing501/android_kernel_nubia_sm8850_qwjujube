        ...
        double a10)
{
  ...
  if ( ((*(_QWORD *)(*(_QWORD *)(a1 + 104) + 8 * ((unsigned __int64)a2 >> 6) + 128) >> a2) & 1) != 0 )
  {
    ...
    if ( v14 != -1 )
    {
      ...
      if ( *(_DWORD *)(a1 + 3844) > (unsigned int)v10 )
      {
        _X9 = (unsigned __int64 *)(a1 + 3856);
        __asm { PRFM            #0x11, [X9] }
        do
          v55 = __ldxr(_X9);
            ...
            if ( *(_DWORD *)(a1 + 3712) | *(unsigned __int16 *)(a1 + 3716) )
            {
              if ( *(_DWORD *)(a1 + 3720) | *(unsigned __int16 *)(a1 + 3724) )
              {
                if ( *(_DWORD *)(a1 + 3728) | *(unsigned __int16 *)(a1 + 3732) )
                {
                  ...
                  {
                    if ( *(_DWORD *)(a1 + 3744) | *(unsigned __int16 *)(a1 + 3748) )
                    {
                      qdf_trace_msg(
                        0x33u,
                        2u,
...
LABEL_24:
  ...
  if ( *(_DWORD *)(a1 + 3848) <= v32 )
    goto LABEL_47;
  _X9 = (unsigned __int64 *)(a1 + 3864);
  __asm { PRFM            #0x11, [X9] }
  do
    v58 = __ldxr(_X9);
