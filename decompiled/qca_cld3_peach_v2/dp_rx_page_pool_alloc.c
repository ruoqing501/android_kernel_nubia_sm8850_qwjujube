...
LABEL_29:
  ...
  v22 = *(_QWORD *)(a1 + 544LL * a2 + 20560);
  if ( !v22 )
  {
    v22 = v53[0];
    if ( v53[0] )
    {
      *(_QWORD *)(a1 + 544LL * a2 + 20560) = v53[0];
      LODWORD(v5) = v22;
    }
    else
    {
      v22 = 4096;
      *(_QWORD *)(a1 + 544LL * a2 + 20560) = 4096;
    }
  }
  v23 = (unsigned int)v5;
  ...
  v25 = *(_QWORD *)(a1 + 40);
  *(_DWORD *)(a1 + 544LL * a2 + 20536) = 0;
  *(_QWORD *)(a1 + 544LL * a2 + 20544) = 0;
  *(_BYTE *)(a1 + 544LL * a2 + 20720) = 0;
  *(_QWORD *)(a1 + 544LL * a2 + 20520) = a1;
...
LABEL_26:
  *(_QWORD *)(a1 + 544LL * a2 + 20496) = 2048;
  v49[0] = 0;
  v45 = _dp_rx_page_pool_create(a1, 2048, v26, &v51, &v50, v49);
  *(_QWORD *)(a1 + 544LL * a2 + 20488) = v45;
  if ( !v45
    || (v46 = v49[0],
        *(_QWORD *)(a1 + 544LL * a2 + 20504) = v50,
        *(_QWORD *)(a1 + 544LL * a2 + 20552) = (unsigned int)v5,
        *(_BYTE *)(a1 + 544LL * a2 + 20512) = v46,
        *(_QWORD *)(a1 + 544LL * a2 + 20808) = v26 - 384,
        *(_DWORD *)(a1 + 544LL * a2 + 20816) = 0,
