__int64 __fastcall dp_tx_ext_desc_pool_init_by_id(__int64 a1, unsigned __int16 a2, unsigned __int8 a3)
{
  ...
  *(_WORD *)(v6 + 4080) = a2;
  *(_QWORD *)(v6 + 4184) = *v8;
  if ( (unsigned int)qdf_mem_multi_page_link(v7, (unsigned __int16 *)(v6 + 4144), 0x38u, a2, 1) )
  {
...
LABEL_13:
  ...
  while ( 1 )
  {
    if ( (unsigned __int16)v21 % (unsigned int)*(unsigned __int16 *)(v6 + 4096) )
    {
      v22[1] = v19[1] + *(int *)(v6 + 4084);
      v23 = v19[2] + *(int *)(v6 + 4084);
      goto LABEL_11;
    }
    if ( !**(_QWORD **)(v6 + 4104) )
      break;
...
LABEL_11:
    ...
    if ( v24 )
    {
      ...
      v19 = v22;
      v22 = v24;
      if ( v21 < *(unsigned __int16 *)(v6 + 4080) )
        continue;
    }
    goto LABEL_13;
  }
