__int64 __fastcall wlan_cm_tgt_exclude_rm_partial_scan_freq(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( v18 )
  {
    ...
    if ( v20 )
      qdf_trace_msg(
        0x68u,
        8u,
        "%s: vdev %d fail to exclude roam partial scan freq",
        v21,
        v22,
        v23,
        v24,
        ...
        v27,
        v28,
        "wlan_cm_tgt_exclude_rm_partial_scan_freq",
        v4);
    goto LABEL_13;
  }
LABEL_12:
  qdf_trace_msg(
    0x68u,
    2u,
    "%s: vdev %d send_exclude_rm_partial_scan_freq is NULL",
    v6,
    v7,
    v8,
    v9,
