__int64 __fastcall wlan_objmgr_vdev_try_get_ref(
        __int64 a1,
        unsigned int a2,
        double a3,
        double a4,
        ...
        double a10)
{
  ...
  if ( a1 )
  {
    ...
    if ( *(_DWORD *)(a1 + 1336) == 1 )
    {
      ...
      if ( (v34 & 1) != 0 )
      {
        *(_QWORD *)(a1 + 1352) = v34 & 0xFFFFFFFFFFFFFFFELL;
    ...
    else
    {
      ...
      if ( (v14 & 1) != 0 )
      {
        *(_QWORD *)(a1 + 1352) = v14 & 0xFFFFFFFFFFFFFFFELL;
        raw_spin_unlock_bh(a1 + 1344);
      }
      else
      {
      ...
      *(_BYTE *)(a1 + 169) = v24 + 1;
      if ( !v24 )
        qdf_trace_msg(
          0x57u,
          8u,
          "%s: [Ref id: %d] vdev(%d) is not in Created state(%d)",
          v16,
          v17,
          v18,
          v19,
