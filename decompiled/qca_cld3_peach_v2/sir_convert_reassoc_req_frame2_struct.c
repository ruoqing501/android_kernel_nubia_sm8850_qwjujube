__int64 __fastcall sir_convert_reassoc_req_frame2_struct(__int64 a1, __int64 a2, unsigned int a3, unsigned __int16 *a4)
{
  ...
  __int64 v90; // [xsp+0h] [xbp-50h]
  _WORD v91[2]; // [xsp+20h] [xbp-30h] BYREF
  _BYTE v92[4]; // [xsp+24h] [xbp-2Ch] BYREF
  _WORD v93[2]; // [xsp+28h] [xbp-28h] BYREF
  _BYTE v94[4]; // [xsp+2Ch] [xbp-24h] BYREF
  __int64 v95; // [xsp+30h] [xbp-20h] BYREF
  __int64 v96; // [xsp+38h] [xbp-18h] BYREF
  int v97; // [xsp+40h] [xbp-10h] BYREF
  __int16 v98; // [xsp+44h] [xbp-Ch]
      ...
      *a4 = *(_WORD *)v12 & 0x8000 | v36 & 0x7FFF;
      ...
      if ( *((_BYTE *)a4 + 3258) )
      {
        if ( *((_BYTE *)a4 + 3259) || *((_BYTE *)a4 + 3260) )
        {
          ...
          if ( v12[2592] )
          {
            qdf_mem_copy(a4 + 1740, v12 + 2592, 0x5Cu);
            qdf_trace_msg(
              0x35u,
              8u,
              "%s: Received Assoc Req with EHT Capability IE",
              v54,
              v55,
              v56,
              v57,
              ...
              v60,
              v61,
              "sir_convert_reassoc_req_frame2_eht_struct");
            ((void (__fastcall *)(__int64, __int64, unsigned __int16 *, __int64))qdf_trace_hex_dump)(
              53,
              8,
              a4 + 1740,
              92);
          }
          v62 = (unsigned __int8)v12[2684];
          v95 = 0;
          v96 = 0;
          v98 = 0;
          v97 = 0;
          ...
          if ( v62 )
          {
            if ( !(unsigned int)util_find_mlie(a2 + 10, a3 - 4, &v96, &v95) )
            {
              util_get_bvmlie_persta_partner_info(v96, v95, a4 + 1788, 255);
              util_get_bvmlie_eml_cap(v96, v95, v94, v93);
              if ( v94[0] == 1 )
              {
                v79 = (v93[0] >> 1) & 7;
                v80 = (v93[0] >> 4) & 7;
                v81 = (v93[0] >> 11) & 0xF;
                v82 = v93[0] & 1;
                a4[1876] = a4[1876] & 0x8780 | v93[0] & 0x787F;
                qdf_trace_msg(
                  0x35u,
                  8u,
              ...
              util_get_bvmlie_mldmacaddr(v96, v95, (int)&v97);
              qdf_mem_copy(a4 + 1878, &v97, 6u);
              util_get_bvmlie_mldcap(v96, v95, v92, v91);
              if ( v92[0] == 1 )
              {
                v83 = (v91[0] >> 4) & 1;
                v84 = (v91[0] >> 5) & 3;
                ...
                v86 = (v91[0] >> 12) & 1;
                v87 = v91[0] & 0xF;
                a4[1877] = a4[1877] & 0xE000 | v91[0] & 0x1FFF;
                qdf_trace_msg(
                  0x35u,
                  8u,
          ...
          LODWORD(v90) = (unsigned __int8)v12[2076];
          qdf_trace_msg(
            0x35u,
            8u,
