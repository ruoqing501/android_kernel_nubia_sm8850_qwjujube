__int64 __fastcall wlan_hdd_cfg80211_set_mon_ch(_QWORD *a1, unsigned int *a2)
{
  ...
  __int64 v138; // x21
  __int64 v139; // x19
  __int64 v140; // [xsp+0h] [xbp-30h] BYREF
  unsigned int v141; // [xsp+8h] [xbp-28h] BYREF
  __int64 v142; // [xsp+Ch] [xbp-24h]
  __int64 v143; // [xsp+14h] [xbp-1Ch]
  int v144; // [xsp+1Ch] [xbp-14h]
  int v145; // [xsp+20h] [xbp-10h] BYREF
  __int16 v146; // [xsp+24h] [xbp-Ch]
  __int64 v147; // [xsp+28h] [xbp-8h]
  ...
  if ( a1 )
  {
        ...
        & 0xFFFFFFFB) != 0 )
    {
      ...
      qdf_trace_msg(
        ...
        v72,
        "__wlan_hdd_cfg80211_set_mon_ch");
      qdf_mem_copy(&v145, (const void *)(v26 + 1617), 6u);
      v76 = *(_QWORD *)a2;
      v77 = a1[193];
      v141 = v43;
                            ...
                            v93) )
      {
        ...
        {
          v104 = jiffies;
          if ( _wlan_hdd_cfg80211_set_mon_ch___last_ticks_1194 - jiffies + 125 < 0 )
          {
            v105 = v95;
            qdf_trace_msg(
              0x33u,
              ...
              "__wlan_hdd_cfg80211_set_mon_ch");
            v95 = v105;
            _wlan_hdd_cfg80211_set_mon_ch___last_ticks_1194 = v104;
          }
          v14 = qdf_status_to_os_return(v95);
          goto LABEL_4;
        }
        *(_BYTE *)(v26 + 52194) = 1;
        qdf_mem_set(&v141, 0x18u, 0);
        v106 = _qdf_mem_malloc(0x40u, "__wlan_hdd_cfg80211_set_mon_ch", 32592);
        if ( v106 )
        {
          v115 = v106;
          *(_BYTE *)v106 = *(_BYTE *)(*(_QWORD *)(v26 + 52832) + 8LL);
          v116 = *(_QWORD *)a2;
          v141 = v43;
          ...
          *(_WORD *)(v115 + 16) = v117;
          ...
          {
            v127 = jiffies;
            if ( _wlan_hdd_cfg80211_set_mon_ch___last_ticks_1196 - jiffies + 125 < 0 )
            {
              qdf_trace_msg(
                0x33u,
                2u,
                ...
                "__wlan_hdd_cfg80211_set_mon_ch",
                v118);
              _wlan_hdd_cfg80211_set_mon_ch___last_ticks_1196 = v127;
            }
          }
          else
          {
            ...
            v118 = v128;
            v137 = jiffies;
            if ( _wlan_hdd_cfg80211_set_mon_ch___last_ticks_1198 - jiffies + 125 < 0 )
            {
              qdf_trace_msg(
                0x33u,
                2u,
                ...
                v136,
                "__wlan_hdd_cfg80211_set_mon_ch",
                *(unsigned __int8 *)(*(_QWORD *)(v26 + 52832) + 8LL));
              _wlan_hdd_cfg80211_set_mon_ch___last_ticks_1198 = v137;
            }
            if ( *(_BYTE *)(v26 + 1701) == 1 )
            {
              v138 = jiffies;
              if ( _wlan_hdd_cfg80211_set_mon_ch___last_ticks_1200 - jiffies + 125 < 0 )
              {
                qdf_trace_msg(
                  0x33u,
                  2u,
                  ...
                  v136,
                  "__wlan_hdd_cfg80211_set_mon_ch");
                _wlan_hdd_cfg80211_set_mon_ch___last_ticks_1200 = v138;
              }
            }
            else
            {
              ...
              if ( v118 == 15 )
              {
                if ( _wlan_hdd_cfg80211_set_mon_ch___last_ticks_1202 - jiffies + 125 < 0 )
                {
                  qdf_trace_msg(
                    0x33u,
                    2u,
                    ...
                    v136,
                    "__wlan_hdd_cfg80211_set_mon_ch");
                  _wlan_hdd_cfg80211_set_mon_ch___last_ticks_1202 = v139;
                }
              }
              else if ( _wlan_hdd_cfg80211_set_mon_ch___last_ticks_1204 - jiffies + 125 < 0 )
              {
                qdf_trace_msg(
                  0x33u,
                  2u,
                  ...
                  "__wlan_hdd_cfg80211_set_mon_ch",
                  v118);
                _wlan_hdd_cfg80211_set_mon_ch___last_ticks_1204 = v139;
              }
            }
          }
          *(_BYTE *)(v63 + 3042) = 0;
