...
LABEL_32:
    ...
    qdf_mtrace(51, 51, 0x2Au, *(_BYTE *)(*(_QWORD *)(a2 + 55520) + 8LL), *(_DWORD *)(a4 + 20));
...
LABEL_26:
        ...
        if ( (unsigned int)hdd_softap_change_sta_state(*(_QWORD *)(a2 + 55520), &v65, 3) )
        {
...
LABEL_28:
    ...
    vdev_by_user = _hdd_objmgr_get_vdev_by_user(*(_QWORD *)(a2 + 55520), 87, "__wlan_hdd_change_station");
    if ( !vdev_by_user )
      goto LABEL_6;
    v61 = vdev_by_user;
