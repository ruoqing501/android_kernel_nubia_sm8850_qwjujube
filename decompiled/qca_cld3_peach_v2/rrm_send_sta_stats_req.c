__int64 __fastcall rrm_send_sta_stats_req(__int64 a1, __int64 a2, const void *a3)
{
  ...
  LODWORD(v16) = *(unsigned __int8 *)(v16 + 168);
  v59[0] = 6;
  v59[1] = 0;
  HIDWORD(v61) = 1;
  ...
  *(_BYTE *)(a1 + 21568) = v16;
  ...
  v17 = _qdf_mem_malloc(0xA758u, "rrm_update_vdev_stats", 737);
  if ( !v17 )
  {
    v15 = 2;
    goto LABEL_20;
...
LABEL_21:
  ...
  qdf_trace_msg(
    ...
    v34,
    v35,
    *(unsigned int *)(v26 + 4632),
    *(unsigned int *)(v26 + 6988),
    *(_QWORD *)(v26 + 2504),
    *(unsigned int *)(v26 + 3432),
    *(unsigned int *)(v26 + 3440),
    *(_DWORD *)(v26 + 6984));
  if ( *(_BYTE *)(a1 + 21306) == 1 )
  {
    v42 = *(_DWORD *)(a1 + 21312);
    *(_DWORD *)(a1 + 21308) = *(_DWORD *)(v26 + 3432) - *(_DWORD *)(a1 + 21308);
    v43 = *(_DWORD *)(v26 + 3440) - v42;
    v44 = *(_DWORD *)(a1 + 21316);
    *(_DWORD *)(a1 + 21312) = v43;
    *(_DWORD *)(a1 + 21316) = *(_DWORD *)(v26 + 6984) - v44;
  }
  else if ( !*(_BYTE *)(a1 + 21306) )
  {
    v39 = *(_DWORD *)(a1 + 21332);
    *(_DWORD *)(a1 + 21308) = *(_DWORD *)(v26 + 4632) - *(_DWORD *)(a1 + 21308);
    v40 = *(_DWORD *)(v26 + 6988) - v39;
    v41 = *(_DWORD *)(a1 + 21312);
    *(_DWORD *)(a1 + 21332) = v40;
    *(_DWORD *)(a1 + 21312) = *(_DWORD *)(v26 + 2504) - v41;
  }
  _qdf_mem_free(v26);
  v45 = wlan_cp_stats_infra_cp_register_resp_cb(*(_QWORD *)(a1 + 21624), v59);
  if ( v45 )
  {
    v15 = v45;
    goto LABEL_20;
  }
  v48 = wlan_cp_stats_send_infra_cp_req(*(_QWORD *)(a1 + 21624), v59);
  if ( !v48 )
  {
    v15 = 0;
    goto LABEL_22;
  ...
  qdf_trace_msg(
    ...
    "rrm_send_sta_stats_req",
    v48);
  v15 = wlan_cp_stats_infra_cp_deregister_resp_cb(*(_QWORD *)(a1 + 21624));
  if ( v15 )
  {
