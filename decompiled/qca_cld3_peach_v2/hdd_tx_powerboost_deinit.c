        ...
        double a9)
{
  ...
  if ( (*(_BYTE *)(a1 + 8496) & 1) != 0 )
  {
    ...
    v10 = *(_QWORD **)(a1 + 8824);
    if ( v10 != (_QWORD *)(a1 + 8824) )
    {
      do
      {
        v11 = (_QWORD *)*v10;
        qdf_list_remove_node(a1 + 8824, v10);
        _qdf_mem_free((__int64)v10);
        v10 = v11;
      }
      while ( v11 != (_QWORD *)(a1 + 8824) );
    }
    qdf_mutex_release(a1 + 8848);
    qdf_mutex_destroy(a1 + 8848);
    if ( *(_DWORD *)(a1 + 8840) )
      qdf_trace_msg(
        0x33u,
        2u,
        ...
        v19,
        "qdf_list_destroy");
    qdf_runtime_lock_deinit((__int64 *)(a1 + 8816));
    _qdf_wake_lock_destroy(a1 + 8616);
...
LABEL_13:
      ...
      _qdf_mem_free_consistent(v20, *(_QWORD *)(v20 + 40), *(_DWORD *)(a1 + 8608));
