__int64 __fastcall _policy_mgr_is_ll_lt_sap_restart_required(__int64 a1, __int64 a2)
{
  ...
  {
    v16 = &qword_8D4F0C;
    if ( (_DWORD)qword_8D4F0C == 6 || v15 != HIDWORD(qword_8D4F0C) )
    {
      v16 = &qword_8D4F30;
      if ( (_DWORD)qword_8D4F30 == 6 || v15 != HIDWORD(qword_8D4F30) )
      {
        v16 = &qword_8D4F54;
        if ( (_DWORD)qword_8D4F54 == 6 || v15 != HIDWORD(qword_8D4F54) )
        {
          v16 = &qword_8D4F78;
          if ( (_DWORD)qword_8D4F78 == 6 || v15 != HIDWORD(qword_8D4F78) )
          {
