    ...
    *(_DWORD *)(a1 + 720) = *(_DWORD *)(v3 + 1620);
    ...
    if ( *(_DWORD *)(a1 + 2616) )
    {
      qdf_trace_msg(
        ...
        *(unsigned __int8 *)(*(_QWORD *)(v5 + 16) + 168LL));
      result = 0;
      goto LABEL_26;
    }
    if ( v42[0] != 5
      && ((policy_mgr_is_hw_dbs_capable(*(_QWORD *)v3) & 1) == 0 || !wlan_reg_is_24ghz_ch_freq(*(_DWORD *)(a1 + 1436)))
    ...
    if ( (unsigned int)policy_mgr_get_connection_count(*(_QWORD *)v3) == 2 && *(_DWORD *)(a1 + 2004) == 4 )
    {
      LODWORD(v44[0]) = 0;
      ...
      {
        if ( wlan_reg_is_24ghz_ch_freq(*(_DWORD *)(a1 + 1468)) )
          v23 = 1;
        else
          v23 = 2;
        *(_DWORD *)(a1 + 2004) = v23;
    ...
    if ( *(_DWORD *)(v5 + 728) == 2
      && policy_mgr_is_vdev_ll_lt_sap(*(_QWORD *)v3, *(unsigned __int8 *)(*(_QWORD *)(v5 + 16) + 168LL)) )
    {
      v24 = *(const void **)(a1 + 1456);
      if ( v24 )
      {
        v25 = *(unsigned __int8 *)(a1 + 1464);
        v26 = *(void **)(a1 + 1440);
        v27 = *(_QWORD *)v3;
        v28 = *(unsigned __int8 *)(a1 + 1448);
        memset(v44, 0, 40);
        v43[0] = 0;
        qdf_mem_copy(v26, v24, (unsigned int)(4 * v25));
        *(_BYTE *)(a1 + 1448) = *(_BYTE *)(a1 + 1464);
        ...
        if ( v29 )
        {
          ...
          if ( !(unsigned int)policy_mgr_get_pcl_ch_list_for_ll_sap(
                                ...
                                *(unsigned __int8 *)(v5 + 12),
                                ...
                                v43) )
          {
            wlan_hdd_trim_acs_channel_list(v30, *(unsigned int *)(v30 + 512), *(_QWORD *)(a1 + 1440), a1 + 1448);
            if ( v28 != *(unsigned __int8 *)(a1 + 1448) )
              sap_dump_acs_channel(a1 + 1424);
          }
          _qdf_mem_free(v30);
        }
      }
