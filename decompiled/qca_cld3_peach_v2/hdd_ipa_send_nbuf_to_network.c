        ...
        double a10)
{
  ...
  {
    vdev_by_user = _hdd_objmgr_get_vdev_by_user(*(_QWORD *)(a2 + 55520), 0x61u, (__int64)"hdd_ipa_send_nbuf_to_network");
    if ( vdev_by_user )
    {
      v29 = vdev_by_user;
  ...
  qdf_dp_trace_log_pkt(*(unsigned __int8 *)(*(_QWORD *)(a2 + 55520) + 8LL), a1, 1u, 0xFFu, *(_DWORD *)(a2 + 2728));
  ...
  v44 = *(_QWORD *)(a2 + 2720);
  *(_QWORD *)(a1 + 16) = v44;
  v45 = eth_type_trans(a1, v44);
  v46 = *(_BYTE *)(a1 + 128);
  v47 = *(_DWORD *)(a1 + 112);
  *(_WORD *)(a1 + 180) = v45;
  *(_BYTE *)(a1 + 128) = v46 & 0x9F;
  if ( (ipa_get_lan_rx_napi(v45) & 1) != 0 )
    v48 = netif_receive_skb(a1);
  else
    v48 = netif_rx(a1);
  result = ((__int64 (__fastcall *)(_QWORD, _QWORD, bool))ucfg_dp_inc_rx_pkt_stats)(
             *(_QWORD *)(*(_QWORD *)(a2 + 55520) + 32LL),
             v47,
             v48 == 0);
  if ( (v43 & 1) == 0 )
    v42[188] = 0;
