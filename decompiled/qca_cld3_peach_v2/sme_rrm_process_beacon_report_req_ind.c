__int64 __fastcall sme_rrm_process_beacon_report_req_ind(_QWORD *a1, __int64 a2)
{
  ...
  if ( v2 >= 6 )
    goto LABEL_92;
  v5 = (unsigned __int8 *)a1 + 17482;
  v6 = (unsigned __int16 *)&a1[68 * (unsigned int)v2 + 2186];
  ...
  if ( (unsigned int)v109 > 5 || !(a1[2162] + 96LL * (unsigned int)v109) )
  {
    qdf_trace_msg(
      0x34u,
      2u,
  ...
  if ( wlan_reg_is_6ghz_op_class(a1[2704], *(_BYTE *)(a2 + 32)) )
  {
    v25 = 4;
    v111 = 4;
  }
  ...
  if ( *(_BYTE *)(a2 + 33) && (*(unsigned __int8 *)(a2 + 33) != 255 || *(_BYTE *)(a2 + 92)) )
  {
    ...
    *((_QWORD *)v6 + 8) = v48;
    if ( v48 )
    {
      ...
      {
        v58 = *(_DWORD *)(a2 + 36);
        if ( (((__int64 (__fastcall *)(__int64, _QWORD))wlan_roam_is_channel_valid)(a1[1] + 5972LL, v58) & 1) != 0 )
        {
          *v57 = v58;
          v59 = 1;
LABEL_44:
          if ( !*(_BYTE *)(a2 + 92) )
            goto LABEL_69;
          v69 = *(_DWORD *)(a2 + 96);
          if ( (((__int64 (__fastcall *)(__int64, _QWORD))wlan_roam_is_channel_valid)(a1[1] + 5972LL, v69) & 1) != 0 )
            v57[v59++] = v69;
          if ( *(unsigned __int8 *)(a2 + 92) < 2u )
            goto LABEL_69;
          v70 = *(_DWORD *)(a2 + 100);
          if ( (((__int64 (__fastcall *)(__int64, _QWORD))wlan_roam_is_channel_valid)(a1[1] + 5972LL, v70) & 1) != 0 )
            v57[v59++] = v70;
          if ( *(unsigned __int8 *)(a2 + 92) < 3u )
            goto LABEL_69;
          v71 = *(_DWORD *)(a2 + 104);
          if ( (((__int64 (__fastcall *)(__int64, _QWORD))wlan_roam_is_channel_valid)(a1[1] + 5972LL, v71) & 1) != 0 )
            v57[v59++] = v71;
          if ( *(unsigned __int8 *)(a2 + 92) < 4u )
            goto LABEL_69;
          v72 = *(_DWORD *)(a2 + 108);
          if ( (((__int64 (__fastcall *)(__int64, _QWORD))wlan_roam_is_channel_valid)(a1[1] + 5972LL, v72) & 1) != 0 )
            v57[v59++] = v72;
          if ( *(unsigned __int8 *)(a2 + 92) < 5u )
            goto LABEL_69;
          v73 = *(_DWORD *)(a2 + 112);
          if ( (((__int64 (__fastcall *)(__int64, _QWORD))wlan_roam_is_channel_valid)(a1[1] + 5972LL, v73) & 1) != 0 )
            v57[v59++] = v73;
          if ( *(unsigned __int8 *)(a2 + 92) < 6u )
            goto LABEL_69;
          v74 = *(_DWORD *)(a2 + 116);
          if ( (((__int64 (__fastcall *)(__int64, _QWORD))wlan_roam_is_channel_valid)(a1[1] + 5972LL, v74) & 1) != 0 )
            v57[v59++] = v74;
          if ( *(unsigned __int8 *)(a2 + 92) < 7u )
            goto LABEL_69;
          v75 = *(_DWORD *)(a2 + 120);
          if ( (((__int64 (__fastcall *)(__int64, _QWORD))wlan_roam_is_channel_valid)(a1[1] + 5972LL, v75) & 1) != 0 )
            v57[v59++] = v75;
          if ( *(unsigned __int8 *)(a2 + 92) < 8u )
            goto LABEL_69;
          v76 = *(_DWORD *)(a2 + 124);
          if ( (((__int64 (__fastcall *)(__int64, _QWORD))wlan_roam_is_channel_valid)(a1[1] + 5972LL, v76) & 1) != 0 )
          {
            v57[v59] = v76;
            LOBYTE(v59) = v59 + 1;
          }
