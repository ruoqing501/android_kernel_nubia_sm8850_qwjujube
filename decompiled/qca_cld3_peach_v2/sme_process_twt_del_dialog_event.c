__int64 __fastcall sme_process_twt_del_dialog_event(_QWORD *a1, unsigned int *a2)
{
  ...
  if ( !(_DWORD)result )
  {
    if ( opmode_from_vdev_id )
    {
      ...
      {
        v6 = (void (__fastcall *)(__int64, unsigned int *))a1[1814];
        if ( v6 )
        {
          v7 = a1[2703];
    ...
    else
    {
      ...
      if ( (((__int64 (__fastcall *)(__int64, unsigned int *, __int64, __int64, int *))mlme_twt_is_command_in_progress)(
        ...
        || a2[4] - 7 < 3 )
      {
        if ( (mlme_get_user_ps(a1[2703], *a2) & 1) == 0 && !a2[4] )
          a2[4] = 12;
        v21 = (void (__fastcall *)(__int64, unsigned int *))a1[1814];
        if ( v21 )
        {
          v22 = a1[2703];
        ...
        if ( (a2[4] & 0xFFFFFFFE) == 8 )
          mlme_twt_set_wait_for_notify(a1[2703], *a2, 1);
        mlme_set_twt_command_in_progress(a1[2703], a2 + 1, a2[3], 0);
        if ( a2[4] - 1 >= 6 )
          ((void (__fastcall *)(_QWORD, unsigned int *, _QWORD))mlme_init_twt_context)(a1[2703], a2 + 1, a2[3]);
      }
      else
      {
        qdf_trace_msg(
    ...
    result = qdf_mutex_release((__int64)(a1 + 1606));
  }
