...
LABEL_18:
        ...
        if ( v28 != 2 )
        {
          if ( v28 == 1 )
            goto LABEL_18;
LABEL_71:
          if ( !*(_BYTE *)(a1 + 14881) && HIWORD(v103) )
          {
            sch_set_fixed_beacon_fields(a1, v16);
            qdf_trace_msg(
              0x35u,
              8u,
...
LABEL_64:
      ...
      if ( *(_DWORD *)(v16 + 7232) == 2 )
      {
        if ( !*(_BYTE *)(v16 + 155) )
        {
          ...
          if ( *(_BYTE *)(a4 + 2475) )
          {
            if ( (*(_BYTE *)(*(_QWORD *)(a1 + 8) + 3532LL) & 1) != 0 || (*(_BYTE *)(a4 + 1132) & 3) == 0 )
              goto LABEL_71;
          }
          ...
          if ( (wlan_cm_get_ese_assoc(*(_QWORD *)(a1 + 21632), *(_BYTE *)(v16 + 10)) & 1) != 0 )
            qdf_trace_msg(
              0x35u,
              4u,
