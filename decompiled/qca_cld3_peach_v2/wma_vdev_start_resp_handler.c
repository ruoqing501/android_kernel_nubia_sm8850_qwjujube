                ...
                if ( !*((_DWORD *)a2 + 2) )
                {
                  ...
                  qdf_trace_msg(
                    ...
                    *((unsigned int *)a2 + 4),
                    ...
                    0,
                    0);
                  qdf_mem_copy(*(void **)(*(_QWORD *)v44 + 32LL), *(const void **)(*(_QWORD *)v44 + 40LL), 0x28u);
                  wma_set_and_update_mac_id(v40, context, a1, a2, v21, v46);
                }
...
LABEL_51:
                ...
                if ( !cmpt_obj )
                  goto LABEL_36;
                v65 = cmpt_obj;
                *(_DWORD *)(cmpt_obj + 132) = *((_DWORD *)a2 + 9);
                *(_BYTE *)(cmpt_obj + 137) = *((_DWORD *)a2 + 10);
                qdf_trace_msg(
                  0x36u,
                  8u,
                  ...
                  *((unsigned int *)a2 + 10));
                v74 = v44[41] != 2
                   || (unsigned int)mlme_get_assoc_type(*(_QWORD *)(a1 + 520), v66, v67, v68, v69, v70, v71, v72, v73) < 2;
...
LABEL_31:
                  ...
                  if ( (unsigned int)(*(_DWORD *)(v42 + 6796) - 1) > 3 )
                    goto LABEL_51;
                  v84 = *(_QWORD *)v40;
                  if ( !(unsigned int)_wmi_validate_handle(
                                        ...
                                        v38) )
                  {
                    if ( (unsigned int)(*(_DWORD *)(v42 + 6796) - 1) >= 4 )
                    {
...
LABEL_36:
                ...
                if ( v93 != 6 )
                {
                  if ( v93 != 4 && (v93 != 2 || !v74) )
                  {
                    ...
                    qdf_mem_copy((void *)(v65 + 184), &v104, 6u);
                    wma_vdev_start_rsp(v40, *(_QWORD *)(a1 + 520), a2);
                    goto LABEL_31;
                  }
                  goto LABEL_30;
                }
