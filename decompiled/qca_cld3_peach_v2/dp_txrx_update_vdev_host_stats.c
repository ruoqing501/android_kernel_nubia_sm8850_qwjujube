          ...
          while ( 1 )
          {
            ...
            if ( !a5 )
            {
              ...
              *(_DWORD *)(v19 + 656) = v38;
              ...
              LODWORD(v37) = *(_DWORD *)(v19 + 664);
              *(_DWORD *)(v19 + 660) = v38;
              LODWORD(v38) = v37 + *(_DWORD *)(a3 + 256);
              LODWORD(v37) = *(_DWORD *)(v19 + 668);
              *(_DWORD *)(v19 + 664) = v38;
...
LABEL_27:
    ...
    if ( (v39 & 1) != 0 )
    {
      *(_QWORD *)(a1 + 18992) = v39 & 0xFFFFFFFFFFFFFFFELL;
      raw_spin_unlock_bh(a1 + 18984);
    }
    else
    {
