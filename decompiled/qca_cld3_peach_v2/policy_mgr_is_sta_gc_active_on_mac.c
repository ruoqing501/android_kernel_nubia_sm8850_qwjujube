__int64 __fastcall policy_mgr_is_sta_gc_active_on_mac(__int64 a1, unsigned __int8 a2)
{
  ...
  unsigned int v21; // [xsp+10h] [xbp-10h]
  ...
  v13 = context;
  v14 = a2;
  v15 = policy_mgr_mode_specific_connection_count(a1, 0, &v19);
    ...
    if ( v15 != 1 )
    {
      ...
      if ( v15 != 2 )
      {
        if ( (unsigned int)v20 > 4 )
          goto LABEL_33;
        if ( *((unsigned __int8 *)&pm_conc_connection_list + 36 * (unsigned int)v20 + 12) == v14 )
          goto LABEL_28;
        if ( v15 != 3 )
        {
          if ( HIDWORD(v20) > 4 )
            goto LABEL_33;
          if ( *((unsigned __int8 *)&pm_conc_connection_list + 36 * HIDWORD(v20) + 12) == v14 )
            goto LABEL_28;
          if ( v15 != 4 )
          {
            if ( v21 > 4 )
              goto LABEL_33;
            if ( *((unsigned __int8 *)&pm_conc_connection_list + 36 * v21 + 12) == v14 )
              goto LABEL_28;
            if ( v15 != 5 )
LABEL_33:
              JUMPOUT(0x28D64C);
  ...
  v16 = policy_mgr_mode_specific_connection_count(a1, 2, &v19);
  v17 = qdf_mutex_acquire(v13 + 56);
  if ( !v16 )
  {
LABEL_10:
    qdf_mutex_release(v13 + 56);
