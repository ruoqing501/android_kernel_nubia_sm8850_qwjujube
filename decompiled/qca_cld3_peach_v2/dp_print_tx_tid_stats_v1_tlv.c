__int64 __fastcall dp_print_tx_tid_stats_v1_tlv(__int64 a1)
{
  __int64 v2; // x0
  double v3; // d0
  double v4; // d1
  ...
  v2 = _qdf_mem_malloc(0x3E8u, "dp_print_tx_tid_stats_v1_tlv", 948);
  if ( !v2 )
    return qdf_trace_msg(
             ...
             v9,
             v10,
             "dp_print_tx_tid_stats_v1_tlv");
  v11 = (char *)v2;
  DP_PRINT_STATS("HTT_TX_TID_STATS_V1_TLV:", v3, v4, v5, v6, v7, v8, v9, v10);
  ...
  DP_PRINT_STATS("max_qdepth_bytes = %u", v50, v51, v52, v53, v54, v55, v56, v57, *(unsigned int *)(a1 + 24));
  DP_PRINT_STATS("max_qdepth_n_msdus = %u", v58, v59, v60, v61, v62, v63, v64, v65, *(unsigned int *)(a1 + 28));
  DP_PRINT_STATS("rsvd = %u", v66, v67, v68, v69, v70, v71, v72, v73, *(unsigned int *)(a1 + 32));
