    ...
    if ( (unsigned int)wlan_mlme_get_sap_get_peer_info(*a1, v102) )
    {
      ...
      if ( hdd_get_connected_station_info_ex___last_ticks_137 - jiffies + 125 < 0 )
      {
        qdf_trace_msg(
          ...
          v100,
          v101);
        hdd_get_connected_station_info_ex___last_ticks_137 = v42;
      }
    }
    if ( v102[0] != 1 )
    {
...
LABEL_26:
      ...
      if ( !v53 )
      {
        ...
        if ( hdd_get_connected_station_info_ex___last_ticks_138 - jiffies + 125 < 0 )
        {
          qdf_trace_msg(
            ...
            v30,
            "hdd_get_connected_station_info_ex");
          hdd_get_connected_station_info_ex___last_ticks_138 = v65;
        }
        v33 = -12;
        goto LABEL_77;
      }
      ...
      {
        v64 = jiffies;
        if ( hdd_get_connected_station_info_ex___last_ticks_139 - jiffies + 125 < 0 )
        {
          qdf_trace_msg(
            0x33u,
            2u,
            ...
            v63,
            "hdd_get_connected_station_info_ex");
          hdd_get_connected_station_info_ex___last_ticks_139 = v64;
        }
      }
      else
      {
        if ( v102[0] != 1 || !(unsigned int)hdd_add_peer_stats(v54, v22) )
        {
          if ( *((_BYTE *)v22 + 152) )
          {
            ...
            {
              v88 = jiffies;
              if ( hdd_get_connected_station_info_ex___last_ticks_142 - jiffies + 125 < 0 )
              {
                qdf_trace_msg(
                  0x33u,
                  2u,
                  ...
                  v87,
                  "hdd_get_connected_station_info_ex");
                hdd_get_connected_station_info_ex___last_ticks_142 = v88;
              }
              goto LABEL_75;
            }
            if ( *((_DWORD *)v22 + 35) >= 4u )
            {
              v98 = jiffies;
              if ( hdd_get_connected_station_info_ex___last_ticks_144 - jiffies + 125 < 0 )
              {
                qdf_trace_msg(
                  0x33u,
                  2u,
                  ...
                  v87,
                  "hdd_get_connected_station_info_ex");
                hdd_get_connected_station_info_ex___last_ticks_144 = v98;
              }
              goto LABEL_75;
            }
            v103 = *((_DWORD *)v22 + 35);
            ...
            {
              v97 = jiffies;
              if ( hdd_get_connected_station_info_ex___last_ticks_146 - jiffies + 125 < 0 )
              {
                qdf_trace_msg(
                  0x33u,
                  2u,
                  ...
                  v96,
                  "hdd_get_connected_station_info_ex");
                hdd_get_connected_station_info_ex___last_ticks_146 = v97;
              }
              goto LABEL_75;
            }
          }
...
LABEL_77:
        ...
        if ( hdd_get_connected_station_info_ex___last_ticks_141 - jiffies + 125 < 0 )
        {
          qdf_trace_msg(
            ...
            v73,
            "hdd_get_connected_station_info_ex");
          hdd_get_connected_station_info_ex___last_ticks_141 = v74;
        }
      }
LABEL_75:
