__int64 __fastcall wmi_interface_logging_init(__int64 a1, int a2)
{
  ...
  *(_QWORD *)(a1 + 688) = dir;
  ...
  {
    v14 = dir;
    entry = qdf_debugfs_create_entry(wmi_debugfs_infos, 420, dir, a1, off_128C0);
    *(_QWORD *)(a1 + 776) = entry;
    if ( !entry )
      goto LABEL_11;
    v24 = qdf_debugfs_create_entry(off_128C8, 420, v14, a1, off_128D0);
    *(_QWORD *)(a1 + 784) = v24;
    if ( !v24 )
      goto LABEL_11;
    v25 = qdf_debugfs_create_entry(off_128D8, 420, v14, a1, off_128E0);
    *(_QWORD *)(a1 + 792) = v25;
    if ( !v25 )
      goto LABEL_11;
    v26 = qdf_debugfs_create_entry(off_128E8, 420, v14, a1, off_128F0);
    *(_QWORD *)(a1 + 800) = v26;
    if ( !v26 )
      goto LABEL_11;
    v27 = qdf_debugfs_create_entry(off_128F8, 420, v14, a1, off_12900);
    *(_QWORD *)(a1 + 808) = v27;
    if ( !v27 )
      goto LABEL_11;
    v28 = qdf_debugfs_create_entry(off_12908, 420, v14, a1, off_12910);
    *(_QWORD *)(a1 + 816) = v28;
    if ( !v28
      || (v29 = qdf_debugfs_create_entry(off_12918, 420, v14, a1, off_12920), (*(_QWORD *)(a1 + 824) = v29) == 0)
      || (v30 = qdf_debugfs_create_entry(off_12928, 420, v14, a1, off_12930), (*(_QWORD *)(a1 + 832) = v30) == 0)
      || (result = qdf_debugfs_create_entry(off_12938, 420, v14, a1, off_12940), (*(_QWORD *)(a1 + 840) = result) == 0) )
    {
LABEL_11:
      qdf_trace_msg(
        0x31u,
