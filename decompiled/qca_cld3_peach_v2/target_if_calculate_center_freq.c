        ...
        double a12)
{
  ...
  __int64 result; // x0
  const char *v16; // x2
  unsigned __int16 *v17[2]; // [xsp+0h] [xbp-10h] BYREF

  v17[1] = *(unsigned __int16 **)(_ReadStatusReg(SP_EL0) + 1808);
  if ( !a2 )
  {
    qdf_trace_msg(
      0x56u,
...
LABEL_12:
  ...
  v13 = *a1;
  v17[0] = nullptr;
  if ( (wlan_reg_get_5g_bonded_channel_and_state_for_pwrmode(v13, a3, v12, v17, 0, 0, a5, a6, a7, a8, a9, a10, a11, a12)
      & 0xFFFFFFFB) == 0 )
  {
  ...
  result = 0;
  *a4 = (*(unsigned __int16 *)((char *)v17[0] + (unsigned __int64)&off_0 + 2) + (unsigned int)*v17[0]) >> 1;
LABEL_13:
