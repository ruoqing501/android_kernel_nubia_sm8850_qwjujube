__int64 __fastcall wlan_hdd_handle_single_ch_in_acs_list(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 1436) = v5;
  v6 = *v4;
  *(_DWORD *)(a1 + 1988) = *v4;
  if ( v6 <= (unsigned int)wlan_reg_ch_to_freq(0xDu) && *(_WORD *)(a1 + 1466) && !v44 )
  {
    *(_WORD *)(a1 + 1466) = 0;
    qdf_trace_msg(
      0x33u,
  ...
  v15 = sap_config_acs_result(v3[2], *(_QWORD *)(a1 + 272), *(unsigned int *)(a1 + 1992));
  v16 = *(_DWORD *)(a1 + 1992);
  *(_DWORD *)(a1 + 728) = *(unsigned __int16 *)(a1 + 1466);
  *(_BYTE *)(a1 + 732) = wlan_reg_freq_to_chan(v3[1], v16, v15, v17, v18, v19, v20, v21, v22, v23);
  *(_BYTE *)(a1 + 733) = wlan_reg_freq_to_chan(v3[1], *(_DWORD *)(a1 + 1996), v24, v25, v26, v27, v28, v29, v30, v31);
  v40 = wlan_reg_freq_to_chan(v3[1], *(_DWORD *)(a1 + 2000), v32, v33, v34, v35, v36, v37, v38, v39);
  v41 = *(_DWORD *)(a1 + 1996);
  v42 = *(_DWORD *)(a1 + 2000);
  *(_BYTE *)(a1 + 734) = v40;
  *(_DWORD *)(a1 + 736) = v41;
