        ...
        double a10)
{
  ...
  result = csr_ll_peek_head((__int64)&unk_91F2E0, 0, a3, a4, a5, a6, a7, a8, a9, a10);
  if ( result )
  {
    v21 = 0;
    v22 = 0;
    ...
    while ( 1 )
    {
      do
      {
        ...
        v26 = result;
        v27 = v24;
        result = csr_ll_next((__int64)&unk_91F2E0, result, 0, v13, v14, v15, v16, v17, v18, v19, v20);
        v24 = v27;
      }
...
LABEL_21:
      ...
      *(_QWORD *)v96 = *(_QWORD *)(v26 + 32);
      ...
      if ( v55 )
      {
        ...
        *(_WORD *)(v55 + 141) = 0;
        *(_BYTE *)(v55 + 143) = 0;
        csr_ll_insert_head(qword_91F2D8 + 3040LL * a2 + 2944, (__int64 *)v55, 1, v56, v57, v58, v59, v60, v61, v62, v63);
        qdf_trace_msg(
          0x34u,
          8u,
...
LABEL_22:
      qdf_trace_msg(
        ...
        v26,
        *(unsigned int *)(v26 + 24));
      csr_ll_remove_entry((__int64)&unk_91F2E0, (__int64 *)v26, 1, v84, v85, v86, v87, v88, v89, v90, v91);
      _qdf_mem_free(v26);
      result = v95;
      v24 = v27;
    }
