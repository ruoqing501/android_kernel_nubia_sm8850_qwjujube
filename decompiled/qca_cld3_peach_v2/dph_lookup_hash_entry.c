        ...
        __int64 a12)
{
  ...
  if ( *(_QWORD *)a12 )
  {
    ...
    if ( result )
    {
      while ( v12 != *(unsigned __int8 *)(result + 350)
           || v13 != *(unsigned __int8 *)(result + 351)
           || v14 != *(unsigned __int8 *)(result + 352)
           || v15 != *(unsigned __int8 *)(result + 353)
           || v16 != *(unsigned __int8 *)(result + 354)
           || v17 != *(unsigned __int8 *)(result + 355) )
      {
