__int64 __fastcall tdls_update_6g_power(__int64 a1, __int64 a2, char a3)
{
  ...
  if ( (a3 & 1) != 0 )
  {
    ...
    *(_BYTE *)(a2 + 626) = mlme_ch_power;
    qdf_trace_msg(
      ...
      *(unsigned __int8 *)(a2 + 627),
      *(unsigned __int8 *)(v30 + 548),
      mlme_ch_power);
    v50 = *(unsigned __int8 *)(v30 + 548);
  }
  else
  {
    if ( (*(_BYTE *)(a2 + 627) & 0xFE) == 2 )
      return result;
    qdf_trace_msg(
      0,
      8u,
      ...
      v16,
      "tdls_update_6g_power",
      *(unsigned __int8 *)(result + 548));
    v50 = *(unsigned __int8 *)(a2 + 627);
    *(_BYTE *)(v30 + 548) = v50;
  }
  v51 = *(unsigned __int8 *)(v30 + 549);
  if ( v50 == 3 )
  {
  ...
  {
    _6g_pwr_for_power_type = *(unsigned __int8 *)(a2 + 626);
  }
  if ( !v51 )
    goto LABEL_34;
...
LABEL_34:
  ...
  v53 = 0;
LABEL_32:
  *(_WORD *)(v30 + 652 + 8 * v53 + 4) = (unsigned __int8)_6g_pwr_for_power_type;
LABEL_35:
