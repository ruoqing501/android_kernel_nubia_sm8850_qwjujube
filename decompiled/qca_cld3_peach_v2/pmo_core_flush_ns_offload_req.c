__int64 __fastcall pmo_core_flush_ns_offload_req(
        __int64 a1,
        double a2,
        double a3,
        double a4,
        ...
        double a9)
{
  ...
  qdf_trace_msg(0x4Du, 8u, "%s: enter", a2, a3, a4, a5, a6, a7, a8, a9, "pmo_core_flush_ns_offload_req");
  if ( a1 )
  {
    ...
    if ( !ref )
    {
      ...
      {
        if ( (pmo_core_is_vdev_supports_offload(a1, v27, v28, v29, v30, v31, v32, v33, v34) & 1) != 0 )
        {
          ...
          else
          {
            qdf_trace_msg(
              0x4Du,
              8u,
              "%s: Flush ns offload on vdev id: %d vdev: %pK",
              v44,
              v45,
              v46,
              v47,
            ...
            qdf_trace_msg(
              ...
              v58,
              v59,
              "pmo_core_flush_ns_from_vdev_priv");
            ...
            qdf_mem_set((void *)(v61 + 20), 0x28Cu, 0);
            v63 = *(_QWORD *)(v61 + 1064);
            *(_BYTE *)(v61 + 20) = 0;
            *(_BYTE *)(v61 + 668) = 0;
            if ( (v63 & 1) != 0 )
  ...
  qdf_trace_msg(0x4Du, 8u, "%s: exit", v19, v20, v21, v22, v23, v24, v25, v26, "pmo_core_flush_ns_offload_req");
  return ref;
}
