__int64 __fastcall lim_check_aid_and_delete_peer(__int64 result, __int64 a2)
{
  __int64 v3; // x20
  __int64 v4; // x26
  __int64 v5; // x27
  ...
  do
  {
    ...
    do
    {
      if ( (v7 & (1 << v9)) != 0 )
      {
        hash_entry = (unsigned __int8 *)dph_get_hash_entry(v3, (unsigned __int16)v8 + (unsigned __int16)v9, a2 + 360);
        if ( hash_entry )
        {
          v27 = hash_entry;
          qdf_trace_msg(
          ...
          if ( !wlan_cm_is_vdev_roam_sync_inprogress(*(_QWORD *)(a2 + 16), v28, v29, v30, v31, v32, v33, v34, v35) )
            lim_send_deauth_mgmt_frame(v3, 3u, v27 + 350, a2, 0, v36, v37, v38, v39, v40, v41, v42, v43);
          qdf_mem_copy(&v62, v27 + 350, 6u);
          v65 = v63;
          v64 = v62;
          WORD2(v61) = 0;
          v52 = dph_lookup_hash_entry(
                  ...
                  (_WORD *)&v61 + 2,
                  a2 + 360);
          if ( v52 && *(_BYTE *)(v52 + 356) == 4 )
            lim_del_sta(v3, v52, 0, a2);
          else
            qdf_trace_msg(
              0x35u,
              8u,
              ...
              HIBYTE(v65),
              v61);
          dph_delete_hash_entry(v10, v11, v12, v13, v14, v15, v16, v17, v3, v27 + 350, *((_WORD *)v27 + 174), a2 + 360);
        }
        result = lim_release_peer_idx(v18, v19, v20, v21, v22, v23, v24, v25, v3, v8 + v9, a2);
