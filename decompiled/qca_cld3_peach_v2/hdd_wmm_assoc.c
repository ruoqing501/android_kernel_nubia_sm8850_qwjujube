        ...
        double a11)
{
  ...
  if ( (a2 & 1) == 0 )
  {
    ...
    if ( (a3 & 1) != 0 )
    {
      ...
      sme_enable_uapsd_for_ac(3, 7, 7, v29, v28, 3, 1, *(unsigned __int8 *)(*(_QWORD *)(a1 + 52832) + 8LL), v27);
      if ( (a3 & 2) == 0 )
      {
LABEL_6:
        if ( (a3 & 4) == 0 )
...
LABEL_26:
          ...
          else
          {
            ...
            {
              sme_enable_uapsd_for_ac(1, 3, 3, v29, v28, 3, 1, *(unsigned __int8 *)(*(_QWORD *)(a1 + 52832) + 8LL), v27);
              goto LABEL_8;
            }
...
LABEL_21:
    ...
    sme_enable_uapsd_for_ac(2, 5, 5, v29, v28, 3, 1, *(unsigned __int8 *)(*(_QWORD *)(a1 + 52832) + 8LL), v27);
    if ( (a3 & 4) == 0 )
      goto LABEL_7;
    goto LABEL_21;
  }
