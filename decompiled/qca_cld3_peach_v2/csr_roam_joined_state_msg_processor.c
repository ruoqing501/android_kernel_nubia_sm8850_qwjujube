  ...
  else
  {
    if ( v12 == 5158 )
    {
      ...
      if ( a1[2162] + 96LL * v23 )
      {
        ...
        {
          v25 = v24;
          opmode_from_vdev_id = wlan_get_opmode_from_vdev_id(a1[2704], v23);
          *(_DWORD *)(v25 + 32) = 0;
          ...
          *(_QWORD *)(v25 + 80) = a2 + 275;
          ...
          qdf_mem_copy((void *)(v25 + 352), (char *)a2 + 2769, 6u);
          ...
          *(_BYTE *)(v25 + 273) = *((_BYTE *)a2 + 2767);
          if ( (v27 & 0xFFFFFFFD) == 1 )
          {
            ...
            *(_DWORD *)(a1[2162] + 96LL * v23 + 4) = 4;
            *(_BYTE *)(v25 + 16) = *((_BYTE *)a2 + 2600) != 0;
            *(_BYTE *)(v25 + 376) = *((_BYTE *)a2 + 2768);
            *(_BYTE *)(v25 + 377) = *((_BYTE *)a2 + 2775);
            *(_WORD *)(v25 + 378) = a2[1388];
            if ( a1 && (v46 = a1[2162]) != 0 && (*(_BYTE *)(v46 + 96LL * v23 + 1) & 1) != 0 )
            {
              wlan_get_operation_chan_freq_vdev_id(a1[2704], v23);
              v47 = (_DWORD *)a1[2755];
              if ( v47 )
              {
                v48 = a1[2703];
