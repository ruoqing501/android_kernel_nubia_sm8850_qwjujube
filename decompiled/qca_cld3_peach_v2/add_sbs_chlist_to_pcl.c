...
LABEL_48:
          ...
          {
            v34 = (char *)&qword_8D4F0C + 4;
            if ( !wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_8D4F0C)) )
            {
              v35 = HIDWORD(qword_8D4F0C);
              if ( HIDWORD(qword_8D4F0C) < v31 )
                goto LABEL_8;
            }
            if ( BYTE4(qword_8D4F48) == 1 )
            {
              v34 = (char *)&qword_8D4F30 + 4;
              if ( !wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_8D4F30)) )
              {
                v35 = HIDWORD(qword_8D4F30);
                if ( HIDWORD(qword_8D4F30) < v31 )
                  goto LABEL_8;
              }
              if ( BYTE4(qword_8D4F6C) == 1 )
              {
                v34 = (char *)&qword_8D4F54 + 4;
                if ( wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_8D4F54))
                  || (v35 = HIDWORD(qword_8D4F54), HIDWORD(qword_8D4F54) >= v31) )
                {
                  if ( BYTE4(qword_8D4F90) == 1 )
                  {
                    v34 = (char *)&qword_8D4F78 + 4;
                    v37 = 0;
                    ...
                    v35 = HIDWORD(qword_8D4F78);
                    v36 = v75;
                    if ( HIDWORD(qword_8D4F78) >= v31 )
                      goto LABEL_49;
                    goto LABEL_9;
                  }
                  goto LABEL_47;
        ...
        if ( (a11 & 0xFFFFFFFE) != 6 )
        {
            ...
            if ( BYTE4(qword_8D4F00) )
            {
              if ( !wlan_reg_is_24ghz_ch_freq(HIDWORD(pm_conc_connection_list))
                ...
                && (!wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_8D4F0C))
                 && (v44 = HIDWORD(qword_8D4F0C), HIDWORD(qword_8D4F0C) > v31)
                 || BYTE4(qword_8D4F48) == 1
                 && (!wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_8D4F30))
                  && (v44 = HIDWORD(qword_8D4F30), HIDWORD(qword_8D4F30) > v31)
                  || BYTE4(qword_8D4F6C) == 1
                  && (!wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_8D4F54))
                   && (v44 = HIDWORD(qword_8D4F54), HIDWORD(qword_8D4F54) > v31)
                   || BYTE4(qword_8D4F90) == 1
                   && !wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_8D4F78))
                   && (v44 = HIDWORD(qword_8D4F78), HIDWORD(qword_8D4F78) > v31)))) )
              {
          ...
          else if ( a11 == 8 )
          {
            if ( BYTE4(qword_8D4F00) )
            {
              if ( !wlan_reg_is_24ghz_ch_freq(HIDWORD(pm_conc_connection_list))
                ...
                || BYTE4(qword_8D4F24) == 1
                && (!wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_8D4F0C))
                 && (v43 = HIDWORD(qword_8D4F0C), HIDWORD(qword_8D4F0C) < v31)
                 || BYTE4(qword_8D4F48) == 1
                 && (!wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_8D4F30))
                  && (v43 = HIDWORD(qword_8D4F30), HIDWORD(qword_8D4F30) < v31)
                  || BYTE4(qword_8D4F6C) == 1
                  && (!wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_8D4F54))
                   && (v43 = HIDWORD(qword_8D4F54), HIDWORD(qword_8D4F54) < v31)
                   || BYTE4(qword_8D4F90) == 1
                   && !wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_8D4F78))
                   && (v43 = HIDWORD(qword_8D4F78), HIDWORD(qword_8D4F78) < v31)))) )
              {
          ...
          else
          {
            if ( BYTE4(qword_8D4F00) )
            {
              ...
              if ( BYTE4(qword_8D4F24) == 1 )
              {
                result = wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_8D4F0C));
                if ( (result & 1) == 0 )
                {
                  v45 = HIDWORD(qword_8D4F0C);
                  if ( HIDWORD(qword_8D4F0C) < v31 )
                    goto LABEL_46;
                }
                if ( BYTE4(qword_8D4F48) == 1 )
                {
                  if ( (result = wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_8D4F30)), (result & 1) == 0)
                    && (v45 = HIDWORD(qword_8D4F30), HIDWORD(qword_8D4F30) < v31)
                    || BYTE4(qword_8D4F6C) == 1
                    && ((result = wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_8D4F54)), (result & 1) == 0)
                     && (v45 = HIDWORD(qword_8D4F54), HIDWORD(qword_8D4F54) < v31)
                     || BYTE4(qword_8D4F90) == 1
                     && (result = wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_8D4F78)), (result & 1) == 0)
                     && (v45 = HIDWORD(qword_8D4F78), HIDWORD(qword_8D4F78) < v31)) )
                  {
LABEL_46:
            ...
            if ( a8 )
            {
              ...
              do
              {
                ...
                v69 = *a7;
                if ( *a7 >= v31
                  && ((qword_8D4F00 & 0x100000000LL) == 0
                   || HIDWORD(pm_conc_connection_list) != v69
                   && (BYTE4(qword_8D4F24) != 1
                    || HIDWORD(qword_8D4F0C) != v69
                    && (BYTE4(qword_8D4F48) != 1
                     || HIDWORD(qword_8D4F30) != v69
                     && (BYTE4(qword_8D4F6C) != 1
                      || HIDWORD(qword_8D4F54) != v69 && (BYTE4(qword_8D4F90) != 1 || HIDWORD(qword_8D4F78) != v69))))) )
                {
            ...
            if ( a10 && (a6 & 1) == 0 )
            {
              ...
              do
              {
                ...
                if ( (qword_8D4F00 & 0x100000000LL) == 0
                  ...
                  && (BYTE4(qword_8D4F24) != 1
                   || HIDWORD(qword_8D4F0C) != v72
                   && (BYTE4(qword_8D4F48) != 1
                    || HIDWORD(qword_8D4F30) != v72
                    && (BYTE4(qword_8D4F6C) != 1
                     || HIDWORD(qword_8D4F54) != v72 && (BYTE4(qword_8D4F90) != 1 || HIDWORD(qword_8D4F78) != v72)))) )
                {
...
LABEL_184:
        ...
        if ( BYTE4(qword_8D4F00) )
        {
          ...
          if ( BYTE4(qword_8D4F24) == 1 )
          {
            v39 = (char *)&qword_8D4F0C + 4;
            if ( !wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_8D4F0C)) )
            {
              v40 = HIDWORD(qword_8D4F0C);
              if ( HIDWORD(qword_8D4F0C) > v31 )
                goto LABEL_17;
            }
            if ( BYTE4(qword_8D4F48) != 1 )
              goto LABEL_77;
            v39 = (char *)&qword_8D4F30 + 4;
            if ( !wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_8D4F30)) )
            {
              v40 = HIDWORD(qword_8D4F30);
              if ( HIDWORD(qword_8D4F30) > v31 )
                goto LABEL_17;
            }
            if ( BYTE4(qword_8D4F6C) != 1 )
              goto LABEL_77;
            v39 = (char *)&qword_8D4F54 + 4;
            if ( !wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_8D4F54)) )
            {
              v40 = HIDWORD(qword_8D4F54);
              if ( HIDWORD(qword_8D4F54) > v31 )
              {
LABEL_17:
                v41 = v75;
                goto LABEL_18;
...
LABEL_78:
                ...
                if ( BYTE4(qword_8D4F00) == 1 )
                {
                  if ( !wlan_reg_is_24ghz_ch_freq(HIDWORD(pm_conc_connection_list))
                    ...
                    || BYTE4(qword_8D4F24) == 1
                    && (!wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_8D4F0C))
                     && (v66 = HIDWORD(qword_8D4F0C), HIDWORD(qword_8D4F0C) < v31)
                     || BYTE4(qword_8D4F48) == 1
                     && (!wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_8D4F30))
                      && (v66 = HIDWORD(qword_8D4F30), HIDWORD(qword_8D4F30) < v31)
                      || BYTE4(qword_8D4F6C) == 1
                      && (!wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_8D4F54))
                       && (v66 = HIDWORD(qword_8D4F54), HIDWORD(qword_8D4F54) < v31)
                       || BYTE4(qword_8D4F90) == 1
                       && !wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_8D4F78))
                       && (v66 = HIDWORD(qword_8D4F78), HIDWORD(qword_8D4F78) < v31)))) )
                  {
