  ...
  if ( a2 )
  {
    ...
    else
    {
      ...
      *(_WORD *)(a3 + 248) = 0;
      ...
      LODWORD(v49) = 0;
      lim_init_peer_idxpool((__int64)a1, a3, v41, v42, v43, v44, v45, v46, v47, v48);
    }
    BYTE4(v49) = *(_BYTE *)(a3 + 8);
    result = lim_send_start_bss_confirm((__int64)a1, (unsigned __int8 *)&v49, v22, v23, v24, v25, v26, v27, v28, v29);
  }
  else
  {
