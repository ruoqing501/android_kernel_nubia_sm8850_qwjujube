        ...
        double a9)
{
  ...
  v10 = _qdf_mem_malloc(0x6240u, "vdevmgr_mlme_ext_hdl_create", 1712);
  *(_QWORD *)(a1 + 536) = v10;
  if ( !v10 )
    return 2;
  ...
  *(_QWORD *)(*(_QWORD *)(a1 + 536) + 24080LL) = 0;
  v36 = *(_QWORD *)(a1 + 520);
  if ( v36 )
  {
    v37 = *(_QWORD *)(a1 + 536);
...
LABEL_7:
  _qdf_wake_lock_create((_QWORD *)(*(_QWORD *)(a1 + 536) + 24704LL), (__int64)"bss_color_change_wakelock");
  _qdf_runtime_lock_init(
    (__int64 *)(*(_QWORD *)(a1 + 536) + 24904LL),
    "&vdev_mlme->ext_vdev_ptr->bss_color_change_runtime_lock");
  _qdf_runtime_lock_init(
    (__int64 *)(*(_QWORD *)(a1 + 536) + 24912LL),
    "&vdev_mlme->ext_vdev_ptr->disconnect_runtime_lock");
  sme_get_vdev_type_nss(*(unsigned int *)(*(_QWORD *)(a1 + 520) + 16LL), a1 + 24, a1 + 25);
  v46 = *(_DWORD *)(*(_QWORD *)(a1 + 520) + 16LL);
  *(_WORD *)(a1 + 179) = 0;
  if ( v46 > 5 )
  {
    if ( v46 <= 7 )
...
LABEL_30:
  *(_BYTE *)(a1 + 179) = v47;
LABEL_31:
  *(_DWORD *)(*(_QWORD *)(a1 + 536) + 25144LL) = 0;
  _qdf_wake_lock_create((_QWORD *)(*(_QWORD *)(a1 + 536) + 24936LL), (__int64)"peer_set_key");
  _qdf_runtime_lock_init(
    (__int64 *)(*(_QWORD *)(a1 + 536) + 25136LL),
