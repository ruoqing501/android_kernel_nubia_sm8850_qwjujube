        ...
        double a11)
{
  ...
  if ( a2 <= 4u )
  {
    ...
    if ( (wlan_cfg_get_dp_tx_page_pool_enabled(*(_QWORD *)(v13 + 40)) & 1) != 0 )
    {
      ...
      {
        raw_spin_lock(a1 + 22504);
      }
      else
      {
        raw_spin_lock_bh(a1 + 22504);
        *(_QWORD *)(a1 + 22512) |= 1uLL;
      }
      v24 = *(_QWORD *)(a1 + 22456);
      v25 = (_QWORD *)a1;
      ...
      if ( (v43 & 1) != 0 )
      {
        v25[2814] = v43 & 0xFFFFFFFFFFFFFFFELL;
        raw_spin_unlock_bh(v25 + 2813);
      }
      else
      {
        raw_spin_unlock(v25 + 2813);
      }
    }
    ...
    if ( *(_BYTE *)(a1 + 20720) == 1 )
    {
      ...
      qdf_trace_msg(
        ...
        *(_QWORD *)(a1 + 20728),
        *(_QWORD *)(a1 + 20736));
      if ( (*(_BYTE *)(a1 + 21264) & 1) == 0 )
      {
LABEL_84:
        if ( (*(_BYTE *)(a1 + 21808) & 1) == 0 )
        {
LABEL_90:
          if ( (*(_BYTE *)(a1 + 22352) & 1) == 0 )
            return 0;
LABEL_91:
          qdf_trace_msg(
            0x45u,
