__int64 __fastcall pmo_unregister_pause_bitmap_notifier(
        __int64 a1,
        double a2,
        double a3,
        double a4,
        ...
        double a9)
{
  ...
  if ( !a1 )
  {
    qdf_trace_msg(0x4Du, 2u, "%s: psoc is null", a2, a3, a4, a5, a6, a7, a8, a9, "pmo_unregister_pause_bitmap_notifier");
    return 29;
  }
