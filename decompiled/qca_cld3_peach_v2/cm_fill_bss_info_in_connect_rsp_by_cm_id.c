__int64 __fastcall cm_fill_bss_info_in_connect_rsp_by_cm_id(_QWORD *a1, int a2, __int64 a3)
{
  _QWORD *v6; // x1
  unsigned int v7; // w20
  ...
  if ( (a2 & 0xF000000) == 0xC000000 )
  {
    ...
    qdf_list_peek_front(a1 + 12, v10);
    v6 = (_QWORD *)v10[0];
    if ( v10[0] )
    {
      while ( 1 )
      {
        qdf_list_peek_next(a1 + 12, v6, &v9);
      ...
      cm_fill_connect_resp_from_req(*a1, a3, v10[0]);
      v7 = 0;
    }
    else
    {
