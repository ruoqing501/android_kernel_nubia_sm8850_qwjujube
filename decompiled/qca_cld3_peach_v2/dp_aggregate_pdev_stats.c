__int64 __fastcall dp_aggregate_pdev_stats(_QWORD *a1)
{
  ...
  v2 = qdf_mem_malloc_atomic_fl(0xA758u, (__int64)"dp_aggregate_pdev_stats", 0x1F17u);
  v11 = a1[1];
  if ( !v2 )
    return qdf_trace_msg(
             ...
             a1[1]);
  v12 = (__int64)v2;
  qdf_mem_set(a1 + 374, 0xAB8u, 0);
  qdf_mem_set(a1 + 717, 0x700u, 0);
