__int64 __fastcall populate_dot11f_he_operation(__int64 a1, __int64 a2, _BYTE *a3)
{
  ...
  *(_DWORD *)(a3 + 1) = v17;
  ...
  {
    v20 = updated;
    if ( !policy_mgr_is_vdev_ll_lt_sap(*(_QWORD *)(a1 + 21624), *(unsigned __int8 *)(a2 + 10))
  ...
  *(_DWORD *)(a3 + 1) = v17 | 0x200000;
  ...
  v21 = wlan_reg_freq_to_chan(*(_QWORD *)(a1 + 21632), *(_DWORD *)(a2 + 284), v8, v9, v10, v11, v12, v13, v14, v15);
  v22 = a3[13];
  a3[12] = v21;
  a3[16] = 0;
  a3[13] = v22 & 0xFB;
  wlan_reg_get_cur_6g_ap_pwr_type(*(_QWORD *)(a1 + 21632), &v33, v23, v24, v25, v26, v27, v28, v29, v30);
  if ( v33 == 3 )
    v31 = 16;
  else
    v31 = 8 * (v33 & 0xF);
