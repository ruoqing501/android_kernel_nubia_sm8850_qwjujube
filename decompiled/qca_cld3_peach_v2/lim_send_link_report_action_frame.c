    ...
    *(_DWORD *)((char *)&v92[3] + 1) = v19;
    ...
    else
    {
      ...
      *((_WORD *)v38 + 11) = (16 * (v49 & 0xF)) | *((_WORD *)v38 + 11) & 0xFF0F;
      v50 = (unsigned __int8)(*(_WORD *)(a1 + 21604) >> 4);
      *((_WORD *)v38 + 11) = (16 * *(_WORD *)(a1 + 21604)) & 0xFF00 | (16 * (v49 & 0xF));
      qdf_trace_msg(
        0x35u,
        8u,
      ...
      else
      {
        ...
        v87 = jiffies;
        if ( lim_send_link_report_action_frame___last_ticks_195 - jiffies + 125 < 0 )
        {
          qdf_trace_msg(
            0x35u,
            2u,
            ...
            "lim_send_link_report_action_frame",
            v78);
          lim_send_link_report_action_frame___last_ticks_195 = v87;
        }
      }
    }
  }
