...
LABEL_42:
      if ( v37 != -1 )
      {
        qdf_trace_msg(
          ...
          "__wlan_hdd_cfg80211_set_bitrate_mask",
          v37);
        updated = wma_cli_set_command(*(unsigned __int8 *)(*(_QWORD *)(v122 + 55520) + 8LL), 27, v37, 1);
        if ( updated )
          qdf_trace_msg(
            0x33u,
            2u,
        ...
        if ( !(_BYTE)v124 )
        {
          ...
          if ( v136 )
          {
            ...
            updated = sme_update_ht_config(
                        *(_QWORD *)(v123 + 1552),
                        *(unsigned __int8 *)(*(_QWORD *)(v122 + 55520) + 8LL),
                        5);
            if ( updated )
              qdf_trace_msg(
                0x33u,
      ...
      if ( v126 )
        qdf_trace_msg(
          ...
          v126);
      HIDWORD(v155) = v135;
      updated = sme_update_ht_config(*(_QWORD *)(v123 + 1552), *(unsigned __int8 *)(*(_QWORD *)(v122 + 55520) + 8LL), 5);
      if ( updated )
        qdf_trace_msg(
          0x33u,
          2u,
