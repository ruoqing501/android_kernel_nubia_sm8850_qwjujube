__int64 __fastcall target_if_oob_connect_response_event_handler(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  const char *v28; // x2
  __int64 result; // x0
  void (__fastcall *v30)(__int64, unsigned __int64); // x10
...
LABEL_10:
  ...
  if ( !*(_QWORD *)(comp_private_obj + 32) )
  {
    v28 = "%s: Invalid ll_sap rx ops";
    goto LABEL_10;
  }
  v18 = comp_private_obj;
  v19 = wmi_extract_oob_connect_response_event(v15, a2, a3, &v32);
  if ( v19 )
  {
    qdf_trace_msg(
      0x49u,
...
LABEL_11:
  ...
  v30 = *(void (__fastcall **)(__int64, unsigned __int64))(v18 + 32);
  v31 = (unsigned __int8)v32 | ((unsigned __int64)HIDWORD(v32) << 32);
  if ( *((_DWORD *)v30 - 1) != -71426398 )
    __break(0x822Au);
  v30(v16, v31);
  result = 0;
LABEL_12:
