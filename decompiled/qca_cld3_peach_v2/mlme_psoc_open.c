__int64 __fastcall mlme_psoc_open(__int64 a1)
{
  ...
  if ( comp_private_obj )
  {
    ...
    *(_WORD *)(v11 + 2070) = *(_WORD *)(v11 + 2070) & 0xFEFF
                           | (*(unsigned __int8 *)(cfg_psoc_get_values(a1) + 1100) << 8)
                           | 8;
    *(_BYTE *)(v11 + 2072) = *(_DWORD *)(cfg_psoc_get_values(a1) + 1104);
    wlan_minidump_log(v12, v13, v14, v15, v16, v17, v18, v19, v11, 2152, a1);
  }
  else
  {
    qdf_trace_msg(
