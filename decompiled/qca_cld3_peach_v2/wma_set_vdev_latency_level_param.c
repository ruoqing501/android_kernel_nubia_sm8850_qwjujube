__int64 __fastcall wma_set_vdev_latency_level_param(__int64 a1, unsigned int a2)
{
  ...
  v4 = *(unsigned __int8 *)(*(_QWORD *)(a1 + 8) + 5936LL);
  wlm_multi_client_ll_caps = wlan_mlme_get_wlm_multi_client_ll_caps(*(_QWORD *)(a1 + 21624));
