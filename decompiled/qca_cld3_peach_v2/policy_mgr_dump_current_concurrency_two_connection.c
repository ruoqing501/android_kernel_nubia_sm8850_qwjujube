__int64 __fastcall policy_mgr_dump_current_concurrency_two_connection(__int64 a1, const char *a2)
{
  int v4; // w21
  double v5; // d0
  double v6; // d1
  ...
  v60 = 0;
  *(_QWORD *)string = 0;
  v5 = scnprintf(string, 9, "(vdev %d)", qword_8D4F24);
  if ( v4 > 2 )
  {
    if ( v4 <= 4 )
    {
      if ( v4 == 3 )
      {
        v13 = policy_mgr_dump_current_concurrency_one_connection(a1, a2);
...
LABEL_21:
    qdf_trace_msg(
      ...
      v11,
      v12,
      "policy_mgr_dump_current_concurrency_two_connection",
      (unsigned int)v4);
    v43 = 0;
    goto LABEL_39;
  }
  v20 = policy_mgr_dump_current_concurrency_one_connection(a1, a2);
  v21 = qword_8D4F24;
...
LABEL_67:
  ...
  return policy_mgr_dump_current_concurrency_three_connection(v57, v58);
}
