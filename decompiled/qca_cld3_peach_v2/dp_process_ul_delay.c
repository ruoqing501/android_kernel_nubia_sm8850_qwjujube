__int64 __fastcall dp_process_ul_delay(__int64 a1, unsigned __int8 a2)
{
  ...
  {
    v13 = ref_by_id_1;
    v14 = ref_by_id_1 + 43552;
    v15 = (unsigned int *)*(unsigned int *)(ref_by_id_1 + 43552);
    if ( (_DWORD)v15 )
    {
      if ( *(_DWORD *)(ref_by_id_1 + 43568) )
        dp_accumulate_hist_stats(ref_by_id_1 + 5232, ref_by_id_1 + 5360);
      if ( *(_DWORD *)(v14 + 24) )
      {
        dp_accumulate_hist_stats(v13 + 5232, v13 + 5488);
        v38 = 0;
        __isb(0xFu);
        ...
        if ( v17 - *(_QWORD *)(v14 + 32) >= 1000 * (unsigned __int64)*(unsigned __int16 *)(v14 + 28) )
        {
          ...
          if ( v24 )
          {
            ...
            *(_QWORD *)(v14 + 32) = v17;
            WORD2(v38) = v28;
            qdf_mem_set((void *)(v13 + 5488), 0x80u, 0);
      ...
      qdf_mem_set((void *)(v13 + 5232), 0x80u, 0);
    }
