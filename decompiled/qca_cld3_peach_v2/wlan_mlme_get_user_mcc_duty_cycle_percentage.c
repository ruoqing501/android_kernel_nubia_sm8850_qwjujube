...
LABEL_7:
  ...
  v11 = *(unsigned __int8 *)(psoc_ext_obj_fl + 1141);
  v12 = *(unsigned __int8 *)(psoc_ext_obj_fl + 1140);
  if ( v11 == 255 || !*(_BYTE *)(psoc_ext_obj_fl + 1140) )
  {
    qdf_trace_msg(
      0x68u,
      8u,
      ...
      *(unsigned __int8 *)(psoc_ext_obj_fl + 1141),
      *(unsigned __int8 *)(psoc_ext_obj_fl + 1140));
    goto LABEL_9;
  }
  v13 = *(_DWORD *)(psoc_ext_obj_fl + 1136);
