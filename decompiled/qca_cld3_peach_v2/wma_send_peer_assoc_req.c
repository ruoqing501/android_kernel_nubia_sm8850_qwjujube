...
LABEL_23:
  ...
  wmi_unified_send_txbf(v40, a1 + 24, v88, v89, v90, v91, v92, v93, v94, v95);
  v96 = *v40;
  v97 = (*(unsigned __int8 *)(context[1] + 3533LL) << 31) | 0x200;
...
LABEL_46:
  ...
  a1[279] = a1[864];
  v124 = ((__int64 (__fastcall *)(__int64 *, __int64, unsigned __int8 *))wma_send_peer_assoc)(v40, v123, a1 + 24);
  if ( v124 )
  {
    v37 = v124;
    qdf_trace_msg(
  ...
  if ( (unsigned int)wma_vdev_set_bss_params(v40, a1[167], *((_WORD *)a1 + 7), a1[16], a1[12], a1[13], v134) )
    qdf_trace_msg(
      0x36u,
      2u,
...
LABEL_28:
  ...
  qdf_mem_copy((void *)(cmpt_obj + 184), a1, 6u);
