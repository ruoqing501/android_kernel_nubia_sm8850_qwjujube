        ...
        double a10)
{
  ...
  {
    if ( (v21 & 1) == 0 )
      return raw_spin_unlock(a1 + 768);
    *(_QWORD *)(a1 + 776) = v21 & 0xFFFFFFFFFFFFFFFELL;
    return raw_spin_unlock_bh(a1 + 768);
  }
  if ( (v21 & 1) != 0 )
  {
    *(_QWORD *)(a1 + 776) = v21 & 0xFFFFFFFFFFFFFFFELL;
...
LABEL_33:
  ...
  {
    raw_spin_lock(v32 + 1264);
  }
  else
  {
    raw_spin_lock_bh(v32 + 1264);
    *(_QWORD *)(v32 + 1272) |= 1uLL;
  }
  qdf_list_insert_back((_QWORD *)(v32 + 1280), (_QWORD *)(a1 + 32));
  v33 = *(_QWORD *)(v32 + 1272);
  ++*(_DWORD *)(v32 + 1352);
  if ( (v33 & 1) != 0 )
  {
    *(_QWORD *)(v32 + 1272) = v33 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(v32 + 1264);
  }
  else
  {
    raw_spin_unlock(v32 + 1264);
  }
  qdf_trace_msg(
    0x57u,
    8u,
    ...
    v41,
    "wlan_peer_obj_free_enqueue",
    *(unsigned int *)(v32 + 1352),
    *(unsigned int *)(v32 + 1296),
    a1,
    *(unsigned __int8 *)(a1 + 48),
    *(unsigned __int8 *)(a1 + 49),
    *(unsigned __int8 *)(a1 + 50),
    *(unsigned __int8 *)(a1 + 53));
  return queue_work_on(32, system_wq, v32 + 1304);
}
