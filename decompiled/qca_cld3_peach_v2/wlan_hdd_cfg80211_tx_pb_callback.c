        ...
        double a10)
{
  ...
  qdf_wake_lock_timeout_acquire(a1 + 8616, 1000);
  qdf_runtime_pm_prevent_suspend((__int64 *)(a1 + 8816));
  v13 = _cfg80211_alloc_event_skb(*(_QWORD *)(a1 + 24), 0, 103, 197, 0, 76, 128, 3264);
  if ( !v13 )
  {
...
LABEL_41:
  ...
  qdf_list_insert_back((_QWORD *)(a1 + 8824), (_QWORD *)v28);
  qdf_mutex_release(a1 + 8848);
  qdf_trace_msg(
    0x33u,
    8u,
