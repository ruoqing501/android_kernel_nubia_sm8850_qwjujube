__int64 __fastcall wlan_hdd_cfg80211_concurrent_session_policy(__int64 a1, __int64 a2, __int64 a3, unsigned int a4)
{
  ...
  if ( !(_DWORD)result )
  {
    ...
    else
    {
      ...
      {
        v28 = jiffies;
        if ( _wlan_hdd_cfg80211_concurrent_session_policy___last_ticks_946 - jiffies + 125 < 0 )
        {
          qdf_trace_msg(
            0x33u,
            2u,
            ...
            v27,
            "__wlan_hdd_cfg80211_concurrent_session_policy");
          _wlan_hdd_cfg80211_concurrent_session_policy___last_ticks_946 = v28;
        }
      }
      ...
      {
        v37 = jiffies;
        if ( _wlan_hdd_cfg80211_concurrent_session_policy___last_ticks_948 - jiffies + 125 < 0 )
        {
          qdf_trace_msg(
            0x33u,
            2u,
            ...
            v36,
            "__wlan_hdd_cfg80211_concurrent_session_policy");
          _wlan_hdd_cfg80211_concurrent_session_policy___last_ticks_948 = v37;
        }
      }
      else if ( (unsigned int)_nla_parse(&v50, 2, a3, a4, &wlan_hdd_set_concurrent_session_policy, 31, 0) )
      {
        v46 = jiffies;
        if ( _wlan_hdd_cfg80211_concurrent_session_policy___last_ticks_950 - jiffies + 125 < 0 )
        {
          qdf_trace_msg(
            0x33u,
            2u,
            ...
            v45,
            "__wlan_hdd_cfg80211_concurrent_session_policy");
          _wlan_hdd_cfg80211_concurrent_session_policy___last_ticks_950 = v46;
        }
      }
      else
      {
        ...
        v48 = jiffies;
        if ( _wlan_hdd_cfg80211_concurrent_session_policy___last_ticks_951 - jiffies + 125 < 0 )
        {
          qdf_trace_msg(
            0x33u,
            2u,
            ...
            v45,
            "__wlan_hdd_cfg80211_concurrent_session_policy");
          _wlan_hdd_cfg80211_concurrent_session_policy___last_ticks_951 = v48;
        }
      }
      v19 = -22;
    }
