__int64 __fastcall hdd_debugfs_mws_antenna_sharing_read(__int64 a1, __int64 a2)
{
  __int64 v4; // x8
  __int64 v5; // x0
  ...
  double v38; // d7
  __int64 result; // x0
  __int64 v40[2]; // [xsp+40h] [xbp-10h] BYREF

  v40[1] = *(_QWORD *)(_ReadStatusReg(SP_EL0) + 1808);
  v4 = *(_QWORD *)(a2 + 24);
  v40[0] = 0;
  v5 = _osif_psoc_sync_op_start(*(_QWORD *)(v4 + 488), v40, (__int64)"hdd_debugfs_mws_antenna_sharing_read");
  if ( !(_DWORD)v5 )
  {
    ...
    if ( first_valid_adapter )
    {
      if ( (*((_QWORD *)first_valid_adapter + 203) & 4) != 0 )
      {
        ...
        v17 = osif_request_alloc(_hdd_debugfs_mws_antenna_sharing_read_params);
        if ( v17 )
        {
          v18 = v17;
    ...
    qdf_trace_msg(0x33u, 2u, v15, v7, v8, v9, v10, v11, v12, v13, v14, "__hdd_debugfs_mws_antenna_sharing_read");
LABEL_16:
    _osif_psoc_sync_op_stop(v40[0], (__int64)"hdd_debugfs_mws_antenna_sharing_read");
    v5 = 0;
  }
