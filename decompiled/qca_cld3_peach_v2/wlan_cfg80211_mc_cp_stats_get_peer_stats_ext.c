        ...
        double a11)
{
  ...
  double v68; // d6
  double v69; // d7
  char v70[4]; // [xsp+4h] [xbp-3Ch] BYREF
  _QWORD v71[2]; // [xsp+8h] [xbp-38h] BYREF
  int v72; // [xsp+18h] [xbp-28h]
  int v73; // [xsp+1Ch] [xbp-24h]
  _QWORD v74[4]; // [xsp+20h] [xbp-20h] BYREF

  v74[3] = *(_QWORD *)(_ReadStatusReg(SP_EL0) + 1808);
  v11 = *(_QWORD *)(a1 + 216);
  memset(v74, 0, 24);
  v70[0] = 0;
  if ( v11 )
