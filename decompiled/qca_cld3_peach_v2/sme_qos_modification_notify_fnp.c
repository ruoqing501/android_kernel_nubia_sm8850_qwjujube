__int64 __fastcall sme_qos_modification_notify_fnp(
        __int64 a1,
        __int64 a2,
        double a3,
        double a4,
  ...
  if ( a2 )
  {
    ...
    if ( v10 < 5 )
    {
      ...
      if ( v11 <= 2 )
      {
        ...
        v14 = qword_91F2D8 + 3040LL * *(unsigned __int8 *)(a2 + 16) + 728LL * v10 + 76LL * (int)v11;
    ...
    __break(0x5512u);
    return sme_qos_update_tspec_mask();
  }
  else
  {
    qdf_trace_msg(0x34u, 2u, "%s: Entry is NULL", a3, a4, a5, a6, a7, a8, a9, a10, "sme_qos_modification_notify_fnp");
    return 16;
  }
}
