__int64 __fastcall sme_update_channel_list(__int64 a1)
{
  ...
  while ( 1 )
  {
    if ( (wlan_get_opmode_from_vdev_id(*(_QWORD *)(a1 + 21632), v13) & 0xFFFFFFFD) != 0 )
      goto LABEL_7;
    operation_chan_freq_vdev_id = wlan_get_operation_chan_freq_vdev_id(*(_QWORD *)(a1 + 21632), v13);
