__int64 __fastcall debug_wmi_rx_event_log_write(__int64 a1, unsigned __int64 a2, size_t a3)
{
  __int64 v3; // x8
  __int64 result; // x0
  __int64 v5; // x21
  ...
  *(_QWORD *)s = 0;
  ...
  if ( a2 && a3 <= 0x32 )
  {
    ...
    else
    {
      ...
      qdf_mem_set(*(void **)(v5 + 504), (unsigned int)(32 * wmi_event_log_max_entry), 0);
      v17 = *(_DWORD **)(v5 + 520);
      *(_DWORD *)(v5 + 512) = 0;
      *v17 = 0;
      v18 = *(_QWORD *)(v5 + 672);
