        ...
        __int64 a12)
{
  ...
  __int16 v41; // w22
  __int64 v42; // x0
  __int64 v44; // [xsp+0h] [xbp-40h] BYREF
    ...
    if ( a12 )
    {
      ...
      if ( (_WORD)v18 && (unsigned __int16)v18 > (v20 | 3) )
      {
        ...
        if ( *v21 == 5 && v21[1] == 1 )
        {
          ...
          qdf_mem_set(&v44, 0x34u, 0);
          HIWORD(v44) = v41;
          time_of_the_day_us = qdf_get_time_of_the_day_us();
          v42 = ktime_get(time_of_the_day_us);
          HIBYTE(v48) = v24;
          BYTE6(v48) = v37;
          LOWORD(v48) = 11267;
          v50 = v50 & 0xFFFF87FF | (v15 << 11) | 0x100;
          v47 = v42 / 1000;
          v50 = v23 & 0xFFFFF9FF | ((wlan_get_diag_tx_status(v15) & 3) << 9) | v50 & 0xFFFFF900;
          host_diag_event_report_payload(3384, 52, &v44);
        }
        else
        {
          qdf_trace_msg(
