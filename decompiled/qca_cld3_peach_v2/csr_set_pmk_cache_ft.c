        ...
        double a11)
{
  ...
  v15 = ((__int64 (__fastcall *)(_QWORD, _QWORD, __int64))wlan_objmgr_get_vdev_by_id_from_psoc)(a1[2703], a2, 11);
  if ( !v15 )
  {
...
LABEL_13:
  ...
  if ( (param & 0x1180020) != 0 )
  {
    qdf_trace_msg(
      ...
      "csr_set_pmk_cache_ft",
      param);
    cm_update_pmk_cache_ft(a1[2703], a2, (__int64)a3);
    result = 0;
    goto LABEL_10;
  }
  v70 = 0;
  ...
  v69 = 0;
  v67 = 0;
  v45 = _qdf_mem_malloc(0x2D8u, "csr_set_pmk_cache_ft", 5166);
  if ( !v45 )
  {
    result = 2;
    goto LABEL_10;
  ...
  *(_BYTE *)(v45 + 16) = 1;
  ...
  scan_result = scm_get_scan_result(a1[2704], v46, v47, v48, v49, v50, v51, v52, v53, v54);
  _qdf_mem_free(v46);
  if ( !scan_result )
  {
