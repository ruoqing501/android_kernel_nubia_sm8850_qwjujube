__int64 __fastcall dp_print_tsf_tx_delay_hist(__int64 *a1, char a2)
{
  ...
  if ( a1 )
  {
    ...
    qdf_trace_msg(0x45u, 5u, v13, v14, v15, v16, v17, v18, v19, v20, v21, "dp_print_tsf_tx_delay_hist", &unk_98C763);
    scnprintf(s, 512, "%7s", fw_to_hw_delay_bkt_str[0]);
    v23 = v22;
    scnprintf(&s[v22], 512LL - v22, "%7s", off_162C0[0]);
    v25 = v23 + v24;
    scnprintf(&s[v25], 512 - v25, "%7s", off_162C8[0]);
    v27 = v25 + v26;
    scnprintf(&s[v27], 512 - v27, "%7s", off_162D0[0]);
    v29 = v27 + v28;
    scnprintf(&s[v29], 512 - v29, "%7s", off_162D8[0]);
    v31 = v29 + v30;
    scnprintf(&s[v31], 512 - v31, "%9s", off_162E0[0]);
    v33 = v31 + v32;
    scnprintf(&s[v33], 512 - v33, "%9s", off_162E8[0]);
    v35 = v33 + v34;
    scnprintf(&s[v35], 512 - v35, "%9s", off_162F0[0]);
    v37 = v35 + v36;
    scnprintf(&s[v37], 512 - v37, "%9s", off_162F8[0]);
    v39 = v37 + v38;
    scnprintf(&s[v39], 512 - v39, "%9s", off_16300[0]);
    v41 = v39 + v40;
    scnprintf(&s[v41], 512 - v41, "%9s", off_16308[0]);
    v43 = v41 + v42;
    scnprintf(&s[v43], 512 - v43, "%9s", off_16310[0]);
    v45 = scnprintf(&s[v43 + v44], 512 - (v43 + v44), "%9s", off_16318);
