        ...
        double a10)
{
  ...
  if ( v11
    && a1
    && v11 + 96LL * *(unsigned __int8 *)(a2 + 168)
    && *(_BYTE *)(v11 + 96LL * *(unsigned __int8 *)(a2 + 168) + 1) == 1 )
  {
    v14 = a1;
    v15 = (char *)a1 + 4 * v10;
    if ( *((_DWORD *)v15 + 4311) == 3 && *((_DWORD *)v15 + 4317) == 5 )
    {
      v16 = a2;
      qdf_trace_msg(
        0x34u,
      ...
      cm_stop_wait_for_key_timer(v14[2703], (unsigned int)v10);
    ...
    wlan_serialization_purge_all_cmd_by_vdev_id(v14[2704], v10, v25, v26, v27, v28, v29, v30, v31, v32);
    if ( v14[2754] )
    {
      return 0;
    }
