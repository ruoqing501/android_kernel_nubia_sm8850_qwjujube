        ...
        double a11)
{
  ...
  if ( (unsigned int)a3 - 3 > 0xFFFFFFFD )
  {
    ...
    v12 = *(_QWORD *)(a1 + 8);
    v14 = *(unsigned __int16 *)(v12 + 1328);
    v15 = -1LL << (2 * a3);
    v16 = (v15 | *(unsigned __int16 *)(v12 + 1330)) & 0xFFFC | v14 & 3;
...
LABEL_9:
    ...
    {
      *(_WORD *)(*(_QWORD *)(a1 + 8) + 1328LL) = v17;
      v21 = HIWORD(v16);
      if ( HIWORD(v16) )
        goto LABEL_9;
    }
    *(_WORD *)(*(_QWORD *)(a1 + 8) + 1330LL) = v16;
    if ( !v19 )
    {
LABEL_10:
      qdf_mem_copy((void *)(*(_QWORD *)(a1 + 8) + 1332LL), &v27, 2u);
      v20 = a1;
      v22 = (_WORD *)(a1 + 20480);
      if ( v21 )
        goto LABEL_19;
...
LABEL_19:
      ...
      v22[695] = v16;
      v26 = v20;
      qdf_mem_copy((void *)(v20 + 21872), (const void *)(v25 + 1332), 2u);
      qdf_mem_copy((void *)(v26 + 21874), (const void *)(*(_QWORD *)(v26 + 8) + 1334LL), 2u);
      result = csr_update_session_he_cap(v26);
      goto LABEL_14;
    }
LABEL_18:
    qdf_mem_copy((void *)(*(_QWORD *)(v20 + 8) + 1334LL), &v28, 2u);
    LOWORD(v16) = v28;
    v20 = a1;
    goto LABEL_19;
  }
