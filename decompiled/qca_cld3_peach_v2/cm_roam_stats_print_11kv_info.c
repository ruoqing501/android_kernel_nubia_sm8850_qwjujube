...
LABEL_18:
      ...
      if ( v43 )
      {
        ...
        v52 = jiffies;
        if ( cm_roam_stats_print_11kv_info___last_ticks_202 - jiffies + 125 < 0 )
        {
          if ( v3 == 1 )
            v53 = "BTM_REQ";
          else
          ...
          qdf_trace_msg(
            ...
            (unsigned __int8)a3,
            v54);
          cm_roam_stats_print_11kv_info___last_ticks_202 = v52;
        }
        if ( v3 == 2 )
      ...
      {
        v55 = jiffies;
        if ( cm_roam_stats_print_11kv_info___last_ticks_207 - jiffies + 125 < 0 )
        {
          if ( v3 == 1 )
            v56 = "BTM";
          else
          ...
          cm_roam_stats_print_11kv_info___last_ticks_207 = v55;
        }
      }
      goto LABEL_35;
    }
