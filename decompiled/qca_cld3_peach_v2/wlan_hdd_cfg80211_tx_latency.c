                               ...
                               v19) )
    {
      ...
      else if ( v37 )
      {
        ...
        if ( v29 == 2 )
        {
          ...
          {
            v31 = jiffies;
            if ( _wlan_hdd_cfg80211_tx_latency___last_ticks_408 - jiffies + 125 < 0 )
            {
              qdf_trace_msg(
                0x33u,
                2u,
                ...
                v27,
                "__wlan_hdd_cfg80211_tx_latency");
              _wlan_hdd_cfg80211_tx_latency___last_ticks_408 = v31;
            }
          }
        }
        else if ( v29 == 1 )
        {
          if ( v39 )
          {
            if ( v40 )
            {
              ...
              {
                v34 = jiffies;
                if ( _wlan_hdd_cfg80211_tx_latency___last_ticks_406 - jiffies + 125 < 0 )
                {
                  qdf_trace_msg(
                    0x33u,
                    2u,
                    ...
                    v27,
                    "__wlan_hdd_cfg80211_tx_latency");
                  _wlan_hdd_cfg80211_tx_latency___last_ticks_406 = v34;
                }
              }
            }
            else
            {
              v33 = jiffies;
              if ( _wlan_hdd_cfg80211_tx_latency___last_ticks_404 - jiffies + 125 < 0 )
              {
                qdf_trace_msg(
                  0x33u,
                  2u,
                  ...
                  v27,
                  "__wlan_hdd_cfg80211_tx_latency");
                _wlan_hdd_cfg80211_tx_latency___last_ticks_404 = v33;
              }
            }
          }
          else
          {
            v32 = jiffies;
            if ( _wlan_hdd_cfg80211_tx_latency___last_ticks_402 - jiffies + 125 < 0 )
            {
              qdf_trace_msg(
                0x33u,
                2u,
                ...
                v27,
                "__wlan_hdd_cfg80211_tx_latency");
              _wlan_hdd_cfg80211_tx_latency___last_ticks_402 = v32;
            }
          }
        }
        else if ( !v29 && *(_BYTE *)(v11 + 73800) == 1 )
        {
          memset(v42, 0, 24);
      ...
      {
        v30 = jiffies;
        if ( _wlan_hdd_cfg80211_tx_latency___last_ticks_400 - jiffies + 125 < 0 )
        {
          qdf_trace_msg(
            0x33u,
            2u,
            ...
            v27,
            "__wlan_hdd_cfg80211_tx_latency");
          _wlan_hdd_cfg80211_tx_latency___last_ticks_400 = v30;
        }
      }
    }
