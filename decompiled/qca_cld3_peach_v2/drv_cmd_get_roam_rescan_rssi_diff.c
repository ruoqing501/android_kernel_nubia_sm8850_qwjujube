__int64 __fastcall drv_cmd_get_roam_rescan_rssi_diff(__int64 a1, __int64 *a2, const char *a3, __int64 a4, __int64 a5)
{
  __int64 v7; // x0
  ...
  v33[0] = 0;
  memset(v34, 0, 32);
  ucfg_cm_get_roam_rescan_rssi_diff(v7, v33);
  ...
  qdf_trace_msg(
    ...
    v18,
    v19,
    "drv_cmd_get_roam_rescan_rssi_diff");
  result = 4294967282LL;
LABEL_12:
