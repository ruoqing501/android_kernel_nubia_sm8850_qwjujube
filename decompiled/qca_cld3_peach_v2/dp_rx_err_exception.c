        ...
        double a10)
{
  ...
  if ( !a1 || (v12 = *(_DWORD *)(a1 + 14128) + 1, *(_DWORD *)(a1 + 14128) = v12, v12 >= 0x15) )
  {
    qdf_trace_msg(
      0x45u,
      2u,
...
LABEL_15:
  ...
  v28 = (unsigned __int8 *)(*(_QWORD *)(*(_QWORD *)(a1 + 12440) + 8LL * BYTE1(v27))
                          + (unsigned __int8)v27 * (unsigned int)*(unsigned __int16 *)(a1 + 12420));
  if ( !v28 )
  {
LABEL_38:
    if ( a1 )
...
LABEL_40:
  ...
  if ( v35 < 5 )
  {
    ...
    dp_rx_nbuf_unmap_pool(a1, v37 + 12416, *(_QWORD *)v28);
    v28[30] |= 2u;
    v38 = *(_QWORD *)(a1 + 18528);
    if ( (v38 & 1) != 0 )
    {
      *(_QWORD *)(a1 + 18528) = v38 & 0xFFFFFFFFFFFFFFFELL;
