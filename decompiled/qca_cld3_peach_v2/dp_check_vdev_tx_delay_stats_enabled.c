__int64 __fastcall dp_check_vdev_tx_delay_stats_enabled(__int64 a1, unsigned __int8 a2)
{
  ...
  if ( a2 <= 5u )
  {
    ...
    if ( (v24 & 1) != 0 )
    {
      *(_QWORD *)(a1 + 18992) = v24 & 0xFFFFFFFFFFFFFFFELL;
      raw_spin_unlock_bh(a1 + 18984);
    }
    else
    {
