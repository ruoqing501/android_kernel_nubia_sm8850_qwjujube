__int64 __fastcall dp_print_sched_txq_cmd_posted_tlv_v(unsigned int *a1)
{
  unsigned int v2; // w21
  __int64 v3; // x0
  double v4; // d0
  ...
  v2 = *a1;
  v3 = _qdf_mem_malloc(0x3E8u, "dp_print_sched_txq_cmd_posted_tlv_v", 2367);
  if ( !v3 )
  ...
  v12 = (char *)v3;
  v13 = (v2 >> 14) & 0x3FF;
  DP_PRINT_STATS("HTT_SCHED_TXQ_CMD_POSTED_TLV_V:", v4, v5, v6, v7, v8, v9, v10, v11);
  if ( v13 )
  {
