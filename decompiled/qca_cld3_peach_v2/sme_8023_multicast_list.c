        ...
        double a11)
{
  ...
  if ( !a1
    ...
    || !cm_is_vdevid_connected(*(_QWORD *)(a1 + 21632), a2) && (csr_is_ndi_started(a1, a2) & 1) == 0 )
  {
    qdf_trace_msg(
      0x34u,
      2u,
...
LABEL_13:
  ...
  v25 = v24;
  if ( !cm_is_vdevid_connected(*(_QWORD *)(a1 + 21632), a2) && (csr_is_ndi_started(a1, a2) & 1) == 0 )
  {
    qdf_trace_msg(
      0x34u,
      2u,
  ...
  wlan_mlme_get_mac_vdev_id(*(_QWORD *)(a1 + 21632), a2, (void *)(v25 + 1444));
  wlan_mlme_get_bssid_vdev_id(*(_QWORD *)(a1 + 21632), a2, (void *)(v25 + 1450));
  LODWORD(v43) = 4251;
  v44 = v25;
