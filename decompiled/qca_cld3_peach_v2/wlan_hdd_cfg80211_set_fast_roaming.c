__int64 __fastcall wlan_hdd_cfg80211_set_fast_roaming(__int64 *a1, __int64 a2, int a3)
{
  ...
  v3 = a2 + 49152;
  v6 = sme_set_aggressive_roaming(a1[2], *(unsigned __int8 *)(*(_QWORD *)(a2 + 52832) + 8LL), 0);
  if ( v6 )
    return qdf_status_to_os_return(v6);
  is_rso_enabled = ucfg_is_rso_enabled(a1[1], *(unsigned __int8 *)(*(_QWORD *)(v3 + 3680) + 8LL));
  v9 = ucfg_user_space_enable_disable_rso(a1[1], *(unsigned __int8 *)(*(_QWORD *)(v3 + 3680) + 8LL), a3 != 0);
  if ( v9
    && (qdf_trace_msg(
          0x33u,
          2u,
  ...
  if ( (hdd_cm_is_vdev_associated(*(_QWORD *)(v3 + 3680)) & 1) == 0
