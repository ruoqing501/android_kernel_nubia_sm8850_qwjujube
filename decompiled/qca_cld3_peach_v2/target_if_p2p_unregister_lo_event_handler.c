__int64 __fastcall target_if_p2p_unregister_lo_event_handler(
        __int64 a1,
        __int64 a2,
        double a3,
        double a4,
        ...
        double a10)
{
  ...
  if ( wmi_unified_hdl )
  {
    v29 = wmi_unified_unregister_event(wmi_unified_hdl, 0x51u, v21, v22, v23, v24, v25, v26, v27, v28);
    v30 = v29 != 0;
    qdf_trace_msg(
      0x49u,
      8u,
      "%s: wmi unregister lo event handle, status:%d",
      v31,
      v32,
      v33,
      v34,
