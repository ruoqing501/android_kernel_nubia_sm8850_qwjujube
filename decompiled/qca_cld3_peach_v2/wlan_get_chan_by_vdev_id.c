...
LABEL_7:
  ...
  if ( (unsigned int)wlan_vdev_mlme_is_active(v12)
    || (active_channel = (_QWORD *)wlan_vdev_get_active_channel(v13)) == nullptr )
  {
    v23 = 4;
  }
  else
  {
    v23 = 0;
    *a3 = *active_channel;
    v14 = (unsigned int *)active_channel[4];
    v26 = active_channel[1];
    v27 = active_channel[2];
    a3[3] = active_channel[3];
    a3[4] = v14;
    a3[1] = v26;
    a3[2] = v27;
  }
