        ...
        double a10)
{
  ...
  *(_BYTE *)(a2 + 179) = 0;
  ...
  v14 = *v10;
  v15 = a2 + 4096;
  *(_BYTE *)(a2 + 7160) = *(_BYTE *)(a1[1] + 1298LL);
  if ( v11 == 1 )
  {
    v16 = *(_BYTE *)(a2 + 7024) & 0xFD | (2 * *(_BYTE *)(a1[1] + 5669LL));
    *(_BYTE *)(a2 + 7024) = v16;
  }
  else
  {
  ...
  v17 = *(unsigned __int8 *)(a1[1] + 5671LL);
  ...
  *(_BYTE *)(a2 + 7024) = v18;
  ...
  if ( v11 == 1 )
  {
    v18 = *(_BYTE *)(a1[1] + 5668LL) | v18 & 0xFE;
    *(_BYTE *)(v15 + 2928) = v18;
  }
  v19 = (v18 & 4) != 0 && v11 == 1;
  v20 = v18 | 8;
  if ( !v19 )
    v20 = v18 & 0xF7 | (8 * *(_BYTE *)(a1[1] + 5601LL));
  *(_BYTE *)(v15 + 2928) = v20;
  qdf_trace_msg(
    0x35u,
    8u,
  ...
  if ( *(_DWORD *)(a2 + 88) == 1 && !*(_WORD *)(a2 + 248) )
  {
    ...
    return (_QWORD *)sch_set_fixed_beacon_fields(a1, a2);
  }
  return result;
}
