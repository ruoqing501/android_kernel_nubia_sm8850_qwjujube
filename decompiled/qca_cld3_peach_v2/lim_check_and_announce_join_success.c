...
LABEL_10:
    ...
    if ( *(_DWORD *)(a4 + 7036) == 2 && *(_BYTE *)(a2 + 1328) )
    {
      ...
      if ( v21 >= 0x2DC6C0 )
        v21 = 3000000;
      *(_DWORD *)(a4 + 7092) = *(_DWORD *)(*(_QWORD *)(a1 + 8) + 3692LL);
      v22 = 4294968LL * v21;
      v23 = *(_QWORD *)(a1 + 8);
      v24 = *(_DWORD *)(v23 + 3692) + HIDWORD(v22);
      if ( (unsigned int)(v24 - 500) > 0x1194 )
        *(_DWORD *)(v23 + 3692) = 1000;
      else
        *(_DWORD *)(v23 + 3692) = v24;
    }
    else
    ...
    wlan_cm_get_check_assoc_disallowed(*(_QWORD *)(a1 + 21624), v58);
    ...
    else
    {
      ...
      *(_WORD *)(a4 + 176) = v36;
      ...
      if ( result && *(_BYTE *)(a2 + 2718) )
      {
        v54 = *(_QWORD *)(a2 + 2718);
        v55 = *(_QWORD *)(a2 + 2726);
        *(_QWORD *)(result + 839) = *(_QWORD *)(a2 + 2731);
        *(_QWORD *)(result + 826) = v54;
        *(_QWORD *)(result + 834) = v55;
