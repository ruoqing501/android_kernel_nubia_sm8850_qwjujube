__int64 __fastcall dp_print_tx_pdev_stats_sifs_tlv_v(unsigned int *a1)
{
  unsigned int v2; // w20
  __int64 v3; // x0
  double v4; // d0
  ...
  v2 = *a1;
  v3 = _qdf_mem_malloc(0x3E8u, "dp_print_tx_pdev_stats_sifs_tlv_v", 702);
  if ( !v3 )
    return qdf_trace_msg(
             ...
             v10,
             v11,
             "dp_print_tx_pdev_stats_sifs_tlv_v");
  v12 = v3;
  LODWORD(v13) = (v2 >> 14) & 0x3FF;
  DP_PRINT_STATS("HTT_TX_PDEV_STATS_SIFS_TLV_V:", v4, v5, v6, v7, v8, v9, v10, v11);
  if ( (_DWORD)v13 )
  {
    v22 = 0;
    v23 = 0;
