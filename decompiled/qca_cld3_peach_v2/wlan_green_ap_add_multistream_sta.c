__int64 __fastcall wlan_green_ap_add_multistream_sta(
        __int64 a1,
        double a2,
        double a3,
        double a4,
  ...
  if ( a1 )
  {
    ...
    if ( comp_private_obj )
    {
      ...
      qdf_trace_msg(
        0x5Du,
        8u,
        "%s: Green AP add multistream sta received",
        v10,
        v11,
        v12,
        v13,
        ...
        v16,
        v17,
        "wlan_green_ap_add_multistream_sta");
      ...
      else
      {
        ...
        return wlan_green_ap_state_mc(v18, 5u, v39, v40, v41, v42, v43, v44, v45, v46);
      }
    }
    else
    {
