__int64 __fastcall tdls_pe_del_peer(__int64 a1)
{
  __int64 v2; // x0
  double v3; // d0
  double v4; // d1
  ...
  v49 = 0;
  v50 = 0;
  v2 = _qdf_mem_malloc(0x14u, "tdls_pe_del_peer", 384);
  if ( !v2 )
  {
    v45 = 2;
    goto LABEL_21;
...
LABEL_19:
  ...
  *(_BYTE *)(v12 + 4) = *(_BYTE *)(v11 + 168);
  ...
  qdf_mem_copy((void *)(v12 + 14), *(const void **)(a1 + 8), 6u);
  qdf_trace_msg(
    0,
    8u,
    ...
    *(unsigned __int8 *)(v12 + 19));
  LOWORD(v49) = *(_WORD *)(v24 + 336);
  v50 = v12;
  v45 = scheduler_post_message_debug(0, 0x35u, 53, (unsigned __int16 *)&v49, 0x1A4u, (__int64)"tdls_pe_del_peer");
  if ( v45 )
  {
    v46 = "%s: fail to post pe msg to del peer";
LABEL_20:
    qdf_trace_msg(0, 2u, v46, v16, v17, v18, v19, v20, v21, v22, v23, "tdls_pe_del_peer");
    _qdf_mem_free(v12);
  }
LABEL_21:
