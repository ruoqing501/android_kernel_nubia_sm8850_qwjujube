      ...
      if ( wlan_hdd_validate_modules_state((__int64)context, v27, v28, v29, v30, v31, v32, v33, v34) )
      {
        ...
        if ( v73 )
        {
          ...
          do
          {
            ...
            {
              printk(&unk_AA9225, v56, v40, v41);
              printk(&unk_AC279B, *((unsigned int *)conn_info + 6), v57, v58);
              printk(&unk_9729B3, *((unsigned int *)conn_info + 1), v59, v60);
              printk(&unk_A5186D, *((unsigned int *)conn_info + 2), v61, v62);
              printk(&unk_A6B6C8, *(unsigned int *)conn_info, v63, v64);
              printk(&unk_A204C6, *((unsigned __int8 *)conn_info + 12), v65, v66);
              printk(&unk_94CD68, *((unsigned __int8 *)conn_info + 28), v67, v68);
              printk(&unk_A5184D, v69, v70, v71);
              v42 = v73;
        ...
        printk(&unk_9D5D2B, v45 & 1, v46 & 1, v47);
