  ...
  switch ( *a2 )
  {
    ...
    case 0x1409u:
      ...
      if ( result )
      {
        ...
        qdf_trace_msg(
          ...
          *((_DWORD *)a2 + 2));
        opmode_from_vdev_id = wlan_get_opmode_from_vdev_id(*(_QWORD *)(v11 + 21632), v60);
        result = v63;
    ...
    case 0x140Au:
      ...
      if ( (result & 1) != 0 )
      {
        ...
        if ( (result & 1) == 0 )
        {
          v124 = *(_QWORD *)(v11 + 17296) + 96LL * v114;
          if ( !v124 )
          {
            v204 = "csr_roam_chk_lnk_disassoc_ind";
            goto LABEL_176;
          }
          qdf_trace_msg(
            0x34u,
            ...
            if ( v61 )
            {
              if ( *(_BYTE *)(v61 + 96LL * *((unsigned __int8 *)a2 + 4) + 1) == 1 )
              {
                ...
                qdf_trace_msg(
                  ...
                  *((unsigned __int8 *)a2 + 17),
                  *((_DWORD *)a2 + 2));
                v64 = wlan_get_opmode_from_vdev_id(*(_QWORD *)(v11 + 21632), v60);
                result = v63;
                if ( (v64 & 0xFFFFFFFD) == 1 )
                {
                  v73 = *v62;
                  ...
                  *(_DWORD *)(v63 + 36) = 2;
                  *(_DWORD *)(v63 + 32) = *((_DWORD *)a2 + 2);
                  v74 = *(_QWORD *)(v11 + 17296);
                  if ( v74 && (*(_BYTE *)(v74 + 96LL * v60 + 1) & 1) != 0 )
                  {
LABEL_33:
                    wlan_get_operation_chan_freq_vdev_id(*(_QWORD *)(v11 + 21632), v60);
                    v75 = *(_DWORD **)(v11 + 22040);
                    if ( v75 )
                    {
                      v76 = *(_QWORD *)(v11 + 21624);
                      if ( *(v75 - 1) != 1469140685 )
                        __break(0x8228u);
...
LABEL_116:
      ...
      if ( (result & 1) != 0 )
        goto LABEL_199;
      v128 = (_DWORD *)(*(_QWORD *)(v11 + 17296) + 96LL * v114);
      if ( !v128 )
      {
        v204 = "csr_roam_chk_lnk_deauth_ind";
LABEL_176:
...
LABEL_173:
    ...
    case 0x1415u:
      ...
      if ( !(*(_QWORD *)(v11 + 17296) + 96LL * BYTE6(v210)) )
      {
        result = qdf_trace_msg(
                   0x34u,
                   2u,
      ...
      if ( !result )
        goto LABEL_199;
      v22 = result;
      v173 = wlan_get_opmode_from_vdev_id(*(_QWORD *)(v11 + 21632), v171);
      ...
      *(_BYTE *)(v22 + 273) = *((_BYTE *)a2 + 2901);
      if ( (v173 & 0xFFFFFFFD) != 1 )
        goto LABEL_191;
      if ( wlan_is_open_wep_cipher(*(_QWORD *)(v11 + 21632), v171) )
      {
...
LABEL_153:
      ...
      if ( !v11 || (v199 = *(_QWORD *)(v11 + 17296)) == 0 || (*(_BYTE *)(v199 + 96LL * v171 + 1) & 1) == 0 )
      {
        qdf_trace_msg(
          0x34u,
          2u,
      ...
      wlan_get_operation_chan_freq_vdev_id(*(_QWORD *)(v11 + 21632), v171);
      v200 = *(_DWORD **)(v11 + 22040);
      if ( v200 )
      {
        v201 = *(_QWORD *)(v11 + 21624);
...
LABEL_199:
    ...
    case 0x1417u:
      ...
      v105 = a2[20];
      v106 = *(_QWORD *)(v11 + 21632);
      LODWORD(v210) = *((_DWORD *)a2 + 9);
      WORD2(v210) = v105;
      BYTE6(v210) = 6;
      ...
      wlan_cm_init_occupied_ch_freq_list(*(_QWORD *)(v11 + 21632), *(_QWORD *)(v11 + 21624), BYTE6(v210));
      ...
      *(_DWORD *)(result + 148) = *((_DWORD *)a2 + 6);
      ...
      {
        if ( (unsigned int)(v197 - 11) > 0x13 && (unsigned int)(v197 - 31) > 9 )
          *(_DWORD *)(result + 284) = 0;
        else
          *(_DWORD *)(result + 284) = 2;
      }
      ...
      if ( v11 && (v205 = *(_QWORD *)(v11 + 17296)) != 0 && (*(_BYTE *)(v205 + 96LL * v107 + 1) & 1) != 0 )
      {
        wlan_get_operation_chan_freq_vdev_id(*(_QWORD *)(v11 + 21632), v107);
        v206 = *(_DWORD **)(v11 + 22040);
        if ( v206 )
        {
          v207 = *(_QWORD *)(v11 + 21624);
          if ( *(v206 - 1) != 1469140685 )
            __break(0x8228u);
          ((void (__fastcall *)(__int64, _QWORD, __int64, __int64, _QWORD))v206)(v207, v107, v196, 42, 0);
        }
        result = v196;
      }
      else
    ...
    case 0x141Bu:
      ...
      *(_QWORD *)(v22 + 88) = (char *)a2 + 11;
      if ( *((_BYTE *)a2 + 29) )
        ...
        v101 = 4;
      if ( v11 && (v102 = *(_QWORD *)(v11 + 17296)) != 0 && (*(_BYTE *)(v102 + 96LL * v99 + 1) & 1) != 0 )
      {
        wlan_get_operation_chan_freq_vdev_id(*(_QWORD *)(v11 + 21632), v99);
        v103 = *(_DWORD **)(v11 + 22040);
        if ( v103 )
        {
          v104 = *(_QWORD *)(v11 + 21624);
...
LABEL_138:
    ...
    case 0x1425u:
      ...
      if ( BYTE6(v210) > 5uLL )
        goto LABEL_197;
      *(_QWORD *)(v22 + 88) = a2 + 6;
      if ( !v11 || (v51 = *(_QWORD *)(v11 + 17296)) == 0 || (*(_BYTE *)(v51 + 96LL * v49 + 1) & 1) == 0 )
      {
        qdf_trace_msg(
          0x34u,
          2u,
      ...
      wlan_get_operation_chan_freq_vdev_id(*(_QWORD *)(v11 + 21632), v49);
      v25 = *(void (__fastcall **)(__int64, __int64, __int64, __int64, __int64))(v11 + 22040);
      if ( !v25 )
        goto LABEL_197;
      v26 = *(_QWORD *)(v11 + 21624);
      v27 = v49;
      v28 = v22;
      v29 = 19;
      v30 = 12;
    ...
    case 0x1439u:
      ...
      *(_DWORD *)(v22 + 23) = v153;
      ...
      if ( v23 > 5 )
        goto LABEL_113;
      v154 = *(_QWORD *)(v11 + 17296);
      if ( !v154 || (*(_BYTE *)(v154 + 96LL * v23 + 1) & 1) == 0 )
        goto LABEL_113;
      wlan_get_operation_chan_freq_vdev_id(*(_QWORD *)(v11 + 21632), v23);
      v25 = *(void (__fastcall **)(__int64, __int64, __int64, __int64, __int64))(v11 + 22040);
      if ( !v25 )
        goto LABEL_197;
      v26 = *(_QWORD *)(v11 + 21624);
    ...
    default:
      ...
      *(_QWORD *)(result + 368) = a2;
      v22 = result;
      v23 = *((unsigned __int8 *)a2 + 4);
      if ( v11 && v23 <= 5 && (v24 = *(_QWORD *)(v11 + 17296)) != 0 && (*(_BYTE *)(v24 + 96LL * v23 + 1) & 1) != 0 )
      {
        wlan_get_operation_chan_freq_vdev_id(*(_QWORD *)(v11 + 21632), v23);
        v25 = *(void (__fastcall **)(__int64, __int64, __int64, __int64, __int64))(v11 + 22040);
        if ( v25 )
