__int64 __fastcall lim_log_he_cap(
        double a1,
        double a2,
        double a3,
        double a4,
  ...
  if ( *(_BYTE *)a10 )
  {
    ...
    qdf_trace_msg(
      ...
      *(_QWORD *)(v11 + 1) >> 63,
      v138);
    v64 = *(_DWORD *)(v11 + 9);
    LODWORD(v139) = (v64 >> 9) & 7;
    LODWORD(v144) = (v64 >> 12) & 7;
    qdf_trace_msg(
      0x35u,
      8u,
      ...
      v144);
    v73 = *(_QWORD *)(v11 + 9);
    LODWORD(v140) = BYTE3(v73) & 7;
    LODWORD(v145) = ((unsigned int)v73 >> 27) & 7;
    qdf_trace_msg(
      0x35u,
      8u,
      ...
      (v73 >> 30) & 7);
    v82 = *(_QWORD *)(v11 + 9);
    LODWORD(v141) = (v82 >> 40) & 1;
    LODWORD(v146) = (v82 >> 41) & 1;
    qdf_trace_msg(
      0x35u,
      8u,
      ...
      v146);
    v91 = *(_QWORD *)(v11 + 9);
    LODWORD(v142) = (v91 >> 50) & 1;
    LODWORD(v147) = (v91 >> 46) & 7;
    qdf_trace_msg(
      0x35u,
      8u,
    ...
    qdf_trace_msg(
      ...
      *(unsigned __int16 *)(v11 - 2),
      v124 & 7,
      v143);
    return ((__int64 (__fastcall *)(__int64, __int64, __int64, __int64))qdf_trace_hex_dump)(53, 8, v11, 25);
  }
  return result;
}
