__int64 __fastcall wlan_objmgr_vdev_peer_attach(__int64 a1, __int64 a2)
{
  ...
  v5 = *(_DWORD *)(a2 + 68);
  v6 = *(_QWORD *)(a1 + 216);
  if ( v5 != 8 && v5 != 11 && *(unsigned __int16 *)(a1 + 224) >= (unsigned int)*(unsigned __int16 *)(a1 + 232) )
  {
    v28 = *(_QWORD *)(a1 + 1352);
    if ( (v28 & 1) == 0 )
    {
...
LABEL_56:
  ...
  {
    raw_spin_lock_bh(v6 + 1248);
    *(_QWORD *)(v6 + 1256) |= 1uLL;
    goto LABEL_13;
  }
LABEL_12:
  raw_spin_lock(v6 + 1248);
LABEL_13:
  v9 = *(_DWORD *)(a2 + 68);
  if ( v9 != 11 && v9 != 8 )
  {
    ...
    if ( v12 >= v13 && v14 >= *(unsigned __int16 *)(v6 + 74) - *(unsigned __int8 *)(v6 + 42) )
    {
      ...
      if ( (v29 & 1) != 0 )
      {
        *(_QWORD *)(v6 + 1256) = v29 & 0xFFFFFFFFFFFFFFFELL;
        raw_spin_unlock_bh(v6 + 1248);
      }
      else
      {
        raw_spin_unlock(v6 + 1248);
      }
      qdf_trace_msg(
        0x57u,
        2u,
...
LABEL_23:
    ...
    *(_QWORD *)(v6 + 1256) = v15 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(v6 + 1248);
    if ( (_ReadStatusReg(DAIF) & 0x80) != 0 )
      goto LABEL_26;
LABEL_24:
    ...
    if ( (*(_DWORD *)(v16 + 16) & 0xF0000) == 0 && (*(_DWORD *)(v16 + 16) & 0xFF00) == 0 )
    {
      ...
      *(_QWORD *)(a1 + 1352) |= 1uLL;
LABEL_27:
      qdf_list_insert_back((_QWORD *)(a1 + 192), (_QWORD *)(a2 + 16));
      ++*(_WORD *)(a1 + 224);
      ...
      else
      {
        qdf_trace_msg(
          ...
          0);
        v27 = 0x18D5D800048025LL;
      }
      *(_QWORD *)(a1 + 1352) = v27 & 0xFFFFFFFFFFFFFFFELL;
      raw_spin_unlock_bh(a1 + 1344);
      return 0;
    }
LABEL_26:
  ...
  {
    v38 = v6 + 1248;
    *(_QWORD *)(v6 + 1256) = v10 & 0xFFFFFFFFFFFFFFFELL;
    goto LABEL_56;
  }
  v11 = v6 + 1248;
LABEL_43:
