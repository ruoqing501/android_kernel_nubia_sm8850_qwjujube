__int64 __fastcall policy_mgr_is_special_mode_active_5g(__int64 a1, int a2)
{
  ...
  if ( context )
  {
    ...
    {
      v14 = BYTE4(qword_8D4F00);
    }
    else
    {
      v14 = 0;
    }
    if ( (_DWORD)qword_8D4F0C == a2 )
    {
      v15 = HIDWORD(qword_8D4F0C);
      if ( v15 >= (unsigned int)wlan_reg_min_5ghz_chan_freq() )
        v14 |= BYTE4(qword_8D4F24);
    }
    if ( (_DWORD)qword_8D4F30 == a2 )
    {
      v16 = HIDWORD(qword_8D4F30);
      if ( v16 >= (unsigned int)wlan_reg_min_5ghz_chan_freq() )
        v14 |= BYTE4(qword_8D4F48);
    }
    if ( (_DWORD)qword_8D4F54 == a2 )
    {
      v17 = HIDWORD(qword_8D4F54);
      if ( v17 >= (unsigned int)wlan_reg_min_5ghz_chan_freq() )
        v14 |= BYTE4(qword_8D4F6C);
    }
    if ( (_DWORD)qword_8D4F78 == a2 )
    {
      v18 = HIDWORD(qword_8D4F78);
      if ( v18 >= (unsigned int)wlan_reg_min_5ghz_chan_freq() )
        v14 |= BYTE4(qword_8D4F90);
    }
