__int64 __fastcall _lim_process_sme_disassoc_req(
        __int64 a1,
        const void *a2,
        double a3,
        double a4,
        ...
        double a10)
{
  ...
  if ( (lim_is_sme_disassoc_req_valid(a1, v59, 0) & 1) == 0 )
  {
    ...
    *(_BYTE *)(a1 + 4012) = 0;
LABEL_15:
    result = lim_send_sme_disassoc_ntf(a1, (char *)&v59[1] + 3, &v57, 500);
    goto LABEL_31;
  }
  ...
  *(_BYTE *)(v29 + 8674) = BYTE5(v59[2]);
  if ( v38 == 1 )
  {
    lim_mlo_sap_validate_and_update_ra(v29, (char *)&v59[1] + 3);
  }
  else
  {
    if ( v38 != 2 )
...
LABEL_18:
    ...
    if ( v39 <= 9 )
    {
      if ( v39 == 7 )
      {
        ...
        v43 = 0;
LABEL_19:
        result = lim_send_sme_disassoc_ntf(a1, (char *)&v59[1] + 3, &v57, v43);
        goto LABEL_31;
      }
      if ( v39 == 8 )
        goto LABEL_10;
...
LABEL_22:
      qdf_trace_msg(
        ...
        v37,
        "__lim_process_sme_disassoc_req");
      result = lim_print_sme_state(a1, 2, *(unsigned int *)(v29 + 80));
      if ( !*(_BYTE *)(a1 + 4012) )
        goto LABEL_31;
      if ( *(_DWORD *)(v29 + 80) != 5 )
        *(_BYTE *)(a1 + 4012) = 0;
...
LABEL_27:
  ...
  v44 = WORD1(v59[2]);
  result = _qdf_mem_malloc(0xEu, "__lim_process_sme_disassoc_req", 7308);
  if ( result )
  {
    ...
    *(_BYTE *)(result + 12) = v45;
    ...
    result = lim_process_mlm_req_messages(a1, (unsigned __int16 *)v56, v47, v48, v49, v50, v51, v52, v53, v54);
  }
LABEL_31:
