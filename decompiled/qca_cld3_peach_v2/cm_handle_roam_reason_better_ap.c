__int64 __fastcall cm_handle_roam_reason_better_ap(
        unsigned __int8 a1,
        unsigned int a2,
        double a3,
        double a4,
        ...
        double a10)
{
  ...
  __int64 (__fastcall *v41)(__int64); // [xsp+18h] [xbp-28h]
  ...
  result = (__int64)_cds_get_context(54, (__int64)"wma_handle_roam_reason_better_ap", a3, a4, a5, a6, a7, a8, a9, a10);
  if ( result )
  {
    v21 = result;
    qdf_trace_msg(
      0x36u,
      8u,
      "%s: Better AP found for vdevid %x, rssi %d",
      v13,
      v14,
      v15,
      v16,
      ...
      v19,
      v20,
      "wma_handle_roam_reason_better_ap",
      a1,
      a2);
    mlme_set_roam_reason_better_ap(
      *(_QWORD *)(*(_QWORD *)(v21 + 520) + 488LL * a1),
      0,
      v22,
      v23,
      v24,
