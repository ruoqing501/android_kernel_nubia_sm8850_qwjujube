__int64 __fastcall reg_get_reg_chan(
        __int64 a1,
        unsigned int a2,
        double a3,
        double a4,
...
LABEL_13:
      v25 = jiffies;
      if ( reg_get_reg_chan___last_ticks - jiffies + 125 >= 0 )
        return 0;
      qdf_trace_msg(
        0x51u,
        2u,
        ...
        "reg_get_reg_chan",
        v22);
      reg_get_reg_chan___last_ticks = v25;
      return 0;
    }
    result = pdev_obj + 36LL * (unsigned int)v22;
    if ( *(_DWORD *)(result + 8) )
      return result;
    qdf_trace_msg(
      0x51u,
      2u,
      "%s: Channel %u is not enabled for this pdev",
      v12,
      v13,
      v14,
      v15,
