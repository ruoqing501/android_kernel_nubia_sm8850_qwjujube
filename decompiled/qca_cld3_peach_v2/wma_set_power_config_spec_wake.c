__int64 __fastcall wma_set_power_config_spec_wake(
        unsigned __int8 a1,
        unsigned __int16 a2,
        double a3,
        double a4,
        ...
        double a10)
{
  ...
  context = _cds_get_context(54, (__int64)"wma_set_power_config_spec_wake", a3, a4, a5, a6, a7, a8, a9, a10);
  if ( !context )
  {
    qdf_trace_msg(
      0x36u,
      ...
      v19,
      v20,
      "wma_set_power_config_spec_wake");
LABEL_6:
    result = 4;
    goto LABEL_8;
  }
