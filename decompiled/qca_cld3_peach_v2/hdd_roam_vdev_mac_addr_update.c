__int64 __fastcall hdd_roam_vdev_mac_addr_update(
        __int64 a1,
        unsigned __int8 *a2,
        unsigned __int8 *a3,
        double a4,
        ...
        double a11)
{
  ...
  context = _cds_get_context(51, (__int64)"hdd_roam_vdev_mac_addr_update", a4, a5, a6, a7, a8, a9, a10, a11);
  link_info_by_link_addr = hdd_get_link_info_by_link_addr(context, a2);
  ...
  if ( (_DWORD)v25 != v24 )
  {
    ...
    v65 = 6460;
LABEL_19:
    _cds_trigger_recovery(44, (__int64)"hdd_roam_vdev_mac_addr_update", v65, v57, v58, v59, v60, v61, v62, v63, v64);
    result = 4;
    goto LABEL_20;
  }
  v26 = (_QWORD *)link_info_by_link_addr;
  v27 = hdd_get_link_info_by_link_addr(context, a3);
  if ( !v27 )
  {
    if ( a3 )
    {
