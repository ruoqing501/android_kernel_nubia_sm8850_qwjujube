...
LABEL_23:
    ...
    a5 = *((_WORD *)v58 + 12);
LABEL_10:
    v43 = *(void (__fastcall **)(__int64, __int64))(a1 + 14704);
    if ( v43 )
    {
    ...
    ((void (__fastcall *)(__int64, _QWORD, _QWORD, __int64))lim_tear_down_link_with_ap)(
      a1,
      *(unsigned __int8 *)(session_by_vdev_id + 8),
      a5,
      5);
    goto LABEL_15;
  }
