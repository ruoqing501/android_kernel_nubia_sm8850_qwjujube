__int64 __fastcall target_if_twt_disable_comp_event_handler(
        __int64 a1,
        __int64 a2,
        double a3,
        double a4,
...
LABEL_16:
  ...
  if ( !psoc_from_scn_hdl )
  {
    v43 = "%s: psoc is null";
LABEL_15:
    qdf_trace_msg(0x49u, 2u, v43, v21, v22, v23, v24, v25, v26, v27, v28, "target_if_twt_disable_comp_event_handler");
    goto LABEL_16;
  }
  ...
  v33 = wmi_extract_twt_disable_comp_event(v31, a2, &v46);
  if ( v33 )
  {
    v42 = v33;
    qdf_trace_msg(
      0x49u,
      2u,
      "%s: TWT disable extract event failed(status=%d)",
      v34,
      v35,
      v36,
      v37,
  ...
  {
    v45 = *(__int64 (__fastcall **)(__int64, __int64 *))(v29 + 1320);
    if ( *((_DWORD *)v45 - 1) != 1652520814 )
      __break(0x8228u);
    v42 = v45(v32, &v46);
  }
