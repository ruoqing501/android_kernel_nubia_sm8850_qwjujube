__int64 __fastcall trace_event_raw_event_kgsl_context_create(__int64 a1, __int64 a2, __int64 a3, unsigned int a4)
{
  __int64 v6; // x8
  const char *v7; // x22
  int v8; // w23
    ...
    || (v14 = a2, result = _trace_trigger_soft_disabled(a1), a2 = v14, (result & 1) == 0) )
  {
    ...
    if ( result )
    {
      ...
      v13 = (_DWORD *)result;
      *(_DWORD *)(result + 8) = v11;
      memcpy((void *)(result + 28), v7, v12);
      *(_BYTE *)(v10 + v12) = 0;
      v13[3] = *(_DWORD *)(a3 + 4);
      v13[4] = a4 & 0xFE0F0FFF;
      v13[5] = (unsigned __int16)a4 >> 12;
      v13[6] = (a4 >> 20) & 0x1F;
