__int64 __fastcall perf_trace_adreno_drawctxt_template(__int64 result, __int64 a2)
{
  __int64 v2; // x30
  __int64 v3; // x21
  __int64 v4; // x19
  ...
  {
    result = perf_trace_buf_alloc(20, v13, &v12);
    if ( result )
    {
      v8 = (_QWORD *)v13[0];
      v9 = v12;
      ...
      *(_DWORD *)(result + 12) = *(_DWORD *)(a2 + 8);
      result = perf_trace_run_bpf_submit(result, 20, v9, v4, 1, v10, StatusReg + v6, 0);
    }
  }
