__int64 __fastcall gen8_hfi_send_generic_req_v5(__int64 a1, int *a2, int *a3, unsigned int a4)
{
  __int64 result; // x0
  int v7; // w4
  ...
  {
    result = gen8_hfi_send_cmd_wait_inline(a1, a2, a4, a3);
    if ( (_DWORD)result )
      goto LABEL_6;
    v7 = a3[4];
    switch ( v7 )
...
LABEL_14:
  ...
  v8 = 0;
  v9 = 0;
  result = gen8_hfi_send_cmd_wait_inline(a1, a2, a4, (int *)&v8);
  if ( !(_DWORD)result )
  {
    if ( !HIDWORD(v9) )
    {
