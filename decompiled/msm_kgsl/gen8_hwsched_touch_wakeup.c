__int64 __fastcall gen8_hwsched_touch_wakeup(__int64 a1)
{
  __int64 result; // x0
  __int64 v3; // x20
  __int64 v4; // x0
  ...
  if ( (*(_QWORD *)(result + 1040) & 0x10) == 0 && (*(_QWORD *)(result + 1040) & 1) != 0 )
  {
    if ( (*(_QWORD *)(result + 1040) & 2) != 0 )
    {
LABEL_7:
    ...
    result = gen8_hwsched_gmu_boot(a1);
    if ( !(_DWORD)result )
    {
