__int64 __fastcall perf_trace_kgsl_reclaim_process(__int64 result, __int64 a2, int a3, char a4)
{
  __int64 v4; // x30
  __int64 v5; // x23
  __int64 v8; // x19
  ...
  {
    result = perf_trace_buf_alloc(28, v18, &v17);
    if ( result )
    {
      v12 = (_QWORD *)v18[0];
      ...
      *(_DWORD *)(result + 12) = a3;
      v14 = v17;
      v15 = v18[0];
      *(_DWORD *)(result + 16) = *(_DWORD *)(a2 + 400);
      *(_BYTE *)(result + 20) = a4 & 1;
      result = perf_trace_run_bpf_submit(result, 28, v14, v8, 1, v15, StatusReg + v10, 0);
    }
  }
