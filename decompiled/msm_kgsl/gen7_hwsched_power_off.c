__int64 __fastcall gen7_hwsched_power_off(__int64 a1)
{
  __int64 v2; // x0
  __int64 result; // x0
  __int64 v4; // x20
  ...
  if ( (*(_QWORD *)(a1 + 22496) & 0x10) != 0 )
  {
    ...
    {
      v7 = next;
      while ( *(_BYTE *)(v7 + 288) != 1 || !(unsigned int)gen7_hwsched_check_context_inflight_hw_fences(a1) )
      {
        ++v23;
