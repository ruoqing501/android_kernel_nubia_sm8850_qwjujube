__int64 __fastcall gen7_gmu_snapshot_itcm(__int64 a1, __int64 a2, unsigned __int64 a3, __int64 a4)
{
  __int64 v6; // x8
  ...
  if ( *(_QWORD *)(a4 + 1088) )
  {
    if ( (unsigned __int64)*(unsigned int *)(*(_QWORD *)(a1 + 8224) + 4LL) + 28 <= a3 )
    {
      ...
      *(_QWORD *)(a2 + 20) = 0;
      *(_QWORD *)(a2 + 12) = v6;
      memcpy((void *)(a2 + 28), *(const void **)(a4 + 1088), *(unsigned int *)(*(_QWORD *)(a1 + 8224) + 4LL));
      return *(unsigned int *)(*(_QWORD *)(a1 + 8224) + 4LL) + 28LL;
    }
    else
    {
      if ( (unsigned int)__ratelimit(&gen7_gmu_snapshot_itcm__rs, "gen7_gmu_snapshot_itcm") )
