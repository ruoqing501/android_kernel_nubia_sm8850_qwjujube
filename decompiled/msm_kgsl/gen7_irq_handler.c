__int64 __fastcall gen7_irq_handler(_QWORD *a1)
{
  _QWORD *v2; // x24
  __int64 v3; // x22
  ...
  if ( (unsigned int)kgsl_regmap_read(a1 + 1650) )
  {
    ...
    if ( (unsigned int)__ratelimit(&gen7_irq_poll_fence__rs, "gen7_irq_poll_fence") )
      dev_crit(
        *a1,
...
LABEL_14:
    ...
    result = adreno_irq_callbacks((__int64)a1, (__int64)&gen7_irq_funcs, v13);
  }
  __dmb(9u);
  if ( (v2[496] & 2) == 0 )
  {
