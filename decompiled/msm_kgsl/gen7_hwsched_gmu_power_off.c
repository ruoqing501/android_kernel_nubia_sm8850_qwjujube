__int64 __fastcall gen7_hwsched_gmu_power_off(__int64 a1)
{
  __int64 v2; // x0
  unsigned int v3; // w8
  int v4; // w9
  ...
  if ( (*(_BYTE *)(a1 + 13192) & 1) != 0 || (unsigned int)gen7_gmu_wait_for_lowest_idle(a1) )
    goto LABEL_6;
  v2 = to_gen7_gmu(a1);
  v3 = *(_DWORD *)(a1 + 10052);
  v4 = *(_DWORD *)(v2 + 1352);
  ...
  if ( v3 < 0x20 )
  {
    ...
    v6 = gen7_hfi_send_cmd_async(a1, v8, 12);
    gmu_core_regwrite(a1, 129265, 1);
    if ( !v6 && !(unsigned int)gen7_gmu_wait_for_idle(a1) )
    {
      gen7_rscc_sleep_sequence(a1);
