__int64 __fastcall gen8_hfi_start(__int64 a1)
{
  __int64 v2; // x20
  _DWORD *v3; // x8
  unsigned int v4; // w21
  ...
  if ( v3[30] )
    v3[40] = v3[41];
  v4 = ((__int64 (__fastcall *)(__int64))gen8_hfi_send_gpu_perf_table)(a1);
  if ( v4 )
    goto LABEL_22;
  v37 = 0;
  v38 = 0;
  ...
  v23 = 0;
  v24 = 0;
  v4 = gen8_hfi_send_cmd_wait_inline(a1, (int *)(v2 + 56), 0x280u, (int *)&v23);
  if ( v4 )
    goto LABEL_22;
  if ( HIDWORD(v24) )
  {
  ...
  v4 = gen8_hfi_send_acd_feature_ctrl(a1);
  if ( v4 )
    goto LABEL_22;
  if ( *(_BYTE *)(a1 + 20437) == 1 )
  {
    ...
    v24 = 0;
    v20 = 0xB0000000BLL;
    v4 = gen8_hfi_send_generic_req_v5(a1, (int *)&v20, (int *)&v23, 0x10u);
    if ( (v4 & 0x80000000) != 0 )
    {
      v8 = *(_QWORD *)(a1 + 1544);
...
LABEL_14:
  v4 = gen8_hfi_send_minbw_feature_ctrl(a1);
  if ( v4 )
    goto LABEL_22;
  v4 = gen8_hfi_send_clx_feature_ctrl(a1);
  if ( v4 )
    goto LABEL_22;
  v4 = gen8_hfi_send_ifpc_feature_ctrl(a1);
  if ( v4 )
    goto LABEL_22;
  v4 = gen8_hfi_send_core_fw_start(a1);
  if ( v4 )
    goto LABEL_22;
