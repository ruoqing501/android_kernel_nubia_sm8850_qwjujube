__int64 __fastcall perf_trace_adreno_syncobj_submitted(__int64 result, int a2, int a3, int a4, __int64 a5)
{
  __int64 v5; // x30
  __int64 v6; // x24
  __int64 v9; // x19
  ...
  {
    result = perf_trace_buf_alloc(36, v19, &v18);
    if ( result )
    {
      v14 = (_QWORD *)v19[0];
      v15 = v18;
      ...
      *(_DWORD *)(result + 16) = a4;
      *(_QWORD *)(result + 24) = a5;
      result = perf_trace_run_bpf_submit(result, 36, v15, v9, 1, v16, StatusReg + v12, 0);
    }
  }
