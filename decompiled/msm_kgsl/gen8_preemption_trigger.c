__int64 __fastcall gen8_preemption_trigger(__int64 result, char a2)
{
  unsigned int *v2; // x19
  __int64 v3; // x24
  __int64 v4; // x23
...
LABEL_32:
  ...
  gmu_core_regwrite(v2, 128997, 1);
  if ( (unsigned int)gen8_fenced_write(v2, 2243, *(_DWORD *)(*(_QWORD *)(v7 + 184) + 24LL), 2)
    || (a2 & 1) == 0 && (unsigned int)gmu_core_dev_wait_for_active_transition(v2)
    || (unsigned int)gen8_fenced_write(v2, 2244, *(_DWORD *)(*(_QWORD *)(v7 + 184) + 28LL), 2)
    || (unsigned int)gen8_fenced_write(v2, 2245, *(_DWORD *)(*(_QWORD *)(v7 + 192) + 24LL), 2)
    || (unsigned int)gen8_fenced_write(v2, 2246, *(_DWORD *)(*(_QWORD *)(v7 + 192) + 28LL), 2)
    || (unsigned int)gen8_fenced_write(v2, 2247, v31, 2)
    || (unsigned int)gen8_fenced_write(v2, 2248, HIDWORD(v31), 2) )
  {
    goto LABEL_29;
  }
  *((_QWORD *)v2 + 2456) = v7;
  ...
  if ( *(_BYTE *)(v4 + 949) )
    ...
    v15 = v14;
  trace_adreno_preempt_trigger_1(
  ...
  *(_DWORD *)(v4 + 856) = 2;
  ...
  result = gen8_fenced_write(v2, 2240, v15, 2);
  if ( (_DWORD)result )
  {
    *((_QWORD *)v2 + 2456) = 0;
...
LABEL_29:
    ...
    *(_DWORD *)(v4 + 856) = 0;
    __dmb(0xAu);
    result = gmu_core_regwrite(v2, 128997, 0);
  }
LABEL_33:
