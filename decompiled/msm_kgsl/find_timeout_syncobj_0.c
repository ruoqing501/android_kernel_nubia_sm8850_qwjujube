__int64 __fastcall find_timeout_syncobj_0(__int64 a1, unsigned int a2, int a3)
{
  __int64 v6; // x24
  unsigned int *v7; // x0
  unsigned int v8; // w8
  ...
  __int64 v40; // x1
  int v42; // w8
  __int64 v43; // [xsp+0h] [xbp-D0h]
  __int64 s; // [xsp+8h] [xbp-C8h] BYREF
  __int64 v45; // [xsp+10h] [xbp-C0h]
  unsigned int v46; // [xsp+18h] [xbp-B8h]
  __int64 v47; // [xsp+20h] [xbp-B0h] BYREF
  __int64 v48; // [xsp+28h] [xbp-A8h]
  __int64 v49; // [xsp+30h] [xbp-A0h]
  __int64 v50; // [xsp+38h] [xbp-98h]
  _QWORD v51[18]; // [xsp+40h] [xbp-90h] BYREF

  v51[16] = *(_QWORD *)(_ReadStatusReg(SP_EL0) + 1808);
  v6 = to_gen8_gmu(a1);
  v46 = 0;
  s = 0;
  v45 = 0;
      ...
      if ( (unsigned __int8)v21 == 152 )
      {
        ...
        if ( HIDWORD(v45) == a3 )
        {
          ...
          while ( 2 )
          {
            ...
            if ( (_DWORD)result )
              goto LABEL_16;
            v27 = scnprintf(v51, 128, "syncobj[%d] ctxt_id:%llu seqno:%llu flags:", v25, v48, v49);
            v28 = v50;
            v29 = v27;
            if ( (v50 & 1) != 0 )
            {
              v31 = scnprintf((char *)v51 + v27, 128 - v27, "%s", "KGSL");
              v28 = v50;
              v29 += v31;
              if ( (v50 & 2) != 0 )
              {
                v32 = scnprintf((char *)v51 + v29, 128 - v29, "|%s", "SIGNALED");
                goto LABEL_36;
              }
              v30 = 0;
            }
            else
            {
              ...
              v32 = scnprintf((char *)v51 + v27, 128 - v27, "%s", "SIGNALED");
LABEL_36:
              v28 = v50;
              v30 = 0;
              v29 += v32;
...
LABEL_45:
            ...
            ++v25;
            v26 = ((unsigned __int64)(unsigned int)v26 + 8) % *(unsigned int *)(v43 + 8);
            if ( v25 >= v46 )
              goto LABEL_16;
            continue;
          }
