__int64 __fastcall perf_trace_kgsl_clock_throttling(__int64 result, int a2, int a3, int a4, int a5, __int64 a6)
{
  __int64 v6; // x30
  __int64 v7; // x25
  __int64 v10; // x19
  ...
  {
    result = perf_trace_buf_alloc(36, v21, &v20);
    if ( result )
    {
      v16 = (_QWORD *)v21[0];
      v17 = v20;
      ...
      *(_DWORD *)(result + 20) = a5;
      *(_QWORD *)(result + 24) = a6;
      result = perf_trace_run_bpf_submit(result, 36, v17, v10, 1, v18, StatusReg + v14, 0);
    }
  }
