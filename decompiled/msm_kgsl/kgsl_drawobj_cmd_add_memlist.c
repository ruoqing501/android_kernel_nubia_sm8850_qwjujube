__int64 __fastcall kgsl_drawobj_cmd_add_memlist(_QWORD *a1, __int64 a2, __int64 a3, unsigned int a4, int a5)
{
  int v5; // w19
  __int64 v7; // x22
  __int64 result; // x0
  ...
  unsigned __int64 v15; // [xsp+10h] [xbp-20h]
  unsigned __int64 v16; // [xsp+18h] [xbp-18h]
...
LABEL_26:
        ...
        if ( (v17 & 0x10) != 0 )
        {
          add_profiling_buffer((unsigned __int64)a1, a2, v15, v16, HIDWORD(v17), v14);
        }
        else
        {
          result = kgsl_drawobj_add_memobject(a2 + 104, &v14);
          if ( (_DWORD)result )
            goto LABEL_5;
        }
        --v5;
