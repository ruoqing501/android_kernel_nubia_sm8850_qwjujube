__int64 __fastcall gen7_hwsched_create_hw_fence(__int64 a1, __int64 a2)
{
  __int64 v4; // x22
  __int64 v5; // x19
  unsigned int v6; // w25
...
LABEL_44:
  ...
  if ( v8 != v9 )
  {
    if ( v8 > v9 && ((v8 - v9) & 0x80000000) == 0
      ...
      && v18 <= 0x80000000 )
    {
      hw_fence_entry = allocate_hw_fence_entry(a1, v5, a2);
      if ( hw_fence_entry )
      {
        v20 = *(_QWORD **)(v5 + 2064);
        ...
        v26 = (_QWORD *)*v20;
        v27 = (_QWORD *)(hw_fence_entry + 64);
        if ( *(_QWORD **)(*v20 + 8LL) != v20 || v27 == v20 || v26 == v27 )
        {
          _list_add_valid_or_report(hw_fence_entry + 64, v20);
        }
        else
        {
          v26[1] = v27;
          *(_QWORD *)(hw_fence_entry + 64) = v26;
          *(_QWORD *)(hw_fence_entry + 72) = v20;
          *v20 = v27;
        }
      }
      goto LABEL_57;
...
LABEL_57:
  ...
  v28 = allocate_hw_fence_entry(a1, v5, a2);
  if ( !v28 )
    goto LABEL_57;
  v29 = v28;
  v30 = send_hw_fence_no_ack(a1, v28);
  if ( !v30 )
  {
    _list_add(v29 + 64, *(_QWORD *)(v5 + 2080), v5 + 2072);
    goto LABEL_57;
  }
  v31 = v30;
  if ( (unsigned int)__ratelimit(&gen7_hwsched_create_hw_fence__rs, "gen7_hwsched_create_hw_fence") )
    dev_err(
      *(_QWORD *)(a1 + 1544) + 16LL,
