__int64 __fastcall gen8_cx_timer_init(__int64 result)
{
  ...
  if ( (*(_QWORD *)(result + 14240) & 0x20000) == 0 )
  {
    ...
    do
    {
      ...
      if ( *(_DWORD *)(arch_timer_read_counter - 4LL) != -1073338243 )
        __break(0x8228u);
      v14 = v12();
      kgsl_regmap_write(v7 + 13200, (unsigned int)v14);
      v15 = kgsl_regmap_write(v7 + 13200, HIDWORD(v14));
      __dsb(0xFu);
    ...
    kgsl_regmap_write(v7 + 13200, (unsigned int)v20);
    result = kgsl_regmap_write(v7 + 13200, HIDWORD(v20));
    _WriteStatusReg(DAIF, v17);
    _X8 = (unsigned __int64 *)(v7 + 14240);
    __asm { PRFM            #0x11, [X8] }
    do
      v23 = __ldxr(_X8);
