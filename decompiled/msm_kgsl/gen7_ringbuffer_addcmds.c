__int64 __fastcall gen7_ringbuffer_addcmds(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        char a4,
    ...
    else
    {
      ...
      *(_DWORD *)(a2 + 36) = v15;
      ...
      if ( (unsigned __int64)v16 < 0xFFFFFFFFFFFFF001LL )
      {
        ...
        *v16 = 1880096769;
        v16[1] = v17;
        v18 = gen7_preemption_pre_ibsubmit(a1, (unsigned __int64 *)a2, a3, (__int64)(v16 + 2));
        ...
        *(_DWORD *)(a2 + 16) = v36
                             - a6
                             + *(_DWORD *)(a2 + 16)
                             + gen7_preemption_post_ibsubmit((_QWORD *)a1, (__int64)&v12[v36 + 6])
                             - 98;
        LODWORD(v12) = gen7_ringbuffer_submit(a2, a8);
      }
    }
  }
