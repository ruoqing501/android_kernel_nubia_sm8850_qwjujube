__int64 __fastcall log_kgsl_cmdbatch_submitted_event(__int64 result, int a2, int a3, __int64 a4)
{
  int v4; // w22
  __int64 v8; // x0
  __int64 v9; // x1
  ...
  if ( kgsl_eventlog )
  {
    ...
    v12 = v8;
    v13 = eventlog_wptr;
    v14 = eventlog_wptr + 44;
    if ( (unsigned int)(eventlog_wptr + 44) <= 0x17FE8 )
    {
