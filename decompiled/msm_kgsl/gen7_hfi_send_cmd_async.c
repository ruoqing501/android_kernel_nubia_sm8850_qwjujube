__int64 __fastcall gen7_hfi_send_cmd_async(__int64 a1, int *a2, unsigned int a3)
{
  int v6; // w10
  int v7; // w24
  ...
  _X9 = (unsigned int *)(to_gen7_gmu(a1) + 44);
  __asm { PRFM            #0x11, [X9] }
  do
  {
    v23 = __ldxr(_X9);
  ...
  *a2 = v7;
  ...
  v37 = 0;
  v38 = nullptr;
  _init_swait_queue_head(v36, "&x->wait", &init_completion___key_2);
  raw_write_lock_irq(a1 + 24556);
  v8 = *(unsigned __int64 **)(a1 + 24576);
  if ( &v37 == (unsigned __int64 *)(a1 + 24568) || &v37 == v8 || *v8 != a1 + 24568 )
  {
  ...
  LODWORD(v25) = v7;
  v9 = gen7_hfi_cmdq_write(a1, a2, a3);
  if ( !v9 )
  {
    v9 = adreno_hwsched_wait_ack_completion(a1, *(_QWORD *)(a1 + 1544) + 16LL, &v25, gen7_hwsched_process_msgq);
    if ( !v9 )
    {
