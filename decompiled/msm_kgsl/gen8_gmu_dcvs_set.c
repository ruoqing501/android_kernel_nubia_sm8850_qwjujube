__int64 __fastcall gen8_gmu_dcvs_set(__int64 a1, unsigned int a2, int a3, unsigned int a4)
{
  _QWORD *v4; // x20
  __int64 result; // x0
  int v6; // w8
...
LABEL_2:
  ...
  {
    LODWORD(v21) = 30;
    result = gen8_hfi_send_generic_req(a1, &v21, 16);
    if ( (_DWORD)result )
    {
      v8 = result;
      if ( (unsigned int)__ratelimit(&gen8_gmu_dcvs_set__rs, "gen8_gmu_dcvs_set") )
    ...
    while ( v22 != 255 )
    {
      ...
      {
        v13 = result;
        gmu_core_rdpm_mx_freq_update(a1, *(unsigned int *)(a1 + 12LL * v22 - 520));
        result = v13;
        break;
      }
      __break(0x5512u);
