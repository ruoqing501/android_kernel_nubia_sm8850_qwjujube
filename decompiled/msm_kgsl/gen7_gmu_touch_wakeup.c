__int64 __fastcall gen7_gmu_touch_wakeup(__int64 result)
{
  __int64 v2; // x19
  __int64 v3; // x0
  unsigned __int64 v9; // x8

  _X20 = (unsigned __int64 *)(result - 680);
  if ( (*(_QWORD *)(result - 680) & 0x10) == 0 && (*_X20 & 1) != 0 )
  {
    v2 = result;
    if ( (*_X20 & 2) != 0 )
    {
LABEL_7:
    ...
    result = gen7_gmu_boot(v2);
    if ( !(_DWORD)result )
    {
      result = gen7_gpu_boot(v2);
      if ( !(_DWORD)result )
      {
