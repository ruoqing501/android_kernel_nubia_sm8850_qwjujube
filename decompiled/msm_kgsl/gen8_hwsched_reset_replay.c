__int64 __fastcall gen8_hwsched_reset_replay(__int64 a1)
{
  __int64 v2; // x20
  __int64 v3; // x21
  _QWORD *i; // x23
  ...
  _QWORD *v62; // [xsp+0h] [xbp-20h] BYREF
  _QWORD **v63; // [xsp+8h] [xbp-18h]
  int v64; // [xsp+14h] [xbp-Ch] BYREF
  __int64 v65; // [xsp+18h] [xbp-8h]

  v65 = *(_QWORD *)(_ReadStatusReg(SP_EL0) + 1808);
  v2 = to_gen8_gmu(a1);
  v3 = to_gen8_hwsched_hfi(a1);
  raw_read_lock(v3 + 4);
  ...
  if ( (*(_QWORD *)(v2 + 1040) & 2) != 0 )
  {
    ...
    *(_DWORD *)(a1 + 23156) = 0;
    ...
    if ( (unsigned int)gen8_hwsched_boot(a1) )
      goto LABEL_116;
    adreno_hwsched_replay(a1);
    guilty_context_0 = get_guilty_context_0(a1);
    if ( guilty_context_0 )
    {
      _X20 = guilty_context_0;
      do
      {
        ...
        else
        {
          do
          {
            ...
            v12 = v11 - 8;
            v13 = v14;
            v15 = gen8_send_hw_fence_hfi_wait_ack(a1, v12, 1);
            v16 = v15 == 0;
            if ( v15 )
              break;
    ...
    v64 = 0;
    next = idr_get_next(a1 + 11184, &v64);
    if ( next )
    {
      v20 = next;
      while ( 1 )
...
LABEL_61:
        v31 = v63;
        v32 = (_QWORD **)(v21 + 2);
        if ( v21 + 2 == &v62 || v63 == v32 || *v63 != &v62 )
        {
          _list_add_valid_or_report(v32, v63);
        }
        else
        {
          v63 = (_QWORD **)(v21 + 2);
    ...
    if ( v62 != &v62 )
    {
      ...
      while ( 1 )
      {
        ...
        *v33 = v33;
        ...
        {
          v41 = v40 ^ 0x80000000;
          _CF = (v38 ^ 0x80000000) >= v41;
          v42 = (v38 ^ 0x80000000) - v41;
          if ( v42 == 0 || !_CF || v42 > 0x80000000 )
            goto LABEL_92;
        }
        if ( !_X20 )
          goto LABEL_92;
        ...
        if ( v44 )
          goto LABEL_91;
LABEL_92:
        v47 = gen8_send_hw_fence_hfi_wait_ack(a1, v33 - 10, 0);
        v48 = v47 == 0;
        if ( !v47 && (v34 & 1) != 0 )
        {
          *(_DWORD *)(v39 + 12) = v38;
...
LABEL_110:
    if ( (unsigned int)gen8_hwsched_process_detached_hw_fences(a1)
      || (unsigned int)gen8_hwsched_disable_hw_fence_throttle(a1) )
    {
      goto LABEL_116;
    }
  }
