__int64 __fastcall gen8_rscc_wakeup_sequence(__int64 a1)
{
  __int64 v3; // x0
  _QWORD *v4; // x22
  __int64 v5; // x20
  ...
  _X21 = (unsigned __int64 *)(a1 - 784);
  if ( (*(_QWORD *)(a1 - 784) & 8) == 0 )
    return 0;
  ...
  else
  {
    v4 = (_QWORD *)(a1 - 776);
    v5 = ktime_get(v3);
    v6 = readl_2(*(_QWORD *)(a1 - 776) + 1028LL);
    if ( !(_DWORD)v6 )
      goto LABEL_9;
    v7 = v5 + 100000000;
    while ( ktime_get(v6) <= v7 )
    {
      ...
      __yield();
      v6 = readl_2(*v4 + 1028LL);
      if ( !(_DWORD)v6 )
        goto LABEL_9;
    }
    if ( !(unsigned int)readl_2(*v4 + 1028LL) )
    {
LABEL_9:
