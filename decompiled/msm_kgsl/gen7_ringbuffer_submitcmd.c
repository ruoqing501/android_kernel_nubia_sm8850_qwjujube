__int64 __fastcall gen7_ringbuffer_submitcmd(__int64 a1, __int64 a2, char a3, __int64 a4)
{
  signed int v7; // w28
  int v10; // w20
  _QWORD *v11; // x9
  ...
  int v150; // w8
  _DWORD *v151; // x23
  int v152; // [xsp+4h] [xbp-11Ch]
  _DWORD *v153; // [xsp+8h] [xbp-118h]
  _DWORD *v154; // [xsp+8h] [xbp-118h]
  _QWORD *v155; // [xsp+10h] [xbp-110h]
  __int64 v156; // [xsp+10h] [xbp-110h]
  _DWORD v157[6]; // [xsp+1Ch] [xbp-104h] BYREF
  __int64 v158; // [xsp+34h] [xbp-ECh]
  __int64 v159; // [xsp+3Ch] [xbp-E4h]
  unsigned __int64 v160; // [xsp+44h] [xbp-DCh]
  __int64 v161; // [xsp+4Ch] [xbp-D4h]
  __int64 v162; // [xsp+54h] [xbp-CCh]
  __int64 v163; // [xsp+5Ch] [xbp-C4h]
  __int64 v164; // [xsp+64h] [xbp-BCh]
  __int64 v165; // [xsp+6Ch] [xbp-B4h]
  __int64 v166; // [xsp+74h] [xbp-ACh]
  __int64 v167; // [xsp+7Ch] [xbp-A4h]
  __int64 v168; // [xsp+84h] [xbp-9Ch]
  __int64 v169; // [xsp+8Ch] [xbp-94h]
  __int64 v170; // [xsp+94h] [xbp-8Ch]
  __int64 v171; // [xsp+9Ch] [xbp-84h]
  __int64 v172; // [xsp+A4h] [xbp-7Ch]
  __int64 v173; // [xsp+ACh] [xbp-74h]
  __int64 v174; // [xsp+B4h] [xbp-6Ch]
  __int64 v175; // [xsp+BCh] [xbp-64h]
  __int64 v176; // [xsp+C4h] [xbp-5Ch]
  __int64 v177; // [xsp+CCh] [xbp-54h]
  __int64 v178; // [xsp+D4h] [xbp-4Ch]
  __int64 v179; // [xsp+DCh] [xbp-44h]
  __int64 v180; // [xsp+E4h] [xbp-3Ch]
  __int64 v181; // [xsp+ECh] [xbp-34h]
  __int64 v182; // [xsp+F4h] [xbp-2Ch]
  __int64 v183; // [xsp+FCh] [xbp-24h]
  __int64 v184; // [xsp+104h] [xbp-1Ch]
  int v185; // [xsp+10Ch] [xbp-14h]
  __int64 v186; // [xsp+110h] [xbp-10h]
...
LABEL_206:
    ...
    v13 = 20 * v10 + 240;
    *(_QWORD *)(StatusReg + 80) = &gen7_ringbuffer_submitcmd__alloc_tag;
    v14 = (_DWORD *)_kvmalloc_node_noprof(v13, 0, 3264, 0xFFFFFFFFLL);
...
LABEL_175:
    ...
    v143 = gen7_ringbuffer_addcmds(a1, v12, 0, 1, v157, v136, 0, nullptr);
    if ( v143 )
    {
      v144 = v143;
      __asm { PRFM            #0x11, [X22] }
...
LABEL_203:
    ...
    v144 = gen7_ringbuffer_addcmds(a1, *(_QWORD *)(_X22 + 1536), _X22, a3, v145, v7 + 2, *(_DWORD *)(a2 + 20), v155);
    v14 = v145;
    goto LABEL_208;
  }
  if ( v113 )
