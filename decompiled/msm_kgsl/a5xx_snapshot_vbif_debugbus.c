__int64 __fastcall a5xx_snapshot_vbif_debugbus(_QWORD *a1, _DWORD *a2, unsigned __int64 a3, _DWORD *a4)
{
  _DWORD *v6; // x23
  unsigned int v7; // w20
  char v8; // w26
  ...
  if ( a3 > 0x267 )
  {
    ...
    *a2 = *a4;
    ...
    for ( n = 0; n != 4; ++n )
    {
      kgsl_regmap_write(a1 + 1650, (unsigned int)(1 << n));
      kgsl_regmap_write(a1 + 1650, 0);
      *v6 = kgsl_regmap_read(a1 + 1650);
      kgsl_regmap_write(a1 + 1650, 1);
      v6[1] = kgsl_regmap_read(a1 + 1650);
  ...
  {
    if ( (unsigned int)__ratelimit(&a5xx_snapshot_vbif_debugbus__rs, "a5xx_snapshot_vbif_debugbus") )
