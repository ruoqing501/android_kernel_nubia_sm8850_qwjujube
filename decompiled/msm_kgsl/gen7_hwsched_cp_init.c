__int64 __fastcall gen7_hwsched_cp_init(__int64 a1)
{
  __int64 v2; // x21
  __int64 v3; // x20
  __int64 result; // x0
  ...
  *(_QWORD *)&v9[11] = *(_QWORD *)(_ReadStatusReg(SP_EL0) + 1808);
  ...
  memset(&v9[1], 0, 40);
  v9[0] = 131;
  gen7_cp_init_cmds(a1, (__int64)&v9[1]);
  result = gen7_hfi_send_cmd_async(a1, v9, 0x2Cu);
  if ( (_DWORD)result )
    goto LABEL_4;
...
LABEL_4:
  ...
  *(_DWORD *)(v3 + 1344) = v9[0];
  result = adreno_zap_shader_load(a1, *(_QWORD *)(v2 + 128));
  if ( !(_DWORD)result )
  {
    if ( *(_DWORD *)(a1 + 20868) )
    {
      ...
      *(_QWORD *)v9 = 0x70E6000100000083LL;
      result = gen7_hfi_send_cmd_async(a1, v9, 0xCu);
      if ( !(_DWORD)result )
      {
        ...
        {
          v8 = result;
          gen7_spin_idle_debug((_QWORD *)a1, "Switch to unsecure failed to idle\n");
          result = v8;
        }
      }
      *(_DWORD *)(v7 + 1348) = v9[0];
