__int64 __fastcall a6xx_hfi_send_acd_feature_ctrl(__int64 a1)
{
  __int64 v2; // x0
  __int64 result; // x0
  ...
  if ( *(_BYTE *)(a1 + 20433) == 1 )
  {
    ...
    v4 = 0;
    v5 = 0;
    result = a6xx_hfi_send_cmd_wait_inline(a1, (int *)(v2 + 688), 0x114u, (int *)&v4);
    if ( !(_DWORD)result )
    {
      if ( HIDWORD(v5) )
      {
      ...
      {
        result = a6xx_hfi_send_feature_ctrl(a1, 12, 1, 0);
      }
    }
  }
  else
