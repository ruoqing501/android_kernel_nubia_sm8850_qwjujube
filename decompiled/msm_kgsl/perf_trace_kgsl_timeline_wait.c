__int64 __fastcall perf_trace_kgsl_timeline_wait(__int64 result, int a2, __int64 a3, __int64 a4)
{
  __int64 v4; // x30
  __int64 v5; // x23
  __int64 v8; // x19
  ...
  {
    result = perf_trace_buf_alloc(36, v17, &v16);
    if ( result )
    {
      v12 = (_QWORD *)v17[0];
      v13 = v16;
      ...
      *(_QWORD *)(result + 16) = a3;
      *(_QWORD *)(result + 24) = a4;
      result = perf_trace_run_bpf_submit(result, 36, v13, v8, 1, v14, StatusReg + v10, 0);
    }
  }
