__int64 __fastcall adreno_dispatcher_queue_context(__int64 a1, __int64 _X1)
{
  unsigned int v2; // w8
  unsigned int v3; // w19
  unsigned int v9; // w9
  ...
  if ( _X1 && (*(_QWORD *)(_X1 + 32) & 2) == 0 )
  {
    ...
    v11 = a1;
    v12 = kmem_cache_alloc_noprof(jobs_cache, 2080);
    _X8 = v10;
    if ( v12 )
    {
      while ( 1 )
      {
        *(_QWORD *)(v12 + 8) = _X8;
        ...
        v18 = jobs_cache;
        *(_QWORD *)(StatusReg + 80) = &dispatcher_queue_context__alloc_tag;
