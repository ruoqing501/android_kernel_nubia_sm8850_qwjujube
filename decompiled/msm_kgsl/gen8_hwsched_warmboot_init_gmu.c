__int64 __fastcall gen8_hwsched_warmboot_init_gmu(__int64 a1)
{
  __int64 v2; // x20
  char v3; // w9
  __int64 v4; // x8
  ...
  if ( (v3 & 1) != 0 )
  {
    ...
    v27[2] = 1;
    v27[0] = 154;
    LODWORD(result) = gen8_hfi_send_generic_req_v5(a1, v27, (int *)v28, 0x14u);
    if ( (_DWORD)result )
      goto LABEL_5;
  }
  v8 = *(_DWORD *)(a1 + 24616) | 1;
  *(_DWORD *)(a1 + 24616) = v8;
  ...
  result = gen8_hwsched_setup_default_votes(a1);
  if ( (_DWORD)result )
  {
LABEL_5:
    _X8 = (unsigned __int64 *)(v2 + 1040);
