__int64 __fastcall gen7_hfi_send_acd_feature_ctrl(__int64 a1)
{
  __int64 v2; // x0
  __int64 v3; // x20
  __int64 result; // x0
...
LABEL_8:
  ...
  v9 = 0xC0000000BLL;
  v10 = 1;
  result = gen7_hfi_send_generic_req_v5(a1, (int *)&v9, (int *)&v11, 0x10u);
  ...
  if ( !(_DWORD)result )
  {
    ...
    v11 = 0;
    v12 = 0;
    result = gen7_hfi_send_cmd_wait_inline(a1, (int *)(v3 + 696), 0x114u, (int *)&v11);
    if ( !(_DWORD)result )
    {
      if ( HIDWORD(v12) )
      {
      ...
      v9 = 0x700000000DLL;
      v10 = 44;
      v5 = gen7_hfi_send_generic_req_v5(a1, (int *)&v9, (int *)&v11, 0x10u);
      if ( v5 < 0 )
