__int64 __fastcall kgsl_drawobj_timeline_create(__int64 a1, unsigned int *a2)
{
  __int64 result; // x0
  unsigned int v5; // w8
  unsigned int v6; // w21
...
LABEL_14:
      ...
      *(_DWORD *)(result + 16) = 16;
      *(_DWORD *)(result + 56) = 1;
      *(_QWORD *)(result + 40) = timelineobj_destroy;
      *(_QWORD *)(result + 48) = timelineobj_destroy_object;
      return result;
    }
  }
  kfree(result);
