__int64 __fastcall check_detached_context_hardware_fences(__int64 a1, __int64 a2)
{
  _QWORD *v2; // x8
  _QWORD *v3; // x21
  __int64 v6; // x9
...
LABEL_11:
    ...
    while ( 1 )
    {
      ...
      v15 = (__int64)(v14 - 8);
      v16 = v17;
      v18 = gen7_send_hw_fence_hfi_wait_ack(a1, v15, 1);
      if ( v18 )
        break;
  ...
  move_detached_context_hardware_fences(a1, a2);
