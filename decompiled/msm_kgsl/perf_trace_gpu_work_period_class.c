__int64 __fastcall perf_trace_gpu_work_period_class(__int64 result, int a2, int a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // x30
  __int64 v7; // x25
  __int64 v10; // x19
  ...
  if ( *(_QWORD *)(result + 112) || *(_QWORD *)(StatusReg + v14) )
  {
    ...
    if ( result )
    {
      ...
      *(_QWORD *)(result + 24) = a5;
      *(_QWORD *)(result + 32) = a6;
      result = perf_trace_run_bpf_submit(result, 44, v17, v10, 1, v18, StatusReg + v14, 0);
    }
  }
