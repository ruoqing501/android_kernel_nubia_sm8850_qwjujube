__int64 __fastcall gen7_gpu_boot(__int64 a1)
{
  __int64 v2; // x22
  unsigned int v3; // w20
  __int64 v5; // x8
  ...
  if ( v3 )
    goto LABEL_5;
  v3 = gen7_gmu_oob_set(a1, 0);
  if ( v3 || (v13 = 10, (v3 = gen7_hfi_send_generic_req(a1, &v13, 4)) != 0) )
  {
LABEL_4:
    gmu_core_regwrite(a1, 129428, 0x80000000LL);
LABEL_5:
    gen7_gmu_power_off(a1);
    goto LABEL_6;
  }
  *(_QWORD *)(a1 + 20376) = 0;
  *(_QWORD *)(a1 + 20368) = 0;
  ...
  *(_DWORD *)(a1 + 20384) = 0;
  ...
  if ( v8 )
  {
    ...
    v13 = 0;
    gmu_core_regread(a1, 129232, &v13);
    if ( (v13 & 3) == 0 )
      adreno_irqctrl(a1, 0);
    if ( *(_BYTE *)(a1 + 20832) == 1 )
    {
