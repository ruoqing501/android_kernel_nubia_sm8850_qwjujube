__int64 __fastcall gen8_hwsched_process_dbgq(__int64 a1, char a2)
{
  __int64 v4; // x21
  __int64 result; // x0
  int v6; // w8
  ...
  do
  {
    result = gen8_hfi_queue_read(v4, 2u, &v8, 0x4Cu);
    if ( (int)result < 1 )
      break;
    switch ( (unsigned __int8)v8 )
    {
      case 'e':
        result = adreno_gen8_receive_debug_req(v4);
        if ( (unsigned __int8)v8 == 102 )
          goto LABEL_9;
        break;
      case 'd':
        ((void (__fastcall *)(__int64, __int64 *))adreno_gen8_receive_err_req)(v4, &v8);
        result = gen8_hwsched_fault(a1, 32);
        goto LABEL_14;
      case 'f':
LABEL_9:
