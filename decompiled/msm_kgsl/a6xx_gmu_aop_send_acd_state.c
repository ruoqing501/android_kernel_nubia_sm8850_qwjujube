__int64 __fastcall a6xx_gmu_aop_send_acd_state(__int64 result, char a2)
{
  ...
  if ( v2 )
  {
    if ( v2 <= 0xFFFFFFFFFFFFF000LL )
    {
      ...
      if ( (result & 0x80000000) != 0 )
        result = dev_err(*(_QWORD *)(v3 + 3192) + 16LL, "AOP mbox send message failed: %d\n", result);
    }
  }
