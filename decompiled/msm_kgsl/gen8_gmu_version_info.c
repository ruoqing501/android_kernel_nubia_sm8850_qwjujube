__int64 __fastcall gen8_gmu_version_info(__int64 a1)
{
  __int64 v2; // x20
  unsigned int v3; // w2
  unsigned int v4; // w3
  ...
  v2 = *(_QWORD *)(a1 + 14264);
  if ( (gmu_core_capabilities_enabled(a1 + 8232, 0) & 1) == 0 )
  {
  ...
  if ( v3 >= v4 )
    return 0;
  if ( (gen8_gmu_version_info___print_once & 1) == 0 )
  {
    v6 = *(_QWORD *)(a1 + 1544);
    gen8_gmu_version_info___print_once = 1;
