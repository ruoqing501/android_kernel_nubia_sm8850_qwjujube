__int64 __fastcall gen8_hfi_send_cmd_wait_inline(__int64 a1, int *a2, unsigned int a3, int *a4)
{
  __int64 v8; // x0
  int v9; // w8
  __int64 v10; // x22
  ...
  *a2 = v9;
  if ( a4 )
  {
    v10 = v8;
    *a4 = v9;
    result = gen8_hfi_cmdq_write(a1, a2, a3);
    if ( !(_DWORD)result )
    {
      v22 = 0;
      v12 = -250LL - jiffies;
...
LABEL_6:
        ...
        result = ((__int64 (__fastcall *)(__int64, __int64, int *))gen8_hfi_process_queue)(v10, 1, a4);
        goto LABEL_8;
      }
