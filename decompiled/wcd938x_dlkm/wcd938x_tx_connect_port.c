__int64 __fastcall wcd938x_tx_connect_port(__int64 a1, __int64 a2, int a3, char a4)
{
  char v6; // w20
  __int64 v7; // x8
  __int64 v8; // x22
  ...
  v20[0] = 0;
  v19 = 0;
  result = wcd938x_set_port_params(a1, a2, v23, v22, v21, &v19, v20, 0);
  if ( (_DWORD)result )
    goto LABEL_10;
  if ( a3 )
    v19 = a3;
...
LABEL_10:
  ...
  v17 = *((unsigned __int8 *)*(&off_20600 + (unsigned __int8)(v6 - 29)) + 1);
  if ( v17 < 0xD )
  {
    v20[0] = *(_BYTE *)(v8 + v17 + 3193);
    goto LABEL_7;
  }
  __break(0x5512u);
  return wcd938x_set_port_params(result, v10, v11, v12, v13, v14, v15, v16);
}
