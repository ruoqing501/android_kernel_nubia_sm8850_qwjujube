__int64 __fastcall wcd938x_enable_rx1(__int64 a1, __int64 a2, int a3)
{
  __int64 v3; // x20
  __int64 v4; // x19
  __int64 v5; // x21
  ...
  if ( a3 == 8 )
  {
    if ( (*(_QWORD *)(v5 + 352) & 0x2000) == 0 && (*(_QWORD *)(v5 + 352) & 0x4000) == 0 )
    {
      v13[0] = 0;
      v11[0] = 0;
      v10[0] = 0;
      if ( !(unsigned int)wcd938x_set_port_params(v3 - 208, 14, v13, v12, v11, &v9, v10, 1) )
      ...
      if ( *(_BYTE *)(v5 + 288) == 1 )
      {
        ...
        v11[0] = 0;
        v10[0] = 0;
        if ( !(unsigned int)wcd938x_set_port_params(v4, 16, v13, v12, v11, &v9, v10, 1) )
