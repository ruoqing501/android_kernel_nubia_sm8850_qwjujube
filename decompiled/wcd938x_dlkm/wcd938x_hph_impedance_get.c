__int64 __fastcall wcd938x_hph_impedance_get(__int64 a1, __int64 a2)
{
  __int64 v4; // x20
  __int64 mbhc; // x0
  int v6; // w20
  ...
  {
    if ( (unsigned int)__ratelimit(&wcd938x_hph_impedance_get__rs, "wcd938x_hph_impedance_get") )
