_QWORD *__fastcall perf_trace_cache_alloc_gpu_update(_QWORD *result, __int64 a2, __int64 a3)
{
  __int64 v3; // x30
  __int64 v4; // x22
  __int64 v7; // x23
  ...
  if ( result[14] || *(_QWORD *)(StatusReg + v7) )
  {
    result = (_QWORD *)perf_trace_buf_alloc(28, v12, &v11);
    if ( result )
    {
      v9 = (_QWORD *)v12[0];
