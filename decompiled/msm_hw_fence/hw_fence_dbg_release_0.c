__int64 __fastcall hw_fence_dbg_release_0(__int64 result, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v5; // x30
  __int64 v6; // x19
...
LABEL_11:
      ...
      {
        v9 = v5;
        v10 = hw_fence_destroy_refcount(*(_QWORD *)(v6 + 168), *(_QWORD *)(v6 + 176), 0x40000000u);
        goto LABEL_11;
      }
    }
