__int64 __fastcall _ipa_parse_gen_pkt(__int64 a1, __int64 a2, long double a3)
{
  bool v4; // zf
  __int64 v5; // x0
  __int64 result; // x0
  ...
  *(_BYTE *)(a1 + 58) = *(_BYTE *)(a2 + 6) & 0x1F;
  *(_BYTE *)(a1 + 59) = *(_BYTE *)(a2 + 7) & 0x1F;
  ...
  *(_BYTE *)(a1 + 33) = (*(_QWORD *)(a2 + 8) & 0x400000000000LL) != 0;
  *(_BYTE *)(a1 + 34) = (*(_QWORD *)(a2 + 8) & 0x800000000000LL) != 0;
  *(_BYTE *)(a1 + 35) = *(_BYTE *)(a2 + 14) & 1;
  *(_BYTE *)(a1 + 60) = (*(_QWORD *)(a2 + 8) >> 49) & 0x1F;
  *(_BYTE *)(a1 + 36) = *(_QWORD *)(a2 + 8) >> 54 == 1023;
  *(_WORD *)(a1 + 52) = *(_QWORD *)(a2 + 8) >> 54;
  *(_BYTE *)(a1 + 37) = *(_BYTE *)(a2 + 16) & 1;
  *(_WORD *)(a1 + 54) = (*(_WORD *)(a2 + 16) >> 1) & 0x1FFF;
  *(_QWORD *)a1 = *(_QWORD *)(a2 + 16) >> 16;
