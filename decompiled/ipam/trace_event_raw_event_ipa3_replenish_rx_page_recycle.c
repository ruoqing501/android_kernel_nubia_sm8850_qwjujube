__int64 __fastcall trace_event_raw_event_ipa3_replenish_rx_page_recycle(__int64 a1, int a2, __int64 a3, char a4)
{
  __int64 v7; // x8
  __int64 result; // x0
  __int64 v9; // x8
  ...
  if ( (v7 & 0x2C0) == 0 || (v7 & 0x100) != 0 || (result = _trace_trigger_soft_disabled(a1), (result & 1) == 0) )
  {
    ...
    if ( result )
    {
      ...
      *(_QWORD *)(result + 32) = (a3 - -64 * (v9 >> 12) + 0x140000000LL) >> 6;
