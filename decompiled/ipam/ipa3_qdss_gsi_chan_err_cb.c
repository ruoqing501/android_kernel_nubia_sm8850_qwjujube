__int64 __fastcall ipa3_qdss_gsi_chan_err_cb(__int64 a1)
{
  int v1; // w3
  __int64 v2; // x0
  __int64 v3; // x8
  ...
  if ( v1 > 2 )
  {
    ...
    {
      case 3:
        v2 = printk(&unk_3D2934, "ipa3_qdss_gsi_chan_err_cb");
        v9 = ipa3_ctx;
        if ( ipa3_ctx )
        {
        ...
        break;
      case 4:
        v2 = printk(&unk_3BB098, "ipa3_qdss_gsi_chan_err_cb");
        v16 = ipa3_ctx;
        if ( ipa3_ctx )
        {
          ...
          if ( v2 )
            v2 = ipc_log_string(
                   ...
                   "ipa3_qdss_gsi_chan_err_cb",
                   48);
        }
        break;
      case 5:
        v2 = printk(&unk_3F5243, "ipa3_qdss_gsi_chan_err_cb");
        v5 = ipa3_ctx;
        if ( ipa3_ctx )
        {
      ...
      default:
LABEL_28:
        v2 = printk(&unk_3C9A50, "ipa3_qdss_gsi_chan_err_cb");
        v12 = ipa3_ctx;
        if ( ipa3_ctx )
        {
  ...
  else if ( v1 )
  {
    if ( v1 != 1 )
    {
      if ( v1 == 2 )
      {
        v2 = printk(&unk_3E0E65, "ipa3_qdss_gsi_chan_err_cb");
        v3 = ipa3_ctx;
        if ( ipa3_ctx )
        {
    ...
    v2 = printk(&unk_3FDE8E, "ipa3_qdss_gsi_chan_err_cb");
    v14 = ipa3_ctx;
    if ( ipa3_ctx )
    {
  ...
  {
    v2 = printk(&unk_3F7F94, "ipa3_qdss_gsi_chan_err_cb");
    v7 = ipa3_ctx;
    if ( ipa3_ctx )
    {
