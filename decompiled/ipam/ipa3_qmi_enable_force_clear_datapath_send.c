__int64 __fastcall ipa3_qmi_enable_force_clear_datapath_send(__int64 a1)
{
  __int64 type; // x0
  __int64 v3; // x0
  __int64 v4; // x0
  ...
  {
    if ( !*(_BYTE *)(a1 + 10)
      || !*(_DWORD *)(a1 + 12) && !*(_DWORD *)(a1 + 16) && !*(_DWORD *)(a1 + 20) && !*(_DWORD *)(a1 + 24) )
    {
      goto LABEL_20;
    }
  }
  ...
  {
LABEL_20:
    v8 = printk(&unk_3E9D9C, "ipa3_qmi_enable_force_clear_datapath_send");
    ...
    if ( ipc_logbuf_low )
    {
      ...
      ipc_log_string(v12, "ipa-wan %s:%d invalid params\n", "ipa3_qmi_enable_force_clear_datapath_send", 1340);
    }
    result = 4294967274LL;
    goto LABEL_25;
  }
  ...
  if ( (_DWORD)type == 1 || (type = ipa3_ctx_get_type(2), (_DWORD)type == 3) )
  {
    ...
    result = ipa3_get_ipc_logbuf_low(v3);
    if ( result )
    {
  ...
  {
    v25[1] = &ipa3_enable_force_clear_datapath_req_msg_data_v01_ei;
    v24[1] = &ipa3_enable_force_clear_datapath_resp_msg_data_v01_ei;
    v25[0] = 37;
    v24[0] = 0x700000000LL;
    v26 = 0;
    if ( ipa_q6_clnt )
    {
      ...
      {
        v13 = v7;
        v14 = printk(&unk_3EF59E, "ipa3_qmi_enable_force_clear_datapath_send");
      ...
      {
        v19 = printk(&unk_3F86EF, "ipa3_qmi_enable_force_clear_datapath_send");
      ...
      {
        result = ipa3_check_qmi_response(v7, 37, 0, HIWORD(v26), "ipa_enable_force_clear_datapath");
      }
    }
    else
    {
