__int64 __fastcall ipa_eth_gsi_evt_ring_err_cb(__int64 a1)
{
  int v1; // w3
  __int64 v2; // x0
  __int64 v3; // x8
  ...
  if ( v1 > 1 )
  {
    if ( v1 == 2 )
    {
      v2 = printk(&unk_3F20AC, "ipa_eth_gsi_evt_ring_err_cb");
      v12 = ipa3_ctx;
      if ( ipa3_ctx )
      {
    ...
    else
    {
      ...
      {
LABEL_16:
        v2 = printk(&unk_3C9A50, "ipa_eth_gsi_evt_ring_err_cb");
        v8 = ipa3_ctx;
        if ( ipa3_ctx )
        {
      ...
      v2 = printk(&unk_3A6B54, "ipa_eth_gsi_evt_ring_err_cb");
      v5 = ipa3_ctx;
      if ( ipa3_ctx )
      {
  ...
  else
  {
    if ( v1 )
    {
      if ( v1 == 1 )
      {
        v2 = printk(&unk_3CF9B1, "ipa_eth_gsi_evt_ring_err_cb");
        v3 = ipa3_ctx;
        if ( ipa3_ctx )
        {
    ...
    v2 = printk(&unk_3E3A9B, "ipa_eth_gsi_evt_ring_err_cb");
    v10 = ipa3_ctx;
    if ( ipa3_ctx )
    {
