__int64 __fastcall ipa_imm_cmd_construct_ip_v4_routing_init(unsigned int a1, __int64 a2, char a3)
{
  __int64 v5; // x1
  __int64 v6; // x19
  __int16 opcode; // w0
  ...
  {
    printk(&unk_3C8A72, "ipa_imm_cmd_construct_ip_v4_routing_init");
    if ( ipa3_get_ipc_logbuf() )
    {
      ipc_logbuf = ipa3_get_ipc_logbuf();
      ipc_log_string(ipc_logbuf, "ipahal %s:%d kzalloc err\n", "ipa_imm_cmd_construct_ip_v4_routing_init", 788);
    }
