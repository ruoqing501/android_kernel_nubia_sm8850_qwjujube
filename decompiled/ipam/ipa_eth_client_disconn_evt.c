__int64 __fastcall ipa_eth_client_disconn_evt(__int64 a1)
{
  ...
  if ( v4 )
  {
    ...
    *(_QWORD *)(v4 + 8) = v8;
    ...
    if ( ipa3_get_ipc_logbuf() )
    {
      ...
      ipc_log_string(
        v9,
        "ipa_eth %s:%d send PERIPHERAL_DISCONNECT, len:%d, buff %pK",
        "ipa_eth_client_disconn_evt",
        816,
        36,
        v5);
    }
