__int64 __fastcall ipa3_gsb_msg_free_cb(const void *a1, __int64 a2, int a3)
{
  __int64 result; // x0
  __int64 v4; // x8
  __int64 v5; // x0
  ...
  if ( a1 )
  {
    if ( (unsigned int)(a3 - 35) >= 2 )
    {
      result = printk(&unk_3B76CF, "ipa3_gsb_msg_free_cb");
      v8 = ipa3_ctx;
      if ( ipa3_ctx )
      {
  ...
  {
    result = printk(&unk_3B18C1, "ipa3_gsb_msg_free_cb");
    v4 = ipa3_ctx;
    if ( ipa3_ctx )
    {
