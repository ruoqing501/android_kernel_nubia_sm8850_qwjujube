long double ipa_mhi_wq_notify_ready()
{
  ...
  if ( *(v4 - 1) != -967519881 )
    __break(0x8229u);
  ((void (__fastcall *)(__int64, _QWORD, _QWORD, long double))v4)(v3, 0, 0, v1);
  if ( ipa3_get_ipc_logbuf() )
  {
    v5 = ipa3_get_ipc_logbuf();
    ipc_log_string(v5, "ipa_mhi_client %s:%d EXIT\n", "ipa_mhi_wq_notify_ready", 539);
  }
  if ( ipa3_get_ipc_logbuf_low() )
  {
