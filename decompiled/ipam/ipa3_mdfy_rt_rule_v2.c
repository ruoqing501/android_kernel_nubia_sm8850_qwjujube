__int64 __fastcall ipa3_mdfy_rt_rule_v2(__int64 a1)
{
  __int64 v2; // x8
  __int64 v3; // x0
  __int64 v4; // x0
  ...
  {
    if ( (unsigned int)__ratelimit(&ipa3_mdfy_rt_rule_v2__rs, "ipa3_mdfy_rt_rule_v2") )
      printk(&unk_3C3EF1, "ipa3_mdfy_rt_rule_v2");
    v2 = ipa3_ctx;
    if ( ipa3_ctx )
    {
  ...
  if ( *(_BYTE *)(a1 + 8) )
  {
    ...
    do
    {
      if ( *(_BYTE *)(ipa3_ctx + 32270) == 1 )
        *(_BYTE *)(*(_QWORD *)(a1 + 24) + v6 + 173) = 0;
      if ( !(unsigned int)_ipa_mdfy_rt_rule((_BYTE *)(*(_QWORD *)(a1 + 24) + v6)) )
      {
        v8 = 0;
        goto LABEL_15;
      }
      if ( (unsigned int)__ratelimit(&ipa3_mdfy_rt_rule_v2__rs_112, "ipa3_mdfy_rt_rule_v2") )
      {
        printk(&unk_3E6CDA, "ipa3_mdfy_rt_rule_v2");
        v10 = ipa3_ctx;
        if ( ipa3_ctx )
        {
LABEL_21:
