__int64 __fastcall ipa3_cfg_ep_status(unsigned int a1, unsigned __int8 *a2)
{
  __int64 v3; // x8
  unsigned int v4; // w22
  __int64 v6; // x0
  ...
  if ( a2 && *(_DWORD *)(ipa3_ctx + 480LL * a1 + 168) )
  {
    if ( ipa3_ctx )
    {
      ...
      if ( v6 )
      {
        ipc_log_string(
          v6,
          "ipa %s:%d pipe=%d, status_en=%d status_ep=%d status_location=%d\n",
          "ipa3_cfg_ep_status",
          8965,
          a1,
          *a2,
    ...
    *(_DWORD *)(v3 + 480LL * a1 + 520) = *(_DWORD *)a2;
    if ( *(_DWORD *)(ipa3_ctx + 34308) <= a1 )
    {
    ...
    ((void (__fastcall *)(__int64, _QWORD, unsigned __int8 *))ipahal_write_reg_n_fields)(73, a1, a2);
    if ( *(_DWORD *)(ipa3_ctx + 34308) <= a1 )
    {
      printk(&unk_3E7136, "ipa3_get_client_mapping");
      v18 = ipa3_ctx;
...
LABEL_16:
  printk(&unk_3E4584, "ipa3_cfg_ep_status");
  v9 = ipa3_ctx;
  if ( !ipa3_ctx )
    goto LABEL_21;
