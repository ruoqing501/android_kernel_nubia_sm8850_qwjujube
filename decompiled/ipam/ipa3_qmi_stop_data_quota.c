__int64 __fastcall ipa3_qmi_stop_data_quota(__int64 a1)
{
  ...
  v15[1] = &ipa3_stop_data_usage_quota_req_msg_data_v01_ei;
  v14[1] = &ipa3_stop_data_usage_quota_resp_msg_data_v01_ei;
  v16 = 0;
  v15[0] = 0x800000034LL;
  v14[0] = 0x700000034LL;
  ...
  if ( ipc_logbuf_low )
  {
    ...
    ipc_log_string(
      v3,
      "ipa-wan %s:%d Sending QMI_IPA_STOP_DATA_USAGE_QUOTA_REQ_V01\n",
      "ipa3_qmi_stop_data_quota",
      2801);
  }
  if ( ipa_q6_clnt )
  {
    ...
    if ( (v4 & 0x80000000) != 0 )
    {
      v9 = printk(&unk_3CCE82, "ipa3_qmi_stop_data_quota");
    ...
    else
    {
      ...
      if ( v6 )
      {
        ...
        ipc_log_string(
          v7,
          "ipa-wan %s:%d QMI_IPA_STOP_DATA_USAGE_QUOTA_RESP_V01 received\n",
          "ipa3_qmi_stop_data_quota",
          2816);
      }
      result = ipa3_check_qmi_response(
                 ...
                 HIWORD(v16),
                 "ipa_stop_data_usage_quota_req_msg_v01");
    }
  }
  else
  {
