__int64 ipa_init_flt6_v3()
{
  ...
  v1 = ((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, __int64, __int64 *, _QWORD))ipahal_flt_generate_empty_img)(
         ...
         *(unsigned int *)(**(_QWORD **)(ipa3_ctx + 34176) + 32LL),
         *(unsigned int *)(**(_QWORD **)(ipa3_ctx + 34176) + 44LL),
         v0,
         &v33,
         0);
  if ( v1 )
  {
    v17 = v1;
    printk(&unk_3B1844, "_ipa_init_flt6_v3");
    v19 = ipa3_ctx;
    if ( ipa3_ctx )
    {
      ...
      if ( v20 )
      {
        ipc_log_string(v20, "ipa %s:%d fail generate empty v6 flt img\n", "_ipa_init_flt6_v3", 6131);
        v19 = ipa3_ctx;
      }
      v21 = *(_QWORD *)(v19 + 34160);
      if ( v21 )
        ipc_log_string(v21, "ipa %s:%d fail generate empty v6 flt img\n", "_ipa_init_flt6_v3", 6131);
    }
  }
  else
  {
    ...
    if ( ipa3_ctx )
    {
      if ( *v4 )
      {
        ipc_log_string(
          *v4,
          "ipa %s:%d putting hashable filtering IPv6 rules to phys 0x%x\n",
          "_ipa_init_flt6_v3",
          6155,
          v9);
        v2 = ipa3_ctx;
      ...
      if ( v2 )
      {
        ...
        if ( v13 )
        {
          ipc_log_string(
            v13,
            "ipa %s:%d putting non-hashable filtering IPv6 rules to phys 0x%x\n",
            "_ipa_init_flt6_v3",
            6157,
            v11);
          v2 = ipa3_ctx;
    ...
    v15 = ((__int64 (__fastcall *)(__int64, __int64 *, _QWORD))ipahal_construct_imm_cmd)(1, &v28, 0);
    if ( v15 )
    {
      v16 = v15;
      ...
      {
        printk(&unk_3CB958, "_ipa_init_flt6_v3");
        v25 = ipa3_ctx;
        if ( ipa3_ctx )
        {
    ...
    {
      printk(&unk_3E0366, "_ipa_init_flt6_v3");
      v22 = ipa3_ctx;
      if ( !ipa3_ctx )
        goto LABEL_37;
      ...
      if ( v23 )
      {
        ipc_log_string(v23, "ipa %s:%d fail construct ip_v6_flt_init imm cmd\n", "_ipa_init_flt6_v3", 6162);
        v22 = ipa3_ctx;
      }
      v24 = *(_QWORD *)(v22 + 34160);
      if ( v24 )
      {
        ipc_log_string(v24, "ipa %s:%d fail construct ip_v6_flt_init imm cmd\n", "_ipa_init_flt6_v3", 6162);
        v17 = -1;
      }
      else
      {
