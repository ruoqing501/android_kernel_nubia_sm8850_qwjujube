__int64 __fastcall ipa_pm_activate_sync(unsigned int a1)
{
  __int64 v1; // x0
  __int64 v3; // x0
  __int64 v4; // x0
  ...
  return ipa_pm_activate_helper(v1, 1);
}
