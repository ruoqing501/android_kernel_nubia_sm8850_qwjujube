__int64 __fastcall ipa_rt_gen_hw_rule_ipav4_5(int *a1, unsigned int *a2, __int64 *a3)
{
  unsigned int v5; // w8
...
LABEL_14:
      ...
      *a3 = v14 & 0xFFFF7FFFFFFFFFFFLL | ((unsigned __int64)(*(_BYTE *)(*((_QWORD *)a1 + 4) + 166LL) != 0) << 47);
      ...
      a1 = v35;
LABEL_18:
      v16 = *a3 & 0xFC00FFFFFFFFFFFFLL | ((unsigned __int64)(v15 & 0x3FF) << 48);
      *a3 = v16;
      v17 = v16 & 0x3FFFFFFFFFFFFFFLL | ((unsigned __int64)*((unsigned __int8 *)a1 + 28) << 58);
      *a3 = v17;
      *a3 = v17 & 0xFFFFF3FFFFFFFFFFLL | ((((unsigned __int64)*((unsigned __int8 *)a1 + 28) >> 6) & 3) << 42);
      v18 = *a1;
      v19 = *((_QWORD *)a1 + 4);
      v39[0] = a3 + 1;
      if ( (unsigned int)ipa_fltrt_generate_hw_rule_bdy(v18, v19 + 12, v39, &v38) )
      {
        printk(&unk_3C2B3C, "ipa_rt_gen_hw_rule_ipav4_5");
        if ( ipa3_get_ipc_logbuf() )
        {
          ipc_logbuf = ipa3_get_ipc_logbuf();
          ipc_log_string(ipc_logbuf, "ipahal %s:%d fail to generate hw rule\n", "ipa_rt_gen_hw_rule_ipav4_5", 292);
        }
      ...
      else
      {
        ...
        *(_WORD *)a3 = v38;
        ...
        printk(&unk_3B3D90, "ipa_rt_gen_hw_rule_ipav4_5");
        if ( ipa3_get_ipc_logbuf() )
        {
  ...
  v29 = a1;
  printk(&unk_3D75DB, "ipa_rt_gen_hw_rule_ipav4_5");
  if ( ipa3_get_ipc_logbuf() )
  {
    v30 = ipa3_get_ipc_logbuf();
    ipc_log_string(v30, "ipahal %s:%d Invalid HDR type %d\n", "ipa_rt_gen_hw_rule_ipav4_5", 274, v29[2]);
  }
  if ( ipa3_get_ipc_logbuf_low() )
  {
