__int64 __fastcall ipa3_ioctl_add_rt_rule_v2(unsigned __int64 a1)
{
  __int64 v2; // x8
  __int64 v3; // x0
  __int64 v4; // x0
  ...
  unsigned __int64 v49; // [xsp+50h] [xbp-50h]
  ...
  {
    if ( (unsigned int)__ratelimit(&ipa3_ioctl_add_rt_rule_v2__rs, "ipa3_ioctl_add_rt_rule_v2") )
      printk(&unk_3F47D5, "ipa3_ioctl_add_rt_rule_v2");
    v2 = ipa3_ctx;
    if ( ipa3_ctx )
    {
  ...
  if ( DWORD1(v48) >= 0xBD )
  {
    if ( (unsigned int)__ratelimit(&ipa3_ioctl_add_rt_rule_v2__rs_532, "ipa3_ioctl_add_rt_rule_v2") )
      printk(&unk_3E2FB4, "ipa3_ioctl_add_rt_rule_v2");
    v34 = ipa3_ctx;
    if ( ipa3_ctx )
    {
  ...
  if ( !v49 )
  {
    if ( (unsigned int)__ratelimit(&ipa3_ioctl_add_rt_rule_v2__rs_535, "ipa3_ioctl_add_rt_rule_v2") )
      printk(&unk_3DAAB1, "ipa3_ioctl_add_rt_rule_v2");
    v37 = ipa3_ctx;
    if ( ipa3_ctx )
    {
...
LABEL_10:
    ...
    {
      if ( (unsigned int)__ratelimit(&ipa3_ioctl_add_rt_rule_v2__rs_538, "ipa3_ioctl_add_rt_rule_v2") )
        printk(&unk_3A8F59, "ipa3_ioctl_add_rt_rule_v2");
      v40 = ipa3_ctx;
      if ( ipa3_ctx )
      {
...
LABEL_86:
        ...
        v49 = v7;
        v6 = v46;
        if ( (unsigned int)ipa3_add_rt_rule_usr_v2(v47, 1) )
          goto LABEL_45;
        v10 = 0;
        v23 = 0;
        while ( 1 )
...
LABEL_88:
        ...
        *(_QWORD *)(StatusReg + 80) = &ipa3_ioctl_add_rt_rule_v2__alloc_tag;
        v7 = _kmalloc_noprof(v15, 3520);
...
LABEL_53:
        ...
        {
          if ( (unsigned int)__ratelimit(&ipa3_ioctl_add_rt_rule_v2__rs_545, "ipa3_ioctl_add_rt_rule_v2") )
            printk(&unk_3F1771, "ipa3_ioctl_add_rt_rule_v2");
          v31 = ipa3_ctx;
          if ( ipa3_ctx )
          {
...
LABEL_45:
      if ( (unsigned int)__ratelimit(&ipa3_ioctl_add_rt_rule_v2__rs_540, "ipa3_ioctl_add_rt_rule_v2") )
        printk(&unk_3E5AC4, "ipa3_ioctl_add_rt_rule_v2");
      v28 = ipa3_ctx;
      if ( ipa3_ctx )
      {
        ...
        if ( v29 )
        {
          ipc_log_string(v29, "ipa %s:%d ipa3_add_rt_rule_usr_v2 fails\n", "ipa3_ioctl_add_rt_rule_v2", 1648);
          v28 = ipa3_ctx;
        }
        v30 = *(_QWORD *)(v28 + 34160);
        if ( v30 )
          ipc_log_string(v30, "ipa %s:%d ipa3_add_rt_rule_usr_v2 fails\n", "ipa3_ioctl_add_rt_rule_v2", 1648);
      }
      v8 = -1;
    }
    else
