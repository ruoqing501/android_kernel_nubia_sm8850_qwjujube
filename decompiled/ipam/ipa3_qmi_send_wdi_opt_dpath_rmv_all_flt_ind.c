__int64 __fastcall ipa3_qmi_send_wdi_opt_dpath_rmv_all_flt_ind(unsigned __int16 *a1)
{
  ...
  if ( ipc_logbuf )
  {
    ...
    ipc_logbuf = ipc_log_string(
                   v3,
                   "ipa-wan %s:%d Sending QMI_IPA_WLAN_OPT_DATAPATH_REMOVE_ALL_FILTER_COMPLT_IND_V01\n",
                   "ipa3_qmi_send_wdi_opt_dpath_rmv_all_flt_ind",
                   2951);
  }
