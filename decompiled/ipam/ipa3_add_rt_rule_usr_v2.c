__int64 __fastcall ipa3_add_rt_rule_usr_v2(__int64 a1, char a2)
{
  __int64 v3; // x8
  __int64 v4; // x0
  __int64 v5; // x0
  ...
  {
    if ( (unsigned int)__ratelimit(&ipa3_add_rt_rule_usr_v2__rs, "ipa3_add_rt_rule_usr_v2") )
      printk(&unk_3C3EF1, "ipa3_add_rt_rule_usr_v2");
    v3 = ipa3_ctx;
    if ( ipa3_ctx )
    {
  ...
  if ( *(_BYTE *)(a1 + 40) )
  {
    ...
    do
    {
      *(_BYTE *)(a1 + 39) = 0;
      ...
      if ( (unsigned int)__ratelimit(&ipa3_add_rt_rule_usr_v2__rs_27, "ipa3_add_rt_rule_usr_v2") )
      {
        printk(&unk_3B00AA, "ipa3_add_rt_rule_usr_v2");
        v12 = ipa3_ctx;
        if ( ipa3_ctx )
        {
LABEL_21:
