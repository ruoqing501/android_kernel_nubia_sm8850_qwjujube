__int64 __fastcall ipa_gsi_evt_ring_err_cb_1(__int64 a1)
{
  int v1; // w3
  __int64 v2; // x0
  long double v3; // q0
  ...
  if ( v1 > 1 )
  {
    if ( v1 == 2 )
    {
      ...
      if ( ipa3_ctx )
      {
        ...
        v2 = *(_QWORD *)(v13 + 34160);
        if ( v2 )
          v3 = ipc_log_string(v2, "ipa %s:%d Got GSI_EVT_UNSUPPORTED_INTER_EE_OP_ERR\n", "ipa_gsi_evt_ring_err_cb", 595);
      }
    }
    else
    {
