__int64 __fastcall _ipa3_release_hdr(__int64 a1)
{
  int v1; // w19
  int v2; // w0
  __int64 v3; // x8
  ...
  if ( (_DWORD)result )
  {
    printk(&unk_3B501F, "__ipa3_release_hdr");
    v8 = ipa3_ctx;
    if ( ipa3_ctx )
    {
