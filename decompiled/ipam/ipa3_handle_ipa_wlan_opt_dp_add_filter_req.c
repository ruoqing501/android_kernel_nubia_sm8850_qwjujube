__int64 __fastcall ipa3_handle_ipa_wlan_opt_dp_add_filter_req(
        __int64 a1,
        __int64 *a2,
        __int64 a3,
        int *a4,
        ...
        __int64 a8)
{
  ...
  *(_DWORD *)(v12 + 8) = v11;
  v13 = qmi_send_response(a1, a2, a3, 74, 7, &ipa_wlan_opt_dp_add_filter_resp_msg_data_v01_ei, &v41, a8);
  ...
  if ( ipc_logbuf )
  {
    ...
    ipc_logbuf = ipc_log_string(
                   v15,
                   "ipa-wan %s:%d add_filter_req: filter_idx %x, iptype %d\n",
                   "ipa3_handle_ipa_wlan_opt_dp_add_filter_req",
                   1801,
                   *a4,
                   a4[1]);
  }
  ...
  *(_QWORD *)s = 0;
  ...
  snprintf(
    s,
    0x100u,
    "ipa-event-log %s:%d add_filter_req: filter_idx %x, iptype %d\n",
    "ipa3_handle_ipa_wlan_opt_dp_add_filter_req",
    1803,
    v18,
    v19);
  ipa3_send_opt_log_msg(s);
  v20 = ipa_wdi_opt_dpath_add_filter_req(a4, &v39);
  ...
  if ( v21 )
  {
    ...
    v21 = ipc_log_string(
            v22,
            "ipa-wan %s:%d qmi_snd_rsp: flt_idx %x, flt_hdl%d\n",
            "ipa3_handle_ipa_wlan_opt_dp_add_filter_req",
            1809,
            HIDWORD(v39),
            HIDWORD(v40));
  ...
  *(_QWORD *)s = 0;
  ...
  snprintf(
    s,
    0x100u,
    "ipa-event-log %s:%d qmi_snd_rsp: flt_idx %x, flt_hdl%d, result %d, err %d\n",
    "ipa3_handle_ipa_wlan_opt_dp_add_filter_req",
    1816,
    HIDWORD(v39),
    HIDWORD(v40),
    ...
    WORD1(v39));
  ipa3_send_opt_log_msg(s);
  v29 = qmi_send_indication(a1, ipa3_qmi_ctx + 28864, 74, 21, &ipa_wlan_opt_dp_add_filter_complt_ind_msg_v01_ei, &v39);
  if ( (v29 & 0x80000000) != 0 )
  {
    v34 = printk(&unk_3F593C, "ipa3_handle_ipa_wlan_opt_dp_add_filter_req");
