__int64 __fastcall ipa_adpl_read(__int64 a1, unsigned __int64 a2, unsigned __int64 a3)
{
  ...
  v37[0] = 0;
  v37[1] = StatusReg;
  add_wait_queue(ipa3_odl_ctx + 720, v37);
  v7 = 0;
  v8 = a2;
  v9 = ipa3_ctx;
  if ( !ipa3_ctx )
...
LABEL_2:
  v10 = *(_QWORD *)(v9 + 34160);
  if ( v10 )
    ipc_log_string(v10, "ipa %s:%d Writing message to adpl pipe\n", "ipa_adpl_read", 571);
LABEL_4:
  while ( (*(_WORD *)(ipa3_odl_ctx + 692) & 2) != 0 )
  {
    mutex_lock(ipa3_odl_ctx + 336);
    v11 = *(_QWORD **)(ipa3_odl_ctx + 320);
    if ( v11 == (_QWORD *)(ipa3_odl_ctx + 320) )
    {
      mutex_unlock(ipa3_odl_ctx + 336);
      if ( (*(_BYTE *)(a1 + 49) & 8) != 0 )
        goto LABEL_42;
    }
    else
    {
      ...
      *v11 = 0xDEAD000000000100LL;
      ...
      if ( *(_DWORD *)(ipa3_odl_ctx + 712) )
      {
        _X8 = (unsigned int *)(ipa3_odl_ctx + 712);
        __asm { PRFM            #0x11, [X8] }
        do
          v31 = __ldxr(_X8);
      ...
      if ( v11 != &qword_10 )
      {
        ...
        if ( a3 < v15 )
        {
          printk(&unk_3FB600, "ipa_adpl_read");
          v32 = ipa3_ctx;
          if ( ipa3_ctx )
          {
...
LABEL_42:
  ...
  remove_wait_queue(ipa3_odl_ctx + 720, v37);
  v35 = v8 - a2;
