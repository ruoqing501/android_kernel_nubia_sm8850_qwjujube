__int64 __fastcall ipa3_uc_mhi_suspend_channel(unsigned __int8 a1)
{
  __int64 v2; // x0
  unsigned int v3; // w19
  __int64 v5; // x8
  ...
  if ( ipa3_uc_mhi_ctx )
  {
    ...
    *(_DWORD *)(ipa3_uc_mhi_ctx + 4) = v2;
    ...
    if ( v3 )
    {
      printk(&unk_3D039E, "ipa3_uc_mhi_suspend_channel");
      v8 = ipa3_ctx;
      if ( ipa3_ctx )
      {
  ...
  {
    printk(&unk_3B8A54, "ipa3_uc_mhi_suspend_channel");
    v5 = ipa3_ctx;
    if ( !ipa3_ctx )
      goto LABEL_15;
