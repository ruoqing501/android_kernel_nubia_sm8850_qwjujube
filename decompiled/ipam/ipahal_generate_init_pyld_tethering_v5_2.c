_WORD *__fastcall ipahal_generate_init_pyld_tethering_v5_2(_DWORD *a1, char a2)
{
  _WORD *v3; // x21
  unsigned int v4; // w8
  unsigned int v5; // w9
  ...
  do
  {
    ...
    if ( v10 <= 1 )
    {
      ...
      if ( ((unsigned int)ipahal_get_ep_bit((unsigned int)v8) & v13) != 0 )
      {
        ...
        {
          printk(&unk_3E877F, "ipahal_generate_init_pyld_tethering_v5_2");
  ...
  for ( result = (_WORD *)_kmalloc_noprof(v21, v20); result; *(_QWORD *)(StatusReg + 80) = v38 )
  {
    ...
    *result = 24 * v22;
    ...
    while ( 1 )
    {
      ...
      if ( v21 - v25 < 8 )
        break;
      v30 = (unsigned int)(*(_QWORD *)(v9 - 1) >> 11);
      *(_DWORD *)v3 = v30;
      if ( v21 < v25 )
        break;
      if ( v21 - v25 < 8 )
        break;
      v31 = v25 + 8;
      *(_QWORD *)v3 = v30 & 0xFFE00000FFFFFFFFLL | ((unsigned __int64)(*v9 >> 11) << 32);
      ...
      *((_DWORD *)v3 + 4) = v6;
      if ( ipa3_get_ipc_logbuf_low() )
      {
        ...
        ipc_log_string(v33, "ipahal %s:%d Pipe: %d\n", "ipahal_generate_init_pyld_tethering_v5_2", 418, v23);
      }
      if ( ipa3_get_ipc_logbuf_low() )
      {
...
LABEL_67:
    ...
    *(_QWORD *)(StatusReg + 80) = &ipahal_generate_init_pyld_tethering_v5_2__alloc_tag;
    v21 = (24 * ((int)v9 + (unsigned __int64)v6)) | 4;
    if ( ((unsigned __int8)v3 & 1) != 0 )
      v39 = 2336;
    else
