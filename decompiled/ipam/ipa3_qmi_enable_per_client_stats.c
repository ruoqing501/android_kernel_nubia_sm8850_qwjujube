__int64 __fastcall ipa3_qmi_enable_per_client_stats(__int64 a1, unsigned __int16 *a2)
{
  ...
  v21[1] = &ipa3_enable_per_client_stats_req_msg_data_v01_ei;
  v20[1] = &ipa3_enable_per_client_stats_resp_msg_data_v01_ei;
  v21[0] = 56;
  v20[0] = 56;
  ...
  if ( ipc_logbuf )
  {
    ...
    ipc_logbuf = ipc_log_string(
                   v5,
                   "ipa-wan %s:%d Sending QMI_IPA_ENABLE_PER_CLIENT_STATS_REQ_V01\n",
                   "ipa3_qmi_enable_per_client_stats",
                   2844);
  }
  ...
  if ( ipa_q6_clnt )
  {
    ...
    if ( (v8 & 0x80000000) != 0 )
    {
      v15 = printk(&unk_3EF59E, "ipa3_qmi_enable_per_client_stats");
    ...
    else
    {
      ...
      if ( v10 )
      {
        ...
        v10 = ipc_log_string(
                v11,
                "ipa-wan %s:%d QMI_IPA_ENABLE_PER_CLIENT_STATS_RESP_V01 received\n",
                "ipa3_qmi_enable_per_client_stats",
                2860);
      }
      ...
      result = ipa3_check_qmi_response(v9, 56, *a2, a2[1], "ipa3_qmi_enable_per_client_stats");
    }
  }
  else
  {
