__int64 __fastcall synx_handle_import(__int64 a1, __int64 a2)
{
  int v2; // w8
  __int64 v4; // x1
  __int64 result; // x0
  ...
  v36 = 0;
  v37[0] = 0;
  if ( inline_copy_from_user((int)&v36, v4, 0x20u) )
  {
    result = 4294967282LL;
    goto LABEL_25;
  }
  ...
  if ( (v36 & 0x800000000LL) != 0 && (_DWORD)v38 )
  {
    ...
    {
      if ( (synx_debug & 1) != 0 )
        printk(&unk_27836, &unk_29207, "synx_handle_import", 2882, (unsigned int)v38, v9);
      goto LABEL_24;
    }
    v7 = HIDWORD(v36);
  }
...
LABEL_24:
  ...
  {
    _copy_overflow(32, *(unsigned int *)(v11 + 4));
    result = 4294967282LL;
  }
  else
  {
