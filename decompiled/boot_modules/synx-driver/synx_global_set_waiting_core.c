__int64 __fastcall synx_global_set_waiting_core(
        unsigned int a1,
        unsigned int a2,
        __int64 a3,
        __int64 a4,
        ...
        __int64 a6)
{
  ...
  if ( synx_gmem_2 )
  {
    ...
    {
      if ( (synx_debug & 1) != 0 )
        printk(&unk_27C7E, &unk_29207, "synx_global_set_waiting_core", 422, a1, a6);
      result = 4294967274LL;
    }
    else
    {
      if ( (get_ipclite_feature(4) & 1) != 0 )
      {
        ...
        if ( !(_DWORD)result )
        {
          v11 = synx_gmem_2;
LABEL_16:
          *(_WORD *)(v11 + glcoredata_size * a1 + 14) |= 1LL << v6;
          if ( (get_ipclite_feature(4) & 1) != 0 )
          {
      ...
      {
        v13 = result;
        printk(&unk_2981B, &unk_29207, "synx_global_set_waiting_core", 428, a1, v9);
        result = v13;
      }
    }
  }
  ...
  {
    if ( (synx_debug & 1) != 0 )
      printk(&unk_267BF, &unk_29207, "synx_global_set_waiting_core", 417, a5, a6);
    result = 4294967284LL;
  }
LABEL_28:
