__int64 __fastcall alpha_pll_fabia_set_rate(__int64 a1, unsigned __int64 a2, __int64 a3)
{
  ...
  else
  {
    ...
    regmap_write(
      *(_QWORD *)(a1 + 24),
      *(_DWORD *)(a1 - 48) + (unsigned int)*(unsigned __int8 *)(*(_QWORD *)(a1 - 40) + 20LL),
      (unsigned int)v9);
    return _clk_alpha_pll_update_latch(a1 - 48);
  }
}
