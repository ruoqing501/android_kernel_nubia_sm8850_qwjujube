__int64 __fastcall perf_trace_cbo_dispatch_handle(__int64 result, const char *a2, int a3, __int64 a4, __int64 a5)
{
  __int64 v5; // x30
  __int64 v6; // x25
  __int64 v9; // x19
  ...
  if ( !*(_QWORD *)(result + 112) && !*(_QWORD *)(StatusReg + v12) )
    goto LABEL_10;
  result = perf_trace_buf_alloc(84, v23, &v22);
  if ( !result )
    goto LABEL_10;
  v14 = (_QWORD *)v23[0];
  v15 = result;
  *(_QWORD *)(v23[0] + 232LL) = &v24;
  ...
  else
  {
    ...
    if ( v17 < 0x31 )
    {
      sized_strscpy(v15 + 8, a2);
      v18 = v22;
      v19 = v23[0];
      *(_DWORD *)(v15 + 56) = a3;
      *(_QWORD *)(v15 + 64) = a4;
      *(_QWORD *)(v15 + 72) = a5;
      result = perf_trace_run_bpf_submit(v15, 84, v18, v9, 1, v19, StatusReg + v12, 0);
LABEL_10:
  ...
  return trace_event_raw_event_cbo_dispatch_wait(v20);
}
