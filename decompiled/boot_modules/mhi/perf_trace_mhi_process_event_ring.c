size_t __fastcall perf_trace_mhi_process_event_ring(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v3; // x30
  __int64 v5; // x23
  __int64 v7; // x8
  ...
  if ( *(_QWORD *)(a1 + 112) || *(_QWORD *)(StatusReg + v11) )
  {
    ...
    if ( result )
    {
      ...
      *(_QWORD *)(v25[0] + 248LL) = &v23;
      ...
      v16[33] = 5;
      *(_DWORD *)(result + 8) = v17;
      memcpy((void *)(result + 40), v9, v20);
      *(_BYTE *)(v18 + v20) = 0;
      *(_QWORD *)(v19 + 32) = a3;
      v21 = v24;
      v22 = v25[0];
      *(_QWORD *)(v19 + 24) = *(_QWORD *)a3;
      *(_DWORD *)(v19 + 12) = *(_DWORD *)(a3 + 8);
      *(_DWORD *)(v19 + 16) = *(_DWORD *)(a3 + 12);
      *(_DWORD *)(v19 + 20) = *(unsigned __int8 *)(a3 + 11);
