__int64 __fastcall trace_event_raw_event_mhi_process_event_ring(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v5; // x8
  const char *v6; // x21
  int v7; // w22
    ...
    || (v13 = a2, result = _trace_trigger_soft_disabled(a1), a2 = v13, (result & 1) == 0) )
  {
    if ( *(_QWORD *)(*(_QWORD *)(a2 + 16) + 8LL) )
      v6 = *(const char **)(*(_QWORD *)(a2 + 16) + 8LL);
    else
      v6 = "(null)";
    v7 = strlen(v6) + 1;
    ...
    if ( result )
    {
      ...
      v12 = result;
      *(_DWORD *)(result + 8) = v10;
      memcpy((void *)(result + 40), v6, v11);
      *(_BYTE *)(v9 + v11) = 0;
      *(_QWORD *)(v12 + 32) = a3;
      *(_QWORD *)(v12 + 24) = *(_QWORD *)a3;
      *(_DWORD *)(v12 + 12) = *(_DWORD *)(a3 + 8);
      *(_DWORD *)(v12 + 16) = *(_DWORD *)(a3 + 12);
      *(_DWORD *)(v12 + 20) = *(unsigned __int8 *)(a3 + 11);
