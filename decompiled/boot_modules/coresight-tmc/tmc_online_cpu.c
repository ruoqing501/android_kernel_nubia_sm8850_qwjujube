__int64 __fastcall tmc_online_cpu(unsigned int a1)
{
  __int64 v1; // x23
  _UNKNOWN ***v2; // x22
  __int64 v3; // x27
  ...
  if ( cpu_pm_list != (_UNKNOWN *)&cpu_pm_list )
  {
    ...
    do
    {
      ...
      if ( ((unsigned __int64)(*(v2 - 5))[(unsigned __int64)a1 >> 6] & (1LL << a1)) != 0 )
      {
        ...
        *((_BYTE *)v2 - 8) = 1;
        raw_spin_unlock_irqrestore(v2 - 39);
      }
      v2 = (_UNKNOWN ***)v7;
    }
...
LABEL_13:
  ...
  *v15 = 0xDEAD000000000100LL;
  ...
  {
    if ( (unsigned int)tmc_add_coresight_dev(*(v15 - 2), *(v15 - 2) + 912LL) )
    {
      _pm_runtime_idle(*(v15 - 2), 4);
    }
    else
    {
      *(_QWORD *)(v19 + 376) = *(v15 - 1);
      _X8 = (unsigned __int64 *)(v19 + 368 + 8 * v1);
      __asm { PRFM            #0x11, [X8] }
      do
        v28 = __ldxr(_X8);
      while ( __stxr(v28 | v37, _X8) );
      _X8 = (unsigned __int64 *)(v19 + 384 + 8 * v1);
      __asm { PRFM            #0x11, [X8] }
      do
        v31 = __ldxr(_X8);
      ...
      *(_BYTE *)(v19 + 409) = 1;
      ...
      else
      {
        ...
        *(_QWORD *)(v19 + 416) = v24;
        *(_QWORD *)(v19 + 424) = &cpu_pm_list;
        cpu_pm_list = (_UNKNOWN *)(v19 + 416);
      }
      raw_spin_unlock(&delay_lock);
    }
    goto LABEL_13;
