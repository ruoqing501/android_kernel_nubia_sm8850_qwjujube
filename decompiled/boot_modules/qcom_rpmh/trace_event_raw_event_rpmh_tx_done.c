__int64 __fastcall trace_event_raw_event_rpmh_tx_done(__int64 a1, const char *a2, int a3, __int64 a4)
{
  __int64 v7; // x8
  const char *v8; // x22
  int v9; // w23
    ...
    || (v15 = a2, result = _trace_trigger_soft_disabled(a1), a2 = v15, (result & 1) == 0) )
  {
    ...
    if ( result )
    {
      ...
      v14 = (_DWORD *)result;
      *(_DWORD *)(result + 8) = v12;
      memcpy((void *)(result + 24), v8, v13);
      *(_BYTE *)(v11 + v13) = 0;
      v14[3] = a3;
      v14[4] = **(_DWORD **)(a4 + 16);
      v14[5] = *(_DWORD *)(*(_QWORD *)(a4 + 16) + 4LL);
