__int64 __fastcall speed_show(__int64 a1, __int64 a2, __int64 a3, __int64 *a4, __int64 a5, __int64 a6, __int64 a7)
{
  __int64 result; // x0
  __int64 v8; // x9
  __int64 v9; // x22
  ...
  *(_QWORD *)s = 0;
  if ( !v8 )
  {
    printk(&unk_A635, "aw86320", 805, "speed_show", *(unsigned int *)(g_aw86320 + 8), a6, a7);
