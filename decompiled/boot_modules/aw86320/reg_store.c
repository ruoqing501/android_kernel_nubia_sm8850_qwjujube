size_t __fastcall reg_store(__int64 a1, unsigned __int64 a2, unsigned __int64 a3)
{
  ...
  *(_QWORD *)&s[7] = 0;
  v8 = 0;
  *(_QWORD *)s = 0;
  printk(&unk_A543, "aw86320", 943, "reg_store", "reg_store", v5, 15);
  ...
  {
    v7 = WORD2(v8);
    printk(&unk_A18B, "aw86320", 951, "reg_store", "reg_store", (unsigned __int8)v8, WORD2(v8));
    haptic_i2c_write(v4, (unsigned int)v8, v7);
  }
