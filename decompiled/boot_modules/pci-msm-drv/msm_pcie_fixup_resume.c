__int64 __fastcall msm_pcie_fixup_resume(__int64 result)
{
  __int64 v1; // x19
  __int64 v2; // x22
  int v3; // w0
  ...
  if ( *(_DWORD *)(v2 + 1176) == 2 && (*(_BYTE *)(v2 + 1180) & 1) == 0 && !*(_QWORD *)(*(_QWORD *)(v1 + 16) + 16LL) )
  {
    ...
    if ( v3 )
    {
      ...
      if ( v2 )
      {
        ipc_log_string(
          *(_QWORD *)(v2 + 1704),
          "ERR:%s: PCIe: RC%d got failure in fixup resume:%d.\n",
          "msm_pcie_fixup_resume",
          *(_DWORD *)(v2 + 1348),
          v3);
        ipc_log_string(
          *(_QWORD *)(v2 + 1696),
          "%s: PCIe: RC%d got failure in fixup resume:%d.\n",
          "msm_pcie_fixup_resume",
          *(_DWORD *)(v2 + 1348),
          v4);
      }
