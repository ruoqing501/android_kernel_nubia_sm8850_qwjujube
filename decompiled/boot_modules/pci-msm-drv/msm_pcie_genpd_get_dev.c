__int64 __fastcall msm_pcie_genpd_get_dev(__int64 a1, const char *a2, unsigned __int64 *a3)
{
  const char **v3; // x23
  unsigned __int64 v7; // x0

  v3 = *(const char ***)a1;
  v7 = dev_pm_domain_attach_by_name(*(_QWORD *)a1 + 16LL);
  *a3 = v7;
