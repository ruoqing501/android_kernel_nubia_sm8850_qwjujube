__int64 __fastcall funnel_cpu_pm_notify(__int64 a1, __int64 a2)
{
      ...
      if ( cpu_pm_list != (_UNKNOWN *)&cpu_pm_list )
      {
        ...
        do
        {
          ...
          if ( ((unsigned __int64)(*(v8 - 5))[v9] & v10) != 0 )
          {
            ...
            raw_spin_unlock_irqrestore(v8 - 7);
          }
          v8 = (_UNKNOWN ***)v11;
        }
    ...
    if ( cpu_pm_list != (_UNKNOWN *)&cpu_pm_list )
    {
      ...
      do
      {
        ...
        if ( ((unsigned __int64)(*(v3 - 5))[v4] & v5) != 0 )
        {
          ...
          raw_spin_unlock_irqrestore(v3 - 7);
        }
        v3 = (_UNKNOWN ***)v22;
      }
