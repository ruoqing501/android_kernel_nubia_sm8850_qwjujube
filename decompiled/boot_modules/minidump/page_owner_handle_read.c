__int64 __fastcall page_owner_handle_read(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  size_t v7; // x0
  __int64 result; // x0
  ...
  *(_QWORD *)s = 0;
  v10 = 0;
  snprintf(s, 0x40u, "%lu KB\n", (unsigned __int64)page_owner_handles_size >> 10);
  v7 = strnlen(s, 0x40u);
  if ( v7 >= 0x41 )
  {
