__int64 __fastcall func_type_store(__int64 a1, int a2, char *s, int a4)
{
  __int64 v5; // x19
  __int64 v7; // x22
  __int64 result; // x0
...
LABEL_13:
    ...
    if ( (_DWORD)v10 == 7364963 )
    {
      v9 = 0;
    }
    else
    {
      if ( (_DWORD)v10 != 6517347 )
      {
        v5 = -22;
        goto LABEL_13;
      }
    ...
    v5 = (int)v5;
    *(_DWORD *)(*(_QWORD *)(v7 + 96) + 4LL * *(unsigned __int8 *)(v7 + 332)) = v9;
    goto LABEL_13;
  }
  result = -22;
LABEL_14:
