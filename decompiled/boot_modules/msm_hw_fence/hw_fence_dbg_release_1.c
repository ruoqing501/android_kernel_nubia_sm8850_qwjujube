__int64 __fastcall hw_fence_dbg_release_1(__int64 result, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v5; // x30
  _QWORD *v6; // x19
  ...
  if ( result )
  {
    ...
    if ( v7 && v7 < 0xFFFFFFFFFFFFF001LL )
    {
      ...
      {
        v9 = v5;
        v10 = msm_hw_fence_destroy((unsigned int *)v6[16], v6, a3, a4, v7);
LABEL_11:
        if ( v10 )
      ...
      {
        v9 = v5;
        v10 = hw_fence_destroy_refcount(v6[21], v6[22], 0x40000000u);
        goto LABEL_11;
      }
    }
