__int64 __fastcall sde_setup_ucsc_gcv1_common(__int64 a1, unsigned int a2, _DWORD *a3)
{
  __int64 v4; // x10
  unsigned int v5; // w20
  int *v6; // x21
  ...
  v10 = v8 & 0xFFFFFF07;
  if ( !*v6 )
    return sde_reg_write(a1, v5, v10, "gc_base");
  if ( v9 > 2 )
  {
    if ( v9 == 3 )
    {
      v10 = (unsigned int)v10 | 0x50;
      return sde_reg_write(a1, v5, v10, "gc_base");
    }
    if ( v9 == 4 )
    {
      v10 = (unsigned int)v10 | 0x70;
      return sde_reg_write(a1, v5, v10, "gc_base");
    }
    return _drm_err("Invalid UCSC GC mode \tmode: %d\n", v9);
  }
  if ( v9 == 1 )
  {
