__int64 __fastcall perf_trace_sde_perf_uidle_cntr(
        __int64 result,
        int a2,
        int a3,
        int a4,
        ...
        int a9)
{
  ...
  {
    result = perf_trace_buf_alloc(44, v26, &v25);
    if ( result )
    {
      v20 = (_QWORD *)v26[0];
      ...
      *(_DWORD *)(result + 24) = a6;
      *(_DWORD *)(result + 28) = a7;
      *(_DWORD *)(result + 32) = (_DWORD)v20;
      *(_DWORD *)(result + 36) = a9;
      result = perf_trace_run_bpf_submit(result, 44, v22, v12, 1, v21, StatusReg + v18, 0);
    }
  }
