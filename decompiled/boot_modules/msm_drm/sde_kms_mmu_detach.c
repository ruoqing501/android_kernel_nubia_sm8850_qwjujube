__int64 __fastcall sde_kms_mmu_detach(_QWORD *a1, char a2)
{
  __int64 v2; // x21
  __int64 v5; // x22
  __int64 v6; // x0
  ...
  if ( v2 )
  {
    ...
    msm_gem_aspace_domain_attach_detach_update(v2, 1);
    if ( (_drm_debug & 4) != 0 )
      _drm_dev_dbg(0, 0, 0, "Detaching domain:%d\n", 0);
    v8 = *(void (__fastcall **)(__int64, char **, __int64))(**(_QWORD **)(v2 + 256) + 8LL);
    if ( *((_DWORD *)v8 - 1) != 332361455 )
      __break(0x8228u);
    v8(v5, &iommu_ports, 1);
    *(_BYTE *)(v2 + 268) = 0;
  }
...
LABEL_18:
  ...
  {
LABEL_21:
    msm_gem_aspace_domain_attach_detach_update(v9, 1);
    if ( (_drm_debug & 4) != 0 )
      _drm_dev_dbg(0, 0, 0, "Detaching domain:%d\n", 1);
    v14 = *(void (__fastcall **)(__int64, char **, __int64))(**(_QWORD **)v11 + 8LL);
    if ( *((_DWORD *)v14 - 1) != 332361455 )
      __break(0x8228u);
...
LABEL_26:
  ...
  if ( v15 )
  {
    ...
    msm_gem_aspace_domain_attach_detach_update(v15, 1);
    if ( (_drm_debug & 4) != 0 )
      _drm_dev_dbg(0, 0, 0, "Detaching domain:%d\n", 2);
    v19 = *(void (__fastcall **)(__int64, char **, __int64))(**(_QWORD **)(v15 + 256) + 8LL);
    if ( *((_DWORD *)v19 - 1) != 332361455 )
      __break(0x8228u);
...
LABEL_44:
  msm_gem_aspace_domain_attach_detach_update(v20, 1);
  if ( (_drm_debug & 4) != 0 )
    _drm_dev_dbg(0, 0, 0, "Detaching domain:%d\n", 3);
  v24 = *(void (__fastcall **)(__int64, char **, __int64))(**(_QWORD **)v22 + 8LL);
  if ( *((_DWORD *)v24 - 1) != 332361455 )
    __break(0x8228u);
