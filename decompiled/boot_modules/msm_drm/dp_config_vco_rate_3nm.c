__int64 __fastcall dp_config_vco_rate_3nm(__int64 a1, __int64 a2)
{
  int v4; // w21
  ...
  v4 = readl_relaxed_3((unsigned int *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 48) + 344LL) + 24LL) + 200LL));
  *(_BYTE *)(a1 + 56) = v4 & 0xF;
...
LABEL_177:
      ...
      printk(&unk_2618EB, "dp_vco_pll_init_db_3nm");
      v175 = get_ipc_log_context();
      ipc_log_string(v175, "[e][%-4d]VCO Init DB failed\n", *v6);
      v174 = &unk_22D9D2;
      goto LABEL_178;
    }
    v9 = 9720000;
  ...
  *(_DWORD *)(a1 + 60) = v10;
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 20,
    ...
    v12,
    v176);
  writel_relaxed_3(15, *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 20LL);
  if ( *(_BYTE *)(a1 + 56) == 4 )
  {
  ...
  sde_evtlog_log(v15, "dp_config_vco_rate_3nm", v16, 4, v17 + 24, v18, -1059143953, v14, v177);
  writel_relaxed_3(v19, *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 24LL);
  v24 = *(_DWORD *)(a1 + 60);
  if ( v24 > 3 )
  {
    v173 = get_ipc_log_context();
    ipc_log_string(v173, "[e][%-4d]link rate not set\n", *v6);
    v174 = &unk_22A22C;
LABEL_178:
    printk(v174, "dp_config_vco_rate_3nm");
    return 4294967274LL;
  }
  v25 = *(_QWORD *)(a1 + 64);
  __dsb(0xEu);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 380,
    ...
    v27,
    v178);
  writel_relaxed_3(21, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 380LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 272,
    ...
    v29,
    v179);
  writel_relaxed_3(59, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 272LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 228,
    ...
    v31,
    v180);
  writel_relaxed_3(2, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 228LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 224,
    ...
    v33,
    v181);
  writel_relaxed_3(12, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 224LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 232,
    ...
    v36,
    v182);
  writel_relaxed_3(6, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 232LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 356,
    ...
    v38,
    v183);
  writel_relaxed_3(48, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 356LL);
  __dsb(0xEu);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 244,
    ...
    v40,
    v184);
  writel_relaxed_3((unsigned int)v34[17], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 244LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 120,
    ...
    v42,
    v185);
  writel_relaxed_3(54, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 120LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 116,
    ...
    v44,
    v186);
  writel_relaxed_3(22, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 116LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 112,
    ...
    v46,
    v187);
  writel_relaxed_3(6, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 112LL);
  __dsb(0xEu);
  ...
  sde_evtlog_log(
    ...
    *v34,
    ...
    v48,
    v188);
  writel_relaxed_3((unsigned int)*v34, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 60LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 136,
    ...
    v50,
    v189);
  writel_relaxed_3((unsigned int)v34[5], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 136LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 144,
    ...
    v52,
    v190);
  writel_relaxed_3((unsigned int)v34[6], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 144LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 148,
    ...
    v54,
    v191);
  writel_relaxed_3((unsigned int)v34[7], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 148LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 152,
    ...
    v56,
    v192);
  writel_relaxed_3((unsigned int)v34[8], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 152LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 128,
    ...
    v58,
    v193);
  writel_relaxed_3((unsigned int)v34[9], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 128LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 132,
    ...
    v60,
    v194);
  writel_relaxed_3((unsigned int)v34[10], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 132LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 288,
    ...
    v62,
    v195);
  writel_relaxed_3((unsigned int)v34[3], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 288LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 112,
    ...
    v64,
    v196);
  writel_relaxed_3((unsigned int)v34[4], *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 112LL);
  __dsb(0xEu);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 372,
    ...
    v66,
    v197);
  writel_relaxed_3(18, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 372LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 160,
    ...
    v68,
    v198);
  writel_relaxed_3((unsigned int)v34[1], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 160LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 164,
    ...
    v70,
    v199);
  writel_relaxed_3((unsigned int)v34[2], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 164LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 320,
    ...
    v72,
    v200);
  writel_relaxed_3(0, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 320LL);
  __dsb(0xEu);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 188,
    ...
    v74,
    v201);
  writel_relaxed_3((unsigned int)v34[18], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 188LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 124,
    ...
    v76,
    v202);
  writel_relaxed_3(20, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 124LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 316,
    ...
    v78,
    v203);
  writel_relaxed_3(0, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 316LL);
  ...
  sde_evtlog_log(v84, "dp_config_vco_rate_3nm", v85, 4, v86 + 220, v87, -1059143953, v83, v204);
  writel_relaxed_3(v88, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 220LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 368,
    ...
    v90,
    v205);
  writel_relaxed_3((unsigned int)v34[19], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 368LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 88,
    ...
    v92,
    v206);
  writel_relaxed_3((unsigned int)v34[15], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 88LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 92,
    ...
    v94,
    v207);
  writel_relaxed_3((unsigned int)v34[16], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 92LL);
  __dsb(0xEu);
  if ( *(_BYTE *)(a1 + 32) == 1 )
  {
    ...
    sde_evtlog_log(
      ...
      *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 192,
      ...
      v96,
      v208);
    writel_relaxed_3(1, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 192LL);
    ...
    sde_evtlog_log(
      ...
      *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 196,
      ...
      v98,
      v209);
    writel_relaxed_3(0, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 196LL);
    ...
    sde_evtlog_log(
      ...
      *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 204,
      ...
      v100,
      v210);
    writel_relaxed_3((unsigned int)v34[13], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 204LL);
    ...
    sde_evtlog_log(
      ...
      *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 208,
      ...
      v102,
      v211);
    writel_relaxed_3((unsigned int)v34[14], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 208LL);
    ...
    sde_evtlog_log(
      ...
      *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 96,
      ...
      v104,
      v212);
    writel_relaxed_3((unsigned int)v34[11], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 96LL);
    ...
    sde_evtlog_log(
      ...
      *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 100,
      ...
      v106,
      v213);
    writel_relaxed_3((unsigned int)v34[12], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 100LL);
  }
  ...
  sde_evtlog_log(v112, "dp_config_vco_rate_3nm", v113, 4, v114 + 28, v115, -1059143953, v111, v208);
  writel_relaxed_3(v116, *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 28LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 36,
    ...
    v118,
    v214);
  writel_relaxed_3(19, *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 36LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 40,
    ...
    v120,
    v215);
  writel_relaxed_3(164, *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 40LL);
  __dsb(0xEu);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 120,
    ...
    v122,
    v216);
  writel_relaxed_3(5, *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 120LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 32,
    ...
    v124,
    v217);
  writel_relaxed_3(48, *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 32LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 44,
    ...
    v126,
    v218);
  writel_relaxed_3(59, *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 44LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 8,
    ...
    v128,
    v219);
  writel_relaxed_3(15, *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 8LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 28,
    ...
    v130,
    v220);
  writel_relaxed_3(3, *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 28LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 192,
    ...
    v132,
    v221);
  writel_relaxed_3(15, *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 192LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 96,
    ...
    v134,
    v222);
  writel_relaxed_3(0, *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 96LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 196,
    ...
    v136,
    v223);
  writel_relaxed_3(0, *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 196LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 60,
    ...
    v138,
    v224);
  writel_relaxed_3((unsigned int)v34[20], *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 60LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 64,
    ...
    v140,
    v225);
  writel_relaxed_3((unsigned int)v34[21], *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 64LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 36,
    ...
    v142,
    v226);
  writel_relaxed_3(4, *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 36LL);
  __dsb(0xEu);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 156,
    ...
    v144,
    v227);
  writel_relaxed_3(5, *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 156LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 32,
    ...
    v146,
    v228);
  writel_relaxed_3(48, *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 32LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 44,
    ...
    v148,
    v229);
  writel_relaxed_3(59, *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 44LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 8,
    ...
    v150,
    v230);
  writel_relaxed_3(15, *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 8LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 28,
    ...
    v152,
    v231);
  writel_relaxed_3(3, *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 28LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 192,
    ...
    v154,
    v232);
  writel_relaxed_3(15, *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 192LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 96,
    ...
    v156,
    v233);
  writel_relaxed_3(0, *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 96LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 196,
    ...
    v158,
    v234);
  writel_relaxed_3(0, *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 196LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 60,
    ...
    v160,
    v235);
  writel_relaxed_3((unsigned int)v34[20], *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 60LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 64,
    ...
    v162,
    v236);
  writel_relaxed_3((unsigned int)v34[21], *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 64LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 36,
    ...
    v164,
    v237);
  writel_relaxed_3(4, *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 36LL);
  __dsb(0xEu);
  if ( (readl_relaxed_3(*(unsigned int **)(*(_QWORD *)(a1 + 376) + 24LL)) & 0x80000000) == 0 )
    return 4294967274LL;
  v166 = readl_relaxed_3((unsigned int *)(*(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 112LL)) & 0xFFFFFFFC;
  if ( a2 > 5399999 )
  {
    if ( a2 == 5400000 )
    {
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 112,
    ...
    v169,
    v238);
  writel_relaxed_3(v166, *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 112LL);
  __dsb(0xEu);
  v170 = *(_QWORD *)(a1 + 8) / (unsigned __int64)v167;
  v171 = *(_QWORD *)(a1 + 8);
  clk_set_rate(***(_QWORD ***)(a1 + 384), v171 / 0xA);
  clk_set_rate(*(_QWORD *)(**(_QWORD **)(a1 + 384) + 8LL), v170);
