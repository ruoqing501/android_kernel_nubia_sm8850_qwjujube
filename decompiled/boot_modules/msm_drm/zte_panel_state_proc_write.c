__int64 __fastcall zte_panel_state_proc_write(__int64 a1, int a2, size_t a3)
{
  size_t v3; // x19
  size_t v6; // x21
...
LABEL_4:
    ...
    if ( inline_copy_from_user_8((int)v7, a2, v3) )
      goto LABEL_4;
    if ( !a1 )
      break;
    if ( v6 )
    {
      zte_set_disp_parameter(a1, 5, *v7 - 48);
      kfree(v7);
      return v3;
    }
    __break(1u);
    ...
    *(_QWORD *)(StatusReg + 80) = &zte_panel_state_proc_write__alloc_tag;
