__int64 __fastcall sde_setup_fp16_unmultv1(__int64 a1, unsigned int a2, _DWORD *a3)
{
  int v4; // w3
  __int64 v5; // x10
  unsigned int v6; // w20
  ...
  if ( !v6 )
    return _drm_err("invalid offset for FP16 UNMULT CP block\tpipe: %d\tindex: %d\n", *(_DWORD *)(a1 + 48), a2);
  v8 = sde_reg_read(a1, v6);
  if ( *(_QWORD *)a3 && **(_BYTE **)a3 == 1 )
    v9 = v8 | 1u;
  else
    v9 = v8 & 0xFFFFFFFE;
  return sde_reg_write(a1, v6, v9, "unmult_base");
}
