__int64 __fastcall edp_pll_configure_0(__int64 a1, __int64 a2)
{
  __int64 v3; // x20
  ...
  else
  {
    ...
    ipc_log_string(
      ...
      *(_DWORD *)(_ReadStatusReg(SP_EL0) + 1800),
      a2);
    printk(&unk_234518, "edp_pll_configure");
    return 4294967274LL;
  }
}
