__int64 __fastcall sde_encoder_phys_vid_control_esync_vsync_irq(__int64 a1, char a2)
{
  const void *v2; // x30
  const void *v4; // x22
  int v6; // w21
  ...
  if ( !a1 )
  {
    printk(&unk_26FCAB, "sde_encoder_phys_vid_control_esync_vsync_irq");
...
LABEL_12:
  ...
  v14 = sde_evtlog_log(
          sde_dbg_base_evtlog,
          "sde_encoder_phys_vid_control_esync_vsync_irq",
          1681,
          -1,
          v13,
          a2 & 1,
  ...
  if ( (a2 & 1) == 0 )
  {
    ...
    if ( !v29 )
    {
      ...
      v15 = sde_encoder_helper_unregister_irq(a1, 5u);
      if ( !v15 )
        goto LABEL_22;
      __asm { PRFM            #0x11, [X26] }
      do
...
LABEL_30:
      printk(&unk_26C9CC, "sde_encoder_phys_vid_control_esync_vsync_irq");
      if ( *(_QWORD *)a1 )
...
LABEL_21:
  ...
  v15 = sde_encoder_helper_register_irq(a1, 5u);
  if ( v15 )
  {
    __asm { PRFM            #0x11, [X26] }
    do
