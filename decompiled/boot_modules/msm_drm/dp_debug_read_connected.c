unsigned __int64 __fastcall dp_debug_read_connected(__int64 a1, unsigned __int64 a2, unsigned __int64 a3, _QWORD *a4)
{
  __int64 v4; // x8
  ...
  if ( v4 )
  {
    ...
    {
      v5 = a3;
      v8 = *(unsigned __int8 *)(*(_QWORD *)(v4 + 104) + 8LL);
      v25[0] = 0;
      v9 = snprintf((char *)v25, 8u, "%d\n", v8);
      if ( v9 < v5 )
        v5 = v9;
      if ( v5 >= 9 )
      {
