__int64 __fastcall sde_get_hw_caps_for_tuna(__int64 result)
{
  ...
  do
    v60 = __ldxr(_X8);
  while ( __stxr(v60 | 0x20000000000LL, _X8) );
  __asm { PRFM            #0x11, [X8] }
  do
    v62 = __ldxr(_X8);
  while ( __stxr(v62 | 0x40000000000LL, _X8) );
  __asm { PRFM            #0x11, [X8] }
  do
    v64 = __ldxr(_X8);
  while ( __stxr(v64 | 0x100, _X8) );
  __asm { PRFM            #0x11, [X8] }
  do
    v66 = __ldxr(_X8);
  while ( __stxr(v66 | 0x1000000000LL, _X8) );
  __asm { PRFM            #0x11, [X8] }
  do
    v68 = __ldxr(_X8);
  while ( __stxr(v68 | 0x400000000000LL, _X8) );
  __asm { PRFM            #0x11, [X8] }
  do
    v70 = __ldxr(_X8);
  while ( __stxr(v70 | 0x1000000000000LL, _X8) );
