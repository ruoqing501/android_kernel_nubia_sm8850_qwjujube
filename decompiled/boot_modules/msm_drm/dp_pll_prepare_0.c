__int64 __fastcall dp_pll_prepare_0(__int64 a1)
{
  unsigned int v2; // w0
  __int64 v3; // x0
  __int64 v4; // x8
  ...
  if ( *(_DWORD *)a1 >= 3u && *(_QWORD *)(a1 + 8) == 8100000 )
  {
    v2 = dp_regulator_enable_4nm(*(_QWORD *)(a1 + 320), 1);
    if ( (v2 & 0x80000000) != 0 )
    {
      v21 = v2;
  ...
  **(_DWORD **)(a1 + 336) &= ~0x2000u;
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 16,
    ...
    v6,
    vars0);
  writel_relaxed_2(1, *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 16LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 16,
    ...
    v8,
    vars0a);
  writel_relaxed_2(5, *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 16LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 16,
    ...
    v12,
    vars0c);
  writel_relaxed_2(9, *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 16LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 280,
    ...
    v14,
    vars0d);
  writel_relaxed_2(32, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 280LL);
  __dsb(0xEu);
  if ( (dp_4nm_pll_get_status(a1, 0) & 1) == 0
    || (dp_4nm_pll_get_status(a1, 1) & 1) == 0
    || (dp_4nm_pll_get_status(a1, 2) & 1) == 0 )
  {
    goto LABEL_25;
  }
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 16,
    ...
    v16,
    vars0e);
  writel_relaxed_2(25, *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 16LL);
  __dsb(0xEu);
  if ( (dp_4nm_pll_get_status(a1, 4) & 1) == 0 || (dp_4nm_pll_get_status(a1, 3) & 1) == 0 )
  {
LABEL_25:
