__int64 __fastcall dspp_sixzone_install_property(__int64 *a1)
{
  __int64 v1; // x8
  __int64 v2; // x8
  int v3; // w4
  ...
  *(_QWORD *)s = 0;
  v7 = 0;
  v3 = HIWORD(*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v2 + 8) + 152LL) + 8216LL) + 212LL));
  ...
  {
    snprintf(s, 0x100u, "%s%d", "SDE_DSPP_PA_SIXZONE_V", v3);
    result = sde_cp_crtc_install_blob_property(a1, s, 8, 4648);
  }
