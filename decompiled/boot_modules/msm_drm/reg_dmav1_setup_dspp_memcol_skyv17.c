size_t __fastcall reg_dmav1_setup_dspp_memcol_skyv17(int *a1, _QWORD *a2)
{
  const void *v4; // x1
  __int64 v5; // x2
  unsigned int v6; // w4
  ...
  if ( &dspp_buf[2 * v5] == (unsigned __int64 *)-480LL )
  ...
  *((_DWORD *)a2 + 40) = a2[20] & 0xFF0F0FFF | 0x701000;
  if ( v7 )
  {
    ...
    if ( v8 == 48 )
    {
      sde_evtlog_log(
        ...
        1,
        239);
      return _setup_dspp_memcol((__int64)a1, 6u, (__int64)a2, v9, v10, v11, v12);
    }
    else
    {
  ...
  {
    v14 = _drm_dev_dbg(0, 0, 1, "disable memcolor sky feature\n");
    reg_dma_dspp_memcol_off((__int64)a1, (__int64)a2, 6u, v14, v15, v16, v17);
