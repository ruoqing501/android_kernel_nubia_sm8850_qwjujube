__int64 __fastcall zte_lcd_temp_debug_proc_write(__int64 a1, unsigned __int64 a2, size_t a3)
{
  size_t v3; // x19
  size_t v6; // x21
...
LABEL_4:
    ...
    if ( v6 )
    {
      zte_set_disp_parameter(a1, 14, *v7 - 48);
      kfree(v7);
      return v3;
    }
    __break(1u);
    ...
    *(_QWORD *)(StatusReg + 80) = &zte_lcd_temp_debug_proc_write__alloc_tag;
