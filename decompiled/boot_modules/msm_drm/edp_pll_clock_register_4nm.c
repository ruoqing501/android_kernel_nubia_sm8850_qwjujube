__int64 __fastcall edp_pll_clock_register_4nm(__int64 a1)
{
  __int64 v1; // x22
  __int64 v3; // x0
  __int64 v4; // x0
  ...
  if ( !a1 )
  {
    ...
    printk(&unk_22D972, "edp_pll_clock_register_4nm");
    return 4294967274LL;
  }
  v1 = *(_QWORD *)(a1 + 312);
  ...
  *(_DWORD *)(v4 + 8) = 2;
  *(_QWORD *)(a1 + 64) = &pll_params_1;
  v5 = *(const char **)(a1 + 24);
  *(_QWORD *)(a1 + 400) = edp_pll_configure_0;
  *(_QWORD *)(a1 + 408) = edp_pll_prepare_0;
  *(_QWORD *)(a1 + 48) = a1;
  *(_QWORD *)(a1 + 416) = edp_pll_unprepare_0;
  snprintf((char *)(a1 + 160), 0x20u, "%s%s", v5, "_phy_pll_link_clk");
  v6 = *(const char **)(a1 + 24);
  *(_QWORD *)(a1 + 104) = a1 + 160;
  *(_QWORD *)(a1 + 112) = &edp_pll_link_clk_ops_0;
  *(_QWORD *)(a1 + 88) = a1 + 104;
  snprintf((char *)(a1 + 280), 0x20u, "%s%s", v6, "_phy_pll_vco_div_clk");
  *(_QWORD *)(a1 + 232) = &edp_pll_vco_div_clk_ops_0;
  ...
  *(_QWORD *)(a1 + 208) = a1 + 224;
  ...
  if ( v7 )
  {
    ...
    v15 = &unk_24F36D;
LABEL_15:
    printk(v15, "edp_pll_clock_register_4nm");
    dp_pll_clock_unregister_4nm(a1);
    return v8;
  }
