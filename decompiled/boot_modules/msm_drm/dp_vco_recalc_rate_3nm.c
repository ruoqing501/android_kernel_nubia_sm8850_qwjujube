__int64 __fastcall dp_vco_recalc_rate_3nm(_QWORD *a1)
{
  __int64 v2; // x20
  __int64 v3; // x25
  unsigned int v4; // w19
  ...
  if ( !a1 )
  {
    ...
    printk(&unk_26189D, "dp_vco_recalc_rate_3nm");
    return -22;
  }
  if ( (readl_relaxed_3(*(_QWORD *)(a1[47] + 24LL)) & 0x80000000) == 0 )
    return 0;
  v2 = 8100000;
  v3 = 2700000;
  v4 = readl_relaxed_3(*(_QWORD *)(a1[44] + 24LL) + 60LL) & 0xF;
  if ( v4 > 2 )
  {
    if ( v4 == 5 )
    {
  ...
  v5 = 1;
LABEL_16:
  v9 = ((unsigned int)readl_relaxed_3(*(_QWORD *)(a1[43] + 24LL) + 40LL) >> 2) & 3;
  switch ( v9 )
  {
    case 0u:
      v10 = 5;
  ...
  printk(&unk_21CA97, "dp_vco_recalc_rate_3nm");
  v10 = 0;
  if ( (v5 & 1) != 0 )
  {
LABEL_22:
