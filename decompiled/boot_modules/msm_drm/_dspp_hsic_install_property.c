__int64 __fastcall dspp_hsic_install_property(__int64 *a1)
{
  __int64 v1; // x8
  __int64 v2; // x8
  int v3; // w1
  ...
  *(_QWORD *)s = 0;
  v7 = 0;
  v3 = HIWORD(*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v2 + 8) + 152LL) + 8216LL) + 140LL));
  if ( v3 == 1 )
  {
    snprintf(s, 0x100u, "%s%d", "SDE_DSPP_PA_HSIC_V", 1);
    result = sde_cp_crtc_install_blob_property(a1, s, 3, 24);
  }
  else
  {
