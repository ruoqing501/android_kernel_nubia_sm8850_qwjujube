__int64 __fastcall dspp_rc_install_property(__int64 *a1)
{
  __int64 v2; // x20
  int v3; // w1
  __int64 result; // x0
  ...
  *(_QWORD *)s = 0;
  ...
  if ( a1 )
  {
    v2 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*a1 + 56) + 8LL) + 152LL);
    v3 = HIWORD(*(_DWORD *)(*(_QWORD *)(v2 + 8216) + 532LL));
    if ( v3 == 1 )
    {
      snprintf(s, 0x100u, "%s%d", "SDE_DSPP_RC_MASK_V", 1);
      result = sde_cp_crtc_install_blob_property(a1, s, 34, 21856);
      if ( (*(_QWORD *)(v2 + 22008) & 0x80000000) != 0 )
      {
        result = _drm_dev_dbg(0, 0, 0, "rc using lm flush override\n");
        v5 = a1 + 565;
        while ( 1 )
        {
          v5 = (__int64 *)*v5;
  ...
  {
    result = _drm_err("invalid arguments");
  }
