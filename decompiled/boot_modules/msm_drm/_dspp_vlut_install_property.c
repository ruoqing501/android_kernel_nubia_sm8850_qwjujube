__int64 __fastcall dspp_vlut_install_property(__int64 *a1)
{
  __int64 v2; // x8
  __int64 v3; // x8
  int v4; // w20
  ...
  *(_QWORD *)s = 0;
  v7 = 0;
  v4 = HIWORD(*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v3 + 8) + 152LL) + 8216LL) + 500LL));
  snprintf(s, 0x100u, "%s%d", "SDE_DSPP_VLUT_V", v4);
  if ( v4 == 1 )
  {
    sde_cp_crtc_install_range_property(a1, s, 14, 0, -1, 0);
    result = sde_cp_create_local_blob(a1, 14, 1032);
  }
  else
  {
