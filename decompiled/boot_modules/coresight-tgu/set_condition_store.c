__int64 __fastcall set_condition_store(__int64 a1, int a2, char *s, __int64 a4)
{
  __int64 v4; // x9
  __int64 v5; // x20
  __int64 v7; // x2
...
LABEL_8:
  ...
  {
    dev_err(*(_QWORD *)(v5 + 8), "Invalid condition decode data\n", v7);
  }
  else
  {
    *(_QWORD *)(*(_QWORD *)(v5 + 64) + 16LL * *(int *)(v5 + 100)) = 472 * (int)v9 + 4 * HIDWORD(v9) + 80;
    *(_QWORD *)(*(_QWORD *)(v5 + 64) + 16LL * (int)(*(_DWORD *)(v5 + 100))++ + 8) = v10;
  }
