__int64 __fastcall sched_nbia_queuework_enable_show(__int64 a1, __int64 a2, char *a3)
{
  __int64 result; // x0
  ...
  *(_QWORD *)s = 0;
  v6 = 0;
  snprintf(s, 0x100u, "%d", sched_nbia_queuework_enable);
  LODWORD(result) = snprintf(a3, 0x100u, "%s", s);
