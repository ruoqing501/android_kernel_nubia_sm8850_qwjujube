__int64 __fastcall perf_trace_safg_sau_cnt_calc(__int64 result, int a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // x30
  __int64 v7; // x25
  __int64 v10; // x19
  ...
  if ( *(_QWORD *)(result + 112) || *(_QWORD *)(StatusReg + v14) )
  {
    ...
    if ( result )
    {
      ...
      *(_QWORD *)(result + 32) = a5;
      *(_QWORD *)(result + 40) = a6;
      result = perf_trace_run_bpf_submit(result, 52, v17, v10, 1, v18, StatusReg + v14, 0);
    }
  }
