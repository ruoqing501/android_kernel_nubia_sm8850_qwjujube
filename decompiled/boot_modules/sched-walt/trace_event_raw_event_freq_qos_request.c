__int64 __fastcall trace_event_raw_event_freq_qos_request(__int64 a1, const char *a2, __int64 a3, int a4, int a5)
{
  __int64 v9; // x8
  const char *v10; // x23
  int v11; // w24
    ...
    || (v17 = a2, result = _trace_trigger_soft_disabled(a1), a2 = v17, (result & 1) == 0) )
  {
    if ( a2 )
      ...
      v10 = "(null)";
    v11 = strlen(v10) + 1;
    result = trace_event_buffer_reserve(v18, a1, v11 + 48LL);
    if ( result )
    {
      v13 = result + 48;
      v14 = (v11 << 16) | 0x30;
