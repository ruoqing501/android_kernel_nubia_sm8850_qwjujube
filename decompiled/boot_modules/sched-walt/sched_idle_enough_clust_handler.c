__int64 __fastcall sched_idle_enough_clust_handler(__int64 *a1, unsigned int a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v5; // x8
  __int64 v6; // x9
  __int64 v7; // x10
  ...
  else
  {
    ...
    if ( a2 )
    {
      ...
      if ( !v16 )
        sysctl_sched_idle_enough = sysctl_sched_idle_enough_clust;
    }
    else
    {
      v19 = (_QWORD *)a1[1];
