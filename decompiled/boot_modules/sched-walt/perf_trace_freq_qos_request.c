size_t __fastcall perf_trace_freq_qos_request(__int64 a1, const char *a2, __int64 a3, int a4, int a5)
{
  __int64 v5; // x30
  __int64 v7; // x25
  const char *v11; // x24
