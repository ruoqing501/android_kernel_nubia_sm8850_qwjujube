__int64 __fastcall other_sync_pct(unsigned __int64 a1)
{
  __int64 v1; // x8
  __int64 v2; // x8
  __int64 v3; // x9
  ...
  v1 = num_sched_clusters - 2;
  if ( (unsigned int)sched_ravg_window < 0xF42400 )
  {
    if ( (unsigned int)v1 <= 3 && (unsigned int)(num_sched_clusters - 1) <= 3 )
    {
      v2 = 16 * v1;
      v3 = 4LL * (unsigned int)(num_sched_clusters - 1);
...
LABEL_12:
    __break(0x5512u);
    return prime_sync_pct();
  }
  if ( (unsigned int)v1 >= 4 || (unsigned int)(num_sched_clusters - 1) > 3 )
    goto LABEL_12;
  v2 = 16 * v1;
  v3 = 4LL * (unsigned int)(num_sched_clusters - 1);
