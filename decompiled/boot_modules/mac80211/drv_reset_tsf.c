__int64 __fastcall drv_reset_tsf(__int64 result, __int64 a2)
{
  int v2; // w2
  void (*v3)(void); // x8
  __int64 v4; // x19
  ...
  if ( (*(_BYTE *)(*(_QWORD *)(a2 + 1616) + 1471LL) & 1) != 0
    ...
    || (drv_reset_tsf___already_done & 1) != 0 )
  {
  ...
  {
    v5 = *(_QWORD *)(a2 + 1608);
    drv_reset_tsf___already_done = 1;
    v6 = result;
    if ( v5 )
  ...
  v3 = *(void (**)(void))(*(_QWORD *)(result + 464) + 368LL);
  if ( v3 )
  {
    v4 = result;
