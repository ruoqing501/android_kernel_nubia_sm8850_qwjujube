__int64 __fastcall drv_sta_set_txpwr(__int64 a1, __int64 a2)
{
  int v2; // w8
  __int64 v4; // x10
  __int64 v5; // x19
  ...
  if ( (*(_BYTE *)(*(_QWORD *)(a2 + 1616) + 1471LL) & 1) != 0
    ...
    || (drv_sta_set_txpwr___already_done & 1) != 0 )
  {
  ...
  {
    v4 = *(_QWORD *)(a2 + 1608);
    drv_sta_set_txpwr___already_done = 1;
    v5 = a1;
    v6 = a2;
    if ( v4 )
  ...
  v8 = *(__int64 (**)(void))(*(_QWORD *)(a1 + 464) + 288LL);
  if ( !v8 )
    return 4294967201LL;
  if ( *((_DWORD *)v8 - 1) != -494940096 )
    __break(0x8228u);
  return v8();
}
