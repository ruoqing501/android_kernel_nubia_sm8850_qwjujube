__int64 __fastcall ieee80211_crypto_aes_cmac_encrypt(__int64 a1)
{
  int v1; // w8
  __int64 v2; // x20
  __int64 v3; // x19
  ...
  if ( v1 == 1 )
  {
    ...
    if ( *(_QWORD *)(v3 + 72) && (*(_WORD *)(v2 + 552) & 0x400) == 0 )
      goto LABEL_13;
    if ( !*(_DWORD *)(v3 + 116) && (unsigned int)(*(_DWORD *)(v3 + 212) - *(_DWORD *)(v3 + 208)) > 0x11 )
    {
      v5 = skb_put(v3, 18);
      *(_WORD *)v5 = 4172;
      ...
      *(_BYTE *)(v5 + 9) = BYTE5(v19);
      if ( !*(_QWORD *)(v3 + 72) )
      {
        ...
        *(_QWORD *)((char *)v20 + 2) = v9;
        ieee80211_aes_cmac(v11, v20, (__int64)(v6 + 12), v10, (_QWORD *)(v5 + 10));
      }
LABEL_13:
      result = 0;
      goto LABEL_14;
