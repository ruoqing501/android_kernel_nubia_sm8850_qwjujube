__int64 __fastcall ipclite_dbg_ctrl_write(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  int v5; // w0
  __int64 v6; // x2
  __int64 v7; // x3
  ...
  v5 = kstrtoint(a3, 0, &ipclite_debug_control);
  if ( v5 < 0 )
  {
    v20 = v5;
    if ( (ipclite_debug_level & 1) != 0 )
    {
      ...
      {
        printk(&unk_10A4E, "ipclite", "ipclite_dbg_ctrl_write");
...
LABEL_23:
  ...
  if ( (debug_status & 1) != 0 )
  {
    *(_DWORD *)(ipclite_dbg_info + 8) = ipclite_debug_control;
    v12 = 1;
    __dsb(0xEu);
    while ( 1 )
    {
      if ( (((unsigned int)enabled_hosts >> v12) & 1) != 0 )
      {
        if ( (ipclite_notify_core(v12, 5) & 0x80000000) != 0 )
        {
          ...
          if ( (ipclite_debug_control & 1) != 0 )
          {
            printk(&unk_10F9A, "ipclite", "ipclite_dbg_ctrl_write");
            if ( (ipclite_debug_control & 4) == 0 )
              goto LABEL_5;
          }
        ...
        else
        {
          ...
          if ( (ipclite_debug_control & 1) != 0 )
          {
            printk(&unk_1092D, "ipclite", "ipclite_dbg_ctrl_write");
            if ( (ipclite_debug_control & 4) == 0 )
              goto LABEL_5;
          }
          else if ( (ipclite_debug_control & 4) == 0 )
...
LABEL_5:
  ...
  printk(&unk_EEDB, "ipclite", "ipclite_dbg_ctrl_write");
  return -12;
}
