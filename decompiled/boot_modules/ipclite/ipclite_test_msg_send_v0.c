__int64 __fastcall ipclite_test_msg_send_v0(
        unsigned int a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        __int64 a8)
{
  ...
  if ( a1 >= 9 )
  {
    if ( (ipclite_debug_level & 1) != 0 )
    {
      ...
      {
        printk(&unk_FCEA, "ipclite", "ipclite_test_msg_send_v0");
...
LABEL_5:
  ...
  result = ipclite_tx(ipclite + 704LL * a1 + 8, a2, 3);
  if ( (result & 0x80000000) == 0 )
  {
    if ( (ipclite_debug_level & 8) != 0 )
    {
      ...
      {
        v14 = result;
        printk(&unk_10EBD, "ipclite", "ipclite_test_msg_send_v0");
        LODWORD(result) = v14;
        if ( (ipclite_debug_control & 4) == 0 )
          return 0;
        goto LABEL_11;
...
LABEL_11:
        ipclite_inmem_log(
          "APPS:%s:Test Msg send complete to core : %d signal : %d ret : %d\n",
          (__int64)&unk_1039F,
          a1,
          3,
          (unsigned int)result,
  ...
  if ( (ipclite_debug_level & 1) != 0 )
  {
    ...
    {
      v15 = result;
      printk(&unk_E61A, "ipclite", "ipclite_test_msg_send_v0");
      result = v15;
      if ( (ipclite_debug_control & 4) == 0 )
        return result;
    }
