__int64 __fastcall perf_trace_rdev_inform_bss(__int64 result, __int64 a2, __int64 a3)
{
  __int64 v3; // x30
  __int64 v4; // x23
  __int64 v6; // x19
  ...
  *(_QWORD *)(v22[0] + 232LL) = &v23;
  ...
  else
  {
    ...
    if ( v14 < 0x21 )
    {
      ...
      v15 = *(_DWORD *)(a3 + 72);
      *(_WORD *)(v11 + 44) = *(_WORD *)(a3 + 76);
      *(_DWORD *)(v11 + 40) = v15;
      v16 = *(_DWORD **)a3;
      if ( *(_QWORD *)a3 )
      {
        *(_DWORD *)(v11 + 48) = *v16;
        *(_DWORD *)(v11 + 52) = *(_DWORD *)(*(_QWORD *)a3 + 4LL);
        LOWORD(v16) = *(_WORD *)(*(_QWORD *)a3 + 8LL);
      }
      else
      {
        *(_QWORD *)(v11 + 48) = 0;
      ...
      v17 = v21;
      v18 = v22[0];
      *(_WORD *)(v11 + 56) = (_WORD)v16;
      result = perf_trace_run_bpf_submit(v11, 60, v17, v6, 1, v18, StatusReg + v8, 0);
LABEL_15:
  ...
  return trace_event_raw_event_rdev_set_txq_params(v19 - 64);
}
