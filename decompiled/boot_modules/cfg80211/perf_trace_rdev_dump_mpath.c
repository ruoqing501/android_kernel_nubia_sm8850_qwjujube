__int64 __fastcall perf_trace_rdev_dump_mpath(__int64 result, __int64 a2, __int64 a3, int a4, int *a5, int *a6)
{
  __int64 v6; // x30
  __int64 v7; // x26
  __int64 v10; // x19
  ...
  if ( !*(_QWORD *)(result + 112) && !*(_QWORD *)(StatusReg + v14) )
    goto LABEL_17;
  result = perf_trace_buf_alloc(76, v30, &v29);
  if ( !result )
    goto LABEL_17;
  v16 = (_QWORD *)v30[0];
  v17 = result;
...
LABEL_17:
  ...
  return trace_event_raw_event_rdev_get_mpp(v26, v27 - 1024, *(_QWORD *)(v27 - 1024));
}
