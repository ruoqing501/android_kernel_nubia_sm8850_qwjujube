__int64 __fastcall perf_trace_cfg80211_probe_status(__int64 result, __int64 a2, int *a3, __int64 a4, char a5)
{
  __int64 v5; // x30
  __int64 v6; // x24
  __int64 v9; // x19
  ...
  {
    result = perf_trace_buf_alloc(60, v21, &v20);
    if ( result )
    {
      v14 = (_QWORD *)v21[0];
      ...
      *(_BYTE *)(result + 48) = a5 & 1;
      result = perf_trace_run_bpf_submit(result, 60, v17, v9, 1, v18, StatusReg + v12, 0);
    }
  }
