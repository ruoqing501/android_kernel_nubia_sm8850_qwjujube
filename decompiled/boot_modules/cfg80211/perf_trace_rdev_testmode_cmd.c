__int64 __fastcall perf_trace_rdev_testmode_cmd(__int64 result, __int64 a2, unsigned __int64 a3)
{
  __int64 v3; // x30
  __int64 v4; // x23
  __int64 v6; // x19
  ...
  if ( !*(_QWORD *)(result + 112) && !*(_QWORD *)(StatusReg + v8) || (result = perf_trace_buf_alloc(44, v21, &v20)) == 0 )
  {
LABEL_15:
  ...
  *(_QWORD *)(v21[0] + 232LL) = &v22;
  ...
  return trace_event_raw_event_rdev_testmode_dump(v18, loc_3F728);
}
