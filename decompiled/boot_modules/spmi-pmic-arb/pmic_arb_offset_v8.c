__int64 __fastcall pmic_arb_offset_v8(_QWORD *a1, unsigned __int8 a2, unsigned __int16 a3, int a4)
{
  __int64 v4; // x23
  int v5; // w20
  __int64 (*v9)(void); // x8
  ...
  if ( (result & 0x80000000) == 0 )
  {
    ...
    {
      if ( a4 == 1 )
        return 32 * (unsigned __int16)result + (*(unsigned __int8 *)(v4 + 49) << 18);
      else
        return 0;
    }
    else if ( *(unsigned __int8 *)(a1[19] + 4LL * (unsigned __int16)result + 2) == *(unsigned __int8 *)(v4 + 49) )
    {
      return (unsigned __int16)result << 9;
    }
    else
    {
