__int64 __fastcall perf_trace_qseecom_process_listener_from_smcinvoke_ret(__int64 result, __int64 a2, int a3, int a4)
{
  __int64 v4; // x30
  __int64 v5; // x23
  __int64 v8; // x19
  ...
  if ( *(_QWORD *)(result + 112) || *(_QWORD *)(StatusReg + v10) )
  {
    ...
    if ( result )
    {
      ...
      *(_DWORD *)(result + 16) = a3;
      *(_DWORD *)(result + 20) = a4;
      result = perf_trace_run_bpf_submit(result, 28, v13, v8, 1, v14, StatusReg + v10, 0);
    }
  }
