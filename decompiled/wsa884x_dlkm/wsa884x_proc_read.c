__int64 __fastcall wsa884x_proc_read(__int64 a1, unsigned __int64 a2, unsigned __int64 a3, __int64 *a4)
{
  __int64 result; // x0
  __int64 v8; // x28
  __int64 *v9; // x8
  ...
  if ( !v11 )
    goto LABEL_39;
LABEL_8:
  v12 = scnprintf(v11, a3, "%x", 14591);
  regcache_cache_bypass(v42, 1);
  v41 = v11;
  if ( (unsigned int)(v8 + 12288) >> 8 <= 0x38 )
  {
