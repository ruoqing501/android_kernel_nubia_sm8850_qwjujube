__int64 __fastcall sde_setup_dspp_memcol_sky_v17(_QWORD *a1, _DWORD *a2)
{
  int v4; // w20
  int v5; // w1
  unsigned int v6; // w1
  ...
  if ( !*(_QWORD *)a2 )
  {
    _drm_dev_dbg(0, 0, 1, "disable memcolor sky feature\n");
  ...
  if ( v5 == 48 )
  {
    _setup_dspp_memcol_0((__int64)a1, 1, *(unsigned int **)a2);
    v6 = *(_DWORD *)(*(_QWORD *)(a1[9] + 48LL) + 128LL);
    v7 = v4 | 0x100080;
    return sde_reg_write((__int64)a1, v6, v7, "ctx->cap->sblk->hsic.base");
  }
