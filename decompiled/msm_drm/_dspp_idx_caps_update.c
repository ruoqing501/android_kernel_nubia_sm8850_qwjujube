unsigned int *__fastcall dspp_idx_caps_update(unsigned int *result, __int64 a2)
{
  __int64 v2; // x8
  unsigned int v3; // w9
  bool v4; // cf
  ...
  v2 = result[548];
  v3 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)result + 56LL) + 8LL) + 152LL) + 8160LL);
  if ( v3 )
    v4 = (int)v2 - 1 >= v3;
  else
    v4 = 1;
  if ( !v4 )
  {
    ...
    *(_QWORD *)s = 0;
    ...
    do
    {
      ...
      if ( v9 )
      {
        snprintf(s, 0x100u, "dspp%u", *(_DWORD *)(v9 + 64) - 1);
