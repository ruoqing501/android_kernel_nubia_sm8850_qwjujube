unsigned __int64 __fastcall reg_dmav1_setup_demurav4(int *a1, __int64 *a2)
{
  __int64 v3; // x4
  unsigned int v4; // w5
  __int64 v5; // x22
  ...
  if ( !*a2 )
  {
    sde_evtlog_log(sde_dbg_base_evtlog, "reg_dmav1_setup_demurav4", 8714, -1, v3, v4, a1[7], 0, 239);
...
LABEL_34:
      ...
      v24 = _reg_dmav1_setup_demura_cfg_common(
              (__int64)a1,
              (__int64 *)v5,
              (__int64)&v51,
              v13,
      ...
      if ( v24 )
      {
        result = _drm_err("failed to setup_demura_cfg_common rc %d", v24);
        goto LABEL_34;
      }
      v25 = _reg_dmav1_setup_demura_cfg0_param4_5_6_v3((__int64)a1, v5, (__int64)&v51, v13);
      if ( v25 )
      {
        result = _drm_err("failed setup_demura_cfg0_param4_5_6_v3 rc %d", v25);
        goto LABEL_34;
      }
      result = _reg_dmav1_setup_demura_en_v3_common(
                 (__int64)a1,
                 (__int64 *)v5,
                 (__int64)&v51,
                 v13,
...
LABEL_45:
  __break(1u);
  return _reg_dmav1_setup_demurav1_dual_pipe(result, v9, v10, v11, v12);
}
