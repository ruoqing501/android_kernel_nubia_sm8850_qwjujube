__int64 __fastcall dp_config_vco_rate_5nm(__int64 a1, __int64 a2)
{
  int v4; // w21
  ...
  v4 = readl_relaxed_1((unsigned int *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 48) + 344LL) + 24LL) + 200LL));
  *(_BYTE *)(a1 + 56) = v4 & 0xF;
...
LABEL_177:
      ...
      printk(&unk_2618EB, "dp_vco_pll_init_db_5nm");
      v173 = get_ipc_log_context();
      ipc_log_string(v173, "[e][%-4d]VCO Init DB failed\n", *v6);
      v172 = &unk_22D9D2;
      goto LABEL_178;
    }
    v9 = 9720000;
  ...
  *(_DWORD *)(a1 + 60) = v10;
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 20,
    ...
    v12,
    v174);
  writel_relaxed_1(15, *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 20LL);
  if ( *(_BYTE *)(a1 + 56) == 4 )
  {
  ...
  sde_evtlog_log(v15, "dp_config_vco_rate_5nm", v16, 4, v17 + 24, v18, -1059143953, v14, v175);
  writel_relaxed_1(v19, *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 24LL);
  __dsb(0xEu);
  v24 = *(_DWORD *)(a1 + 60);
  if ( v24 > 3 )
  {
    v171 = get_ipc_log_context();
    ipc_log_string(v171, "[e][%-4d]link rate not set\n", *v6);
    v172 = &unk_22A22C;
LABEL_178:
    printk(v172, "dp_config_vco_rate_5nm");
    return 4294967274LL;
  }
  v25 = *(_QWORD *)(a1 + 64);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 388,
    ...
    v27,
    v176);
  writel_relaxed_1(5, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 388LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 148,
    ...
    v29,
    v177);
  writel_relaxed_1(59, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 148LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 76,
    ...
    v31,
    v178);
  writel_relaxed_1(2, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 76LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 72,
    ...
    v33,
    v179);
  writel_relaxed_1(12, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 72LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 80,
    ...
    v36,
    v180);
  writel_relaxed_1(6, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 80LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 340,
    ...
    v38,
    v181);
  writel_relaxed_1(48, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 340LL);
  __dsb(0xEu);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 88,
    ...
    v40,
    v182);
  writel_relaxed_1((unsigned int)v34[17], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 88LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 132,
    ...
    v42,
    v183);
  writel_relaxed_1(54, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 132LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 124,
    ...
    v44,
    v184);
  writel_relaxed_1(22, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 124LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 116,
    ...
    v46,
    v185);
  writel_relaxed_1(6, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 116LL);
  __dsb(0xEu);
  ...
  sde_evtlog_log(
    ...
    *v34,
    ...
    v48,
    v186);
  writel_relaxed_1((unsigned int)*v34, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 344LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 188,
    ...
    v50,
    v187);
  writel_relaxed_1((unsigned int)v34[5], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 188LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 204,
    ...
    v52,
    v188);
  writel_relaxed_1((unsigned int)v34[6], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 204LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 208,
    ...
    v54,
    v189);
  writel_relaxed_1((unsigned int)v34[7], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 208LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 212,
    ...
    v56,
    v190);
  writel_relaxed_1((unsigned int)v34[8], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 212LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 172,
    ...
    v58,
    v191);
  writel_relaxed_1((unsigned int)v34[9], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 172LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 176,
    ...
    v60,
    v192);
  writel_relaxed_1((unsigned int)v34[10], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 176LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 164,
    ...
    v62,
    v193);
  writel_relaxed_1((unsigned int)v34[3], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 164LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 112,
    ...
    v64,
    v194);
  writel_relaxed_1((unsigned int)v34[4], *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 112LL);
  __dsb(0xEu);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 380,
    ...
    v66,
    v195);
  writel_relaxed_1(2, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 380LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 236,
    ...
    v68,
    v196);
  writel_relaxed_1((unsigned int)v34[1], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 236LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 240,
    ...
    v70,
    v197);
  writel_relaxed_1((unsigned int)v34[2], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 240LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 268,
    ...
    v72,
    v198);
  writel_relaxed_1(0, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 268LL);
  __dsb(0xEu);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 12,
    ...
    v74,
    v199);
  writel_relaxed_1((unsigned int)v34[18], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 12LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 360,
    ...
    v76,
    v200);
  writel_relaxed_1(10, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 360LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 264,
    ...
    v78,
    v201);
  writel_relaxed_1(0, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 264LL);
  v79 = *(unsigned __int8 *)(a1 + 33);
  v80 = get_ipc_log_context();
  v81 = *v6;
  v82 = *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 68LL;
  if ( v79 == 1 )
  {
  ...
  sde_evtlog_log(v84, "dp_config_vco_rate_5nm", v85, 4, v86 + 68, v87, -1059143953, v83, v202);
  writel_relaxed_1(v88, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 68LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 372,
    ...
    v90,
    v203);
  writel_relaxed_1((unsigned int)v34[19], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 372LL);
  __dsb(0xEu);
  if ( *(_BYTE *)(a1 + 32) == 1 )
  {
    ...
    sde_evtlog_log(
      ...
      *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 16,
      ...
      v92,
      v204);
    writel_relaxed_1(1, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 16LL);
    ...
    sde_evtlog_log(
      ...
      *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 20,
      ...
      v94,
      v205);
    writel_relaxed_1(0, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 20LL);
    ...
    sde_evtlog_log(
      ...
      *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 28,
      ...
      v96,
      v206);
    writel_relaxed_1((unsigned int)v34[13], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 28LL);
    ...
    sde_evtlog_log(
      ...
      *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 32,
      ...
      v98,
      v207);
    writel_relaxed_1((unsigned int)v34[13], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 32LL);
    ...
    sde_evtlog_log(
      ...
      *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 36,
      ...
      v100,
      v208);
    writel_relaxed_1((unsigned int)v34[11], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 36LL);
    ...
    sde_evtlog_log(
      ...
      *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 40,
      ...
      v102,
      v209);
    writel_relaxed_1((unsigned int)v34[12], *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 40LL);
  }
  v103 = *(unsigned __int8 *)(a1 + 57);
  v104 = get_ipc_log_context();
  v105 = *v6;
  v106 = *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 28LL;
  if ( v103 == 2 )
  {
    ipc_log_string(v104, "[d][%-4d]DP_PHY_MODE, addr=0x%llx, val=0x%x\n", v105, v106, 76);
    if ( (_drm_debug & 4) != 0 )
      _drm_dev_dbg(
        0,
        0,
        ...
        *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 28LL,
        76);
    v108 = sde_dbg_base_evtlog;
    v109 = 325;
    v110 = *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL);
    v111 = 76;
    v112 = 76;
  }
  else
  ...
  sde_evtlog_log(v108, "dp_config_vco_rate_5nm", v109, 4, v110 + 28, v111, -1059143953, v107, v204);
  writel_relaxed_1(v112, *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 28LL);
  v113 = get_ipc_log_context();
  ipc_log_string(
    v113,
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 36,
    ...
    v114,
    v210);
  writel_relaxed_1(19, *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 36LL);
  v115 = get_ipc_log_context();
  ipc_log_string(
    v115,
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 40,
    ...
    v116,
    v211);
  writel_relaxed_1(164, *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 40LL);
  __dsb(0xEu);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 120,
    ...
    v118,
    v212);
  writel_relaxed_1(5, *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 120LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 200,
    ...
    v120,
    v213);
  writel_relaxed_1(64, *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 200LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 32,
    ...
    v122,
    v214);
  writel_relaxed_1(48, *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 32LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 44,
    ...
    v124,
    v215);
  writel_relaxed_1(59, *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 44LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 8,
    ...
    v126,
    v216);
  writel_relaxed_1(15, *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 8LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 28,
    ...
    v128,
    v217);
  writel_relaxed_1(3, *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 28LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 192,
    ...
    v130,
    v218);
  writel_relaxed_1(15, *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 192LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 96,
    ...
    v132,
    v219);
  writel_relaxed_1(0, *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 96LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 196,
    ...
    v134,
    v220);
  writel_relaxed_1(0, *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 196LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 60,
    ...
    v136,
    v221);
  writel_relaxed_1((unsigned int)v34[20], *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 60LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 64,
    ...
    v138,
    v222);
  writel_relaxed_1((unsigned int)v34[21], *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 64LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 36,
    ...
    v140,
    v223);
  writel_relaxed_1(4, *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 36LL);
  __dsb(0xEu);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 156,
    ...
    v142,
    v224);
  writel_relaxed_1(5, *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 156LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 200,
    ...
    v144,
    v225);
  writel_relaxed_1(64, *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 200LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 32,
    ...
    v146,
    v226);
  writel_relaxed_1(48, *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 32LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 44,
    ...
    v148,
    v227);
  writel_relaxed_1(59, *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 44LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 8,
    ...
    v150,
    v228);
  writel_relaxed_1(15, *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 8LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 28,
    ...
    v152,
    v229);
  writel_relaxed_1(3, *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 28LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 192,
    ...
    v154,
    v230);
  writel_relaxed_1(15, *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 192LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 96,
    ...
    v156,
    v231);
  writel_relaxed_1(0, *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 96LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 196,
    ...
    v158,
    v232);
  writel_relaxed_1(0, *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 196LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 60,
    ...
    v160,
    v233);
  writel_relaxed_1((unsigned int)v34[20], *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 60LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 64,
    ...
    v162,
    v234);
  writel_relaxed_1((unsigned int)v34[21], *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 64LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 36,
    ...
    v164,
    v235);
  writel_relaxed_1(4, *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 36LL);
  __dsb(0xEu);
  if ( (readl_relaxed_1(*(unsigned int **)(*(_QWORD *)(a1 + 376) + 24LL)) & 0x80000000) == 0 )
    return 4294967274LL;
  v166 = readl_relaxed_1((unsigned int *)(*(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 112LL)) & 0xFFFFFFFC;
  if ( a2 > 5399999 )
  {
    if ( a2 == 5400000 )
    {
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 112,
    ...
    v169,
    v236);
  writel_relaxed_1(v166, *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 112LL);
  __dsb(0xEu);
  clk_set_rate(***(_QWORD ***)(a1 + 384), *(_QWORD *)(a1 + 8) / 0xAuLL);
  clk_set_rate(*(_QWORD *)(**(_QWORD **)(a1 + 384) + 8LL), *(_QWORD *)(a1 + 8) / (unsigned __int64)v167);
  v170 = get_ipc_log_context();
  ipc_log_string(
    v170,
    ...
    *v6,
    ...
    v167,
    *(_QWORD *)(a1 + 8) / 0xAuLL,
    *(_QWORD *)(a1 + 8) / (unsigned __int64)v167);
  if ( (_drm_debug & 4) != 0 )
    _drm_dev_dbg(
      0,
      0,
