__int64 __fastcall edp_pll_prepare_0(__int64 a1)
{
  __int64 v2; // x0
  __int64 v3; // x8
  ...
  **(_DWORD **)(a1 + 336) &= ~0x2000u;
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 16,
    ...
    v5,
    v63);
  writel_relaxed_5(1, *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 16LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 16,
    ...
    v7,
    v64);
  writel_relaxed_5(5, *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 16LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 16,
    ...
    v11,
    v66);
  writel_relaxed_5(9, *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 16LL);
  v12 = get_ipc_log_context();
  ipc_log_string(
    v12,
    "[d][%-4d]QSERDES_COM_RESETSM_CNTRL, addr=0x%llx, val=0x%x\n",
    *(_DWORD *)(StatusReg + 1800),
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 280LL,
    32);
  if ( (_drm_debug & 4) != 0 )
    _drm_dev_dbg(
      0,
  ...
  sde_evtlog_log(
    ...
    435,
    4,
    *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 280,
    32,
    -1059143953,
    v13,
    v67);
  writel_relaxed_5(32, *(_QWORD *)(*(_QWORD *)(a1 + 352) + 24LL) + 280LL);
  __dsb(0xEu);
  if ( (edp_4nm_pll_get_status(a1, 0) & 1) == 0 )
    goto LABEL_65;
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 16,
    ...
    v15,
    v68);
  writel_relaxed_5(25, *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 16LL);
  __dsb(0xEu);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 88,
    ...
    v22,
    v69);
  writel_relaxed_5(v18, *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 88LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 92,
    ...
    v24,
    v70);
  writel_relaxed_5(0, *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 92LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 88,
    ...
    v26,
    v71);
  writel_relaxed_5(v19, *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 88LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 92,
    ...
    v28,
    v72);
  writel_relaxed_5(0, *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 92LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 24,
    ...
    v30,
    v73);
  writel_relaxed_5(16, *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 24LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 24,
    ...
    v32,
    v74);
  writel_relaxed_5(16, *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 24LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 68,
    ...
    v34,
    v75);
  writel_relaxed_5(17, *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 68LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 72,
    ...
    v36,
    v76);
  writel_relaxed_5(17, *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 72LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 68,
    ...
    v38,
    v77);
  writel_relaxed_5(17, *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 68LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 72,
    ...
    v40,
    v78);
  writel_relaxed_5(17, *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 72LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 4,
    ...
    v42,
    v79);
  writel_relaxed_5(16, *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 4LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 4,
    ...
    v44,
    v80);
  writel_relaxed_5(16, *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 4LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 20,
    ...
    v46,
    v81);
  writel_relaxed_5(31, *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 20LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 20,
    ...
    v48,
    v82);
  writel_relaxed_5(31, *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 20LL);
  __dsb(0xEu);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 84,
    ...
    v50,
    v83);
  writel_relaxed_5(v20, *(_QWORD *)(*(_QWORD *)(a1 + 360) + 24LL) + 84LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 84,
    ...
    v52,
    v84);
  writel_relaxed_5(v17, *(_QWORD *)(*(_QWORD *)(a1 + 368) + 24LL) + 84LL);
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 20,
    ...
    v54,
    v85);
  writel_relaxed_5(v16, *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 20LL);
  if ( (edp_4nm_pll_get_status(a1, 3) & 1) == 0 )
    goto LABEL_65;
  ...
  sde_evtlog_log(
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 16,
    ...
    v56,
    v86);
  writel_relaxed_5(24, *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 16LL);
  ...
  writel_relaxed_5(25, *(_QWORD *)(*(_QWORD *)(a1 + 344) + 24LL) + 16LL);
  __dsb(0xEu);
  if ( (edp_4nm_pll_get_status(a1, 4) & 1) == 0 || (edp_4nm_pll_get_status(a1, 3) & 1) == 0 )
  {
LABEL_65:
