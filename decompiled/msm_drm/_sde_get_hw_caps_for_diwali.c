__int64 __fastcall sde_get_hw_caps_for_diwali(__int64 result)
{
  ...
  *(_DWORD *)(result + 640) = 344;
  ...
  do
    v55 = __ldxr(_X9);
  while ( __stxr(v55 | 0x1000000, _X9) );
  _X9 = (unsigned __int64 *)(result + 22008);
  __asm { PRFM            #0x11, [X9] }
  do
    v58 = __ldxr(_X9);
  while ( __stxr(v58 | 0x400000, _X9) );
  _X9 = (unsigned __int64 *)(result + 22008);
  __asm { PRFM            #0x11, [X9] }
  do
    v61 = __ldxr(_X9);
  while ( __stxr(v61 | 0x800000000LL, _X9) );
  _X9 = (unsigned __int64 *)(result + 22008);
  __asm { PRFM            #0x11, [X9] }
  do
    v64 = __ldxr(_X9);
  while ( __stxr(v64 | 0x4000000000LL, _X9) );
  _X9 = (unsigned __int64 *)(result + 22008);
  __asm { PRFM            #0x11, [X9] }
  do
    v67 = __ldxr(_X9);
  while ( __stxr(v67 | 0x800000, _X9) );
