__int64 __fastcall dsi_phy_hw_v7_2_wait_for_lane_idle(__int64 a1, char a2)
{
  char v4; // w0
  int v5; // w20
  int v6; // w4
  ...
  v8 = ktime_get(v7);
  v9 = readl_9((unsigned int *)(*(_QWORD *)a1 + 332LL));
  v10 = v9 & v5;
  if ( ((unsigned int)v9 & v5) != v5 )
  {
    ...
    v12 = readl_9((unsigned int *)(*(_QWORD *)a1 + 332LL));
    if ( (v12 & v5) != v5 )
      goto LABEL_12;
    return 0;
  }
