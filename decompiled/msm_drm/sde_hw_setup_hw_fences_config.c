__int64 __fastcall sde_hw_setup_hw_fences_config(__int64 *a1, unsigned int a2, __int64 a3)
{
  __int64 v3; // x8
  int v4; // w19
  __int64 v5; // x9
  ...
  if ( a1 )
  {
    ...
    sde_reg_write((__int64)&v11, v8 + 180, 0x402u, "offset");
    result = sde_reg_write((__int64)&v11, (int)v8 + 200, 0xFu, "offset");
  }
  else
  {
    result = printk(&unk_269D2C, "sde_hw_setup_hw_fences_config");
  }
