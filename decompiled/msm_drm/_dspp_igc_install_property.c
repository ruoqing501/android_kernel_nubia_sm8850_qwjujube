__int64 __fastcall dspp_igc_install_property(__int64 *a1)
{
  __int64 v2; // x8
  __int64 v3; // x8
  int v4; // w20
  ...
  *(_QWORD *)s = 0;
  v7 = 0;
  v4 = HIWORD(*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v3 + 8) + 152LL) + 8216LL) + 32LL));
  snprintf(s, 0x100u, "%s%d", "SDE_DSPP_IGC_V", v4);
  if ( (unsigned int)(v4 - 3) > 2 )
    result = _drm_err("version %d not supported\n", v4);
  else
    result = sde_cp_crtc_install_blob_property(a1, s, 0, 4632);
