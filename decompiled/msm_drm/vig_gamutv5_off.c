unsigned __int64 __fastcall vig_gamutv5_off(__int64 a1, __int64 a2)
{
  __int64 v4; // x8
  __int64 v5; // x0
  __int64 v6; // x8
  ...
  if ( (unsigned int)v11 > 1 )
    goto LABEL_29;
  if ( (unsigned __int64)(16 * v10 + 8 * v11 + 6240) > 0x4650 )
    goto LABEL_30;
  ...
  if ( (unsigned int)v16 > 1 )
    goto LABEL_29;
  if ( (unsigned __int64)(16 * v15 + 8 * v16 + 6240) > 0x4650 )
    goto LABEL_30;
  HIDWORD(v44) = 0;
  DWORD1(v44) = 0;
  v47 = 0;
  v45 = sspp_buf[2 * v15 + 780 + v16];
  v46 = nullptr;
