__int64 __fastcall dp_catalog_ctrl_phy_lane_cfg_v500(__int64 a1, char a2, char a3)
{
  _QWORD *v3; // x21
  unsigned int v4; // w19
  __int64 v5; // x20
  ...
  if ( a1 )
  {
    ...
    if ( *(v8 - 1) != 621108289 )
      __break(0x8228u);
    return ((__int64 (__fastcall *)(__int64, __int64, __int64, _QWORD))v8)(v9, v5, 204, v4);
  }
  else
  {
    v11 = get_ipc_log_context(0);
    ipc_log_string(v11, "[e][%-4d]invalid input\n", *(_DWORD *)(_ReadStatusReg(SP_EL0) + 1800));
    return printk(&unk_279170, "dp_catalog_ctrl_phy_lane_cfg_v500");
  }
}
