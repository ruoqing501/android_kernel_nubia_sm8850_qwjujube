double __fastcall dsi_phy_hw_v7_2_disable(unsigned int *a1, __int64 a2)
{
  char v4; // w0
  int v5; // w0
  int v6; // w0
  ...
  if ( (a1[8] & 1) == 0 )
  {
    ...
    __dsb(0xEu);
    _const_udelay(8590);
    v6 = readl_relaxed_15(*(_QWORD *)a1 + 36LL);
    writel_relaxed_12(v6 & 0xFFFFFF60, (unsigned int *)(*(_QWORD *)a1 + 36LL));
    writel_relaxed_12(0, (unsigned int *)(*(_QWORD *)a1 + 160LL));
    writel_relaxed_12(0, (unsigned int *)(*(_QWORD *)a1 + 36LL));
    __dsb(0xEu);
    if ( a1 )
      v7 = a1[7];
    else
