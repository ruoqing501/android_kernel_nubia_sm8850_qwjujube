__int64 __fastcall lm_gc_install_property(__int64 *a1)
{
  __int64 v2; // x8
  __int64 v3; // x8
  int v4; // w20
  ...
  *(_QWORD *)s = 0;
  v7 = 0;
  v4 = HIWORD(*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v3 + 8) + 152LL) + 7008LL) + 88LL));
  snprintf(s, 0x100u, "%s%d", "SDE_LM_GC_V", v4);
  if ( v4 == 1 )
    result = sde_cp_crtc_install_blob_property(a1, s, 51, 7688);
  else
