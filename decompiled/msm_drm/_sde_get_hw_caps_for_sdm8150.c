_DWORD *__fastcall sde_get_hw_caps_for_sdm8150(_DWORD *result)
{
  ...
  do
    v19 = __ldxr(_X8);
  while ( __stxr(v19 | 0x100, _X8) );
  _X9 = (unsigned __int64 *)(result + 5502);
  __asm { PRFM            #0x11, [X9] }
  do
    v22 = __ldxr(_X9);
  while ( __stxr(v22 | 0x10000, _X9) );
  result[5448] = 24;
  result[10] = 2;
  result[7] = 256;
  result[5398] = 8;
