__int64 __fastcall dp_catalog_aux_clear_hw_int_v200(__int64 a1)
{
  __int64 v1; // x20
  __int64 v2; // x0
  __int64 v3; // x19
  ...
  if ( a1 )
  {
    ...
    if ( *(v9 - 1) != 621108289 )
      __break(0x8228u);
    result = ((__int64 (__fastcall *)(__int64, __int64, __int64, _QWORD))v9)(v10, v3, 76, 0);
    __dsb(0xEu);
  }
  else
  {
    ...
    return printk(&unk_275B6D, "dp_catalog_aux_clear_hw_int_v200");
  }
  return result;
}
