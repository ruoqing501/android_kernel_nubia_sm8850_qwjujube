__int64 __fastcall hfi_dbg_ctrl_read(__int64 a1, unsigned __int64 a2, unsigned __int64 a3, _QWORD *a4)
{
  __int64 result; // x0
  signed int v8; // w0
  __int64 v9; // x19
  ...
  if ( a2 && a4 )
  {
    if ( *a4 || (v8 = scnprintf(v23, 24, "0x%x\n", *(_DWORD *)(hfi_dbg + 328)), (unsigned int)v8 > 0x17) )
    {
      result = 0;
    }
    else
    {
      ...
      {
LABEL_16:
        printk(&unk_25E252, "hfi_dbg_ctrl_read");
        result = -14;
      }
      else
      {
