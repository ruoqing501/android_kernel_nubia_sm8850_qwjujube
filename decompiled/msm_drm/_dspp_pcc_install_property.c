__int64 __fastcall dspp_pcc_install_property(__int64 *a1)
{
  __int64 v2; // x8
  __int64 v3; // x8
  unsigned int v4; // w20
  ...
  *(_QWORD *)s = 0;
  v7 = 0;
  v4 = HIWORD(*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v3 + 8) + 152LL) + 8216LL) + 68LL));
  snprintf(s, 0x100u, "%s%d", "SDE_DSPP_PCC_V", v4);
  if ( v4 <= 6 && ((1 << v4) & 0x72) != 0 )
    result = sde_cp_crtc_install_blob_property(a1, s, 1, 144);
  else
