__int64 __fastcall hfi_dbg_bus_read(__int64 a1, unsigned __int64 a2, unsigned __int64 a3, _QWORD *a4)
{
  __int64 result; // x0
  __int64 v5; // x23
  ...
  if ( a2 && a4 )
  {
    v5 = *(_QWORD *)(hfi_dbg + 160);
    if ( v5 && (v6 = *(unsigned int *)(hfi_dbg + 168) - *a4) != 0 )
    {
      if ( v6 >= a3 )
        v9 = a3;
      else
        v9 = *(unsigned int *)(hfi_dbg + 168) - *a4;
