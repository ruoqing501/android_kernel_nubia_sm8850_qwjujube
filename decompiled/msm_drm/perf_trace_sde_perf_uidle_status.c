__int64 __fastcall perf_trace_sde_perf_uidle_status(
        __int64 result,
        int a2,
        int a3,
        int a4,
        ...
        int a12)
{
  ...
  {
    result = perf_trace_buf_alloc(52, v30, &v29);
    if ( result )
    {
      v23 = (_QWORD *)v30[0];
      ...
      *(_DWORD *)(result + 48) = a12;
      result = perf_trace_run_bpf_submit(result, 52, v25, v15, 1, v24, StatusReg + v21, 0);
    }
  }
