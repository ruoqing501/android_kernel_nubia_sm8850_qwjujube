unsigned __int64 __fastcall codec_debug_dump(__int64 a1, __int64 a2, __int64 a3, __int64 *a4)
{
  ...
  *(_QWORD *)s = 0;
  ...
  while ( 1 )
  {
    if ( (unsigned int)(v12 - 1030) >> 1 < 0xDFD
...
LABEL_40:
  if ( (unsigned int)__ratelimit(&wcd938x_swrslave_reg_show__rs, "wcd938x_swrslave_reg_show") )
    printk(&unk_6D5C, "wcd938x_swrslave_reg_show");
  v4 = -14;
LABEL_43:
  *a4 = 98412;
LABEL_44:
