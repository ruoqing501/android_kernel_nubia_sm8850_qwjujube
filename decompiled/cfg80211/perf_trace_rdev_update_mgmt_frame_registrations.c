__int64 __fastcall perf_trace_rdev_update_mgmt_frame_registrations(
        __int64 result,
        __int64 a2,
        unsigned __int64 a3,
        _DWORD *a4)
{
  ...
  if ( !*(_QWORD *)(result + 112) && !*(_QWORD *)(StatusReg + v10)
    || (result = perf_trace_buf_alloc(52, v23, &v22)) == 0 )
  {
LABEL_15:
  ...
  *(_QWORD *)(v23[0] + 232LL) = &vars0;
  ...
  else
  {
    ...
    if ( v16 < 0x21 )
    {
      ...
      *(_WORD *)(v13 + 44) = *a4;
      *(_WORD *)(v13 + 46) = a4[1];
      result = perf_trace_run_bpf_submit(v13, 52, v18, v8, 1, v19, StatusReg + v10, 0);
      goto LABEL_15;
    }
  }
  _fortify_panic(7, 32);
  return trace_event_raw_event_rdev_return_int_tx_rx((unsigned int)(v20 - 10035200));
}
