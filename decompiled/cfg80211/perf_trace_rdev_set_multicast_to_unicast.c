__int64 __fastcall perf_trace_rdev_set_multicast_to_unicast(__int64 result, __int64 a2, __int64 a3, char a4)
{
  __int64 v4; // x30
  __int64 v5; // x24
  __int64 v8; // x19
...
LABEL_12:
  ...
  return trace_event_raw_event_rdev_get_ftm_responder_stats(v20);
}
