__int64 __fastcall perf_trace_cfg80211_tdls_oper_request(
        __int64 result,
        __int64 a2,
        __int64 a3,
        int *a4,
  ...
  *(_QWORD *)(v34[0] + 232LL) = &vars0;
  ...
  else
  {
    ...
    if ( v20 < 0x21 )
    {
      ...
      *(_DWORD *)(v17 + 68) = a5;
      *(_WORD *)(v17 + 72) = a6;
      result = perf_trace_run_bpf_submit(v17, 76, v23, v10, 1, v24, StatusReg + v14, 0);
LABEL_15:
  ...
  __asm { STGP            X26, X25, [X4] }
  return trace_event_raw_event_cfg80211_scan_done(v25);
}
