__int64 __fastcall msm_pcie_config_l1(__int64 a1, __int64 a2, char a3)
{
  int v6; // w24
  __int64 v7; // x0
  const char *v8; // x22
  ...
  if ( !v10
    || (v11 = *(unsigned __int8 *)(v10 + 108),
        ...
        v15 = (v15 >> 11) & ((unsigned __int8)(v14 & 2) >> 1),
        (v15 & 1) != 0) )
  {
    ...
    if ( (v15 & 0x800) == 0 )
    {
      if ( a1 )
      {
        ipc_log_string(
          *(_QWORD *)(a1 + 1704),
          "DBG1:%s: PCIe: RC%d: PCI device %02x:%02x.%01x does not support L1\n",
          "msm_pcie_check_l1_support",
          *(_DWORD *)(a1 + 1348),
          *(unsigned __int8 *)(*(_QWORD *)(a2 + 16) + 248LL),
          (unsigned __int8)*(_DWORD *)(a2 + 56) >> 3,
          *(_DWORD *)(a2 + 56) & 7);
        result = ipc_log_string(
                   *(_QWORD *)(a1 + 1696),
                   "%s: PCIe: RC%d: PCI device %02x:%02x.%01x does not support L1\n",
                   "msm_pcie_check_l1_support",
                   *(_DWORD *)(a1 + 1348),
                   *(unsigned __int8 *)(*(_QWORD *)(a2 + 16) + 248LL),
                   (unsigned __int8)*(_DWORD *)(a2 + 56) >> 3,
...
LABEL_14:
  ...
  if ( a1 )
  {
    ipc_log_string(
      *(_QWORD *)(a1 + 1704),
      "DBG1:%s: PCIe: RC%d: Parent PCI device %02x:%02x.%01x does not support L1\n",
      "msm_pcie_check_l1_support",
      *(_DWORD *)(a1 + 1348),
    ...
    result = ipc_log_string(
               *(_QWORD *)(a1 + 1696),
               "%s: PCIe: RC%d: Parent PCI device %02x:%02x.%01x does not support L1\n",
               "msm_pcie_check_l1_support",
               *(_DWORD *)(a1 + 1348),
               *(unsigned __int8 *)(*(_QWORD *)(v10 + 16) + 248LL),
               (unsigned __int8)*(_DWORD *)(v10 + 56) >> 3,
