__int64 __fastcall wcd9378_populate_dt_data(__int64 a1)
{
  __int64 v2; // x19
  __int64 v3; // x0
  int v4; // w0
  ...
  if ( v2 )
  {
    ...
    *(_QWORD *)v2 = v5;
    if ( v5 )
    {
      msm_cdc_get_power_supplies(a1, v2 + 64, v2 + 72);
      if ( *(_QWORD *)(v2 + 64) && *(int *)(v2 + 72) > 0 )
      {
        v6 = *(_QWORD *)(a1 + 744);
        v23 = 0;
        v24 = 0;
        ...
        *(_QWORD *)(v2 + 16) = v12;
        ...
        {
          if ( (of_property_read_variable_u32_array(*(_QWORD *)(a1 + 744), "qcom,cdc-micbias1-mv", &v15, 1, 0)
              & 0x80000000) != 0 )
            dev_err(
              a1,
              "%s: Looking up %s property in node %s failed\n",
              "wcd9378_read_of_property_u32",
        ...
        {
          dev_info(a1, "%s: Micbias1 DT property not found\n", "wcd9378_dt_parse_micbias_info");
        }
        if ( of_find_property(*(_QWORD *)(a1 + 744), "qcom,cdc-micbias2-mv", 0) )
        {
          if ( (of_property_read_variable_u32_array(*(_QWORD *)(a1 + 744), "qcom,cdc-micbias2-mv", &v15, 1, 0)
              & 0x80000000) != 0 )
            dev_err(
              a1,
              "%s: Looking up %s property in node %s failed\n",
        ...
        {
          if ( (of_property_read_variable_u32_array(*(_QWORD *)(a1 + 744), "qcom,cdc-micbias3-mv", &v15, 1, 0)
              & 0x80000000) != 0 )
            dev_err(
              a1,
              "%s: Looking up %s property in node %s failed\n",
