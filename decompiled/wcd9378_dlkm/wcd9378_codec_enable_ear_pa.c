__int64 __fastcall wcd9378_codec_enable_ear_pa(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v3; // x21
  ...
  if ( (_DWORD)a3 == 8 )
  {
    ...
    if ( (v9 & 0x800) != 0 )
    {
      ...
      do
        v34 = __ldxr(_X8);
      while ( __stxr(v34 & 0xFFFFFFFFFFFFF7FFLL, _X8) );
      mutex_unlock(v4 + 29);
      if ( (v4[2] & 0x1000) != 0 )
        return 0;
    ...
    else
    {
      ...
      do
        v28 = __ldxr(_X8);
      while ( __stxr(v28 & 0xFFFFFFFFFFFFFEFFLL, _X8) );
      mutex_unlock(v4 + 29);
  ...
  if ( (v4[2] & 0x800) != 0 )
  {
    if ( v5 )
    {
      ...
      if ( *(v5 - 1) != -17866579 )
        __break(0x8228u);
      ((void (__fastcall *)(unsigned __int64, __int64, _QWORD))v5)(v14, 1, 0);
    }
    virq = regmap_irq_get_virq(v4[54], 13);
    v16 = irq_to_desc(virq);
    if ( !v16 || *(_DWORD *)(v16 + 136) )
      wcd_enable_irq(v4 + 51, 13);
    _X8 = v4 + 57;
    __asm { PRFM            #0x11, [X8] }
    do
      v31 = __ldxr(_X8);
    while ( __stxr(v31 | 0x1000, _X8) );
  }
  else
  {
    if ( v5 )
    {
      ...
      if ( *(v5 - 1) != -17866579 )
        __break(0x8228u);
      ((void (__fastcall *)(unsigned __int64, __int64, __int64))v5)(v6, 1, 0x20000);
    }
