__int64 __fastcall wcd939x_codec_enable_hphl_pa(__int64 a1, __int64 a2, int a3)
{
  __int64 result; // x0
  __int64 v5; // x8
  __int64 v6; // x20
  ...
  if ( a3 > 3 )
  {
    if ( a3 == 4 )
    {
      ...
      wcd_disable_irq(v7 + 328, 11);
      v20 = *(_DWORD **)(v7 + 3152);
      if ( v20 && *(_BYTE *)(v7 + 308) == 1 )
      {
        v21 = *(_QWORD *)(v7 + 3144);
        if ( *(v20 - 1) != -17866579 )
          __break(0x8228u);
        ((void (__fastcall *)(__int64, __int64, _QWORD))v20)(v21, 4, 0);
      }
      if ( (*(_BYTE *)(v7 + 308) & 1) != 0 )
      {
        v22 = 7000;
  ...
  if ( a3 != 1 )
  {
    ...
    if ( v24 )
    {
      ...
      if ( *(v24 - 1) != -17866579 )
        __break(0x8228u);
      ((void (__fastcall *)(__int64, __int64, _QWORD))v24)(v25, 1, 0);
    }
    if ( !*(_BYTE *)(v7 + 280) )
      wcd_enable_irq(v7 + 328, 11);
    return 0;
  }
  if ( *(_BYTE *)(v7 + 310) == 1 )
