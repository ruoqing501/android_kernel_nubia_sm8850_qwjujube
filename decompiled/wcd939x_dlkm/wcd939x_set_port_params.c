__int64 __fastcall wcd939x_set_port_params(
        __int64 a1,
        __int64 a2,
        _BYTE *a3,
        _BYTE *a4,
...
LABEL_24:
  ...
  {
LABEL_149:
    if ( (unsigned int)__ratelimit(&wcd939x_set_port_params__rs_291, "wcd939x_set_port_params") )
      dev_err(*(_QWORD *)(a1 + 24), "%s Failed to find slave port for type %u\n", "wcd939x_set_port_params", v8);
    return 4294967274LL;
  }
  else
  {
    __break(0x5512u);
    return _wcd939x_codec_enable_micbias(a1, a2);
  }
}
