__int64 __fastcall wcd939x_codec_enable_adc(__int64 a1, __int64 a2, int a3)
{
  __int64 v5; // x24
  __int64 v6; // x22
  int v7; // w0
  ...
  if ( a3 == 8 )
  {
    *(_DWORD *)(v6 + 304) = (*(_DWORD *)(v6 + 304) - 1) & ~((*(_DWORD *)(v6 + 304) - 1) >> 31);
    wcd939x_tx_connect_port(v5 - 208, (unsigned int)*(unsigned __int8 *)(a1 + 76) + 30, 0, 0);
    result = 0;
    if ( *(_BYTE *)(a1 + 76) != 1 )
      goto LABEL_71;
    if ( (*(_QWORD *)(v6 + 376) & 0x80) == 0 )
    {
LABEL_12:
      result = 0;
      goto LABEL_71;
    ...
    v40[0] = 0;
    v38[0] = 0;
    if ( !(unsigned int)wcd939x_set_port_params(v5 - 208, 29, v40, &v39, v38, &v36, v37, 0) )
    {
      v13 = *(_QWORD *)(v12 + 48);
      v37[0] = *(_BYTE *)(v12 + 3223);
