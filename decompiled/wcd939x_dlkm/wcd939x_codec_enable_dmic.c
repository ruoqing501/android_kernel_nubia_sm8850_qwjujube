__int64 __fastcall wcd939x_codec_enable_dmic(__int64 a1, __int64 a2, int a3)
{
  __int64 v3; // x23
  unsigned int v4; // w8
  __int64 v5; // x24
...
LABEL_15:
    ...
    if ( a3 == 8 )
    {
      wcd939x_tx_connect_port(v14, v4 + 34, 0, 0);
    ...
    else if ( a3 == 1 )
    {
      ...
      snd_soc_component_update_bits(v14, 13403, 2, 2);
      snd_soc_component_update_bits(v14, 13403, 4, 4);
...
LABEL_11:
  if ( (unsigned int)__ratelimit(&wcd939x_codec_enable_dmic__rs, "wcd939x_codec_enable_dmic") )
