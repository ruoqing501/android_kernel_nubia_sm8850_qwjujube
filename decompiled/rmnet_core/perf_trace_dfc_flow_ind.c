__int64 __fastcall perf_trace_dfc_flow_ind(
        __int64 result,
        int a2,
        int a3,
        char a4,
        ...
        int a9)
{
  ...
  {
    result = perf_trace_buf_alloc(36, v26, &v25);
    if ( result )
    {
      v20 = (_QWORD *)v26[0];
      ...
      *(_DWORD *)(result + 20) = a6;
      *(_WORD *)(result + 24) = a7;
      *(_BYTE *)(result + 26) = (_BYTE)v20;
      *(_DWORD *)(result + 28) = a9;
      result = perf_trace_run_bpf_submit(result, 36, v22, v12, 1, v21, StatusReg + v18, 0);
    }
  }
