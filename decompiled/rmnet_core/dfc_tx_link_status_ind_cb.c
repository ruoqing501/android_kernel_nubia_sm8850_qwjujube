__int64 __fastcall dfc_tx_link_status_ind_cb(__int64 result, __int64 a2, __int64 a3, _BYTE *a4)
{
  __int64 v5; // x19
  _QWORD *v6; // x21
  __int64 v7; // x0
  ...
  if ( a4[1] )
  {
    if ( (unsigned __int8)a4[2] >= 0x11u )
    {
      return printk(&unk_2D460, "dfc_tx_link_status_ind_cb");
    }
    else
    {
      v5 = result;
      ...
      {
        *(_WORD *)(result + 16) = 36;
        memcpy((void *)(result + 20), a4, 0x84u);
