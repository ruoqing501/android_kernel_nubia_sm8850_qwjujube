__int64 __fastcall qpace_urgent_decompress(unsigned __int64 a1, __int64 a2)
{
...
LABEL_6:
    ...
    v10 = (int)(v9 << 12);
    writel(a2 & 0xFFFFFF00 | 1, qpace_urg_regs + v10);
    ...
    *(_DWORD *)(StatusReg + 16) = v11;
    ...
    printk(&unk_7D84, "qpace_urgent_decompress", v9);
    return 4294967274LL;
  }
  if ( (i & 0xF00000) != 0 )
    goto LABEL_6;
