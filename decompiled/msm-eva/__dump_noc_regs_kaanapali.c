__int64 __fastcall _dump_noc_regs_kaanapali(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v5; // x26
  int v6; // w20
...
LABEL_56:
  ...
  _print_reg_details_errlog3_low_kaanapali(v14, v15, v16, v17, v18, v19, v20);
