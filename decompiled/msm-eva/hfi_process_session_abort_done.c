__int64 __fastcall hfi_process_session_abort_done(int a1, _DWORD *a2, __int64 a3, __int64 a4)
{
  __int64 v4; // x21
  int v5; // w22
  __int64 v6; // x23
  ...
  if ( (msm_cvp_debug & 0x2000) != 0 && !msm_cvp_debug_out )
  {
    ...
    v10 = a2;
    v11 = a3;
    printk(&unk_922BD, "sess", (unsigned int)a2[2], a4);
    a1 = v9;
    a2 = v10;
    a3 = v11;
    if ( !v10 )
...
LABEL_11:
  ...
  if ( (msm_cvp_debug & 1) != 0 && !msm_cvp_debug_out )
  {
    ...
    printk(&unk_82FFE, *(unsigned int *)(v12 + 1800), *(unsigned int *)(v12 + 1804), &unk_8E7CE);
    return 4294967289LL;
  }
  return result;
}
