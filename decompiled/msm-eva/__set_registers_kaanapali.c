__int64 __fastcall _set_registers_kaanapali(__int64 a1)
{
  __int64 v1; // x23
  __int64 v3; // x22
  __int64 v4; // x24
  ...
  if ( v1 )
  {
    ...
    _write_register(
      a1,
      0x13038u,
      *(_DWORD *)(*(_QWORD *)(a1 + 2208) + 424LL) ^ *(_DWORD *)(*(_QWORD *)(v3 + 32) + 12LL));
    ...
    _write_register(
      a1,
      0x13438u,
      *(_DWORD *)(*(_QWORD *)(a1 + 2208) + 428LL) ^ *(_DWORD *)(*(_QWORD *)(v3 + 32) + 12LL));
