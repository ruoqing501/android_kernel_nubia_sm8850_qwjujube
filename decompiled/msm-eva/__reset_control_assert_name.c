...
LABEL_4:
    ...
    {
      printk(&unk_85EBB, &unk_8DA84, "__reset_control_assert_name", s2);
      return 4294967274LL;
    }
  }
  else
  {
    ...
    if ( (_DWORD)result )
    {
      if ( (msm_cvp_debug & 1) != 0 && !msm_cvp_debug_out )
      {
        ...
        v8 = result;
        printk(&unk_8237B, *(unsigned int *)(StatusReg + 1800), *(unsigned int *)(StatusReg + 1804), &unk_8E7CE);
        return v8;
      }
    }
    else if ( (msm_cvp_debug & 0x400) != 0 && !msm_cvp_debug_out )
    {
      printk(&unk_8BA1D, &unk_8DA84, "__reset_control_assert_name", *(_QWORD *)(v4 + 16));
      return 0;
    }
  }
  return result;
