__int64 __fastcall _noc_error_info_iris2_pakala(__int64 result, __int64 a2, __int64 a3, __int64 a4)
{
  _DWORD *v4; // x22
  ...
  else
  {
    ...
    _print_reg_details_errlog3_low_pakala(v34, v35, v36, v37, v38, v39, v40);
