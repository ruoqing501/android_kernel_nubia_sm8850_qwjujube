__int64 __fastcall _read_register(__int64 a1, unsigned int a2)
{
  __int64 v3; // x21
  __int64 v5; // x19
  __int64 result; // x0
  ...
  if ( (*(_BYTE *)(a1 + 72) & 1) == 0 )
  {
    if ( (msm_cvp_debug & 2) != 0 && !msm_cvp_debug_out )
    {
      ...
      printk(&unk_961D4, *(unsigned int *)(v9 + 1800), *(unsigned int *)(v9 + 1804), "warn");
    }
