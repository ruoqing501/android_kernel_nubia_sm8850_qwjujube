__int64 __fastcall _power_off_core_pakala(__int64 a1)
{
  int v2; // w0
  __int64 v3; // x2
  __int64 v4; // x3
...
LABEL_51:
  ...
  if ( (v2 & 2) != 0 || !msm_cvp_fw_low_power_mode )
  {
                    ...
                    if ( (_read_register(a1, 0x50u) & 0x400000) == 0 )
                    {
                      ...
                      if ( (_read_register(a1, 0x50u) & 0x400000) == 0 )
                      {
                        ...
                        if ( (msm_cvp_debug & 2) != 0 && !msm_cvp_debug_out )
                        {
                          ...
                          printk(&unk_88910, *(unsigned int *)(v19 + 1800), *(unsigned int *)(v19 + 1804), "warn");
                        }
                      }
                    }
                  }
    ...
    if ( (msm_cvp_debug & 2) != 0 && !msm_cvp_debug_out )
    {
      ...
      printk(&unk_89AF0, *(unsigned int *)(v18 + 1800), *(unsigned int *)(v18 + 1804), "warn");
      if ( a1 )
        goto LABEL_45;
    }
    else if ( a1 )
