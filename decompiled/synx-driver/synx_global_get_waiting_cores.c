__int64 __fastcall synx_global_get_waiting_cores(
        unsigned int a1,
        unsigned __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        __int64 a6)
{
  ...
  if ( synx_gmem_2 )
  {
    if ( a1 - 1 <= 0xFFE && a2 && a2 < 0xFFFFFFFFFFFFF001LL )
    {
      if ( (get_ipclite_feature(4) & 1) != 0 )
      {
        ...
        if ( !(_DWORD)result )
        {
          v11 = synx_gmem_2;
LABEL_17:
          synx_global_get_waiting_cores_locked(v11 + glcoredata_size * a1, a2);
          if ( (get_ipclite_feature(4) & 1) != 0 )
          {
      ...
      {
        v13 = result;
        printk(&unk_2981B, &unk_29207, "synx_global_get_waiting_cores", 400, a1, v9);
        result = v13;
      }
    }
    else
    {
      if ( (synx_debug & 1) != 0 )
        printk(&unk_29CFB, &unk_29207, "synx_global_get_waiting_cores", 394, a2, a1);
      result = 4294967274LL;
    }
  }
  else
  {
    if ( (synx_debug & 1) != 0 )
      printk(&unk_267BF, &unk_29207, "synx_global_get_waiting_cores", 389, a5, a6);
    result = 4294967284LL;
  }
LABEL_29:
