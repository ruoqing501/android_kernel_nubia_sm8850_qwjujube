__int64 __fastcall synx_handle_cancel_async_wait(__int64 a1, __int64 a2)
{
  int v2; // w8
  __int64 v4; // x1
  __int64 result; // x0
  ...
  if ( v2 == 40 )
  {
    ...
    else
    {
      ...
      v10 = v14;
      result = synx_cancel_async_wait(a2, &v8);
      if ( (_DWORD)result && (synx_debug & 1) != 0 )
      {
        v7 = result;
        printk(&unk_2ADA3, &unk_29207, "synx_handle_cancel_async_wait", 3338, (unsigned int)v13, v6);
        result = v7;
      }
    }
  }
