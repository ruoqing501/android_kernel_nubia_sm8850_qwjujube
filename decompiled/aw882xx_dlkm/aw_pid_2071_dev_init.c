__int64 __fastcall aw_pid_2071_dev_init(__int64 result)
{
  *(_DWORD *)(result + 520) = 1000;
  *(_QWORD *)(result + 444) = 0xFFFF83FF00000078LL;
  *(_QWORD *)(result + 452) = 0x7A0000000ALL;
  *(_DWORD *)(result + 28) = 126;
  *(_QWORD *)(result + 460) = 0xAFFFF83FFLL;
  *(_QWORD *)(result + 468) = 0xFFFF03FFFFFFFDFFLL;
  *(_QWORD *)(result + 504) = 0xFFFF03FFFFFFFDFFLL;
  qmemcpy((void *)(result + 128), "aw882xx_pid_2071_monitor.bin", 28);
  ...
  *(_QWORD *)(result + 376) = "btn 2071 hmute";
  ...
  *(_QWORD *)(result + 992) = "btn 2071 dither";
