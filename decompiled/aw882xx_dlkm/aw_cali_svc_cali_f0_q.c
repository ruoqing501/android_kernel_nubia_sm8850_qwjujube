__int64 __fastcall aw_cali_svc_cali_f0_q(__int64 a1, char a2, char a3)
{
  ...
  if ( (a2 & 1) != 0 )
  {
    ...
    {
      f0_q = aw882xx_dsp_cali_en(a1, 2);
      if ( (f0_q & 0x80000000) == 0 )
      {
        msleep(5000);
        f0_q = aw_cali_svc_dev_get_f0_q(a1);
      }
      v35 = f0_q;
      aw882xx_dsp_cali_en(a1, 0);
      if ( (a3 & 2) == 0 )
...
LABEL_53:
  ...
  if ( list_head )
  {
    ...
    if ( !v26 )
      v26 = *v24;
    printk(&unk_26742, v26, "aw_cali_svc_devs_cali_f0_q");
    result = v25;
  }
  else
  {
...
LABEL_17:
      ...
      else
      {
        while ( 1 )
        {
          result = aw_cali_svc_dev_get_f0_q(v16 - 153);
