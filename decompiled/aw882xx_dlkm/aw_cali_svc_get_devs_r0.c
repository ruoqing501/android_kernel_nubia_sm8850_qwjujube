__int64 __fastcall aw_cali_svc_get_devs_r0(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( list_head )
  {
    ...
    v15 = &unk_26C84;
LABEL_19:
    printk(v15, v14, "aw_cali_svc_get_devs_r0");
  }
  else
  {
    v7 = *(_QWORD **)v18[0];
    if ( *(_QWORD *)v18[0] != v18[0] )
    {
      ...
      while ( 1 )
      {
        ...
        if ( (unsigned int)v9 >= a3 )
        {
          ...
          if ( !v12 )
            v12 = *v11;
          printk(&unk_2782C, v12, "aw_cali_svc_get_devs_r0");
        }
        else
        {
          r0 = aw882xx_dsp_read_r0(v7 - 153, a2 + 4 * v9);
          if ( r0 )
          {
            v8 = r0;
            v16 = (__int64 *)*(v7 - 139);
