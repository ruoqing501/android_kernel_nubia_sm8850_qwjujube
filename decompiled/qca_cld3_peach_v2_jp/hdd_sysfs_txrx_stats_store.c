          ...
          if ( !(unsigned int)kstrtouint(v64, 0, &v99) )
          {
            ...
            if ( v65 )
            {
              if ( !(unsigned int)kstrtou8(v65, 0, v98) )
              {
                ...
                if ( context )
                {
                  if ( (v99 == 28 || v99 == 11) && v44[676] )
                  {
                    if ( v44 == (unsigned __int8 *)-300LL )
                    {
                      v84 = 0;
                      v82 = 0;
                      v83 = 0;
                  ...
                  v86 = cdp_txrx_stats_request(context, *(unsigned __int8 *)(*(_QWORD *)(a1 + 54136) + 8LL), v101);
                  if ( v86 )
                  {
                    v95 = v86;
                    v96 = jiffies;
