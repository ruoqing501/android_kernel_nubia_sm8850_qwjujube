        ...
        double a10)
{
  ...
  unsigned int v60; // w8
  __int16 v61; // w9
  _QWORD v62[4]; // [xsp+8h] [xbp-48h] BYREF
  __int64 v63; // [xsp+28h] [xbp-28h]
  __int64 v64; // [xsp+30h] [xbp-20h]
  __int64 v65; // [xsp+38h] [xbp-18h] BYREF
  int v66; // [xsp+40h] [xbp-10h]
...
LABEL_50:
        ...
        if ( v22 == 5 )
        {
          if ( (lim_is_sb_disconnect_allowed_fl(session_by_vdev_id, (__int64)"lim_delete_sta_context", 0x118u) & 1) != 0 )
          {
            ...
            lim_tear_down_link_with_ap(a1, *(unsigned __int8 *)(v23 + 8), 12, 6);
          }
          goto LABEL_50;
        }
LABEL_25:
      ...
      if ( *(_DWORD *)(session_by_vdev_id + 88) != 2 || (*(_BYTE *)v10 & 1) != 0 )
      {
        ...
        {
          v43 = v34;
          *(_BYTE *)(v34 + 644) = *(_BYTE *)(v10 + 18);
          v44 = *(_DWORD *)(v23 + 88);
          if ( v44 == 2 )
          {
            if ( *(_BYTE *)(v34 + 344) == 4 )
            {
              wlan_tdls_update_peer_kickout_count(*(_QWORD *)(v23 + 16), v34 + 338);
          ...
          else if ( v44 == 1 )
          {
            ...
            {
              if ( (*(_WORD *)v43 & 0x800) != 0 && *(_DWORD *)(v43 + 832) != *(_DWORD *)(v23 + 284) )
              {
                lim_send_deauth_mgmt_frame(a1, 2, v43 + 338, v23, 1);
                *(_BYTE *)(v43 + 642) = 1;
              }
              else
              {
                lim_send_disassoc_mgmt_frame(a1, 4, v43 + 338, v23, 0);
          ...
          if ( v60 <= 0xF && ((1 << v60) & 0xD000) != 0 )
          {
            *(_DWORD *)(v43 + 24) = 4;
            *(_WORD *)(v43 + 34) = 6;
            qdf_mem_copy(&v65, (const void *)(v43 + 338), 6u);
            v61 = *(_WORD *)(v43 + 34);
            HIWORD(v65) = *(unsigned __int8 *)(v43 + 24);
            LOWORD(v66) = v61;
            lim_delete_tdls_peers(a1, v23, 0);
            if ( *(_DWORD *)(v23 + 88) == 2 )
              lim_process_mlm_rsp_messages(a1, 1019, &v65);
...
LABEL_27:
      ...
      if ( dph_get_hash_entry(a1, 1u, v23 + 360) )
      {
        ...
        if ( v48 == 6 )
          ...
          v50 = v49;
        lim_tear_down_link_with_ap(a1, *(unsigned __int8 *)(v23 + 8), v50, 6);
        qdf_mem_set(v62, 0x30u, 0);
        qdf_mem_copy(v62, (const void *)(v10 + 10), 6u);
        v51 = *(_QWORD *)(a1 + 21560);
        v63 = 0x200000002LL;
        LODWORD(v64) = 1;
        dlm_add_bssid_to_reject_list(v51, v62);
        goto LABEL_50;
      }
