...
LABEL_61:
        ...
        result = mod_timer(a1 + 17728, v52 + 2LL * multiplier);
        goto LABEL_62;
      }
      v49 = 0;
      v50 = a1 + 7800;
...
LABEL_25:
          ...
          v41 = ((__int64 (__fastcall *)(__int64, __int64, _QWORD, _QWORD))v40)(
                  a1,
                  a1 + 200LL * (unsigned __int8)v3 + 7800,
                  (unsigned int)v20,
                  (unsigned int)v34);
          if ( !v41 )
            goto LABEL_26;
