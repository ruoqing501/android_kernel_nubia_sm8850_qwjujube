...
LABEL_6:
  ...
  dp_ssr_dump_srng_register("wbm_desc_rel_ring", a1 + 7720, -1);
  wlan_minidump_log(
    v11,
    v12,
    v13,
  ...
  dp_ssr_dump_srng_register("reo_exception_ring", a1 + 6352, -1);
  wlan_minidump_log(
    v21,
    v22,
    v23,
...
LABEL_17:
  ...
  dp_ssr_dump_srng_register("reo_reinject_ring", a1 + 6432, -1);
  wlan_minidump_log(
    v30,
    v31,
    v32,
  ...
  dp_ssr_dump_srng_register("rx_rel_ring", a1 + 6672, -1);
  wlan_minidump_log(
    v38,
    v39,
    v40,
  ...
  dp_ssr_dump_srng_register("reo_cmd_ring", a1 + 6512, -1);
  wlan_minidump_log(
    v46,
    v47,
    v48,
    ...
    v53,
    *(_QWORD *)(a1 + 6520),
    *(unsigned int *)(a1 + 6552),
    *(_QWORD *)(a1 + 16));
  hal_reo_init_cmd_ring(*(_QWORD *)(a1 + 1128), *(_QWORD *)(a1 + 6512));
  *(_QWORD *)(a1 + 13160) = 0;
  *(_DWORD *)(a1 + 13176) = 0;
  *(_QWORD *)(a1 + 13168) = a1 + 13160;
  *(_QWORD *)(a1 + 13184) = 0;
  if ( (unsigned int)dp_srng_init(a1) )
  {
  ...
  dp_ssr_dump_srng_register("reo_status_ring", a1 + 6592, -1);
  wlan_minidump_log(
    v54,
    v55,
    v56,
  ...
  if ( *(_BYTE *)(a1 + 7153) )
  {
    ...
    {
      if ( *(unsigned __int8 *)(a1 + 7153) <= (unsigned int)(unsigned __int8)++v62 )
        goto LABEL_22;
    }
    goto LABEL_7;
  }
...
LABEL_7:
  ...
  qdf_event_create((_DWORD *)(a1 + 18576));
  if ( *(_BYTE *)(a1 + 12848) )
  {
    v63 = 0;
    v64 = a1 + 5712;
    while ( 1 )
    {
      ...
      ++v63;
      v64 += 80;
      if ( v63 >= *(unsigned __int8 *)(a1 + 12848) )
        goto LABEL_29;
    }
    __break(0x5512u);
