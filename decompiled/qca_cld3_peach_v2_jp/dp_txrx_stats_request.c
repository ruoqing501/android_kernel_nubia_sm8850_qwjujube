...
LABEL_22:
  ...
  v16 = v15 + 40960;
  v17 = *(_DWORD *)(v15 + 42560);
  do
  {
    if ( !v17 )
      goto LABEL_20;
    _X13 = (unsigned int *)(v15 + 42560);
    __asm { PRFM            #0x11, [X13] }
    while ( 1 )
    {
      v24 = __ldxr(_X13);
  ...
  while ( 1 )
  {
    ...
    if ( (v68 & 1) != 0 )
    {
      *(_QWORD *)(a1 + 18936) = v68 & 0xFFFFFFFFFFFFFFFELL;
      raw_spin_unlock_bh(a1 + 18928);
      if ( !a3 )
      {
LABEL_62:
...
LABEL_47:
    ...
    if ( v42 == 32 )
    {
      v53 = qdf_wait_single_event(*(_QWORD *)(v41 + 17528) + 96LL, 0xBB8u);
      if ( v53 == 15 )
      {
