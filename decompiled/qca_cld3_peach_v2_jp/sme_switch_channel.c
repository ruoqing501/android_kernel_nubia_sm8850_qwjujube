__int64 __fastcall sme_switch_channel(__int64 a1, int *a2, unsigned int a3, int a4)
{
  ...
  v46 = 0;
  v47 = 0;
  v8 = _qdf_mem_malloc(0x20u, "sme_switch_channel", 17311);
  if ( v8 )
  {
    v17 = *((_WORD *)a2 + 2);
    v18 = *a2;
    ...
    *(_DWORD *)(v8 + 24) = v18;
    *(_DWORD *)(v8 + 12) = a4;
    v20 = wlan_reg_freq_to_chan(*(_QWORD *)(a1 + 21560), a3, v9, v10, v11, v12, v13, v14, v15, v16);
    v21 = *(unsigned __int8 *)(v19 + 24);
    v22 = *(unsigned __int8 *)(v19 + 25);
    v23 = *(unsigned __int8 *)(v19 + 26);
    v24 = *(unsigned __int8 *)(v19 + 29);
    v25 = *(_DWORD *)(v19 + 4);
    v26 = *(_DWORD *)(v19 + 12);
    *(_BYTE *)v19 = v20;
    *(_BYTE *)(v19 + 8) = 1;
