...
LABEL_13:
  ...
  v21 = sme_register_mgmt_frame(v11, 50, 208, &unk_95895F, 2);
  if ( v21 )
  {
    v30 = "%s: Failed to register GAS_INITIAL_REQ";
    goto LABEL_13;
  }
  v33 = sme_register_mgmt_frame(v11, 50, 208, &unk_88EE42, 2);
  if ( v33 )
  {
    v42 = v33;
    qdf_trace_msg(
...
LABEL_29:
  ...
  v43 = sme_register_mgmt_frame(v11, 50, 208, &unk_86DCB6, 2);
  if ( v43 )
  {
    v42 = v43;
    qdf_trace_msg(
...
LABEL_28:
  ...
  v52 = sme_register_mgmt_frame(v11, 50, 208, &unk_8F4292, 2);
  if ( v52 )
  {
    v42 = v52;
    qdf_trace_msg(
...
LABEL_26:
  ...
  result = sme_register_mgmt_frame(v11, *(unsigned __int8 *)(*(_QWORD *)(a1 + 52824) + 8LL), 208, &unk_942780, 2);
  if ( (_DWORD)result )
  {
    v42 = result;
    qdf_trace_msg(
