        ...
        double a9)
{
  ...
  if ( a1 )
  {
    *a1 = tgt_mgmt_txrx_tx_completion_handler;
    ...
    a1[146] = (__int64 (__fastcall *)(__int64, unsigned int, unsigned int, __int64))wlan_green_ap_is_ps_enabled;
    a1[147] = (__int64 (__fastcall *)(__int64, unsigned int, unsigned int, __int64))ucfg_green_ap_get_debug_prints;
    a1[149] = (__int64 (__fastcall *)(__int64, unsigned int, unsigned int, __int64))ucfg_green_ap_set_ps_config;
    a1[148] = (__int64 (__fastcall *)(__int64, unsigned int, unsigned int, __int64))ucfg_green_ap_get_ps_config;
    a1[150] = (__int64 (__fastcall *)(__int64, unsigned int, unsigned int, __int64))wlan_green_ap_suspend_handle;
    a1[152] = (__int64 (__fastcall *)(__int64, unsigned int, unsigned int, __int64))wlan_ftm_process_utf_event;
    tgt_vdev_mgr_register_rx_ops(a1);
    tgt_twt_register_rx_ops(a1);
    a1[162] = (__int64 (__fastcall *)(__int64, unsigned int, unsigned int, __int64))target_if_dbam_process_event;
    return 0;
  }
  else
  {
