__int64 __fastcall ce_disable_any_copy_compl_intr_nolock(__int64 a1)
{
  __int64 result; // x0
            ...
            *(_DWORD *)(a1 + 31092) = (v22 >> 19) & 0x3F;
            ...
            if ( v25 != v23 )
              qdf_trace_msg(
                ...
                v25,
                12920);
            writel_1(v17 & (unsigned int)~v20, *(_QWORD *)(a1 + 30720) + (*(_QWORD *)&v22 & 0x7FFFFLL) + 0x80000);
            pld_unlock_reg_window(*(_QWORD *)(a1 + 30760), v47);
          }
          else
          {
            writel_1(v17 & (unsigned int)~v20, v12);
          }
          v4 = a1 + 480;
        }
        if ( *(_QWORD *)(v5 + 112) )
            ...
            *(_DWORD *)(a1 + 31092) = (v43 >> 19) & 0x3F;
            ...
            if ( v46 != v44 )
              qdf_trace_msg(
                ...
                v46,
                12920);
            writel_1(v36 & (unsigned int)~v42, *(_QWORD *)(a1 + 30720) + (*(_QWORD *)&v43 & 0x7FFFFLL) + 0x80000);
            pld_unlock_reg_window(*(_QWORD *)(a1 + 30760), v47);
          }
          else
          {
            writel_1(v36 & (unsigned int)~v42, v31);
          }
        }
        ++v3;
      }
