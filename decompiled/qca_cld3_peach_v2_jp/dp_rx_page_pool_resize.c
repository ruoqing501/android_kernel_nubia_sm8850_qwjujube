__int64 __fastcall dp_rx_page_pool_resize(__int64 a1, unsigned int a2, unsigned __int64 a3)
{
  ...
  v15 = a1 + 544LL * a2 + 20224;
  v16 = *(_QWORD *)(a1 + 544LL * a2 + 20496);
  if ( v16 == a3 )
  {
    qdf_trace_msg(
      0x45u,
  ...
  if ( a3 && v16 )
  {
    *(_DWORD *)(a1 + 544LL * a2 + 20512) = 1;
    if ( v16 < a3 )
    {
      v18 = *(_QWORD *)(a1 + 544LL * a2 + 20504);
      v112[0] = 0;
      v111[0] = 0;
      v110 = 0;
      v105 = a3 % v18;
      ...
      while ( 1 )
      {
        ...
        {
          raw_spin_lock(a1 + 544LL * a2 + 20480);
        }
        else
        {
          raw_spin_lock_bh(a1 + 544LL * a2 + 20480);
          *(_QWORD *)(a1 + 544LL * a2 + 20488) |= 1uLL;
        }
        v52 = *v43;
        if ( *v43 == v43 )
        {
LABEL_39:
        ...
        else
        {
          ...
          qdf_list_remove_node(a1 + 544LL * a2 + 20640, v52);
          ...
          {
LABEL_40:
            raw_spin_unlock(a1 + 544LL * a2 + 20480);
            if ( !v53 )
              goto LABEL_41;
            goto LABEL_24;
          }
        }
        *(_QWORD *)(a1 + 544LL * a2 + 20488) = v54 & 0xFFFFFFFFFFFFFFFELL;
        raw_spin_unlock_bh(a1 + 544LL * a2 + 20480);
        if ( !v53 )
        {
LABEL_41:
...
LABEL_54:
            if ( v45 >= 2 )
            {
              ...
              v69 = (_BYTE *)(544LL * a2 + 48LL * (unsigned int)v45 + a1 + 20216);
              while ( v68 <= 5 )
              {
                v70 = *((_QWORD *)v69 - 3);
                if ( v70 )
...
LABEL_83:
    ...
    if ( (_qdf_page_pool_full_bh() & 1) == 0 )
    {
      ...
      if ( v21 )
      {
        v30 = (const void *)(a1 + 544LL * a2 + 20272);
        v31 = v21;
