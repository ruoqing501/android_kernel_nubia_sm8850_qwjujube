__int64 __fastcall tgt_vdev_mgr_set_tx_rx_decap_type(
        __int64 a1,
        double a2,
        double a3,
        double a4,
        ...
        double a9)
{
  ...
  if ( !a1 )
  {
    qdf_trace_msg(0x68u, 2u, "%s: Invalid input", a2, a3, a4, a5, a6, a7, a8, a9, "tgt_vdev_mgr_set_tx_rx_decap_type");
    return 4;
  }
  v9 = *(_QWORD *)(a1 + 504);
  v10 = *(_QWORD *)(v9 + 152);
