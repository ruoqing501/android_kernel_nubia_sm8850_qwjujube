__int64 __fastcall tgt_mc_cp_stats_extract_peer_stats(__int64 a1, __int64 a2, char a3)
{
  ...
  __int64 v229; // x12
  __int64 v230; // x8
  __int64 v231; // [xsp+0h] [xbp-140h]
  __int64 v232; // [xsp+8h] [xbp-138h]
  unsigned __int64 StatusReg; // [xsp+18h] [xbp-128h]
  unsigned __int64 v234; // [xsp+18h] [xbp-128h]
  int v235; // [xsp+20h] [xbp-120h]
  unsigned __int64 v236; // [xsp+20h] [xbp-120h]
  int v237; // [xsp+20h] [xbp-120h]
  __int64 v238; // [xsp+28h] [xbp-118h]
  char v239[4]; // [xsp+34h] [xbp-10Ch] BYREF
  __int64 v240; // [xsp+38h] [xbp-108h] BYREF
  void (__fastcall *v241)(__int64 *, __int64); // [xsp+40h] [xbp-100h]
  __int64 v242; // [xsp+48h] [xbp-F8h]
  __int64 v243; // [xsp+50h] [xbp-F0h] BYREF
  __int64 v244; // [xsp+58h] [xbp-E8h] BYREF
  __int64 v245; // [xsp+60h] [xbp-E0h]
  __int64 v246; // [xsp+68h] [xbp-D8h]
  __int64 v247; // [xsp+70h] [xbp-D0h] BYREF
  __int64 v248; // [xsp+78h] [xbp-C8h]
  __int64 v249; // [xsp+80h] [xbp-C0h]
  __int64 v250; // [xsp+88h] [xbp-B8h]
  __int64 v251; // [xsp+90h] [xbp-B0h]
  __int64 v252; // [xsp+98h] [xbp-A8h]
  __int64 v253; // [xsp+A0h] [xbp-A0h]
  __int64 v254; // [xsp+A8h] [xbp-98h]
  __int64 v255; // [xsp+B0h] [xbp-90h]
  __int64 v256; // [xsp+B8h] [xbp-88h]
  __int64 v257; // [xsp+C0h] [xbp-80h]
  __int64 v258; // [xsp+C8h] [xbp-78h]
  __int64 v259; // [xsp+D0h] [xbp-70h]
  __int64 v260; // [xsp+D8h] [xbp-68h]
  __int64 v261; // [xsp+E0h] [xbp-60h]
  __int64 v262; // [xsp+E8h] [xbp-58h]
  __int64 v263; // [xsp+F0h] [xbp-50h]
  __int64 v264; // [xsp+F8h] [xbp-48h]
  __int64 v265; // [xsp+100h] [xbp-40h]
  __int64 v266; // [xsp+108h] [xbp-38h]
  __int64 v267; // [xsp+110h] [xbp-30h]
  __int64 v268; // [xsp+118h] [xbp-28h]
  __int64 v269; // [xsp+120h] [xbp-20h]
  __int64 v270; // [xsp+128h] [xbp-18h]
  __int64 v271; // [xsp+130h] [xbp-10h]
  ...
  if ( *(_QWORD *)(a2 + 40) )
  {
    ...
    if ( (unsigned __int8)(v243 & BYTE1(v243) & BYTE2(v243) & BYTE3(v243) & BYTE4(v243) & BYTE5(v243)) != 0xFF
      && v65 == (_DWORD)v16 )
    {
      result = qdf_trace_msg(
                 0x62u,
...
LABEL_93:
      ...
      if ( v169 )
      {
        if ( (unsigned __int8)v243 != 255
          ...
          || BYTE5(v243) != 255 )
        {
          peer = wlan_objmgr_get_peer(v5, SBYTE4(v242), &v243, 0x26u);
          v183 = peer;
          if ( peer )
          {
            v203 = wlan_objmgr_peer_get_comp_private_obj(peer, 0x1Bu);
            if ( v203 )
            {
              v212 = v203;
