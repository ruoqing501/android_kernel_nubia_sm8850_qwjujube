__int64 __fastcall hdd_disable_and_flush_mc_addr_list(__int64 a1, unsigned int a2)
{
  ...
  v2 = *(_QWORD **)(a1 + 24);
  v4 = ucfg_pmo_disable_mc_addr_filtering_in_fwr(*v2, *(unsigned __int8 *)(*(_QWORD *)(a1 + 52824) + 8LL), a2);
  if ( v4 )
    qdf_trace_msg(
      0x33u,
      8u,
      ...
      v4);
  result = ucfg_pmo_flush_mc_addr_list(*v2, *(unsigned __int8 *)(*(_QWORD *)(a1 + 52824) + 8LL));
  if ( (_DWORD)result )
