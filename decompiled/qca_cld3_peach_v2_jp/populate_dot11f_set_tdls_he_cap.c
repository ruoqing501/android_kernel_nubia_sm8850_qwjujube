void __fastcall populate_dot11f_set_tdls_he_cap(
        __int64 a1,
        unsigned int a2,
        _BYTE *a3,
        __int64 a4,
        ...
        double a13)
{
  ...
  lim_tdls_set_he_chan_width(a1, a3, a5, is_fw_wideband_capable & 1);
  if ( (a3[14] & 4) != 0 )
  {
...
LABEL_57:
  lim_log_he_cap(v18, v19, v20, v21, v22, v23, v24, v25, a1, (__int64)a3);
  if ( a4 )
    populate_dot11f_he_6ghz_cap(a1, a5, a4, v31, v32, v33, v34, v35, v36, v37, v38);
}
