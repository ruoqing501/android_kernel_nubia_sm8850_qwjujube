__int64 __fastcall target_if_ndp_initiator_rsp_handler(__int64 a1)
{
  ...
  unsigned int ndp_initiator_rsp; // w0
  double v15; // d0
  double v16; // d1
  double v17; // d2
  double v18; // d3
...
LABEL_9:
    qdf_trace_msg(0x49u, 2u, v24, v2, v3, v4, v5, v6, v7, v8, v9, "target_if_ndp_initiator_rsp_handler");
    goto LABEL_10;
  }
  v12 = _qdf_mem_malloc(0x18u, "target_if_ndp_initiator_rsp_handler", 289);
  if ( !v12 )
  {
    result = 4294967284LL;
    goto LABEL_11;
  ...
  ndp_initiator_rsp = wmi_extract_ndp_initiator_rsp(v11);
  if ( ndp_initiator_rsp )
  {
    qdf_trace_msg(
      0x49u,
      2u,
