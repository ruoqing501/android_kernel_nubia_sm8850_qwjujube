...
LABEL_53:
    ...
    if ( a3 == 11 && ((unsigned __int8)v35 & *(_BYTE *)(v37 + 1072) & 1) != 0 )
      v38 = 1;
LABEL_50:
    result = ucfg_coex_psoc_get_btc_chain_mode(*(_QWORD *)(a1 + 21552), &v44);
    if ( (_DWORD)result )
    {
    ...
    *(_DWORD *)(v17 + 4 * v15) = v25;
    v29 = (*(_DWORD *)(v34 + 3284) >> v36) & 7;
    if ( v29 >= v16 )
      v29 = v16;
    *(_DWORD *)(a2 + 40) = v29;
    v30 = (*(_DWORD *)(v34 + 3276) >> v36) & 7;
    if ( v30 >= v16 )
      v30 = v16;
    *(_DWORD *)(a2 + 32) = v30;
    v31 = (*(_DWORD *)(v34 + 3280) >> v36) & 7;
    if ( v31 >= v16 )
      v31 = v16;
    *(_DWORD *)(a2 + 36) = v31;
    *(_BYTE *)(v41 + v15) = *(_BYTE *)(v26 + 3288);
    if ( v27 >= v16 )
      v32 = v16;
    else
      v32 = v27;
  ...
  while ( (v35 & 1) != 0 );
  v39 = *(_QWORD *)(a1 + 8);
  *(_BYTE *)(a2 + 50) = *(_BYTE *)(v39 + 3294);
  *(_DWORD *)(a2 + 52) = *(_DWORD *)(v39 + 3296);
