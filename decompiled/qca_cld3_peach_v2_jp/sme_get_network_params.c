__int64 __fastcall sme_get_network_params(__int64 a1, __int64 a2)
{
  ...
  if ( a1 )
  {
    ...
    if ( !(_DWORD)result )
    {
      wlan_mlme_get_sap_chan_switch_rate_enabled(*(_QWORD *)(a1 + 21552), (_BYTE *)&v38 + 4);
      ucfg_policy_mgr_get_mcc_scc_switch(*(_QWORD *)(a1 + 21552), &v38);
      if ( (_BYTE)v38 )
        BYTE4(v38) = 0;
      opmode_from_vdev_id = wlan_get_opmode_from_vdev_id(*(_QWORD *)(a1 + 21560), *(_BYTE *)a2);
