  ...
  if ( v69 )
  {
    ...
    if ( (_DWORD)v7 == 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v43 >= *(unsigned __int16 *)(v3 + 1866) )
          break;
        v44 = (__int64 *)(*(_QWORD *)(v3 + 1872) + 24LL * v43);
        v45 = v44[2];
        v46 = *v44;
        if ( !(v46 + v71 - v45) )
          break;
        ...
        else
        {
          ...
          do
          {
            ...
            if ( (*(_BYTE *)(v29 + 30) & 1) != 0 && (v60 = *(_QWORD *)v29) != 0 )
            {
              ...
              {
                raw_spin_lock(v3 + 18464);
              }
              else
              {
                raw_spin_lock_bh(v3 + 18464);
                *(_QWORD *)(v3 + 18472) |= 1uLL;
              }
              dp_rx_nbuf_unmap_pool(v3, v3 + 12368 + 120LL * (unsigned int)v59, v60);
              *(_BYTE *)(v29 + 30) |= 2u;
              v61 = *(_QWORD *)(v3 + 18472);
              if ( (v61 & 1) != 0 )
              {
                *(_QWORD *)(v3 + 18472) = v61 & 0xFFFFFFFFFFFFFFFELL;
                raw_spin_unlock_bh(v3 + 18464);
              }
              else
              {
                raw_spin_unlock(v3 + 18464);
              }
    ...
    else if ( !(_DWORD)v7 )
    {
      ...
      if ( result )
      {
        ...
        if ( *(_QWORD *)result )
        {
          ...
          dp_rx_nbuf_unmap_pool(v3, v13 + 12368, *(_QWORD *)v11);
          *(_BYTE *)(v11 + 30) |= 2u;
          v12 = *(_QWORD *)(v3 + 18472);
          if ( (v12 & 1) != 0 )
            goto LABEL_72;
...
LABEL_71:
            __break(0x5512u);
LABEL_72:
            *(_QWORD *)(v3 + 18472) = v12 & 0xFFFFFFFFFFFFFFFELL;
...
LABEL_68:
          if ( v3 )
            ++*(_DWORD *)(v3 + 13516);
          result = _dp_rx_buffers_replenish(v3, 0, (__int64 *)(v3 + 80), v3 + 12368, v11, &v68, (__int64)&v67, 0, 0);
        }
      }
    }
  }
