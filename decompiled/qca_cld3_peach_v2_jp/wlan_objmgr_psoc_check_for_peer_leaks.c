...
LABEL_7:
  ...
  do
  {
    ...
    if ( v39 )
    {
      ...
      {
        raw_spin_lock(v39 + 1272);
      }
      else
      {
        raw_spin_lock_bh(v39 + 1272);
        *(_QWORD *)(v39 + 1280) |= 1uLL;
      }
      v61 = v39;
      v42 = *(__int64 **)(v39 + 128);
      v41 = (__int64 *)(v39 + 128);
      ...
      if ( v42 != v41 )
      {
        do
        {
          ...
          if ( (_ReadStatusReg(DAIF) & 0x80) != 0
            ...
            || (*(_DWORD *)(v37 + 16) & 0xFF00) != 0 )
          {
            raw_spin_lock(v40 + 93);
          }
          else
          {
            raw_spin_lock_bh(v40 + 93);
            v40[94] |= 1uLL;
          }
          v52 = *((_DWORD *)v40 + 20);
          LODWORD(v58) = v52;
          ...
          if ( (v53 & 1) != 0 )
          {
            v40[94] = v53 & 0xFFFFFFFFFFFFFFFELL;
            raw_spin_unlock_bh(v40 + 93);
          }
          else
          {
            raw_spin_unlock(v40 + 93);
          }
          v36 += v52;
          v40 = v43;
        }
      ...
      if ( (v54 & 1) != 0 )
      {
        *(_QWORD *)(v61 + 1280) = v54 & 0xFFFFFFFFFFFFFFFELL;
        raw_spin_unlock_bh(v61 + 1272);
      }
      else
      {
        raw_spin_unlock(v61 + 1272);
      }
    }
    ++v35;
  }
