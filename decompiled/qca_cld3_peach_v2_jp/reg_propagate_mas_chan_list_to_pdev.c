...
LABEL_34:
  ...
  if ( v20 )
  {
    if ( *(v20 - 1) != 13449260 )
      __break(0x8228u);
    ((void (__fastcall *)(__int64, _QWORD, _BYTE *))v20)(a1, v18, v49);
  }
  else
  {
    v49[0] = v18;
  ...
  if ( v49[0] < 4uLL )
  {
    inited = reg_init_pdev_mas_chan_list((_BYTE *)v17, v15 + 30364LL * v49[0]);
    if ( v49[0] <= 2uLL )
    {
      v24 = (_QWORD *)(v17 + 56728);
      ((void (__fastcall *)(__int64, __int64))reg_save_reg_rules_to_pdev)(v15 + 30364LL * v49[0] + 29624, v17);
      ...
      *(_DWORD *)(v17 + 58204) = v33;
      ...
      if ( v49[0] <= 2uLL )
      {
        *(_BYTE *)(v17 + 58200) = *(_BYTE *)(v15 + v49[0] + 91092);
        reg_init_indoor_channel_list(a2);
        reg_compute_indoor_list_on_cc_change(a1, a2);
        reg_update_channel_ranges(a2);
        reg_compute_pdev_current_chan_list(v17);
        v48 = *(void (__fastcall **)(_QWORD))(v21 + 152);
        if ( v48 )
        {
          if ( *((_DWORD *)v48 - 1) != -2099273483 )
            __break(0x8228u);
          v48(a2);
        }
        if ( *a3 )
