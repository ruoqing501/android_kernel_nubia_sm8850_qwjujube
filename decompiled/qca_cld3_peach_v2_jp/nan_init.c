__int64 __fastcall nan_init(double a1, double a2, double a3, double a4, double a5, double a6, double a7, double a8)
{
  ...
  if ( !handler )
  {
    ...
    if ( v18 )
    {
      ...
      qdf_trace_msg(
        0x53u,
        2u,
        "%s: wlan_objmgr_register_psoc_destroy_handler failed",
        v19,
        v20,
        v21,
        v22,
    ...
    else
    {
      ...
      if ( v35 )
      {
        ...
        qdf_trace_msg(
          0x53u,
          2u,
          "%s: wlan_objmgr_register_psoc_create_handler failed",
          v36,
          v37,
          v38,
          v39,
