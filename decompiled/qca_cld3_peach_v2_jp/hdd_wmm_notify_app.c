        ...
        double a9)
{
  ...
  __int64 v30; // x0
  __int64 v31; // x1
  _QWORD v32[8]; // [xsp+0h] [xbp-40h] BYREF

  v32[7] = *(_QWORD *)(_ReadStatusReg(SP_EL0) + 1808);
  ...
  v19 = a1[9];
  memset(v32, 0, 51);
  snprintf((char *)v32, 0x32u, "QCOM: TS change[%u: %u]", v18, v19);
  v20 = strnlen((const char *)v32, 0x33u);
  if ( v20 >= 0x34 )
  {
...
LABEL_6:
  ...
  return hdd_wmm_enable_inactivity_timer(v30, v31);
}
