__int64 __fastcall scm_disable_obss_pdev_scan(__int64 a1, __int64 a2)
{
  ...
  if ( result )
  {
    if ( *(_BYTE *)(result + 18741) == 1 )
    {
      ...
      {
        raw_spin_lock(a2 + 1240);
      }
      else
      {
        raw_spin_lock_bh(a2 + 1240);
        *(_QWORD *)(a2 + 1248) |= 1uLL;
      }
      v50[0] = 0;
        ...
        if ( v50[0] )
        {
          ...
          do
          {
            qdf_trace_msg(
              ...
              v22,
              v21);
            comp_private_obj = wlan_objmgr_vdev_get_comp_private_obj((__int64)v21, 3u);
            if ( comp_private_obj )
            {
              ...
              else
              {
                qdf_trace_msg(
                  ...
                  v30,
                  v31,
                  *((unsigned __int8 *)&dword_68 + (_QWORD)v21));
              }
            }
            else
            {
            ...
            v50[0] = 0;
            if ( (unsigned int)qdf_list_peek_next((_QWORD *)(a2 + 48), v21, v50) )
              break;
            v21 = (_QWORD *)v50[0];
            ++v22;
          }
      ...
      if ( (v41 & 1) != 0 )
      {
        *(_QWORD *)(a2 + 1248) = v41 & 0xFFFFFFFFFFFFFFFELL;
        result = raw_spin_unlock_bh(a2 + 1240);
      }
      else
      {
        result = raw_spin_unlock(a2 + 1240);
      }
    }
  }
  else
