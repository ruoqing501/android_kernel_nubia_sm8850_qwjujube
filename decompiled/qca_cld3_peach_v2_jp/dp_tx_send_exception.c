...
LABEL_51:
  ...
  if ( (*(_BYTE *)(a3 + 68) & 4) != 0 )
    ...
    v19 = 0;
  v20 = *(_QWORD *)(v17 + 24);
  *(_QWORD *)(v17 + 408) += (unsigned int)(*(_DWORD *)(a3 + 112) + v19);
...
LABEL_11:
    if ( (wlan_cfg_is_lapb_enabled(v21) & 1) != 0 )
    {
      ...
      if ( (*(_DWORD *)(a3 + 168) & 0xF000000) == 0xB000000 )
        LOBYTE(v23) = *(_BYTE *)(*(_QWORD *)(v23 + 8) + 7153LL) - 1;
      else
        LODWORD(v23) = *(unsigned __int16 *)(a3 + 124) % (*(unsigned __int8 *)(*(_QWORD *)(v23 + 8) + 7153LL) - 1);
    }
    else
    {
      LOWORD(v23) = (unsigned int)*(_WORD *)(a3 + 124)
                  % *(unsigned __int8 *)(*(_QWORD *)(*(_QWORD *)(v17 + 24) + 8LL) + 7153LL);
    }
    goto LABEL_17;
  }
...
LABEL_50:
  ...
  if ( v32 != 0xFFFF )
  {
    ...
    {
      raw_spin_lock(v33 + 13256);
    }
    else
    {
      raw_spin_lock_bh(v33 + 13256);
      *(_QWORD *)(v33 + 13264) |= 1uLL;
    }
    if ( *(_DWORD *)(v33 + 13276) > v32 )
    {
      v35 = *(_QWORD *)(*(_QWORD *)(v33 + 13088) + 8LL * v32);
      if ( !v35 )
        goto LABEL_45;
      if ( *(unsigned __int8 *)(v35 + 380) <= 2u )
      {
        v58 = *(_DWORD *)(v35 + 40);
        while ( v58 )
        {
    ...
    v35 = 0;
LABEL_45:
    v36 = *(_QWORD *)(v33 + 13264);
    if ( (v36 & 1) != 0 )
    {
      *(_QWORD *)(v33 + 13264) = v36 & 0xFFFFFFFFFFFFFFFELL;
      raw_spin_unlock_bh(v33 + 13256);
      if ( v35 )
        goto LABEL_47;
    }
    else
    {
      raw_spin_unlock(v33 + 13256);
      if ( v35 )
      {
LABEL_47:
    ...
    v16 = (unsigned int)(*(_DWORD *)(v17 + 772) + 1);
    *(_DWORD *)(v17 + 772) = v16;
    goto LABEL_51;
  }
LABEL_48:
...
LABEL_59:
        ...
        if ( v40 )
        {
          if ( (*(_BYTE *)(a3 + 68) & 4) != 0 )
            ...
            v41 = 0;
          *(_QWORD *)(v40 + 91328) += (unsigned int)(*(_DWORD *)(a3 + 112) + v41);
        }
      }
    }
    else
      ...
      if ( v16 )
      {
        ...
        if ( v16 )
        {
          if ( (*(_BYTE *)(a3 + 68) & 4) != 0 )
            ...
            v66 = 0;
          *(_QWORD *)(v16 + 91352) += (unsigned int)(*(_DWORD *)(a3 + 112) + v66);
        }
      }
      goto LABEL_51;
    }
    *(_QWORD *)(v17 + 400) += (unsigned int)(v78 - 1);
    goto LABEL_95;
  }
  if ( *(_DWORD *)(a3 + 116) )
  {
  ...
  if ( (a4[6] & 1) != 0 )
  {
    ...
    if ( (*(_BYTE *)(a3 + 68) & 4) != 0 )
      ...
      v42 = 0;
    *(_QWORD *)(v17 + 824) += (unsigned int)(*(_DWORD *)(a3 + 112) + v42);
    v43 = a4[7];
...
LABEL_106:
    ...
    if ( (*(_BYTE *)(a3 + 68) & 4) != 0 )
      ...
      v72 = 0;
    *(_QWORD *)(v17 + 568) += (unsigned int)(*(_DWORD *)(a3 + 112) + v72);
LABEL_95:
    a3 = dp_tx_send_msdu_multiple(v17, a3, (int *)&v77, v8, v9, v10, v11, v12, v13, v14, v15);
    goto LABEL_51;
  }
  ++*(_DWORD *)(v17 + 4LL * BYTE4(v77) + 424);
  ...
  if ( (a4[6] & 2) != 0 )
  {
    if ( *(_BYTE *)(v17 + 56) == 1 )
    {
      ...
      if ( (*(_BYTE *)(a3 + 68) & 4) != 0 )
        ...
        v73 = 0;
      *(_QWORD *)(v17 + 504) += (unsigned int)(*(_DWORD *)(a3 + 112) + v73);
    }
    v45 = v17;
