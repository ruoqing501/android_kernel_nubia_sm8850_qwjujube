        ...
        double a10)
{
  ...
  if ( (unsigned int)v10 < 6 )
  {
    ...
    if ( (_DWORD)v11 == 1 )
    {
      v18 = wlan_reg_freq_to_chan(*(_QWORD *)(a1 + 21560), *(_DWORD *)(a2 + 284), a3, a4, a5, a6, a7, a8, a9, a10);
      v19 = "%s: Updated SAP Filter for session %d channel %d";
      *(_BYTE *)(a1 + v10 + 21675) = v18;
      v20 = v18;
    ...
    v14 = *(unsigned __int8 *)(v16 + 1157);
    v11 = *(unsigned __int8 *)(v16 + 1194);
    v12 = "%s: sta %d sap %d";
    v13 = 8;
  }
  else
