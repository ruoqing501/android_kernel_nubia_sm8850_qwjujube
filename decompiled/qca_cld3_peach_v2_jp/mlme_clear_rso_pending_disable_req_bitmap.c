__int64 __fastcall mlme_clear_rso_pending_disable_req_bitmap(__int64 a1, __int64 a2)
{
  __int64 v2; // x0
  double v3; // d0
  double v4; // d1
  ...
  if ( !v2 )
    return qdf_trace_msg(
             ...
             v9,
             v10,
             "mlme_clear_rso_pending_disable_req_bitmap");
  v11 = v2;
  ...
  if ( ext_hdl )
    *(_BYTE *)(ext_hdl + 157) = 0;
    ...
    qdf_trace_msg(
      ...
      v21,
      "mlme_clear_rso_pending_disable_req_bitmap");
  return wlan_objmgr_vdev_release_ref(v11, 0x43u, v13, v14, v15, v16, v17, v18, v19, v20, v21);
}
