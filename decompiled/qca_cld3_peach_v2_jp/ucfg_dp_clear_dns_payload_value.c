void *__fastcall ucfg_dp_clear_dns_payload_value(
        __int64 a1,
        double a2,
        double a3,
        double a4,
        ...
        double a9)
{
  ...
  if ( a1 )
  {
    ...
    if ( comp_private_obj )
      return qdf_mem_set(
               (void *)(*(_QWORD *)(comp_private_obj + 32) + 3084LL),
               *(unsigned int *)(*(_QWORD *)(comp_private_obj + 32) + 3340LL),
               0);
  }
  else
  {
  ...
  return (void *)qdf_trace_msg(
                   ...
                   v16,
                   v17,
                   "ucfg_dp_clear_dns_payload_value");
}
