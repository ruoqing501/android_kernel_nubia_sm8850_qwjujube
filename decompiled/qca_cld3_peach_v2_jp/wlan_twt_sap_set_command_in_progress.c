        ...
        double a13)
{
  ...
  v27 = v18;
  v28 = wlan_vdev_peer_list_peek_active_head(v18, (_QWORD *)(v18 + 128), 0x5Eu);
  if ( !v28 )
  {
LABEL_19:
...
LABEL_12:
    next_active_peer_of_vdev = wlan_peer_get_next_active_peer_of_vdev(v27, (_QWORD *)(v27 + 128), v38, 0x5Eu);
