    ...
    *(_QWORD *)s = 0;
    do
    {
      ...
      if ( v12 == 55 )
        __break(0x5512u);
      v17 = &a3[v11];
      if ( a3[v11 + 26] == 3 && (wlan_is_sae_auth_log_present_for_bssid(v10, v17 + 5, v32) & 1) != 0 )
      {
        result = wlan_print_cached_sae_auth_logs(v10, v17 + 5, v32[0]);
      }
      else
      {
        qdf_mem_set(s, 0x18u, 0);
        mlme_get_converted_timestamp(*((_DWORD *)v17 + 3), s);
        if ( v17[16] != 3 )
        {
          v26 = jiffies;
          if ( cm_roam_print_frame_info___last_ticks - jiffies + 125 < 0 )
          {
            ...
            LODWORD(v31) = *((unsigned __int16 *)v13 + 12);
            LODWORD(v30) = *((unsigned __int16 *)v13 + 14);
            LODWORD(v29) = v16;
            LODWORD(v28) = v15;
            LODWORD(v27) = v14;
            qdf_trace_msg(
        ...
        result = cm_roam_mgmt_frame_event(a2, (__int64)(v17 + 4), a4, a5);
      }
      ++v12;
      v11 += 40;
    }
