...
LABEL_21:
  *v19 = v26;
LABEL_22:
  qdf_mem_copy((void *)(a2 + 836), (const void *)(a3 + 2508), 0x3Cu);
  if ( *(_BYTE *)(a3 + 2464) && *(_BYTE *)(a3 + 2484) )
    *(_WORD *)(a2 + 896) = *(_WORD *)(a3 + 2485);
...
LABEL_29:
  qdf_trace_msg(
    ...
    a13,
    "lim_update_stads_he_caps",
    *(unsigned __int16 *)(a2 + 896),
    *(unsigned __int16 *)(*(_QWORD *)(a1 + 8) + 1472LL),
    *(unsigned __int16 *)(*(_QWORD *)(a1 + 8) + 1474LL));
  return lim_update_he_mcs_12_13_map(*(_QWORD *)(a1 + 21552), *(unsigned __int8 *)(a4 + 10), *(_WORD *)(a2 + 896));
}
