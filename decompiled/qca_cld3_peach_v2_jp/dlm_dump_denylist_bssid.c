...
LABEL_6:
  ...
  if ( v34[0] )
  {
    do
    {
      ...
      v18 = v34[0];
      if ( (*(_BYTE *)(v34[0] + 104LL) & 4) != 0 )
      {
        v19 = 0;
      }
      else if ( (*(_BYTE *)(v34[0] + 104LL) & 1) != 0 )
      {
        v19 = 1;
      }
      else if ( (*(_BYTE *)(v34[0] + 104LL) & 8) != 0 )
      {
        v19 = 2;
      }
      else if ( (*(_BYTE *)(v34[0] + 104LL) & 2) != 0 )
      {
        v19 = 3;
      }
      else if ( (*(_BYTE *)(v34[0] + 104LL) & 0x10) != 0 )
      {
        v19 = 4;
      }
      else if ( (*(_BYTE *)(v34[0] + 104LL) & 0x20) != 0 )
      {
        v19 = 5;
      }
      else
      ...
      LODWORD(v32) = *(_DWORD *)(v18 + 44);
      LODWORD(v30) = *(char *)(v18 + 28);
