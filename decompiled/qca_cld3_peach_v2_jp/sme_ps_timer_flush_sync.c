__int64 __fastcall sme_ps_timer_flush_sync(_QWORD *a1, unsigned int a2)
{
  ...
  {
    v6 = sme_acquire_global_lock((__int64)(a1 + 1596));
    if ( v6 )
    {
      v15 = v6;
      qdf_trace_msg(
    ...
    {
      if ( (mlme_get_user_ps(a1[2694], a2) & 1) != 0 )
      {
        if ( cm_is_vdevid_active(a1[2695], a2) )
        {
          v24 = &a1[24 * (unsigned __int8)a2];
          if ( (unsigned int)qdf_mc_timer_get_current_state((__int64)(v24 + 1643)) == 21 )
          {
            qdf_trace_msg(
              0x34u,
              8u,
              ...
              "sme_ps_timer_flush_sync",
              v2);
            qdf_mc_timer_stop((__int64)(v24 + 1643));
