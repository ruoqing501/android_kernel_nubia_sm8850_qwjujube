                        ...
                        if ( !v1 )
                        {
                          ...
                          if ( !(_DWORD)v40 )
                          {
                            ...
                            if ( !v1 )
                            {
                              ...
                              if ( !(_DWORD)v49 )
                              {
                                v50 = ucfg_pre_cac_init();
                                v1 = v50;
                                if ( !(_DWORD)v50 )
                                {
                                  v50 = ucfg_dp_init(v51, v52, v53, v54, v55, v56, v57, v58);
                                  v1 = v50;
                                  if ( !(_DWORD)v50 )
                                  {
                                    v1 = ucfg_qmi_init();
                                    if ( !v1 )
                                    {
                                      v67 = ucfg_ll_sap_init();
                                      v1 = v67;
                                      if ( !(_DWORD)v67 )
                                      {
                                        v68 = ucfg_mgmt_rx_srng_init();
                                        if ( !v68 )
                                        {
                                        ...
                                        v1 = v68;
                                        v67 = ucfg_ll_sap_deinit();
                                      }
                                      v59 = ucfg_qmi_deinit(v67);
                                    }
                                    v50 = ucfg_dp_deinit(v59, v60, v61, v62, v63, v64, v65, v66);
                                  }
                                }
                                v69 = ucfg_pre_cac_deinit(v50);
                                v49 = ucfg_dlm_deinit(v69);
                              }
                              v41 = ucfg_tdls_deinit(v49);
                            }
                            v40 = policy_mgr_deinit(v41, v42, v43, v44, v45, v46, v47, v48);
                          }
