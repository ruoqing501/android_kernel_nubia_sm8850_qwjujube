...
LABEL_33:
          ...
          if ( !started )
          {
            ...
            *(_BYTE *)(v12 + 1808) = 0;
            ...
            hdd_lpass_notify_start(*(_QWORD *)(v12 + 52824));
            goto LABEL_47;
          }
          qdf_trace_msg(
            0x33u,
...
LABEL_220:
  ...
  ucfg_p2p_psoc_priv_set_sta_vdev_id(*a1, *(_BYTE *)(*(_QWORD *)(v192 + 52824) + 8LL));
  if ( (unsigned int)wlan_mlme_set_p2p_device_mac_addr(
                       *(_QWORD *)(*(_QWORD *)(v192 + 52824) + 32LL),
                       (int *)(v251 + 1617),
                       v308,
                       v309,
                       v310,
  ...
  *(_BYTE *)(*(_QWORD *)(v251 + 52824) + 8LL) = *(_BYTE *)(*(_QWORD *)(v192 + 52824) + 8LL);
