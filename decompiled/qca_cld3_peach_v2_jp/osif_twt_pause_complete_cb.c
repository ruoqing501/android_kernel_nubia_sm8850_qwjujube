__int64 __fastcall osif_twt_pause_complete_cb(__int64 a1, unsigned int *a2)
{
  unsigned int v3; // w20
  __int64 v4; // x0
  double v5; // d0
    ...
    if ( v13 )
    {
      ...
      if ( *v13 )
      {
        qdf_trace_msg(
          0x48u,
          8u,
          "%s: TWT: pause dialog_id:%d status:%d vdev_id:%d peer macaddr %02x:%02x:%02x:**:**:%02x",
          v5,
          v6,
          v7,
          v8,
...
LABEL_7:
            v27 = 2;
LABEL_8:
            qdf_trace_msg(0x48u, v27, v26, v18, v19, v20, v21, v22, v23, v24, v25, "osif_twt_pause_pack_resp_nlmsg");
            v36 = 16;
LABEL_20:
            qdf_trace_msg(
              0x48u,
          ...
          {
            v63[0] = a2[3];
            if ( (unsigned int)nla_put(v17, 5, 1, v63) )
            {
            ...
            {
              v26 = "%s: Failed to put QCA_WLAN_TWT_PAUSE status";
              goto LABEL_7;
            }
            if ( !(unsigned int)nla_put(v17, 15, 6, a2 + 1) )
            {
          ...
          qdf_trace_msg(0x48u, 2u, v58, v49, v50, v51, v52, v53, v54, v55, v56, "osif_twt_pause_pack_resp_nlmsg");
          v36 = 4;
          goto LABEL_20;
        }
        v37 = "%s: TWT: Alloc pause resp skb fail";
      }
      else
      {
    ...
    qdf_trace_msg(0x48u, 2u, v37, v5, v6, v7, v8, v9, v10, v11, v12, "osif_twt_pause_complete_cb");
    v36 = 16;
LABEL_21:
    wlan_objmgr_vdev_release_ref(v14, 0x5Eu, v38, v39, v40, v41, v42, v43, v44, v45, v46);
    goto LABEL_22;
  }
  qdf_trace_msg(0x48u, 2u, "%s: vdev is null", v5, v6, v7, v8, v9, v10, v11, v12, "osif_twt_pause_complete_cb");
  v36 = 16;
LABEL_22:
