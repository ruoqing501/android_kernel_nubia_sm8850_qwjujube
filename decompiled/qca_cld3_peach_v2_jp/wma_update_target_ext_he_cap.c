__int64 __fastcall wma_update_target_ext_he_cap(__int64 a1, _BYTE *a2)
{
  ...
  qdf_mem_set(a2 + 284, 0x3Cu, 0);
  qdf_mem_set(a2 + 344, 0x3Cu, 0);
  if ( !a1 )
    goto LABEL_34;
  v12 = *(_DWORD *)(a1 + 504);
  v13 = (_DWORD *)(a1 + 1072);
    ...
    do
    {
      ...
      if ( (v13[v16 / 4 + 6] & 1) != 0 )
      {
        ...
        qdf_trace_msg(
          ...
          (unsigned int)v17[33],
          (unsigned int)v17[34]);
        wma_convert_he_ppet(a2 + 232, v17 + 33);
      }
      if ( LOBYTE(v81[0]) )
      {
        wma_derive_ext_he_cap(v79, v81, 0);
        wma_derive_ext_he_cap(a2 + 284, v81, 0);
      }
      qdf_mem_set(v81, 0x3Cu, 0);
      v26 = v17[6];
      if ( (v26 & 2) != 0 )
      {
        ...
        wma_convert_he_ppet(a2 + 257, &v13[v16 / 4 + 43]);
      }
      if ( LOBYTE(v81[0]) )
      {
        v35 = (v26 >> 1) & 1;
        wma_derive_ext_he_cap(v79, v81, v35);
        wma_derive_ext_he_cap(a2 + 344, v81, v35);
      }
      v16 += 256LL;
    }
    while ( v15 != v16 );
  }
  qdf_mem_copy(a2 + 172, v79, 0x3Cu);
  wma_print_he_cap((__int64)(a2 + 172), v39, v40, v41, v42, v43, v44, v45, v46);
  qdf_trace_msg(0x36u, 8u, "%s: 5 GHz HE caps:", v47, v48, v49, v50, v51, v52, v53, v54, "wma_update_target_ext_he_cap");
  wma_print_he_cap((__int64)(a2 + 344), v55, v56, v57, v58, v59, v60, v61, v62);
  qdf_trace_msg(
    0x36u,
    8u,
    "%s: 2.4 GHz HE caps:",
    ...
    v70,
    "wma_update_target_ext_he_cap");
  result = wma_print_he_cap((__int64)(a2 + 284), v71, v72, v73, v74, v75, v76, v77, v78);
LABEL_37:
