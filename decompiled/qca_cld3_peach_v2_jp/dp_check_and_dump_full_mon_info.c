  ...
  if ( v32 )
  {
    ...
    if ( v251 )
    {
      ...
      if ( *((_DWORD *)v261 - 1) != -621572614 )
        __break(0x8228u);
      v261(v32, &v308);
      print_hex_dump(&unk_927457, "\tHAL_BUF_INFO: ", 0, 32, 4, &v308, 16, 0);
      if ( (v309 & 0xE0000) != 0
        || (v270 = *(_QWORD *)(*(_QWORD *)(v16 + 120 * (((unsigned __int64)(unsigned int)v309 >> 16) & 1) + 11912)
                             + 8LL * BYTE1(v309))
      ...
      {
        print_hex_dump(&unk_927457, "\tRX_DESC: ", 0, 32, 4, v270, 32, 0);
      }
    }
  }
  else
  ...
  if ( (_DWORD)v280 != *(_DWORD *)(v279 + 136) )
  {
    ...
    if ( v282 )
    {
      ...
      qdf_trace_msg(
        ...
        v302,
        LOWORD(v307[0]));
      result = print_hex_dump(&unk_927457, "\tDESC_INFO: ", 0, 32, 4, v307, 56, 0);
      goto LABEL_39;
    }
  }
LABEL_40:
