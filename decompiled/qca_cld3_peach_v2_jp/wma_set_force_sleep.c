        ...
        double a13)
{
  ...
  v35 = a3 != 0;
  v36 = a3 == 0;
  if ( (unsigned __int8)ucfg_pmo_get_max_ps_poll(context[2694]) )
  {
    max_ps_poll = ucfg_pmo_get_max_ps_poll(context[2694]);
    v36 = 0;
    v35 = 1;
  }
  else
...
LABEL_40:
  ...
  v126 = ((__int64 (__fastcall *)(_QWORD, _QWORD, __int64))wlan_objmgr_get_vdev_by_id_from_psoc)(context[2694], a2, 8);
  if ( !v126
    || (v135 = v126,
  ...
  {
    v147 = *a1;
    v148 = *(unsigned __int16 *)(context[1] + 3204LL);
