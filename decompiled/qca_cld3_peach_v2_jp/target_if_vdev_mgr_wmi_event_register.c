        ...
        double a9)
{
  ...
  if ( a1 )
  {
    ...
    if ( v9 && (v10 = *(_QWORD *)(v9 + 16)) != 0 )
    {
      ...
      v59 = wmi_unified_register_event_handler(v10, 260, target_if_vdev_mgr_csa_ie_received_handler, 2);
      if ( v59 )
        qdf_trace_msg(
          0x68u,
          2u,
          ...
          v67,
          "target_if_vdev_mgr_wmi_event_register");
      wmi_unified_register_event_handler(v10, 247, target_if_update_macaddr_conf_evt_handler, 2);
      return v59;
    }
    else
    {
