        ...
        double a9)
{
  ...
  if ( *(_DWORD *)(v19 + 16) == 3
    && *(_WORD *)(v19 + 160) == 2
    && (unsigned int)policy_mgr_mode_specific_connection_count(context[2694], 3, nullptr) >= 2 )
  {
    result = (__int64)_cds_get_context(53, (__int64)"sap_get_mac_context", v21, v22, v23, v24, v25, v26, v27, v28);
    if ( result )
    {
      v30 = *(unsigned int **)(result + 14816);
      if ( v30
        && *(_DWORD *)(result + 14824) == 3
        && *((_BYTE *)v30 + 1741) == 1
        && *(unsigned __int8 *)(a1 + 12) != *((unsigned __int8 *)v30 + 12)
        || (v30 = *(unsigned int **)(result + 14832)) != nullptr
        && *(_DWORD *)(result + 14840) == 3
        && *((_BYTE *)v30 + 1741) == 1
        && *(unsigned __int8 *)(a1 + 12) != *((unsigned __int8 *)v30 + 12)
        || (v30 = *(unsigned int **)(result + 14848)) != nullptr
        && *(_DWORD *)(result + 14856) == 3
        && *((_BYTE *)v30 + 1741) == 1
        && *(unsigned __int8 *)(a1 + 12) != *((unsigned __int8 *)v30 + 12)
        || (v30 = *(unsigned int **)(result + 14864)) != nullptr
        && *(_DWORD *)(result + 14872) == 3
        && *((_BYTE *)v30 + 1741) == 1
        && *(unsigned __int8 *)(a1 + 12) != *((unsigned __int8 *)v30 + 12)
        || (v30 = *(unsigned int **)(result + 14880)) != nullptr
        && *(_DWORD *)(result + 14888) == 3
        && *((_BYTE *)v30 + 1741) == 1
        && *(unsigned __int8 *)(a1 + 12) != *((unsigned __int8 *)v30 + 12)
        || (v30 = *(unsigned int **)(result + 14896)) != nullptr
        && *(_DWORD *)(result + 14904) == 3
        && *((_BYTE *)v30 + 1741) == 1
        && *(unsigned __int8 *)(a1 + 12) != *((unsigned __int8 *)v30 + 12) )
      {
        v31 = result;
...
LABEL_38:
  ...
  result = policy_mgr_fetch_existing_con_info(v20[2694], *(_BYTE *)(a1 + 12), *(_DWORD *)a1, &v33, &v35, &v34);
  if ( *(_DWORD *)(*(_QWORD *)(a1 + 16) + 16LL) == 3 )
  {
    result = policy_mgr_go_scc_enforced(v20[2694]);
    if ( (result & 1) != 0 )
    {
      result = policy_mgr_is_go_scc_strict(v20[2694]);
      if ( (result & 1) == 0 && *(_WORD *)(*(_QWORD *)(a1 + 16) + 160LL) == 2 && (v33 & 0xFFFFFFFD) == 0 )
        result = policy_mgr_process_forcescc_for_go(v20[2694], *(_BYTE *)(a1 + 12), v35, v34, v33);
    }
  }
LABEL_39:
