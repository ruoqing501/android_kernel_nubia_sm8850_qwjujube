void *__fastcall lim_add_he_cap(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( a4 && (*(_BYTE *)(a3 + 152) & 1) != 0 )
  {
    result = qdf_mem_copy((void *)(a3 + 156), (const void *)(a4 + 3372), 0x3Cu);
    if ( *(_BYTE *)(a2 + 8764) == 1 )
    {
      qdf_mem_copy((void *)(a3 + 234), (const void *)(a4 + 3432), 4u);
      v8 = *(unsigned __int16 *)(a3 + 235);
