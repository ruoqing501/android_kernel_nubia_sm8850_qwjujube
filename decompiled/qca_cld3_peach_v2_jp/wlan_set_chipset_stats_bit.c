        ...
        double a10)
{
  ...
  if ( (result & 1) != 0 )
  {
    if ( a2 )
    {
      ...
      __asm { PRFM            #0x11, [X8] }
      do
        v24 = __ldxr((unsigned __int64 *)&qword_76E1D0);
      while ( __stxr(v24 | 0x20, (unsigned __int64 *)&qword_76E1D0) );
      _X8 = &qword_76E1D0;
      __asm { PRFM            #0x11, [X8] }
      do
        v27 = __ldxr((unsigned __int64 *)&qword_76E1D0);
      while ( __stxr(v27 | 0x40, (unsigned __int64 *)&qword_76E1D0) );
    }
  }
  else
  {
