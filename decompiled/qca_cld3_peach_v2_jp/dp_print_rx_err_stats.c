        ...
        double a10)
{
  ...
  DP_PRINT_STATS("intra-bss EAPOL drops: %u", a3, a4, a5, a6, a7, a8, a9, a10, a1[3532]);
  DP_PRINT_STATS("mic errors %u", v12, v13, v14, v15, v16, v17, v18, v19, *(unsigned int *)(a2 + 5648));
  DP_PRINT_STATS(
  ...
  DP_PRINT_STATS(
    ...
    v50,
    v51,
    *(unsigned int *)(*(_QWORD *)(a2 + 8) + 13708LL));
  DP_PRINT_STATS(
    ...
    v58,
    v59,
    *(unsigned int *)(*(_QWORD *)(a2 + 8) + 13704LL));
  DP_PRINT_STATS(
    ...
    v66,
    v67,
    *(unsigned int *)(*(_QWORD *)(a2 + 8) + 13700LL));
  DP_PRINT_STATS("RX invalid cookie: %d", v68, v69, v70, v71, v72, v73, v74, v75, a1[3513]);
  DP_PRINT_STATS("RX stale cookie: %d", v76, v77, v78, v79, v80, v81, v82, v83, a1[3514]);
  DP_PRINT_STATS(
    ...
    v90,
    v91,
    *(unsigned int *)(*(_QWORD *)(a2 + 8) + 14060LL));
  DP_PRINT_STATS(
    ...
    v98,
    v99,
    *(unsigned int *)(*(_QWORD *)(a2 + 8) + 14064LL));
  DP_PRINT_STATS(
    "2k jump msdu drop: %u",
    v100,
    v101,
  ...
  DP_PRINT_STATS(
    ...
    v114,
    v115,
    *(unsigned int *)(*(_QWORD *)(a2 + 8) + 14084LL));
  DP_PRINT_STATS(
    ...
    v122,
    v123,
    *(unsigned int *)(*(_QWORD *)(a2 + 8) + 14080LL));
  DP_PRINT_STATS("Rx err msdu rejected: %d", v124, v125, v126, v127, v128, v129, v130, v131, a1[3523]);
  DP_PRINT_STATS("Rx raw frame dropped: %d", v132, v133, v134, v135, v136, v137, v138, v139, a1[3525]);
  DP_PRINT_STATS(
    ...
    v146,
    v147,
    *(unsigned int *)(*(_QWORD *)(a2 + 8) + 14104LL));
  DP_PRINT_STATS(
    ...
    v154,
    v155,
    *(unsigned int *)(*(_QWORD *)(a2 + 8) + 14108LL));
  DP_PRINT_STATS(
    ...
    v162,
    v163,
    *(unsigned int *)(*(_QWORD *)(a2 + 8) + 14112LL));
  DP_PRINT_STATS(
    ...
    v170,
    v171,
    *(unsigned int *)(*(_QWORD *)(a2 + 8) + 14012LL));
  DP_PRINT_STATS(
    ...
    v178,
    v179,
    *(unsigned int *)(*(_QWORD *)(a2 + 8) + 14016LL));
  DP_PRINT_STATS(
    ...
    v186,
    v187,
    *(unsigned int *)(*(_QWORD *)(a2 + 8) + 14020LL));
  DP_PRINT_STATS("PN-in-Dest error frame pn-check fail: %d", v188, v189, v190, v191, v192, v193, v194, v195, a1[3533]);
  DP_PRINT_STATS("Reo Statistics", v196, v197, v198, v199, v200, v201, v202, v203);
  DP_PRINT_STATS("near_full: %u ", v204, v205, v206, v207, v208, v209, v210, v211, a1[3410]);
  DP_PRINT_STATS(
    "rbm error: %u msdus",
    v212,
    v213,
    ...
    v218,
    v219,
    *(unsigned int *)(*(_QWORD *)(a2 + 8) + 13688LL));
  DP_PRINT_STATS(
    ...
    v226,
    v227,
    *(unsigned int *)(*(_QWORD *)(a2 + 8) + 13768LL));
  result = DP_PRINT_STATS(
             ...
             v234,
             v235,
             *(unsigned int *)(*(_QWORD *)(a2 + 8) + 13772LL));
  v245 = *(_DWORD **)(a2 + 8);
  if ( v245[3477] )
  {
