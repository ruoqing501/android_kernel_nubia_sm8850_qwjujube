...
LABEL_5:
    ...
    *((_DWORD *)v11 + 2) = v9;
    ...
    v46 = 331;
LABEL_45:
    printk(&unk_881311, "../vendor/qcom/opensource/wlan/qcacld-3.0/cmn/htc/htc_services.c", v46, "false");
    result = 27;
    goto LABEL_61;
  }
LABEL_17:
  credit_allocation = htc_get_credit_allocation((__int64)a1, v6);
  if ( !(_BYTE)credit_allocation && (dword_B0B4 & 8) != 0 )
  ...
  if ( !v31 )
  {
    printk(&unk_881311, "../vendor/qcom/opensource/wlan/qcacld-3.0/cmn/htc/htc_services.c", 141, "false");
    result = 2;
    goto LABEL_61;
  }
  v32 = *(_QWORD *)(v31 + 96);
...
LABEL_26:
    ...
    if ( v38 )
      goto LABEL_27;
LABEL_60:
    printk(&unk_881311, "../vendor/qcom/opensource/wlan/qcacld-3.0/cmn/htc/htc_services.c", 159, "0");
    result = 5;
    goto LABEL_61;
  }
  ...
  if ( !(_DWORD)result )
  {
    ...
    if ( !(_DWORD)result )
    {
      ...
      *(_BYTE *)(a3 + 20) = v43;
      ...
      if ( (unsigned int)*a2 - 261 >= 2 && (dword_B0B4 & 1) != 0 )
        qdf_trace_msg(
          56,
          2,
