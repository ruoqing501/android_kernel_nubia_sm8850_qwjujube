__int64 __fastcall wlan_ipa_send_to_userspace(char a1)
{
  ...
  {
    v7 = v5;
    if ( qdf_list_empty(&qword_864628) || dword_864E84 != 1 && (a1 & 1) == 0 )
      break;
    ...
    qdf_list_remove_front(&qword_864628, v49);
    if ( (qword_864648 & 1) != 0 )
    {
      qword_864648 &= ~1uLL;
...
LABEL_23:
            ...
            word_864E70 += v3;
LABEL_26:
            qdf_mem_set(&unk_864650, 0x800u, 0);
            v16 = (const char *)v49[0];
            v3 = 0;
            v2 = 0;
LABEL_27:
        ...
        v29[8] = 0;
        v29[9] = v2;
        qdf_mem_copy(v29 + 10, &unk_864650, (unsigned int)v2);
...
LABEL_47:
    ...
    v46[8] = 0;
    v46[9] = v2;
    qdf_mem_copy(v46 + 10, &unk_864650, (unsigned int)v2);
