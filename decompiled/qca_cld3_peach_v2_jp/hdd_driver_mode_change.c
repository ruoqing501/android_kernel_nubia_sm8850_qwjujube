        ...
        double a9)
{
  ...
  if ( !started )
  {
    ...
    {
      v98 = jiffies;
      if ( _hdd_driver_mode_change___last_ticks_902 - jiffies + 125 < 0 )
      {
        qdf_trace_msg(
          0x33u,
          2u,
          ...
          "__hdd_driver_mode_change");
        v46 = 0;
        _hdd_driver_mode_change___last_ticks_902 = v98;
        goto LABEL_13;
      }
LABEL_19:
      v46 = 0;
...
LABEL_37:
            curr_con_mode = a1;
            pld_set_mode(a1);
            qdf_event_reset((__int64)(v63 + 866));
            qdf_mutex_acquire((__int64)(v63 + 871));
            *((_BYTE *)v63 + 6924) = 1;
            qdf_mutex_release((__int64)(v63 + 871));
