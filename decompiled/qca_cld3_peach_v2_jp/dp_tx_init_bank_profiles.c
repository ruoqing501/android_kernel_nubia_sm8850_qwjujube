...
LABEL_19:
  ...
  *((_BYTE *)v2 + 1992) = v5;
  ...
  if ( v7 )
  {
    qdf_mutex_create((__int64)(a1 + 2810));
    if ( v6 )
    {
      v24 = 0;
      do
    ...
    qdf_trace_msg(
      ...
      *((unsigned __int8 *)v2 + 1992));
    if ( (wlan_cfg_is_ipa_enabled(a1[5]) & 1) != 0 )
    {
      v26 = wlan_cfg_pkt_type(a1[5]);
      v27 = *((unsigned __int8 *)v2 + 1992) - 1LL;
      *(_BYTE *)(a1[2818] + 12 * v27) = 1;
      *(_DWORD *)(a1[2818] + 12 * v27 + 8) = (2 * (v26 & 3)) | 0xC00;
      v28 = *(void (**)(void))(*(_QWORD *)(a1[141] + 74392LL) + 1808LL);
      if ( *((_DWORD *)v28 - 1) != -2046187666 )
        __break(0x8228u);
      v28();
      _X8 = (unsigned int *)(a1[2818] + 12 * v27 + 4);
      __asm { PRFM            #0x11, [X8] }
      do
        v46 = __ldxr(_X8);
      ...
      qdf_trace_msg(
        ...
        (unsigned int)v27,
        *(unsigned int *)(a1[2818] + 12LL * (int)v27 + 8));
    }
    else
    {
      LOBYTE(v27) = -1;
