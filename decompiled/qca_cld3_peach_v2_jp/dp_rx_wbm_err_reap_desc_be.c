  ...
  while ( 1 )
  {
    ...
    *(_DWORD *)(v7 + 120) = v23;
    ...
    if ( (v30[2] & 0x10000) != 0 )
      ...
      v31 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a2 + 22552) + 24LL * (v30[1] >> 21))
    ...
    if ( v31 )
    {
      if ( (*(_BYTE *)(v31 + 30) & 1) != 0 )
      {
        ...
        else
        {
          ...
          v42 = a2 + 12368 + 120LL * (unsigned int)v40;
...
LABEL_35:
          ...
          *(_BYTE *)(v31 + 30) |= 2u;
          ...
          if ( (v53 & 1) != 0 )
          {
            *(_QWORD *)(a2 + 18472) = v53 & 0xFFFFFFFFFFFFFFFELL;
          ...
          {
            v56 = v48;
            if ( *(_BYTE *)(a2 + 18718) != 1 || (dp_rx_is_sg_formation_required(&v92) & 1) == 0 )
            {
              v57 = v91;
              v58 = 0;
...
LABEL_48:
  ...
  if ( v18 )
  {
    _dp_rx_buffers_replenish(a2, 0, a2 + 80, a2 + 12368, v18, v94, &v93, 0, 0, "dp_rx_buffers_replenish_simple");
    *v82 += v18;
  }
LABEL_97:
