        ...
        double a12)
{
  ...
  _BYTE v63[4]; // [xsp+8h] [xbp-28h] BYREF
  unsigned __int8 v64[4]; // [xsp+Ch] [xbp-24h] BYREF
  _BYTE v65[4]; // [xsp+10h] [xbp-20h] BYREF
  _BYTE v66[4]; // [xsp+14h] [xbp-1Ch] BYREF
  int v67; // [xsp+18h] [xbp-18h] BYREF
  ...
  if ( (unsigned int)wlan_reg_get_chan_enum_for_freq(a2, a5, a6, a7, a8, a9, a10, a11, a12) < 0x66 )
  {
    ...
    v35 = *(_QWORD *)(v12 + 8);
    v67 = 9;
    wlan_reg_set_channel_params_for_pwrmode(v35, a2, 0, (__int64)&v67, 0, v27, v28, v29, v30, v31, v32, v33, v34);
    if ( v67 == 9 )
    {
...
LABEL_29:
      vdev_by_user = _hdd_objmgr_get_vdev_by_user(*(_QWORD *)(a1 + 52824), 6, "hdd_validate_channel_and_bandwidth");
      if ( !vdev_by_user )
      {
        result = 4294967274LL;
        goto LABEL_43;
      ...
      if ( *(_DWORD *)(a1 + 40) == 3 )
      {
        ...
        ucfg_p2p_get_ap_assist_dfs_params((__int64)v50, v66, v65, nullptr, 0, v64, v63);
        is_6ghz_op_class = wlan_reg_is_6ghz_op_class(*(_QWORD *)(v12 + 8), v64[0]);
        v61 = 0;
        if ( !is_6ghz_op_class )
          v61 = (unsigned int)wlan_reg_legacy_chan_to_freq(
                                *(_QWORD *)(v12 + 8),
                                ...
                                v60);
        vdev_by_user = (__int64)v50;
        if ( (v66[0] & 1) == 0 && v65[0] == 1 && ((_DWORD)v61 != operation_chan_freq || (_DWORD)v61 != a2) )
        {
          qdf_trace_msg(
            0x33u,
            8u,
