__int64 __fastcall save_ext_service_bitmap_tlv(__int64 a1, __int64 *a2, void *a3)
{
  ...
  v7 = *(void **)(v3 + 6344);
  if ( v7
    || (v7 = (void *)_qdf_mem_malloc(0x10u, "save_ext_service_bitmap_tlv", 13594), (*(_QWORD *)(v3 + 6344) = v7) != 0) )
  {
    ...
    qdf_trace_msg(
      ...
      **(unsigned int **)(v3 + 6344),
      *(unsigned int *)(*(_QWORD *)(v3 + 6344) + 4LL),
      *(unsigned int *)(*(_QWORD *)(v3 + 6344) + 8LL),
      *(unsigned int *)(*(_QWORD *)(v3 + 6344) + 12LL));
    if ( a3 )
      qdf_mem_copy(a3, *(const void **)(v3 + 6344), 0x10u);
    v24 = (const void *)a2[2];
    if ( !v24 )
    {
      qdf_trace_msg(
      ...
      if ( *((_DWORD *)a2 + 6) )
      {
        ...
        do
        {
          qdf_trace_msg(
            ...
            "save_ext_service_bitmap_tlv",
            (unsigned int)v35,
            *(unsigned int *)(*(_QWORD *)(v3 + 6360) + 4 * v35));
          ++v35;
        }
