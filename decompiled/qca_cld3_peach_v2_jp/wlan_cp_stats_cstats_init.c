__int64 __fastcall wlan_cp_stats_cstats_init(__int64 a1)
{
  ...
  {
    byte_85CAD0 = 1;
    qword_85CAB0 = wlan_cp_stats_get_user_delay_value_ms(a1);
    qword_85CAB8 = wlan_cp_stats_get_user_delay_interval(a1);
    v10 = nullptr;
    byte_85CAD1 = wlan_cp_stats_is_debug_logging_enabled(a1) & 1;
    v11 = 1;
    ...
    if ( (v15 & 1) == 0 )
    {
      ...
      if ( (v32 & 1) != 0 )
      {
        qword_85CA80 = v32 & 0xFFFFFFFFFFFFFFFELL;
