  ...
  if ( result )
  {
    ...
    if ( v17 )
      qdf_trace_msg(
        ...
        v17,
        v14);
    if ( (wlan_reg_is_6ghz_supported(*(_QWORD *)(a1 + 21552), v18, v19, v20, v21, v22, v23, v24, v25) & 1) == 0
      && wlan_reg_is_6ghz_op_class(*(_QWORD *)(a1 + 21560), BYTE1(*(_DWORD *)(v16 + 4))) )
    {
      qdf_trace_msg(
        0x35u,
        2u,
...
LABEL_9:
    ...
    _qdf_mem_free(v16);
    is_vdev_ll_lt_sap = policy_mgr_is_vdev_ll_lt_sap(*(_QWORD *)(a1 + 21552), *(unsigned __int8 *)(a3 + 10));
    v52 = *(_DWORD *)(a3 + 284);
      ...
      if ( v52 == v34 )
      {
        if ( (mlme_is_chan_switch_in_progress(*(_QWORD *)(a3 + 16), v44, v45, v46, v47, v48, v49, v50, v51) & 1) == 0 )
        {
          result = wlan_dcs_start_dcs(
                     *(_QWORD *)(a1 + 21552),
                     *(unsigned __int8 *)(*(_QWORD *)(a1 + 21560) + 40LL),
                     *(unsigned __int8 *)(a3 + 10),
                     2);
          goto LABEL_10;
        }
      ...
      result = qdf_trace_msg(
           ...
           || (result = wlan_reg_get_channel_state_for_pwrmode(
                          *(_QWORD *)(a1 + 21560),
                          ...
                          v51),
               (_DWORD)result != 3)
           && ((wlan_reg_is_dfs_for_freq(*(_QWORD *)(a1 + 21560), v34, v64, v65, v66, v67, v68, v69, v70, v71) & 1) == 0
            || (result = policy_mgr_concurrent_open_sessions_running(*(_QWORD *)(a1 + 21552)), (result & 1) != 0)) )
    {
      result = qdf_trace_msg(
                 0x35u,
                 2u,
