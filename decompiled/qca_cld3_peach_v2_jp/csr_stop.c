        ...
        double a9)
{
  ...
  if ( *(_BYTE *)(a1[1] + 6384LL) == 1 )
    ucfg_scan_unregister_event_handler(
      ...
      a8,
      a9);
  comp_private_obj = (_DWORD *)wlan_objmgr_psoc_get_comp_private_obj(a1[2694], 3u);
  if ( comp_private_obj )
  {
    *comp_private_obj |= 2u;
    qdf_trace_msg(
  ...
  if ( a1 )
  {
    ...
    {
      if ( *(_BYTE *)(v35 + 1) == 1 )
        ucfg_scan_flush_results(a1[2695], 0, v27, v28, v29, v30, v31, v32, v33, v34);
      v36 = a1[2153];
      if ( v36 )
      {
        if ( *(_BYTE *)(v36 + 97) == 1 )
