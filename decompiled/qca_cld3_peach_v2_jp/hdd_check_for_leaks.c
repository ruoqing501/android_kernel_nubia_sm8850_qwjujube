        ...
        double a9)
{
  ...
  if ( *result )
  {
    ...
    if ( v46 )
    {
      for ( i = 0; i != 109; ++i )
      {
        v48 = (unsigned int *)*(unsigned int *)(v46 + 4 * i + 172);
        if ( (int)v48 >= 1 )
    ...
    if ( v49 )
    {
      for ( j = 0; j != 109; ++j )
      {
        v51 = (unsigned int *)*(unsigned int *)(v49 + 4 * j + 172);
        if ( (int)v51 >= 1 )
    ...
    if ( v52 )
    {
      for ( k = 0; k != 109; ++k )
      {
        v54 = (unsigned int *)*(unsigned int *)(v52 + 4 * k + 172);
        if ( (int)v54 >= 1 )
    ...
    if ( v55 )
    {
      for ( m = 0; m != 109; ++m )
      {
        v57 = (unsigned int *)*(unsigned int *)(v55 + 4 * m + 172);
        if ( (int)v57 >= 1 )
    ...
    if ( v58 )
    {
      for ( n = 0; n != 109; ++n )
      {
        v60 = (unsigned int *)*(unsigned int *)(v58 + 4 * n + 172);
        if ( (int)v60 >= 1 )
    ...
    if ( v61 )
    {
      for ( ii = 0; ii != 109; ++ii )
      {
        v63 = (unsigned int *)*(unsigned int *)(v61 + 4 * ii + 172);
        if ( (int)v63 >= 1 )
