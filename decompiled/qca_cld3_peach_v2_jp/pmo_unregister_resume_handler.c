__int64 __fastcall pmo_unregister_resume_handler(
        unsigned int a1,
        __int64 a2,
        double a3,
        double a4,
        ...
        double a10)
{
  ...
  qdf_trace_msg(0x4Du, 8u, "%s: enter", a3, a4, a5, a6, a7, a8, a9, a10, "pmo_unregister_resume_handler");
...
LABEL_13:
  ...
  if ( *(_QWORD *)(v30 + 864 + 8LL * a1) != a2 )
  {
    ...
    qdf_trace_msg(
      0x4Du,
      2u,
      "%s: can't find resume handler for component id: %d ",
      v32,
      v33,
      v34,
      v35,
  ...
  v42 = 8LL * a1;
  *(_QWORD *)(v30 + 864 + v42) = 0;
  *(_QWORD *)(v30 + v42 + 1296) = 0;
  v43 = *(_QWORD *)(v30 + 1736);
  if ( (v43 & 1) != 0 )
  {
  ...
  v40 = 0;
LABEL_14:
  qdf_trace_msg(0x4Du, 8u, "%s: exit", v21, v22, v23, v24, v25, v26, v27, v28, "pmo_unregister_resume_handler");
  return v40;
}
