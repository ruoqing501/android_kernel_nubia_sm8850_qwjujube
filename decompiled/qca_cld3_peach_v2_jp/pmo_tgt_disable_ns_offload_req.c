__int64 __fastcall pmo_tgt_disable_ns_offload_req(
        __int64 a1,
        unsigned __int8 a2,
        double a3,
        double a4,
        ...
        double a10)
{
  ...
  qdf_trace_msg(0x4Du, 8u, "%s: enter", a3, a4, a5, a6, a7, a8, a9, a10, "pmo_tgt_disable_ns_offload_req");
  comp_private_obj = wlan_objmgr_vdev_get_comp_private_obj(a1, 4u);
  v13 = *(_QWORD *)(*(_QWORD *)(a1 + 152) + 80LL);
  v14 = _qdf_mem_malloc(0xCu, "pmo_tgt_disable_ns_offload_req", 113);
  if ( v14 )
  {
    v23 = (unsigned __int8 *)v14;
    v24 = _qdf_mem_malloc(0x28Cu, "pmo_tgt_disable_ns_offload_req", 119);
    if ( v24 )
    {
  ...
  qdf_trace_msg(0x4Du, 8u, "%s: exit", v15, v16, v17, v18, v19, v20, v21, v22, "pmo_tgt_disable_ns_offload_req");
  return v53;
}
