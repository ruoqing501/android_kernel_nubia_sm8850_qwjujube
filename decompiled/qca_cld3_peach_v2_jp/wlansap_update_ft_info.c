...
LABEL_7:
  ...
  v19 = context;
  if ( (unsigned int)qdf_wait_single_event(a1 + 1680, 0x1F4u) )
  {
    qdf_trace_msg(
      0x39u,
      2u,
...
LABEL_8:
  ...
  if ( (unsigned int)qdf_list_peek_front((_QWORD *)(a1 + 1656), &v60) )
  {
    qdf_trace_msg(
      0x39u,
      2u,
  ...
  else
  {
    while ( 1 )
    {
      ...
      if ( !(unsigned int)qdf_mem_cmp(a2, (const void *)(v60[2] + 5LL), 6u) )
        break;
      v46 = qdf_list_peek_next((_QWORD *)(a1 + 1656), v47, &v60);
      result = 0;
      if ( v46 )
        goto LABEL_9;
    }
    v48 = qdf_list_remove_node(a1 + 1656, v47);
    if ( v48 )
    {
      v57 = v48;
      qdf_trace_msg(
