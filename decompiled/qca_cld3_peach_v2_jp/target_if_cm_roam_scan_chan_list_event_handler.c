__int64 __fastcall target_if_cm_roam_scan_chan_list_event_handler(__int64 a1, __int64 a2, unsigned int a3)
{
...
LABEL_8:
  ...
  v17 = wmi_extract_roam_scan_chan_list(v15, a2, a3, &v39);
  if ( v17 )
  {
    qdf_trace_msg(
      0x49u,
...
LABEL_9:
  ...
  v37 = *(unsigned int (__fastcall **)(_QWORD))(ext_hdl + 7352);
  if ( !v37 )
  {
LABEL_19:
    qdf_trace_msg(
