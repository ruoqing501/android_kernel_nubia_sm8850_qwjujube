__int64 __fastcall csr_scan_get_result(__int64 a1, __int64 a2, __int64 *a3)
{
  ...
  if ( a3 )
    *a3 = 0;
  pdev_by_id = wlan_objmgr_get_pdev_by_id(*(_QWORD *)(a1 + 21552), 0, 7u);
  if ( pdev_by_id )
  {
    v15 = pdev_by_id;
      ...
      for ( i = v95; i; v95 = i )
      {
            ...
            & 0xFFFFFFFB) != 0 )
        {
          v64 = (_DWORD *)_qdf_mem_malloc(
                            (unsigned __int16)(*(_DWORD *)(v47 + 1704) + 68) + 200LL,
                            "csr_fill_bss_from_scan_entry",
                            826);
          if ( v64 )
          {
            v65 = (__int64)v64;
            if ( *(_DWORD *)(v47 + 1136) || *(_DWORD *)(v47 + 1140) || *(_DWORD *)(v47 + 1144) )
            {
              v66 = *(_DWORD *)(v47 + 1144);
              if ( v66 )
              {
              ...
              v64[5] = v67;
              csr_fill_auth_type(v64 + 6, *(_DWORD *)(v47 + 1136), *(_DWORD *)(v47 + 1140), *(_DWORD *)(v47 + 1144));
              ...
              qdf_trace_msg(
                ...
                *(unsigned int *)(v47 + 1136),
                *(unsigned int *)(v47 + 1140),
                *(unsigned int *)(v47 + 1144),
                *(unsigned int *)(v47 + 1148),
                v91,
                v92,
                v93);
            }
