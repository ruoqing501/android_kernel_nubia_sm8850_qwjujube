...
LABEL_19:
  ...
  else
  {
    ...
    *a3 = *(_BYTE *)(hash_entry + 338);
    a3[1] = *(_BYTE *)(hash_entry + 339);
    a3[2] = *(_BYTE *)(hash_entry + 340);
    a3[3] = *(_BYTE *)(hash_entry + 341);
    a3[4] = *(_BYTE *)(hash_entry + 342);
    a3[5] = *(_BYTE *)(hash_entry + 343);
  }
