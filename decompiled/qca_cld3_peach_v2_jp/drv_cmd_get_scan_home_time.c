__int64 __fastcall drv_cmd_get_scan_home_time(__int64 a1, __int64 *a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v7; // x0
  unsigned int v8; // w1
  unsigned __int16 neighbor_scan_period; // w0
  __int64 v10; // x4
  double v11; // d0
  double v12; // d1
  double v13; // d2
  ...
  memset(v44, 0, 32);
  neighbor_scan_period = ucfg_cm_get_neighbor_scan_period(v7, v8);
  v10 = *(unsigned __int8 *)(a1 + 8);
  LOWORD(a1) = neighbor_scan_period;
  qdf_trace_msg(
    0x33u,
    8u,
    "%s: vdev_id: %u, scan home time: %u",
    v11,
    v12,
    v13,
    v14,
    ...
    v17,
    v18,
    "drv_cmd_get_scan_home_time",
    v10,
    neighbor_scan_period);
  scnprintf(v44, 32, "%s %d", "GETSCANHOMETIME", (unsigned __int16)a1);
  v20 = *(_DWORD *)(a5 + 12);
  if ( v20 > v19 )
    LOBYTE(v20) = v19 + 1;
