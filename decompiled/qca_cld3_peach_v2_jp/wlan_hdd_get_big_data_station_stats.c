...
LABEL_8:
    ...
    {
      a1[1092] = *big_data_stats;
      a1[1093] = big_data_stats[1];
      a1[1094] = big_data_stats[2];
      a1[1095] = big_data_stats[3];
      a1[1096] = big_data_stats[4];
      a1[1097] = big_data_stats[5];
      a1[1098] = big_data_stats[6];
      a1[1099] = big_data_stats[7];
    }
