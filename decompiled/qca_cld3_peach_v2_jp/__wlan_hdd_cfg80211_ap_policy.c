__int64 __fastcall _wlan_hdd_cfg80211_ap_policy(__int64 a1, __int64 a2)
{
  ...
  v4 = *(_QWORD *)(*(_QWORD *)(a1 + 52824) + 32LL);
  v5 = *(unsigned __int8 *)(v4 + 104);
  result = hdd_get_device_mode(*(unsigned __int8 *)(v4 + 104));
  if ( (_DWORD)result == 1 )
  {
    v15 = *(_QWORD *)(a2 + 16);
    ...
    {
      v25 = jiffies;
      if ( _wlan_hdd_cfg80211_ap_policy___last_ticks_912 - jiffies + 125 < 0 )
      {
        result = qdf_trace_msg(
                   0x33u,
                   2u,
                   ...
                   "__wlan_hdd_cfg80211_ap_policy",
                   v16);
        _wlan_hdd_cfg80211_ap_policy___last_ticks_912 = v25;
      }
      return result;
    }
    ...
    if ( (unsigned int)wlan_mlme_get_ap_policy(
      ...
      || !(unsigned int)wlan_mlme_set_ap_policy(
                          *(_QWORD *)(*(_QWORD *)(a1 + 52824) + 32LL),
                          ...
                          v65) )
    {
      result = wlan_mlme_ll_lt_sap_send_oce_flags_fw(*(_QWORD *)(*(_QWORD *)(a1 + 52824) + 32LL));
      *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 52824) + 32LL) + 56LL) &= ~0x80000000;
      return result;
    }
