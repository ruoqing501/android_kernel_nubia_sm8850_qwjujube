__int64 __fastcall pmo_core_disable_hw_filter_in_fwr(
        __int64 a1,
        double a2,
        double a3,
        double a4,
        ...
        double a9)
{
  ...
  __int64 v43; // x0
  __int16 v45; // [xsp+0h] [xbp-10h] BYREF
  int v46; // [xsp+4h] [xbp-Ch]
  ...
  qdf_trace_msg(
    ...
    a8,
    a9,
    "pmo_core_disable_hw_filter_in_fwr",
    0,
...
LABEL_10:
    ...
    comp_private_obj = wlan_objmgr_psoc_get_comp_private_obj(*(_QWORD *)(*(_QWORD *)(a1 + 152) + 80LL), 4u);
...
LABEL_9:
        ...
        v43 = *(_QWORD *)(v41 + 80);
        v45 = v42;
        ref = pmo_tgt_conf_hw_filter(v43, &v45);
        goto LABEL_10;
      }
    }
    else
...
LABEL_11:
  qdf_trace_msg(0x4Du, 8u, "%s: exit", v19, v20, v21, v22, v23, v24, v25, v26, "pmo_core_disable_hw_filter_in_fwr");
