__int64 __fastcall sme_set_rssi_monitoring(
        __int64 a1,
        __int64 *a2,
        double a3,
        double a4,
        ...
        double a10)
{
  ...
  v34 = 0;
  v35 = 0;
  qdf_trace_msg(0x34u, 8u, "%s: enter", a3, a4, a5, a6, a7, a8, a9, a10, "sme_set_rssi_monitoring");
  v12 = _qdf_mem_malloc(0xCu, "sme_set_rssi_monitoring", 12353);
  if ( v12 )
  {
    v13 = *a2;
    v14 = v12;
    ...
    *(_QWORD *)v12 = v13;
    v15 = qdf_mutex_acquire(a1 + 12776);
    if ( v15 )
    {
      v24 = v15;
      qdf_trace_msg(
    ...
    else
    {
      ...
      v24 = scheduler_post_message_debug(
              ...
              0x3053u,
              (__int64)"sme_set_rssi_monitoring");
      if ( v24 )
      {
        qdf_trace_msg(
          0x34u,
