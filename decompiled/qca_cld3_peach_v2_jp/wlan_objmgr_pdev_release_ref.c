        ...
        double a11@<D7>)
{
  ...
  if ( *(_DWORD *)(v11 + 1224) != 6 )
    qdf_trace_msg(
      ...
      "wlan_objmgr_pdev_obj_destroy",
      v14);
  wlan_minidump_remove(v11, 1352, *(_QWORD *)(v11 + 80), 51, "wlan_objmgr_pdev");
  for ( i = 0; i != 54; ++i )
  {
    v24 = v11 + 4 * i;
    v25 = g_umac_glb_obj + 8 * i;
    v26 = *(__int64 (__fastcall **)(__int64, __int64))(v25 + 3496);
    if ( v26 && ((v27 = *(_DWORD *)(v24 + 1008), v28 = *(_QWORD *)(v25 + 3928), v27 == 40) || !v27) )
    {
      if ( *((_DWORD *)v26 - 1) != 223207110 )
        __break(0x8228u);
      *(_DWORD *)(v24 + 1008) = v26(v11, v28);
    }
    else
    {
      *(_DWORD *)(v24 + 1008) = 39;
  ...
  {
    raw_spin_lock(v11 + 1240);
  }
  else
  {
    raw_spin_lock_bh(v11 + 1240);
    *(_QWORD *)(v11 + 1248) |= 1uLL;
  }
  v38 = 0;
  v39 = 16;
  while ( 1 )
  {
    v40 = *(_DWORD *)(v11 + 4 * v38 + 1008);
    if ( v40 != 40 )
    {
      if ( v40 == 2 || v40 == 16 )
        goto LABEL_33;
...
LABEL_33:
  ...
  if ( (v41 & 1) != 0 )
  {
    *(_QWORD *)(v11 + 1248) = v41 & 0xFFFFFFFFFFFFFFFELL;
    result = raw_spin_unlock_bh(v11 + 1240);
    if ( v39 == 40 )
      goto LABEL_42;
LABEL_35:
    if ( v39 == 16 )
  ...
  result = raw_spin_unlock(v11 + 1240);
  if ( v39 != 40 )
    goto LABEL_35;
LABEL_42:
  *(_DWORD *)(v11 + 1224) = 4;
