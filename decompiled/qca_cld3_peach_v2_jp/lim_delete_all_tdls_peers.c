        ...
        double a10)
{
  ...
  double v38; // d6
  double v39; // d7
  bool is_vdev_roam_sync_inprogress; // w8
  __int64 result; // x0
  ...
  tgt_tdls_delete_all_peers_indication(*(_QWORD *)(v21 + 21552), *(unsigned __int8 *)(v31 + 10));
  is_vdev_roam_sync_inprogress = wlan_cm_is_vdev_roam_sync_inprogress(
                                   *(_QWORD *)(v31 + 16),
                                   v32,
                                   v33,
                                   v34,
                                   ...
                                   v39);
  result = 0;
  if ( a2 != 3 && !is_vdev_roam_sync_inprogress )
  {
    if ( *(_BYTE *)(v31 + 7260) == 1 )
      tgt_tdls_peers_deleted_notification(*(_QWORD *)(v21 + 21552), *(unsigned __int8 *)(v31 + 10));
    *(_BYTE *)(v31 + 7260) = 1;
    return 0;
  }
  return result;
