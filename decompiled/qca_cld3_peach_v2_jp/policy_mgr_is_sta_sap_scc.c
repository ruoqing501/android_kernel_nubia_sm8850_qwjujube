__int64 __fastcall policy_mgr_is_sta_sap_scc(__int64 a1, unsigned int a2, char a3)
{
  ...
  if ( context )
  {
    ...
    if ( BYTE4(qword_81C458) == 1
      ...
      || BYTE4(qword_81C47C) == 1 && ((unsigned int)qword_81C464 | 2) == 2 && HIDWORD(qword_81C464) == a2
      || BYTE4(qword_81C4A0) == 1 && ((unsigned int)qword_81C488 | 2) == 2 && HIDWORD(qword_81C488) == a2
      || BYTE4(qword_81C4C4) == 1 && ((unsigned int)qword_81C4AC | 2) == 2 && HIDWORD(qword_81C4AC) == a2
      || BYTE4(qword_81C4E8) == 1 && ((unsigned int)qword_81C4D0 | 2) == 2 && HIDWORD(qword_81C4D0) == a2 )
    {
    ...
    if ( (a3 & 1) != 0
      ...
      && (policy_mgr_if_freq_n_inactive_links_freq_same(a1) & 1) != 0 )
    {
      qdf_trace_msg(
        0x4Fu,
        8u,
