    ...
    else
    {
      if ( (dword_B0B4 & 1) != 0 )
        qdf_trace_msg(
          ...
          "free_htc_bundle_packet");
      printk(&unk_881311, "../vendor/qcom/opensource/wlan/qcacld-3.0/cmn/htc/htc_send.c", 307, "pQueueSave");
      if ( (_ReadStatusReg(DAIF) & 0x80) != 0 )
        goto LABEL_13;
    }
...
LABEL_13:
  ...
  result = printk(&unk_881311, "../vendor/qcom/opensource/wlan/qcacld-3.0/cmn/htc/htc_send.c", 279, "netbuf");
  if ( (dword_B0B4 & 1) != 0 )
