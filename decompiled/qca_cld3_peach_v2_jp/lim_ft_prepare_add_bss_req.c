        ...
        double a11)
{
  ...
  result = _qdf_mem_malloc(0xD80u, "lim_ft_prepare_add_bss_req", 133);
  if ( result )
  {
    v15 = result;
    v16 = _qdf_mem_malloc(0x138u, "lim_ft_prepare_add_bss_req", 138);
    if ( !v16 )
    ...
    *(_BYTE *)(v17 + 18) = (*v18 & 0x10) != 0;
    ...
    if ( ((unsigned int)(v30 - 7) < 7 || v30 == 5 || !*(_BYTE *)(a2 + 154)) && *(_BYTE *)(v15 + 1200) )
    {
      ...
      qdf_mem_copy((void *)(v17 + 154), (const void *)(v15 + 10), 2u);
      qdf_mem_copy((void *)(v17 + 156), (const void *)(v15 + 1201), 2u);
    }
    v32 = *(_DWORD *)(a2 + 7176);
...
LABEL_20:
    ...
    *(_BYTE *)(v17 + 28) = 1;
    qdf_mem_copy((void *)(v17 + 20), (const void *)(a3 + 2), 6u);
    v43 = *(_WORD *)(a3 + 16);
    *(_WORD *)(v17 + 26) = 0;
    *(_WORD *)(v17 + 39) = 0;
    *(_WORD *)(v17 + 36) = v43;
    ...
    *(_BYTE *)(v17 + 125) = (*v18 & 0x10) != 0;
    ...
    if ( ((unsigned int)(v44 - 7) < 7 || v44 == 5 || !*(_BYTE *)(a2 + 154)) && *(_BYTE *)(v15 + 1200) )
    {
      ...
      *(_DWORD *)(v17 + 48) = (*(unsigned __int16 *)v20 >> 2) & 3;
      *(_BYTE *)(v17 + 53) = (*(_BYTE *)(v15 + 1203) >> 2) & 7;
      *(_BYTE *)(v17 + 55) = (*v20 & 0x20) != 0;
      *(_BYTE *)(v17 + 54) = (*v20 & 0x40) != 0;
