__int64 __fastcall target_if_vdev_mgr_tbttoffset_update_handler(
        __int64 a1,
        __int64 a2,
        double a3,
        double a4,
...
LABEL_13:
  ...
  if ( (unsigned int)wmi_extract_tbttoffset_num_vdevs(v14, a2, &v20) )
  {
    v15 = "%s: WMI extract failed";
LABEL_15:
    qdf_trace_msg(0x68u, 2u, v15, a3, a4, a5, a6, a7, a8, a9, a10, "target_if_vdev_mgr_tbttoffset_update_handler");
    result = 4294967274LL;
    goto LABEL_16;
  }
  v17 = *(_DWORD **)(v12 + 1104);
  ...
  if ( *(v17 - 1) != -2129657465 )
    __break(0x8228u);
  v19 = ((__int64 (__fastcall *)(__int64, _QWORD))v17)(v18, 0);
