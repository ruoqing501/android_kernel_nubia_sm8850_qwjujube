__int64 __fastcall dp_soc_srng_alloc(__int64 a1)
{
  ...
  if ( (unsigned int)dp_srng_alloc((_QWORD *)a1, a1 + 7720, 0xCu, dp_soc_wbm_release_ring_size, 0) )
  {
...
LABEL_13:
  ...
  if ( (unsigned int)dp_srng_alloc((_QWORD *)a1, a1 + 6432, 2u, dp_soc_reo_reinject_ring_size, 0) )
  {
...
LABEL_12:
  ...
  if ( (unsigned int)dp_srng_alloc((_QWORD *)a1, a1 + 6672, 0xDu, dp_soc_rx_release_ring_size, 0) )
  {
    v12 = "%s: %pK: dp_srng_alloc failed for rx_rel_ring";
    goto LABEL_12;
  }
  dp_soc_reo_cmd_ring_size = wlan_cfg_get_dp_soc_reo_cmd_ring_size(v14);
  if ( (unsigned int)dp_srng_alloc((_QWORD *)a1, a1 + 6512, 3u, dp_soc_reo_cmd_ring_size, 0) )
  {
    v12 = "%s: %pK: dp_srng_alloc failed for reo_cmd_ring";
    goto LABEL_12;
  }
  dp_soc_reo_status_ring_size = wlan_cfg_get_dp_soc_reo_status_ring_size(v14);
  if ( (unsigned int)dp_srng_alloc((_QWORD *)a1, a1 + 6592, 4u, dp_soc_reo_status_ring_size, 0) )
  {
  ...
  if ( (unsigned int)dp_srng_alloc((_QWORD *)a1, a1 + 6352, 1u, dp_soc_reo_exception_ring_size, 0) )
  {
  ...
  if ( *(_BYTE *)(a1 + 7153) )
  {
    ...
    {
      if ( ++v21 >= *(unsigned __int8 *)(a1 + 7153) )
        goto LABEL_22;
    }
    goto LABEL_14;
  }
...
LABEL_14:
  ...
  if ( *(_BYTE *)(a1 + 12848) )
  {
    ...
    while ( 1 )
    {
      ...
      ++v25;
      v26 += 80;
      if ( v25 >= *(unsigned __int8 *)(a1 + 12848) )
        goto LABEL_29;
    }
    __break(0x5512u);
