  ...
  if ( (sta_sap_scc_allowed_on_indoor_chnl & 1) != 0 )
  {
    ...
    if ( v24 )
    {
      ...
      if ( !(_DWORD)pm_conc_connection_list
        ...
        && (v34 = &pm_conc_connection_list, BYTE4(qword_81C458) == 1)
        || !(_DWORD)qword_81C464
        && (wlan_reg_is_freq_indoor() & 1) != 0
        && (v34 = &qword_81C464, (qword_81C47C & 0x100000000LL) != 0)
        || !(_DWORD)qword_81C488
        && (wlan_reg_is_freq_indoor() & 1) != 0
        && (v34 = &qword_81C488, (qword_81C4A0 & 0x100000000LL) != 0)
        || !(_DWORD)qword_81C4AC
        && (wlan_reg_is_freq_indoor() & 1) != 0
        && (v34 = &qword_81C4AC, (qword_81C4C4 & 0x100000000LL) != 0)
        || !(_DWORD)qword_81C4D0
        && (wlan_reg_is_freq_indoor() & 1) != 0
        && (v34 = &qword_81C4D0, (qword_81C4E8 & 0x100000000LL) != 0) )
      {
        v63 = *((_DWORD *)v34 + 1);
      }
      else
