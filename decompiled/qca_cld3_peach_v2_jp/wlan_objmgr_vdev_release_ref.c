        ...
        double a11@<D7>)
{
  ...
  {
    v11 = result + 172;
    v12 = *(unsigned __int8 *)(result + 104);
    _X8 = (unsigned int *)(result + 172 + 4LL * a2);
    if ( !*_X8 )
    {
      qdf_trace_msg(
        0x57u,
  ...
  if ( !v58 )
  {
    ...
    {
      v14 = *(unsigned __int8 *)(result + 104);
      v15 = result;
      qdf_trace_msg(
        0x57u,
        8u,
      ...
      if ( *(_DWORD *)(v15 + 1264) == 6 )
      {
        ...
        if ( v24 )
          ...
          v25 = 0;
        wlan_minidump_remove(v15, 1344, v25, 56, "wlan_objmgr_vdev");
        v34 = v15;
        v35 = 1260;
        v36 = 6944;
        do
