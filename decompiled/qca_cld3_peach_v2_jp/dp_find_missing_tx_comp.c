...
LABEL_17:
    for ( i = 0; i != 6; ++i )
    {
      v24 = (unsigned __int16 *)(v9 + 2256 + 296 * i);
      v25 = v24[28];
          ...
          if ( v31 != -559038737 )
          {
            if ( v31 == -1412623820 )
            {
              ...
              if ( v32 )
              {
                ...
                {
                  v34 = jiffies;
                  if ( dp_tx_comp_delay_check___last_ticks_108 - jiffies + 125 < 0 )
                  {
                    ...
                    result = qdf_trace_msg(
                               ...
                               v35,
                               v36);
                    dp_tx_comp_delay_check___last_ticks_108 = v34;
                  }
                  v45 = jiffies;
                  ...
                  if ( *(unsigned __int8 *)(v30 + 48) == 255 )
                  {
                    *(_DWORD *)(v30 + 32) |= 0x2000u;
                    v46 = jiffies;
                    if ( dp_find_missing_tx_comp___last_ticks_60 - jiffies + 125 < 0 )
                    {
                      qdf_trace_msg(
                        0x45u,
                        2u,
                        ...
                        "dp_find_missing_tx_comp",
                        *(unsigned int *)(v30 + 36));
                      dp_find_missing_tx_comp___last_ticks_60 = v46;
                    }
            ...
            {
              v28 = jiffies;
              if ( dp_find_missing_tx_comp___last_ticks_62 - jiffies + 125 < 0 )
              {
                result = qdf_trace_msg(
                           0x45u,
                           2u,
                           ...
                           *(unsigned int *)(v30 + 36),
                           *(unsigned int *)(v30 + 32));
                dp_find_missing_tx_comp___last_ticks_62 = v28;
              }
            }
          }
          ++v27;
  ...
  while ( 1 )
  {
    ...
    if ( *(_BYTE *)(*(_QWORD *)(*(_QWORD *)(v9 + 40) + 776LL) + v11) != 15 )
    {
      ...
      if ( v17 != v18 )
      {
        v19 = *(_DWORD *)(v16 + 116);
        v20 = jiffies;
        if ( dp_check_pending_tx___last_ticks_104 - jiffies + 125 < 0 )
        {
          if ( v19 )
            v21 = v17;
          else
          ...
          result = qdf_trace_msg(
                     ...
                     v22,
                     v21);
          dp_check_pending_tx___last_ticks_104 = v20;
        }
        return result;
      }
    }
LABEL_3:
    ...
    v12 += 10;
    v11 += 4;
    if ( v10 >= *(unsigned __int8 *)(v9 + 7153) )
      goto LABEL_17;
  }
