        ...
        __int64 a18)
{
  ...
  double v144; // d6
  double v145; // d7
  __int64 v146; // [xsp+0h] [xbp-60h]
  __int64 v147; // [xsp+8h] [xbp-58h]
  _BYTE *v150; // [xsp+20h] [xbp-40h]
  _BYTE *v151; // [xsp+28h] [xbp-38h]
  size_t v152[3]; // [xsp+30h] [xbp-30h] BYREF
  _QWORD v153[3]; // [xsp+48h] [xbp-18h] BYREF

  v153[2] = *(_QWORD *)(_ReadStatusReg(SP_EL0) + 1808);
...
LABEL_120:
    qdf_trace_msg(0x35u, 2u, v32, a8, a9, a10, a11, a12, a13, a14, a15, "lim_populate_peer_rate_set", v146);
    result = 16;
    goto LABEL_121;
  }
LABEL_6:
  ...
  if ( v26 )
  {
    ...
    while ( v29 != 12 )
    {
      if ( *((unsigned __int8 *)v153 + v29 + 1) > 0xF9u )
        ++v30;
      v31 = v29 + v30;
      if ( (int)v29 + v30 < v26 )
      {
        if ( v31 > 0xB )
          goto LABEL_27;
        *((_BYTE *)v153 + v29 + 1) = *((_BYTE *)v153 + v31 + 1);
      }
      if ( v26 == ++v29 )
        goto LABEL_18;
    }
...
LABEL_18:
  ...
  if ( v27 )
  {
    ...
    while ( v33 != 12 )
    {
      if ( *((unsigned __int8 *)&v152[1] + v33 + 1) > 0xF9u )
        ++v34;
      v35 = v33 + v34;
      if ( (int)v33 + v34 < v27 )
      {
        if ( v35 > 0xB )
          break;
        *((_BYTE *)&v152[1] + v33 + 1) = *((_BYTE *)&v152[1] + v35 + 1);
      }
      if ( v27 == ++v33 )
        goto LABEL_29;
    }
...
LABEL_29:
  ...
  if ( v27 != (unsigned __int8)v34 )
  {
    if ( (((_BYTE)v27 - (_BYTE)v34) & 0xFE) != 0 )
      ...
      v37 = 1;
    memcpy((char *)v153 + v18 + 1, (char *)&v152[1] + 1, v37);
  }
  LOBYTE(v153[0]) = v36 + v18;
  v150 = a2;
  ...
  if ( LOBYTE(v153[0]) )
  {
    ...
    while ( 1 )
    {
      ...
      {
        v51 = BYTE1(v153[0]) & 0x7F;
        v52 = BYTE2(v153[0]) & 0x7F;
        v50 = v51 > v52;
        if ( v51 < v52 )
          v52 = BYTE1(v153[0]) & 0x7F;
        if ( v46 != 2 )
        {
          v53 = BYTE3(v153[0]) & 0x7F;
          v54 = v52 > v53;
          if ( v52 >= v53 )
            v52 = BYTE3(v153[0]) & 0x7F;
          if ( v54 )
            v50 = 2;
          if ( v46 != 3 )
          {
            v55 = BYTE4(v153[0]) & 0x7F;
            v56 = v52 > v55;
            if ( v52 >= v55 )
              v52 = BYTE4(v153[0]) & 0x7F;
            if ( v56 )
              v50 = 3;
            if ( v46 != 4 )
            {
              v57 = BYTE5(v153[0]) & 0x7F;
              v58 = v52 > v57;
              if ( v52 >= v57 )
                v52 = BYTE5(v153[0]) & 0x7F;
              if ( v58 )
                v50 = 4;
              if ( v46 != 5 )
              {
                v59 = BYTE6(v153[0]) & 0x7F;
                v60 = v52 > v59;
                if ( v52 >= v59 )
                  v52 = BYTE6(v153[0]) & 0x7F;
                if ( v60 )
                  v50 = 5;
                if ( v46 != 6 )
                {
                  v61 = HIBYTE(v153[0]) & 0x7F;
                  v62 = v52 > v61;
                  if ( v52 >= v61 )
                    v52 = HIBYTE(v153[0]) & 0x7F;
                  if ( v62 )
                    v50 = 6;
                  if ( v46 != 7 )
                  {
                    ...
                    if ( v46 != 8 )
                    {
                      v65 = BYTE1(v153[1]) & 0x7F;
                      v66 = v52 > v65;
                      if ( v52 >= v65 )
                        v52 = BYTE1(v153[1]) & 0x7F;
                      if ( v66 )
                        v50 = 8;
                      if ( v46 != 9 )
                      {
                        v67 = BYTE2(v153[1]) & 0x7F;
                        v68 = v52 > v67;
                        if ( v52 >= v67 )
                          v52 = BYTE2(v153[1]) & 0x7F;
                        if ( v68 )
                          v50 = 9;
                        if ( v46 != 10 )
                        {
                          v69 = BYTE3(v153[1]) & 0x7F;
                          v70 = v52 > v69;
                          if ( v52 >= v69 )
                            v52 = BYTE3(v153[1]) & 0x7F;
                          if ( v70 )
                            v50 = 10;
                          if ( v46 != 11 )
                          {
                            if ( v52 > (BYTE4(v153[1]) & 0x7Fu) )
                              v50 = 11;
                            if ( v46 < 0xC )
                              __break(1u);
                          }
      ...
      {
        v71 = v50;
        if ( (*((char *)v153 + v50 + 1) & 0x80000000) == 0 )
        {
          qdf_trace_msg(
            0x35u,
            8u,
        ...
        v72 = *((unsigned __int8 *)v153 + v50 + 1);
      }
      else
      {
        v71 = v50;
...
LABEL_103:
      ...
      if ( v48 && *(unsigned __int16 *)&v151[2 * v48 - 2] == (_DWORD)v72 )
      {
        v74 = "%s: Duplicate 11a rate: %d";
        goto LABEL_114;
      }
      *(_WORD *)&v151[2 * v48++] = v72;
LABEL_115:
      *((_BYTE *)v153 + v71 + 1) = -1;
      ++v49;
      v46 = LOBYTE(v153[0]);
      if ( v49 >= LOBYTE(v153[0]) )
        goto LABEL_116;
    }
    if ( ((1LL << v73) & 0x400814) != 0 )
    {
      if ( v47 >= 4 )
      {
        ...
        v72 = v47;
LABEL_114:
        qdf_trace_msg(0x35u, 8u, v74, v38, v39, v40, v41, v42, v43, v44, v45, "lim_populate_peer_rate_set", v72, v146);
        goto LABEL_115;
      }
...
LABEL_116:
  ...
  if ( ((unsigned int)(v76 - 7) < 7 || v76 == 5 || !*(_BYTE *)(a5 + 154)) && (*(_BYTE *)(a5 + 8764) & 1) == 0 )
  {
    ...
    v78 = a2 + 24;
    v152[0] = 16;
    if ( (unsigned int)wlan_mlme_get_cfg_str(a2 + 24, v77 + 2856, v152, v38, v39, v40, v41, v42, v43, v44, v45) )
    {
    ...
    lim_dump_ht_mcs_mask(nullptr, a2 + 24);
    if ( !*v78 )
    {
      qdf_trace_msg(
        0x35u,
    ...
    *(_BYTE *)(a5 + 8653) = a2[25] == 0;
  }
  lim_populate_vht_mcs_set(v147, a2, v146, a5, *(_BYTE *)(a5 + 8635), a17);
  v124 = a7;
  v125 = nullptr;
  if ( a7 && (*(_BYTE *)(a5 + 8676) & 1) != 0 )
  {
    if ( *a7 )
    {
      ...
      if ( *(_DWORD *)(a5 + 7176) == 3 && (a7[7] & 0x10) == 0 )
      {
        qdf_trace_msg(
          0x35u,
          2u,
...
LABEL_144:
        ...
        v128 = _qdf_mem_malloc(0xD80u, "lim_populate_peer_rate_set", 1791);
        if ( !v128 )
        {
          result = 2;
          goto LABEL_121;
        ...
        qdf_mem_set(v125, 0xD80u, 0);
        if ( ielen_from_bss_description && (unsigned int)sir_parse_beacon_ie(v147, (int)v125) )
          qdf_trace_msg(
            0x35u,
            2u,
...
LABEL_151:
  lim_populate_he_mcs_set(v147, v150, v124, a5, *(unsigned __int8 *)(a5 + 8635));
