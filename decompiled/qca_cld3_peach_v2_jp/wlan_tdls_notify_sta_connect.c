__int64 __fastcall wlan_tdls_notify_sta_connect(
        char a1,
        char a2,
        char a3,
        __int64 a4,
...
LABEL_5:
    v17 = "wlan_tdls_notify_sta_connect";
    v18 = 2;
    goto LABEL_6;
  }
  v36 = 0;
  ...
  v32 = 0;
  v33 = 0;
  qdf_trace_msg(0, 8u, "%s: Enter ", a5, a6, a7, a8, a9, a10, a11, a12, "tdls_notify_connect");
  v20 = _qdf_mem_malloc(0x10u, "tdls_notify_connect", 460);
  if ( !v20 )
  {
