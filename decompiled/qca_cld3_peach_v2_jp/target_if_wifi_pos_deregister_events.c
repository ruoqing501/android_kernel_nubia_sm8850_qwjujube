        ...
        double a9)
{
  ...
  if ( a1 && (v9 = *(_QWORD *)(a1 + 2800)) != 0 && (v11 = *(_QWORD **)(v9 + 16)) != nullptr )
  {
    ...
    {
      wmi_unified_unregister_event_handler(v52, 0xFCu, v43, v44, v45, v46, v47, v48, v49, v50);
      v61 = *(_QWORD *)(a1 + 2800);
      if ( v61 )
        v62 = *(_QWORD **)(v61 + 16);
      else
        v62 = nullptr;
      wmi_unified_unregister_event_handler(v62, 0xFDu, v53, v54, v55, v56, v57, v58, v59, v60);
    }
    else
    {
      qdf_trace_msg(
