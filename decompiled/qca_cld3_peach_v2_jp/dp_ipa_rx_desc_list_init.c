        ...
        double a9)
{
  ...
  if ( v9 >= 5 )
    __break(0x5512u);
  v11 = *(unsigned __int16 *)(v10 + 17864);
  v12 = 64 - v11;
  *(_BYTE *)(v10 + 20046) = 1;
  qdf_trace_msg(
    0x45u,
  ...
  free_desc_list = dp_rx_get_free_desc_list(
                     v10,
                     (unsigned int)v9,
                     v10 + 120LL * (unsigned int)v9 + 12368,
                     v12,
                     v36,
                     &v35);
  ...
  {
    raw_spin_lock_bh(v10 + 17848);
    *(_QWORD *)(v10 + 17856) |= 1uLL;
    v23 = (__int64 *)v36[0];
    if ( !v36[0] )
      goto LABEL_6;
  }
  do
  {
    ...
    *v23 = *(_QWORD *)(v10 + 17832);
    v33 = *(_QWORD *)(v10 + 17840);
    *(_QWORD *)(v10 + 17832) = v23;
    if ( !v33 || !*v23 )
      *(_QWORD *)(v10 + 17840) = v23;
    ++*(_WORD *)(v10 + 17864);
    v23 = v32;
    v36[0] = v32;
  }
...
LABEL_6:
  ...
  wlan_ipa_log_message(
    ...
    v28,
    v34);
  v29 = *(_QWORD *)(v10 + 17856);
  if ( (v29 & 1) != 0 )
  {
    *(_QWORD *)(v10 + 17856) = v29 & 0xFFFFFFFFFFFFFFFELL;
    result = raw_spin_unlock_bh(v10 + 17848);
  }
  else
  {
    result = raw_spin_unlock(v10 + 17848);
  }
