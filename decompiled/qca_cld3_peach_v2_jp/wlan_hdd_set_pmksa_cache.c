        ...
        double a10)
{
  ...
  if ( (unsigned int)_wlan_hdd_validate_context(*(_QWORD *)(a1 + 24), "wlan_hdd_set_pmksa_cache") )
    return 4;
  v13 = *(_QWORD *)(v10 + 16);
  vdev_by_user = _hdd_objmgr_get_vdev_by_user(*(_QWORD *)(a1 + 52824), 6, "wlan_hdd_set_pmksa_cache");
  if ( !vdev_by_user )
    return 16;
  v15 = vdev_by_user;
  ...
  if ( v16 )
  {
    ...
    *(_BYTE *)(v17 + 128) = *((_BYTE *)a2 + 128);
    ...
    {
      sme_roam_set_psk_pmk(v13, v17, *(unsigned __int8 *)(*(_QWORD *)(a1 + 52824) + 8LL), 0);
      sme_set_pmk_cache_ft(v13, *(unsigned __int8 *)(*(_QWORD *)(a1 + 52824) + 8LL), a2);
    }
