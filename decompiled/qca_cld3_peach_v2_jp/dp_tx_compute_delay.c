__int64 __fastcall dp_tx_compute_delay(__int64 result, __int64 a2, unsigned int a3, unsigned int a4)
{
  ...
  if ( (*(_BYTE *)(*(_QWORD *)(result + 24) + 95042LL) & 1) == 0 )
  {
    if ( !*(_BYTE *)(result + 45317) )
      return result;
    goto LABEL_5;
  }
  if ( *(_BYTE *)(result + 45317) )
...
LABEL_5:
    ...
    if ( (unsigned __int8)a3 <= 9u && (unsigned __int8)a4 < 5u )
      return dp_update_delay_stats(
               v6 + 6768LL * (unsigned __int8)a4 + 752LL * (unsigned __int8)a3 + 8584,
               nullptr,
...
LABEL_12:
  ...
  if ( (unsigned __int64)(v26 + 999999) >= 0x1E847F )
  {
    if ( (unsigned __int8)a3 <= 9u && (unsigned __int8)a4 < 5u )
    {
      ...
      v31 = v30 - *(_DWORD *)(v27 + 376);
      dp_update_delay_stats(v28 + 8584, nullptr, v29 - v30, v32, v33, v34, v35, v36, v37, v38, v39, a3, 0, a4, 0);
      result = dp_update_delay_stats(v28 + 8584, nullptr, v31, v40, v41, v42, v43, v44, v45, v46, v47, a3, 1u, a4, 0);
      *(_QWORD *)(v27 + 376) = v30;
      return result;
    }
    goto LABEL_12;
