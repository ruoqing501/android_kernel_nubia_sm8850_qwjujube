...
LABEL_6:
  ...
  v82 = (_DWORD *)(*((_QWORD *)a1 + 11945) + 18528LL * (a2 & 3));
  ...
  while ( 1 )
  {
    ...
    if ( *(_BYTE *)(*(_QWORD *)(v27 + 40) + 633LL) == 1 )
      break;
    v30 = a4;
    if ( v28 >= *(unsigned __int16 *)(v27 + 1866) )
      goto LABEL_59;
    v32 = (_QWORD *)(v27 + 1872);
LABEL_16:
    ...
    if ( v86 )
    {
      ...
      do
      {
        ...
        if ( *(_BYTE *)(*(_QWORD *)(v6 + 40) + 633LL) == 1 )
        {
          if ( (v38 & 0xF0000) == 0 )
          {
            v39 = *(_QWORD *)(*(_QWORD *)(v6 + 11432) + 8LL * (unsigned __int8)BYTE1(*(_DWORD *)((char *)v91 + v36)))
                + (unsigned __int8)*(_DWORD *)((char *)v91 + v36) * (unsigned int)*(unsigned __int16 *)(v6 + 11412);
            if ( v39 )
              goto LABEL_29;
          }
        }
