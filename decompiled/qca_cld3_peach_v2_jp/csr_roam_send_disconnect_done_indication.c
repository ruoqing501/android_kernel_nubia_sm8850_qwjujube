__int64 __fastcall csr_roam_send_disconnect_done_indication(__int64 a1, __int64 a2)
{
  ...
  if ( result )
  {
    ...
    qdf_trace_msg(
      ...
      *(_DWORD *)(a2 + 8));
    if ( a1 && v3 <= 5 && (v23 = *(_QWORD *)(a1 + 17224)) != 0 && *(_BYTE *)(v23 + 96LL * v3 + 1) == 1 )
    {
      v24 = *(_DWORD *)(a2 + 8);
      *(_DWORD *)(v14 + 32) = 520;
      *(_DWORD *)(v14 + 36) = v24;
      qdf_mem_copy((void *)(v14 + 23), (const void *)(a2 + 12), 6u);
      *(_DWORD *)(v14 + 304) = *(_DWORD *)(a1 + 21600);
      *(_DWORD *)(v14 + 308) = *(_DWORD *)(a1 + 21604);
      *(_DWORD *)(v14 + 312) = *(_DWORD *)(a1 + 21608);
      *(_BYTE *)(v14 + 40) = *(_DWORD *)(a2 + 8);
      *(_DWORD *)(v14 + 320) = *(_DWORD *)(a1 + 21616);
      *(_DWORD *)(v14 + 324) = *(_DWORD *)(a1 + 21612);
      v25 = *(_QWORD *)(a1 + 17224);
      if ( v25 && (*(_BYTE *)(v25 + 96LL * v3 + 1) & 1) != 0 )
      {
        wlan_get_operation_chan_freq_vdev_id(*(_QWORD *)(a1 + 21560), v3);
        v26 = *(_DWORD **)(a1 + 21968);
        if ( v26 )
        {
          v27 = *(_QWORD *)(a1 + 21552);
