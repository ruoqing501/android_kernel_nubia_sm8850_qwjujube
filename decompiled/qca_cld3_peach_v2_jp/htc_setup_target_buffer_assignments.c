...
LABEL_12:
  if ( *(_WORD *)(v2 + 3416) && (dword_B0B4 & 4) != 0 )
  ...
  if ( *(_WORD *)(v2 + 3420) && (dword_B0B4 & 4) != 0 )
    result = qdf_trace_msg(
               56,
               2,
               "%s: SVS Index : %d TX : 0x%2.2X : alloc:%d",
  ...
  if ( *(_WORD *)(v2 + 3424) && (dword_B0B4 & 4) != 0 )
    result = qdf_trace_msg(
               56,
               2,
               "%s: SVS Index : %d TX : 0x%2.2X : alloc:%d",
  ...
  if ( *(_WORD *)(v2 + 3428) && (dword_B0B4 & 4) != 0 )
    result = qdf_trace_msg(
               56,
               2,
               "%s: SVS Index : %d TX : 0x%2.2X : alloc:%d",
  ...
  if ( *(_WORD *)(v2 + 3432) && (dword_B0B4 & 4) != 0 )
    result = qdf_trace_msg(
               56,
               2,
               "%s: SVS Index : %d TX : 0x%2.2X : alloc:%d",
  ...
  if ( *(_WORD *)(v2 + 3436) && (dword_B0B4 & 4) != 0 )
    result = qdf_trace_msg(
               56,
               2,
               "%s: SVS Index : %d TX : 0x%2.2X : alloc:%d",
  ...
  if ( *(_WORD *)(v2 + 3440) && (dword_B0B4 & 4) != 0 )
    result = qdf_trace_msg(
               56,
               2,
               "%s: SVS Index : %d TX : 0x%2.2X : alloc:%d",
