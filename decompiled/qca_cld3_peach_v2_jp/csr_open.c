__int64 __fastcall csr_open(__int64 a1)
{
  ...
  v3 = *(_DWORD *)(v2 + 788);
  *(_QWORD *)(a1 + 17224) = &csr_roam_roam_session;
  if ( v3 )
  {
    v4 = mac_trace_getcsr_roam_state(0);
    v5 = mac_trace_getcsr_roam_state(*(_DWORD *)(v2 + 788));
  ...
  if ( *(_DWORD *)(v2 + 792) )
  {
    ...
    v15 = mac_trace_getcsr_roam_state(*(_DWORD *)(v2 + 792));
  ...
  if ( *(_DWORD *)(v2 + 796) )
  {
    ...
    v25 = mac_trace_getcsr_roam_state(*(_DWORD *)(v2 + 796));
  ...
  if ( *(_DWORD *)(v2 + 800) )
  {
    ...
    v35 = mac_trace_getcsr_roam_state(*(_DWORD *)(v2 + 800));
  ...
  if ( *(_DWORD *)(v2 + 804) )
  {
    ...
    v45 = mac_trace_getcsr_roam_state(*(_DWORD *)(v2 + 804));
  ...
  *(_DWORD *)(v2 + 768) = 2;
  ...
  if ( !(_DWORD)result )
  {
    if ( a1 )
    {
      v65 = qdf_mc_timer_init(a1 + 17232, 0, (__int64)csr_packetdump_timer_handler, a1);
      if ( v65 )
      {
        v74 = v65;
        qdf_trace_msg(
      ...
      else
      {
        ...
        *(_DWORD *)(v2 + 1016) = 0;
        ...
        {
          v85 = psoc_ext_obj_fl;
          qdf_mc_timer_init(psoc_ext_obj_fl + 7440, 0, (__int64)csr_disconnect_stats_timer_cb, a1);
          *(_DWORD *)(v85 + 7436) = 0;
        }
        else
        {
