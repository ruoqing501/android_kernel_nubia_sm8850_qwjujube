        ...
        double a11)
{
  ...
  if ( a3 )
  {
    ...
    if ( (_DWORD)result )
      return result;
    wlan_hdd_stop_sap(*(_QWORD *)(v22 + 52824), v33, v34, v35, v36, v37, v38, v39, v40);
...
LABEL_14:
  ...
  v54 = adapter;
  ucfg_pre_cac_complete_set(*(_QWORD *)(*(_QWORD *)(adapter + 52824) + 32LL), 1, v41, v42, v43, v44, v45, v46, v47, v48);
  wlan_hdd_set_sap_csa_reason(*v51, *(_BYTE *)(*(_QWORD *)(v54 + 52824) + 8LL), 4u);
  freq = ucfg_pre_cac_get_freq(*(_QWORD *)(*(_QWORD *)(v54 + 52824) + 32LL));
  if ( (unsigned int)hdd_softap_set_channel_change(*(__int64 **)(v54 + 52824), freq, 0, chan_width, 0, 0) )
  {
    qdf_trace_msg(
      0x33u,
      2u,
    ...
    ucfg_pre_cac_complete_set(*(_QWORD *)(*(_QWORD *)(v54 + 52824) + 32LL), 0, v56, v57, v58, v59, v60, v61, v62, v63);
  }
  v49 = "%s: exit";
  v50 = "wlan_hdd_pre_cac_success";
LABEL_11:
