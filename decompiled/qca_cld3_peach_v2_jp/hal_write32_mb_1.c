__int64 __fastcall hal_write32_mb_1(_QWORD *a1, unsigned int a2, unsigned int a3)
{
  __int64 result; // x0
  char v7; // w23
  double v8; // d0
...
LABEL_15:
  ...
  *((_DWORD *)a1 + 18557) = (a2 >> 19) & 0x3F;
  ...
  writel_7(a3, a1[2] + (a2 & 0x7FFFF) + 0x80000LL);
