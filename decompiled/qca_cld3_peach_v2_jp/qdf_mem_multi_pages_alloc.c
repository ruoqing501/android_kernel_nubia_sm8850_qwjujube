  ...
  *(_QWORD *)(a2 + 8) = result;
  ...
  if ( *(_WORD *)(a2 + 2) )
  {
    ...
    while ( 1 )
    {
      ...
      __asm { PRFM            #0x11, [X27] }
      do
        v27 = __ldxr((unsigned int *)&dword_716984);
      while ( __stxr(v27 + v19, (unsigned int *)&dword_716984) );
...
LABEL_33:
      if ( v15 )
      {
        ...
        do
        {
          ...
          __asm { PRFM            #0x11, [X24] }
          do
            v33 = __ldxr((unsigned int *)&dword_716984);
          while ( __stxr(v33 - v31, (unsigned int *)&dword_716984) );
