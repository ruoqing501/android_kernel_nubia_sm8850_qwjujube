...
LABEL_171:
        ...
        if ( !v116 )
        {
          ...
          *(_BYTE *)(v92 + 30) = v146;
          ...
          v148 = (unsigned int)*(unsigned __int8 *)(v4 + 20004) + 3;
...
LABEL_213:
        ...
        *(_QWORD *)v92 = v116;
        ...
        v129 = (unsigned int)*(unsigned __int8 *)(v4 + 20004) + 3;
...
LABEL_215:
    __break(0x5512u);
  v40 = *((_QWORD *)v39 + 11945) + 18528LL * (v6 & 3);
  v157 = *((_QWORD *)v39 + 11945);
  if ( !*(_DWORD *)(v40 + 56) )
  {
    v41 = *(_DWORD *)(v40 + 3264);
    if ( v41 )
