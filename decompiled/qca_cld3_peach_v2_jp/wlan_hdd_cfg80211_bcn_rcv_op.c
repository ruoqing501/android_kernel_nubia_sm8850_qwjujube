...
LABEL_16:
    ...
    {
      if ( hdd_cm_is_vdev_associated(*(_DWORD **)(v18 + 55512)) )
      {
...
LABEL_14:
        ...
        v46 = vdev_by_user;
        pdev_status = ucfg_scan_get_pdev_status(*(_QWORD *)(vdev_by_user + 152), v38, v39, v40, v41, v42, v43, v44, v45);
        ...
        else
        {
          ...
          if ( v69 == 1 )
          {
            if ( (sme_is_beacon_report_started(
                    *(_QWORD *)(a1 + 1552),
                    *(unsigned __int8 *)(*(_QWORD *)(v18 + 55512) + 8LL),
                    v70,
                    v71,
                    v72,
                    v73,
