__int64 __fastcall dp_ipa_set_doorbell_paddr(__int64 a1)
{
  ...
  if ( (wlan_cfg_is_ipa_enabled(*(_QWORD *)(a1 + 40)) & 1) != 0 )
  {
    ...
    *(_QWORD *)(a1 + 18424) = v4;
    if ( *(_BYTE *)(v6 + 608) == 1 )
    {
      v7 = pld_smmu_map(*(_QWORD *)(v6 + 40), *(_QWORD *)(a1 + 18416), (__int64)v12, 4);
      *(_QWORD *)(a1 + 18416) = LODWORD(v12[0]);
      if ( v7 )
      {
        v10 = printk(
                &unk_9BB309,
      ...
      v8 = pld_smmu_map(*(_QWORD *)(*(_QWORD *)(a1 + 24) + 40LL), *(_QWORD *)(a1 + 18432), (__int64)v12 + 4, 4);
      *(_QWORD *)(a1 + 18432) = HIDWORD(v12[0]);
      if ( v8 )
      {
        v11 = printk(
                &unk_9BB309,
    ...
    hal_srng_dst_set_hp_paddr_confirm(v2, *(_QWORD *)(a1 + 18432));
  }
