        ...
        double a8)
{
  ...
  __int64 v102; // x0
  __int64 v103; // x0
  __int64 v104; // [xsp+0h] [xbp-20h] BYREF
  __int64 v105; // [xsp+8h] [xbp-18h] BYREF
  _BYTE v106[4]; // [xsp+14h] [xbp-Ch] BYREF
  __int64 v107; // [xsp+18h] [xbp-8h]
...
LABEL_11:
  ...
  hdd_get_front_adapter_no_lock(v25, &v105);
  if ( v105 )
  {
    hdd_adapter_dev_hold_debug(v105, 0x32u, v35, v36, v37, v38, v39, v40, v41, v42, v43);
    v44 = v105;
  }
  else
  {
  ...
  hdd_get_next_adapter_no_lock(v25, v44, &v104);
  if ( v104 )
    hdd_adapter_dev_hold_debug(v104, 0x32u, v55, v56, v57, v58, v59, v60, v61, v62, v63);
  v64 = *(_QWORD *)(v25 + 40);
  if ( (v64 & 1) != 0 )
  {
...
LABEL_18:
      ...
      do
      {
        while ( 1 )
        {
            ...
            if ( v73 != -52832 )
            {
              do
              {
                                      ...
                                      v72) )
                {
                  ...
                  if ( v102 )
                  {
                    if ( (ucfg_pmo_is_vdev_connected(v102) & 1) != 0 )
                    {
                      if ( !*(_DWORD *)(v105 + 40) )
                ...
                if ( v105 )
                {
                  if ( (unsigned __int8)~(-910593773 * ((unsigned int)(v75 - *(_DWORD *)v75 - 52832) >> 4))
                    || (*(_QWORD *)(v105 + 1640) & 1) == 0 )
                  {
                    break;
                  }
                  v75 = v105 + 52832;
          ...
          hdd_adapter_dev_put_debug(v105, 0x32u, v76, v77, v78, v79, v80, v81, v82, v83);
          if ( (_ReadStatusReg(DAIF) & 0x80) != 0
          ...
          v105 = v104;
          hdd_get_next_adapter_no_lock(v25, v104, &v104);
          hdd_validate_next_adapter(&v105, &v104, 0x32u, v84, v85, v86, v87, v88, v89, v90, v91);
          if ( v104 )
            hdd_adapter_dev_hold_debug(v104, 0x32u, v92, v93, v94, v95, v96, v97, v98, v99, v100);
          v101 = *(_QWORD *)(v25 + 40);
          if ( (v101 & 1) != 0 )
            break;
...
LABEL_46:
  ...
  else
  {
    v103 = *(_QWORD *)v25;
    *(_BYTE *)(v25 + 185) = 1;
    ucfg_dp_suspend_wlan(v103);
    hdd_configure_sar_sleep_index(v25);
    v106[0] = 0;
    qdf_mem_set(v106, 1u, 0);
    v106[0] = 0;
    host_diag_event_report_payload(2743, 1, v106);
    result = 0;
  }
LABEL_12:
