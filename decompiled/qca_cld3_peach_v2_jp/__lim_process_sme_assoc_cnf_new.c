    ...
    else
    {
      ...
      if ( session_by_bssid )
      {
        ...
        if ( *(_DWORD *)(session_by_bssid + 88) == 1 && (_DWORD)v22 == 16 )
        {
          ...
          {
            v33 = hash_entry;
            if ( (unsigned int)qdf_mem_cmp((const void *)(hash_entry + 338), (char *)&v77 + 6, 6u) )
            {
              v42 = WORD2(v78);
              v43 = BYTE6(v77);
            ...
            else
            {
              if ( *(_DWORD *)(v33 + 8) == 15 && a2 == 5142 )
              {
                ...
                lim_deactivate_and_change_per_sta_id_timer(a1, 8, *(unsigned __int16 *)(v33 + 336));
                if ( HIDWORD(v76) )
                {
                  if ( (*(_BYTE *)(v33 + 32) & 2) == 0 )
                    *(_BYTE *)(v33 + 32) |= 2u;
            ...
            qdf_trace_msg(
              ...
              v72);
LABEL_34:
            v68 = *(_QWORD *)(*(_QWORD *)(v23 + 384) + 8LL * *(unsigned __int16 *)(v33 + 336));
            if ( v68 && (v83 & 0x100000000LL) == 0 )
            {
              lim_free_assoc_req_frm_buf(v68);
              _qdf_mem_free(*(_QWORD *)(*(_QWORD *)(v23 + 384) + 8LL * *(unsigned __int16 *)(v33 + 336)));
              *(_QWORD *)(*(_QWORD *)(v23 + 384) + 8LL * *(unsigned __int16 *)(v33 + 336)) = 0;
            }
            goto LABEL_13;
          }
          qdf_trace_msg(
