_BYTE *__fastcall wma_derive_ext_he_cap(_BYTE *result, __int64 a2, char a3)
{
  ...
  int v282; // w28
  int v283; // w11
  unsigned int v284; // w13
  int v285; // w10
  unsigned __int16 v286; // w16
  ...
  __int16 v310; // w4
  __int64 v311; // x9
  unsigned int v312; // w8
  unsigned int v313; // w15
  int v314; // w13
  int v315; // w17
  int v316; // w12
  __int16 v317; // w7
  ...
  int v341; // w20
  int v342; // w21
  unsigned __int16 v343; // w5
  int v344; // w22
  unsigned int v345; // w24
  unsigned int v346; // w19
  unsigned int v347; // w8
  ...
  int v369; // w19
  int v370; // w2
  unsigned __int16 v371; // w5
  int v372; // w20
  int v373; // w21
  int v374; // w22
  unsigned int v375; // w19
  unsigned int v376; // w24
  unsigned int v377; // w8
  ...
  int v399; // w19
  int v400; // w2
  unsigned __int16 v401; // w5
  int v402; // w20
  int v403; // w21
  int v404; // w22
  unsigned int v405; // w19
  unsigned int v406; // w24
  unsigned int v407; // w8
  unsigned int v408; // w9
  int v409; // w2
  int v410; // w3
  int v411; // w12
  int v412; // w13
  ...
  int v432; // w20
  int v433; // w21
  unsigned int v434; // w23
  unsigned int v435; // w24
  _BYTE *v436; // x19
  unsigned __int64 v437; // [xsp+8h] [xbp-48h]
  unsigned __int64 v438; // [xsp+10h] [xbp-40h]
  __int16 v439; // [xsp+1Ch] [xbp-34h]
  __int16 v440; // [xsp+20h] [xbp-30h]
  int v441; // [xsp+24h] [xbp-2Ch]
  int v442; // [xsp+28h] [xbp-28h]
  unsigned __int16 v443; // [xsp+2Ch] [xbp-24h]
  __int16 v444; // [xsp+2Ch] [xbp-24h]
  int v446; // [xsp+38h] [xbp-18h]
  __int16 v447; // [xsp+3Ch] [xbp-14h]
  __int16 v448; // [xsp+3Ch] [xbp-14h]
  unsigned __int16 v449; // [xsp+40h] [xbp-10h]
  int v450; // [xsp+44h] [xbp-Ch]
  unsigned __int16 v451; // [xsp+44h] [xbp-Ch]
  __int16 v452; // [xsp+48h] [xbp-8h]
  ...
  if ( *result )
  {
    ...
    *(_QWORD *)(result + 1) = v247 | v119;
    ...
    v262 = (v238 >> 6) & 1;
    v263 = (v238 >> 7) & 1;
    v441 = (v250 >> 4) & ((v238 >> 4) | ~(v246 | (v250 >> 5)));
    v442 = (v250 >> 2) & ((v238 >> 2) | ~(v240 | (v250 >> 3)));
    ...
    v449 = v248;
    v271 = v244 | ~(v250 >> 8);
    v446 = (v250 >> 8) & ((v238 >> 8) | ~(v244 | (v250 >> 9)));
    ...
    LOBYTE(v274) = (v250 >> 12) & ((v238 >> 12) | ~((v238 >> 13) | (v250 >> 13)));
    v280 = v238 | ~v254;
    v281 = (v238 >> 12) & 1;
    v282 = (v238 >> 13) & 1;
    v283 = (v250 >> 13) & 1;
    ...
    v285 = (v238 >> 14) & 1;
    v250 >>= 14;
    v286 = v282 & ~(_WORD)v281;
    LOWORD(v282) = v283 | v282;
    LOWORD(v283) = v279 & v283;
    LOBYTE(v284) = v284 | ~(v278 | v277);
    LOWORD(v279) = v285 & ~(v278 | v277);
    LOWORD(v248) = v277 & ~(_WORD)v285;
    v287 = *((unsigned __int16 *)result + 11);
    LOWORD(v277) = (v277 | ~(_WORD)v250) & v278;
    LOWORD(v278) = v280 & v252;
    v288 = v261 | v257;
    v289 = v266 | v251;
    LOWORD(v277) = v277 | v248;
    LOWORD(v281) = v281 & ~(_WORD)v282;
    LOWORD(v248) = v447 & ~v254 | v278;
    LOWORD(v282) = v249 | v264;
    v290 = ((v269 & 1 | (unsigned __int16)v275) << 10) | (((unsigned __int16)v271 | v276) << 11);
    v291 = (v287 >> 2) & 1;
    v292 = (v287 >> 3) & 1;
    v293 = (v287 >> 4) & 1;
    v294 = (v287 >> 9) & 1;
    v295 = v290 | ((v446 & 1 | v443) << 8) | ((_WORD)v282 << 9);
    v296 = (v287 >> 6) & 1;
    v297 = (v287 >> 8) & 1;
    LOWORD(v278) = v295 | ((v267 & 1 | (unsigned __int16)v262) << 6) | ((v449 | v451) << 7);
    v298 = (v287 >> 5) & 1;
    LOWORD(v248) = (((unsigned __int8)v250 & (unsigned __int8)v284 & 1 | (unsigned __int16)v279) << 14)
                 | ((_WORD)v277 << 15)
                 | ((v274 & 1 | (unsigned __int16)v281) << 12)
                 | (((unsigned __int16)v283 | v286) << 13)
                 | v248
                 | (2 * v452)
                 | (4 * (v442 & 1 | v439))
                 | (8 * v288)
    ...
    *((_WORD *)result + 10) = v248;
    v444 = v292 & ~(_WORD)v291;
    v300 = *(unsigned __int16 *)(a2 + 22);
    LOWORD(v446) = v298 & ~(_WORD)v293;
    LODWORD(v248) = (v300 >> 3) & 1;
    v448 = v291 & ~(v248 | v292);
    v301 = (v300 >> 5) & 1;
    v302 = ((v287 >> 3) | ~(v300 >> 2)) & v248;
    LOWORD(v291) = v294 & ~(_WORD)v297;
    LOWORD(v442) = v293 & ~(v301 | v298);
    v303 = ((v287 >> 5) | ~(v300 >> 4)) & v301;
    v304 = (v300 >> 9) & 1;
    LOWORD(v297) = v297 & ~(v304 | v294);
    v305 = ((v287 >> 9) | ~(v300 >> 8)) & v304;
    v306 = (v287 >> 10) & 1;
    LODWORD(v248) = (v287 >> 11) & 1;
    v307 = (v300 >> 11) & 1;
    v308 = ((v287 >> 11) | ~(*(_WORD *)(a2 + 22) >> 10)) & v307 | v248 & ~(_WORD)v306;
    LOWORD(v297) = BYTE1(v300) & (unsigned __int8)(BYTE1(v287) | ~((v300 >> 9) | (v287 >> 9))) & 1 | v297;
    v309 = v287 & 1 & ~((v300 >> 1) & 1 | (v287 >> 1) & 1)
         | (v287 | ~((v300 >> 1) & 1 | (v287 >> 1) & 1)) & v300 & 1
         | (2 * ((v300 >> 1) & 1 & ((v287 >> 1) | ~(v300 & 1)) | (v287 >> 1) & 1 & ~(v287 & 1)));
    LOWORD(v298) = (unsigned __int8)(v300 >> 10) & (unsigned __int8)((v287 >> 10) | ~((v300 >> 11) | (v287 >> 11))) & 1
                 | v306 & ~(v307 | v248);
    LOWORD(v301) = (unsigned __int8)(v300 >> 6) & (unsigned __int8)((v287 >> 6) | ~((v300 >> 7) | (v287 >> 7))) & 1
                 | v296 & ~((*(_WORD *)(a2 + 22) >> 7) & 1 | v299);
    v310 = (4 * ((unsigned __int8)(v300 >> 2) & (unsigned __int8)((v287 >> 2) | ~((v300 >> 3) | (v287 >> 3))) & 1 | v448))
         | (8 * (v302 | v444));
    LOWORD(v303) = (16
                  * ((unsigned __int8)(v300 >> 4) & (unsigned __int8)((v287 >> 4) | ~((v300 >> 5) | (v287 >> 5))) & 1
                   | v442))
                 | (32 * (v303 | v446));
    *((_WORD *)result + 11) = (((unsigned __int8)(v300 >> 14)
                              & (unsigned __int8)((v287 >> 14) | ~((v300 >> 15) | (v287 >> 15)))
                              & 1
                              | (v287 >> 14) & 1 & (unsigned __int16)~((v300 >> 15) | (v287 >> 15))) << 14)
                            | ((((v287 >> 15) | (unsigned __int16)~(unsigned __int16)(v300 >> 14))
                              & (unsigned __int16)(v300 >> 15)
                              | (v287 >> 15) & (unsigned __int16)~((v287 >> 14) & 1)) << 15)
                            | (((unsigned __int8)(v300 >> 12)
                              & (unsigned __int8)((v287 >> 12) | ~((v300 >> 13) | (v287 >> 13)))
                              & 1
                              | (v287 >> 12) & 1 & (unsigned __int16)~((v300 >> 13) & 1 | (v287 >> 13) & 1)) << 12)
                            | (((unsigned __int16)((v287 >> 13) | ~(unsigned __int16)(v300 >> 12)) & (v300 >> 13) & 1
                              | (v287 >> 13) & 1 & (unsigned __int16)~((v287 >> 12) & 1)) << 13)
                            | v309
                            | v310
                            | v303
                            | ((_WORD)v298 << 10)
                            | (v308 << 11)
                            | ((_WORD)v297 << 8)
                            | (((unsigned __int16)v305 | (unsigned __int16)v291) << 9)
                            | ((_WORD)v301 << 6)
                            | (((unsigned __int16)((v287 >> 7) | ~(unsigned __int16)(v300 >> 6))
                              & (*(_WORD *)(a2 + 22) >> 7)
                              & 1
                              | (unsigned __int16)(v299 & ~(_WORD)v296)) << 7);
    if ( (a3 & 1) != 0 )
    {
      v311 = (*(_QWORD *)(a2 + 1) >> 57) & 0xFLL;
      v312 = *((unsigned __int16 *)result + 12);
      v313 = v312 >> 3;
      if ( ((v438 >> 57) & 0xF) < (unsigned int)v311 )
        LOBYTE(v311) = (v438 >> 57) & 0xF;
      v314 = (v312 >> 2) & 1;
      v315 = (v312 >> 3) & 1;
      v316 = (v312 >> 1) & 1;
      *(_QWORD *)(result + 1) = v437 & 0xE1FFFFFFFFFFFFFFLL | ((unsigned __int64)(v311 & 0xF) << 57);
      v317 = v315 & ~(_WORD)v314;
      v318 = (v312 >> 4) & 1;
      v319 = *(unsigned __int16 *)(a2 + 24);
      v320 = (v312 >> 5) & 1;
      v321 = v316 & ~(v312 & 1);
      v322 = (v319 >> 3) & 1;
      v323 = (v319 >> 1) & 1;
      LOWORD(v316) = v323 | v316;
      v324 = v323 & ((v312 >> 1) | ~(v319 & 1));
      v325 = (v319 >> 5) & 1;
      LOWORD(v314) = (unsigned __int8)(v319 >> 2) & (unsigned __int8)((v312 >> 2) | ~(v313 | (v319 >> 3))) & 1
                   | v314 & ~(v322 | v315);
      LOWORD(v315) = (unsigned __int8)(v319 >> 4) & (unsigned __int8)((v312 >> 4) | ~((v312 >> 5) | (v319 >> 5))) & 1
                   | v318 & ~(v325 | v320);
      v326 = v312 & 1 & ~(_WORD)v316 | (v312 | ~(_WORD)v316) & *(_WORD *)(a2 + 24) & 1 | (2 * (v324 | v321));
      LOWORD(v324) = (4 * v314) | (8 * ((v313 | ~(*(_WORD *)(a2 + 24) >> 2)) & v322 | v317));
      v327 = ((v312 >> 5) | ~(v319 >> 4)) & v325 | v320 & ~v318;
      v328 = (v312 >> 7) & 1;
      v329 = (v319 >> 7) & 1;
      v330 = (v312 >> 6) & 1;
      LOWORD(v327) = (16 * v315) | (32 * v327);
      v331 = (v312 >> 9) & 1;
      v332 = (v319 >> 9) & 1;
      v333 = (unsigned __int8)(v319 >> 6) & (unsigned __int8)((v312 >> 6) | ~((v312 >> 7) | (v319 >> 7))) & 1
           | v330 & ~(v329 | v328);
      v334 = v328 & ~(_WORD)v330;
      v335 = (v312 >> 8) & 1;
      LOWORD(v315) = BYTE1(v319) & (unsigned __int8)(BYTE1(v312) | ~((v312 >> 9) | (v319 >> 9))) & 1
                   | v335 & ~(v332 | v331);
      v336 = (v312 >> 11) & 1;
      v337 = (v319 >> 11) & 1;
      v338 = v331 & ~v335;
      v339 = (v312 >> 10) & 1;
      v340 = ((v312 >> 9) | ~(v319 >> 8)) & v332 | v338;
      v341 = (v312 >> 13) & 1;
      v342 = (v319 >> 13) & 1;
      LOWORD(v338) = (unsigned __int8)(v319 >> 10)
                   & (unsigned __int8)((v312 >> 10) | ~((v312 >> 11) | (v319 >> 11)))
                   & 1
                   | v339 & ~(v337 | v336);
      v343 = v336 & ~(_WORD)v339;
      v344 = (v312 >> 12) & 1;
      v345 = v319 >> 15;
      v346 = v312 >> 15;
      *((_WORD *)result + 12) = (((unsigned __int8)(v319 >> 14)
                                & (unsigned __int8)((v312 >> 14) | ~(v345 | (v312 >> 15)))
                                & 1
                                | (v312 >> 14) & 1 & (unsigned __int16)~(v345 | (v312 >> 15))) << 14)
                              | (((v346 | (unsigned __int16)~(unsigned __int16)(v319 >> 14)) & (unsigned __int16)v345
                                | v346 & (unsigned __int16)~((v312 >> 14) & 1)) << 15)
                              | (((unsigned __int8)(v319 >> 12)
                                & (unsigned __int8)((v312 >> 12) | ~((v312 >> 13) | (v319 >> 13)))
                                & 1
                                | (unsigned __int16)(v344 & ~(v342 | v341))) << 12)
                              | ((((v312 >> 13) | (unsigned __int16)~(unsigned __int16)(v319 >> 12))
                                & (unsigned __int16)v342
                                | (unsigned __int16)(v341 & ~(_WORD)v344)) << 13)
                              | v326
                              | v324
                              | v327
                              | ((_WORD)v338 << 10)
                              | ((((v312 >> 11) | (unsigned __int16)~(unsigned __int16)(v319 >> 10))
                                & (unsigned __int16)v337
                                | v343) << 11)
                              | ((_WORD)v315 << 8)
                              | ((_WORD)v340 << 9)
                              | (v333 << 6)
                              | ((((v312 >> 7) | (unsigned __int16)~(unsigned __int16)(v319 >> 6))
                                & (unsigned __int16)v329
                                | v334) << 7);
      v347 = *((unsigned __int16 *)result + 13);
      v348 = *(unsigned __int16 *)(a2 + 26);
      v349 = (v347 >> 3) & 1;
      v350 = (v348 >> 3) & 1;
      v351 = (v347 >> 2) & 1;
      v352 = v347 & 1 & ~((v348 >> 1) & 1 | (v347 >> 1) & 1)
           | (v347 | ~((v348 >> 1) & 1 | (v347 >> 1) & 1)) & v348 & 1
           | (2 * ((v348 >> 1) & 1 & ((v347 >> 1) | ~(v348 & 1)) | (v347 >> 1) & 1 & ~(v347 & 1)));
      LOWORD(v324) = (unsigned __int8)(v348 >> 2) & (unsigned __int8)((v347 >> 2) | ~((v347 >> 3) | (v348 >> 3))) & 1
                   | v351 & ~(v350 | v349);
      LOWORD(v351) = v349 & ~(_WORD)v351;
      v353 = ((v347 >> 3) | ~(v348 >> 2)) & v350;
      v354 = (v347 >> 5) & 1;
      v355 = (v348 >> 5) & 1;
      v356 = (v347 >> 4) & 1;
      LOWORD(v324) = (4 * v324) | (8 * (v353 | v351));
      LOWORD(v353) = (unsigned __int8)(v348 >> 4) & (unsigned __int8)((v347 >> 4) | ~((v347 >> 5) | (v348 >> 5))) & 1
                   | v356 & ~(v355 | v354);
      v357 = v354 & ~v356;
      v358 = (v347 >> 7) & 1;
      v359 = ((v347 >> 5) | ~(v348 >> 4)) & v355 | v357;
      v360 = (v348 >> 7) & 1;
      v361 = (v347 >> 6) & 1;
      LOWORD(v353) = (16 * v353) | (32 * v359);
      v362 = (v347 >> 9) & 1;
      v363 = (v348 >> 9) & 1;
      LOWORD(v359) = (unsigned __int8)(v348 >> 6) & (unsigned __int8)((v347 >> 6) | ~((v347 >> 7) | (v348 >> 7))) & 1
                   | v361 & ~(v360 | v358);
      v364 = v358 & ~(_WORD)v361;
      v365 = (v347 >> 8) & 1;
      LOWORD(v354) = BYTE1(v348) & (unsigned __int8)(BYTE1(v347) | ~((v347 >> 9) | (v348 >> 9))) & 1
                   | v365 & ~(v363 | v362);
      v366 = (v347 >> 11) & 1;
      v367 = (v348 >> 11) & 1;
      v368 = v362 & ~v365;
      v369 = (v347 >> 10) & 1;
      v370 = ((v347 >> 9) | ~(v348 >> 8)) & v363 | v368;
      LOWORD(v368) = (unsigned __int8)(v348 >> 10)
                   & (unsigned __int8)((v347 >> 10) | ~((v347 >> 11) | (v348 >> 11)))
                   & 1
                   | v369 & ~(v367 | v366);
      v371 = v366 & ~(_WORD)v369;
      v372 = (v347 >> 13) & 1;
      v373 = (v348 >> 13) & 1;
      v374 = (v347 >> 12) & 1;
      v375 = v347 >> 15;
      v376 = v348 >> 15;
      *((_WORD *)result + 13) = (((unsigned __int8)(v348 >> 14)
                                & (unsigned __int8)((v347 >> 14) | ~(v376 | (v347 >> 15)))
                                & 1
                                | (v347 >> 14) & 1 & (unsigned __int16)~(v376 | (v347 >> 15))) << 14)
                              | (((v375 | (unsigned __int16)~(unsigned __int16)(v348 >> 14)) & (unsigned __int16)v376
                                | v375 & (unsigned __int16)~((v347 >> 14) & 1)) << 15)
                              | (((unsigned __int8)(v348 >> 12)
                                & (unsigned __int8)((v347 >> 12) | ~((v347 >> 13) | (v348 >> 13)))
                                & 1
                                | (unsigned __int16)(v374 & ~(v373 | v372))) << 12)
                              | ((((v347 >> 13) | (unsigned __int16)~(unsigned __int16)(v348 >> 12))
                                & (unsigned __int16)v373
                                | (unsigned __int16)(v372 & ~(_WORD)v374)) << 13)
                              | v352
                              | v324
                              | v353
                              | ((_WORD)v368 << 10)
                              | ((((v347 >> 11) | (unsigned __int16)~(unsigned __int16)(v348 >> 10))
                                & (unsigned __int16)v367
                                | v371) << 11)
                              | ((_WORD)v354 << 8)
                              | ((_WORD)v370 << 9)
                              | ((_WORD)v359 << 6)
                              | ((((v347 >> 7) | (unsigned __int16)~(unsigned __int16)(v348 >> 6))
                                & (unsigned __int16)v360
                                | v364) << 7);
      v377 = *((unsigned __int16 *)result + 14);
      v378 = *(unsigned __int16 *)(a2 + 28);
      v379 = (v377 >> 3) & 1;
      v380 = (v378 >> 3) & 1;
      v381 = (v377 >> 2) & 1;
      v382 = v377 & 1 & ~((v378 >> 1) & 1 | (v377 >> 1) & 1)
           | (v377 | ~((v378 >> 1) & 1 | (v377 >> 1) & 1)) & v378 & 1
           | (2 * ((v378 >> 1) & 1 & ((v377 >> 1) | ~(v378 & 1)) | (v377 >> 1) & 1 & ~(v377 & 1)));
      LOWORD(v324) = (unsigned __int8)(v378 >> 2) & (unsigned __int8)((v377 >> 2) | ~((v377 >> 3) | (v378 >> 3))) & 1
                   | v381 & ~(v380 | v379);
      LOWORD(v381) = v379 & ~(_WORD)v381;
      v383 = ((v377 >> 3) | ~(v378 >> 2)) & v380;
      v384 = (v377 >> 5) & 1;
      v385 = (v378 >> 5) & 1;
      v386 = (v377 >> 4) & 1;
      LOWORD(v324) = (4 * v324) | (8 * (v383 | v381));
      LOWORD(v383) = (unsigned __int8)(v378 >> 4) & (unsigned __int8)((v377 >> 4) | ~((v377 >> 5) | (v378 >> 5))) & 1
                   | v386 & ~(v385 | v384);
      v387 = v384 & ~v386;
      v388 = (v377 >> 7) & 1;
      v389 = ((v377 >> 5) | ~(v378 >> 4)) & v385 | v387;
      v390 = (v378 >> 7) & 1;
      v391 = (v377 >> 6) & 1;
      LOWORD(v383) = (16 * v383) | (32 * v389);
      v392 = (v377 >> 9) & 1;
      v393 = (v378 >> 9) & 1;
      LOWORD(v389) = (unsigned __int8)(v378 >> 6) & (unsigned __int8)((v377 >> 6) | ~((v377 >> 7) | (v378 >> 7))) & 1
                   | v391 & ~(v390 | v388);
      v394 = v388 & ~(_WORD)v391;
      v395 = (v377 >> 8) & 1;
      LOWORD(v384) = BYTE1(v378) & (unsigned __int8)(BYTE1(v377) | ~((v377 >> 9) | (v378 >> 9))) & 1
                   | v395 & ~(v393 | v392);
      v396 = (v377 >> 11) & 1;
      v397 = (v378 >> 11) & 1;
      v398 = v392 & ~v395;
      v399 = (v377 >> 10) & 1;
      v400 = ((v377 >> 9) | ~(v378 >> 8)) & v393 | v398;
      LOWORD(v398) = (unsigned __int8)(v378 >> 10)
                   & (unsigned __int8)((v377 >> 10) | ~((v377 >> 11) | (v378 >> 11)))
                   & 1
                   | v399 & ~(v397 | v396);
      v401 = v396 & ~(_WORD)v399;
      v402 = (v377 >> 13) & 1;
      v403 = (v378 >> 13) & 1;
      v404 = (v377 >> 12) & 1;
      v405 = v377 >> 15;
      v406 = v378 >> 15;
      *((_WORD *)result + 14) = (((unsigned __int8)(v378 >> 14)
                                & (unsigned __int8)((v377 >> 14) | ~(v406 | (v377 >> 15)))
                                & 1
                                | (v377 >> 14) & 1 & (unsigned __int16)~(v406 | (v377 >> 15))) << 14)
                              | (((v405 | (unsigned __int16)~(unsigned __int16)(v378 >> 14)) & (unsigned __int16)v406
                                | v405 & (unsigned __int16)~((v377 >> 14) & 1)) << 15)
                              | (((unsigned __int8)(v378 >> 12)
                                & (unsigned __int8)((v377 >> 12) | ~((v377 >> 13) | (v378 >> 13)))
                                & 1
                                | (unsigned __int16)(v404 & ~(v403 | v402))) << 12)
                              | ((((v377 >> 13) | (unsigned __int16)~(unsigned __int16)(v378 >> 12))
                                & (unsigned __int16)v403
                                | (unsigned __int16)(v402 & ~(_WORD)v404)) << 13)
                              | v382
                              | v324
                              | v383
                              | ((_WORD)v398 << 10)
                              | ((((v377 >> 11) | (unsigned __int16)~(unsigned __int16)(v378 >> 10))
                                & (unsigned __int16)v397
                                | v401) << 11)
                              | ((_WORD)v384 << 8)
                              | ((_WORD)v400 << 9)
                              | ((_WORD)v389 << 6)
                              | ((((v377 >> 7) | (unsigned __int16)~(unsigned __int16)(v378 >> 6))
                                & (unsigned __int16)v390
                                | v394) << 7);
      v407 = *((unsigned __int16 *)result + 15);
      v408 = *(unsigned __int16 *)(a2 + 30);
      v409 = (v407 >> 3) & 1;
      v410 = (v408 >> 3) & 1;
      v411 = (v407 >> 2) & 1;
      LOWORD(v324) = (unsigned __int8)(v408 >> 2) & (unsigned __int8)((v407 >> 2) | ~((v407 >> 3) | (v408 >> 3))) & 1
                   | v411 & ~(v410 | v409);
      LOWORD(v411) = v409 & ~(_WORD)v411;
      v412 = ((v407 >> 3) | ~(v408 >> 2)) & v410;
      v413 = (v407 >> 5) & 1;
      v414 = (v408 >> 5) & 1;
      v415 = (v407 >> 4) & 1;
      LOWORD(v324) = (4 * v324) | (8 * (v412 | v411));
      LOWORD(v412) = (unsigned __int8)(v408 >> 4) & (unsigned __int8)((v407 >> 4) | ~((v407 >> 5) | (v408 >> 5))) & 1
                   | v415 & ~(v414 | v413);
      v416 = v413 & ~v415;
      v417 = (v407 >> 7) & 1;
      v418 = ((v407 >> 5) | ~(v408 >> 4)) & v414 | v416;
      v419 = (v408 >> 7) & 1;
      v420 = (v407 >> 6) & 1;
      LOWORD(v412) = (16 * v412) | (32 * v418);
      v421 = (v407 >> 9) & 1;
      v422 = (v408 >> 9) & 1;
      LOWORD(v418) = (unsigned __int8)(v408 >> 6) & (unsigned __int8)((v407 >> 6) | ~((v407 >> 7) | (v408 >> 7))) & 1
                   | v420 & ~(v419 | v417);
      v423 = v417 & ~(_WORD)v420;
      v424 = (v407 >> 8) & 1;
      LOWORD(v413) = BYTE1(v408) & (unsigned __int8)(BYTE1(v407) | ~((v407 >> 9) | (v408 >> 9))) & 1
                   | v424 & ~(v422 | v421);
      v425 = v421 & ~v424;
      v426 = (v407 >> 11) & 1;
      v427 = (v408 >> 11) & 1;
      v428 = (v407 >> 10) & 1;
      v429 = ((v407 >> 9) | ~(v408 >> 8)) & v422 | v425;
      LOWORD(v424) = (unsigned __int8)(v408 >> 10)
                   & (unsigned __int8)((v407 >> 10) | ~((v407 >> 11) | (v408 >> 11)))
                   & 1
                   | v428 & ~(v427 | v426);
      v430 = ((v407 >> 11) | ~(v408 >> 10)) & v427 | v426 & ~v428;
      v431 = (v407 >> 13) & 1;
      v432 = (v408 >> 13) & 1;
      v433 = (v407 >> 12) & 1;
      v434 = v407 >> 15;
      v435 = v408 >> 15;
      *((_WORD *)result + 15) = (((unsigned __int8)(v408 >> 14) & (unsigned __int8)((v407 >> 14) | ~(v435 | v434)) & 1
                                | (v407 >> 14) & 1 & (unsigned __int16)~(v435 | v434)) << 14)
                              | (((v434 | (unsigned __int16)~(unsigned __int16)(v408 >> 14)) & (unsigned __int16)v435
                                | v434 & (unsigned __int16)~((v407 >> 14) & 1)) << 15)
                              | (((unsigned __int8)(v408 >> 12)
                                & (unsigned __int8)((v407 >> 12) | ~((v407 >> 13) | (v408 >> 13)))
                                & 1
                                | (unsigned __int16)(v433 & ~(v432 | v431))) << 12)
                              | ((((v407 >> 13) | (unsigned __int16)~(unsigned __int16)(v408 >> 12))
                                & (unsigned __int16)v432
                                | (unsigned __int16)(v431 & ~(_WORD)v433)) << 13)
                              | v407 & 1 & ~((v408 >> 1) & 1 | (v407 >> 1) & 1)
                              | (v407 | ~((v408 >> 1) & 1 | (v407 >> 1) & 1)) & v408 & 1
                              | (2 * ((v408 >> 1) & 1 & ((v407 >> 1) | ~(v408 & 1)) | (v407 >> 1) & 1 & ~(v407 & 1)))
                              | v324
                              | v412
                              | ((_WORD)v424 << 10)
                              | ((_WORD)v430 << 11)
                              ...
                              | ((_WORD)v429 << 9)
                              | ((_WORD)v418 << 6)
                              | ((((v407 >> 7) | (unsigned __int16)~(unsigned __int16)(v408 >> 6))
