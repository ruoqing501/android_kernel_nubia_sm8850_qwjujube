        ...
        double a11)
{
  ...
  v12 = a2 + 0x2000;
  *(_BYTE *)a3 = 1;
  v13 = *(_WORD *)(a3 + 1) & 0xFFFC | *(_BYTE *)(v11 + 2674) & 3;
  *(_WORD *)(a3 + 1) = v13;
  v14 = *(_BYTE *)(v11 + 2616);
...
LABEL_13:
  ...
  v17 = v15 & 0xFFEF | (16 * (*(_BYTE *)(v11 + 2617) & 1));
  *(_WORD *)(a3 + 1) = v17;
  v18 = v17 & 0xFFDF | (32 * (*(_BYTE *)(v11 + 2618) & 1));
  *(_WORD *)(a3 + 1) = v18;
  if ( 4 * (v14 & 3) )
  {
    v18 = v18 & 0xFFBF | ((*(_BYTE *)(v11 + 2619) & 1) << 6);
    *(_WORD *)(a3 + 1) = v18;
  }
  v19 = *(_WORD *)(a3 + 4);
  v20 = v18 & 0xFF7F | ((*(_BYTE *)(v11 + 2620) & 1) << 7);
  *(_WORD *)(a3 + 1) = v20;
  v21 = v20 & 0xF8FF | (*(unsigned __int8 *)(v11 + 2621) << 8);
  *(_WORD *)(a3 + 1) = v21;
  v22 = v21 & 0xEFFF | (*(unsigned __int8 *)(v11 + 2623) << 12);
  v23 = *(_BYTE *)(a3 + 3);
  *(_WORD *)(a3 + 1) = v22;
  v24 = v23 & 0xEF | (16 * *(_BYTE *)(v11 + 2668));
  *(_BYTE *)(a3 + 3) = v24;
  v25 = v22 & 0xF1FF | (*(unsigned __int8 *)(v11 + 2622) << 11);
  *(_WORD *)(a3 + 1) = v25;
  LOWORD(v26) = v25 & 0x1FFF | (*(unsigned __int8 *)(v11 + 2624) << 13);
  *(_WORD *)(a3 + 1) = v26;
  v27 = v24 & 0xDF | (32 * *(_BYTE *)(v11 + 2627));
  *(_BYTE *)(a3 + 3) = v27;
  v28 = v27 & 0xF8 | *(_BYTE *)(v11 + 2625) & 7;
  *(_BYTE *)(a3 + 3) = v28;
  LOBYTE(v29) = v28 & 0xBF | (*(_BYTE *)(v11 + 2628) << 6);
  *(_BYTE *)(a3 + 3) = v29;
  v30 = v19 & 0xFFDF | (32 * (*(_BYTE *)(v11 + 2630) & 1));
  *(_WORD *)(a3 + 4) = v30;
  v31 = v30 & 0xFFBF | ((*(_BYTE *)(v11 + 2631) & 1) << 6);
  *(_WORD *)(a3 + 4) = v31;
  v32 = v31 & 0xFFF8 | *(_BYTE *)(v11 + 2673) & 7;
  *(_WORD *)(a3 + 4) = v32;
  v33 = v32 & 0xFFE7 | (8 * (*(_BYTE *)(v11 + 2629) & 3));
  *(_WORD *)(a3 + 4) = v33;
  LOWORD(v34) = v33 & 0xFE7F | ((*(_BYTE *)(v11 + 2681) & 3) << 7);
LABEL_25:
  *(_WORD *)(a3 + 4) = v34;
  v53 = *(_WORD *)(a3 + 12);
  v54 = *(unsigned __int8 *)(v11 + 2683);
  *(_WORD *)(a3 + 8) = *(_WORD *)(a3 + 8) & 0x1FFF | (v54 << 13);
  v55 = v53 & 0xDFFF | ((*(_BYTE *)(v11 + 2682) & 1) << 13);
  *(_WORD *)(a3 + 12) = v55;
  *(_BYTE *)(a3 + 3) = v29 & 0xF7 | (8 * *(_BYTE *)(v11 + 2626));
  v56 = v54 << 13;
  v57 = *(unsigned __int16 *)(v11 + 2632);
  *(_WORD *)(a3 + 6) = v57;
  *(_WORD *)(a3 + 8) = (v54 << 13) | *(_WORD *)(v11 + 2640) & 0x1FFF;
  v58 = *(unsigned __int16 *)(v11 + 2636);
  *(_WORD *)(a3 + 10) = v58;
  *(_WORD *)(a3 + 12) = v55 & 0xE000 | *(_WORD *)(v11 + 2644) & 0x1FFF;
  if ( !a2 )
    return 0;
  if ( *(_DWORD *)(a2 + 7176) )
    v59 = 0;
  else
    v59 = *(_BYTE *)(v11 + 2666) ^ 1;
