__int64 __fastcall drv_cmd_get_roam_mode(__int64 a1, __int64 *a2, const char *a3, __int64 a4, __int64 a5)
{
  ...
  memset(v33, 0, 32);
  scnprintf(v33, 32, "%s %d", a3, (is_lfr_feature_enabled & 1) == 0);
  v9 = *(_DWORD *)(a5 + 12);
  if ( v9 > v8 )
    LOBYTE(v9) = v8 + 1;
