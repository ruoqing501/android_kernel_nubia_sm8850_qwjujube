...
LABEL_50:
  ...
  if ( !v52 )
  {
    ...
    wlan_minidump_remove(g_umac_glb_obj, 11728, v10, 45, "wlan_objmgr_global");
    for ( i = 0; i != 54; ++i )
    {
      v22 = v10 + 4 * i;
      v23 = g_umac_glb_obj + 8 * i;
      v24 = *(__int64 (__fastcall **)(__int64, __int64))(v23 + 904);
      if ( v24 && ((v25 = *(_DWORD *)(v22 + 2576), v26 = *(_QWORD *)(v23 + 1336), v25 == 40) || !v25) )
      {
