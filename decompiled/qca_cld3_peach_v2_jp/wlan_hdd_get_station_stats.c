__int64 __fastcall wlan_hdd_get_station_stats(__int64 *a1)
{
  ...
  if ( vdev_by_user )
  {
    ...
    if ( (get_station_fw_request_needed & 1) != 0
      || ((v12 = *(_QWORD *)(vdev_by_user + 152)) == 0 ? (v13 = 0) : (v13 = *(_QWORD *)(v12 + 80)),
...
LABEL_30:
          ...
          v36 = (const char *)&unk_8B9E43;
          v37 = (const char *)&unk_8B9E43;
        }
        else
        {
          v37 = (const char *)&unk_8B9E43;
      ...
      if ( station_stats[7] )
        v38 = (const char *)&unk_8B9E43;
      else
        v38 = " peer_adv_stats";
      if ( station_stats[1] )
        v39 = (const char *)&unk_8B9E43;
      else
        v39 = " pdev_stats";
      qdf_trace_msg(
        0x33u,
