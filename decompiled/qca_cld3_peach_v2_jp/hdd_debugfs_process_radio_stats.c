        ...
        int a12)
{
  ...
  if ( ll_stats_1 )
  {
    ...
    scnprintf(ll_stats_1 + ll_stats_0, 0x4000 - ll_stats_0, "\n\n===LL_STATS_RADIO: number of radios: %u===", a12);
    v17 = v16;
    if ( a12 )
    {
      v18 = 0;
      ...
      do
      {
        ...
        if ( *(_DWORD *)(a11 + 48) )
        {
          ...
          do
          {
            ...
            v20 += v24;
            ll_stats_0 += v24;
            scnprintf(v20, 0x4000 - ll_stats_0, "%d ", *(_DWORD *)(v26 + 4LL * (int)v25++));
            v24 = v27;
          }
        ...
        if ( *(_DWORD *)(a11 + 68) )
        {
          ...
          do
          {
            ...
            v34 = *(_QWORD *)(a1 + 24);
            v17 = v33;
            if ( v34 && *(_BYTE *)(v34 + 6920) == 1 )
            {
              v15 += v33;
              ll_stats_0 += v33;
              scnprintf(v15, 0x4000 - ll_stats_0, ", tx_time: %u, rx_time: %u", v32[6], v32[7]);
              v17 = v35;
            }
            ++v31;
          }
