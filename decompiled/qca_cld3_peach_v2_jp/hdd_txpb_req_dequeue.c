__int64 __fastcall hdd_txpb_req_dequeue(__int64 a1, _DWORD *a2, _QWORD *a3)
{
  ...
  if ( qdf_list_empty((_QWORD *)(a1 + 8792)) )
  {
...
LABEL_10:
  ...
  if ( (unsigned int)qdf_list_peek_front((_QWORD *)(a1 + 8792), v50) )
  {
    qdf_mutex_release(a1 + 8816);
    goto LABEL_10;
  }
  while ( v50[0] != a3 )
  {
    if ( (unsigned int)qdf_list_peek_next((_QWORD *)(a1 + 8792), v50[0], v50) )
    {
      qdf_mutex_release(a1 + 8816);
      qdf_trace_msg(
        0x33u,
  ...
  v14 = v50[0];
  v15 = qdf_list_remove_node(a1 + 8792, v50[0]);
  if ( v15 )
  {
    v24 = v15;
    qdf_mutex_release(a1 + 8816);
