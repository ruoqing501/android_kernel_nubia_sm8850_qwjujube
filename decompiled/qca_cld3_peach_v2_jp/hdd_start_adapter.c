...
LABEL_82:
  if ( (unsigned int)hdd_set_fw_params(a1) )
    qdf_trace_msg(
      ...
      v113,
      "hdd_start_adapter");
  if ( *(unsigned __int8 *)(*(_QWORD *)(a1 + 52824) + 8LL) == 255 )
  {
    v115 = 255;
  }
  else
  {
    ...
    v115 = *(unsigned __int8 *)(*(_QWORD *)(a1 + 52824) + 8LL);
  }
  ...
  if ( v116 )
  {
    ...
    {
      ucfg_p2p_psoc_priv_set_sta_vdev_id(**(_QWORD **)(a1 + 24), *(_BYTE *)(*(_QWORD *)(v117 + 52824) + 8LL));
      if ( (unsigned int)wlan_mlme_set_p2p_device_mac_addr(
                           *(_QWORD *)(*(_QWORD *)(v117 + 52824) + 32LL),
                           (int *)(a1 + 1617),
                           v118,
                           v119,
                           v120,
      ...
      *(_BYTE *)(*(_QWORD *)(a1 + 52824) + 8LL) = *(_BYTE *)(*(_QWORD *)(v117 + 52824) + 8LL);
    }
  }
LABEL_95:
