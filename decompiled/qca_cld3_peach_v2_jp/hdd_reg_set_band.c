  ...
  if ( !(unsigned int)ucfg_reg_get_band(*(_QWORD *)(v12 + 8), &v69, v13, v14, v15, v16, v17, v18, v19, v20) )
  {
    ...
    else
    {
      ...
      *(_DWORD *)(v12 + 3252) = v46;
      ...
      v66 = wlan_cm_set_roam_band_update(*(_QWORD *)v12, *(unsigned __int8 *)(*(_QWORD *)(a1 + 55512) + 8LL));
      v67 = *(_QWORD *)v12;
      v68 = v66;
      wlan_cm_set_roam_band_bitmask(v67, *(unsigned __int8 *)(*(_QWORD *)(a1 + 55512) + 8LL), a2);
      if ( !v68 )
      {
LABEL_16:
        result = 0;
