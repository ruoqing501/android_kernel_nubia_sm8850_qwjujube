__int64 __fastcall p2p_peer_authorized(
        __int64 a1,
        _BYTE *a2,
        double a3,
        double a4,
        ...
        double a10)
{
  ...
  {
    v50 = "%s: vdev:%pK";
    return qdf_trace_msg(0x4Eu, 2u, v50, a3, a4, a5, a6, a7, a8, a9, a10, "p2p_peer_authorized", 0);
  }
  v10 = *(_QWORD *)(a1 + 152);
  ...
  if ( result )
  {
    ...
    if ( comp_private_obj )
    {
      ...
      {
        *(_BYTE *)(comp_private_obj + 16) = (unsigned int)ucfg_p2p_set_noa(v11, *(unsigned __int8 *)(a1 + 104), 1) != 0;
    ...
    {
      return wlan_objmgr_peer_release_ref(v14, 0xFu, v16, v17, v18, v19, v20, v21, v22, v23);
    }
  }
  return result;
}
