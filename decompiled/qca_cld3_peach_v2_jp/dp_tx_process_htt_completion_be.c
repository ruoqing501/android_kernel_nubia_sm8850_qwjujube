...
LABEL_56:
  ...
  {
    v51 = v50;
    if ( (v20[95042] & 1) != 0 || *(_BYTE *)(v32 + 45317) )
      dp_tx_compute_delay(v32, a2);
    v52 = (__int64)&v20[6768 * (unsigned __int8)a4 + 8016 + 752 * v51 + 8 * v15];
    ++*(_QWORD *)(v52 + 696);
    v53 = dp_txrx_peer_get_ref_by_id(v13, v33, &v72);
    v54 = v53;
    if ( v53 )
    {
      v55 = *(_QWORD *)(a2 + 8);
