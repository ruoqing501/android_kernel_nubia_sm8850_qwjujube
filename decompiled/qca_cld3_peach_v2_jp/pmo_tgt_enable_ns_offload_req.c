__int64 __fastcall pmo_tgt_enable_ns_offload_req(__int64 a1, unsigned __int8 a2)
{
  ...
  v5 = *(_QWORD *)(*(_QWORD *)(a1 + 152) + 80LL);
  v6 = _qdf_mem_malloc(0xCu, "pmo_tgt_enable_ns_offload_req", 44);
  if ( v6 )
  {
    v7 = (unsigned __int8 *)v6;
    v8 = _qdf_mem_malloc(0x28Cu, "pmo_tgt_enable_ns_offload_req", 50);
    if ( !v8 )
    {
      v38 = 2;
      v9 = (unsigned int *)v7;
