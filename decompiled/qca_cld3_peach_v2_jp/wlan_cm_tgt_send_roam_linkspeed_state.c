__int64 __fastcall wlan_cm_tgt_send_roam_linkspeed_state(__int64 a1, unsigned __int8 *a2)
{
  __int64 v3; // x0
  double v4; // d0
  double v5; // d1
  ...
  __int64 v14; // x0
  __int64 ext_hdl; // x0
  __int64 (__fastcall *v16)(__int64, __int64, _BOOL8); // x8
  __int64 v17; // x1
  _BOOL8 v18; // x2
  unsigned int *v19; // x8
...
LABEL_11:
  ...
  v16 = *(__int64 (__fastcall **)(__int64, __int64, _BOOL8))(ext_hdl + 7264);
  if ( v16 )
  {
    v17 = *a2;
    v18 = a2[1] != 0;
    if ( *((_DWORD *)v16 - 1) != 1494901571 )
      __break(0x8228u);
    v20 = v16(v13, v17, v18);
    if ( v20 )
      qdf_trace_msg(
        0x68u,
        8u,
        "%s: vdev %d fail to send roam linkspeed state",
        v21,
        v22,
        v23,
        v24,
        ...
        v27,
        v28,
        "wlan_cm_tgt_send_roam_linkspeed_state",
        *a2);
    goto LABEL_13;
  }
LABEL_12:
  qdf_trace_msg(
    0x68u,
    2u,
    "%s: vdev %d send_roam_linkspeed_state is NULL",
    v4,
    v5,
    v6,
    v7,
