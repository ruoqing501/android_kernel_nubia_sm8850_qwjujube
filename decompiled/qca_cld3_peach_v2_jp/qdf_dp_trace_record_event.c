__int64 __fastcall qdf_dp_trace_record_event(__int64 result, char a2, unsigned int a3, char a4, char a5)
{
  ...
  if ( byte_73EC28 == 1 )
  {
    if ( (unsigned __int8)byte_73EC26 > 1u )
    {
      ...
      else if ( byte_73EC26 != 4 && (byte_73EC26 != 3 || (unsigned int)result >= 0x23) )
      {
        goto LABEL_14;
      }
      goto LABEL_13;
    ...
    if ( byte_73EC26 == 1 && (unsigned int)result < 0xE )
    {
LABEL_13:
      v5[1] = a4;
      v5[2] = a5;
