        ...
        double a12)
{
  ...
  unsigned int v65; // [xsp+1Ch] [xbp-14h] BYREF
  _QWORD v66[2]; // [xsp+20h] [xbp-10h] BYREF
...
LABEL_12:
  ...
  v20 = a4;
  peer_phymode = mlme_get_peer_phymode(v19, (_BYTE *)(a2 + 24), &v65);
  if ( peer_phymode )
  {
    qdf_trace_msg(
      0x35u,
...
LABEL_13:
  ...
  ch_width_from_phymode = wlan_mlme_get_ch_width_from_phymode(v65, v22, v23, v24, v25, v26, v27, v28, v29);
  a4 = v20;
  if ( ch_width_from_phymode < v14 )
  {
    if ( !wlan_cm_is_vdev_connected(*(_QWORD *)(a2 + 16), v33, v34, v35, v36, v37, v38, v39, v40) )
      goto LABEL_13;
    qdf_mem_set(&v63, 0x10u, 0);
    v41 = a1[2695];
    v42 = *(_DWORD *)(a2 + 284);
    LODWORD(v63) = v14;
    wlan_reg_set_channel_params_for_pwrmode(v41, v42, 0, (__int64)&v63, 0, v43, v44, v45, v46, v47, v48, v49, v50);
    v51 = (_BYTE *)_qdf_mem_malloc(0x20u, "lim_check_vht_op_mode_change", 5164);
    if ( v51 )
    {
      v52 = v51;
      *v51 = wlan_reg_freq_to_chan(a1[2695], *(_DWORD *)(a2 + 284), a5, a6, a7, a8, a9, a10, a11, a12);
      v53 = v63;
      *((_DWORD *)v52 + 1) = *(_DWORD *)(a2 + 284);
      v54 = *(_WORD *)((char *)&v63 + 5);
      *((_DWORD *)v52 + 3) = v53;
      *(_WORD *)(v52 + 17) = v54;
      LOWORD(v53) = *(_WORD *)(a2 + 28);
      *((_DWORD *)v52 + 6) = *(_DWORD *)(a2 + 24);
      *((_WORD *)v52 + 14) = v53;
...
LABEL_2:
  ...
  v65 = v14;
  v66[0] = v16;
  qdf_mem_copy((char *)v66 + 2, a4, 6u);
  lim_send_mode_update((__int64)a1, &v65, a2);
