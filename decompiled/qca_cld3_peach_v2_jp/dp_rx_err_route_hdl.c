__int64 __fastcall dp_rx_err_route_hdl(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, unsigned __int8 a6)
{
  ...
  *(_BYTE *)(a2 + 84) = *(_BYTE *)(a2 + 84) & 0xBF | ((v18(a4) & 1) << 6);
  ...
  if ( *(v19 - 1) != -177782713 )
    __break(0x8228u);
  ((void (__fastcall *)(__int64, _QWORD *))v19)(a4, v54);
  ...
  {
    v22 = LOWORD(v54[0]) + v21 + *(unsigned __int16 *)(a1 + 1138);
...
LABEL_71:
  ...
  {
    v41 = *(_QWORD *)(a2 + 40);
    v42 = LOWORD(v54[0]) + (unsigned __int64)*(unsigned __int16 *)(a1 + 1138);
    if ( v41 )
  ...
  *(_WORD *)(a2 + 62) = *(_WORD *)(a3 + 8);
  ...
  result = qdf_mem_cmp(*(const void **)(a2 + 224), v40 + 12, 6u);
  if ( (_DWORD)result )
    goto LABEL_56;
  ++v40[357];
  if ( (*(_BYTE *)(a2 + 68) & 4) != 0 )
    ...
    v47 = 0;
  v40[358] += (unsigned int)(*(_DWORD *)(a2 + 112) + v47);
  ++*(_QWORD *)(a3 + 32);
  if ( (*(_BYTE *)(a2 + 68) & 4) != 0 )
    v48 = *(unsigned __int16 *)(a2 + 66);
  else
    v48 = 0;
  v49 = a3 + 2224 + 3256LL * a6;
  v50 = *(_QWORD *)(v49 + 992);
  *(_QWORD *)(a3 + 40) += (unsigned int)(*(_DWORD *)(a2 + 112) + v48);
  *(_QWORD *)(v49 + 992) = v50 + 1;
  if ( (*(_BYTE *)(a2 + 68) & 4) != 0 )
    v51 = *(unsigned __int16 *)(a2 + 66);
  else
    v51 = 0;
  *(_QWORD *)(a3 + 2224 + 3256LL * a6 + 1000) += (unsigned int)(*(_DWORD *)(a2 + 112) + v51);
  v52 = *(_DWORD *)(a2 + 48);
  *(_QWORD *)a2 = 0;
  *(_DWORD *)(a2 + 48) = v52 | 0x80;
