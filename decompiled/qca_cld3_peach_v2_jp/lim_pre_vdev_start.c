__int64 __fastcall lim_pre_vdev_start(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( !(_DWORD)result )
  {
    ...
    *(_BYTE *)(a2 + 123) = *(_BYTE *)(a3 + 7032);
    v15 = *(unsigned __int8 *)(a2 + 163);
    *(_WORD *)(a2 + 20) = *(_WORD *)(a3 + 7158);
    if ( v15 == 1 )
    {
      v16 = *(_QWORD *)(a2 + 504);
      *(_BYTE *)(a2 + 224) = *(_BYTE *)(a3 + 7020) != 0;
    ...
    *(_DWORD *)(a2 + 304) = *(unsigned __int16 *)(a3 + 8656);
    *(_BYTE *)(a2 + 64) = *(_BYTE *)(a3 + 155) != 0;
    *(_BYTE *)(a2 + 59) = *(_BYTE *)(a3 + 7170) != 0;
    *(_BYTE *)(*(_QWORD *)(a2 + 520) + 24006LL) = *(_BYTE *)(a3 + 7273);
    *(_BYTE *)(a2 + 397) = cds_is_5_mhz_enabled(v7, v8, v9, v10, v11, v12, v13, v14);
    is_10_mhz_enabled = cds_is_10_mhz_enabled(v17, v18, v19, v20, v21, v22, v23, v24);
    v26 = *(_QWORD *)(a2 + 504);
    *(_BYTE *)(a2 + 396) = is_10_mhz_enabled;
    v27 = *(_BYTE *)(a3 + 8635);
    *(_BYTE *)(a2 + 402) = v27;
    *(_BYTE *)(a2 + 403) = v27;
    ...
    if ( cmpt_obj )
    {
      ...
      {
        v46 = cmpt_obj;
        qdf_mem_copy((void *)(cmpt_obj + 129), (const void *)(a3 + 37), v28);
        cmpt_obj = v46;
      }
      *(_BYTE *)(cmpt_obj + 162) = v28;
    }
