__int64 __fastcall osif_cm_connect(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  __int64 v43; // x8
  __int64 v44; // x0
  int v45; // [xsp+40h] [xbp-10h] BYREF
  __int16 v46; // [xsp+44h] [xbp-Ch]
  ...
  if ( v8 || (LODWORD(v8) = v9, v9) )
    qdf_mem_copy((int)&v45, v8, 6u);
  vdev_by_macaddr_from_pdev = wlan_objmgr_get_vdev_by_macaddr_from_pdev(*(_QWORD *)(a2 + 152), &v45, 88);
  if ( vdev_by_macaddr_from_pdev )
  {
    ...
    qdf_trace_msg(
      ...
      "osif_cm_connect",
      *(unsigned __int8 *)(vdev_by_macaddr_from_pdev + 104),
      (unsigned __int8)v45,
      BYTE1(v45),
      BYTE2(v45),
      HIBYTE(v46));
...
LABEL_27:
    ...
    v23 = _qdf_mem_malloc(816, "osif_cm_connect", 793);
    if ( !v23 )
    {
      result = 4294967284LL;
      goto LABEL_28;
...
LABEL_87:
                ...
                started = osif_cm_set_fils_info(a2);
                if ( !started )
                {
                  osif_cm_fill_connect_params(v24, a4);
                  started = wlan_cm_start_connect(a2, v24);
                  if ( started )
                    qdf_trace_msg(72, 2, "%s: Connect failed with status %d", "osif_cm_connect", started);
                }
                goto LABEL_87;
              }
