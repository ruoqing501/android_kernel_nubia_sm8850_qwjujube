        ...
        double a12)
{
  ...
  if ( *(_QWORD *)(a1 + 576 + 8LL * a2) )
  {
    ...
    if ( (v26 & 1) != 0 )
    {
      *(_QWORD *)(a1 + 1248) = v26 & 0xFFFFFFFFFFFFFFFELL;
  ...
  *(_QWORD *)(a1 + 576 + 8LL * a2) = a3;
  *(_DWORD *)(a1 + 4LL * a2 + 1008) = a4;
  v27 = *(_QWORD *)(a1 + 1248);
  if ( (v27 & 1) != 0 )
  {
    *(_QWORD *)(a1 + 1248) = v27 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(a1 + 1240);
  }
  else
  {
...
LABEL_27:
  ...
  if ( (v32 & 1) != 0 )
  {
    *(_QWORD *)(a1 + 1248) = v32 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(a1 + 1240);
    if ( !v30 )
      goto LABEL_35;
LABEL_29:
...
LABEL_36:
    ...
    *(_DWORD *)(a1 + 1224) = v33;
    ...
    do
    {
      v36 = *(_DWORD **)(v35 + v34 + 4792);
      if ( v36 )
      {
        v37 = *(_QWORD *)(v35 + v34 + 5224);
        if ( *(v36 - 1) != -1609821410 )
          __break(0x8229u);
