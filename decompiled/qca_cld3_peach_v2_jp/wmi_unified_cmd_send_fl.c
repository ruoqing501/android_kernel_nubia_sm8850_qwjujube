        ...
        double a14)
{
  ...
  if ( v20 )
  {
    v21 = *(__int64 (**)(void))(*(_QWORD *)(a1 + 728) + 3488LL);
  ...
  if ( !*(_DWORD *)(a1 + 724) )
  {
    v37 = *(_QWORD *)(a2 + 224);
    v38 = v22;
    v39 = *(_DWORD **)(*(_QWORD *)(a1 + 728) + 3984LL);
    if ( *(v39 - 1) != 409496415 )
      __break(0x8228u);
  ...
  **(_DWORD **)(a2 + 224) = a4 & 0xFFFFFF | (*(unsigned __int8 *)(*(_QWORD *)(a2 + 224) + 3LL) << 24);
  ...
  if ( *(_DWORD *)(a1 + 24) >= (int)*(unsigned __int16 *)(a1 + 768) )
  {
    ...
    qdf_trace_msg(
      ...
      v115,
      v116,
      *(unsigned int *)(*(_QWORD *)(a1 + 760) + 7696LL),
      v125);
...
LABEL_60:
  ...
  *(_QWORD *)(v34 + 96) = a2;
  ...
  if ( *(_BYTE *)(a1 + 680) == 1 )
  {
    ...
    v137 = *(__int64 (__fastcall **)(_QWORD))(*(_QWORD *)(a1 + 728) + 3512LL);
    ...
    if ( (v137(a4) & 1) == 0 )
    {
      ...
      v139 = *(_QWORD *)(a2 + 224);
      v140 = *v138;
      v141 = *(unsigned int *)(*(_QWORD *)(a1 + 760) + 7752LL);
