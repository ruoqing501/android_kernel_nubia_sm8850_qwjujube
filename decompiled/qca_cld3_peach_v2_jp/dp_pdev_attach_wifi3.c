...
LABEL_11:
  wlan_minidump_log(v7, v8, v9, v10, v11, v12, v13, v14, v17, 95608, *(_QWORD *)(a1 + 16));
  v18 = *(_QWORD *)(a1 + 40);
  ...
  *(_QWORD *)s = 0;
  ...
  ((void (__fastcall *)(char *, __int64, __int64))qdf_ssr_driver_dump_register_region)(s, v17, 95608);
...
LABEL_48:
  ...
  v108 = *(_QWORD *)(*(_QWORD *)(v17 + 8) + 20056LL);
  if ( v108 )
  {
