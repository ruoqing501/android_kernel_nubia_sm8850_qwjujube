...
LABEL_24:
    ...
    *a5 = v40;
    ...
    v28 = lim_check_vht_op_mode_change((_QWORD *)a1, a3, *a5, a2 + 338, v51, v52, v53, v54, v55, v56, v57, v58);
    return v28 & 1;
  }
  if ( (wlan_cm_get_force_20mhz_in_24ghz(*(_QWORD *)(a3 + 16), v11, v12, v13, v14, v15, v16, v17, v18) & 1) == 0 )
  {
    v9 = *(unsigned __int8 *)(a1 + 17120);
    goto LABEL_6;
  }
  v27 = jiffies;
