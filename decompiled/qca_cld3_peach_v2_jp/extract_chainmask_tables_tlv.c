        ...
        __int64 a11)
{
  ...
  {
    v20 = jiffies;
    if ( extract_chainmask_tables_tlv___last_ticks_440 - jiffies + 125 < 0 )
    {
      qdf_trace_msg(
        0x31u,
        2u,
        ...
        a8,
        "extract_chainmask_tables_tlv");
      extract_chainmask_tables_tlv___last_ticks_440 = v20;
    }
    return 4;
  }
  v21 = 0;
    ...
    if ( *(_DWORD *)(v23 + 4) )
    {
      ...
      do
      {
        ...
        *(_DWORD *)(*(_QWORD *)(v23 + 8) + v25) = *(_DWORD *)(*(_QWORD *)(v23 + 8) + v25) & 0xFFFFFFEF
                                                | (16 * ((*(_DWORD *)(v13 + 4) >> 4) & 1));
        *(_DWORD *)(*(_QWORD *)(v23 + 8) + v25) = *(_DWORD *)(*(_QWORD *)(v23 + 8) + v25) & 0xFDFFFFFF
                                                | (((*(_DWORD *)(v13 + 4) >> 27) & 1) << 25);
        *(_DWORD *)(*(_QWORD *)(v23 + 8) + v25) = *(_DWORD *)(*(_QWORD *)(v23 + 8) + v25) & 0xFBFFFFFF
                                                | (((*(_DWORD *)(v13 + 4) >> 28) & 1) << 26);
        *(_DWORD *)(*(_QWORD *)(v23 + 8) + v25) = *(_DWORD *)(*(_QWORD *)(v23 + 8) + v25) & 0xF7FFFFFF
                                                | (((*(_DWORD *)(v13 + 4) >> 29) & 1) << 27);
        *(_DWORD *)(*(_QWORD *)(v23 + 8) + v25) = *(_DWORD *)(*(_QWORD *)(v23 + 8) + v25) & 0xEFFFFFFF
                                                | (((*(_DWORD *)(v13 + 4) >> 30) & 1) << 28);
        *(_DWORD *)(*(_QWORD *)(v23 + 8) + v25) = *(_DWORD *)(*(_QWORD *)(v23 + 8) + v25) & 0xDFFFFFFF
                                                | (*(_DWORD *)(v13 + 4) >> 31 << 29);
        *(_DWORD *)(*(_QWORD *)(v23 + 8) + v25) = *(_DWORD *)(*(_QWORD *)(v23 + 8) + v25) & 0xFFFFFFDF
                                                | (32 * ((*(_DWORD *)(v13 + 4) >> 5) & 1));
