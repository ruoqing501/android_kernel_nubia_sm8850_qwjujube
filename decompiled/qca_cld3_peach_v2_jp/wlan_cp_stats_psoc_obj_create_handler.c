...
LABEL_28:
        ...
        if ( !v45 )
        {
          ...
          *(_QWORD *)(v19 + 40) = *(unsigned int *)(cfg_psoc_get_values(a1) + 3928);
          *(_QWORD *)(v19 + 48) = *(unsigned int *)(cfg_psoc_get_values(a1) + 3928);
          wlan_cp_stats_cstats_init(a1);
          *(_BYTE *)(v19 + 56) = *(_BYTE *)(cfg_psoc_get_values(a1) + 1068);
          qdf_trace_msg(
            0x62u,
            8u,
