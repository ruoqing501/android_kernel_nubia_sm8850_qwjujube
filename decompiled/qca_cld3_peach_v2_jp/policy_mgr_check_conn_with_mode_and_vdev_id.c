__int64 __fastcall policy_mgr_check_conn_with_mode_and_vdev_id(__int64 a1, int a2, int a3)
{
  ...
  if ( context )
  {
    ...
    {
      if ( (_DWORD)pm_conc_connection_list == a2 && (_DWORD)qword_81C458 == a3 )
        goto LABEL_5;
      if ( BYTE4(qword_81C47C) == 1 )
      {
        if ( (_DWORD)qword_81C464 == a2 && (_DWORD)qword_81C47C == a3 )
          goto LABEL_5;
        if ( BYTE4(qword_81C4A0) != 1 )
          goto LABEL_23;
        if ( (_DWORD)qword_81C488 == a2 && (_DWORD)qword_81C4A0 == a3 )
        {
LABEL_5:
          v15 = 0;
LABEL_24:
        ...
        {
          if ( (_DWORD)qword_81C4AC != a2 || (_DWORD)qword_81C4C4 != a3 )
          {
            v15 = 16;
            if ( BYTE4(qword_81C4E8) == 1 )
            {
              if ( (_DWORD)qword_81C4E8 == a3 && (_DWORD)qword_81C4D0 == a2 )
                v15 = 0;
              else
                v15 = 16;
            }
