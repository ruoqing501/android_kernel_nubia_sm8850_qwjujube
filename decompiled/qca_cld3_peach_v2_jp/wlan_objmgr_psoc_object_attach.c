__int64 __fastcall wlan_objmgr_psoc_object_attach(__int64 a1)
{
  ...
  {
    raw_spin_lock(v2 + 11712);
  }
  else
  {
    raw_spin_lock_bh(v2 + 11712);
    *(_QWORD *)(v2 + 11720) |= 1uLL;
  }
  v4 = g_umac_glb_obj;
...
LABEL_16:
  ...
  if ( (v7 & 1) != 0 )
  {
    *(_QWORD *)(v4 + 11720) = v7 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(v4 + 11712);
  }
  else
  {
    raw_spin_unlock(v4 + 11712);
  }
  return v6;
}
