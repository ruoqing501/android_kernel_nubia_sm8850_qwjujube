__int64 __fastcall wlan_mlme_get_feature_info(__int64 a1, __int64 a2)
{
  ...
  if ( psoc_ext_obj_fl )
    *(_BYTE *)a2 = *(_BYTE *)(psoc_ext_obj_fl + 5684);
  else
  ...
  *(_WORD *)(a2 + 11) = 257;
  *(_DWORD *)(a2 + 28) = 15;
  if ( (*(_BYTE *)(cfg_psoc_get_values(a1) + 3911) & 1) == 0 )
    *(_DWORD *)(a2 + 28) |= 0x10u;
  v23 = *(unsigned __int8 *)(cfg_psoc_get_values(a1) + 3911);
  values = cfg_psoc_get_values(a1);
  if ( v23 == 1 && (*(_BYTE *)(values + 3914) & 1) == 0 )
    v25 = *(_DWORD *)(a2 + 28);
  else
    v25 = *(_DWORD *)(a2 + 28) | 0x20;
  *(_DWORD *)(a2 + 28) = v25 | 0x300;
  v26 = *(unsigned __int8 *)(cfg_psoc_get_values(a1) + 3911);
  v27 = cfg_psoc_get_values(a1);
  if ( v26 != 1 || *(_BYTE *)(v27 + 3914) == 1 )
    *(_DWORD *)(a2 + 28) |= 0x800u;
  if ( (*(_BYTE *)(cfg_psoc_get_values(a1) + 3911) & 1) == 0 )
    *(_DWORD *)(a2 + 28) |= 0x2000u;
  if ( *(_BYTE *)(cfg_psoc_get_values(a1) + 3910) == 1 )
    *(_DWORD *)(a2 + 28) |= 0x40u;
  if ( *(_BYTE *)(cfg_psoc_get_values(a1) + 3912) == 1 )
    *(_DWORD *)(a2 + 28) |= 0x80u;
  qdf_trace_msg(
    0x68u,
    8u,
