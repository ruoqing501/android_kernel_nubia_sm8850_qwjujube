        ...
        double a11)
{
  ...
  *a2 = 0;
  ...
  if ( *(_DWORD *)(a3 + 88) == 1 )
    ...
    v15 = (unsigned __int8 *)(*(_QWORD *)(a1 + 8) + 5436LL);
  v16 = *v15;
  v17 = *a2;
  if ( v16 )
  {
  ...
  *a2 = v18 & 0xFF3F;
  if ( *(_BYTE *)(a3 + 154) != 3 )
  {
    if ( *(_DWORD *)(a3 + 88) == 1 || *(_BYTE *)(*(_QWORD *)(a1 + 8) + 5388LL) == 1 )
    {
