__int64 __fastcall pld_get_thermal_state(__int64 a1, __int64 a2, unsigned int a3)
{
  __int64 v4; // x22
  __int64 v7; // x0
  __int64 v8; // x23
  ...
  if ( a1 && pld_ctx )
  {
    ...
    else
    {
      if ( (unsigned int)(v9 - 1) < 5 )
        return 4294967274LL;
      if ( !(_DWORD)v9 )
        return cnss_get_curr_therm_cdev_state(a1, a2, a3);
    }
  }
  else
  {
...
LABEL_16:
  ...
  printk(&unk_886A85, "pld_get_thermal_state", 2800, v9);
  return 4294967274LL;
}
