__int64 __fastcall ucfg_dp_req_set_arp_stats(
        __int64 a1,
        __int64 a2,
        double a3,
        double a4,
...
LABEL_8:
  ...
  v13 = *(__int64 (__fastcall **)(__int64, __int64))(comp_private_obj + 792);
  if ( *((_DWORD *)v13 - 1) != 1566005903 )
    __break(0x8228u);
  return v13(a1, a2);
}
