__int64 __fastcall wlan_objmgr_peer_component_obj_attach(__int64 a1, unsigned int a2, __int64 a3, int a4)
{
  ...
  if ( *(_QWORD *)(a1 + 104 + 8LL * a2) )
  {
    v12 = *(_QWORD *)(a1 + 768);
    if ( (v12 & 1) != 0 )
    {
      *(_QWORD *)(a1 + 768) = v12 & 0xFFFFFFFFFFFFFFFELL;
  ...
  *(_QWORD *)(a1 + 104 + 8LL * a2) = a3;
  *(_DWORD *)(a1 + 4LL * a2 + 536) = a4;
  v13 = *(_QWORD *)(a1 + 768);
  if ( (v13 & 1) != 0 )
  {
    *(_QWORD *)(a1 + 768) = v13 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(a1 + 760);
  }
  else
  {
...
LABEL_27:
  ...
  if ( (v26 & 1) != 0 )
  {
    *(_QWORD *)(a1 + 768) = v26 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(a1 + 760);
    if ( !v25 )
      goto LABEL_35;
LABEL_29:
...
LABEL_36:
    ...
    *(_DWORD *)(a1 + 752) = v27;
    ...
    do
    {
      v30 = *(_DWORD **)(v29 + v28 + 10408);
      if ( v30 )
      {
        v31 = *(_QWORD *)(v29 + v28 + 10840);
        if ( *(v30 - 1) != -202286667 )
          __break(0x8229u);
