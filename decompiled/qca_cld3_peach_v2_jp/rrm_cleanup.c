        ...
        double a10)
{
  ...
  {
    v12 = *(_QWORD *)(result + 20160 + 8LL * (unsigned __int8)a2);
    if ( v12 )
    {
      if ( *(_BYTE *)(v12 + 16) )
      {
      ...
      if ( *(_BYTE *)(v12 + 3) == 7 )
      {
        ...
        qdf_mem_set((void *)(v10 + 21224), 0x118u, 0);
      }
      _qdf_mem_free(v12);
      v13 = *(unsigned __int8 *)(v10 + 20158);
      *(_QWORD *)(v10 + 20160 + 8LL * v11) = 0;
