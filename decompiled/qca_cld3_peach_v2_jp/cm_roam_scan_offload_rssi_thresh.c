__int64 __fastcall cm_roam_scan_offload_rssi_thresh(__int64 a1, unsigned int a2, __int64 a3, __int64 a4)
{
  ...
  if ( !result )
    return result;
  v17 = result;
  if ( *(_BYTE *)(a4 + 1367) == 1 && (*(_BYTE *)(a4 + 92) & 1) == 0 )
  {
    v19 = *(unsigned __int8 *)(result + 2568);
    goto LABEL_7;
  }
  v18 = *(_DWORD *)(result + 2484);
  if ( !v18 )
  {
    qdf_trace_msg(
      0x68u,
...
LABEL_7:
  ...
  *(_DWORD *)(a3 + 16) = *(_DWORD *)(v17 + 1668);
  *(_DWORD *)(a3 + 64) = *(_DWORD *)(v17 + 1592);
  v42 = *(_DWORD *)(v17 + 1596);
  *(_DWORD *)(a3 + 68) = v42;
  *(_DWORD *)(a3 + 76) = *(_DWORD *)(v17 + 1588);
  if ( v42 < *(char *)(a4 + 676) )
    *(_DWORD *)(a3 + 72) = 1;
  *(_BYTE *)(a3 + 84) = *(_DWORD *)(v17 + 1600);
  *(_DWORD *)(a3 + 88) = *(_DWORD *)(v17 + 1604);
  *(_BYTE *)(a3 + 85) = *(_DWORD *)(v17 + 1608);
  *(_DWORD *)(a3 + 92) = *(_DWORD *)(v17 + 1612);
  *(_DWORD *)(a3 + 96) = *(_DWORD *)(v17 + 1616);
  *(_DWORD *)(a3 + 100) = *(_DWORD *)(v17 + 1620);
  *(_DWORD *)(a3 + 20) = *(_DWORD *)(v17 + 1680);
  *(_BYTE *)(a3 + 36) = *(_DWORD *)(v17 + 1672);
  *(_BYTE *)(a3 + 37) = *(_DWORD *)(v17 + 1684);
  *(_DWORD *)(a3 + 40) = *(_DWORD *)(v17 + 1676);
  *(_DWORD *)(a3 + 44) = *(_DWORD *)(v17 + 1688);
  if ( *(_DWORD *)(v17 + 2480) )
    v43 = -96;
  else
    v43 = 0;
  *(_DWORD *)(a3 + 48) = v43;
  v44 = *(unsigned __int8 *)(v17 + 1560);
  *(_BYTE *)(a3 + 52) = v44;
  if ( v44 == 1 )
  {
    *(_DWORD *)(a3 + 56) = *(char *)(v17 + 1585);
    *(_DWORD *)(a3 + 60) = *(char *)(v17 + 1586);
  }
