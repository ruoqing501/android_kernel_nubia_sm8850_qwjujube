        ...
        double a13)
{
  ...
  v17 = 0;
  v18 = 1;
  if ( (unsigned __int16)a2[929] == v16 || (unsigned __int16)a2[930] == v16 )
    goto LABEL_19;
  if ( !a2[931] || !a2[932] )
  {
    LODWORD(v17) = 2;
  ...
  v18 = 3;
  v17 = 2;
  if ( (unsigned __int16)a2[931] == v16 || (unsigned __int16)a2[932] == v16 )
    goto LABEL_19;
  if ( !a2[933] || !a2[934] )
  {
    LODWORD(v17) = 4;
  ...
  v18 = 5;
  v17 = 4;
  if ( (unsigned __int16)a2[933] == v16 || (unsigned __int16)a2[934] == v16 )
  {
LABEL_19:
    v15[v17] = 0;
    v15[v18] = 0;
  ...
  if ( a2[935] && a2[936] )
  {
    v18 = 7;
    v17 = 6;
    if ( (unsigned __int16)a2[935] != v16 && (unsigned __int16)a2[936] != v16 )
      goto LABEL_23;
    goto LABEL_19;
  }
  LODWORD(v17) = 6;
