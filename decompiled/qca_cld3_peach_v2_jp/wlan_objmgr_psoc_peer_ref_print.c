__int64 __fastcall wlan_objmgr_psoc_peer_ref_print(__int64 a1, __int64 a2)
{
  ...
  {
    raw_spin_lock(a2 + 760);
    v4 = *(_QWORD *)(a2 + 768);
  }
  else
  {
    raw_spin_lock_bh(a2 + 760);
    v4 = *(_QWORD *)(a2 + 768) | 1LL;
    *(_QWORD *)(a2 + 768) = v4;
  }
  v5 = *(_DWORD *)(a2 + 752);
  v6 = *(unsigned __int8 *)(*(_QWORD *)(a2 + 88) + 104LL);
  if ( (v4 & 1) != 0 )
  {
    *(_QWORD *)(a2 + 768) = v4 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(a2 + 760);
  }
  else
  {
    raw_spin_unlock(a2 + 760);
  }
  qdf_trace_msg(
    0x57u,
    1u,
