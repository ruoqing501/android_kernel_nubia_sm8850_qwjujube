        ...
        double a9)
{
  ...
  if ( context )
  {
    ...
    if ( a1[182] == 2 || !*a1 )
    {
      if ( policy_mgr_concurrent_beaconing_sessions_running(context[2694])
        || *((_BYTE *)a1 + 1552) == 5
        && ((unsigned int)policy_mgr_mode_specific_connection_count(v19[2694], 1, nullptr)
         || (unsigned int)policy_mgr_mode_specific_connection_count(v19[2694], 3, nullptr)) )
      {
        sme_get_beaconing_concurrent_operation_channel(v19, *((unsigned __int8 *)a1 + 12));
      }
      if ( (unsigned int)policy_mgr_get_concurrency_mode(v19[2694]) != 3 && *((_BYTE *)a1 + 1552) == 5 )
        policy_mgr_get_concurrency_mode(v19[2694]);
      v21 = *((_QWORD *)a1 + 186);
      if ( v21 )
      {
        _qdf_mem_free(v21);
      ...
      if ( v138 && (v31 = v139[0]) != 0 )
      {
        ...
        if ( v32 )
        {
          ...
          if ( v35 )
          {
            ...
            scan_id = wlan_scan_get_scan_id(v19[2694], v44, v45, v46, v47, v48, v49, v50, v51);
            v53 = *(_DWORD *)(v34 + 92);
            *(_DWORD *)(v34 + 16) = v33;
            v54 = 0;
            ...
            *((_BYTE *)a1 + 1496) = v30;
            *((_BYTE *)a1 + 1754) = 0;
            *(_QWORD *)((char *)a1 + 1755) = 0;
            *(_QWORD *)((char *)a1 + 1763) = 0;
            *(_QWORD *)((char *)a1 + 1771) = 0;
              ...
              *((_BYTE *)a1 + 1753) = 0;
              ...
              if ( v137 )
              {
                ...
                if ( *(_BYTE *)(v34 + 120) )
                {
                  ...
                  v70 = 0;
                  v135 = (_DWORD *)(v34 + 124);
                  v136 = *(_DWORD *)(*((_QWORD *)a1 + 192) + 588LL);
                  do
                  {
                    if ( v69 == 102 )
                      goto LABEL_69;
...
LABEL_60:
            if ( *(_BYTE *)(v34 + 120) )
            {
              *(_BYTE *)(*((_QWORD *)a1 + 192) + 584LL) = 0;
              *((_QWORD *)a1 + 193) = qdf_get_time_of_the_day_ms();
