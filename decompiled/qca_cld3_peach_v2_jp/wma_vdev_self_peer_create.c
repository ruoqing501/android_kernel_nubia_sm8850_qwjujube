        ...
        double a9)
{
  ...
  v12 = (__int64)context;
  if ( mlme_vdev_uses_self_peer(*(unsigned __int8 *)(a1 + 163), *(unsigned __int8 *)(a1 + 164)) )
  {
...
LABEL_15:
  ...
  objmgr_peer = wma_create_objmgr_peer(v12, *(unsigned __int8 *)(v10 + 104), (unsigned __int8 *)v32, 0);
  result = 0;
  if ( !objmgr_peer )
  {
    qdf_trace_msg(
