...
LABEL_70:
          ...
          case 0xDu:
            ...
            goto LABEL_67;
          case 0xEu:
            if ( (policy_mgr_get_dfs_master_dynamic_enabled(v26[2694]) & 1) != 0 )
...
LABEL_29:
    ...
    if ( a3 > 46 )
    {
      ...
      v80 = wlan_reg_legacy_chan_to_freq(
              ...
              *((unsigned __int8 *)a1 + 1613),
              ...
              v78);
      *v79 = v80;
      v79[4] = *((unsigned __int8 *)a1 + 1614);
      v79[5] = *((unsigned __int8 *)a1 + 1614);
      if ( !v80 )
      {
        qdf_trace_msg(
          0x39u,
    ...
    else
    {
      ...
      {
LABEL_26:
        if ( (sap_is_csa_vdev_restart_state(v26[2694], a1) & 1) != 0 )
        {
...
LABEL_37:
      ...
      if ( (wlan_pre_cac_get_status(v26[2694]) & 1) != 0 )
      {
