__int64 __fastcall target_if_nlo_complete_handler(
        __int64 a1,
        __int64 a2,
        double a3,
        double a4,
...
LABEL_13:
    qdf_trace_msg(0x49u, 2u, v33, v12, v13, v14, v15, v16, v17, v18, v19, "target_if_nlo_complete_handler");
    return 4294967274LL;
  }
  v22 = psoc_from_scn_hdl;
  v23 = _qdf_mem_malloc(0x38u, "target_if_nlo_complete_handler", 158);
  if ( !v23 )
    return 4294967284LL;
  v24 = v23;
  if ( (unsigned int)wmi_extract_nlo_complete_ev_param(v21, a2, v23 + 8) )
  {
    qdf_trace_msg(
      0x49u,
      2u,
      "%s: Failed to extract WMI PNO complete event",
      v25,
      v26,
      v27,
      v28,
...
LABEL_9:
  ...
  qdf_trace_msg(
    0x49u,
    8u,
    "%s: PNO complete event received for vdev %d",
    v25,
    v26,
    v27,
    v28,
