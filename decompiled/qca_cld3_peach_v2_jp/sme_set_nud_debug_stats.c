__int64 __fastcall sme_set_nud_debug_stats(__int64 a1, const void *a2)
{
  void *v3; // x0
  __int64 v4; // x19
  __int64 result; // x0
  ...
  v14 = 0;
  v15 = 0;
  v3 = (void *)_qdf_mem_malloc(0x20u, "sme_set_nud_debug_stats", 14017);
  if ( v3 )
  {
    v4 = (__int64)v3;
    ...
    result = scheduler_post_message_debug(
               ...
               0x36CEu,
               (__int64)"sme_set_nud_debug_stats");
    if ( (_DWORD)result )
    {
      qdf_trace_msg(
        0x34u,
