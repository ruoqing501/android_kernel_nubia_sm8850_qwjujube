...
LABEL_96:
    ...
    {
      case 6:
        if ( !(unsigned int)policy_mgr_get_mac_id_by_session_id(*v24, *(_BYTE *)(*(_QWORD *)(v23 + 55512) + 8LL), v143) )
        {
...
LABEL_80:
      ...
      case 8:
        ...
        if ( v89 )
        {
          v98 = *(unsigned __int8 *)(v89 + 184);
          v99 = *(unsigned __int8 *)(v89 + 185);
        }
        else
        {
          v99 = 0;
...
LABEL_56:
    ...
    qdf_trace_msg(
      ...
      v110,
      "__wlan_hdd_cfg80211_sr_operations",
      *(unsigned __int8 *)(*(_QWORD *)(v23 + 55512) + 8LL));
    v83 = -11;
    goto LABEL_22;
  }
  __break(0x800u);
