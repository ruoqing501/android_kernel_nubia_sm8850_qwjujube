        ...
        __int64 a11)
{
  ...
  if ( context )
  {
    ...
    if ( cmpt_obj )
    {
      v34 = cmpt_obj;
      v35 = (_BYTE *)(a11 + 7022);
      qdf_mem_copy((void *)(cmpt_obj + 168), (const void *)(a11 + 24), 6u);
      if ( *(_BYTE *)(a11 + 8676) == 1 )
      {
      ...
      *(_DWORD *)(a11 + 72) = 16;
      ...
      {
        v38 = _qdf_mem_malloc(0x138u, "lim_mlm_add_bss", 361);
        if ( v38 )
        {
          v39 = v38;
          *(_BYTE *)(v38 + 294) = *(_BYTE *)(a11 + 7170);
          *(_BYTE *)(v38 + 17) = *(_BYTE *)(a11 + 155);
          *(_DWORD *)(v38 + 296) = *(_DWORD *)(a11 + 7176);
          *(_BYTE *)(v38 + 18) = (*(_BYTE *)(a11 + 7024) & 0x10) != 0;
          *(_BYTE *)(v38 + 55) = lim_get_ht_capability(a1, 9, a11);
          *(_BYTE *)(v39 + 54) = lim_get_ht_capability(a1, 8, a11);
