__int64 __fastcall drv_cmd_get_roam_delta(__int64 a1, __int64 *a2, const char *a3, __int64 a4, __int64 a5)
{
  __int64 v8; // x0
  unsigned int v9; // w1
  unsigned int roam_rssi_diff; // w0
  double v11; // d0
  double v12; // d1
  double v13; // d2
  double v14; // d3
  ...
  v44[0] = 0;
  memset(v45, 0, 32);
  roam_rssi_diff = ucfg_cm_get_roam_rssi_diff(v8, v9, v44);
  if ( roam_rssi_diff )
  {
    result = qdf_status_to_os_return(roam_rssi_diff);
  }
  else
  {
    qdf_trace_msg(
      ...
      v17,
      v18,
      "drv_cmd_get_roam_delta",
      *(unsigned __int8 *)(a1 + 8),
      v44[0]);
    qdf_mtrace(51, 51, 0xAu, *(_BYTE *)(a1 + 8), v44[0]);
