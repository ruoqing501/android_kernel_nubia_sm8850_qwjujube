__int64 __fastcall lim_send_he_caps_ie(__int64 a1, int a2, unsigned int a3)
{
  ...
  v7 = (a2 != 11) | ucfg_nan_is_beamforming_supported(*(_QWORD *)(a1 + 21552));
  if ( (v7 & 1) != 0 )
  {
...
LABEL_10:
      ...
      if ( a2 != 1 )
        goto LABEL_22;
LABEL_18:
      wlan_twt_get_responder_cfg(*(_QWORD *)(a1 + 21552), &v83);
      v20 = wlan_twt_check_responder_bit(*(_QWORD *)(a1 + 21552), a3, (unsigned int)a2, (unsigned __int8)v83);
...
LABEL_4:
  if ( a2 == 3 )
  {
    if ( !wlan_vdev_p2p_is_wfd_r2_mode(*(_QWORD *)(a1 + 21552), a3, v8, v9, v10, v11, v12, v13, v14, v15) )
      goto LABEL_22;
    goto LABEL_18;
  }
  if ( a2 == 2 && wlan_vdev_p2p_is_wfd_r2_mode(*(_QWORD *)(a1 + 21552), a3, v8, v9, v10, v11, v12, v13, v14, v15) )
  {
LABEL_13:
    ucfg_twt_cfg_get_requestor(*(_QWORD *)(a1 + 21552), (char *)&v83 + 4);
    if ( BYTE4(v83) )
