void *__fastcall sme_update_tgt_he_cap(_QWORD *a1, __int64 a2, __int64 a3)
{
  ...
  v6 = a1 + 2560;
  v7 = *(_BYTE *)(a1[1] + 2667LL);
  qdf_mem_copy((char *)a1 + 21716, (const void *)(a2 + 284), 0x3Cu);
  qdf_mem_copy(a1 + 2722, (const void *)(a2 + 344), 0x3Cu);
  v16 = a1[1];
  if ( (*(_BYTE *)(v16 + 1296) & 0x1E) == 0 )
  {
    qdf_trace_msg(
      0x34u,
      8u,
      ...
      (*(_QWORD *)((char *)v6 + 1237) >> 57) & 0xFLL,
      (*(_QWORD *)((char *)v6 + 1297) >> 57) & 0xFLL);
    v16 = a1[1];
    v17 = *(_QWORD *)((char *)v6 + 1297) & 0xE1FFFFFFFFFFFFFFLL;
    *(_QWORD *)((char *)v6 + 1237) &= 0xE1FFFFFFFFFFFFFFLL;
    *(_QWORD *)((char *)v6 + 1297) = v17;
  }
  v18 = (_QWORD *)((char *)v6 + 1245);
  v19 = a2 + 293;
  v20 = *(_QWORD *)((char *)v6 + 1245);
  v256 = a1;
  if ( *(_BYTE *)(v16 + 1465) )
  {
    v21 = *(_QWORD *)((char *)v6 + 1305);
  }
  else
  {
    qdf_trace_msg(
      ...
      (*(_DWORD *)((char *)v6 + 1305) >> 7) & 3);
    v20 = *v18 & 0xFFFFFFFFFFFFFE7FLL;
    v16 = a1[1];
    v21 = *(_QWORD *)((char *)v6 + 1305) & 0xFFFFFFFFFFFFFE7FLL;
    *v18 = v20;
    *(_QWORD *)((char *)v6 + 1305) = v21;
  }
  v22 = v21 & 0xFFFFFFFFFFC7FFFFLL;
  v23 = (_QWORD *)((char *)v6 + 1305);
  v24 = *((unsigned __int16 *)v6 + 628);
  v25 = (*(_DWORD *)v19 >> 19) & 7;
  v26 = *((unsigned __int16 *)v6 + 658);
  v27 = *((unsigned __int16 *)v6 + 659);
  v257 = v6;
  v255 = v16;
  if ( v25 >= ((*(_DWORD *)(a3 + 9) >> 19) & 7u) )
    v25 = (*(_DWORD *)(a3 + 9) >> 19) & 7;
  *(_QWORD *)((char *)v6 + 1245) = v20 & 0xFFFFFFFFF8C7FFFFLL | (v25 << 19);
  v28 = -4LL << (2 * v7);
  ...
  v35 = *((unsigned __int16 *)v6 + 629) | (unsigned int)v28;
  v36 = v22 | (v29 << 19);
  v37 = v26 | v28;
  v38 = v27 | v28;
  *v23 = v36;
  ...
  *v23 = v39 | (v45 << 24);
  ...
  v67 = (v52 >> 6) & 1;
  LOWORD(v63) = v59 | v63 | (2 * (v53 & (*(_WORD *)(v16 + 1308) >> 3) | v57));
  ...
  *((_WORD *)v257 + 628) = v86 | v93;
  v96 = *(unsigned __int16 *)(v255 + 1310);
  v97 = (v96 >> 2) & 1;
  v98 = (v96 >> 1) & v96 & 1 | ((unsigned __int16)v35 >> 1) & v35 & 1;
  v99 = (unsigned __int16)v35 >> 3;
  v100 = (v35 >> 2) & 1;
  LOWORD(v57) = (v95 ^ v35 & 1) & ~(*(_WORD *)(v92 + 1310) >> 1) & v96
              | ((*(_WORD *)(v92 + 1310) >> 1) ^ *(_WORD *)(v92 + 1310)) & ~((unsigned __int16)v35 >> 1) & v35 & 1;
  ...
  LOWORD(v121) = ((*(_WORD *)(v92 + 1310) >> 11) ^ (*(_WORD *)(v92 + 1310) >> 10)) & ~(_WORD)v130 & v131;
  v138 = v132 | v131;
  ...
  LOWORD(v137) = (((unsigned __int16)v141 | (unsigned __int16)v139) << 14)
               ...
               | ((((v94 >> 13)
                 ...
                 & (*(_WORD *)(v92 + 1310) >> 12)
                 | (v143 ^ (*(_WORD *)(v92 + 1310) >> 12)) & (unsigned __int16)~(_WORD)v138 & (unsigned __int16)v142
                 | (unsigned __int16)(2
  ...
  *((_WORD *)v257 + 629) = v137 | v142;
  v147 = *(unsigned __int16 *)(v255 + 1308);
  v148 = (v147 >> 2) & 1;
  v149 = (v147 >> 1) & v147 & 1 | ((unsigned __int16)v37 >> 1) & v37 & 1;
  v150 = (unsigned __int16)v37 >> 3;
  v151 = (v37 >> 2) & 1;
  LOWORD(v96) = (v146 ^ v37 & 1) & ~(*(_WORD *)(v92 + 1308) >> 1) & v147
              | ((*(_WORD *)(v92 + 1308) >> 1) ^ *(_WORD *)(v92 + 1308)) & ~((unsigned __int16)v37 >> 1) & v37 & 1;
  ...
  LOWORD(v172) = ((*(_WORD *)(v92 + 1308) >> 11) ^ (*(_WORD *)(v92 + 1308) >> 10)) & ~(_WORD)v181 & v182;
  v189 = v183 | v182;
  ...
  LOWORD(v188) = (((unsigned __int16)v192 | (unsigned __int16)v190) << 14)
               ...
               | ((((v145 >> 13)
                 ...
                 & (*(_WORD *)(v92 + 1308) >> 12)
                 | (v194 ^ (*(_WORD *)(v92 + 1308) >> 12)) & (unsigned __int16)~(_WORD)v189 & (unsigned __int16)v193
                 | (unsigned __int16)(2
  ...
  *((_WORD *)v257 + 658) = v188 | v193;
  v198 = (unsigned __int16)v38 >> 1;
  v199 = *(unsigned __int16 *)(v255 + 1310);
  v200 = (v199 >> 2) & 1;
  ...
  LOWORD(v219) = ((*(_WORD *)(v92 + 1310) >> 11) ^ (*(_WORD *)(v92 + 1310) >> 10)) & ~(_WORD)v229 & v230;
  v237 = v231 | v230;
  ...
  LOWORD(v236) = (((unsigned __int16)v240 | (unsigned __int16)v238) << 14)
               ...
               | ((((v196 >> 13)
                 ...
                 & (*(_WORD *)(v255 + 1310) >> 12)
                 | (v242 ^ (*(_WORD *)(v255 + 1310) >> 12)) & (unsigned __int16)~(_WORD)v237 & (unsigned __int16)v241
                 | (unsigned __int16)(2
               ...
               | (4 * (v213 | v207))
               | v201;
  v244 = *(_QWORD *)((char *)v257 + 1237);
  *((_WORD *)v257 + 659) = v236;
  v245 = ((unsigned int)v244 >> 3) & 3;
  v246 = (unsigned int)v244 >> 3;
  v247 = v244 & 0xFFFFFFFFFFFFFFE7LL;
  if ( v245 >= *(unsigned __int8 *)(v255 + 1464) )
    v248 = *(_BYTE *)(v255 + 1464);
  else
    v248 = v246;
  v249 = v247 | (8 * (v248 & 3u));
  v250 = *(_QWORD *)((char *)v257 + 1297);
  *(_QWORD *)((char *)v257 + 1237) = v249;
  LODWORD(v249) = ((unsigned int)v250 >> 3) & 3;
  v251 = (unsigned int)v250 >> 3;
  v252 = v250 & 0xFFFFFFFFFFFFFFE7LL;
  if ( (unsigned int)v249 >= *(unsigned __int8 *)(v255 + 1464) )
    v253 = *(_BYTE *)(v255 + 1464);
  else
    v253 = v251;
  *(_QWORD *)((char *)v257 + 1297) = v252 | (8 * (v253 & 3u));
  qdf_mem_copy((char *)v256 + 21836, (char *)v256 + 21716, 0x3Cu);
  return qdf_mem_copy(v256 + 2737, v256 + 2722, 0x3Cu);
}
