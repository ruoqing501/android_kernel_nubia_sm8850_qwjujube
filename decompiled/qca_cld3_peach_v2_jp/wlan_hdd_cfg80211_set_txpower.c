...
LABEL_15:
    ...
    {
      v69 = *(_QWORD *)(v26 + 55512);
      if ( !hdd_cm_is_vdev_associated(*(_DWORD **)(v26 + 55512)) )
      {
        ...
        *(_BYTE *)(a1 + 9817) = 0;
        ...
        if ( a3 >= 2 )
        {
          ...
          v70 = sme_set_tx_power(
                  v48,
                  *(unsigned __int8 *)(*(_QWORD *)(v26 + 55512) + 8LL),
                  v47,
