...
LABEL_9:
  ...
  if ( (_DWORD)v26 == 1 )
  {
    ...
    if ( ((unsigned __int8)v26 & 1) == 0 )
      wlan_cm_roam_cfg_set_value(a1[2694], a2, 0x22u, (unsigned int *)v28);
  }
  wlan_objmgr_vdev_release_ref(v15, 0xBu, v26, v18, v19, v20, v21, v22, v23, v24, v25);
  *(_DWORD *)(a1[1] + 3420LL) = v28[0];
  result = wlan_cm_roam_cfg_set_value(a1[2694], a2, 0x2Au, (unsigned int *)v28);
LABEL_10:
