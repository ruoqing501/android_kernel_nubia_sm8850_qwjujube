  ...
  else
  {
    ...
    if ( v18 )
    {
      ...
      if ( v20 )
      {
        ...
        if ( v22 )
        {
          v23 = (*(_DWORD *)(v11 + 3244 + 4LL * a3) >> v15) & 7;
          v24 = v23 >= v19 ? v19 : v23;
          if ( v24 )
          {
            if ( a2 < 0x11 && ((0x189AFu >> a2) & 1) != 0 )
            ...
            v26 = 4LL * a3;
            *(_DWORD *)(*(_QWORD *)(v13 + 8) + v26 + 3252) &= ~(7 << v25);
            if ( v22 >= 2 )
              v27 = 2;
            else
              v27 = v22;
            *(_DWORD *)(*(_QWORD *)(v13 + 8) + v26 + 3252) |= v27 << v25;
            *(_DWORD *)(*(_QWORD *)(v13 + 8) + v26 + 3244) &= ~(7 << v25);
            v28 = *(_QWORD *)(v13 + 8) + v26;
            if ( v24 >= 2 )
              v29 = 2;
            else
              v29 = v24;
            *(_DWORD *)(v28 + 3244) |= v29 << v25;
            qdf_trace_msg(
              0x34u,
              8u,
