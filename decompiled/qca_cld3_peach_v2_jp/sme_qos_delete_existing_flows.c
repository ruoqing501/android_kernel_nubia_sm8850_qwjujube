        ...
        double a10)
{
  ...
  result = csr_ll_peek_head((__int64)&unk_856128, 1, a3, a4, a5, a6, a7, a8, a9, a10);
  if ( result )
  {
    v21 = result;
    do
    {
      result = csr_ll_next((__int64)&unk_856128, v21, 1, v13, v14, v15, v16, v17, v18, v19, v20);
      v30 = result;
      if ( *(unsigned __int8 *)(v21 + 16) == a2 )
      {
        ...
        qdf_trace_msg(
          ...
          v21,
          *(unsigned int *)(v21 + 24));
        csr_ll_remove_entry((__int64)&unk_856128, (__int64 *)v21, 1, v22, v23, v24, v25, v26, v27, v28, v29);
