...
LABEL_9:
        ...
        if ( v31 )
        {
          ...
          if ( BYTE4(qword_81C458) == 1
            || (v49 = &qword_81C464, (qword_81C47C & 0x100000000LL) != 0)
            || (v49 = &qword_81C488, (qword_81C4A0 & 0x100000000LL) != 0)
            || (v49 = &qword_81C4AC, (qword_81C4C4 & 0x100000000LL) != 0)
            || (v49 = &qword_81C4D0, (qword_81C4E8 & 0x100000000LL) != 0) )
          {
            v50 = *((_DWORD *)v49 + 6);
            qdf_trace_msg(
              0x4Fu,
          ...
          else
          {
            ...
            if ( first_vdev )
            {
              v50 = *((unsigned __int8 *)first_vdev + 104);
