__int64 __fastcall wlan_cm_tgt_send_roam_ho_delay_config(__int64 a1, __int64 a2, unsigned int a3)
{
  unsigned int v4; // w20
  __int64 v5; // x0
  double v6; // d0
...
LABEL_11:
  ...
  v18 = *(_DWORD **)(ext_hdl + 7224);
  if ( v18 )
  {
    if ( *(v18 - 1) != -1687241691 )
      __break(0x8228u);
    v20 = ((__int64 (__fastcall *)(__int64, _QWORD, _QWORD))v18)(v15, v4, a3);
    if ( v20 )
      qdf_trace_msg(
        0x68u,
        8u,
        "%s: vdev %d fail to send roam HO delay config",
        v21,
        v22,
        v23,
        v24,
...
LABEL_12:
  qdf_trace_msg(
    0x68u,
    2u,
    "%s: vdev %d send_roam_ho_delay_config is NULL",
    v6,
    v7,
    v8,
    v9,
