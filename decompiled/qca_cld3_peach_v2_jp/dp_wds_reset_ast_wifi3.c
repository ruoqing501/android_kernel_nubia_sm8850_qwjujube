__int64 __fastcall dp_wds_reset_ast_wifi3(__int64 a1, __int64 a2, __int64 a3, unsigned __int8 a4)
{
  ...
  if ( a4 <= 5u && (*(_BYTE *)(a1 + 17650) & 1) == 0 )
  {
    ...
    if ( v10 )
    {
      ...
      if ( (v56 & 1) != 0 )
      {
        *(_QWORD *)(a1 + 18936) = v56 & 0xFFFFFFFFFFFFFFFELL;
...
LABEL_44:
          if ( a2 )
          {
            ...
            if ( (v61 & 1) != 0 )
            {
              *(_QWORD *)(a1 + 17584) = v61 & 0xFFFFFFFFFFFFFFFELL;
...
LABEL_24:
          ...
          if ( (v41 & 1) != 0 )
          {
            *(_QWORD *)(a1 + 17584) = v41 & 0xFFFFFFFFFFFFFFFELL;
            raw_spin_unlock_bh(a1 + 17576);
          }
          else
          {
...
LABEL_27:
    ...
    if ( (v50 & 1) != 0 )
    {
      *(_QWORD *)(a1 + 18936) = v50 & 0xFFFFFFFFFFFFFFFELL;
      raw_spin_unlock_bh(a1 + 18928);
    }
    else
    {
