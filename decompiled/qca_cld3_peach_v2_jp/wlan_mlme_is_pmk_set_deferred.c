__int64 __fastcall wlan_mlme_is_pmk_set_deferred(__int64 a1, __int64 a2)
{
  __int64 v2; // x0
  double v3; // d0
  double v4; // d1
  ...
  if ( !v2 )
  {
    v23 = "%s: get vdev failed";
    v24 = 104;
LABEL_6:
    qdf_trace_msg(v24, 2u, v23, v3, v4, v5, v6, v7, v8, v9, v10, "wlan_mlme_is_pmk_set_deferred");
    v22 = 0;
    return v22 & 1;
  }
  v11 = v2;
