__int64 __fastcall pre_cac_handle_cac_end(__int64 a1)
{
  __int64 v1; // x8
  __int64 v3; // x21
  ...
  if ( comp_private_obj )
  {
    ...
    if ( glbl_pre_cac_ops )
    {
      ...
      if ( *(_QWORD *)glbl_pre_cac_ops )
      {
        if ( *(v15 - 1) != -1125204353 )
          __break(0x8228u);
        ((void (__fastcall *)(__int64, _QWORD, __int64))v15)(v3, (unsigned int)v13, 1);
        v13 = *(unsigned __int8 *)(a1 + 104);
      }
    }
    qdf_trace_msg(
      ...
      v11,
      v12,
      "pre_cac_handle_cac_end",
      v13);
    v16 = *(_BYTE *)(a1 + 104);
    *(_QWORD *)(v14 + 32) = pre_cac_handle_success;
    *(_QWORD *)(v14 + 40) = v3;
    *(_BYTE *)(v14 + 48) = v16;
