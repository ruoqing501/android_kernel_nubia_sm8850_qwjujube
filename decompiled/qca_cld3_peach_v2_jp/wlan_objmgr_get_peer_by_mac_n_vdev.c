__int64 __fastcall wlan_objmgr_get_peer_by_mac_n_vdev(__int64 a1, char a2, const void *a3, _BYTE *a4, unsigned int a5)
{
...
LABEL_5:
      ...
      v28[0] = 0;
      v14 = 0;
      if ( (unsigned int)qdf_list_peek_front((_QWORD *)(v13 + 128), v28) || (v15 = v28[0]) == 0 )
      {
LABEL_17:
        v24 = *(_QWORD *)(a1 + 1672);
        if ( (v24 & 1) != 0 )
      ...
      {
        while ( (unsigned int)qdf_mem_cmp((const void *)(v15 + 48), a4, 6u)
             || (unsigned int)qdf_mem_cmp((const void *)(*(__int64 *)((char *)&qword_58 + v15) + 74), a3, 6u)
             || byte_36[v15] != a2
             || (unsigned int)wlan_objmgr_peer_try_get_ref(v15, a5, v16, v17, v18, v19, v20, v21, v22, v23) )
        {
          v28[0] = 0;
          v14 = 0;
          if ( !(unsigned int)qdf_list_peek_next((_QWORD *)(v13 + 128), (_QWORD *)v15, v28) )
          {
            v15 = v28[0];
            if ( v28[0] )
              continue;
