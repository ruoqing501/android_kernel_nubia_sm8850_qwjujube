            ...
            *(_DWORD *)(v33 + 436) = *v38;
            ...
            if ( *(_DWORD *)(v37 + 304) )
            {
              qdf_trace_msg(
                ...
                v49,
                "wma_vdev_pre_start");
              v50 = *(unsigned __int16 *)(v37 + 304);
              v51 = 131;
              if ( v50 <= 0x77 )
              {
                if ( *(unsigned __int16 *)(v37 + 304) <= 0x3Bu )
                {
                  if ( v50 == 20 )
                  {
                    v51 = 130;
              ...
              else if ( *(unsigned __int16 *)(v37 + 304) > 0x167u )
              {
                switch ( v50 )
                {
                  case 0x168u:
              ...
              *(_DWORD *)(v37 + 304) = v51;
              *(_DWORD *)(v37 + 308) = wlan_mlme_assemble_rate_code(v51 >> 7, 0, v51 & 7);
            }
            if ( (a2 & 1) == 0 )
            {
              qdf_trace_msg(
            ...
            v85 = v35[1];
            v86 = wma_set_tx_rx_aggr_size(a1, *(unsigned int *)(v85 + 2688));
            if ( v86 )
              qdf_trace_msg(
                0x36u,
                2u,
...
LABEL_62:
            if ( *(_BYTE *)(v37 + 163) == 2 )
            {
              result = wma_set_tx_rx_aggr_size_per_ac(context, a1, v85 + 2688, 0);
              if ( !(_DWORD)result )
                goto LABEL_50;
              qdf_trace_msg(
                0x36u,
