__int64 __fastcall drv_cmd_get_roam_intra_band(__int64 a1, __int64 *a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v6; // x0
  ...
  v32 = 0;
  memset(v33, 0, 32);
  ucfg_cm_get_roam_intra_band(v6, &v32);
  scnprintf(v33, 32, "%s %d", "GETROAMINTRABAND", v32);
  v8 = *(_DWORD *)(a5 + 12);
  if ( v8 > v7 )
    LOBYTE(v8) = v7 + 1;
