__int64 __fastcall ucfg_p2p_mgmt_tx_cancel(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        double a12)
{
  ...
  if ( a1 )
  {
    ...
    if ( comp_private_obj )
    {
      ...
      {
        if ( a4 == 7
          && (wlan_p2p_is_sta_vdev_usage_allowed_for_p2p_dev(a1) & 1) != 0
          && !(unsigned int)policy_mgr_mode_specific_get_channel(a1, 3) )
        {
          p2p_del_random_mac(a1, *(unsigned __int8 *)(a2 + 104), a3, v43, v44, v45, v46, v47, v48, v49, v50);
        }
        v51 = (_QWORD *)_qdf_mem_malloc(0x10u, "ucfg_p2p_mgmt_tx_cancel", 444);
        if ( v51 )
        {
          *v51 = v33;
          v52 = (__int64)v51;
          ...
          result = scheduler_post_message_debug(
                     ...
                     0x1C8u,
                     (__int64)"ucfg_p2p_mgmt_tx_cancel");
          if ( (_DWORD)result )
          {
            v53 = result;
            _qdf_mem_free(v52);
