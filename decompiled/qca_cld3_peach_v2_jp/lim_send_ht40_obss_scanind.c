__int64 __fastcall lim_send_ht40_obss_scanind(_QWORD *a1, __int64 a2)
{
  ...
  {
    v13 = v4;
    wlan_reg_read_current_country(a1[2694], &v61, v5, v6, v7, v8, v9, v10, v11, v12);
    ...
    *(_WORD *)(v13 + 20) = *(_WORD *)(a2 + 8650);
    v22 = wlan_reg_freq_to_chan(a1[2695], *(_DWORD *)(a2 + 284), v14, v15, v16, v17, v18, v19, v20, v21);
