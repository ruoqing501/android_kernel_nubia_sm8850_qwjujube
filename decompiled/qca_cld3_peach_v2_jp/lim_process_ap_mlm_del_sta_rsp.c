...
LABEL_15:
  ...
  qdf_trace_msg(
    ...
    "lim_process_ap_mlm_del_sta_rsp",
    *v11,
    *(unsigned __int8 *)(v24 + 338),
    *(unsigned __int8 *)(v24 + 339),
    *(unsigned __int8 *)(v24 + 340),
    *(unsigned __int8 *)(v24 + 343));
  ...
  if ( (v42 & 0xFFFFFFFE) != 0x16 )
  {
    ...
    qdf_trace_msg(
      ...
      "lim_process_ap_mlm_del_sta_rsp",
      v60,
      *(unsigned __int16 *)(v24 + 336));
    goto LABEL_15;
  }
  LODWORD(v78) = *(unsigned __int8 *)(v24 + 343);
  qdf_trace_msg(
    0x35u,
    8u,
