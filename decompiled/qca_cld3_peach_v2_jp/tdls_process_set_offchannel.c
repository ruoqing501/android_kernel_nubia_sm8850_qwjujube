__int64 __fastcall tdls_process_set_offchannel(__int64 a1)
{
  __int64 v2; // x0
  double v3; // d0
  double v4; // d1
  ...
  if ( (unsigned int)tdls_get_vdev_objects(v2, v16, &v15)
    || (qdf_trace_msg(
          0,
          8u,
          "%s: TDLS offchannel to be configured %d",
          v3,
          v4,
          v5,
          v6,
  ...
  {
    v11 = tdls_set_tdls_offchannel(v15);
    v12 = *(void (__fastcall **)(_QWORD))(a1 + 16);
    if ( !v12 )
      goto LABEL_6;
  }
