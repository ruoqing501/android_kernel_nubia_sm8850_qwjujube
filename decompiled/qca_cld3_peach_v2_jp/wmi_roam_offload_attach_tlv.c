__int64 __fastcall wmi_roam_offload_attach_tlv(__int64 result)
{
  ...
  *v1 = extract_roam_event_tlv;
  ...
  v1[112] = send_set_ric_req_cmd_tlv;
  v1[113] = send_process_roam_synch_complete_cmd_tlv;
  v1[115] = send_roam_invoke_cmd_tlv;
  v1[188] = send_vdev_set_pcl_cmd_tlv;
  v1[116] = send_set_roam_trigger_cmd_tlv;
  ...
  v1[15] = extract_peer_oper_mode_event_tlv;
  v1[114] = send_process_roam_vendor_handoff_req_cmd_tlv;
  return result;
}
