        ...
        double a14)
{
  ...
  while ( 1 )
  {
    ...
    v39 = *(_QWORD *)(a2 + 24);
    if ( (*(_BYTE *)(v39 + 95042) & 1) != 0
      || (*(_BYTE *)(*(_QWORD *)(*(_QWORD *)(v39 + 8) + 40LL) + 732LL) & 1) != 0
      || (v40 = *(_QWORD *)(*(_QWORD *)(a2 + 24) + 8LL), (*(_BYTE *)(v40 + 18672) & 1) != 0)
      || *(_BYTE *)(v18 + 2873)
    ...
    v21 = *(_QWORD *)(a1 + 80LL * (unsigned int)v20 + 6752);
    if ( v21 )
    {
      v18 = *(_QWORD *)(a1 + 1128);
