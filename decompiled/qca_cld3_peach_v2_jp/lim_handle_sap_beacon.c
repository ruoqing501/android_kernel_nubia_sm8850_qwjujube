        ...
        if ( *(_BYTE *)(result + 21674) )
        {
          if ( *(_WORD *)(result + 3992) )
          {
            ...
            do
            {
              ...
              if ( *(_BYTE *)(v25 + v21) )
              {
                result = wlan_reg_freq_to_chan(v11, *((_DWORD *)a2 + 266), v12, v13, v14, v15, v16, v17, v18, v19);
...
LABEL_28:
                    ...
                    v36 = qdf_mem_malloc_atomic_fl(0xD80u, (__int64)"lim_allocate_and_get_bcn", 0x367u);
                    if ( !v36 )
                      goto LABEL_27;
                    v37 = *((_DWORD *)a2 + 266);
                    v23 = (__int64)v36;
