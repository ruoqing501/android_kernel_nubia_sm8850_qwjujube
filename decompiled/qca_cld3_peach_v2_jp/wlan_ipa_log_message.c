...
LABEL_42:
  ...
  if ( dword_864E84 == 1 )
  {
    ...
    else
    {
      ...
      {
        qword_864648 &= ~1uLL;
        result = raw_spin_unlock_bh(&dword_864640);
      }
      else
      {
        result = raw_spin_unlock(&dword_864640);
      }
      v41 = v68 + 2;
      if ( v68 == (_QWORD *)-16LL )
      {
      ...
      else
      {
        ...
        *((_BYTE *)v41 + (int)(v53 + 1)) = 0;
        ...
        qdf_list_insert_back(&qword_864628, v68);
        if ( (qword_864648 & 1) != 0 )
        {
          qword_864648 &= ~1uLL;
        ...
        __asm { PRFM            #0x11, [X8] }
        do
          v60 = __ldxr((unsigned __int64 *)&qword_864E78);
        while ( __stxr(v60 | 2, (unsigned __int64 *)&qword_864E78) );
        result = _wake_up(&unk_864E50, 1, 1, 0);
      }
    }
  }
  else
