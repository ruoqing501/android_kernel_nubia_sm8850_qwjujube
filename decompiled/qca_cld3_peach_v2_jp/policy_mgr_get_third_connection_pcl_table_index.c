__int64 __fastcall policy_mgr_get_third_connection_pcl_table_index(__int64 a1)
{
  ...
  if ( context )
  {
    ...
    if ( (_DWORD)pm_conc_connection_list == 2 && (_DWORD)qword_81C464 == 1
      || (_DWORD)pm_conc_connection_list == 1 && (_DWORD)qword_81C464 == 2 )
    {
    ...
    {
      if ( ((_DWORD)pm_conc_connection_list || (_DWORD)qword_81C464 != 1)
        && ((_DWORD)pm_conc_connection_list != 1 || (_DWORD)qword_81C464) )
      {
        if ( (_DWORD)pm_conc_connection_list == 1 && (_DWORD)qword_81C464 == 1 )
        {
          third_connection_pcl_table_index_sap_sap = policy_mgr_get_third_connection_pcl_table_index_sap_sap(a1);
        }
        else if ( ((_DWORD)pm_conc_connection_list || (_DWORD)qword_81C464 != 3)
               && ((_DWORD)pm_conc_connection_list != 3 || (_DWORD)qword_81C464) )
        {
          v23 = (_DWORD)pm_conc_connection_list == 2 && (_DWORD)qword_81C464 == 0;
          v24 = (_DWORD)qword_81C464 == 2 && (_DWORD)pm_conc_connection_list == 0;
          if ( v24 || v23 )
          {
          ...
          {
            v26 = (_DWORD)pm_conc_connection_list == 2 && (_DWORD)qword_81C464 == 3;
            v27 = (_DWORD)qword_81C464 == 2 && (_DWORD)pm_conc_connection_list == 3;
            if ( v27 || v26 )
            {
            ...
            {
              v29 = (_DWORD)pm_conc_connection_list == 3 && (_DWORD)qword_81C464 == 1;
              v30 = (_DWORD)qword_81C464 == 3 && (_DWORD)pm_conc_connection_list == 1;
              if ( v30 || v29 )
              {
                third_connection_pcl_table_index_sap_sap = policy_mgr_get_third_connection_pcl_table_index_go_sap(a1);
              }
              else if ( (unsigned int)pm_conc_connection_list | (unsigned int)qword_81C464 )
              {
                if ( ((_DWORD)pm_conc_connection_list != 5 || (_DWORD)qword_81C464)
                  && ((_DWORD)pm_conc_connection_list || (_DWORD)qword_81C464 != 5) )
                {
                  v33 = (_DWORD)pm_conc_connection_list == 4 && (_DWORD)qword_81C464 == 5;
                  v34 = (_DWORD)qword_81C464 == 4 && (_DWORD)pm_conc_connection_list == 5;
                  if ( v34 || v33 )
                  {
                  ...
                  {
                    v36 = (_DWORD)pm_conc_connection_list == 5 && (_DWORD)qword_81C464 == 1;
                    v37 = (_DWORD)qword_81C464 == 5 && (_DWORD)pm_conc_connection_list == 1;
                    if ( v37 || v36 )
                    {
                      third_connection_pcl_table_index_sap_sap = policy_mgr_get_third_connection_pcl_table_index_sap_nan(a1);
                    }
                    else if ( (_DWORD)pm_conc_connection_list == 3 && (_DWORD)qword_81C464 == 3 )
                    {
                      third_connection_pcl_table_index_sap_sap = policy_mgr_get_third_connection_pcl_table_index_go_go(a1);
                    }
                    else if ( (_DWORD)pm_conc_connection_list == 2 && (_DWORD)qword_81C464 == 2 )
                    {
                      third_connection_pcl_table_index_sap_sap = policy_mgr_get_third_connection_pcl_table_index_cli_cli(a1);
                    }
                    else if ( ((_DWORD)pm_conc_connection_list || (_DWORD)qword_81C464 != 6)
                           && ((_DWORD)pm_conc_connection_list != 6 || (_DWORD)qword_81C464) )
                    {
                      v39 = (_DWORD)pm_conc_connection_list == 6 && (_DWORD)qword_81C464 == 1;
                      v40 = (_DWORD)qword_81C464 == 6 && (_DWORD)pm_conc_connection_list == 1;
                      if ( v40 || v39 )
                      {
                      ...
                      {
                        v42 = (_DWORD)pm_conc_connection_list == 6 && (_DWORD)qword_81C464 == 3;
                        v43 = (_DWORD)qword_81C464 == 6 && (_DWORD)pm_conc_connection_list == 3;
                        if ( v43 || v42 )
                        {
                        ...
                        {
                          v45 = (_DWORD)pm_conc_connection_list == 6 && (_DWORD)qword_81C464 == 2;
                          v46 = (_DWORD)qword_81C464 == 6 && (_DWORD)pm_conc_connection_list == 2;
                          if ( !v46 && !v45 )
                          {
                            if ( (_DWORD)pm_conc_connection_list == 5 && (qword_81C464 & 0xFFFFFFFE) == 2
                              || (v20 = 164, (_DWORD)qword_81C464 == 5) && (pm_conc_connection_list & 0xFFFFFFFE) == 2 )
                            {
                              if ( HIDWORD(pm_conc_connection_list) != HIDWORD(qword_81C464) )
