__int64 __fastcall wlan_hdd_p2p_connection_info(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  else
  {
    v29 = v7;
    v17 = v7;
    v30 = cfg80211_calculate_bitrate(v3 + 696);
    v18 = cfg80211_calculate_bitrate(v3 + 710);
    v19 = *(_DWORD *)(v3 + 692);
    v34 = *(unsigned __int8 *)(v3 + 300);
    v35 = *(unsigned __int8 *)(v3 + 308);
    v32 = *(unsigned __int8 *)(v3 + 302);
    v33 = *(unsigned __int8 *)(v3 + 301);
    v31 = *(unsigned __int8 *)(v3 + 305);
    v20 = hdd_ch_width_str(*(_DWORD *)(v3 + 932));
    v21 = *(char *)(v3 + 832);
    v22 = v20;
    v23 = (const char *)hdd_auth_type_str(*(unsigned int *)(v3 + 880));
    v24 = *(unsigned int *)(v3 + 680);
