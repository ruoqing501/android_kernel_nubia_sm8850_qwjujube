...
LABEL_12:
  ...
  v23 = wlan_mlme_check_chan_param_has_dfs(context[2695], a1 + 375, *a1, v13, v14, v15, v16, v17, v18, v19, v20);
  ...
  if ( (v23 & 1) != 0 )
  {
    if ( !policy_mgr_concurrent_beaconing_sessions_running(v22[2694])
