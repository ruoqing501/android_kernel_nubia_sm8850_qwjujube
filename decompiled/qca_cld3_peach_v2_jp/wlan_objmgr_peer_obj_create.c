...
LABEL_16:
  ...
  v16 = _qdf_mem_malloc(0x308u, "wlan_objmgr_peer_obj_create", 212);
  v17 = v16;
  if ( !v16 )
    return v17;
  *(_DWORD *)(v16 + 752) = 0;
  *(_DWORD *)(v16 + 96) = 0;
  _X8 = (unsigned int *)(v16 + 96);
  __asm { PRFM            #0x11, [X8] }
  do
    v93 = __ldxr(_X8);
...
LABEL_30:
  ...
  *(_BYTE *)(v17 + 54) = *(_BYTE *)(*(_QWORD *)(a1 + 152) + 40LL);
  if ( a2 <= 8 && ((1 << a2) & 0x130) != 0 )
  {
    v48 = *(_QWORD *)(a1 + 120);
    if ( v48 )
    {
      _X8 = (unsigned int *)(v48 + 96);
      __asm { PRFM            #0x11, [X8] }
      do
        v96 = __ldxr(_X8);
  ...
  {
    raw_spin_lock(v17 + 760);
  }
  else
  {
    raw_spin_lock_bh(v17 + 760);
    *(_QWORD *)(v17 + 768) |= 1uLL;
  }
  v63 = 0;
  while ( 1 )
  {
    v64 = *(_DWORD *)(v17 + 4 * v63 + 536);
    if ( v64 != 40 )
    {
      if ( v64 == 2 || v64 == 16 )
      {
...
LABEL_52:
  ...
  if ( (v66 & 1) != 0 )
  {
    *(_QWORD *)(v17 + 768) = v66 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(v17 + 760);
    if ( v65 == 40 )
      goto LABEL_66;
LABEL_54:
    if ( v65 != 16 )
    {
      ...
      *(_DWORD *)(v17 + 752) = 1;
      do
      {
        v77 = *(_DWORD **)(v75 + v76 + 10408);
        if ( v77 )
        {
          v78 = *(_QWORD *)(v75 + v76 + 10840);
          if ( *(v77 - 1) != -202286667 )
            __break(0x8229u);
...
LABEL_67:
  ...
  qdf_trace_msg(
    ...
    v86,
    a2);
  wlan_minidump_log(v17, 776, v13, 60, "wlan_objmgr_peer");
  return v17;
}
