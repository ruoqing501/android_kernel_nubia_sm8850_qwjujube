        ...
        double a9)
{
  ...
  DP_PRINT_STATS("\tFW removed Pkts = %llu", v259, v260, v261, v262, v263, v264, v265, v266, *(_QWORD *)(a1 + 3640));
  DP_PRINT_STATS("\tFW removed bytes= %llu", v267, v268, v269, v270, v271, v272, v273, v274, *(_QWORD *)(a1 + 3648));
  DP_PRINT_STATS(
  ...
  DP_PRINT_STATS("\tTag[%d] = %llu", v755, v756, v757, v758, v759, v760, v761, v762, 0, *(_QWORD *)(a1 + 6776));
  DP_PRINT_STATS("\tTag[%d] = %llu", v763, v764, v765, v766, v767, v768, v769, v770, 1, *(_QWORD *)(a1 + 6784));
  DP_PRINT_STATS("\tTag[%d] = %llu", v771, v772, v773, v774, v775, v776, v777, v778, 2, *(_QWORD *)(a1 + 6792));
  DP_PRINT_STATS("\tTag[%d] = %llu", v779, v780, v781, v782, v783, v784, v785, v786, 3, *(_QWORD *)(a1 + 6800));
  DP_PRINT_STATS("\tTag[%d] = %llu", v787, v788, v789, v790, v791, v792, v793, v794, 4, *(_QWORD *)(a1 + 6808));
  DP_PRINT_STATS("\tTag[%d] = %llu", v795, v796, v797, v798, v799, v800, v801, v802, 5, *(_QWORD *)(a1 + 6816));
  DP_PRINT_STATS("\tTag[%d] = %llu", v803, v804, v805, v806, v807, v808, v809, v810, 6, *(_QWORD *)(a1 + 6824));
  DP_PRINT_STATS("\tTag[%d] = %llu", v811, v812, v813, v814, v815, v816, v817, v818, 7, *(_QWORD *)(a1 + 6832));
  DP_PRINT_STATS("\tTag[%d] = %llu", v819, v820, v821, v822, v823, v824, v825, v826, 8, *(_QWORD *)(a1 + 6840));
  DP_PRINT_STATS("\tTag[%d] = %llu", v827, v828, v829, v830, v831, v832, v833, v834, 9, *(_QWORD *)(a1 + 6848));
  DP_PRINT_STATS("\tTag[%d] = %llu", v835, v836, v837, v838, v839, v840, v841, v842, 10, *(_QWORD *)(a1 + 6856));
  DP_PRINT_STATS("\tTag[%d] = %llu", v843, v844, v845, v846, v847, v848, v849, v850, 11, *(_QWORD *)(a1 + 6864));
  DP_PRINT_STATS("\tTag[%d] = %llu", v851, v852, v853, v854, v855, v856, v857, v858, 12, *(_QWORD *)(a1 + 6872));
  DP_PRINT_STATS("\tTag[%d] = %llu", v859, v860, v861, v862, v863, v864, v865, v866, 13, *(_QWORD *)(a1 + 6880));
  DP_PRINT_STATS(
    ...
    v873,
    v874,
    *(unsigned int *)(a1 + 6888));
  if ( a1 )
  {
    v883 = *(_QWORD *)(a1 + 95560);
    if ( v883 )
    {
      DP_PRINT_STATS(
      ...
      DP_PRINT_STATS(
        ...
        v890,
        v891,
        *(unsigned __int16 *)(*(_QWORD *)(a1 + 95560) + 39212LL));
      DP_PRINT_STATS(
        "cur sched cmdid: %d",
        v892,
        v893,
        ...
        v898,
        v899,
        *(unsigned __int16 *)(*(_QWORD *)(a1 + 95560) + 39214LL));
      DP_PRINT_STATS(
        ...
        v906,
        v907,
        *(unsigned int *)(*(_QWORD *)(a1 + 95560) + 39220LL));
    }
  }
  ...
  {
    if ( *(_DWORD *)(a1 + 4 * i) )
      DP_PRINT_STATS("Wdi msgs received for event ID[%d]:%d", v932, v933, v934, v935, v936, v937, v938, v939, i - 1950);
  }
  v941 = *(_QWORD *)(*(_QWORD *)(a1 + 8) + 20056LL);
  if ( !v941 )
  {
...
LABEL_17:
  ...
  DP_PRINT_STATS(
    ...
    v967,
    v968,
    *(unsigned int *)(a1 + 4712));
  DP_PRINT_STATS("\tFail reason:TTL = %d", v969, v970, v971, v972, v973, v974, v975, v976, *(unsigned int *)(a1 + 4716));
  DP_PRINT_STATS(
