__int64 __fastcall wlan_crypto_decap(__int64 a1, __int64 a2, _BYTE *a3)
{
  ...
  if ( !v8 || (v9 = *(_QWORD *)(v8 + 80)) == 0 )
  {
    ...
    if ( (v17 & 1) != 0 )
    {
      *(_QWORD *)(a1 + 1280) = v17 & 0xFFFFFFFFFFFFFFFELL;
...
LABEL_27:
    ...
    v29 += v30;
LABEL_37:
    if ( (*(_BYTE *)(*(_QWORD *)(a1 + 152) + 12LL) & 0x20) != 0 )
...
LABEL_40:
  ...
  v32 = *(unsigned __int8 *)(*(_QWORD *)(a1 + 152) + 40LL);
  peer = wlan_objmgr_get_peer(v9, *(unsigned __int8 *)(*(_QWORD *)(a1 + 152) + 40LL), a3, 19);
