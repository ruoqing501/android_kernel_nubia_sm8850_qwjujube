  ...
  else
  {
    ...
    else
    {
      ...
      while ( v28 )
      {
        ...
        {
          v29 = *(unsigned __int16 *)(v28 + 336) == v16;
          v28 = *(_QWORD *)(v28 + 936);
          if ( !v29 )
            continue;
        }
      ...
      v32 = (_WORD *)(v26 + 952LL * (unsigned __int8)v16);
      v33 = *((_QWORD *)v32 + 117);
      qdf_mem_set(v32, 0x3B8u, 0);
      *((_QWORD *)v32 + 117) = v33;
      v32[168] = v16;
      qdf_mem_copy(v32 + 169, a10, 6u);
      v34 = *v32;
      *((_BYTE *)v32 + 645) = 0;
      *v32 = v34 | 9;
      *(_WORD *)((char *)v32 + 641) = 0;
      if ( v32 )
      {
        *(_QWORD *)(*(_QWORD *)(a12 + 8) + 952LL * v16 + 936) = *(_QWORD *)(*(_QWORD *)a12 + 8 * v27);
        *(_QWORD *)(*(_QWORD *)a12 + 8 * v27) = *(_QWORD *)(a12 + 8) + 952LL * v16;
