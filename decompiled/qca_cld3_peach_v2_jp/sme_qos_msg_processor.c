...
LABEL_30:
    ...
    do
    {
      ...
      {
        memcpy(dest, (const void *)(qword_856120 + v62 + v61 + 328), 0xC8u);
      ...
      v104 = (*(unsigned __int16 *)(qword_856120 + v62 + v61 + 557) >> 5) & 3;
      qdf_trace_msg(
        0x34u,
        8u,
        "%s: Addts rsp from LIM AC=%d, flow=%d dir=%d, tspecIdx=%x",
      ...
      {
        memcpy(dest, (const void *)(qword_856120 + v62 + v61 + 528), 0xC8u);
        LODWORD(dest[1]) = *(_DWORD *)(v63 - 10);
        LODWORD(dest[2]) = dest[1];
        v64 = *(_QWORD *)(v63 + 40);
        *(_QWORD *)((char *)&dest[7] + 2) = *(_QWORD *)(v63 + 32);
