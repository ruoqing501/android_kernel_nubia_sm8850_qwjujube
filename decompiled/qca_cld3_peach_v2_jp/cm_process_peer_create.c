...
LABEL_12:
  ...
  v20 = context;
  peer_by_mac = wlan_objmgr_get_peer_by_mac(context[2694], v19 + 1, 0x4Du);
  if ( peer_by_mac )
  {
    if ( *((_DWORD *)peer_by_mac + 17) == 12 )
    {
      ...
      qdf_trace_msg(
        ...
        *v19,
        ...
        v19[3],
        v19[6]);
      v31 = wma_remove_existing_pasn_peer(v20[2694], v19);
      v33 = v32;
  ...
  v43 = wma_add_bss_peer_sta(*v19, v19 + 1, 1, 0, 0);
