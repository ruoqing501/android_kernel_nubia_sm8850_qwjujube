__int64 __fastcall dp_cfr_filter_2_0(
        __int64 result,
        char a2,
        char a3,
        unsigned __int16 *a4,
        ...
        double a13)
{
  ...
  if ( a2 || (v13 = *(_QWORD *)(result + 72)) == 0 )
  {
    result = qdf_trace_msg(0x92u, 2u, "%s: pdev is NULL", a6, a7, a8, a9, a10, a11, a12, a13, "dp_cfr_filter_2_0");
  }
  else if ( *(_QWORD *)(*(_QWORD *)(v13 + 95560) + 16LL) )
  {
    *(_BYTE *)(v13 + 95040) = (a3 & 1) != 0 && (a5 & 1) != 0;
  }
  else
  {
    v14 = *(_QWORD *)(v13 + 8);
    ...
    *(_DWORD *)((char *)&v30 + 6) = *(_DWORD *)((_BYTE *)&v30 + 6) & 0xFFFF7FFF | v27;
    ...
    result = dp_mon_ht2_rx_ring_cfg(v14, (unsigned __int8 *)v13, 3, (__int64)v29 + 4);
  }
