...
LABEL_19:
      if ( (*(_QWORD *)(*(_QWORD *)(v20 + 55512) + 4416LL) & 2) == 0 )
      {
...
LABEL_35:
    ...
    if ( hdd_cm_is_vdev_roaming(*(_QWORD *)(v20 + 55512)) )
    {
      v29 = "%s: Roaming is in progress, rej this req";
      v30 = 8;
      goto LABEL_6;
    }
    if ( !hdd_cm_is_vdev_associated(*(_DWORD **)(v20 + 55512)) )
    {
...
LABEL_24:
    ...
    if ( _wlan_hdd_cfg80211_get_txpower___first_time != 1
      || _wlan_hdd_cfg80211_get_txpower___last_ticks_149
       - jiffies
       + 250LL * *(unsigned __int8 *)(*(_QWORD *)(a1 + 1640) + 174LL) < 0 )
    {
      _wlan_hdd_cfg80211_get_txpower___last_ticks_149 = jiffies;
    ...
    *v52 = 1;
    ...
    if ( *(_DWORD *)(a1 + 3000) == 1 )
    {
      if ( _wlan_hdd_cfg80211_get_txpower_is_rate_limited != 1 || *(_BYTE *)(a1 + 9817) != 1 )
      {
        if ( (unsigned int)jiffies_to_msecs(jiffies) - *(_DWORD *)(v20 + 60052) > 0x15E )
        {
          qdf_mtrace(51, 51, 0x25u, *(_BYTE *)(*(_QWORD *)(v20 + 55512) + 8LL), *(_DWORD *)(v20 + 2728));
