        ...
        double a10)
{
  ...
  double v67; // d6
  double v68; // d7
  unsigned int v69; // [xsp+8h] [xbp-18h] BYREF
...
LABEL_8:
  ...
  *(_DWORD *)(session_by_session_id + 80) = 16;
  ...
  if ( !*a2 )
  {
    ...
    result = *(_BYTE *)(v13 + 7184)
           ? wlan_reg_chan_band_to_freq(
               *(_QWORD *)(a1 + 21560),
               *(unsigned __int8 *)(v13 + 7184),
               1LL << v38,
               v39,
               v40,
               v41,
...
LABEL_28:
          if ( wlan_reg_is_6ghz_chan_freq(*(_DWORD *)(v13 + 284))
            || ((*(unsigned __int8 *)(v13 + 10080) | v60) & 1) != 0 )
          {
            qdf_trace_msg(
              0x35u,
              8u,
      ...
      else
      {
        if ( v47 != 3 )
        {
          v60 = wlan_reg_is_dfs_for_freq(*(_QWORD *)(a1 + 21560), v37, v39, v40, v41, v42, v43, v44, v45, v46) ^ 1;
          goto LABEL_28;
        }
        v48 = *(_QWORD *)(a1 + 21560);
        v71 = 0;
      ...
      v60 = _5g_bonded_channel_state_for_pwrmode != 2;
      goto LABEL_28;
    }
  }
LABEL_10:
