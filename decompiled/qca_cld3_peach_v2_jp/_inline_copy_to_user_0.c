unsigned __int64 __fastcall inline_copy_to_user_0(unsigned __int64 a1, __int64 a2, unsigned __int64 a3)
{
  ...
  if ( a3 <= 0x8000000000LL && 0x8000000000LL - a3 >= v4 )
  {
    ...
    a3 = _arch_copy_to_user(a1 & 0xFF7FFFFFFFFFFFFFLL, a2, a3);
