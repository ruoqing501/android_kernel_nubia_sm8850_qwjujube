__int64 __fastcall qdf_crypto_aes_128_cmac(__int64 a1, __int64 a2, unsigned __int16 a3, _QWORD *a4)
{
  ...
  else
  {
    ...
    v15 = v12 >> 31;
    HIDWORD(v12) = BYTE2(v122);
    LODWORD(v12) = BYTE3(v122) << 24;
    v16 = v12 >> 31;
    ...
    v18 = v12 >> 31;
    HIDWORD(v12) = (unsigned __int8)v122;
    LODWORD(v12) = BYTE1(v122) << 24;
    v19 = v12 >> 31;
    ...
    HIDWORD(v12) = BYTE6(v121);
    LODWORD(v12) = HIBYTE(v121) << 24;
    v23 = v12 >> 31;
    if ( (v121 & 0x80u) == 0LL )
      v22 = 2 * HIBYTE(v122);
