__int64 __fastcall dp_hw_link_desc_ring_alloc(__int64 a1)
{
  ...
  if ( v6 <= v2 )
  {
    if ( !(unsigned int)dp_srng_alloc((_QWORD *)a1, a1 + 1912, 0xBu, v5, 0) )
    {
      wlan_minidump_log(
        v18,
        v19,
...
LABEL_18:
  ...
  {
    if ( *(_QWORD *)(a1 + i + 2120) )
      _qdf_mem_free_consistent(*(_QWORD *)(a1 + 24), *(_QWORD *)(*(_QWORD *)(a1 + 24) + 40LL), *(_DWORD *)(a1 + 12904));
  }
  return 2;
}
