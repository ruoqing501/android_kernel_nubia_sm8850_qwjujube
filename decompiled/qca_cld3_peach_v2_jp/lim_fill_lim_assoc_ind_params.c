...
LABEL_217:
  ...
  v13 = a3;
  v14 = *(unsigned __int8 **)(v12 + 8LL * *(unsigned __int16 *)(a3 + 336));
  if ( !v14 )
  {
  ...
  v16 = a4;
  qdf_mem_copy((void *)a1, (const void *)(a3 + 338), 6u);
  *(_WORD *)(a1 + 6) = *(_WORD *)(v13 + 336);
  ...
  *(_WORD *)(a1 + 2622) = v18;
  ...
  {
    vendor_ie_ptr_from_oui = wlan_get_vendor_ie_ptr_from_oui(&unk_A0967C, 4u, v14 + 1006, *((_WORD *)v14 + 502));
    if ( !v14[3267] )
      goto LABEL_11;
  }
  else
...
LABEL_39:
          ...
          *(_BYTE *)(a1 + 2787) = (*(_WORD *)(v14 + 3297) & 0x700) != 0;
          v87 = *(unsigned int *)(v13 + 348);
          if ( (unsigned int)v87 < 0xA && ((0x29Fu >> v87) & 1) != 0 )
          {
            v88 = dword_A09684[v87];
          }
          else
          {
            qdf_trace_msg(
...
LABEL_154:
              ...
              *(_BYTE *)(a1 + 2890) = v14[3572];
              ...
              {
                v124 = *(unsigned int *)(v13 + 348);
                if ( (unsigned int)v124 < 0xA && ((0x29Fu >> v124) & 1) != 0 )
                {
                  v125 = dword_A09684[v124];
                }
                else
                {
                  qdf_trace_msg(
              ...
              *(_BYTE *)(a1 + 2799) = -1;
              if ( *(_BYTE *)(v13 + 38) != 1
                || *(_BYTE *)(v16 + 8676) != 1
                || (he_max_mcs_idx = lim_get_he_max_mcs_idx(*(unsigned int *)(v13 + 348), v14 + 3372),
              ...
              if ( v132 )
              {
                ...
                if ( cmpt_obj )
                  qdf_mem_copy((void *)(*(_QWORD *)(cmpt_obj + 520) + 23964LL), (const void *)(a1 + 2744), 0x28u);
                else
                  qdf_trace_msg(
                    0x35u,
                    2u,
...
LABEL_32:
        *(_BYTE *)(a1 + 2725) = *(_BYTE *)(*(_QWORD *)(a2 + 8) + 5453LL);
        goto LABEL_33;
      }
  ...
  while ( v89 < 0x60 )
  {
    ...
    *(_BYTE *)(v92 + (unsigned __int16)v90) = v93;
    ...
    if ( v91[v89 + 1] >= 2u )
    {
      v95 = v16;
      v96 = v91;
      v97 = wlan_reg_legacy_chan_to_freq(*(_QWORD *)(v148 + 21560), v93, a5, a6, a7, a8, a9, a10, a11, a12);
