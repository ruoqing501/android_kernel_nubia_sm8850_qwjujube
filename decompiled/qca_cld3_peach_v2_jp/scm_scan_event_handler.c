        ...
        double a9)
{
  ...
  v10 = *(_QWORD *)v9;
  comp_private_obj = wlan_objmgr_psoc_get_comp_private_obj(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)v9 + 152LL) + 80LL), 3u);
  if ( !comp_private_obj )
    qdf_trace_msg(
      0x15u,
      2u,
  ...
  v22 = wlan_objmgr_psoc_get_comp_private_obj(*(_QWORD *)(*(_QWORD *)(v10 + 152) + 80LL), 3u);
  if ( !v22 )
  {
    qdf_trace_msg(
      0x15u,
...
LABEL_22:
    if ( v9[3] - 11 <= 1 )
    {
      ...
      v32 = wlan_objmgr_psoc_get_comp_private_obj(*(_QWORD *)(*(_QWORD *)(v10 + 152) + 80LL), 3u);
      v41 = (_QWORD *)v32;
      if ( v32 )
      {
        if ( v31 )
