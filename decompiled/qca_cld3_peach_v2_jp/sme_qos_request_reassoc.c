        ...
        double a11)
{
  ...
  __int64 v25; // x23
  unsigned int operation_chan_freq_vdev_id; // w3
  double v27; // d0
  double v28; // d1
  double v29; // d2
  double v30; // d3
  ...
  {
    v25 = qword_856120;
    wlan_mlme_get_bssid_vdev_id(*(_QWORD *)(a1 + 21560), a2, &v80);
    operation_chan_freq_vdev_id = wlan_get_operation_chan_freq_vdev_id(*(_QWORD *)(a1 + 21560), a2);
