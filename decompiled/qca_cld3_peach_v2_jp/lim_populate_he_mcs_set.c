        ...
        double a13)
{
  ...
  double v60; // d6
  double v61; // d7
  unsigned __int16 v62; // w8
  char v63; // w11
  char v64; // w12
  char v65; // w13
  unsigned __int16 v66; // w9
  unsigned __int16 v67; // w10
  unsigned __int16 v68; // w11
  unsigned __int16 v69; // w12
  unsigned __int16 v70; // w13
  unsigned __int16 sap_he_rx_mcs_map_160; // w0
  __int64 v72; // [xsp+0h] [xbp-10h]
  __int64 v73; // [xsp+8h] [xbp-8h]

  v13 = *(_DWORD *)(*(_QWORD *)(a1 + 8) + 5748LL);
      ...
      if ( v22 )
      {
        if ( v17 == 2 && v22 == 2 && max_bw > 2 )
        {
          v17 = 3;
               ...
               && *(_DWORD *)(a4 + 7176) != v17
               && (wlan_is_dnw_in_progress(*(_QWORD *)(a1 + 21560), *(unsigned __int8 *)(a4 + 10)) & 1) != 0 )
        {
          v17 = *(_DWORD *)(a4 + 7176);
        }
      }
...
LABEL_34:
    ...
    v53 = lim_populate_he_mcs_per_bw(
            v43,
            v44,
            v45,
            v46,
    ...
    if ( v17 == 3 )
    {
      if ( (*(_BYTE *)(a3 + 7) & 0x10) != 0 )
      {
        lim_populate_he_mcs_per_bw(
          ...
          *(unsigned __int16 *)(a3 + 26),
          a5,
          *(unsigned __int16 *)(a1 + 21800),
          *(unsigned __int16 *)(a1 + 21802));
        if ( *(_DWORD *)(a4 + 88) == 1 )
        {
          sap_he_rx_mcs_map_160 = wlan_mlme_get_sap_he_rx_mcs_map_160(*(_QWORD *)(a1 + 21552));
          a2[27] = wlan_mlme_get_min_he_mcs_map(sap_he_rx_mcs_map_160, a2[27]);
        }
      }
      else
      {
      ...
      *(_DWORD *)(a2 + 27) = -1;
      if ( v17 == 4 )
      {
        lim_populate_he_mcs_per_bw(
          ...
          *(unsigned __int16 *)(a3 + 30),
          a5,
          *(unsigned __int16 *)(a1 + 21804),
          *(unsigned __int16 *)(a1 + 21806));
        v62 = a2[25];
        if ( v41 )
        {
LABEL_46:
...
LABEL_42:
        ...
        v64 = a2[29];
        v65 = a2[30];
        v66 = (unsigned __int8)a2[26] | 0xFFFC;
        v67 = (unsigned __int8)a2[27] | 0xFFFC;
        a2[25] = v62;
        v68 = *(_WORD *)&v63 | 0xFFFC;
