        ...
        double a9)
{
  ...
  if ( result )
  {
    ...
    if ( v20 && *(_QWORD *)(v20 + 80) )
    {
      ...
      if ( is_24ghz_ch_freq )
      {
        v25 = *(_QWORD *)(v21 + 1245) & 0x380000LL | v24 & 0xFFFFFFFFF8C7FFFFLL;
LABEL_9:
        *v23 = v25;
        return (char *)qdf_mem_copy((void *)(a1 + 8680), v11 + 23896, 0x3Cu);
      }
      v26 = v11[23903];
      v27 = v24 & 0xFFFFFFFFFFC7FFFFLL | (((*(_QWORD *)(v21 + 1305) >> 19) & 7LL) << 19);
      *v23 = v27;
      if ( (v26 & 0x30) != 0 )
      {
        v25 = v27 & 0xFFFFFFFFF8FFFFFFLL | (((*(_QWORD *)(v21 + 1305) >> 24) & 7LL) << 24);
        goto LABEL_9;
      }
    }
    else
