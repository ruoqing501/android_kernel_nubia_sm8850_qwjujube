__int64 __fastcall policy_mgr_modify_pcl_for_p2p_ndp_concurrency(__int64 a1, _DWORD *a2, unsigned int *a3)
{
  ...
  char v66[4]; // [xsp+10h] [xbp-510h] BYREF
  char v67[4]; // [xsp+14h] [xbp-50Ch] BYREF
