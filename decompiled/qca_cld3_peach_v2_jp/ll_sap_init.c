__int64 __fastcall ll_sap_init(double a1, double a2, double a3, double a4, double a5, double a6, double a7, double a8)
{
  ...
  if ( !handler )
  {
    ...
    if ( v18 )
    {
      ...
      qdf_trace_msg(
        0xA1u,
        2u,
        "%s: objmgr_register_psoc_destroy_handler failed",
        v19,
        v20,
        v21,
        v22,
    ...
    else
    {
      ...
      if ( v35 )
      {
        ...
        qdf_trace_msg(
          0xA1u,
          2u,
          "%s: objmgr_register_vdev_create_handler failed",
          v36,
          v37,
          v38,
          v39,
      ...
      else
      {
        ...
        qdf_trace_msg(
          0xA1u,
          2u,
          "%s: objmgr_register_vdev_destroy_handler failed",
          v52,
          v53,
          v54,
          v55,
  ...
  qdf_trace_msg(
    0xA1u,
    2u,
    "%s: objmgr_register_psoc_create_handler failed",
    v9,
    v10,
    v11,
    v12,
