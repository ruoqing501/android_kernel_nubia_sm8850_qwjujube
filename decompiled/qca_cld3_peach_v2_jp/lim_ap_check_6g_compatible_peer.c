  ...
  if ( *(unsigned __int16 *)(a2 + 376) >= 2u )
  {
    for ( i = 1; *(unsigned __int16 *)(a2 + 376) > (unsigned int)i; ++i )
    {
      ...
      if ( hash_entry )
      {
        ...
        if ( *(_BYTE *)(hash_entry + 344) == 1 )
        {
          if ( !*(_BYTE *)(hash_entry + 902) )
            goto LABEL_20;
          LODWORD(v18) = *(unsigned __int8 *)(hash_entry + 903);
          if ( *(_BYTE *)(hash_entry + 903) )
          {
            v5 = 0;
            while ( v5 != 32 )
            {
              hash_entry = wlan_reg_is_6ghz_op_class(*(_QWORD *)(v3 + 21560), v17[v5 + 904]);
              v18 = v17[903];
...
LABEL_20:
            qdf_trace_msg(
              ...
              v17[343]);
            v19 = 0;
            return policy_mgr_set_ap_6ghz_capable(*(_QWORD *)(v3 + 21552), *(_BYTE *)(a2 + 10), v19, 8u);
          }
          qdf_trace_msg(
            0x35u,
            8u,
