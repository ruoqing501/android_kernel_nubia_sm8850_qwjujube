...
LABEL_28:
  ...
  v11 = *(_QWORD *)(a1 + 8);
  if ( !v11 || (v12 = *(_QWORD *)(v11 + 20056)) == 0 || (v13 = *(_QWORD **)(v12 + 416)) == nullptr )
  {
    v37 = "%s: Monitor ops is NULL";
    goto LABEL_28;
  }
  wlan_minidump_remove(a2, a3, a4, a5, a6, a7, a8, a9, *(_QWORD *)(a1 + 95560), 39328, *(_QWORD *)(v11 + 16));
  wlan_minidump_remove(v14, v15, v16, v17, v18, v19, v20, v21, *(_QWORD *)(v11 + 20056), 456, *(_QWORD *)(v11 + 16));
  ...
  v32 = *(_QWORD *)(a1 + 8);
  if ( v32 && (v33 = *(_QWORD *)(v32 + 20056)) != 0 && (v34 = *(_QWORD *)(v33 + 416)) != 0 )
  {
