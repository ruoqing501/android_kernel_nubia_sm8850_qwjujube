        ...
        double a11)
{
  ...
  v12 = a1[3];
  v15 = raw_spin_lock_irqsave(&dword_76E20C);
  v16 = v15;
  if ( !qword_76E200 )
    return raw_spin_unlock_irqrestore(&dword_76E20C, v15);
  v17 = *(_DWORD **)(qword_76E200 + 16);
  ...
  if ( a2 && a2[1] == 2 )
  {
    ...
    raw_spin_unlock_irqrestore(&dword_76E20C, v16);
  }
  else
  {
    result = raw_spin_unlock_irqrestore(&dword_76E20C, v16);
    if ( !v18 )
      return result;
  }
  _X8 = &qword_76E1D0;
  __asm { PRFM            #0x11, [X8] }
  do
    v30 = __ldxr((unsigned __int64 *)&qword_76E1D0);
  while ( __stxr(v30 | 4, (unsigned __int64 *)&qword_76E1D0) );
