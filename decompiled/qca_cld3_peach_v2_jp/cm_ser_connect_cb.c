        ...
        double a10)
{
  ...
  if ( a2 > 1 )
  {
    ...
    else
    {
      ...
      v24 = *(_DWORD *)(a1 + 4);
      result = _qdf_mem_malloc(0xA0u, "cm_connect_cmd_timeout", 73);
      if ( result )
      {
        *(_DWORD *)(result + 4) = v24;
        *(_DWORD *)(result + 52) = 16;
        ...
        *(_BYTE *)result = v26;
        ...
        v27 = cm_sm_deliver_event(*v22, 12, 160, v25);
        _qdf_mem_free(v25);
        if ( !v27 )
          return 0;
  ...
  else
  {
    ...
    if ( (_DWORD)result )
    {
      v39 = result;
      v40 = *(_DWORD *)(a1 + 4);
      v41 = _qdf_mem_malloc(0xA0u, "cm_connect_handle_event_post_fail", 304);
      if ( v41 )
      {
        *(_DWORD *)(v41 + 4) = v40;
        *(_DWORD *)(v41 + 52) = 16;
