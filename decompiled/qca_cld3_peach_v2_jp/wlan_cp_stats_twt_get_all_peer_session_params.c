__int64 __fastcall wlan_cp_stats_twt_get_all_peer_session_params(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v14 = *(unsigned __int16 *)(v5 + 160);
  v15 = *(_DWORD *)(v5 + 16);
  v16 = v5;
  v17 = wlan_vdev_peer_list_peek_active_head(v5, (_QWORD *)(v5 + 128), 0x26u);
  if ( !v17 )
    goto LABEL_25;
  v26 = (__int64)v17;
  v27 = 0;
...
LABEL_16:
    if ( v15 == 1 && v27 >= v14 )
      break;
    next_active_peer_of_vdev = wlan_peer_get_next_active_peer_of_vdev(v16, (_QWORD *)(v16 + 128), v26, 0x26u);
