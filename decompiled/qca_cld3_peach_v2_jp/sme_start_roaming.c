__int64 __fastcall sme_start_roaming(__int64 a1, __int64 a2, char a3, unsigned int a4)
{
  ...
  {
    v17 = v8;
    rso_pending_disable_req_bitmap = mlme_get_rso_pending_disable_req_bitmap(*(_QWORD *)(a1 + 21552), v7);
    if ( ((unsigned __int8)rso_pending_disable_req_bitmap & (unsigned __int8)a4) != 0 )
    {
      mlme_set_rso_pending_disable_req_bitmap(*(_QWORD *)(a1 + 21552), v7, a4, 1);
    ...
    else
    {
      wlan_objmgr_vdev_release_ref(
        ...
        v25,
        v26);
      return wlan_cm_enable_rso(*(_QWORD *)(a1 + 21560), v7, a4, a3, v37, v38, v39, v40, v41, v42, v43, v44);
    }
  }
  else
  {
