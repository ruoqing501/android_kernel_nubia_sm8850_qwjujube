    ...
    if ( v17 )
    {
      if ( v17 == 1 && *(_BYTE *)(a4 + 155) == 1 && *(_BYTE *)(a4 + 7161) && (a2[32] & 8) == 0 )
      {
        ...
        while ( 1 )
        {
          ...
          {
            result = qdf_mem_cmp((const void *)(a4 + v18 + 1237), a2 + 338, 6u);
            if ( !(_DWORD)result )
              break;
          }
          v18 += 12;
...
LABEL_28:
      if ( *(_BYTE *)(a4 + 155) && (a2[32] & 8) == 0 )
      {
        ...
        while ( 1 )
        {
          ...
          {
            result = qdf_mem_cmp((const void *)(a4 + v23 + 1237), a2 + 338, 6u);
            if ( !(_DWORD)result )
              break;
          }
          v23 += 12;
...
LABEL_35:
    ...
    for ( i = 0; i != 384; i += 12 )
    {
      if ( *(_BYTE *)(a4 + i + 1236) )
      {
        result = qdf_mem_cmp((const void *)(a4 + i + 1237), a2 + 338, 6u);
        if ( !(_DWORD)result )
        {
          v21 = *(_BYTE *)(a4 + 436);
          *(_BYTE *)(a4 + i + 1236) = 0;
  ...
  if ( *(_BYTE *)(a4 + 155) == 1 && (a2[32] & 8) != 0 )
  {
    if ( (a2[332] & 1) == 0 )
    {
      ...
      while ( 1 )
      {
        ...
        {
          result = qdf_mem_cmp((const void *)(a4 + v25 + 1237), a2 + 338, 6u);
          if ( !(_DWORD)result )
            break;
        }
        v25 += 12;
...
LABEL_45:
    ...
    if ( *(_BYTE *)(v16 + 3068) && (a2[334] & 8) == 0 )
    {
      ...
      for ( j = 0; j != 384; j += 12 )
      {
        if ( *(_BYTE *)(a4 + j + 1236) )
        {
          result = qdf_mem_cmp((const void *)(a4 + j + 1237), a2 + 338, 6u);
          if ( !(_DWORD)result )
          {
            v27 = *(_BYTE *)(a4 + 444);
            *(_BYTE *)(a4 + j + 1236) = 0;
...
LABEL_57:
    ...
    if ( !*(_BYTE *)(v16 + 3071) && (a2[332] & 0x10) == 0 )
    {
      LODWORD(v30) = a2[343];
      result = qdf_trace_msg(
                 0x35u,
      ...
      while ( 1 )
      {
        ...
        {
          result = qdf_mem_cmp((const void *)(a4 + v29 + 1237), a2 + 338, 6u);
          if ( !(_DWORD)result )
            break;
        }
        v29 += 12;
