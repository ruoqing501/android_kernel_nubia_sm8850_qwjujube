__int64 __fastcall hdd_nud_failure_work(__int64 a1, __int64 a2)
{
  ...
  v3 = *(_QWORD *)(a2 + 2720);
  v56[0] = nullptr;
  result = _osif_vdev_sync_op_start(v3, v56, (__int64)"hdd_nud_failure_work");
  if ( !(_DWORD)result )
  {
    ...
    if ( (unsigned int)_wlan_hdd_validate_context(
                         ...
                         v37) )
      goto LABEL_16;
    if ( hdd_cm_is_vdev_associated(*(_DWORD **)(a2 + 55512)) )
    {
      if ( *(_BYTE *)(v38 + 185) == 1 )
      {
...
LABEL_16:
          result = _osif_vdev_sync_op_stop((__int64)v56[0], (__int64)"hdd_nud_failure_work");
          goto LABEL_17;
        }
        wlan_hdd_cm_issue_disconnect(*(_QWORD *)(a2 + 55512), 65521, 0);
        v47 = "%s: exit";
      }
    }
    else
