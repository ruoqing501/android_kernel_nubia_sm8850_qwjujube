...
LABEL_19:
  ...
  if ( !v16 || (v17 = *(_QWORD *)(v16 + 80)) == 0 )
  {
    ...
    if ( (v42 & 1) != 0 )
    {
      a1[160] = v42 & 0xFFFFFFFFFFFFFFFELL;
...
LABEL_53:
  ...
  a1[160] = v18 & 0xFFFFFFFFFFFFFFFELL;
  raw_spin_unlock_bh(a1 + 159);
  v19 = *(_QWORD *)(v17 + 2128);
  if ( !v19 )
    goto LABEL_53;
...
LABEL_20:
  ...
  peer_by_mac_n_vdev = wlan_objmgr_get_peer_by_mac_n_vdev(v17, *(unsigned __int8 *)(a1[19] + 40LL), &v56, a3, 19);
