__int64 __fastcall dp_tx_dump_flow_pool_info(__int64 a1)
{
  ...
  memset(s, 0, 0x128u);
  qdf_trace_msg(0x45u, 2u, "No of pool map received %d", v3, v4, v5, v6, v7, v8, v9, v10, v2[296]);
  qdf_trace_msg(0x45u, 2u, "No of pool unmap received %d", v11, v12, v13, v14, v15, v16, v17, v18, v2[297]);
  qdf_trace_msg(
    0x45u,
    2u,
  ...
  {
    raw_spin_lock(a1 + 12856);
  }
  else
  {
    raw_spin_lock_bh(a1 + 12856);
    *(_QWORD *)(a1 + 12864) |= 1uLL;
  }
  v28 = 0;
  ...
  {
    v30 = a1 + v28;
    if ( *(_DWORD *)(a1 + v28 + 2320) > 5u )
      goto LABEL_7;
    if ( (_ReadStatusReg(DAIF) & 0x80) != 0
      || (*(_DWORD *)(v29 + 16) & 0xF0000) != 0
      || (*(_DWORD *)(v29 + 16) & 0xFF00) != 0 )
    {
      raw_spin_lock(v30 + 2512);
    }
    else
    {
      raw_spin_lock_bh(v30 + 2512);
      *(_QWORD *)(a1 + v28 + 2520) |= 1uLL;
    }
    qdf_mem_copy(s, (const void *)(v30 + 2256), 0x128u);
    v31 = *(_QWORD *)(a1 + v28 + 2520);
    if ( (v31 & 1) != 0 )
    {
      *(_QWORD *)(a1 + v28 + 2520) = v31 & 0xFFFFFFFFFFFFFFFELL;
      raw_spin_unlock_bh(v30 + 2512);
      v32 = *(_QWORD *)(a1 + 12864);
      if ( (v32 & 1) != 0 )
      {
LABEL_21:
        *(_QWORD *)(a1 + 12864) = v32 & 0xFFFFFFFFFFFFFFFELL;
        raw_spin_unlock_bh(a1 + 12856);
        goto LABEL_16;
      }
    }
    else
    {
      raw_spin_unlock(v30 + 2512);
      v32 = *(_QWORD *)(a1 + 12864);
      if ( (v32 & 1) != 0 )
        goto LABEL_21;
    }
    raw_spin_unlock(a1 + 12856);
LABEL_16:
...
LABEL_7:
  ...
  while ( v28 != 1776 );
  v169 = *(_QWORD *)(a1 + 12864);
  if ( (v169 & 1) != 0 )
  {
    *(_QWORD *)(a1 + 12864) = v169 & 0xFFFFFFFFFFFFFFFELL;
    result = raw_spin_unlock_bh(a1 + 12856);
  }
  else
  {
    result = raw_spin_unlock(a1 + 12856);
  }
