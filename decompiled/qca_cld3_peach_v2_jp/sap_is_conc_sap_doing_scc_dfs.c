        ...
        double a10)
{
  ...
  if ( (wlan_reg_is_dfs_for_freq(*(_QWORD *)(a1 + 21560), *a2, a3, a4, a5, a6, a7, a8, a9, a10) & 1) != 0 )
  {
    if ( (*(_DWORD *)(a1 + 14824) | 2) == 3 && (v20 = *(unsigned int **)(a1 + 14816)) != nullptr )
    {
      v21 = 0;
      if ( v20 != a2 && v20[182] )
        v21 = *a2 == *v20;
