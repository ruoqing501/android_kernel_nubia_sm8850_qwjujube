        ...
        double a11)
{
  ...
  *(_QWORD *)v96 = 0;
  ...
  if ( a3 )
  {
    ...
    LOBYTE(v97) = 127;
    qdf_mem_copy((char *)&v97 + 1, &unk_89A401, 4u);
...
LABEL_13:
    ...
    *((_WORD *)v44 + 11) = (16 * (v55 & 0xF)) | *((_WORD *)v44 + 11) & 0xFF0F;
    v56 = (unsigned __int8)(*(_WORD *)(a1 + 21532) >> 4);
    *((_WORD *)v44 + 11) = (16 * *(_WORD *)(a1 + 21532)) & 0xFF00 | (16 * (v55 & 0xF));
    qdf_trace_msg(
      0x35u,
      8u,
