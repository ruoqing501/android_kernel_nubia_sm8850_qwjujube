__int64 __fastcall tgt_p2p_noa_event_cb(
        __int64 a1,
        __int64 a2,
        double a3,
        double a4,
...
LABEL_9:
    qdf_trace_msg(0x4Eu, 2u, v34, v12, v13, v14, v15, v16, v17, v18, v19, "tgt_p2p_noa_event_cb");
    if ( a2 )
      _qdf_mem_free(a2);
    goto LABEL_12;
  }
  if ( !a2 )
  {
    qdf_trace_msg(
      0x4Eu,
      2u,
      "%s: invalid noa event information",
      v12,
      v13,
      v14,
      v15,
...
LABEL_12:
  ...
  v22 = (_QWORD *)_qdf_mem_malloc(0x10u, "tgt_p2p_noa_event_cb", 472);
  if ( v22 )
  {
    *v22 = v21;
    v22[1] = a2;
