  ...
  *(_QWORD *)(a1 + 22552) = v2;
  if ( v2 )
  {
    ...
    *(_DWORD *)(a1 + 20004) = 5;
    ...
    if ( v22 > 0xFFF )
    {
      v23 = *(_QWORD *)(a1 + 20024) - v22 + *(_QWORD *)(a1 + 20016);
      *(_QWORD *)(a1 + 20032) = v22 - 4096;
      qdf_trace_msg(
        0x45u,
        5u,
    ...
    v25 = *(_QWORD *)(a1 + 40);
    *(_DWORD *)(a1 + 22560) = v23;
    num_tx_desc = wlan_cfg_get_num_tx_desc(v25, 0);
...
LABEL_13:
    ...
    v24 = dp_hw_cookie_conversion_attach(a1, a1 + 23128, v91, 7, 1u, v90, v92, v93, v94, v95, v96, v97, v98);
    if ( v24 )
      goto LABEL_13;
    v99 = wlan_cfg_get_dp_soc_rx_sw_desc_num(*(_QWORD *)(a1 + 40));
    v24 = dp_hw_cookie_conversion_attach(a1, a1 + 23208, v100, 7, 2u, v99, v101, v102, v103, v104, v105, v106, v107);
    if ( v24 )
      goto LABEL_13;
    v108 = wlan_cfg_get_dp_soc_rx_sw_desc_num(*(_QWORD *)(a1 + 40));
    v24 = dp_hw_cookie_conversion_attach(a1, a1 + 23288, v109, 7, 3u, v108, v110, v111, v112, v113, v114, v115, v116);
    if ( v24 )
      goto LABEL_13;
  }
  else
