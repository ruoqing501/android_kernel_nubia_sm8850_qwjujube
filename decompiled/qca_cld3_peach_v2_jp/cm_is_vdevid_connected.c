bool __fastcall cm_is_vdevid_connected(__int64 a1, unsigned __int8 a2)
{
  ...
  if ( vdev_by_id_from_pdev )
  {
    ...
    else
    {
      ...
      is_vdev_connected = cm_is_vdev_connected((__int64)vdev_by_id_from_pdev, v4, v5, v6, v7, v8, v9, v10, v11);
