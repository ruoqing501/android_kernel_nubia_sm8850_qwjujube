  ...
  *(_DWORD *)(v10 + 12232) = 0;
  ...
  if ( *(_BYTE *)(v10 + 12272) )
  {
    ...
    do
    {
      ...
      if ( hash_entry )
        lim_decide_ap_protection(v10, hash_entry + 338, &v30, a1);
      ++v23;
    }
    while ( *(unsigned __int8 *)(v10 + 12272) >= v23 );
  }
  if ( v13 == *(unsigned __int16 *)(a1 + 8616) || *(_BYTE *)(v10 + 14809) )
  {
  ...
  ((void (__fastcall *)(__int64, __int64))sch_set_fixed_beacon_fields)(v10, a1);
