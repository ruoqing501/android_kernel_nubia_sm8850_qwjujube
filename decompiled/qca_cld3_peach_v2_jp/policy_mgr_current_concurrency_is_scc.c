__int64 __fastcall policy_mgr_current_concurrency_is_scc(__int64 a1)
{
  __int64 *context; // x0
  double v3; // d0
  double v4; // d1
  ...
  if ( !context )
  {
    qdf_trace_msg(
      ...
      v9,
      v10,
      "policy_mgr_current_concurrency_is_scc",
      v26,
      v27,
      v28,
      v29,
...
LABEL_13:
  ...
  if ( sta_p2p_conn_info != 3 )
  {
    if ( sta_p2p_conn_info == 2 )
    {
      ...
      {
        v20 = policy_mgr_are_2_freq_on_same_mac(a1, HIDWORD(v26), HIDWORD(v26));
        goto LABEL_14;
      }
    }
    else
  ...
  if ( (policy_mgr_is_current_hwmode_dbs(a1) & 1) == 0
    && ((unsigned __int8)policy_mgr_is_current_hwmode_sbs(a1) & 1) == 0 )
  {
    v21 = HIDWORD(v26);
    v22 = v31;
    v24 = HIDWORD(v35);
LABEL_19:
  ...
  v24 = HIDWORD(v35);
  v20 = 1;
  if ( HIDWORD(v26) != HIDWORD(v35) && (_DWORD)v31 != HIDWORD(v35) )
    goto LABEL_19;
LABEL_14:
