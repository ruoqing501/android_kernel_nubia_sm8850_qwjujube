__int64 __fastcall target_if_get_roam_vendor_control_param_event_handler(__int64 a1, __int64 a2, unsigned int a3)
{
...
LABEL_8:
  ...
  v17 = wmi_extract_roam_vendor_control_param_event(v15, a2, a3, &v40);
  if ( v17 )
  {
    qdf_trace_msg(
      0x49u,
  ...
  else
  {
    ...
    if ( ext_hdl )
    {
      v37 = *(void (__fastcall **)(__int64, __int64))(ext_hdl + 7392);
      if ( v37 )
      {
        v38 = v40;
        if ( *((_DWORD *)v37 - 1) != -479222966 )
          __break(0x8228u);
        v37(v16, v38);
        result = 0;
        goto LABEL_18;
