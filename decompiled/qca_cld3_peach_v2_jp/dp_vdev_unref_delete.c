        ...
        double a12@<D7>)
{
  ...
  else
  {
    ...
    v12 = a2;
    v13 = result;
    _X8 = (unsigned int *)(a2 + 4LL * a3 + 42564);
  }
  __asm { PRFM            #0x11, [X8] }
  do
    v71 = __ldxr(_X8);
  ...
  if ( v75 )
    return result;
  v16 = *(void (__fastcall **)(__int64, __int64))(v12 + 264);
  v18 = *(__int64 (__fastcall **)(_QWORD))(v12 + 280);
  v17 = *(_QWORD *)(v12 + 288);
  v19 = " with del_notify";
  v20 = *(_QWORD *)(v12 + 88);
  if ( !v16 )
  ...
  v29 = *(unsigned __int8 *)(v13 + 17784);
  if ( v29 == 1 )
  {
    v38 = *(_QWORD *)(v13 + 20056);
    if ( v38 )
    {
      v39 = *(_QWORD *)(v38 + 416);
      if ( v39 )
  ...
  else
  {
    if ( v29 != 2 )
      goto LABEL_28;
    timer_delete_sync(v13 + 17728);
  }
LABEL_19:
  v42 = *(_QWORD *)(v13 + 20056);
  if ( v42 )
  {
    v43 = *(_QWORD *)(v42 + 416);
    if ( v43 )
...
LABEL_28:
  v46 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v12 + 24) + 8LL) + 20056LL);
  if ( v46 )
  {
    v47 = *(_QWORD *)(v46 + 416);
  ...
  {
    raw_spin_lock(v13 + 18912);
    v53 = *(_QWORD *)(v13 + 18896);
    if ( v53 )
      goto LABEL_53;
  }
  else
  {
    raw_spin_lock_bh(v13 + 18912);
    *(_QWORD *)(v13 + 18920) |= 1uLL;
    v53 = *(_QWORD *)(v13 + 18896);
    if ( v53 )
    {
LABEL_53:
      while ( v53 != v12 )
      {
        v53 = *(_QWORD *)(v53 + 42528);
        if ( !v53 )
          goto LABEL_60;
      }
      v54 = *(_QWORD *)(v12 + 42528);
      v55 = *(_QWORD **)(v12 + 42536);
      if ( v54 )
        v56 = (_QWORD *)(v54 + 42536);
      else
        v56 = (_QWORD *)(v13 + 18904);
      *v56 = v55;
      *v55 = *(_QWORD *)(v12 + 42528);
      *(_QWORD *)(v12 + 42536) = 0;
      *(_QWORD *)(v12 + 42528) = 0;
    }
  }
LABEL_60:
  v57 = *(_QWORD *)(v13 + 18920);
  if ( (v57 & 1) != 0 )
  {
    *(_QWORD *)(v13 + 18920) = v57 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(v13 + 18912);
  }
  else
  {
    raw_spin_unlock(v13 + 18912);
  }
  wlan_minidump_remove(v58, v59, v60, v61, v62, v63, v64, v65, v12, 45424, *(_QWORD *)(v13 + 16));
  if ( v16 )
  {
