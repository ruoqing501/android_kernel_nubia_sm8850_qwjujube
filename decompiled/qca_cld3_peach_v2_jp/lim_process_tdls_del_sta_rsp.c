...
LABEL_20:
    ...
    if ( v55 )
    {
      ...
      *(_QWORD *)(v55 + 16) = *(_QWORD *)(a1 + 21552);
      v70 = v55;
      v71 = tgt_tdls_del_peer_rsp;
      v57 = scheduler_post_message_debug(
              0x35u,
              0,
              73,
              (unsigned __int16 *)&v69,
    ...
    lim_release_peer_idx(a1, *(_WORD *)(v51 + 336), a3);
    v66 = *(unsigned __int16 *)(v51 + 336);
    if ( v66 >= 0x20 )
    {
      if ( v66 > 0x3F )
      {
LABEL_19:
        lim_delete_dph_hash_entry(a1, (unsigned __int8 *)(v51 + 338), *(unsigned __int16 *)(v51 + 336), a3);
        goto LABEL_20;
      }
      v67 = 7256;
      LOBYTE(v66) = v66 - 32;
