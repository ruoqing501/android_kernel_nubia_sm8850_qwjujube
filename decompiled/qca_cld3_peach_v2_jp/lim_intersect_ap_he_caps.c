__int64 __fastcall lim_intersect_ap_he_caps(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  if ( a4 && *(_BYTE *)(a4 + 2508) )
    ...
    v8 = a3 + 2640;
  lim_intersect_he_caps((const void *)v8, (_BYTE *)(a2 + 176), a1);
  *(_QWORD *)(a2 + 177) = *(_QWORD *)(a2 + 177) & 0xFFFFFFFFFFFFFFFELL | *(_QWORD *)(v8 + 1) & 1LL;
  ielen_from_bss_description = wlan_get_ielen_from_bss_description(a5);
  if ( wlan_get_vendor_ie_ptr_from_oui(&unk_A0A4D9, 4u, (unsigned __int8 *)(a5 + 104), ielen_from_bss_description)
    && wlan_get_vendor_ie_ptr_from_oui(&unk_A0A4DE, 4u, (unsigned __int8 *)(a5 + 104), ielen_from_bss_description) )
  {
    v18 = *(_QWORD *)(a2 + 177);
