__int64 __fastcall dp_get_peer_mac_list(__int64 a1, unsigned __int8 a2, __int64 a3, unsigned __int16 a4, char a5)
{
  ...
  if ( a2 <= 5u )
  {
    ...
    v11 = *(_QWORD *)(a1 + 8LL * a2 + 12912);
    if ( v11 )
    {
      v12 = a4;
      v13 = *(_DWORD *)(v11 + 42560);
      do
      {
        if ( !v13 )
          goto LABEL_20;
        _X12 = (unsigned int *)(v11 + 42560);
        __asm { PRFM            #0x11, [X12] }
        while ( 1 )
        {
          v20 = __ldxr(_X12);
      ...
      if ( (v35 & 1) != 0 )
      {
        *(_QWORD *)(a1 + 18936) = v35 & 0xFFFFFFFFFFFFFFFELL;
      ...
      v29 = (unsigned int *)*(unsigned int *)(v11 + 42520);
...
LABEL_39:
      ...
      if ( (v38 & 1) != 0 )
      {
        *(_QWORD *)(v11 + 144) = v38 & 0xFFFFFFFFFFFFFFFELL;
