__int64 __fastcall wlan_cm_init_occupied_ch_freq_list(__int64 a1, __int64 a2, unsigned __int8 a3)
{
  ...
  if ( vdev_by_id_from_pdev )
  {
    ...
    if ( cmpt_obj )
    {
      v37 = *(unsigned __int8 *)(cmpt_obj + 162);
      if ( *(_BYTE *)(cmpt_obj + 162) )
      {
        LOBYTE(v89[0]) = *(_BYTE *)(cmpt_obj + 162);
        qdf_mem_copy((char *)v89 + 1, (const void *)(cmpt_obj + 129), v37);
...
LABEL_15:
        ...
        v40 = _qdf_mem_malloc(0x2D0u, "wlan_cm_init_occupied_ch_freq_list", 2374);
        vdev_by_id_from_pdev = (_QWORD *)v16;
        if ( !v40 )
          goto LABEL_15;
