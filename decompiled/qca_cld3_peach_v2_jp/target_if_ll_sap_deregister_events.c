        ...
        double a9)
{
  ...
  {
    wmi_unified_unregister_event_handler(*(_QWORD **)(v9 + 16), 0x107u, a2, a3, a4, a5, a6, a7, a8, a9);
    return wmi_unified_unregister_event_handler(v10, 0x108u, v11, v12, v13, v14, v15, v16, v17, v18);
  }
  else
  {
