        ...
        double a9)
{
  ...
  _X19 = (unsigned __int64 *)(a1 + 6768);
  result = (__int64)qdf_cpumask_clear((_QWORD *)(a1 + 6768));
  __asm { PRFM            #0x11, [X19] }
  do
    v29 = __ldxr(_X19);
  ...
  do
  {
    ...
    dev_pm_qos_add_request(cpu_device, a1 + 4208 + 80LL * (unsigned int)v13, 1, 2000000000);
