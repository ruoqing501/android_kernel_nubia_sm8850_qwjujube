    ...
    else
    {
      ...
      if ( (BYTE4(qword_81C458) != 1
        ...
        && (BYTE4(qword_81C47C) != 1
         || ((wlan_reg_is_same_band_freqs(a2, HIDWORD(qword_81C464)) & 1) != 0
          || !wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_81C464)) && !wlan_reg_is_24ghz_ch_freq(a2))
         && ((is_hw_dbs_required_for_band & 1) == 0 || !wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_81C464))))
        && (BYTE4(qword_81C4A0) != 1
         || ((wlan_reg_is_same_band_freqs(a2, HIDWORD(qword_81C488)) & 1) != 0
          || !wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_81C488)) && !wlan_reg_is_24ghz_ch_freq(a2))
         && ((is_hw_dbs_required_for_band & 1) == 0 || !wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_81C488))))
        && (BYTE4(qword_81C4C4) != 1
         || ((wlan_reg_is_same_band_freqs(a2, HIDWORD(qword_81C4AC)) & 1) != 0
          || !wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_81C4AC)) && !wlan_reg_is_24ghz_ch_freq(a2))
         && ((is_hw_dbs_required_for_band & 1) == 0 || !wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_81C4AC))))
        && (BYTE4(qword_81C4E8) != 1
         || ((wlan_reg_is_same_band_freqs(a2, HIDWORD(qword_81C4D0)) & 1) != 0
          || !wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_81C4D0)) && !wlan_reg_is_24ghz_ch_freq(a2))
         && ((is_hw_dbs_required_for_band & 1) == 0 || !wlan_reg_is_24ghz_ch_freq(HIDWORD(qword_81C4D0)))) )
      {
