__int64 __fastcall wlan_objmgr_peer_component_obj_detach(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  if ( *(_QWORD *)(a1 + 104 + 8LL * a2) != a3 )
  {
    *(_DWORD *)(a1 + 4LL * a2 + 536) = 16;
    v10 = *(_QWORD *)(a1 + 768);
    if ( (v10 & 1) != 0 )
    {
      *(_QWORD *)(a1 + 768) = v10 & 0xFFFFFFFFFFFFFFFELL;
  ...
  *(_QWORD *)(a1 + 104 + 8LL * a2) = 0;
  *(_DWORD *)(a1 + 4LL * a2 + 536) = 0;
  v11 = *(_QWORD *)(a1 + 768);
  if ( (v11 & 1) != 0 )
  {
    *(_QWORD *)(a1 + 768) = v11 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(a1 + 760);
  }
  else
  {
...
LABEL_27:
  ...
  if ( (v24 & 1) != 0 )
  {
    *(_QWORD *)(a1 + 768) = v24 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(a1 + 760);
    if ( v23 == 16 )
      goto LABEL_39;
LABEL_29:
