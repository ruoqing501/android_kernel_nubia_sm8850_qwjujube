...
LABEL_5:
    ...
    {
      raw_spin_lock(v27 + 1240);
      v29 = *(_QWORD *)(v27 + 1248);
      v30 = *(unsigned __int8 *)(v27 + 40);
      if ( (v29 & 1) == 0 )
      {
LABEL_9:
        raw_spin_unlock(v27 + 1240);
LABEL_10:
        qdf_trace_msg(
          0x57u,
          1u,
    ...
    {
      raw_spin_lock_bh(v27 + 1240);
      v29 = *(_QWORD *)(v27 + 1248) | 1LL;
      *(_QWORD *)(v27 + 1248) = v29;
      v30 = *(unsigned __int8 *)(v27 + 40);
      if ( (v29 & 1) == 0 )
        goto LABEL_9;
    }
    *(_QWORD *)(v27 + 1248) = v29 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(v27 + 1240);
    goto LABEL_10;
  }
