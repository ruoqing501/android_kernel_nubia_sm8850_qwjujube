...
LABEL_7:
    ...
    {
      v31 = wlan_serialization_get_active_cmd(*(_QWORD *)(a1 + 21552), a2, 2u, v23, v24, v25, v26, v27, v28, v29, v30);
      if ( !v31 || (v21 = 1, (csr_peer_mac_match_cmd(v31, 1, (char *)&v62 + 6, (char *)&v62 + 12) & 1) == 0) )
      {
        v40 = wlan_serialization_get_active_cmd(*(_QWORD *)(a1 + 21552), a2, 5u, v32, v33, v34, v35, v36, v37, v38, v39);
