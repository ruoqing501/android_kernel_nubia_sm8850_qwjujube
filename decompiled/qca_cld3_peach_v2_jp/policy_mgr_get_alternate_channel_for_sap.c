...
LABEL_40:
  ...
  while ( 1 )
  {
    ...
    v34 = s[v32];
    v35 = BYTE4(qword_81C458);
    v36 = BYTE4(qword_81C47C);
    if ( HIDWORD(pm_conc_connection_list) != v34 )
      v35 = 0;
    v37 = BYTE4(qword_81C4A0);
    if ( HIDWORD(qword_81C464) != v34 )
      v36 = 0;
    v38 = BYTE4(qword_81C4C4);
    if ( HIDWORD(qword_81C488) != v34 )
      v37 = 0;
    if ( HIDWORD(qword_81C4AC) != v34 )
      v38 = 0;
    v39 = v36 + v35 + v37 + v38;
    v40 = HIDWORD(qword_81C4D0) == v34 ? BYTE4(qword_81C4E8) : 0;
    if ( v39 | v40 )
      break;
    if ( !v29 )
      v29 = s[v32];
