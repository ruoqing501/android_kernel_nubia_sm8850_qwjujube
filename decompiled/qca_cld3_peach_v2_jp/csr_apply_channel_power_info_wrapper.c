void *__fastcall csr_apply_channel_power_info_wrapper(__int64 a1)
{
  ...
  if ( v2 )
  {
    ...
    v3[12] = 1;
    wlan_reg_read_current_country(*(_QWORD *)(a1 + 21552), &v27, v4, v5, v6, v7, v8, v9, v10, v11);
    qdf_mem_copy(v3 + 142, &v27, 3u);
    v20 = *(unsigned __int8 *)(a1 + 16532);
    v3[13] = v20;
    if ( (unsigned int)(v20 - 65) >= 0xFFFFFFC0 )
    {
      ...
      while ( v21 < *(unsigned __int8 *)(a1 + 16532) );
    }
    host_diag_log_submit(v3);
    _qdf_mem_free((__int64)v3);
  }
  csr_prune_channel_list_for_mode((void *)a1, (_BYTE *)(a1 + 16532));
  csr_save_channel_power_for_band(a1, 0);
  csr_save_channel_power_for_band(a1, 1);
  csr_apply_channel_power_info_to_fw(a1, (unsigned __int8 *)(a1 + 16532));
  result = qdf_mem_set((void *)(a1 + 14928), 0x194u, 0);
