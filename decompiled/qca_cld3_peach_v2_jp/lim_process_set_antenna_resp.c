_DWORD *__fastcall lim_process_set_antenna_resp(
        __int64 a1,
        int *a2,
        double a3,
        double a4,
        ...
        double a10)
{
  ...
  if ( a2 )
  {
    result = (_DWORD *)_qdf_mem_malloc(4u, "lim_process_set_antenna_resp", 408);
    if ( result )
    {
      v21 = *a2;
LABEL_6:
      *result = v21;
      ...
      qdf_trace_msg(
        0x35u,
        8u,
        "%s: Send eWNI_SME_SET_ANTENNA_MODE_RESP to SME",
        v13,
        v14,
        v15,
        v16,
  ...
  else
  {
    qdf_trace_msg(
      0x35u,
      2u,
      "%s: Set antenna mode resp is NULL",
      a3,
      a4,
      a5,
      a6,
