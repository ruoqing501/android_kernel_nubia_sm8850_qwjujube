        ...
        __int64 *a12)
{
  ...
  {
    v15 = jiffies;
    if ( extract_roam_scan_chan_list_tlv___last_ticks_67 - jiffies + 125 < 0 )
    {
      qdf_trace_msg(
        0x31u,
        2u,
        ...
        a8,
        "extract_roam_scan_chan_list_tlv");
      extract_roam_scan_chan_list_tlv___last_ticks_67 = v15;
    }
    return 4294967274LL;
  }
  if ( *(_DWORD *)(v12 + 4) >= 6u )
  {
    v13 = jiffies;
    if ( extract_roam_scan_chan_list_tlv___last_ticks_69 - jiffies + 125 < 0 )
    {
      qdf_trace_msg(
        0x31u,
        2u,
        ...
        a8,
        "extract_roam_scan_chan_list_tlv");
      extract_roam_scan_chan_list_tlv___last_ticks_69 = v13;
    }
    return 4294967274LL;
  }
  v16 = *((_DWORD *)a10 + 6);
