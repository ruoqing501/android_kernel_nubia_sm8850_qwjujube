__int64 __fastcall dp_ipa_handle_rx_buf_pool_smmu_mapping(__int64 a1, char a2, char a3, __int64 a4, __int64 a5, int a6)
{
  ...
  {
    raw_spin_lock(a1 + 12424);
  }
  else
  {
    raw_spin_lock_bh(a1 + 12424);
    *(_QWORD *)(a1 + 12432) |= 1uLL;
  }
  if ( (_ReadStatusReg(DAIF) & 0x80) != 0
...
LABEL_11:
      ...
      do
      {
        if ( !*(_QWORD *)(a1 + 12392) )
          break;
        v17 = (_BYTE *)dp_rx_desc_find(v15 / v14, v15 % v14, a1 + 12368);
            ...
            *(_DWORD *)(v18 + 48) = v19;
            if ( (a2 & 1) != 0 )
            {
              *(_DWORD *)(v18 + 48) = v19 & 0x3FFFFFF | (a6 << 26);
              _dp_ipa_handle_buf_smmu_mapping(a1, v18, *(unsigned __int16 *)(a1 + 12442), 1);
            }
            else
            {
              v20 = v17;
              _dp_ipa_handle_buf_smmu_mapping(a1, v18, *(unsigned __int16 *)(a1 + 12442), 0);
              if ( (v20[30] & 0x20) != 0 )
                v20[30] &= ~0x20u;
            }
          }
  ...
  if ( (v21 & 1) != 0 )
  {
    *(_QWORD *)(a1 + 18472) = v21 & 0xFFFFFFFFFFFFFFFELL;
  ...
  if ( (v22 & 1) != 0 )
  {
    *(_QWORD *)(a1 + 12432) = v22 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(a1 + 12424);
  }
  else
  {
    raw_spin_unlock(a1 + 12424);
  }
