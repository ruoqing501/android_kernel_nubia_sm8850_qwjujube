__int64 __fastcall policy_mgr_is_owe_connection_present(__int64 a1, unsigned __int8 a2)
{
  __int64 v2; // x20
  double v5; // d0
  double v6; // d1
  ...
  unsigned __int8 v45; // [xsp+Ch] [xbp-24h]
...
LABEL_14:
      ...
      {
        v40 = wlan_objmgr_get_vdev_by_id_from_pdev(a1, BYTE1(v44), 7u);
        if ( !v40 )
          goto LABEL_5;
        v30 = (__int64)v40;
        if ( (wlan_sap_is_owe_connection_present() & 1) != 0 )
        ...
        {
          v41 = wlan_objmgr_get_vdev_by_id_from_pdev(a1, BYTE2(v44), 7u);
          if ( !v41 )
            goto LABEL_5;
          v30 = (__int64)v41;
          if ( (wlan_sap_is_owe_connection_present() & 1) != 0 )
          ...
          {
            v42 = wlan_objmgr_get_vdev_by_id_from_pdev(a1, HIBYTE(v44), 7u);
            if ( !v42 )
              goto LABEL_5;
            v30 = (__int64)v42;
            if ( (wlan_sap_is_owe_connection_present() & 1) != 0 )
