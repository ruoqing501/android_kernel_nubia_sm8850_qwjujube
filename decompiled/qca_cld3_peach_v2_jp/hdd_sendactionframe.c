...
LABEL_13:
  ...
  if ( *(_DWORD *)a2 != *(_DWORD *)(v27 + 300) || a2[2] != *(unsigned __int16 *)(v27 + 304) )
  {
...
LABEL_25:
  ...
  if ( a3 )
  {
    ...
    ucfg_cm_abort_roam_scan(*(_QWORD *)(v25 + 8), *(unsigned __int8 *)(*(_QWORD *)(a1 + 52824) + 8LL));
  }
  else
  {
    HIDWORD(v59[0]) = *(_DWORD *)(v27 + 692);
    if ( !v50 )
      goto LABEL_25;
  }
LABEL_18:
