__int64 __fastcall copy_station_stats_to_adapter(__int64 a1, __int64 a2)
{
  ...
  _QWORD v103[24]; // [xsp+10h] [xbp-120h] BYREF
  _QWORD v104[12]; // [xsp+D0h] [xbp-60h] BYREF

  v104[10] = *(_QWORD *)(_ReadStatusReg(SP_EL0) + 1808);
  v4 = *(_QWORD *)a1;
  result = _hdd_objmgr_get_vdev_by_user(a1, 0x51u, (__int64)"copy_station_stats_to_adapter");
  if ( result )
  {
    v6 = result;
    qdf_mem_copy((void *)(a1 + 2440), (const void *)(*(_QWORD *)(a2 + 96) + 12LL), 0x10u);
    qdf_mem_copy((void *)(a1 + 2456), (const void *)(*(_QWORD *)(a2 + 96) + 28LL), 0x10u);
    qdf_mem_copy((void *)(a1 + 2472), (const void *)(*(_QWORD *)(a2 + 96) + 44LL), 0x10u);
    qdf_mem_copy((void *)(a1 + 2496), (const void *)(*(_QWORD *)(a2 + 96) + 68LL), 0x10u);
    *(_DWORD *)(a1 + 2432) = *(_DWORD *)(*(_QWORD *)(a2 + 96) + 4LL);
    *(_BYTE *)(a1 + 2436) = *(_BYTE *)(*(_QWORD *)(a2 + 96) + 8LL);
    *(_DWORD *)(a1 + 2488) = *(_DWORD *)(*(_QWORD *)(a2 + 96) + 60LL);
    *(_DWORD *)(a1 + 2492) = *(_DWORD *)(*(_QWORD *)(a2 + 96) + 64LL);
    *(_DWORD *)(a1 + 2512) = *(_DWORD *)(*(_QWORD *)(a2 + 96) + 84LL);
    *(_DWORD *)(a1 + 2516) = *(_DWORD *)(*(_QWORD *)(a2 + 96) + 88LL);
    *(_DWORD *)(a1 + 2520) = *(_DWORD *)(*(_QWORD *)(a2 + 96) + 92LL);
    *(_DWORD *)(a1 + 2524) = *(_DWORD *)(*(_QWORD *)(a2 + 96) + 96LL);
    *(_DWORD *)(a1 + 2528) = *(_DWORD *)(*(_QWORD *)(a2 + 96) + 100LL);
    *(_DWORD *)(a1 + 4240) = *(_DWORD *)(*(_QWORD *)(a2 + 56) + 12LL);
    *(_QWORD *)(a1 + 4248) = *(_QWORD *)(*(_QWORD *)(a2 + 56) + 16LL);
    *(_DWORD *)(a1 + 4256) = *(_DWORD *)(*(_QWORD *)(a2 + 56) + 8LL);
    *(_DWORD *)(v4 + 57360) = **(_DWORD **)(a2 + 8);
    *(_DWORD *)(v4 + 57364) = jiffies_to_msecs(jiffies);
    v7 = *(_QWORD *)(a2 + 192);
    if ( v7 )
      *(_BYTE *)(a1 + 2425) = *(_BYTE *)(v7 + 1);
    qdf_mem_copy((void *)(a1 + 2676), (const void *)(*(_QWORD *)(a2 + 128) + 1LL), 2u);
    v9 = *(_QWORD *)(a2 + 168);
    v8 = *(_QWORD *)(a2 + 176);
    *(_DWORD *)(a1 + 4284) = *(_DWORD *)(a2 + 184);
    *(_QWORD *)(a1 + 4268) = v9;
    *(_QWORD *)(a1 + 4276) = v8;
    v10 = *(_QWORD *)(v6 + 152);
    if ( v10 )
      ...
      v11 = 0;
    if ( (ucfg_cp_stats_is_bcn_rssi_history_report_cfg_enable(v11) & 1) != 0
      && *(_DWORD *)(a2 + 200)
      && *(_QWORD *)(a2 + 208) )
    {
      v102 = v6;
      ...
      do
      {
        ...
        link_info_from_vdev = wlan_hdd_get_link_info_from_vdev(
                                ...
                                v19,
                                v11,
                                *(_BYTE *)(*(_QWORD *)(a2 + 208) + 84LL * v20));
        if ( link_info_from_vdev )
          qdf_mem_copy(
            (void *)(link_info_from_vdev + 4288),
            (const void *)(*(_QWORD *)(a2 + 208) + 84LL * v21 + 4),
            0x50u);
        else
          qdf_trace_msg(
            0x33u,
            ...
            *(unsigned __int8 *)(*(_QWORD *)(a2 + 208) + 84LL * v21));
        v20 = v21 + 1;
      }
      while ( *(_DWORD *)(a2 + 200) > (unsigned int)(unsigned __int8)(v21 + 1) );
      v31 = v4 + 52832;
      if ( v4 )
        v32 = v4 + 52832;
      else
      ...
      if ( v32 && v32 == v31 )
      {
        ...
        do
        {
                                ...
                                v19) )
          {
            ...
            do
            {
              v12 = scnprintf((char *)v103 + v35, 192LL - v35, "%d 0x%x,", LODWORD(v104[v34]), HIDWORD(v104[v34]));
              if ( v36 < 1 )
                break;
              v35 += v36;
              if ( v35 >= 0xAC )
...
LABEL_51:
        *(_BYTE *)(a1 + 2537) = v57;
        *(_DWORD *)(a1 + 2552) = *(_DWORD *)(a2 + 140);
        *(_DWORD *)(a1 + 2584) = *(_DWORD *)(a2 + 144);
        ...
        mcs_idx = sme_get_mcs_idx(
                    ...
                    *(unsigned int *)(a2 + 144),
                    ...
                    a1 + 2580,
                    a1 + 2568);
        v90 = *(unsigned __int8 *)(a1 + 2588);
        *(_DWORD *)(a1 + 2560) = mcs_idx;
        if ( v90 )
        {
          v58 = *(unsigned __int8 *)(a1 + 2589);
          if ( *(_BYTE *)(a1 + 2589) )
            goto LABEL_64;
        }
