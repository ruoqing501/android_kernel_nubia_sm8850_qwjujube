__int64 __fastcall debug_wmi_mgmt_command_tx_cmp_log_write(__int64 a1, unsigned __int64 a2, size_t a3)
{
  __int64 v3; // x8
  __int64 result; // x0
  __int64 v5; // x21
  ...
  if ( a2 && a3 <= 0x32 )
  {
    ...
    else if ( sscanf(s, "%d", &v19) != 1 || v19 )
    {
      qdf_trace_msg(
        ...
        v14,
        v15,
        "debug_wmi_mgmt_command_tx_cmp_log_write");
      result = -22;
    }
    else
    {
      ...
      qdf_mem_set(*(void **)(v5 + 568), (unsigned int)(32 * wmi_mgmt_tx_cmpl_log_max_entry), 0);
      v17 = *(_DWORD **)(v5 + 584);
      *(_DWORD *)(v5 + 576) = 0;
      *v17 = 0;
      v18 = *(_QWORD *)(v5 + 672);
