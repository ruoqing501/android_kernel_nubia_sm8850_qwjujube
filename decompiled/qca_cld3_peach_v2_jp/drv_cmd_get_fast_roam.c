__int64 __fastcall drv_cmd_get_fast_roam(__int64 a1, __int64 *a2, __int64 a3, __int64 a4, __int64 a5)
{
  char is_lfr_feature_enabled; // w0
  ...
  is_lfr_feature_enabled = ucfg_cm_get_is_lfr_feature_enabled(*a2);
  memset(v32, 0, 32);
  scnprintf(v32, 32, "%s %d", "GETFASTROAM", is_lfr_feature_enabled & 1);
  v8 = *(_DWORD *)(a5 + 12);
  if ( v8 > v7 )
    LOBYTE(v8) = v7 + 1;
