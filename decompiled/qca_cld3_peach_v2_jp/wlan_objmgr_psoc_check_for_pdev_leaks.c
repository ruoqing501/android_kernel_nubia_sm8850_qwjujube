...
LABEL_19:
  ...
  {
    raw_spin_lock(v35 + 1240);
  }
  else
  {
    raw_spin_lock_bh(v35 + 1240);
    *(_QWORD *)(v35 + 1248) |= 1uLL;
  }
  v45 = 0;
  v46 = 0;
  do
  ...
  if ( (v48 & 1) != 0 )
  {
    *(_QWORD *)(v35 + 1248) = v48 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(v35 + 1240);
    v49 = *(_QWORD *)(a1 + 2824);
    if ( (v49 & 1) == 0 )
      goto LABEL_17;
    goto LABEL_19;
  }
  raw_spin_unlock(v35 + 1240);
  v49 = *(_QWORD *)(a1 + 2824);
  if ( (v49 & 1) != 0 )
    goto LABEL_19;
LABEL_17:
