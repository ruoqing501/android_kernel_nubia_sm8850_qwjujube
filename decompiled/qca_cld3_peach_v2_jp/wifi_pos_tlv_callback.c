...
LABEL_22:
    ...
    if ( *((_DWORD *)v10 + 4) == 16 && !strncmp((const char *)v10[1], "QUALCOMM-OEM-APP", 0x10u) )
    {
      ...
      *(_DWORD *)v72 = *((_DWORD *)v10 + 1);
      ...
      v67 = &wlan_cfg80211_tdls_mgmt_mlo___last_ticks_38;
      vdev_idx = 0;
...
LABEL_42:
  ...
  v66 = v10[1];
  v67 = (__int64 *)*((unsigned int *)v10 + 4);
