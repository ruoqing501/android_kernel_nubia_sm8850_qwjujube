__int64 __fastcall dp_qos_latency_stats_request(__int64 a1, unsigned __int8 a2, unsigned int *a3)
{
  ...
  if ( ref_by_id_1 )
  {
    ...
    v20 = (_DWORD *)(ref_by_id_1 + 42728);
    v21 = ref_by_id_1 + 24LL * v16 + 45232;
    if ( *((_BYTE *)a3 + 8) != 1 )
    {
      *(_DWORD *)(ref_by_id_1 + 24LL * v16 + 45240) = 0;
      v22 = *(__int64 **)(ref_by_id_1 + 24LL * v16 + 45248);
      if ( v22 )
      {
        if ( !*(_DWORD *)(v17 + 45240) && !*(_DWORD *)(v17 + 45264) && !*(_DWORD *)(v17 + 45288) )
        {
    ...
    if ( *(_DWORD *)(ref_by_id_1 + 24LL * v16 + 45240) )
    {
      dp_vdev_unref_delete(a1, ref_by_id_1, 7u, v7, v8, v9, v10, v11, v12, v13, v14, v15);
      return 6;
    }
                      ...
                      if ( v48 )
                      {
                        ...
                        *(_QWORD *)(*(_QWORD *)(v21 + 16) + 64LL) = _qdf_mem_malloc(
                        ...
                        if ( v50 )
                        {
                          ...
                          {
                            v51 = 0;
                            ***(_QWORD ***)(v21 + 16) = *(_QWORD *)(v17 + 43360);
                            *(_QWORD *)(**(_QWORD **)(v21 + 16) + 8LL) = *(_QWORD *)(v17 + 43368);
                            *(_QWORD *)(**(_QWORD **)(v21 + 16) + 16LL) = *(_QWORD *)(v17 + 43376);
                            *(_QWORD *)(**(_QWORD **)(v21 + 16) + 24LL) = *(_QWORD *)(v17 + 43384);
                            *(_QWORD *)(**(_QWORD **)(v21 + 16) + 32LL) = *(_QWORD *)(v17 + 43392);
                            *(_QWORD *)(**(_QWORD **)(v21 + 16) + 40LL) = *(_QWORD *)(v17 + 43400);
                            *(_QWORD *)(**(_QWORD **)(v21 + 16) + 48LL) = *(_QWORD *)(v17 + 43408);
                            *(_QWORD *)(**(_QWORD **)(v21 + 16) + 56LL) = *(_QWORD *)(v17 + 43416);
                            *(_QWORD *)(**(_QWORD **)(v21 + 16) + 64LL) = *(_QWORD *)(v17 + 43424);
                            *(_QWORD *)(**(_QWORD **)(v21 + 16) + 72LL) = *(_QWORD *)(v17 + 43432);
                            *(_QWORD *)(**(_QWORD **)(v21 + 16) + 80LL) = *(_QWORD *)(v17 + 43440);
                            *(_QWORD *)(**(_QWORD **)(v21 + 16) + 88LL) = *(_QWORD *)(v17 + 43448);
                            *(_QWORD *)(**(_QWORD **)(v21 + 16) + 96LL) = *(_QWORD *)(v17 + 43456);
                            *(_QWORD *)(**(_QWORD **)(v21 + 16) + 104LL) = *(_QWORD *)(v17 + 43464);
                            *(_QWORD *)(**(_QWORD **)(v21 + 16) + 112LL) = *(_QWORD *)(v17 + 43472);
                            *(_QWORD *)(**(_QWORD **)(v21 + 16) + 120LL) = *(_QWORD *)(v17 + 43480);
                            *(_QWORD *)(**(_QWORD **)(v21 + 16) + 128LL) = *(_QWORD *)(v17 + 43488);
                            *(_QWORD *)(**(_QWORD **)(v21 + 16) + 136LL) = *(_QWORD *)(v17 + 43496);
                            *(_QWORD *)(**(_QWORD **)(v21 + 16) + 144LL) = *(_QWORD *)(v17 + 43504);
                            *(_QWORD *)(**(_QWORD **)(v21 + 16) + 152LL) = *(_QWORD *)(v17 + 43512);
                            *(_QWORD *)(**(_QWORD **)(v21 + 16) + 160LL) = *(_QWORD *)(v17 + 43520);
                            *(_QWORD *)(**(_QWORD **)(v21 + 16) + 168LL) = *(_QWORD *)(v17 + 43528);
                            *(_QWORD *)(**(_QWORD **)(v21 + 16) + 176LL) = *(_QWORD *)(v17 + 43536);
                            *(_QWORD *)(**(_QWORD **)(v21 + 16) + 184LL) = *(_QWORD *)(v17 + 43544);
                            *(_QWORD *)(**(_QWORD **)(v21 + 16) + 192LL) = *(_QWORD *)(v17 + 43552);
                            *(_QWORD *)(**(_QWORD **)(v21 + 16) + 200LL) = *(_QWORD *)(v17 + 43560);
                            do
                            {
                              *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v21 + 16) + 8LL) + v51) = *(_QWORD *)(v17 + 43568 + v51);
                              v51 += 8;
                            }
                            while ( v51 != 208 );
                            for ( i = 0; i != 208; i += 8 )
                              *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v21 + 16) + 16LL) + i) = *(_QWORD *)(v17 + 43776 + i);
                            for ( j = 0; j != 208; j += 8 )
                              *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v21 + 16) + 24LL) + j) = *(_QWORD *)(v17 + 43984 + j);
                            for ( k = 0; k != 208; k += 8 )
                              *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v21 + 16) + 32LL) + k) = *(_QWORD *)(v17 + 44192 + k);
                            for ( m = 0; m != 208; m += 8 )
                              *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v21 + 16) + 40LL) + m) = *(_QWORD *)(v17 + 44400 + m);
                            for ( n = 0; n != 208; n += 8 )
                              *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v21 + 16) + 48LL) + n) = *(_QWORD *)(v17 + 44608 + n);
                            for ( ii = 0; ii != 208; ii += 8 )
                              *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v21 + 16) + 56LL) + ii) = *(_QWORD *)(v17 + 44816 + ii);
                            for ( jj = 0; jj != 208; jj += 8 )
                              *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v21 + 16) + 64LL) + jj) = *(_QWORD *)(v17 + 45024 + jj);
                            goto LABEL_107;
                          }
                          v69 = (_DWORD *)(v17 + 43352);
                          v89 = (void *)(v17 + 43360);
                          v90 = 1872;
LABEL_106:
...
LABEL_107:
                          ...
                          *(_DWORD *)(v21 + 8) = *((unsigned __int8 *)a3 + 8);
                          raw_spin_lock(v17 + 42712);
                          *(_BYTE *)(v17 + 42742) = 1;
                          *v20 = 1;
                          raw_spin_unlock(v17 + 42712);
                          v23 = 0;
LABEL_103:
                      ...
                      if ( v67 )
                      {
                        ...
                        *(_QWORD *)(*(_QWORD *)(v21 + 16) + 64LL) = _qdf_mem_malloc(
                        ...
                        if ( v68 )
                        {
                          ...
                          v69 = (_DWORD *)(v17 + 42768);
                          if ( *(_DWORD *)(v17 + 42768) )
                          {
                            v70 = 0;
                            v71 = (_QWORD *)(v17 + 42808);
                            do
                            {
