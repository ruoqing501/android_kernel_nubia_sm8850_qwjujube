...
LABEL_17:
  ...
  if ( *(_BYTE *)(v12 + 6776) != 1 )
  {
    result = sme_get_roam_scan_channel_list(a2, a3, a4, *(unsigned __int8 *)(*(_QWORD *)(a1 + 52824) + 8LL));
    if ( !(_DWORD)result )
      return result;
...
LABEL_16:
  ...
  *(_QWORD *)(v26 + 8) = v26 + 16;
  ...
  roam_scan_ch = sme_get_roam_scan_ch(*(_QWORD *)(v12 + 16), *(unsigned __int8 *)(*(_QWORD *)(a1 + 52824) + 8LL), v27);
  if ( roam_scan_ch )
  {
    v37 = roam_scan_ch;
    qdf_trace_msg(
