    ...
    *(_QWORD *)v99 = 0;
    ...
    if ( result )
    {
      if ( *(_DWORD *)(result + 7036) == 2 )
      {
        ...
        {
          v21 = *(_QWORD *)(*(_QWORD *)(result + 16) + 152LL);
          if ( v21 )
          {
            v22 = *(_QWORD *)(v21 + 80);
            if ( v22 )
            {
              v23 = result;
              v103 = 5386;
              v24 = *(unsigned __int8 *)(result + 10077);
              if ( v24 <= 1 )
                LOBYTE(v24) = 1;
              *(_BYTE *)(result + 10077) = v24 + 1;
              v104 = v24;
              v105 = 1281;
              ...
              if ( wlan_reg_is_5ghz_ch_freq(v25)
                || wlan_reg_is_24ghz_ch_freq(v25) && *(_BYTE *)(context[1] + 2671LL) == 1 )
              {
                  ...
                  *(_BYTE *)(*(_QWORD *)v99 + 16LL) = v44[24];
                  ...
                  else
                  {
                    ...
                    qdf_trace_msg(
                      ...
                      "lim_send_channel_usage_req_notif_cap_action_frame",
                      (unsigned __int8)a1,
                      *((unsigned __int16 *)context + 10766),
                      v75,
                      v76,
                      v77,
                      v78,
