...
LABEL_16:
  ...
  v25 = *(__int64 **)(v23 + 24);
  vdev_by_user = _hdd_objmgr_get_vdev_by_user(*(_QWORD *)(v23 + 52824), 6, "wlan_hdd_handle_restrict_offchan_config");
  if ( !vdev_by_user )
  {
LABEL_17:
    result = 4294967274LL;
  ...
  if ( (v11 & 1) != 0 )
  {
    v36 = *(_BYTE *)(vdev_by_user + 104);
    v37 = *v25;
    v62 = *(unsigned __int8 *)(v35 + 104);
    v38 = policy_mgr_qdf_opmode_to_pm_con_mode(v37, v24, v36, v27, v28, v29, v30, v31, v32, v33, v34);
    if ( (_ReadStatusReg(DAIF) & 0x80) != 0
      || (StatusReg = _ReadStatusReg(SP_EL0), (*(_DWORD *)(StatusReg + 16) & 0xF0000) != 0)
      || (*(_DWORD *)(StatusReg + 16) & 0xFF00) != 0 )
    {
      raw_spin_lock(v35 + 1272);
      v40 = *(_QWORD *)(v35 + 1280);
    }
    else
    {
      raw_spin_lock_bh(v35 + 1272);
      v40 = *(_QWORD *)(v35 + 1280) | 1LL;
      *(_QWORD *)(v35 + 1280) = v40;
    }
    *(_DWORD *)(v35 + 48) |= 0x200u;
    if ( (v40 & 1) != 0 )
    {
      *(_QWORD *)(v35 + 1280) = v40 & 0xFFFFFFFFFFFFFFFELL;
      raw_spin_unlock_bh(v35 + 1272);
    }
    else
    {
      raw_spin_unlock(v35 + 1272);
    }
  ...
  else
  {
    ...
    {
      raw_spin_lock(vdev_by_user + 1272);
      v53 = *(_QWORD *)(v35 + 1280);
    }
    else
    {
      raw_spin_lock_bh(vdev_by_user + 1272);
      v53 = *(_QWORD *)(v35 + 1280) | 1LL;
      *(_QWORD *)(v35 + 1280) = v53;
    }
    *(_DWORD *)(v35 + 48) &= ~0x200u;
    if ( (v53 & 1) != 0 )
    {
      *(_QWORD *)(v35 + 1280) = v53 & 0xFFFFFFFFFFFFFFFELL;
      raw_spin_unlock_bh(v35 + 1272);
    }
    else
    {
