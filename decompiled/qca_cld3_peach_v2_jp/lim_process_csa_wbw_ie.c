__int64 __fastcall lim_process_csa_wbw_ie(__int64 a1, __int64 a2, _BYTE *a3, __int64 a4)
{
  ...
  v9 = *(_DWORD *)(a2 + 12);
  v10 = vht_ch_width;
  if ( !*(_BYTE *)(a2 + 17) && !*(_BYTE *)(a2 + 18) )
    goto LABEL_46;
  v11 = *(_DWORD *)(a2 + 4);
  if ( !wlan_reg_is_6ghz_op_class(*(_QWORD *)(a1 + 21560), *(_BYTE *)(a2 + 16)) )
  {
...
LABEL_45:
      ...
      if ( *(_BYTE *)(a2 + 18) )
      {
        v50 = v49 - *(unsigned __int8 *)(a2 + 17);
        if ( v50 < 0 )
          v50 = *(unsigned __int8 *)(a2 + 17) - v49;
        if ( v50 == 8 )
        {
          *(_WORD *)(a2 + 17) = (unsigned __int8)v49;
LABEL_19:
          v52 = v40 - v11;
          if ( (int)v40 - v11 < 0 )
            v52 = v11 - v40;
