        ...
        double a9)
{
  ...
  *(_DWORD *)(comp_private_obj + 264) = *(_DWORD *)(cfg_psoc_get_values(a1) + 10364);
  *(_DWORD *)(v19 + 268) = *(_DWORD *)(cfg_psoc_get_values(a1) + 10368);
  *(_BYTE *)(v19 + 272) = *(_BYTE *)(v19 + 272) & 0xFE | *(_BYTE *)(cfg_psoc_get_values(a1) + 10372);
  *(_BYTE *)(v19 + 272) = *(_BYTE *)(v19 + 272) & 0xFD | (2 * *(_BYTE *)(cfg_psoc_get_values(a1) + 10360));
  *(_BYTE *)(v19 + 272) = *(_BYTE *)(v19 + 272) & 0xFB | (4 * *(_BYTE *)(cfg_psoc_get_values(a1) + 10373));
  *(_BYTE *)(v19 + 272) = *(_BYTE *)(v19 + 272) & 0xF7 | (8 * *(_BYTE *)(cfg_psoc_get_values(a1) + 10374));
  v20 = *(unsigned __int8 *)(cfg_psoc_get_values(a1) + 10375);
  v21 = *(_BYTE *)(v19 + 272) & 0xEF | (16 * v20);
  *(_BYTE *)(v19 + 272) = v21;
  if ( v20 )
    v22 = v21 & 0xDF;
  else
    v22 = *(_BYTE *)(v19 + 272) & 0xDF | (32 * *(_BYTE *)(cfg_psoc_get_values(a1) + 10376));
  *(_BYTE *)(v19 + 272) = v22;
  *(_QWORD *)(v19 + 8) = v19 + 8;
  *(_QWORD *)(v19 + 16) = v19 + 8;
