        ...
        double a12)
{
  ...
  v31 = v16;
  v32 = a3 + v16;
  if ( hdd_cm_is_vdev_associated(*(_DWORD **)(v30 + 3672)) )
  {
    v33 = *(_QWORD *)a1;
    memset(s, 0, 194);
    ...
    if ( (unsigned int)ucfg_pmo_get_mc_addr_list(
                         *(_QWORD *)a1,
                         *(unsigned __int8 *)(*(_QWORD *)(v30 + 3672) + 8LL),
                         s,
                         v34,
                         v35,
                         v36,
...
LABEL_13:
        ...
        if ( a4 <= v67 + v45 )
          goto LABEL_63;
        memset(s, 0, 0x28Cu);
        v70 = _hdd_objmgr_get_vdev_by_user(*(_QWORD *)(v30 + 3672), 0x56u, (__int64)"wlan_hdd_ns_offload_info_debugfs");
        if ( !v70 )
          goto LABEL_57;
        v71 = a3 + v68;
        v72 = v70;
