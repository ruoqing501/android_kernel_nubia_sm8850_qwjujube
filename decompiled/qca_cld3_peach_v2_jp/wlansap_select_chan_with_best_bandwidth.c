        ...
        double a13)
{
  ...
  double v89; // d6
  double v90; // d7
  __int64 v96; // [xsp+0h] [xbp-100h]
  unsigned __int16 v97; // [xsp+Ch] [xbp-F4h] BYREF
  __int64 v98; // [xsp+10h] [xbp-F0h] BYREF
  __int64 v99; // [xsp+18h] [xbp-E8h]
  _QWORD v100[25]; // [xsp+20h] [xbp-E0h] BYREF
  int v101; // [xsp+E8h] [xbp-18h]
  __int64 v102; // [xsp+F0h] [xbp-10h]
...
LABEL_11:
  ...
  v30 = v29;
  if ( (unsigned int)policy_mgr_mode_specific_connection_count(v29[2694], 0, nullptr)
    || (unsigned int)policy_mgr_mode_specific_connection_count(v30[2694], 2, nullptr)
    || (unsigned int)policy_mgr_mode_specific_connection_count(v30[2694], 3, nullptr) )
  {
...
LABEL_14:
  ...
  cnss_utils_get_wlan_unsafe_channel(v28[5], v100, &v97, 204);
  v33 = v97;
  if ( v97 >= 0x66u )
    v34 = 102;
  else
...
LABEL_42:
  ...
  while ( v79 != 204 )
  {
    v80 = *(unsigned __int16 *)((char *)v100 + v79);
    if ( (unsigned int)v77 <= v80 && (unsigned int)v78 >= v80 )
    {
      LODWORD(v96) = *(unsigned __int16 *)((char *)v100 + v79);
      qdf_trace_msg(
        0x39u,
        8u,
