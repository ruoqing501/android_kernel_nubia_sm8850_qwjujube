      ...
      if ( v10 )
      {
        ...
        if ( v11 )
        {
          ...
          if ( v12 )
          {
            ...
            {
              v26 = cmpt_obj;
              v27 = _qdf_mem_malloc(0x3F0u, "mlme_vdev_obj_create_handler", 96);
              if ( !v27 )
                return 2;
              v36 = (_QWORD *)v27;
              wlan_minidump_log(v28, v29, v30, v31, v32, v33, v34, v35, v27, 1008, v10);
              v36[63] = a1;
              ...
              else
              {
                if ( !(unsigned int)mlme_vdev_sm_create(v36) )
                {
                  ...
                  else
                  {
                    ...
                    {
                      v36[122] = mlme_vdev_reconfig_timer_cb;
                      v36[123] = v36;
                      init_timer_key(v36 + 117, _os_timer_shim_4, 0, 0, 0);
                      wlan_objmgr_vdev_component_obj_attach(a1, 0, (__int64)v36, 0);
                      if ( !(unsigned int)mlme_vdev_ops_ext_hdl_post_create() )
                      {
                        qdf_mem_set((char *)v36 + 316, 0x50u, 255);
                        return 0;
                      }
                      qdf_trace_msg(
                        0x68u,
...
LABEL_31:
              wlan_minidump_remove(v49, v50, v51, v52, v53, v54, v55, v56, (__int64)v36, 1008, v10);
