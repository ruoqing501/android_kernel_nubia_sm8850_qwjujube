        ...
        double a9)
{
  ...
  if ( !v19 )
    return qdf_trace_msg(
             ...
             a1);
  v28 = v19;
  v29 = _cds_get_context(71, (__int64)"hdd_v2_flow_pool_map", v20, v21, v22, v23, v24, v25, v26, v27);
  if ( v29 && *v29 )
  {
    v38 = *(__int64 (**)(void))(*v29 + 112LL);
    if ( v38 )
    {
      v38 = *(__int64 (**)(void))v38;
      if ( v38 )
      {
        if ( *((_DWORD *)v38 - 1) != -254072184 )
          __break(0x8228u);
        v39 = v38();
        if ( (v39 & 0xFFFFFFFB) != 0 )
          qdf_trace_msg(
  ...
  {
    qdf_trace_msg(0x89u, 8u, "%s: Invalid Instance:", v30, v31, v32, v33, v34, v35, v36, v37, "cdp_flow_pool_map");
  }
