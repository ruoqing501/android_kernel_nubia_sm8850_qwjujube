...
LABEL_19:
  ...
  if ( (mlme_is_chan_switch_in_progress(*(_QWORD *)(a1 + 504), a2, a3, a4, a5, a6, a7, a8, a9) & 1) == 0 )
    return 0;
  if ( !*(_DWORD *)(*(_QWORD *)(a1 + 504) + 16LL) )
  ...
  if ( v21 == 4 )
  {
    ...
    v37 = wlan_reg_freq_to_chan(v36[2695], *(_DWORD *)(a11 + 284), v13, v14, v15, v16, v17, v18, v19, v20);
    v46 = *(_DWORD *)(a11 + 164);
    if ( *(_BYTE *)(a11 + 161) == 1 )
    {
      if ( v46 == 3 )
...
LABEL_38:
  ...
  mlme_set_chan_switch_in_progress(*(_QWORD *)(a1 + 504), 0, v27, v28, v29, v30, v31, v32, v33, v34);
  return v62;
}
