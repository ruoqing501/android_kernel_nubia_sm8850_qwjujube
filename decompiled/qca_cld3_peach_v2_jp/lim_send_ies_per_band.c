        ...
        double a12)
{
  ...
  if ( a3 - 7 < 7 || a3 == 5 || !a3 )
  {
    ...
    is_beamforming_supported = ucfg_nan_is_beamforming_supported(*(_QWORD *)(a1 + 21552));
  ...
  else
  {
    ...
    v84 = ucfg_nan_is_beamforming_supported(*(_QWORD *)(a1 + 21552));
    if ( a4 == 11 && (v84 & 1) == 0 )
      LODWORD(v93) = v93 & 0xFFE7E7FF;
    v85 = lim_send_ie((unsigned __int8)a2, 191, 2, &v93, 12);
    wlan_mlme_get_vht_for_24ghz(*(_QWORD *)(a1 + 21552), v91);
    if ( v91[0] == 1 )
    {
      if ( (*(_WORD *)(*(_QWORD *)(a1 + 8) + 1268LL) & 1) != 0 )
      {
  ...
  if ( ((1 << a3) & 0x3001) != 0 && (a4 == 16 || a4 == 11) )
    wlan_nan_is_eht_capable(*(_QWORD *)(a1 + 21552));
LABEL_73:
