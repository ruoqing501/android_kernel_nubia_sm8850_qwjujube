__int64 __fastcall pld_register_driver(_QWORD *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( pld_ctx )
  {
    if ( *(_QWORD *)pld_ctx )
    {
      printk(&unk_8A8D59, "pld_register_driver", 254, a4);
      return 4294967279LL;
    }
    else if ( a1 && *a1 && a1[1] && a1[7] && a1[8] )
    {
      ...
      *(_DWORD *)(v4 + 32) = 0;
      ...
      if ( (_DWORD)result )
      {
        ...
        {
          v8 = result;
          printk(&unk_8BF2A5, "pld_register_driver", 271, v6);
          result = v8;
    ...
    {
      printk(&unk_8A8D87, "pld_register_driver", 261, a4);
      return 4294967274LL;
    }
  }
  else
  {
    printk(&unk_8B3FA3, "pld_register_driver", 248, a4);
    return 4294967277LL;
  }
  return result;
}
