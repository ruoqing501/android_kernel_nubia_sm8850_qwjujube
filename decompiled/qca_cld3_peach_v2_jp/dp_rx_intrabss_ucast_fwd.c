...
LABEL_2:
    ...
    if ( (_qdf_is_pp_nbuf(v13) & 1) != 0 )
      *(_QWORD *)(v13 + 40) = v7;
    v17 = *(void (__fastcall **)(__int64, __int64))(*(_QWORD *)a2 + 256LL);
    if ( v17 )
    {
    ...
    if ( (*(_BYTE *)(a1 + 20092) & 1) != 0 || dp_tx_send(a1, a3, v13) )
    {
      if ( a2 )
      {
        v19 = a2 + 3256LL * a7;
        v20 = *(_QWORD *)(v19 + 3128) + v12;
        ++*(_QWORD *)(v19 + 3120);
        *(_QWORD *)(v19 + 3128) = v20;
      }
      result = 0;
