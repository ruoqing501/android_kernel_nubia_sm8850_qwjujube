void *__fastcall convert_edca_param(__int64 a1, __int64 a2, __int64 a3)
{
  void *result; // x0
  char v6; // w9
  char v7; // w9
  ...
  *(_WORD *)a2 = 5132;
  result = qdf_mem_copy((void *)(a2 + 2), (const void *)(a3 + 1), 1u);
  v6 = *(_BYTE *)(a2 + 4) & 0xF0 | *(_BYTE *)(a3 + 3) & 0xF;
  *(_BYTE *)(a2 + 4) = v6;
  v7 = v6 & 0xEF | (16 * ((*(_BYTE *)(a3 + 3) & 0x10) != 0));
  *(_BYTE *)(a2 + 4) = v7;
  v8 = v7 & 0x9F | *(_BYTE *)(a3 + 3) & 0x60;
  v9 = *(_BYTE *)(a2 + 5);
  *(_BYTE *)(a2 + 4) = v8;
  v10 = *(_BYTE *)(a3 + 4);
  *(_BYTE *)(a2 + 5) = v9 & 0xF0 | v10 & 0xF;
  *(_BYTE *)(a2 + 5) = *(_BYTE *)(a3 + 4) & 0xF0 | v10 & 0xF;
  v11 = *(_BYTE *)(a2 + 9);
