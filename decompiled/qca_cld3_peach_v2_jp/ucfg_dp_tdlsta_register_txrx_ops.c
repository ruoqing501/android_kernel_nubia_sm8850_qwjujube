__int64 __fastcall ucfg_dp_tdlsta_register_txrx_ops(__int64 a1)
{
  __int64 context; // x0
  double v3; // d0
  double v4; // d1
  ...
  context = _cds_get_context(71, "ucfg_dp_tdlsta_register_txrx_ops");
  if ( !a1 )
  {
    qdf_trace_msg(
      0x45u,
...
LABEL_6:
    qdf_trace_msg(
      ...
      v19,
      v20,
      "ucfg_dp_tdlsta_register_txrx_ops",
      v47[0]);
    result = 4;
    goto LABEL_33;
  }
