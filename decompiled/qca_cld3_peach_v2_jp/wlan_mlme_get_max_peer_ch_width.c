__int64 __fastcall wlan_mlme_get_max_peer_ch_width(__int64 a1, unsigned __int8 *a2)
{
  ...
  if ( peer_by_mac )
  {
    ...
    qdf_trace_msg(
      0x1Fu,
      8u,
      "%s: phymode: %d, Max allowed ch_width: %d ",
      v13,
      v14,
      v15,
      v16,
      ...
      v19,
      v20,
      "wlan_mlme_get_max_ch_width_from_phymode",
      v12,
      v21);
  }
  else
  {
    ...
    qdf_trace_msg(
      ...
      v10,
      v11,
      "wlan_mlme_get_max_peer_ch_width",
      29,
      v22,
      v23,
      v24,
