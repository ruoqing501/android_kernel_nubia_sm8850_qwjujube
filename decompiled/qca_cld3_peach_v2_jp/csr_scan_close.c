__int64 __fastcall csr_scan_close(__int64 a1)
{
  ...
  while ( 1 )
  {
    v2 = csr_ll_remove_head(a1 + 16936, 0);
    if ( !v2 )
      break;
    _qdf_mem_free(v2);
  }
  ...
  while ( 1 )
  {
    v3 = csr_ll_remove_head(a1 + 17024, 0);
    if ( !v3 )
      break;
    _qdf_mem_free(v3);
  }
  csr_ll_unlock(a1 + 17024);
  csr_ll_close(a1 + 16936);
  csr_ll_close(a1 + 17024);
  comp_private_obj = (_DWORD *)wlan_objmgr_psoc_get_comp_private_obj(*(_QWORD *)(a1 + 21552), 3u);
  if ( comp_private_obj )
  {
    *comp_private_obj |= 2u;
    qdf_trace_msg(
