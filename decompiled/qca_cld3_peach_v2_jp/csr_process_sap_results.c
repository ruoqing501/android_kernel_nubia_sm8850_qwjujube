        ...
        double a12)
{
  ...
  v15 = *(_QWORD *)(a1 + 17224) + 96LL * (unsigned __int8)a4;
  v89 = 8;
  v90 = 18;
  if ( !v15 )
  {
LABEL_13:
  ...
  {
    v20 = result;
    opmode_from_vdev_id = wlan_get_opmode_from_vdev_id(*(_QWORD *)(a1 + 21560), a4);
    qdf_trace_msg(
      0x34u,
      8u,
      "%s: SAP result : %d",
    ...
    if ( a3 - 2 < 2 )
    {
      ...
      {
        v38 = v18;
        if ( *(_DWORD *)(a1 + 4 * v13 + 17196) == 3 )
        {
          v54 = *(_QWORD *)(a1 + 17224) + 96LL * (unsigned int)v13;
          v55 = *(_QWORD *)(v54 + 32);
          if ( v55 )
          {
            _qdf_mem_free(v55);
          ...
          *(_QWORD *)(v54 + 8) = 0;
          *(_QWORD *)(v54 + 16) = 0;
          v56 = csr_translate_to_wni_cfg_dot11_mode(a1, *(unsigned int *)(a1 + 17132));
          v38 = v18;
          *(_DWORD *)(*(_QWORD *)(a1 + 8) + 5748LL) = v56;
        }
        if ( a1 )
        {
          v57 = *(_QWORD *)(a1 + 17224);
          if ( v57 )
          {
            ...
            {
              wlan_get_operation_chan_freq_vdev_id(*(_QWORD *)(a1 + 21560), a4);
              v58 = *(_DWORD **)(a1 + 21968);
              if ( v58 )
              {
                v59 = *(_QWORD *)(a1 + 21552);
    ...
    if ( a3 == 1 )
    {
      ...
      if ( a1 && (v49 = *(_QWORD *)(a1 + 17224)) != 0 && (*(_BYTE *)(v49 + 96LL * (unsigned int)v13 + 1) & 1) != 0 )
      {
        v51 = v89;
        v50 = v90;
        wlan_get_operation_chan_freq_vdev_id(*(_QWORD *)(a1 + 21560), a4);
      ...
      *(_DWORD *)(*(_QWORD *)(a1 + 8) + 5748LL) = csr_translate_to_wni_cfg_dot11_mode(a1, *(unsigned int *)(a1 + 17132));
      goto LABEL_73;
    }
    if ( a3 )
    {
...
LABEL_72:
      ...
      qdf_trace_msg(
        ...
        v18);
      v41 = wlan_get_opmode_from_vdev_id(*(_QWORD *)(a1 + 21560), a4);
      v42 = v41 & 0xFFFFFFFD;
      if ( (v41 & 0xFFFFFFFD) == 1 )
      {
        v43 = 3;
...
LABEL_53:
        ...
        *(_QWORD *)(v40 + 8) = 0;
        *(_QWORD *)(v40 + 16) = 0;
        wlan_mlme_get_mac_vdev_id(*(_QWORD *)(a1 + 21560), a4, (void *)(v20 + 17));
        if ( v42 == 1 && wlan_is_open_wep_cipher(*(_QWORD *)(a1 + 21560), a4) )
...
LABEL_71:
      ...
      *(_DWORD *)(v40 + 4) = 6;
      if ( !(unsigned int)wlan_mlme_get_wmm_mode(*(_QWORD *)(a1 + 21552), v92) )
      {
        if ( v92[0] == 2 )
        {
          *(_BYTE *)(v40 + 40) = 0;
        ...
        {
          if ( (unsigned int)wlan_mlme_get_wmm_uapsd_mask(*(_QWORD *)(a1 + 21552), v91) )
            goto LABEL_73;
          *(_BYTE *)(v40 + 40) = v91[0];
        }
        v62 = 1;
