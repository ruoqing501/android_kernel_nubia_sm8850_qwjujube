__int64 wifi_pos_init()
{
  ...
  if ( !handler )
  {
    ...
    if ( v18 )
    {
      ...
      qdf_trace_msg(
        0x25u,
        2u,
        "%s: register_psoc_destroy_handler failed, status: %d",
        v19,
        v20,
        v21,
        v22,
    ...
    else
    {
      ...
      if ( v35 )
      {
        ...
        qdf_trace_msg(
          0x25u,
          2u,
          "%s: register_vdev_create_handler failed, status: %d",
          v36,
          v37,
          v38,
          v39,
      ...
      else
      {
        ...
        if ( v52 )
        {
          ...
          qdf_trace_msg(
            0x25u,
            2u,
            "%s: register_vdev_destroy_handler failed, status: %d",
            v53,
            v54,
            v55,
            v56,
        ...
        else
        {
          ...
          if ( v69 )
          {
            ...
            qdf_trace_msg(
              0x25u,
              2u,
              "%s: peer create register notification failed",
              v70,
              v71,
              v72,
              v73,
          ...
          else
          {
            ...
            qdf_trace_msg(
              0x25u,
              2u,
              "%s: peer destroy register notification failed",
              v86,
              v87,
              v88,
              v89,
  ...
  qdf_trace_msg(
    0x25u,
    2u,
    "%s: register_psoc_create_handler failed, status: %d",
    v9,
    v10,
    v11,
    v12,
