        ...
        __int64 a11)
{
  ...
  if ( !wlan_hdd_validate_modules_state((__int64)context, v31, v32, v33, v34, v35, v36, v37, v38)
    || (power_string = wlan_reg_get_power_string(*((unsigned __int8 *)context + 7098)),
        scnprintf(a11, 4096, "freq list for power type %s\n", power_string),
        v42 = v41,
        v43 = wlan_reg_get_power_string(*((unsigned __int8 *)context + 7098)),
        !strcmp(v43, "INVALID")) )
  {
    v39 = -22;
    goto LABEL_19;
  ...
  v45 = (__int64)v44;
  wlan_reg_get_6g_ap_master_chan_list(context[1], *((unsigned __int8 *)context + 7098), v44);
  v46 = 0;
  while ( 1 )
  {
    v48 = v45 + v46;
