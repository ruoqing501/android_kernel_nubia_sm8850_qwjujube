  ...
  if ( result )
  {
    ...
    if ( *(_QWORD *)result )
    {
      *a4 = 0;
      ...
      {
LABEL_15:
        v27 = dp_tx_send(v21, *(_BYTE *)(a2 + 59), (char *)a3);
        v28 = *(_QWORD *)v17;
        if ( v27 )
        {
          if ( v28 )
          {
            ++*(_QWORD *)(v28 + 3120);
            if ( *(_QWORD *)v17 )
              *(_QWORD *)(*(_QWORD *)v17 + 3128LL) += (unsigned __int16)v22;
          }
          ++*(_QWORD *)(v19 + 42152);
        ...
        else
        {
          if ( v28 )
          {
            ++*(_QWORD *)(v28 + 3104);
            if ( *(_QWORD *)v17 )
              *(_QWORD *)(*(_QWORD *)v17 + 3112LL) += (unsigned __int16)v22;
          }
          ++*(_QWORD *)(v19 + 42120);
          *a4 = 1;
        }
