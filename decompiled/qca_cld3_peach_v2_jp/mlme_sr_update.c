...
LABEL_28:
  ...
  policy_mgr_get_mac_id_by_session_id(*(_QWORD *)(v10 + 80), *(_BYTE *)(a1 + 104), v131);
          ...
          if ( v36 )
          {
            ...
            if ( v37 )
            {
              ...
              if ( (a2 & 1) != 0 )
              {
                ...
                if ( !v57 )
                  goto LABEL_54;
                v58 = (unsigned int *)*(unsigned __int8 *)(v57 + 186);
                if ( (_DWORD)v58 != 1 )
                  goto LABEL_54;
                v67 = wlan_vdev_mlme_get_cmpt_obj(v35, v59, v60, v61, v62, v63, v64, v65, v66);
                if ( v67 )
                {
                  v58 = (unsigned int *)(*(_BYTE *)(v67 + 182) & 0xA);
                  if ( (_DWORD)v58 == 2 )
                    goto LABEL_54;
                }
                v68 = *(_DWORD **)(v37 + 2112);
              ...
              if ( !v117 )
                goto LABEL_54;
              v58 = (unsigned int *)*(unsigned __int8 *)(v117 + 187);
              if ( (_DWORD)v58 != 1 )
                goto LABEL_54;
