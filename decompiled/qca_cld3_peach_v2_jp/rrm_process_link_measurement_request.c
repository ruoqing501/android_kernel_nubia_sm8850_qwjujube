        ...
        double a12)
{
  ...
  *(_DWORD *)((char *)v68 + 1) = 0;
  ...
  v34 = cmpt_obj;
  v35 = (_BYTE *)(a4 + 7032);
  if ( (wlan_reg_is_ext_tpc_supported(*(_QWORD *)(a1 + 21552), v26, v27, v28, v29, v30, v31, v32, v33) & 1) != 0
    && (*(_BYTE *)(a4 + 10070) & 1) == 0 )
  {
    v48 = *(unsigned __int8 *)(v34 + 552);
    *(_BYTE *)(v34 + 552) = *(_BYTE *)(a3 + 4);
    *(_BYTE *)(v34 + 932) = 1;
    lim_calculate_tpc(a1, a4, 0, v36, v37, v38, v39, v40, v41, v42, v43);
    v49 = *(_DWORD *)(v34 + 116);
    v44 = (unsigned __int8)*(_WORD *)(v34 + 640);
    BYTE1(v68[0]) = *(_WORD *)(v34 + 640);
    if ( v49 )
    {
      if ( v49 < v44 )
        LOBYTE(v44) = v49;
...
LABEL_27:
    ...
    {
      tx_ops = wlan_reg_get_tx_ops(*(_QWORD *)(a1 + 21552), v36, v37, v38, v39, v40, v41, v42, v43);
      if ( !tx_ops )
      {
        result = 16;
        goto LABEL_43;
