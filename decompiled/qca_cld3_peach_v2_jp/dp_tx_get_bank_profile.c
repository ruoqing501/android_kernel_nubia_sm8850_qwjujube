...
LABEL_12:
  ...
  while ( *(unsigned __int8 *)(a1 + 22472) != v6 );
  if ( v2 == -1 )
  {
    if ( v28 == -1 )
      goto LABEL_29;
  ...
  v6 = v2;
  v29 = 12LL * v2;
  *(_BYTE *)(*(_QWORD *)(a1 + 22544) + v29) = 1;
  *(_DWORD *)(*(_QWORD *)(a1 + 22544) + v29 + 8) = v3;
...
LABEL_32:
  ...
  qdf_trace_msg(
    ...
    (unsigned int)v2,
    v3,
    *(unsigned int *)(*(_QWORD *)(a1 + 22544) + 12 * v6 + 8),
    *(_DWORD *)(*(_QWORD *)(a1 + 22544) + 12 * v6 + 4));
  v39 = *(_DWORD *)(*(_QWORD *)(a1 + 22544) + 12 * v6 + 8);
  LODWORD(v55) = (v39 >> 8) & 1;
  qdf_trace_msg(
    0x45u,
    5u,
