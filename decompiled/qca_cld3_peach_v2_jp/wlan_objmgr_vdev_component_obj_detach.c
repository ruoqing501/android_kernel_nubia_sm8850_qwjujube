__int64 __fastcall wlan_objmgr_vdev_component_obj_detach(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  if ( *(_QWORD *)(a1 + 616 + 8LL * a2) == a3 )
  {
    *(_QWORD *)(a1 + 616 + 8LL * a2) = 0;
    *(_DWORD *)(a1 + 4LL * a2 + 1048) = 0;
    v9 = *(_QWORD *)(a1 + 1280);
    if ( (v9 & 1) != 0 )
    {
      *(_QWORD *)(a1 + 1280) = v9 & 0xFFFFFFFFFFFFFFFELL;
    ...
    if ( (*(_DWORD *)(a1 + 1264) & 0xFFFFFFFE) != 4 )
      return 0;
...
LABEL_27:
  ...
  *(_DWORD *)(a1 + 4LL * a2 + 1048) = 16;
  v8 = *(_QWORD *)(a1 + 1280);
  if ( (v8 & 1) != 0 )
  {
    *(_QWORD *)(a1 + 1280) = v8 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(a1 + 1272);
  }
  else
  {
