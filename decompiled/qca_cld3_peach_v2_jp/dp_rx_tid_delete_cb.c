        ...
        double a11)
{
  ...
  {
    raw_spin_lock(a1 + 17816);
  }
  else
  {
    raw_spin_lock_bh(a1 + 17816);
    *(_QWORD *)(a1 + 17824) |= 1uLL;
  }
  *(_QWORD *)(a2 + 16) = v19;
  qdf_list_insert_back_size(a1 + 17792, (_QWORD *)a2, (int *)&v102);
  if ( v102 >= 0x41 )
  {
    qdf_trace_msg(
      0x45u,
  ...
  if ( !(unsigned int)qdf_list_peek_front((_QWORD *)(a1 + 17792), &v101) )
  {
    while ( v102 > 0x3F || v19 > *(_QWORD *)(v101 + 16) + 1000LL || v102 && (*(_BYTE *)(v101 + 168) & 1) != 0 )
    {
      qdf_list_remove_front((_DWORD *)(a1 + 17792), &v101);
      v29 = v101;
        ...
        *(_BYTE *)(v29 + 168) = 0;
                             ...
                             v29) )
        {
          ...
          *(_QWORD *)(v29 + 16) = 1000 * (jiffies / 0xFAuLL) + 4 * (jiffies % 0xFAuLL);
          qdf_list_insert_back((_QWORD *)(a1 + 17792), (_QWORD *)v29);
          qdf_trace_msg(
            0x45u,
            5u,
        ...
        while ( 1 )
        {
          ...
          if ( (unsigned int)dp_reo_send_cmd(a1, 2u, v45, v46, v47, v48, v49, v50, v51, v52, (__int64)&v103, 0, 0) )
          {
            ...
            *(_DWORD *)(v101 + 172) = v80;
            ...
            if ( a1 )
              ++*(_DWORD *)(a1 + 14036);
            qdf_list_insert_back((_QWORD *)(a1 + 17792), v81);
            goto LABEL_41;
          }
        }
        *(_DWORD *)(v101 + 172) = v42;
                             ...
                             v101) )
        {
          ...
          *(_QWORD *)(v101 + 16) = 1000 * (jiffies / 0xFAuLL) + 4 * (jiffies % 0xFAuLL);
          ...
          {
            ++*(_DWORD *)(a1 + 14036);
            qdf_list_insert_back((_QWORD *)(a1 + 17792), v100);
            goto LABEL_60;
          }
          qdf_list_insert_back(qword_4580, v100);
          break;
        }
      }
      if ( (unsigned int)qdf_list_peek_front((_QWORD *)(a1 + 17792), &v101) )
...
LABEL_41:
  ...
  if ( (v82 & 1) != 0 )
  {
    *(_QWORD *)(a1 + 17824) = v82 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(a1 + 17816);
  }
  else
  {
    raw_spin_unlock(a1 + 17816);
  }
  v108 = 0;
  v83 = jiffies;
  v84 = jiffies;
  ...
  if ( !(unsigned int)qdf_list_peek_front((_QWORD *)(a1 + 19960), &v108) )
  {
    ...
    do
    {
      if ( v86 <= *(_QWORD *)(v108 + 16) + 30000LL )
        break;
      qdf_list_remove_front((_DWORD *)(a1 + 19960), &v108);
      v87 = *(_QWORD *)(a1 + 24);
      v88 = *(int *)(v108 + 40);
      v89 = *(_QWORD *)(v108 + 32);
    ...
    while ( !(unsigned int)qdf_list_peek_front((_QWORD *)(a1 + 19960), &v108) );
  }
  v90 = *(_QWORD *)(a1 + 19992);
  if ( (v90 & 1) != 0 )
  {
    *(_QWORD *)(a1 + 19992) = v90 & 0xFFFFFFFFFFFFFFFELL;
    result = raw_spin_unlock_bh(a1 + 19984);
  }
  else
  {
    result = raw_spin_unlock(a1 + 19984);
  }
LABEL_53:
