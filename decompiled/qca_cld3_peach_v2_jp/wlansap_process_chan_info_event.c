        ...
        double a10)
{
  ...
  if ( (result & 1) == 0
    || *(_BYTE *)(*(_QWORD *)(a1 + 1536) + 606LL) == 1
    && (v32 = wlan_reg_freq_to_chan(*(_QWORD *)(v22 + 21560), v11, v24, v25, v26, v27, v28, v29, v30, v31),
        ...
        (result & 1) != 0) )
  {
    result = wlan_reg_get_channel_state_for_pwrmode(
               ...
               *(_DWORD *)(a2 + 360),
               ...
               v30,
               v31);
    if ( (_DWORD)result == 3 && (*(_BYTE *)(a1 + 1754) & 1) == 0 )
    {
      v33 = *(_QWORD *)(a1 + 1536);
      if ( *(_BYTE *)(v33 + 24) )
      {
      ...
      if ( (result & 1) != 0 )
      {
        if ( !wlan_reg_is_6ghz_chan_freq(*(_DWORD *)(a2 + 360))
          || (result = wlan_reg_is_6ghz_psc_chan_freq(*(_DWORD *)(a2 + 360), v37, v38, v39, v40, v41, v42, v43, v44),
              (result & 1) != 0) )
        {
          result = policy_mgr_is_vdev_ll_lt_sap(*(_QWORD *)(v22 + 21552), *(unsigned __int8 *)(a1 + 12));
          if ( (result & 1) == 0 || *(_BYTE *)(*(_QWORD *)(a1 + 1536) + 606LL) == 1 )
          {
            result = _qdf_mem_malloc(0x2D0u, "wlansap_process_chan_info_event", 1813);
            if ( result )
            {
              v45 = result;
              ...
              *(_DWORD *)(v45 + 268) = *(_DWORD *)(a2 + 360);
              v56 = ucfg_scan_get_result(*(_QWORD *)(v22 + 21560), v45, v48, v49, v50, v51, v52, v53, v54, v55);
              ...
              if ( v56 )
              {
                if ( !*((_DWORD *)v56 + 4)
                  && (policy_mgr_is_sap_freq_allowed(
                        ...
                        *(_DWORD *)(a2 + 360))
                    & 1) != 0
                  && (wlan_reg_is_vlp_depriority_freq(*(_QWORD *)(v22 + 21560), *(_DWORD *)(a2 + 360)) & 1) == 0 )
                {
                  if ( !*(_WORD *)(*(_QWORD *)(a1 + 1536) + 42LL) )
                    goto LABEL_32;
                  ...
                  if ( chan_enum_for_freq <= 0x65 )
                    *(_BYTE *)(a1 + chan_enum_for_freq + 1755) = 1;
                  if ( (is_freq_allowed_for_sap(*(_QWORD *)(v22 + 21560), a1, *(unsigned int *)(a2 + 360)) & 1) != 0 )
                  {
LABEL_32:
                    qdf_trace_msg(
                      0x39u,
                    ...
                    *(_BYTE *)(a1 + 1754) = 1;
                    wlan_abort_scan(*(_QWORD *)(v22 + 21560), -1, v66, 0xFFFFFFFF, 0);
                    wlansap_set_acs_ch_freq(v22, a1, *(unsigned int *)(a2 + 360));
                    *(_DWORD *)(*(_QWORD *)(a1 + 1536) + 564LL) = *(_DWORD *)(a2 + 360);
                    sap_config_acs_result(v22, a1, *(_DWORD *)(*(_QWORD *)(a1 + 1536) + 568LL));
                    v75 = *(_QWORD *)(a1 + 1488);
                    *(_QWORD *)(a1 + 1600) = 21;
                    if ( v75 )
                    {
