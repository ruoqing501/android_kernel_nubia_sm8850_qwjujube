        ...
        double a10)
{
  ...
  {
    v13 = context;
    session_by_vdev_id = pe_find_session_by_vdev_id(context, *(unsigned __int8 *)(a1 + 104));
    if ( session_by_vdev_id )
    {
      v23 = *(_DWORD *)(session_by_vdev_id + 7204);
      v24 = *(unsigned __int8 *)(session_by_vdev_id + 7224);
      v25 = *(unsigned __int8 *)(session_by_vdev_id + 7216);
      ...
      v29 = v28;
      v37 = wlan_reg_freq_to_chan(v13[2695], v23, v27, v30, v31, v32, v33, v34, v35, v36);
