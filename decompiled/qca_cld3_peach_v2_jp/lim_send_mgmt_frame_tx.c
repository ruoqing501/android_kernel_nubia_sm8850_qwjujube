            ...
            *(_QWORD *)(v22 + 16) = v23;
            if ( v23 )
            {
              qdf_trace_msg(
                ...
                v13,
                (unsigned int)*(unsigned __int16 *)(v10 + 1052) + 1);
              qdf_mem_copy(*(void **)(v22 + 16), v12, (unsigned int)v14);
              v24 = v45[0];
              *(_BYTE *)(v16 + 2978) = *(_BYTE *)(v18 + 8);
              *(_DWORD *)(v22 + 8) = v14;
              *(_BYTE *)v22 = v24;
              tx_timer_change(v16 + 2928, *(unsigned int *)(*(_QWORD *)(v16 + 8) + 3524LL) / 0xAuLL, 0);
...
LABEL_26:
  *(_DWORD *)(v10 + 1108) = 0;
  result = lim_send_frame(a1, v13, *(unsigned __int16 **)(v11 + 8), v14, a3, a4, a5, a6, a7, a8, a9, a10);
