...
LABEL_74:
    if ( v22 < 0x10 )
    {
      ...
      printk(&unk_86EB60, v172, v173, v174);
      goto LABEL_76;
    }
...
LABEL_76:
  ...
  if ( v39 == 3 )
  {
    ...
    if ( (cds_get_driver_state(v100, v101, v102, v103, v104, v105, v106, v107) & 1) == 0 || (g_soft_unload & 1) != 0 )
      goto LABEL_151;
    printk(&unk_94357C, v108, v109, v110);
LABEL_55:
    v119 = 0;
    goto LABEL_57;
  }
    ...
    if ( v39 != 1 )
    {
      if ( v39 == 2 )
      {
        if ( v162 )
        {
          ...
          {
            v197 = jiffies;
            if ( wlan_hdd_state_ctrl_param_write___last_ticks_864 - jiffies + 125 < 0 )
            {
              qdf_trace_msg(
                0x33u,
                2u,
                ...
                v67,
                "wlan_hdd_state_ctrl_param_write");
              wlan_hdd_state_ctrl_param_write___last_ticks_864 = v197;
            }
          }
        }
        else
        {
          v195 = jiffies;
          if ( wlan_hdd_state_ctrl_param_write___last_ticks_863 - jiffies + 125 < 0 )
          {
            qdf_trace_msg(
              0x33u,
              2u,
              ...
              v67,
              "wlan_hdd_state_ctrl_param_write");
            wlan_hdd_state_ctrl_param_write___last_ticks_863 = v195;
          }
        }
      }
      else if ( v39 == 3 )
      {
        ...
        {
          v196 = jiffies;
          if ( wlan_hdd_state_ctrl_param_write___last_ticks_861 - jiffies + 125 < 0 )
          {
            qdf_trace_msg(
              0x33u,
              2u,
              ...
              v67,
              "wlan_hdd_state_ctrl_param_write");
            wlan_hdd_state_ctrl_param_write___last_ticks_861 = v196;
          }
        }
      }
LABEL_151:
