__int64 __fastcall sme_set_min_roam_score_delta_value(_QWORD *a1, unsigned int a2, unsigned int a3)
{
  __int64 v5; // x0
  ...
  if ( !vdev_by_id_from_pdev )
  {
    qdf_trace_msg(
      ...
      v13,
      v14,
      "sme_set_min_roam_score_delta_value",
      (unsigned __int8)a2);
LABEL_9:
    result = 4;
    goto LABEL_10;
  ...
  rso_config_fl = wlan_cm_get_rso_config_fl(
                    ...
                    (__int64)"sme_set_min_roam_score_delta_value",
                    0x4616u,
                    v7,
                    v8,
                    v9,
  ...
  v26 = (unsigned int *)*(unsigned __int8 *)(rso_config_fl + 1367);
  if ( (_DWORD)v26 == 1 )
  {
    v26 = (unsigned int *)*(unsigned __int8 *)(rso_config_fl + 92);
    if ( ((unsigned __int8)v26 & 1) == 0 )
      wlan_cm_roam_cfg_set_value(a1[2694], a2, 0x21u, (unsigned int *)v28);
  }
  wlan_objmgr_vdev_release_ref(v15, 0xBu, v26, v18, v19, v20, v21, v22, v23, v24, v25);
  *(_DWORD *)(a1[1] + 3428LL) = v28[0];
  result = wlan_cm_roam_cfg_set_value(a1[2694], a2, 0x2Cu, (unsigned int *)v28);
LABEL_10:
