__int64 __fastcall wmi_unified_attach(__int64 a1, __int64 *a2)
{
  ...
  result = _qdf_mem_malloc(0x1E50u, "wmi_unified_attach", 3365);
  if ( !result )
    goto LABEL_13;
  v5 = result;
...
LABEL_12:
  ...
  if ( (unsigned int)wmi_initialize_worker_context(v6) )
    goto LABEL_11;
  *(_QWORD *)(v7 + 760) = v5;
  *(_DWORD *)(v5 + 7696) = *((_DWORD *)a2 + 7);
  *(_BYTE *)(*(_QWORD *)(v7 + 760) + 24LL) = *((_BYTE *)a2 + 13);
  *(_QWORD *)(v7 + 40) = v5 + 40;
  *(_QWORD *)(v7 + 48) = v5 + 1064;
  *(_QWORD *)(v7 + 56) = v5 + 3116;
  *(_QWORD *)(v7 + 744) = v5 + 5252;
  *(_QWORD *)(v7 + 752) = v5 + 6368;
  *(_QWORD *)v7 = a1;
  *(_QWORD *)(v7 + 856) = v5 + 7700;
  *(_QWORD *)(v7 + 864) = v5 + 7712;
  *(_QWORD *)(v7 + 872) = v5 + 7724;
  *(_QWORD *)(v7 + 880) = v5 + 7736;
  *(_QWORD *)(v5 + 8) = a1;
  v16 = *((_DWORD *)a2 + 2);
  *(_DWORD *)(v7 + 724) = v16;
  *(_DWORD *)(v5 + 20) = v16;
