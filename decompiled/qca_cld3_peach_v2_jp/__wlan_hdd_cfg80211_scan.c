        ...
        double a11)
{
  ...
  double v154; // d7
  size_t v155; // x25
  int v156; // [xsp+14h] [xbp-6Ch] BYREF
  char v157[4]; // [xsp+18h] [xbp-68h] BYREF
  char v158[4]; // [xsp+1Ch] [xbp-64h] BYREF
  __int64 v159; // [xsp+20h] [xbp-60h] BYREF
  __int64 v160; // [xsp+28h] [xbp-58h]
  __int64 v161; // [xsp+30h] [xbp-50h]
  __int64 v162; // [xsp+38h] [xbp-48h]
  __int64 v163; // [xsp+40h] [xbp-40h]
  __int64 v164; // [xsp+48h] [xbp-38h]
  __int64 v165; // [xsp+50h] [xbp-30h]
  __int64 v166; // [xsp+58h] [xbp-28h]
  __int64 v167; // [xsp+60h] [xbp-20h] BYREF
  __int64 v168; // [xsp+68h] [xbp-18h]
  int v169; // [xsp+70h] [xbp-10h] BYREF
  char v170[4]; // [xsp+74h] [xbp-Ch] BYREF
  __int64 v171; // [xsp+78h] [xbp-8h]
...
LABEL_6:
  ...
  if ( (sme_is_session_id_valid(v16[2], *(unsigned __int8 *)(a1 + 8)) & 1) == 0 )
    goto LABEL_6;
  if ( (unsigned int)wlan_mlme_get_self_recovery(*v16, v158) )
  {
    qdf_trace_msg(
      0x33u,
      2u,
...
LABEL_21:
  ...
  if ( con_sap_adapter )
  {
    v66 = *(_DWORD **)(con_sap_adapter + 52824);
    v67 = v66[180];
    if ( !v67 )
      v67 = v66[538];
    v68 = v66[182];
    if ( (policy_mgr_is_hw_dbs_capable(*v16) & 1) == 0
      && (policy_mgr_is_sta_present_on_freq(*v16, v157, v67, &v156) & 1) == 0
...
LABEL_16:
  ...
  if ( (hdd_is_connection_in_progress(v170, &v169, v43, v44, v45, v46, v47, v48, v49, v50) & 1) != 0 )
  {
    ...
    v70 = v169;
    if ( *((unsigned __int8 *)v16 + 1803) == (unsigned __int8)v170[0]
      && *((_DWORD *)v16 + 451) == v169
      && (v71 = v16[226]) != 0 )
    {
      ...
      if ( v72 >= 0xF && v71 - jiffies < 0 )
      {
        ...
        v16[226] = 0;
        *((_BYTE *)v16 + 1816) = 0;
        if ( (cds_is_fatal_event_enabled(v135, v136, v137, v138) & 1) != 0 )
        {
          cds_flush_logs(1u, 2u, 11, 0, v158[0], v139, v140, v141, v142, v143, v144, v145, v146);
        }
        else
        {
          qdf_trace_msg(
    ...
    if ( v74 && *(_WORD *)(v15 + 44376) )
    {
      ...
      *(_WORD *)(v15 + 42312) = v75;
      ...
      if ( v76 )
      {
        ...
        LODWORD(v160) = *(unsigned __int16 *)(v15 + 44376);
      }
      goto LABEL_56;
    }
  }
...
LABEL_63:
  ...
  if ( sta_vdev_for_p2p_dev )
  {
    ...
    if ( *(_DWORD *)(v15 + 2728) == 1 )
      ...
      v100 = 5;
    LODWORD(v164) = v100;
    if ( (unsigned int)wlan_mlme_get_scan_probe_unicast_ra(*v16, (_BYTE *)&v167 + 4) )
      qdf_trace_msg(
        0x33u,
        2u,
    ...
    qdf_trace_msg(
      ...
      "__wlan_hdd_cfg80211_scan",
      0);
    if ( cds_is_10_mhz_enabled(v109, v110, v111, v112, v113, v114, v115, v116) )
      BYTE4(v164) = 1;
    if ( cds_is_5_mhz_enabled(v117, v118, v119, v120, v121, v122, v123, v124) )
      BYTE5(v164) = 1;
    v125 = wlan_cfg80211_scan(v90, a2, (char *)&v159);
