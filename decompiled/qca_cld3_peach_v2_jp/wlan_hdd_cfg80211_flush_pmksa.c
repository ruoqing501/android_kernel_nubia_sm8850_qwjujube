__int64 __fastcall wlan_hdd_cfg80211_flush_pmksa(__int64 a1, __int64 a2)
{
  ...
  if ( !(_DWORD)result )
  {
    ...
    else
    {
      ...
      if ( !v21 )
      {
        vdev_by_user = _hdd_objmgr_get_vdev_by_user(*(_QWORD *)(a2 + 55512), 6, "wlan_hdd_flush_pmksa_cache");
        if ( vdev_by_user )
        {
          v40 = vdev_by_user;
        ...
        sme_set_del_pmkid_cache(*v30, *(unsigned __int8 *)(*(_QWORD *)(a2 + 55512) + 8LL), 0, 0);
