__int64 __fastcall populate_dot11f_tdls_offchannel_params(__int64 a1, __int64 a2, _BYTE *a3, _BYTE *a4)
{
  ...
  if ( (_DWORD)v10 )
  {
    v20 = 0;
    v21 = 0;
    v22 = *(unsigned __int8 *)(a1 + 21518);
    v23 = *(unsigned __int8 *)(a1 + 21596);
    v24 = *(unsigned __int8 *)(a1 + 21528);
    v60 = a3;
    v61 = a4;
    if ( v22 >= v23 )
      v22 = *(unsigned __int8 *)(a1 + 21596);
    v62 = 0;
    if ( v24 >= v23 )
      v24 = *(unsigned __int8 *)(a1 + 21596);
    v72 = 0;
    v25 = v22 == 1;
    v26 = a3 + 2;
    ...
    while ( 1 )
    {
      ...
      v4 = (_BYTE *)*(unsigned int *)(*(_QWORD *)(a1 + 8) + 4 * v20 + 5776);
      v30 = wlan_reg_freq_to_chan(
              *(_QWORD *)(a1 + 21560),
              *(_DWORD *)(*(_QWORD *)(a1 + 8) + 4 * v20 + 5776),
              v12,
              v13,
              v14,
              v15,
...
LABEL_25:
            ...
            {
              if ( (tdls_is_6g_freq_allowed(*(_QWORD *)(a1 + 21560), (unsigned int)v4) & 1) == 0 )
              {
...
LABEL_34:
  ...
  *a3 = 1;
  ...
  wlan_reg_read_current_country(*(_QWORD *)(a1 + 21552), &v65, v12, v13, v14, v15, v16, v17, v18, v19);
  v50 = wlan_reg_freq_to_chan(*(_QWORD *)(a1 + 21560), *(_DWORD *)(a2 + 284), v42, v43, v44, v45, v46, v47, v48, v49);
