        ...
        double a10)
{
  ...
  if ( v40 <= v41 )
  {
    qdf_trace_msg(
      ...
      result[340],
      result[343]);
    lim_send_disassoc_mgmt_frame(a1, 4u, (const void *)(v39 + 338), v29, 0, v60, v61, v62, v63, v64, v65, v66, v67);
    result = (unsigned __int8 *)lim_trigger_sta_deletion(a1, v39, v29, v68, v69, v70, v71, v72, v73, v74, v75);
    v59 = 3;
  }
  else
  {
    lim_send_sa_query_request_frame(a1, result + 624, result + 338, v29);
    v42 = *(unsigned __int8 *)(v39 + 629);
    ++*(_WORD *)(v39 + 624);
    qdf_trace_msg(
      0x35u,
      8u,
      ...
      "lim_pmf_sa_query_timer_handler",
      v42);
    result = (unsigned __int8 *)tx_timer_activate((char *)(v39 + 360));
    if ( !(_DWORD)result )
      return result;
