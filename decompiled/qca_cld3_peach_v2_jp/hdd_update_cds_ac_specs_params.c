  ...
  if ( result )
  {
    ...
    if ( *(_QWORD *)(result + 104) )
    {
      ...
      if ( result )
      {
        ...
        qdf_uint8_array_parse((_BYTE *)(values + 4278), (__int64)&v23, 5, &v22);
        if ( v22 == 5 )
        {
          v12 = BYTE1(v23);
          v13 = BYTE2(v23);
        ...
        qdf_uint8_array_parse((_BYTE *)(v17 + 4329), (__int64)&v23, 5, &v22);
        if ( v22 == 5 )
        {
        ...
        qdf_uint8_array_parse((_BYTE *)(v19 + 4227), (__int64)&v23, 5, &v22);
        if ( v22 == 5 )
        {
        ...
        result = qdf_uint8_array_parse((_BYTE *)(v21 + 4176), (__int64)&v23, 5, &v22);
        if ( v22 == 5 )
        {
