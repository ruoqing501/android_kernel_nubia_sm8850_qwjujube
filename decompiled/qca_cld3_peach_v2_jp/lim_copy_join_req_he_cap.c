        ...
        double a9)
{
  ...
  if ( !*(_BYTE *)(*(_QWORD *)(a1 + 8608) + 21636LL) )
  {
    v21 = *(_QWORD *)(*(_QWORD *)(a1 + 16) + 152LL);
    if ( v21 && *(_QWORD *)(v21 + 80) )
    {
      ...
      if ( is_24ghz_ch_freq )
      {
        v25 = *(_QWORD *)(v20 + 1245) & 0x380000LL | v24 & 0xFFFFFFFFF8C7FFFFLL;
LABEL_10:
        *v23 = v25;
        goto LABEL_11;
      }
      v26 = *(_BYTE *)(v19 + 23903);
      v27 = v24 & 0xFFFFFFFFFFC7FFFFLL | (((*(_QWORD *)(v20 + 1305) >> 19) & 7LL) << 19);
      *v23 = v27;
      if ( (v26 & 0x30) != 0 )
      {
        v25 = v27 & 0xFFFFFFFFF8FFFFFFLL | (((*(_QWORD *)(v20 + 1305) >> 24) & 7LL) << 24);
        goto LABEL_10;
      }
    }
    else
