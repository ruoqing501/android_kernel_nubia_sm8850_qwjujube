__int64 __fastcall pmo_core_get_vdev_beacon_interval(__int64 a1)
{
  __int64 v2; // x8
  ...
  unsigned int (__fastcall *v14)(__int64, unsigned __int16 *); // x8
  __int64 v15; // x0
  bool v16; // w21
  __int64 v17; // x8
    ...
    || (*(_DWORD *)(StatusReg + 16) & 0xFF00) != 0 )
  {
    ...
    v14 = *(unsigned int (__fastcall **)(__int64, unsigned __int16 *))(v12 + 1032);
    if ( v14 )
      goto LABEL_6;
LABEL_13:
    v16 = 0;
...
LABEL_10:
    qdf_trace_msg(
      0x4Du,
      2u,
      "%s: Failed to get beacon interval for vdev id %d",
      v4,
      v5,
      v6,
      v7,
