__int64 __fastcall sme_configure_guard_time(__int64 a1, char a2, int a3)
{
  __int64 v6; // x0
  __int64 v7; // x20
  unsigned int v8; // w0
  ...
  v27 = 0;
  v28 = 0;
  v6 = _qdf_mem_malloc(8u, "sme_configure_guard_time", 10896);
  if ( v6 )
  {
    v7 = v6;
    v8 = qdf_mutex_acquire(a1 + 12776);
    if ( v8 )
    {
      v17 = v8;
      qdf_trace_msg(
    ...
    else
    {
      ...
      *(_DWORD *)(v7 + 4) = a3;
      ...
      if ( (unsigned int)scheduler_post_message_debug(
                           ...
                           0x2AA2u,
                           (__int64)"sme_configure_guard_time") )
      {
        qdf_trace_msg(
          0x34u,
          2u,
