        ...
        double a10)
{
  ...
  if ( (_ReadStatusReg(DAIF) & 0x80) == 0 )
  {
    ...
    {
      raw_spin_lock_bh(v12 + 13136);
      *(_QWORD *)(v12 + 13144) |= 1uLL;
      if ( *(_QWORD *)(v12 + 13112) )
        goto LABEL_7;
      goto LABEL_6;
    }
  }
  raw_spin_lock(v12 + 13136);
  if ( !*(_QWORD *)(v12 + 13112) )
LABEL_6:
    *(_DWORD *)(v12 + 13132) = *(_DWORD *)(v13 + 104);
LABEL_7:
  *(_QWORD *)(v13 + 8) = 0;
  v15 = *(__int64 **)(v12 + 13120);
  *(_QWORD *)(v13 + 16) = v15;
  *v15 = v13;
  *(_QWORD *)(v12 + 13120) = v13 + 8;
  if ( v12 )
    ++*(_DWORD *)(v12 + 13608);
  v16 = *(_QWORD *)(v12 + 13144);
  if ( (v16 & 1) == 0 )
    return raw_spin_unlock(v12 + 13136);
  *(_QWORD *)(v12 + 13144) = v16 & 0xFFFFFFFFFFFFFFFELL;
  return raw_spin_unlock_bh(v12 + 13136);
}
