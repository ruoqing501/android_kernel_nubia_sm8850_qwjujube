char *__fastcall dp_tx_send(__int64 a1, unsigned __int8 a2, char *a3)
{
  __int64 v5; // x20
  __int64 v6; // x22
  __int64 v7; // x8
  ...
  double v89; // d6
  double v90; // d7
  unsigned __int16 *v91; // x22
  int v92; // w24
  unsigned __int16 *v93; // x8
  unsigned __int16 *v94; // x20
  int v96; // w8
  unsigned __int16 *v97; // [xsp+0h] [xbp-F0h] BYREF
  ...
  {
    v10 = *(_QWORD *)(v5 + 24);
    if ( (*((_DWORD *)a3 + 42) & 0xF000000) == 0xB000000 )
      LOBYTE(v10) = *(_BYTE *)(*(_QWORD *)(v10 + 8) + 7153LL) - 1;
    else
      LODWORD(v10) = *((unsigned __int16 *)a3 + 62) % (*(unsigned __int8 *)(*(_QWORD *)(v10 + 8) + 7153LL) - 1);
  }
  else
  {
    LOWORD(v10) = (unsigned int)*((_WORD *)a3 + 62)
                % *(unsigned __int8 *)(*(_QWORD *)(*(_QWORD *)(v5 + 24) + 8LL) + 7153LL);
  }
LABEL_12:
  BYTE5(v112) = v10;
  ...
  *(_QWORD *)(v5 + 400) = v21 + 1;
  ...
  v24 = *(_DWORD *)(v5 + 64);
  *(_QWORD *)(v5 + 408) += (unsigned int)(*((_DWORD *)a3 + 28) + v22);
  if ( v24 && !a3 )
  {
  ...
  if ( (is_tid_override & 1) != 0 )
  {
    ...
    if ( v35 )
      goto LABEL_25;
LABEL_71:
    is_tid_override = ((__int64 (__fastcall *)(__int64, char *, __int64 *))dp_tx_get_tid)(v5, a3, &v112);
    goto LABEL_26;
  }
  v35 = *(_BYTE *)(v5 + 74);
  if ( !v35 )
...
LABEL_26:
  v36 = *((_QWORD *)a3 + 27) + *((unsigned int *)a3 + 53);
  if ( !*(_WORD *)(v36 + 4) || (*(_BYTE *)(v36 + 24) & 0x11) == 0 )
  {
    if ( *((_DWORD *)a3 + 29) )
    {
      ...
      if ( (is_tid_override & 1) == 0 )
      {
        ...
        v99 = 0;
        v97 = nullptr;
        a3 = (char *)((__int64 (__fastcall *)(__int64, char *, unsigned __int16 **, __int64 *))dp_tx_prepare_sg)(
                       v5,
                       a3,
                       &v97,
                       &v112);
        ...
        if ( (a3[68] & 4) != 0 )
          ...
          v73 = 0;
        *(_QWORD *)(v5 + 568) += (unsigned int)(*((_DWORD *)a3 + 28) + v73);
        goto LABEL_61;
      }
      if ( *((_DWORD *)a3 + 29) )
      {
    ...
    if ( *(_DWORD *)(v5 + 40) )
    {
      if ( *(_BYTE *)(v5 + 56) == 1 )
      {
        if ( (**((_BYTE **)a3 + 28) & 1) != 0 )
        {
          ...
          {
            qdf_spin_lock_bh_9(a1 + 17576);
            v74 = dp_peer_ast_hash_find_by_pdevid();
            if ( v74 )
              v68 = *(_WORD *)(v74 + 2);
            else
              v68 = -2;
            is_tid_override = qdf_spin_unlock_bh_9(a1 + 17576);
          }
        ...
        if ( (a3[68] & 4) != 0 )
          ...
          v96 = 0;
        v40 = 65534;
        *(_QWORD *)(v5 + 504) += (unsigned int)(*((_DWORD *)a3 + 28) + v96);
      }
      else
      {
        v40 = 0xFFFF;
      }
      if ( *(_BYTE *)(v6 + 262) != 1 || (a3[71] & 0x78) != 0x40 )
        goto LABEL_39;
      v69 = *(_QWORD *)(v6 + 264);
      v70 = v40;
      if ( v69 )
...
LABEL_39:
    ...
    v99 = 0;
    v97 = nullptr;
    a3 = (char *)dp_tx_prepare_raw(v5, a3, &v97, &v112);
    if ( !a3 )
      goto LABEL_119;
    if ( is_dp_verbose_debug_enabled == 1 )
...
LABEL_61:
  ...
  if ( v38 )
  {
    if ( (a3[68] & 4) != 0 )
      ...
      v39 = 0;
    *(_QWORD *)(v38 + 91328) += (unsigned int)(*((_DWORD *)a3 + 28) + v39);
  }
LABEL_42:
      ...
      if ( v64 )
      {
        ...
        if ( v65 )
        {
          if ( (a3[68] & 4) != 0 )
            ...
            v66 = 0;
          *(_QWORD *)(v65 + 91352) += (unsigned int)(*((_DWORD *)a3 + 28) + v66);
        }
      }
      goto LABEL_119;
    }
    *(_QWORD *)(v5 + 400) += (unsigned int)(v113 - 1);
    goto LABEL_61;
  }
...
LABEL_103:
  ...
  if ( v97 )
  {
    ...
    while ( 1 )
    {
      ...
      *(_QWORD *)v93 = 0;
      v97 = (unsigned __int16 *)dp_tx_send_msdu_single(
                                  v5,
                                  v97,
                                  (__int64)&v112,
                                  0xFFFF,
