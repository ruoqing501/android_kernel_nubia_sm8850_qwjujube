__int64 wlan_objmgr_global_obj_can_destroyed()
{
  ...
  {
    raw_spin_lock(v0 + 11712);
  }
  else
  {
    v6 = v0;
    raw_spin_lock_bh(v0 + 11712);
    *(_QWORD *)(v6 + 11720) |= 1uLL;
  }
  v2 = g_umac_glb_obj;
  ...
  v4 = *(_QWORD *)(g_umac_glb_obj + 11720);
  if ( (v4 & 1) != 0 )
  {
    *(_QWORD *)(g_umac_glb_obj + 11720) = v4 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(v2 + 11712);
  }
  else
  {
