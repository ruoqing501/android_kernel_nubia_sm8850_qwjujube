__int64 __fastcall hdd_update_vdev_nss_chains_config(__int64 *a1)
{
  ...
  if ( dynamic_vdev_config )
  {
    ...
    if ( v33 )
    {
      if ( v33 == v32 && *(unsigned __int8 *)(v1 + 52840) != *((unsigned __int8 *)a1 + 8) )
      {
        ...
        if ( (result & 1) != 0 )
        {
          ...
          if ( v34 )
          {
            ...
            return _hdd_objmgr_put_vdev_by_user(v43, 6, "hdd_update_vdev_nss_chains_config");
          }
          else
          {
            return qdf_trace_msg(
