  ...
  if ( v33 )
  {
    if ( *(_DWORD *)(a10 + 56) == (_DWORD)v12 )
    {
      ...
      do
      {
        ...
        {
          v62 = jiffies;
          if ( extract_roam_scan_stats_res_evt_tlv___last_ticks_471 - jiffies + 125 < 0 )
          {
            v63 = v17;
            qdf_trace_msg(
              0x31u,
              ...
              "extract_roam_scan_stats_res_evt_tlv");
            v17 = v63;
            extract_roam_scan_stats_res_evt_tlv___last_ticks_471 = v62;
          }
          goto LABEL_109;
        }
        ++v34;
...
LABEL_110:
  ...
  v64 = jiffies;
  if ( extract_roam_scan_stats_res_evt_tlv___last_ticks_473 - jiffies + 125 < 0 )
  {
    v65 = v17;
    qdf_trace_msg(
      0x31u,
      ...
      "extract_roam_scan_stats_res_evt_tlv");
    v17 = v65;
    extract_roam_scan_stats_res_evt_tlv___last_ticks_473 = v64;
  }
LABEL_109:
