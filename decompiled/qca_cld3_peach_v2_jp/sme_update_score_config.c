void *__fastcall sme_update_score_config(__int64 a1, int a2, unsigned __int8 a3)
{
  ...
  if ( (unsigned int)wlan_mlme_get_vht_for_24ghz(*(_QWORD *)(a1 + 21552), v57) )
    qdf_trace_msg(
      0x34u,
      2u,
  ...
  v27 = v57[0];
  if ( (unsigned int)wlan_mlme_get_vht_enable_tx_bf(*(_QWORD *)(a1 + 21552), v57) )
    qdf_trace_msg(
      0x34u,
      2u,
  ...
  if ( v57[0] )
    ...
    v38 = v36;
  ucfg_mlme_get_channel_bonding_24ghz(*(_QWORD *)(a1 + 21552), &v56);
  v39 = v38 & 0xFE3F;
  v40 = (v56 & 1) << 7;
  ucfg_mlme_get_channel_bonding_5ghz(*(_QWORD *)(a1 + 21552), &v56);
  v41 = ((v56 & 1) << 6) | v40;
  v42 = (mlme_max_chan_switch_is_set(*(_QWORD *)(a1 + 21552)) & 1) == 0;
  v51 = *(_QWORD *)(a1 + 21552);
  if ( v42 )
    v52 = 0;
  else
