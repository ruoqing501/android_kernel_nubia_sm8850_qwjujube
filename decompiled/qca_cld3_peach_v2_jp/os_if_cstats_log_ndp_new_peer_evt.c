__int64 __fastcall os_if_cstats_log_ndp_new_peer_evt(__int64 a1, __int64 a2)
{
  int v3; // w9
  char v4; // w8
  ...
  unsigned __int64 v21; // [xsp+1Ah] [xbp-16h]
  char v22; // [xsp+22h] [xbp-Eh]
  __int16 v23; // [xsp+23h] [xbp-Dh]
  char v24; // [xsp+25h] [xbp-Bh]
