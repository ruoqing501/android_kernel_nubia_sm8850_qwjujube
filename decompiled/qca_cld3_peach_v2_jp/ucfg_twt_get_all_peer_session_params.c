__int64 __fastcall ucfg_twt_get_all_peer_session_params(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v16 = *(_DWORD *)(v15 + 16);
  v17 = wlan_vdev_peer_list_peek_active_head(v15, (_QWORD *)(v15 + 128), 0x26u);
  if ( !v17 )
    goto LABEL_29;
  v26 = (__int64)v17;
  v27 = 0;
...
LABEL_20:
    if ( v16 == 1 && v27 >= v53 )
      break;
    next_active_peer_of_vdev = wlan_peer_get_next_active_peer_of_vdev(v15, (_QWORD *)(v15 + 128), v26, 0x26u);
