  ...
  if ( v9 )
  {
    ...
    while ( v10 )
    {
      ...
      if ( _ZF )
      {
        ...
        if ( (v38 & 1) != 0 )
        {
          *(_QWORD *)(a1 + 18936) = v38 & 0xFFFFFFFFFFFFFFFELL;
...
LABEL_54:
        ...
        switch ( a3 )
        {
          ...
          case 3u:
            ...
            goto LABEL_43;
          case 4u:
            v26 = (unsigned int *)*(unsigned __int8 *)(*(_QWORD *)(*(_QWORD *)(v9 + 24) + 8LL) + 18650LL);
            goto LABEL_43;
          case 9u:
            v26 = (unsigned int *)*(unsigned int *)(v9 + 42444);
            *a4 = (_DWORD)v26;
            goto LABEL_44;
          case 0xCu:
          ...
          case 0x1Au:
            ...
            goto LABEL_43;
          case 0x1Bu:
            v30 = *(unsigned __int8 *)(v9 + 42424);
LABEL_42:
            v26 = (unsigned int *)((v30 >> 1) & 1);
            goto LABEL_43;
          case 0x1Cu:
            v26 = (unsigned int *)*(unsigned __int8 *)(v9 + 45318);
LABEL_43:
            *(_BYTE *)a4 = (_BYTE)v26;
            goto LABEL_44;
          case 0x1Fu:
