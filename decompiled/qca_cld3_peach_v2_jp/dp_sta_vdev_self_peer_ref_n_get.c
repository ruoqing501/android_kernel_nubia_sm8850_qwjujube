__int64 __fastcall dp_sta_vdev_self_peer_ref_n_get(__int64 a1, __int64 a2, unsigned int a3)
{
...
LABEL_6:
        ...
        if ( _ZF )
        {
          if ( a3 >= 3 )
          {
            if ( a3 >= 0x20 )
              ...
              _X9 = (unsigned int *)(v6 + 4LL * a3 + 256);
            __asm { PRFM            #0x11, [X9] }
            do
              v20 = __ldxr(_X9);
      ...
      if ( (v18 & 1) != 0 )
      {
        *(_QWORD *)(a2 + 144) = v18 & 0xFFFFFFFFFFFFFFFELL;
...
LABEL_8:
  ...
  *(_QWORD *)(a2 + 144) = v7 & 0xFFFFFFFFFFFFFFFELL;
  raw_spin_unlock_bh(a2 + 136);
  return 0;
}
