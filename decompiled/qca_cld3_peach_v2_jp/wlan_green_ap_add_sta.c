__int64 __fastcall wlan_green_ap_add_sta(
        __int64 a1,
        double a2,
        double a3,
        double a4,
        ...
        double a9)
{
  ...
  if ( a1 )
  {
    ...
    if ( comp_private_obj )
    {
      ...
      else
      {
        ...
        return wlan_green_ap_state_mc(v18, 3u, v39, v40, v41, v42, v43, v44, v45, v46);
      }
    }
    else
    {
  ...
  {
    qdf_trace_msg(0x5Du, 2u, "%s: pdev context passed is NULL", a2, a3, a4, a5, a6, a7, a8, a9, "wlan_green_ap_add_sta");
    return 4;
  }
}
