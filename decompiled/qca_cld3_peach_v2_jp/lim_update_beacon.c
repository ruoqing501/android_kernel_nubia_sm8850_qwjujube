__int64 __fastcall lim_update_beacon(__int64 result)
{
  ...
  if ( *(_WORD *)(result + 3992) )
  {
    ...
    {
      v3 = v2;
      v4 = *(_QWORD *)(v1 + 12264) + 10792LL * v2;
      if ( *(_BYTE *)(v4 + 70) == 1 && *(_DWORD *)(v4 + 88) == 1 && *(_DWORD *)(v4 + 80) == 16 )
      {
        result = ((__int64 (__fastcall *)(__int64))sch_set_fixed_beacon_fields)(v1);
        if ( !*(_BYTE *)(v1 + 14809) )
          result = lim_send_beacon_ind(v1, *(_QWORD *)(v1 + 12264) + 10792LL * v3, 0, v5, v6, v7, v8, v9, v10, v11, v12);
      }
      v2 = v3 + 1;
    }
