...
LABEL_7:
        dp_peer_unref_delete(v18, 7u, v21, v22, v23, v24, v25, v26, v27, v28);
        return 0;
      }
    }
    else
  ...
  qdf_trace_msg(0x81u, 8u, "%s: %pK: Peer is NULL!", v9, v10, v11, v12, v13, v14, v15, v16, "dp_set_addba_response", a1);
  return 16;
}
