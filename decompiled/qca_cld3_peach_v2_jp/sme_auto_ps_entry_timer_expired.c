        ...
        double a9)
{
  ...
  if ( !(unsigned int)sme_acquire_global_lock((__int64)(v9 + 1596)) )
  {
    v13 = *(_DWORD *)(a1 + 8);
    qdf_trace_msg(
      0x34u,
    ...
    if ( v13 <= 5 )
    {
      if ( (*(_BYTE *)(v9[1] + 5417LL) & 1) != 0 )
      {
        if ( (mlme_get_user_ps(v9[2694], v13) & 1) != 0 )
        {
          if ( cm_is_vdevid_active(v9[2695], v13) )
            sme_ps_enable_disable(v9, v13, 0);
          return sme_release_global_lock((__int64)(v9 + 1596));
        }
