__int64 __fastcall dp_peer_get_ast_info_by_pdevid_wifi3(__int64 a1, __int64 a2, unsigned int a3, __int64 a4)
{
  ...
  if ( *(_DWORD *)(a1 + 13276) > v11 )
  {
    v13 = *(_QWORD *)(*(_QWORD *)(a1 + 13088) + 8LL * v11);
    if ( !v13 )
      goto LABEL_17;
    if ( *(unsigned __int8 *)(v13 + 380) <= 2u )
    {
      v25 = *(_DWORD *)(v13 + 40);
      while ( v25 )
      {
...
LABEL_17:
  ...
  if ( (v14 & 1) != 0 )
  {
    *(_QWORD *)(a1 + 13264) = v14 & 0xFFFFFFFFFFFFFFFELL;
...
LABEL_33:
    ...
    if ( (v34 & 1) != 0 )
    {
      *(_QWORD *)(a1 + 17584) = v34 & 0xFFFFFFFFFFFFFFFELL;
...
LABEL_19:
  ...
  *(_WORD *)(a4 + 14) = *(_WORD *)(v10 + 2);
  ...
  if ( (v23 & 1) != 0 )
  {
    *(_QWORD *)(a1 + 17584) = v23 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(a1 + 17576);
  }
  else
  {
