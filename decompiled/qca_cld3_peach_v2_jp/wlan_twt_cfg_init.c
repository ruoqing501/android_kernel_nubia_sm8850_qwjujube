        ...
        double a9)
{
  ...
  if ( a1 )
  {
    ...
    if ( comp_private_obj )
    {
      ...
      v12 = *(_BYTE *)(cfg_psoc_get_values(a1) + 10088);
      v13 = *(_BYTE *)(cfg_psoc_get_values(a1) + 10096);
      *(_BYTE *)v11 = *(_BYTE *)(cfg_psoc_get_values(a1) + 10076);
      *(_BYTE *)(v11 + 3) = *(_BYTE *)(cfg_psoc_get_values(a1) + 10077);
      *(_BYTE *)(v11 + 1) = *(_DWORD *)(cfg_psoc_get_values(a1) + 10080);
      *(_BYTE *)(v11 + 2) = *(_DWORD *)(cfg_psoc_get_values(a1) + 10080) != 0;
      v14 = *(_DWORD *)(cfg_psoc_get_values(a1) + 10084);
      *(_BYTE *)(v11 + 8) = v12 & 1;
      *(_DWORD *)(v11 + 4) = v14;
      *(_BYTE *)(v11 + 9) = (v12 & 2) != 0;
      *(_BYTE *)(v11 + 10) = *(_BYTE *)(cfg_psoc_get_values(a1) + 10092);
      v15 = *(_BYTE *)(cfg_psoc_get_values(a1) + 10093);
      *(_WORD *)(v11 + 12) = 1;
      *(_BYTE *)(v11 + 14) = v13 & 1;
      *(_BYTE *)(v11 + 11) = v15;
