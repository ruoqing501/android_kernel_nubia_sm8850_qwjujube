...
LABEL_8:
  ...
  is_connection_fail = mlme_is_connection_fail(*(_QWORD *)(a1 + 504), a2, a3, a4, a5, a6, a7, a8, a9);
  qdf_trace_msg(
    0x35u,
    8u,
  ...
  assoc_type = mlme_get_assoc_type(*(_QWORD *)(a1 + 504), v22, v23, v24, v25, v26, v27, v28, v29);
  if ( assoc_type - 1 >= 2 )
  {
    if ( assoc_type )
    {
  ...
  mlme_set_connection_fail(*(_QWORD *)(a1 + 504), 0, v31, v32, v33, v34, v35, v36, v37, v38);
  return v39;
}
