...
LABEL_16:
  v33 = ((double (__fastcall *)(__int64, __int64))sch_set_fixed_beacon_fields)(a1, v29);
  ...
  if ( *(_WORD *)(v29 + 376) )
  {
    for ( i = 0; *(unsigned __int16 *)(v29 + 376) > (unsigned int)i; ++i )
    {
      ...
      if ( result )
      {
        if ( (*(_WORD *)result & 1) != 0 && (*(_BYTE *)(result + 334) & 8) != 0 )
        {
          v50 = result;
          ...
          *(_DWORD *)result = *(_DWORD *)(v29 + 164) != 0;
          qdf_mem_copy((void *)(result + 6), (const void *)(v50 + 338), 6u);
