...
LABEL_11:
    if ( (a2 & 0x80) == 0 )
      goto LABEL_12;
LABEL_19:
    *((_DWORD *)v13 + v2++) = dword_15ABC;
    goto LABEL_20;
  }
LABEL_18:
  *((_DWORD *)v13 + v2++) = dword_15AB8;
  if ( a2 < 0 )
    goto LABEL_19;
LABEL_12:
  if ( !a2 )
