        ...
        __int64 a13)
{
  ...
  *(_BYTE *)(v22 + 16484) = v21;
  __isb(0xFu);
  *(_QWORD *)(v22 + 16488) = _ReadStatusReg(CNTVCT_EL0);
  if ( !a12 )
    return 0;
  v23 = v21;
  ...
  if ( v24 )
  {
    ...
    *(_QWORD *)(v24 + 16) = a12;
    ...
    {
      raw_spin_lock(v20 + 13176);
    }
    else
    {
      raw_spin_lock_bh(v20 + 13176);
      *(_QWORD *)(v20 + 13184) |= 1uLL;
    }
    *(_QWORD *)(v33 + 24) = 0;
    v35 = *(__int64 **)(v20 + 13168);
    *(_QWORD *)(v33 + 32) = v35;
    *v35 = v33;
    v36 = *(_QWORD *)(v20 + 13184);
    *(_QWORD *)(v20 + 13168) = v33 + 24;
    if ( (v36 & 1) != 0 )
    {
      *(_QWORD *)(v20 + 13184) = v36 & 0xFFFFFFFFFFFFFFFELL;
      raw_spin_unlock_bh(v20 + 13176);
    }
    else
    {
      raw_spin_unlock(v20 + 13176);
    }
    return 0;
  }
  qdf_trace_msg(
