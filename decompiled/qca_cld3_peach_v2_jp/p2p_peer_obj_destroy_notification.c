        ...
        double a9)
{
  ...
  if ( *(_DWORD *)(v9 + 16) != 3 )
    return 0;
  comp_private_obj = wlan_objmgr_vdev_get_comp_private_obj(*(_QWORD *)(a1 + 88), 5u);
  v20 = *(_QWORD *)(v9 + 152);
  ...
  if ( *(_DWORD *)(a1 + 68) == 4 && *(_DWORD *)(v9 + 16) == 3 )
  {
    ...
    *(_WORD *)(comp_private_obj + 18) = v23;
    if ( !v23 )
    {
      ...
      {
        *(_BYTE *)(comp_private_obj + 16) = (unsigned int)ucfg_p2p_set_noa(v22, *(unsigned __int8 *)(v9 + 104), 0) == 0;
        qdf_trace_msg(
          0x4Eu,
          8u,
