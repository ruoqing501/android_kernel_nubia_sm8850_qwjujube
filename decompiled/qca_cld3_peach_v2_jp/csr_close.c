__int64 __fastcall csr_close(__int64 a1)
{
  ...
  {
    v11 = psoc_ext_obj_fl;
    if ( (unsigned int)qdf_mc_timer_get_current_state(psoc_ext_obj_fl + 7440) == 21 )
      qdf_mc_timer_stop(v11 + 7440);
    qdf_mc_timer_destroy(v11 + 7440);
  }
  else
  {
    qdf_trace_msg(
  ...
  if ( a1 )
  {
    qdf_mc_timer_stop(a1 + 17232);
    qdf_mc_timer_destroy(a1 + 17232);
  }
  csr_scan_close(a1);
  *(_QWORD *)(a1 + 17224) = 0;
  return 0;
