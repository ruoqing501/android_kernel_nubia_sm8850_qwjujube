...
LABEL_14:
  ...
  v26 = _qdf_mem_malloc(0xE90u, "hdd_get_peer_stats", 1881);
  if ( !v26 )
  {
    result = 4294967284LL;
    goto LABEL_18;
...
LABEL_16:
  ...
  if ( (_DWORD)v39 )
    goto LABEL_16;
  *(_DWORD *)(a2 + 228) = *(_DWORD *)(v35 + 3496);
  is_enabled = ucfg_ipa_is_enabled(v39);
  v41 = *(_QWORD *)(v35 + 2528) + *(_QWORD *)(v35 + 2512);
  if ( (is_enabled & 1) != 0 )
  ...
  *(_DWORD *)(a2 + 232) = v41;
  ...
  {
    if ( (cds_dp_get_vdev_stats(*(unsigned __int8 *)(v25 + 104), &v79) & 1) != 0 )
      *(_DWORD *)(a2 + 236) = v80;
    else
      qdf_trace_msg(
        0x33u,
