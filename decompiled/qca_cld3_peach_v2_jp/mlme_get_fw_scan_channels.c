...
LABEL_10:
  ...
  v14 = *(unsigned __int8 *)(ext_hdl + 1948);
  *a3 = v14;
  if ( !v14 )
    return 0;
  v15 = 0;
  while ( v15 != 102 )
  {
    *(_DWORD *)(a2 + 4 * v15) = *(_DWORD *)(ext_hdl + 1952 + 4 * v15);
    if ( ++v15 >= (unsigned __int64)*(unsigned __int8 *)(ext_hdl + 1948) )
      return 0;
  }
  __break(0x5512u);
  v18 = MEMORY[0xFFFFFFFFFA0F7EF8]();
