...
LABEL_12:
  ...
  v25 = context;
  if ( !cm_is_vdevid_connected(*(_QWORD *)(a1 + 21560), a2) )
  {
    v36 = "%s: STA is not connected, Session_id: %d";
    v37 = 8;
    goto LABEL_12;
  }
  wlan_get_op_chan_freq_info_vdev_id(*(_QWORD *)(a1 + 21560), a2, &v70, (_DWORD *)&v69 + 1, &v69);
  if ( !a3 )
  {
    qdf_trace_msg(
      0x34u,
...
LABEL_23:
  ...
  *a3 = v41;
  if ( *(_BYTE *)(a1 + 21702) == 1 )
    v42 = (*(_BYTE *)(a1 + 21703) & 3) << 9;
  else
    v42 = (v69 & 3) << 9;
  *a3 = v42 | v41 & 0xFFFFF9C7;
  v43 = *(unsigned __int8 *)(a1 + 21706);
  *a3 = v42 & 0xFFFFF7C7 | v41 & 0xFFFFF1C7 | (v43 << 11);
  *a3 = v42 & 0xFFFDF7C7 | v41 & 0xFFFDF1C7 | (v43 << 11) & 0xFFFDFFFF | (*(unsigned __int8 *)(a1 + 21709) << 17) | 3;
  qdf_trace_msg(
    0x34u,
    8u,
  ...
  wlan_mlme_get_bssid_vdev_id(*(_QWORD *)(a1 + 21560), a2, (char *)&v71 + 4);
