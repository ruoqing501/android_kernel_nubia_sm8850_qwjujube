        ...
        double a10)
{
  ...
  double v89; // d6
  double v90; // d7
  char v91[4]; // [xsp+24h] [xbp-4Ch] BYREF
  _QWORD v92[4]; // [xsp+28h] [xbp-48h] BYREF
  __int64 v93[2]; // [xsp+48h] [xbp-28h] BYREF
  int v94; // [xsp+58h] [xbp-18h]
  int v95; // [xsp+5Ch] [xbp-14h]
  ...
  if ( !v29 )
  {
    ...
    if ( result )
    {
      ...
      if ( v32 )
      {
        ...
        v93[0] = v34;
        v93[1] = (__int64)get_big_data_stats_cb;
