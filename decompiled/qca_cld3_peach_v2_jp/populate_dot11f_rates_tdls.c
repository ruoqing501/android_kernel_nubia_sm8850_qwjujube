...
LABEL_10:
      v28 = *(_QWORD *)(a1 + 8);
      v32 = *(_QWORD *)(v28 + 2824);
      wlan_mlme_get_cfg_str(v34, v28 + 2816, &v32, v17, v18, v19, v20, v21, v22, v23, v24);
      v27 = v32;
      v26 = v35[0];
      v33 = v32;
...
LABEL_11:
    ...
    v25 = *(_QWORD *)(a1 + 8);
    v32 = *(_QWORD *)(v25 + 2784);
    wlan_mlme_get_cfg_str((char *)v35 + 1, v25 + 2776, &v32, v17, v18, v19, v20, v21, v22, v23, v24);
    v26 = v32;
  }
  LOBYTE(v35[0]) = v26;
  if ( v16 != 3 )
