__int64 __fastcall sme_close(__int64 a1)
{
  ...
  if ( !(unsigned int)qdf_mutex_acquire(a1 + 12776) )
  {
    ...
    if ( v41 )
    {
      if ( *(_DWORD *)(a1 + 12840) )
      {
        v42 = 0;
        do
          _qdf_mem_free(*(_QWORD *)(*(_QWORD *)(a1 + 12848) + 8 * v42++));
        while ( v42 < *(unsigned int *)(a1 + 12840) );
        v41 = *(_QWORD *)(a1 + 12848);
      }
      _qdf_mem_free(v41);
      *(_QWORD *)(a1 + 12848) = 0;
    }
    v43 = qdf_mutex_release(a1 + 12776);
    if ( v43 )
      qdf_trace_msg(
        0x34u,
        2u,
  ...
  if ( (unsigned int)qdf_mutex_destroy(a1 + 12776) )
    result = 16;
  else
    result = v2;
  *(_DWORD *)(a1 + 12768) = 0;
