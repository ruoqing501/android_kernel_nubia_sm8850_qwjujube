        ...
        double a10)
{
  ...
  if ( !v11 || (*(_BYTE *)(v11 + 96LL * (unsigned int)v10 + 1) & 1) == 0 )
    return qdf_trace_msg(
             ...
             "csr_roam_process_results_default",
             (unsigned int)v10);
  opmode_from_vdev_id = wlan_get_opmode_from_vdev_id(*((_QWORD *)a1 + 2695), v10);
  ...
  if ( result )
  {
    ...
    if ( a1[v10 + 4299] == 3 )
    {
      v18 = *((_QWORD *)a1 + 2153) + 96LL * (unsigned int)v10;
      v19 = *(_QWORD *)(v18 + 32);
      if ( v19 )
      {
        _qdf_mem_free(v19);
      ...
      *(_QWORD *)(v18 + 8) = 0;
      *(_QWORD *)(v18 + 16) = 0;
      v20 = csr_translate_to_wni_cfg_dot11_mode(a1, v17[4283]);
      v17 = a1;
      *(_DWORD *)(*((_QWORD *)a1 + 1) + 5748LL) = v20;
    }
    ...
    {
      v21 = a2;
      *(_DWORD *)(v16 + 304) = v17[5400];
      *(_DWORD *)(v16 + 308) = v17[5401];
      *(_DWORD *)(v16 + 312) = v17[5402];
      *(_DWORD *)(v16 + 320) = v17[5404];
      v22 = v17 + 4293;
      *(_DWORD *)(v16 + 324) = v17[5403];
      if ( v17[v10 + 4293] != 3 )
      {
      ...
      if ( (opmode_from_vdev_id & 0xFFFFFFFD) == 1 )
      {
        ...
        *(_BYTE *)(v16 + 40) = v50;
        ...
        {
          wlan_get_operation_chan_freq_vdev_id(*((_QWORD *)a1 + 2695), v10);
          v52 = *((_DWORD **)a1 + 2746);
          if ( v52 )
          {
            v53 = *((_QWORD *)a1 + 2694);
