__int64 __fastcall qdf_trace_display(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  for ( i = 32; i != 366; i += 2 )
  {
    ...
    {
      printk(&unk_999B93, "qdf_print_is_verbose_enabled", (unsigned int)qdf_pidx, v4);
LABEL_10:
      v8 = " ";
      goto LABEL_11;
    }
    ...
    {
      printk(&unk_9134FE, "qdf_print_is_verbose_enabled", (unsigned int)qdf_pidx, v4);
      goto LABEL_10;
    }
...
LABEL_55:
    ...
    result = printk(&unk_91E33B, v5++, v6, v8);
    v6 += 32;
  }
  return result;
}
