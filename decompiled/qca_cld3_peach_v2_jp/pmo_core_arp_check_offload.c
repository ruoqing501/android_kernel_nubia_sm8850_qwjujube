__int64 __fastcall pmo_core_arp_check_offload(__int64 a1, unsigned int a2, unsigned int a3)
{
  ...
  if ( !v4 )
  {
    qdf_trace_msg(0x4Du, 2u, "%s: vdev is NULL", v5, v6, v7, v8, v9, v10, v11, v12, "pmo_core_arp_check_offload");
    return 4;
  }
  v13 = v4;
  if ( *(_DWORD *)(v4 + 16) == 11 )
  {
    v14 = "%s: ARP offload is not supported in NaN mode";
LABEL_4:
    qdf_trace_msg(0x4Du, 8u, v14, v5, v6, v7, v8, v9, v10, v11, v12, "pmo_core_arp_check_offload");
