        ...
        double a11)
{
  ...
  if ( v11 == 5167 )
  {
    if ( *(unsigned __int8 *)(a3 + 4) >= 6uLL )
      goto LABEL_106;
    v42 = (unsigned __int16 *)&a1[68 * *(unsigned __int8 *)(a3 + 4) + 2177];
    qdf_mem_copy(v42 + 1, (const void *)(a3 + 5), 6u);
    *v42 = *(_WORD *)(a3 + 12);
    *((_BYTE *)v42 + 8) = *(_BYTE *)(a3 + 20);
    v43 = *((unsigned __int8 *)v14 + 1026);
    ...
    *((_DWORD *)v42 + 5) = *(_DWORD *)(a3 + 24);
    ...
    if ( v54 >= 6 )
      goto LABEL_106;
    v55 = (__int64)&a1[68 * (unsigned int)v54 + 2177];
    LODWORD(v249) = 0;
...
LABEL_68:
      report_xmit_ind = sme_rrm_send_chan_load_report_xmit_ind(
                          a1,
                          &a1[68 * (unsigned int)v54 + 2177],
                          (unsigned int)v249,
                          0);
      rrm_cleanup((__int64)a1, (unsigned int)v54, report_xmit_ind, v150, v151, v152, v153, v154, v155, v156);
      goto LABEL_80;
    }
    scan_id = wlan_scan_get_scan_id(a1[2694], v132, v133, v134, v135, v136, v137, v138, v139);
    *(_DWORD *)(v123 + 8) = scan_id;
    *(_DWORD *)(v55 + 140) = scan_id;
    v171 = *(unsigned __int8 *)(v122 + 104);
    v172 = *(_DWORD *)(v123 + 92);
    v254 = 0;
    v253 = 0;
    *(_DWORD *)(v123 + 16) = v171;
    ...
    *(_DWORD *)(v123 + 92) = v172 | 0x5000001;
    ...
    rrm_get_country_code_from_connected_profile((__int64)a1, *(_BYTE *)(v122 + 104), (unsigned __int8 *)&v253);
    ...
    {
      if ( wlan_reg_is_6ghz_op_class(a1[2695], *(_BYTE *)(v55 + 8)) )
...
LABEL_89:
  ...
  if ( *(unsigned __int8 *)(a3 + 5) >= 5uLL )
    goto LABEL_106;
  v23 = (__int64)&a1[68 * *(unsigned __int8 *)(a3 + 5) + 2177];
    ...
    do
    {
      ...
      *(_QWORD *)(v74 + 16) = v75;
      ...
      if ( v89 )
      {
        ...
        wlan_cm_roam_cfg_get_value(a1[2694], *(unsigned __int8 *)(v74 + 28), 0x15u, &v249);
        if ( (_BYTE)v250 )
          v93 = v91;
        else
          v93 = v91 + 30;
      ...
      if ( *(_DWORD *)(v74 + 24) )
      {
        if ( *(_QWORD *)(v74 + 16) )
        {
          if ( (csr_ll_is_list_empty((__int64)(a1 + 2195), 1, v15, v16, v17, v18, v19, v20, v21, v22) & 1) != 0 )
          {
            qdf_trace_msg(
              0x34u,
              2u,
          ...
          {
            v110 = csr_ll_peek_head((__int64)(a1 + 2195), 1, v94, v95, v96, v97, v98, v99, v100, v101);
            if ( v110 )
            {
              v111 = v110;
              while ( 1 )
              {
                v112 = (__int64)(a1 + 2195);
...
LABEL_60:
          csr_ll_insert_tail((__int64)(a1 + 2195), (_QWORD *)v74, 1, v102, v103, v104, v105, v106, v107, v108, v109);
        }
      }
      else
      {
...
LABEL_106:
  ...
  v157 = (unsigned int)csr_ll_count(
                         (__int64)&a1[68 * *(unsigned __int8 *)(a3 + 5) + 2195],
                         v15,
                         v16,
                         v17,
                         v18,
  ...
  *((_BYTE *)v14 + 1264) = 0;
  v158 = v157;
  if ( (unsigned int)qdf_mc_timer_get_current_state((__int64)(a1 + 2207)) == 21 )
  {
    qdf_trace_msg(
      0x34u,
      8u,
    ...
    qdf_mc_timer_stop((__int64)(a1 + 2207));
  }
  v167 = (_DWORD *)a1[2229];
  v168 = a1[2230];
  a1[2229] = 0;
