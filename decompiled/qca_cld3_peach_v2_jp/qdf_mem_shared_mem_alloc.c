...
LABEL_24:
    ...
    __asm { PRFM            #0x11, [X8] }
    do
      v29 = __ldxr((unsigned int *)&dword_716984);
    while ( __stxr(v29 + a2, (unsigned int *)&dword_716984) );
    *(_QWORD *)(v4 + 32) = v10;
    *(_QWORD *)(v4 + 16) = a2;
    memset(v10, 0, a2);
    v11 = 8;
    ...
    *(_QWORD *)v4 = v13;
    if ( (unsigned int)dma_get_sgtable_attrs(*(_QWORD *)(a1 + 40), v4 + 40, *(_QWORD *)(v4 + 32), v12, v5, 0) )
    {
      ...
      __asm { PRFM            #0x11, [X8] }
      do
        v32 = __ldxr((unsigned int *)&dword_716984);
      while ( __stxr(v32 - v14, (unsigned int *)&dword_716984) );
      dma_free_attrs();
      if ( (unsigned __int64)ksize(v4) > 0x2000 && (unsigned int)wcnss_prealloc_put(v4) )
        return 0;
      v15 = ksize(v4);
