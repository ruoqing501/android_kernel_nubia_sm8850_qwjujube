...
void __usercall sub_271DA0(char a1@<W8>)
{
  unsigned int v1; // w19
  unsigned int *v2; // x20
  char v3; // w21
...
LABEL_14:
  ...
  if ( !v67[0] && !(unsigned int)policy_mgr_mode_specific_connection_count(v5, 1, nullptr) )
  {
    qdf_trace_msg(
      0x4Fu,
      8u,
    ...
    if ( (unsigned int)((__int64 (__fastcall *)(__int64, __int64, _DWORD *, unsigned int *, _BYTE *, __int64, _QWORD))policy_mgr_get_pcl)(
                         v5,
                         1,
                         v65,
                         v67,
...
LABEL_40:
    ...
    {
LABEL_49:
      if ( (wlan_reg_is_6ghz_chan_freq(v1) || wlan_reg_is_5ghz_ch_freq(v1) && wlan_reg_is_5ghz_ch_freq(*v2)) && v67[0] )
      {
        v52 = *v2;
        v64 = 0;
        while ( v64 != 102 )
