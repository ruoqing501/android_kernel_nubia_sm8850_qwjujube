        ...
        double a8)
{
  ...
  qword_864618 = (__int64)&g_ipa_logging_ctx;
  qword_864620 = 0x4000000000LL;
  qword_864628 = (__int64)&qword_864628;
  qword_864630 = (__int64)&qword_864628;
  qword_864638 = 0x4000000000LL;
  dword_864640 = 0;
  qword_864648 = 0;
...
LABEL_14:
  ...
  {
    raw_spin_lock(&dword_864640);
  }
  else
  {
    raw_spin_lock_bh(&dword_864640);
    qword_864648 |= 1uLL;
  }
  v17 = 0;
  v18 = 64;
  ...
  {
    qword_864648 &= ~1uLL;
    raw_spin_unlock_bh(&dword_864640);
  }
  else
  {
    raw_spin_unlock(&dword_864640);
  }
  qword_864E78 = 0;
  _init_waitqueue_head(&unk_864E50, "&g_ipa_logging_ctx.wait_q", &wlan_ipa_logging_sock_init___key);
