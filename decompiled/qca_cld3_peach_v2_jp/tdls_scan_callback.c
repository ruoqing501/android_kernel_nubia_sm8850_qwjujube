...
LABEL_38:
      ...
      else
      {
        ...
        v33 = v17 + 8;
        v43[0] = nullptr;
        while ( (unsigned int)qdf_list_peek_front((_QWORD *)(v33 + 24 * v31), v43) )
        {
LABEL_24:
          v32 = v31++ > 0xE;
          if ( v31 == 16 )
        ...
        while ( !v43[0] || *((_DWORD *)v43[0] + 9) != 4 || *((_BYTE *)v43[0] + 50) )
        {
          if ( (unsigned int)qdf_list_peek_next((_QWORD *)(v33 + 24 * v31), v43[0], v43) )
            goto LABEL_24;
        }
LABEL_34:
        if ( v32 )
...
LABEL_37:
          tdls_disable_offchan_and_teardown_links(v6);
      }
      goto LABEL_38;
    }
  }
