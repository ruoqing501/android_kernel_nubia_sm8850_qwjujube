__int64 __fastcall wlan_objmgr_get_peer(__int64 a1, char a2, _BYTE *a3, unsigned int a4)
{
...
LABEL_17:
  ...
  {
    while ( (unsigned int)qdf_mem_cmp((const void *)(v13 + 48), a3, 6u)
         || byte_36[v13] != a2
         || (unsigned int)wlan_objmgr_peer_try_get_ref(v13, a4, v14, v15, v16, v17, v18, v19, v20, v21) )
    {
      v26[0] = 0;
      v12 = 0;
