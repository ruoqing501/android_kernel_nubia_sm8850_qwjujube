    ...
    if ( v11 )
    {
      ...
      *(_DWORD *)(v12 + 72) = a3;
      if ( a5 )
      {
        ...
        v14 = *(_QWORD *)(v12 + 576);
        *(_BYTE *)(v12 + 3951) = *(_BYTE *)(values + 796);
        if ( (pld_is_one_msi(*(_QWORD *)(v14 + 40)) & 1) != 0 )
        {
          qdf_trace_msg(61, 8, "%s: Disable wake IRQ once it is one MSI mode", "hif_get_cfg_from_psoc");
          *(_BYTE *)(v12 + 3951) = 1;
        }
        *(_WORD *)(v12 + 3948) = *(_DWORD *)(cfg_psoc_get_values(a5) + 788);
        *(_BYTE *)(v12 + 3950) = *(_DWORD *)(cfg_psoc_get_values(a5) + 792);
      }
      *(_QWORD *)(v12 + 608) = 255;
      ...
      else
      {
        ...
        v22[0] = 0;
        v16 = *(unsigned __int8 *)(cfg_psoc_get_values(a5) + 797);
        *(_BYTE *)(v12 + 4196) = v16;
