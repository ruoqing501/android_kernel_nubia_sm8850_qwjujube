        ...
        if ( v14 == -1 )
        {
          if ( !wmi_get_runtime_pm_inprogress(*(_QWORD *)a1) )
          {
            ...
            if ( wow_suspend_type > 2 )
              ...
              v34 = off_A17E90[wow_suspend_type];
            qdf_trace_msg(
              0x36u,
              8u,
...
LABEL_31:
        ...
        if ( (wlan_pmo_enable_ssr_on_page_fault(v63) & 1) != 0 )
        {
          ...
          v129 = v117 - v120;
          v130 = *(unsigned __int8 *)(a1 + 4380);
          if ( v117 >= v120 && *(_BYTE *)(a1 + 4380) )
          {
            v131 = *(_QWORD **)(a1 + 4384);
            v132 = 0;
...
LABEL_128:
            ...
            *(_BYTE *)(a1 + 4380) = v226;
            ...
            qdf_mem_set(
              (void *)(*(_QWORD *)(a1 + 4384) + 8LL * *(unsigned __int8 *)(a1 + 4380)),
              8 * (unsigned int)v133,
              0);
            LODWORD(v130) = *(unsigned __int8 *)(a1 + 4380);
          }
LABEL_129:
          v227 = *(_QWORD *)(a1 + 4384);
          *(_BYTE *)(a1 + 4380) = v130 + 1;
          *(_QWORD *)(v227 + 8LL * (unsigned int)v130) = v117;
          if ( *(unsigned __int8 *)(a1 + 4380) >= (unsigned int)min_pagefault_wakeups_for_action )
          {
            ...
            v238 = *(_QWORD *)(a1 + 4384);
            v239 = *(_BYTE *)(a1 + 4380) - 1;
            *(_BYTE *)(a1 + 4380) = v239;
            qdf_mem_copy((void *)v238, (const void *)(v238 + 8), 8 * (unsigned int)v239);
            qdf_mem_set((void *)(*(_QWORD *)(a1 + 4384) + 8LL * *(unsigned __int8 *)(a1 + 4380)), 8u, 0);
          }
LABEL_32:
          v62 = *(_DWORD *)(v12 + 12);
LABEL_33:
...
LABEL_173:
          ...
          if ( (unsigned int)(icmpv6_subtype - 1) > 0x1A )
            goto LABEL_262;
          v366 = off_A17EA8[icmpv6_subtype - 1];
LABEL_261:
...
LABEL_228:
            if ( *(_DWORD *)(a1 + 5184) )
            {
              wma_wow_pagefault_action_cb(*(_QWORD *)(a1 + 5176));
              *(_DWORD *)(a1 + 5184) = 0;
            }
            qdf_spinlock_release(a1 + 5192);
...
LABEL_221:
        ...
        else
        {
          ...
          if ( v324 )
          {
            v333 = (void (__fastcall *)(char *, __int64))v324[1823];
