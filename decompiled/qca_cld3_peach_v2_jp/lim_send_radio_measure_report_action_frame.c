...
LABEL_21:
    ...
    *((_WORD *)v57 + 11) = (16 * (v68 & 0xF)) | *((_WORD *)v57 + 11) & 0xFF0F;
    v69 = (unsigned __int8)(*(_WORD *)(a1 + 21532) >> 4);
    *((_WORD *)v57 + 11) = (16 * *(_WORD *)(a1 + 21532)) & 0xFF00 | (16 * (v68 & 0xF));
    qdf_trace_msg(
      0x35u,
      8u,
    ...
    *((_BYTE *)v116[0] + 16) = *(_BYTE *)(a7 + 24);
    ...
    {
      v105 = jiffies;
      if ( lim_send_radio_measure_report_action_frame___last_ticks_201 - jiffies + 125 < 0 )
      {
        qdf_trace_msg(
          0x35u,
          2u,
          ...
          v104,
          v96);
        lim_send_radio_measure_report_action_frame___last_ticks_201 = v105;
      }
      v96 = 16;
    }
    _qdf_mem_free(v23);
