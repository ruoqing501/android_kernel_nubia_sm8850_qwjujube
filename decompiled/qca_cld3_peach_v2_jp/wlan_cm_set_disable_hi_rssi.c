__int64 __fastcall wlan_cm_set_disable_hi_rssi(__int64 a1, unsigned __int8 a2, char a3)
{
  ...
  if ( (ext_hdl_fl & 0xFFFFFFFD) == 0 )
  {
    ...
    ext_hdl_fl = cm_get_ext_hdl_fl(
                   ...
                   v11,
                   v12);
    vdev_by_id_from_pdev = v14;
    wlan_cm_set_disable_hi_rssi_rso_cfg = ext_hdl_fl;
    if ( ext_hdl_fl )
      *(_BYTE *)(ext_hdl_fl + 91) = a3 & 1;
  }
