__int64 __fastcall wlan_objmgr_trigger_vdev_comp_priv_object_creation(__int64 a1, unsigned int a2)
{
  __int64 result; // x0
  ...
  if ( *(_QWORD *)(a1 + 8LL * a2 + 616) )
  {
    if ( (v6 & 1) != 0 )
    {
      *(_QWORD *)(a1 + 1280) = v6 & 0xFFFFFFFFFFFFFFFELL;
  ...
  v8 = *(__int64 (__fastcall **)(__int64, __int64))(v7 + 5224);
  if ( !v8 )
    return 16;
  v9 = *(_QWORD *)(v7 + 5656);
  if ( *((_DWORD *)v8 - 1) != -1744405434 )
    __break(0x8228u);
  *(_DWORD *)(a1 + 4LL * a2 + 1048) = v8(a1, v9);
  if ( *(_DWORD *)(a1 + 1264) != 1 )
    return 0;
