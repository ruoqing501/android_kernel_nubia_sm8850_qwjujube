...
LABEL_10:
  ...
  v22 = *(_DWORD *)(a1 + 16);
  wlan_mlme_get_sr_enable_modes(context[2694], v145);
  if ( ((v145[0] >> v22) & 1) == 0 )
  {
  ...
  if ( !cmpt_obj || (*(_BYTE *)(cmpt_obj + 186) & 1) == 0 )
  {
    result = qdf_trace_msg(
               0x35u,
               8u,
  ...
  if ( v40 )
    v49 = *(unsigned __int8 *)(v40 + 183);
  else
    v49 = 0;
  v52 = wlan_vdev_mlme_get_cmpt_obj(a1, v41, v42, v43, v44, v45, v46, v47, v48);
  if ( v52 )
  {
    v61 = *(unsigned __int8 *)(v52 + 184);
    v62 = *(unsigned __int8 *)(v52 + 185);
  }
  else
  {
    v61 = 0;
...
LABEL_36:
  ...
  if ( (*(_BYTE *)(v83 + 182) & 0xA) != 2 )
  {
    if ( ((*(_BYTE *)(v83 + 182) & 2) != 0 || (int)v72 <= v49 - 82)
      && ((*(_BYTE *)(v83 + 182) & 8) == 0 || (int)v82 <= v61 - 82 && (int)v82 >= v62 - 82) )
    {
      goto LABEL_51;
    }
    goto LABEL_36;
