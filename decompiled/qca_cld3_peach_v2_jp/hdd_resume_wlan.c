        ...
        double a8)
{
  ...
  __int64 v96; // [xsp+8h] [xbp-18h] BYREF
  _BYTE v97[4]; // [xsp+14h] [xbp-Ch] BYREF
  __int64 v98; // [xsp+18h] [xbp-8h]
...
LABEL_11:
  ...
  *((_BYTE *)v25 + 185) = 0;
  v97[0] = 0;
  qdf_mem_set(v97, 1u, 0);
  v97[0] = 2;
  host_diag_event_report_payload(2743, 1, v97);
  ...
  hdd_get_front_adapter_no_lock((__int64)v25, &v96);
  if ( v96 )
  {
    hdd_adapter_dev_hold_debug(v96, 0x33u, v35, v36, v37, v38, v39, v40, v41, v42, v43);
    v44 = v96;
  }
  else
  {
  ...
  hdd_get_next_adapter_no_lock((__int64)v25, v44, &v95);
  if ( v95 )
    hdd_adapter_dev_hold_debug(v95, 0x33u, v55, v56, v57, v58, v59, v60, v61, v62, v63);
  v64 = v25[5];
  if ( (v64 & 1) != 0 )
  {
...
LABEL_21:
        ...
        v96 = v95;
        hdd_get_next_adapter_no_lock((__int64)v25, v95, &v95);
        hdd_validate_next_adapter(&v96, &v95, 0x33u, v76, v77, v78, v79, v80, v81, v82, v83);
        if ( v95 )
          hdd_adapter_dev_hold_debug(v95, 0x33u, v84, v85, v86, v87, v88, v89, v90, v91, v92);
        v93 = v25[5];
        if ( (v93 & 1) != 0 )
        {
      ...
      while ( 1 )
      {
        ...
        {
          hdd_disable_host_offloads(v96, 1u, v65, v66, v67, v68, v69, v70, v71, v72);
          if ( !*(_DWORD *)(v96 + 40) )
...
LABEL_44:
  ...
  v94 = ucfg_pmo_psoc_user_space_resume_req(*v25, 0);
  if ( v94 )
  {
