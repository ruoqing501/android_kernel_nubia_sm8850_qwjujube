        ...
        double a9)
{
  ...
  else
  {
    ...
    LOBYTE(v44) = 0;
    *(_BYTE *)(a1 + 12411) = v22;
    v23 = *(_DWORD *)(v21 + 5396) != 0;
    *(_WORD *)(v21 + 1268) = *(_WORD *)(v21 + 1268) & 0xFFFD | (2 * v23);
    *(_BYTE *)(*(_QWORD *)(a1 + 8) + 1273LL) = *(_BYTE *)(*(_QWORD *)(a1 + 8) + 1273LL) & 0xFB | (4 * v23);
    *(_DWORD *)(a1 + 12736) = *(_DWORD *)(*(_QWORD *)(a1 + 8) + 3508LL) != 0;
    handle_ht_capabilityand_ht_info(a1, 0);
    if ( (unsigned int)cfg_tdls_get_buffer_sta_enable(*(_QWORD *)(a1 + 21552), &v44) )
    {
