          ...
          if ( v24 && (*(_BYTE *)(v24 + 96LL * v11 + 1) & 1) != 0 )
          {
            ...
            *(_QWORD *)(v25 + 16) = 0;
            ...
            if ( v32 >= 0x18 )
              ...
              v34 = 0;
            v35 = v34 + *(_DWORD *)(v27 + 112) + *(_DWORD *)(v27 + 128) + *(_DWORD *)(v27 + 168);
            if ( v35 + v33 )
            {
              ...
              *(_QWORD *)(v25 + 32) = v36;
              if ( v36 )
              {
                ...
                *(_DWORD *)(v25 + 16) = v41;
                ...
                v44 = *(unsigned int *)(v27 + 168);
                v45 = &v42[v43];
                *(_DWORD *)(v25 + 20) = v44;
                if ( (_DWORD)v44 )
                {
                  qdf_mem_copy(v45, *(const void **)(v27 + 176), v44);
                  v46 = *(unsigned int *)(a2 + 168);
                  v27 = a2;
                }
                else
                {
                ...
                v47 = *(unsigned int *)(v27 + 184);
                *(_DWORD *)(v25 + 24) = v47;
                if ( (_DWORD)v47 )
                {
                  qdf_mem_copy(&v45[v46], *(const void **)(v27 + 192), v47);
                  v27 = a2;
                }
              }
            }
            ...
            v121 = 0;
            *(_BYTE *)(v25 + 40) = v48;
            v50 = _qdf_mem_malloc(0x2D0u, "csr_fill_connected_profile", 5634);
            if ( v50 )
            {
              v59 = *(_WORD *)v50;
              v60 = (_BYTE *)v50;
              ...
              *(_WORD *)v50 = v59 | 8;
              ...
              if ( cmpt_obj )
              {
                v72 = *(unsigned __int8 *)(cmpt_obj + 162);
                if ( *(_BYTE *)(cmpt_obj + 162) )
                {
                  v60[100] = v72;
                  qdf_mem_copy(v60 + 101, (const void *)(cmpt_obj + 129), v72);
                  v71 = v26;
                  v60[17] = 1;
                }
                else
              ...
              scan_result = scm_get_scan_result(v71[2695], (__int64)v60, v63, v64, v65, v66, v67, v68, v69, v70);
              ...
              if ( scan_result )
              {
                if ( *((_DWORD *)scan_result + 4) )
                {
                  ...
                  {
                    v83 = _qdf_mem_malloc(
                            (unsigned __int16)(*(_WORD *)(*(_QWORD *)(v119 + 24) + 1704LL) + 68),
                                            ...
                                            (__int64 *)&v118) )
                      {
                        ...
                        if ( v96 )
                        {
                          if ( !*(_QWORD *)(a2 + 88) )
                          {
                            ...
                            *(_QWORD *)(a2 + 88) = v99;
                            if ( v99 )
                            {
                              qdf_mem_copy(v99, *(const void **)(v96 + 1712), *(unsigned int *)(a2 + 80));
                              v97 = a2;
                            }
                          }
                        }
                        ...
                        if ( (v100 & 4) != 0 )
                        {
                          ...
                          is_ese_connection = cm_is_ese_connection(
                                                ...
                                                v94,
                                                v95);
                          wlan_cm_set_ese_assoc(v26[2695], v49, is_ese_connection & 1);
                          wlan_cm_roam_cfg_get_value(v26[2694], v49, 0x13u, v115);
                          LOBYTE(v117) = v115[0];
                        ...
                        wlan_cm_set_country_code(v26[2695], v49, (unsigned __int8 *)&v121);
