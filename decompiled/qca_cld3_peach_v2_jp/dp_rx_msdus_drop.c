__int64 __fastcall dp_rx_msdus_drop(__int64 a1, unsigned int *a2, unsigned __int16 *a3, _BYTE *a4, char a5)
{
  ...
  if ( v21 < *(unsigned __int16 *)(a1 + 1866)
    && (v22 = (_QWORD *)(*(_QWORD *)(a1 + 1872) + 24LL * v21), (v23 = *v22 + v97 - v22[2]) != 0) )
  {
    v24 = 0;
    memset(v101, 0, 80);
...
LABEL_74:
      ...
      if ( v85 < v84 )
      {
        v86 = (_QWORD *)(*(_QWORD *)(a1 + 1872) + 24LL * v85);
        v8 = (unsigned int *)&v96;
        v23 = *v86 + v97 - v86[2];
      }
    }
...
LABEL_75:
      ...
      *a4 = v37;
      ...
      dp_rx_nbuf_unmap_pool(a1, a1 + 12368 + 120LL * (unsigned int)v47, *(_QWORD *)v36);
      v36[30] |= 2u;
      v48 = *(_QWORD *)(a1 + 18472);
      if ( (v48 & 1) != 0 )
      {
        *(_QWORD *)(a1 + 18472) = v48 & 0xFFFFFFFFFFFFFFFELL;
      ...
      *((_QWORD *)v36 + 1) = *(_QWORD *)(*(_QWORD *)v36 + 224LL);
      ...
      v62 = *(_QWORD *)(a1 + 40);
      v63 = *(_QWORD *)v36;
      v64 = (void (__fastcall *)(__int64, __int64, __int64, __int64, __int64, __int64))v46[11948];
      v99 = 0;
