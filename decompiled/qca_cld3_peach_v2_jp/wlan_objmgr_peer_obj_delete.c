...
LABEL_7:
  ...
  v20 = *(_QWORD *)(a1 + 88);
  if ( v20 && (v21 = *(_QWORD *)(v20 + 152)) != 0 )
    v22 = *(_QWORD *)(v21 + 80);
  else
    v22 = 0;
  wlan_minidump_remove(a1, 776, v22, 60, "wlan_objmgr_peer");
  qdf_get_pidx();
  qdf_trace_msg(
    0x57u,
    8u,
  ...
  {
    raw_spin_lock_bh(a1 + 760);
    v32 = *(_QWORD *)(a1 + 768) | 1LL;
    *(_QWORD *)(a1 + 768) = v32;
  }
  *(_DWORD *)(a1 + 752) = 6;
  if ( (v32 & 1) != 0 )
  {
    *(_QWORD *)(a1 + 768) = v32 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(a1 + 760);
  }
  else
  {
