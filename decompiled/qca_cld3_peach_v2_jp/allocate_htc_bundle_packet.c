...
LABEL_5:
  ...
  if ( v6 )
  {
    ...
    if ( v3 )
    {
      ...
      {
        printk(&unk_881311, "../vendor/qcom/opensource/wlan/qcacld-3.0/cmn/htc/htc_send.c", 239, "pQueueSave");
        _qdf_nbuf_free(v7);
        _qdf_mem_free(v3);
        return 0;
      }
    ...
    {
      printk(&unk_881311, "../vendor/qcom/opensource/wlan/qcacld-3.0/cmn/htc/htc_send.c", 233, "pPacket");
      _qdf_nbuf_free(v7);
    }
  }
  else
  {
    printk(&unk_881311, "../vendor/qcom/opensource/wlan/qcacld-3.0/cmn/htc/htc_send.c", 229, "netbuf");
    return 0;
  }
  return v3;
}
