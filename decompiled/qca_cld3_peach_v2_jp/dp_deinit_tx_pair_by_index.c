__int64 __fastcall dp_deinit_tx_pair_by_index(__int64 a1, unsigned int a2)
{
  ...
  else
  {
    ...
    qdf_trace_msg(
      ...
      v5,
      v6);
    result = dp_srng_deinit(a1, (__int64 *)(v17 + 6752), 5u, v5, v26, v27, v28, v29, v30, v31, v32, v33, v34);
    if ( v6 != 15 )
    {
      v44 = a1 + 80LL * a2;
      wlan_minidump_remove(
        ...
        v43,
        *(_QWORD *)(v44 + 7328),
        *(unsigned int *)(v44 + 7360),
        *(_QWORD *)(a1 + 16));
      return dp_srng_deinit(a1, (__int64 *)(v44 + 7320), 0xDu, v6, v45, v46, v47, v48, v49, v50, v51, v52, v53);
    }
  }
  return result;
}
