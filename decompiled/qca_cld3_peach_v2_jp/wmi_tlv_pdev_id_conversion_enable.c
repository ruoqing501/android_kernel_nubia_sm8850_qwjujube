__int64 __fastcall wmi_tlv_pdev_id_conversion_enable(__int64 result, _DWORD *a2, unsigned __int8 a3)
{
  ...
  *(_BYTE *)(*(_QWORD *)(result + 760) + 7748LL) = v3;
  *(_BYTE *)(*(_QWORD *)(result + 760) + 7749LL) = v3;
  *(_QWORD *)(*(_QWORD *)(result + 728) + 3664LL) = convert_host_pdev_id_to_target_pdev_id;
  *(_QWORD *)(*(_QWORD *)(result + 728) + 3672LL) = convert_target_pdev_id_to_host_pdev_id;
  *(_QWORD *)(*(_QWORD *)(result + 728) + 3680LL) = convert_host_phy_id_to_target_phy_id;
  *(_QWORD *)(*(_QWORD *)(result + 728) + 3688LL) = convert_target_phy_id_to_host_phy_id;
  return result;
}
