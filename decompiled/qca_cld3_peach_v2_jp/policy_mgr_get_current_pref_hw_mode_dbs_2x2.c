...
LABEL_3:
  ...
  if ( connection_count != 3 )
  {
    ...
    v29 = wlan_reg_freq_to_band(HIDWORD(qword_81C464));
    if ( v28 )
    {
      v30 = v29;
      if ( v29 )
      {
        ...
        if ( v28 == 1 && v30 == 1 )
        {
          v31 = policy_mgr_are_sbs_chan(a1, HIDWORD(pm_conc_connection_list), HIDWORD(qword_81C464));
          v32 = BYTE1(v38);
          if ( (v31 & 1) != 0 )
            goto LABEL_14;
          goto LABEL_30;
...
LABEL_27:
  ...
  v34 = wlan_reg_freq_to_band(HIDWORD(qword_81C464));
  v35 = wlan_reg_freq_to_band(HIDWORD(qword_81C488));
  if ( !v33 )
    goto LABEL_27;
  if ( !v34 )
    goto LABEL_27;
  ...
  {
    if ( (policy_mgr_are_sbs_chan(a1, HIDWORD(pm_conc_connection_list), HIDWORD(qword_81C488)) & 1) != 0
      && (policy_mgr_are_sbs_chan(a1, HIDWORD(qword_81C464), HIDWORD(qword_81C488)) & 1) != 0
      && (policy_mgr_are_sbs_chan(a1, HIDWORD(pm_conc_connection_list), HIDWORD(qword_81C464)) & 1) != 0 )
    {
      v32 = BYTE1(v38);
LABEL_14:
      if ( v32 )
