__int64 __fastcall dp_rx_fisa_flush_flow(__int64 result, __int64 a2)
{
  ...
  double v51; // d6
  double v52; // d7
  unsigned int (__fastcall *v53)(_QWORD); // x8
  __int64 v54; // x22
  __int64 v55; // x1
  __int64 v56; // x0
  __int64 v57; // x0
  ...
  if ( *(_BYTE *)(a2 + 41) )
  {
    ...
    *(_BYTE *)(*(_QWORD *)(a2 + 48) + 75LL) = 1;
    ...
    v53 = *(unsigned int (__fastcall **)(_QWORD))(a2 + 152);
    v54 = ref_by_id_3;
    if ( (unsigned int (__fastcall *)(_QWORD))ref_by_id_3 == v53 )
    {
      v55 = *(_QWORD *)(a2 + 48);
      v53 = (unsigned int (__fastcall *)(_QWORD))*(unsigned __int16 *)(a2 + 232);
      if ( *(_DWORD *)(v55 + 116) == (_DWORD)v53 )
      {
        v53 = *(unsigned int (__fastcall **)(_QWORD))(v3 + 160);
        if ( v53 )
        {
          v56 = *(_QWORD *)(v3 + 88);
          if ( *((_DWORD *)v53 - 1) != 424933381 )
            __break(0x8228u);
          if ( !v53(v56) )
            goto LABEL_31;
          v55 = *v5;
      ...
      {
LABEL_31:
        result = dp_vdev_unref_delete(v9, v54, 2u, (unsigned int *)v53, v45, v46, v47, v48, v49, v50, v51, v52);
LABEL_32:
        *v5 = 0;
        v5 = (__int64 *)(a2 + 72);
        goto LABEL_33;
  ...
  **(_QWORD **)(a2 + 48) = 0;
  ...
  if ( v24 )
    *v24 = 0;
  v25 = *(__int64 (__fastcall **)(__int64, __int64))(result + 160);
