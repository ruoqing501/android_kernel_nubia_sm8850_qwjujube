...
LABEL_30:
  ...
  if ( cmpt_obj )
    v24 = *(unsigned __int8 *)(cmpt_obj + 181);
  else
    v24 = 0;
  ...
  if ( *(_DWORD *)(v13 + 88) != 1 )
    goto LABEL_31;
  v44 = *(_DWORD *)(*(_QWORD *)(a1 + 21552) + 20LL);
  ...
  if ( *(_BYTE *)(v13 + 7282)
    && (v44 & 0x2000000) == 0
    && ((v45 = *(unsigned __int8 *)(v13 + 7216), v45 != 1)
      ? (v46 = v45 == *(unsigned __int8 *)(result + 38))
      : (v46 = 1),
        !v46 ? (v47 = 0) : (v47 = 1),
        ((v47 | v24) & 1) != 0)
    || *(_BYTE *)(v13 + 7284) )
  ...
  if ( *(_DWORD *)(v13 + 88) == 1 && *(char *)(v13 + 8745) < 0 )
  {
    ...
    if ( (v48 & 0x3F) != 0 )
    {
      ...
      if ( *(_BYTE *)(v13 + 8766) )
      {
        --*(_BYTE *)(v13 + 8766);
LABEL_52:
        if ( !(unsigned int)((__int64 (__fastcall *)(__int64, __int64))sch_set_fixed_beacon_fields)(a1, v13) )
        {
...
LABEL_51:
      ...
      v81 = *(_QWORD *)(*(_QWORD *)(v13 + 16) + 152LL);
      if ( v81 )
        v82 = *(_QWORD *)(v81 + 80);
      else
        v82 = 0;
