__int64 __fastcall dp_print_hw_stats_wd_timeout_tlv(__int64 a1)
{
  __int64 v2; // x0
  double v3; // d0
  double v4; // d1
  ...
  v2 = _qdf_mem_malloc(0x3E8u, "dp_print_hw_stats_wd_timeout_tlv", 798);
  if ( !v2 )
    return qdf_trace_msg(
             ...
             v9,
             v10,
             "dp_print_hw_stats_wd_timeout_tlv");
  v11 = (char *)v2;
  DP_PRINT_STATS("HTT_HW_STATS_WD_TIMEOUT_TLV:", v3, v4, v5, v6, v7, v8, v9, v10);
  ...
  DP_PRINT_STATS("hw_module_name = %s ", v18, v19, v20, v21, v22, v23, v24, v25, v11);
  DP_PRINT_STATS("count = %u", v26, v27, v28, v29, v30, v31, v32, v33, *(unsigned int *)(a1 + 12));
