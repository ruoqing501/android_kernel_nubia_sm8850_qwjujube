__int64 __fastcall hdd_set_mac_address(__int64 a1, __int64 a2)
{
  ...
  unsigned int v72; // [xsp+18h] [xbp-18h] BYREF
  unsigned __int16 v73; // [xsp+1Ch] [xbp-14h]
  __int64 v74; // [xsp+28h] [xbp-8h]

  v74 = *(_QWORD *)(_ReadStatusReg(SP_EL0) + 1808);
  v71 = 0;
  result = _osif_vdev_sync_op_start(a1, &v71, "hdd_set_mac_address");
  if ( !(_DWORD)result )
  {
    v13 = *(_QWORD *)(a1 + 168);
    v72 = 0;
    ...
    if ( !v23 )
    {
      ...
      {
        qdf_mem_copy(&v72, (const void *)(a2 + 2), 6u);
        adapter_by_macaddr = hdd_get_adapter_by_macaddr((__int64)v14, &v72);
        ...
        else
        {
          if ( v72 | v73 )
          {
            if ( v72 == -1 && (__int16)v73 == -1 )
            {
              v70 = "%s: MAC is Broadcast (via %s)";
            }
            else
            {
              if ( (v72 & 1) == 0 )
              {
                qdf_trace_msg(
                  ...
                  a1 + 296);
                if ( (v13 & 1) == 0
                  || (v60 = *(__int64 **)(a1 + 55512), !v60[4])
                  || (v23 = hdd_dynamic_mac_address_set(v60, v72 | ((unsigned __int64)v73 << 32), 0, 1, 0)) == 0 )
                {
                  ...
                  *(_DWORD *)(a1 + 4305) = v61;
                  ...
                  qdf_trace_msg(0x33u, 8u, "%s: exit", v62, v63, v64, v65, v66, v67, v68, v69, "__hdd_set_mac_address");
                  v23 = 0;
                }
                goto LABEL_3;
              }
              v70 = "%s: MAC is Multicast (via %s)";
            }
          }
          else
          {
            v70 = "%s: MAC is all zero (via %s)";
          }
          qdf_trace_msg(
            0x33u,
            2u,
...
LABEL_3:
    v32 = v23;
    _osif_vdev_sync_op_stop(v71, "hdd_set_mac_address");
    result = v32;
  }
