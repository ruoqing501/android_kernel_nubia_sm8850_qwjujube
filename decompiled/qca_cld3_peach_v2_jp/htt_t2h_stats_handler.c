...
LABEL_117:
      ...
      if ( (v93 & 1) != 0 )
      {
        *(_QWORD *)(a1 + 17880) = v93 & 0xFFFFFFFFFFFFFFFELL;
        result = (_QWORD *)raw_spin_unlock_bh(a1 + 17872);
      }
      else
      {
        result = (_QWORD *)raw_spin_unlock(a1 + 17872);
      }
      goto LABEL_119;
    }
  }
...
LABEL_13:
  ...
  while ( (v13 & 0x800) == 0 );
  v17 = *(_QWORD *)(a1 + 17880);
  v18 = *(_DWORD *)(a1 + 17960) - 1;
  *(_DWORD *)(a1 + 17960) = v18;
  if ( (v17 & 1) != 0 )
  {
    *(_QWORD *)(a1 + 17880) = v17 & 0xFFFFFFFFFFFFFFFELL;
    result = (_QWORD *)raw_spin_unlock_bh(a1 + 17872);
    if ( !v18 )
      goto LABEL_20;
    goto LABEL_19;
  ...
  if ( v18 )
LABEL_19:
    result = (_QWORD *)queue_work_on(32, system_wq, a1 + 17888);
LABEL_20:
  v28 = v101;
  if ( !v101 )
    goto LABEL_119;
...
LABEL_37:
    ...
    *(_DWORD *)(*(_QWORD *)(v38 + 17528) + 152LL) = qdf_get_current_pid();
    *(_DWORD *)(*(_QWORD *)(v38 + 17528) + 148LL) = 1;
LABEL_38:
    v32 = v99;
LABEL_39:
    v40 = (_DWORD *)(v34 + 16);
...
LABEL_44:
      ...
      if ( (v36 & 0x40) != 0 )
      {
        if ( v99 == 88 )
        {
          qdf_mem_copy((void *)(v37 + 7128), v98, 0x80u);
          qdf_event_set(v37 + 95328, v65);
          if ( (v36 & 0x80) != 0 )
            goto LABEL_80;
          goto LABEL_86;
        }
      ...
      if ( (v36 & 0x80) != 0 )
      {
        if ( v99 == 203 )
        {
          if ( (unsigned __int8)v98[1] <= 5u )
          {
            ...
            {
              raw_spin_lock(v66 + 18928);
            }
            else
            {
              raw_spin_lock_bh(v66 + 18928);
              *(_QWORD *)(v66 + 18936) |= 1uLL;
            }
            v67 = *(_QWORD *)(v66 + 8 * (v94 & 7) + 12912);
            if ( v67 )
            {
              v68 = *(_DWORD *)(v67 + 42560);
              while ( v68 )
              {
                _X13 = (unsigned int *)(v67 + 42560);
                __asm { PRFM            #0x11, [X13] }
                while ( 1 )
                {
                  v75 = __ldxr(_X13);
                ...
                if ( _ZF )
                {
                  _X8 = (unsigned int *)(v67 + 42616);
                  __asm { PRFM            #0x11, [X8] }
                  do
                    v83 = __ldxr(_X8);
                  while ( __stxr(v83 + 1, _X8) );
                  v78 = *(_QWORD *)(v66 + 18936);
                  v94 = v67;
                  if ( (v78 & 1) != 0 )
                  {
                    *(_QWORD *)(v66 + 18936) = v78 & 0xFFFFFFFFFFFFFFFELL;
                    raw_spin_unlock_bh(v66 + 18928);
                  }
                  else
                  {
                    raw_spin_unlock(v66 + 18928);
                  }
                  qdf_mem_copy((void *)(v94 + 45380), v98, 0x18u);
                  qdf_event_set(v37 + 95376, v79);
                  dp_vdev_unref_delete(*(_QWORD *)(v37 + 8), v94, 13);
                  goto LABEL_86;
                }
              }
            }
            v80 = *(_QWORD *)(v66 + 18936);
            if ( (v80 & 1) != 0 )
            {
              *(_QWORD *)(v66 + 18936) = v80 & 0xFFFFFFFFFFFFFFFELL;
              raw_spin_unlock_bh(v66 + 18928);
            }
            else
            {
...
LABEL_100:
    if ( !v35
      && (v36 & 0x20) != 0
      && (*((_BYTE *)v40 + 13) & 8) != 0
      && (unsigned int)qdf_event_set(*(_QWORD *)(a1 + 17528) + 96LL, v19) )
    {
      qdf_trace_msg(
        0x80u,
        2u,
