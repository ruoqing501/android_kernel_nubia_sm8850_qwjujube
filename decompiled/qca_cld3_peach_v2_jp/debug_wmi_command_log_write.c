__int64 __fastcall debug_wmi_command_log_write(__int64 a1, __int64 a2, size_t a3)
{
  __int64 v3; // x8
  __int64 result; // x0
  __int64 v5; // x21
  ...
  *(_QWORD *)s = 0;
  ...
  if ( a2 && a3 <= 0x32 )
  {
    ...
    if ( inline_copy_from_user_0((int)s, v7, a3) )
    {
      result = -14;
    }
    ...
    else
    {
      ...
      qdf_mem_set(*(void **)(v5 + 408), (unsigned int)(32 * wmi_cmd_log_max_entry), 0);
      v17 = *(_DWORD **)(v5 + 424);
      *(_DWORD *)(v5 + 416) = 0;
      *v17 = 0;
      v18 = *(_QWORD *)(v5 + 672);
