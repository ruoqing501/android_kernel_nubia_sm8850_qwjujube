__int64 __fastcall dlm_get_delta_of_bssid(int a1, __int64 a2, __int64 *a3)
{
  ...
  if ( a1 > 2 )
  {
    ...
    {
      if ( a1 == 5 )
        return system_time - *(_QWORD *)(a2 + 96);
LABEL_13:
      qdf_trace_msg(
        0x6Du,
        8u,
    ...
    if ( !v18 )
      v18 = 3600000;
    return (v18 + *(_DWORD *)(a2 + 88) - (_DWORD)system_time)
         & (unsigned int)~((v18 + *(_DWORD *)(a2 + 88) - (int)system_time) >> 31);
  }
  else
  {
    if ( !a1 )
    ...
    return system_time - *(_QWORD *)(a2 + 72);
  }
}
