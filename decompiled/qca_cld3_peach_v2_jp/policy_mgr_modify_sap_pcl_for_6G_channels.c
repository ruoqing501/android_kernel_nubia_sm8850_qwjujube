...
LABEL_41:
  ...
  {
    if ( ((unsigned int)qword_81C464 | 2) != 2
      || BYTE4(qword_81C47C) != 1
      || (v20 = &qword_81C464, !wlan_reg_is_6ghz_chan_freq(WORD2(qword_81C464))) )
    {
      if ( ((unsigned int)qword_81C488 | 2) != 2
        || BYTE4(qword_81C4A0) != 1
        || (v20 = &qword_81C488, !wlan_reg_is_6ghz_chan_freq(WORD2(qword_81C488))) )
      {
        if ( ((unsigned int)qword_81C4AC | 2) != 2
          || BYTE4(qword_81C4C4) != 1
          || (v20 = &qword_81C4AC, !wlan_reg_is_6ghz_chan_freq(WORD2(qword_81C4AC))) )
        {
          if ( ((unsigned int)qword_81C4D0 | 2) != 2
            || BYTE4(qword_81C4E8) != 1
            || (v20 = &qword_81C4D0, !wlan_reg_is_6ghz_chan_freq(WORD2(qword_81C4D0))) )
          {
