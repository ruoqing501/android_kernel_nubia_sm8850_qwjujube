...
LABEL_20:
    v53 = jiffies;
    if ( extract_reg_chan_list_ext_update_event_tlv___last_ticks_384 - jiffies + 125 < 0 )
    {
      qdf_trace_msg(
        0x31u,
        2u,
        ...
        v51,
        v50);
      extract_reg_chan_list_ext_update_event_tlv___last_ticks_384 = v53;
    }
    goto LABEL_22;
  }
  ...
  {
    v71 = jiffies;
    if ( extract_reg_chan_list_ext_update_event_tlv___last_ticks_386 - jiffies + 125 < 0 )
    {
      qdf_trace_msg(
        0x31u,
        2u,
        ...
        v45,
        "extract_reg_chan_list_ext_update_event_tlv");
      extract_reg_chan_list_ext_update_event_tlv___last_ticks_386 = v71;
    }
    goto LABEL_22;
  }
  ...
  {
    v72 = jiffies;
    if ( extract_reg_chan_list_ext_update_event_tlv___last_ticks_388 - jiffies + 125 < 0 )
    {
      qdf_trace_msg(
        0x31u,
        2u,
        ...
        v47,
        v46);
      extract_reg_chan_list_ext_update_event_tlv___last_ticks_388 = v72;
    }
    goto LABEL_22;
  }
  v279 = v46;
  ...
  {
    v70 = jiffies;
    if ( extract_reg_chan_list_ext_update_event_tlv___last_ticks_389 - jiffies + 125 < 0 )
    {
      qdf_trace_msg(
        0x31u,
        2u,
        ...
        v45,
        "extract_reg_chan_list_ext_update_event_tlv");
      extract_reg_chan_list_ext_update_event_tlv___last_ticks_389 = v70;
    }
    goto LABEL_22;
  }
  ...
  *(_DWORD *)(a3 + 24) = v12[7];
  ...
  qdf_trace_msg(
    ...
    v73);
  *(_DWORD *)(a3 + 28) = v73 & 0x3F;
  *(_BYTE *)(a3 + 21) = 1;
  *(_BYTE *)(a3 + 12) = v12[4];
  v82 = v12[2];
  v83 = *(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)(a1 + 728) + 3688LL);
