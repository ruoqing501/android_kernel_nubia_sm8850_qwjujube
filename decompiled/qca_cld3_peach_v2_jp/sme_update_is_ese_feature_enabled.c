        ...
        double a11)
{
  ...
  else
  {
    qdf_trace_msg(
      ...
      v13,
      a3 & 1);
    *(_BYTE *)(a1[1] + 1562LL) = v12;
    mlme_set_supplicant_disabled_roaming(a1[2694], a2, (a3 & 1) == 0);
    v17 = a1[2695];
    if ( (a3 & 1) != 0 )
    {
      wlan_cm_roam_state_change(v17, a2, 2, 1u);
      *(_BYTE *)(a1[1] + 1565LL) = 1;
    }
    else
    {
      wlan_cm_roam_state_change(v17, a2, 3, 0x27u);
    }
    if ( *(_BYTE *)(a1[1] + 1708LL) == 1 )
    {
      result = qdf_mutex_acquire((__int64)(a1 + 1597));
      if ( (_DWORD)result )
        return result;
      wlan_roam_update_cfg(a1[2694], a2, 6u);
