__int64 __fastcall csr_is_mcc_channel(_QWORD *a1, unsigned int a2)
{
  ...
  v7 = policy_mgr_is_hw_dbs_capable(a1[2694]) ^ 1;
  do
  {
    if ( !a1 )
      goto LABEL_3;
    ...
    if ( !v8 || *(_BYTE *)(v8 + v4 + 1) != 1 )
      goto LABEL_3;
    v9 = wlan_get_opmode_from_vdev_id(a1[2695], v5) & 0xFFFFFFFD;
    if ( v9 == 1 )
    {
      if ( *(_DWORD *)(v8 + v4 + 4) )
        goto LABEL_12;
    }
    else if ( !v9 && cm_is_vdevid_connected(a1[2695], v5) )
    {
LABEL_12:
      operation_chan_freq_vdev_id = wlan_get_operation_chan_freq_vdev_id(a1[2695], v5);
    }
