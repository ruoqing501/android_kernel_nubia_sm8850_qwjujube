__int64 __fastcall hdd_regulatory_init(__int64 a1, __int64 a2)
{
  ...
  if ( !v4 )
    return 4294967284LL;
  *(_QWORD *)(a1 + 6816) = hdd_country_change_work_handle;
  v5 = (void *)v4;
  *(_QWORD *)(a1 + 6784) = 0xFFFFFFFE00000LL;
  *(_QWORD *)(a1 + 6824) = a1;
  *(_QWORD *)(a1 + 6792) = a1 + 6792;
  *(_QWORD *)(a1 + 6800) = a1 + 6792;
  v6 = *(_QWORD *)a1;
  *(_QWORD *)(a1 + 6808) = _qdf_defer_func;
