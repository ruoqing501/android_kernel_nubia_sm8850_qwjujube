__int64 __fastcall hdd_cfg80211_get_station_cmd(__int64 a1, __int64 a2, __int64 a3, unsigned int a4)
{
  ...
  int v179; // w11
  unsigned int v180; // w14
  int v181; // w14
  __int64 *v182; // [xsp+40h] [xbp-40h] BYREF
  unsigned int v183; // [xsp+48h] [xbp-38h] BYREF
  unsigned __int16 v184; // [xsp+4Ch] [xbp-34h]
  __int64 v185; // [xsp+58h] [xbp-28h] BYREF
  __int64 v186; // [xsp+60h] [xbp-20h]
  __int64 v187; // [xsp+68h] [xbp-18h]
  __int64 v188; // [xsp+70h] [xbp-10h]
  __int64 v189; // [xsp+78h] [xbp-8h]
  ...
  v8 = *(_QWORD *)(a2 + 32);
  v182 = nullptr;
  result = _osif_vdev_sync_op_start(v8, &v182, (__int64)"hdd_cfg80211_get_station_cmd");
  if ( !(_DWORD)result )
  {
    if ( !a1 )
    {
    ...
    if ( (unsigned int)hdd_get_conparam() == 5 )
    {
      ...
      v27 = -1;
LABEL_47:
      _osif_vdev_sync_op_stop((__int64)v182, (__int64)"hdd_cfg80211_get_station_cmd");
      result = v27;
      goto LABEL_48;
    }
    ...
    if ( v27 )
      goto LABEL_47;
    v28 = _nla_parse(&v185, 3, a3, (unsigned int)v7, &hdd_get_station_policy, 31, 0);
    if ( v28 )
    {
      v27 = v28;
      v37 = "%s: Invalid ATTR";
...
LABEL_46:
    ...
    if ( v186 )
    {
      ...
      if ( v7 )
      {
        ...
        {
          if ( *(_DWORD *)(v7 + 980) | *(unsigned __int16 *)(v7 + 984) )
          {
            v48 = *(_BYTE *)(v7 + 1443);
            if ( (v48 & 2) != 0 )
              v49 = 20;
            ...
            if ( !v53 )
              v55 += 12;
            v56 = v54 + ((*(_DWORD *)(v7 + 1504) + 7) & 0xFFFFFFFC);
            if ( v52 )
            ...
            if ( v58 != -8 )
            {
              ...
              if ( !v80 )
                goto LABEL_58;
              if ( (unsigned int)nla_put(a1, 52, *(unsigned __int8 *)(v7 + 1520), v7 + 1521) )
              {
                v79 = "%s: put fail";
LABEL_58:
...
LABEL_59:
              ...
              if ( (unsigned int)nla_put(a1, 6, 6, v7 + 980) )
              {
              ...
              if ( !v98 )
                goto LABEL_58;
              v183 = *(_DWORD *)(v7 + 1372);
              if ( (unsigned int)nla_put(a1, 1, 4, &v183)
                || (LOBYTE(v183) = *(_BYTE *)(v7 + 1404) + 100, (unsigned int)nla_put(a1, 2, 1, &v183)) )
              {
                qdf_trace_msg(
                  0x33u,
                  2u,
...
LABEL_79:
              ...
              LOBYTE(v183) = *(_BYTE *)(v7 + 1512) + 100;
              if ( (unsigned int)nla_put(a1, 7, 1, &v183) )
              {
                v119 = "%s: put fail";
                goto LABEL_79;
              }
...
LABEL_77:
              ...
              {
                v183 = v134;
                if ( (unsigned int)nla_put(a1, 5, 4, &v183) )
                {
                  qdf_trace_msg(
                    0x33u,
                    2u,
...
LABEL_78:
              ...
              {
                LOWORD(v183) = v144;
                if ( (unsigned int)nla_put(a1, 1, 2, &v183) )
                {
                  qdf_trace_msg(
                    0x33u,
                    2u,
              ...
              *v80 = *(_WORD *)(a1 + 216) + *(_DWORD *)(a1 + 208) - (_WORD)v80;
              ...
              if ( (v166 & 2) != 0 )
              {
                if ( (unsigned int)nla_put(a1, 157, 12, v7 + 1431) )
                {
LABEL_94:
                  qdf_trace_msg(
                    0x33u,
                ...
                ((void (__fastcall *)(__int64, __int64, __int64, __int64))qdf_trace_hex_dump)(51, 8, v7 + 1431, 12);
                v166 = *(_BYTE *)(v7 + 1443);
              }
              if ( (v166 & 1) != 0 )
              {
                if ( (unsigned int)nla_put(a1, 31, 26, v7 + 1405) )
                  goto LABEL_94;
                qdf_trace_msg(0x33u, 8u, "STA HT capabilities:", v167, v168, v169, v170, v171, v172, v173, v174);
                ((void (__fastcall *)(__int64, __int64, __int64, __int64))qdf_trace_hex_dump)(51, 8, v7 + 1405, 26);
              }
              *v165 = *(_DWORD *)(a1 + 216) + *(_DWORD *)(a1 + 208) - (_WORD)v165;
              v183 = *(_DWORD *)(v7 + 1508);
              if ( (unsigned int)nla_put(a1, 3, 4, &v183)
                || ((v175 = *(_DWORD *)(v7 + 1560) - 1, v175 > 0x1D) ? (v176 = 0) : (v176 = dword_A2B1B0[v175]),
                    (v183 = v176, (unsigned int)nla_put(a1, 4, 4, &v183))
                 || (v183 = hdd_convert_dot11mode(*(unsigned int *)(v7 + 1360)), (unsigned int)nla_put(a1, 5, 4, &v183))) )
              {
              ...
              if ( (v177 & 0x10) != 0 )
              {
                if ( (unsigned int)nla_put(a1, 7, 22, v7 + 1448) )
                {
                  v107 = "%s: ht operation put fail";
                  goto LABEL_59;
                }
                qdf_trace_msg(0x33u, 8u, "STA HT operation:", v10, v11, v12, v13, v14, v15, v16, v17);
                ((void (__fastcall *)(__int64, __int64, __int64, __int64))qdf_trace_hex_dump)(51, 8, v7 + 1448, 22);
                v177 = *(_BYTE *)(v7 + 1443);
              }
              if ( (v177 & 0x20) == 0 )
                goto LABEL_112;
              if ( (unsigned int)nla_put(a1, 8, 5, v7 + 1470) )
              {
...
LABEL_111:
              ...
              ((void (__fastcall *)(__int64, __int64, __int64, __int64))qdf_trace_hex_dump)(51, 8, v7 + 1470, 5);
LABEL_112:
              ...
              if ( (*(_BYTE *)(v7 + 1443) & 8) != 0 )
              {
                if ( (unsigned int)nla_put(a1, 6, 3, v7 + 1445) )
                {
                  v107 = "%s: hs20 put fail";
                  goto LABEL_59;
                }
                qdf_trace_msg(0x33u, 8u, "STA hs20 vendor IE:", v10, v11, v12, v13, v14, v15, v16, v17);
                ((void (__fastcall *)(__int64, __int64, __int64, __int64))qdf_trace_hex_dump)(51, 8, v7 + 1445, 3);
              }
              v183 = *(_DWORD *)(*(_QWORD *)v7 + 52400LL);
              if ( (unsigned int)nla_put(a1, 37, 4, &v183) )
              {
              ...
              v178 = *(_DWORD *)(v7 + 1560) - 1;
              if ( v178 > 0x1D )
                v179 = 0;
              else
                v179 = dword_A2B1B0[v178];
              v180 = *(_DWORD *)(v7 + 1360) - 1;
              if ( v180 > 0xB )
                v181 = 7;
              else
                v181 = dword_A2B228[v180];
              qdf_trace_msg(
                0x33u,
                8u,
                "STA Info:: SSID:%.*s, BSSID:%02x:%02x:%02x:**:**:%02x, freq:%d, Noise:%d, signal:%d, roam_count:%d, last"
                "_auth_type:%d, dot11mode:%d, disconnect_reason:%d, ",
                v10,
                v11,
                v12,
                v13,
                ...
                32,
                v7 + 1521,
                *(unsigned __int8 *)(v7 + 980),
                *(unsigned __int8 *)(v7 + 981),
                *(unsigned __int8 *)(v7 + 982),
                *(unsigned __int8 *)(v7 + 985),
                *(_DWORD *)(v7 + 1372),
                *(char *)(v7 + 1404) + 100,
                *(char *)(v7 + 1512) + 100,
                *(_DWORD *)(v7 + 1508),
...
LABEL_44:
    ...
    else
    {
      if ( v187 )
      {
        station_assoc_fail = hdd_get_station_assoc_fail(*(_QWORD *)(v18 + 55512));
        goto LABEL_31;
      }
      if ( v188 )
      {
        ...
        if ( (v86 | 2) == 3 )
        {
          ...
          qdf_trace_msg(
            ...
            BYTE2(v183),
            HIBYTE(v184));
          station_assoc_fail = hdd_get_station_remote(*(_QWORD *)(v18 + 55512), v183 | ((unsigned __int64)v184 << 32));
          goto LABEL_31;
        }
        qdf_trace_msg(
          0x33u,
