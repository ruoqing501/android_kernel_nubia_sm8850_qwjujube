        ...
        double a11)
{
  ...
  if ( v11 )
  {
    ...
    if ( v14 <= 5 )
    {
      ...
      {
        raw_spin_lock(v11 + 18928);
      }
      else
      {
        raw_spin_lock_bh(v11 + 18928);
        *(_QWORD *)(v11 + 18936) |= 1uLL;
      }
      v18 = *(_QWORD *)(v11 + 8 * v14 + 12912);
      if ( v18 )
      {
        ...
        while ( v19 )
        {
          ...
          if ( _ZF )
          {
            _X8 = (unsigned int *)(v18 + 42648);
            __asm { PRFM            #0x11, [X8] }
            do
              v42 = __ldxr(_X8);
            while ( __stxr(v42 + 1, _X8) );
            v43 = *(_QWORD *)(v11 + 18936);
            if ( (v43 & 1) != 0 )
            {
              *(_QWORD *)(v11 + 18936) = v43 & 0xFFFFFFFFFFFFFFFELL;
            ...
            *(_WORD *)(a2 + 3464) = *(_DWORD *)(*(_QWORD *)(v16 + 8) + 1856LL);
            *(_WORD *)(a2 + 3466) = *(_WORD *)(v16 + 95062);
      ...
      v38 = *(_QWORD *)(v11 + 18936);
      if ( (v38 & 1) != 0 )
      {
        *(_QWORD *)(v11 + 18936) = v38 & 0xFFFFFFFFFFFFFFFELL;
        result = raw_spin_unlock_bh(v11 + 18928);
      }
      else
      {
