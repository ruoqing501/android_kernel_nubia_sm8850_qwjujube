__int64 __fastcall drv_cmd_get_rssi(__int64 a1, __int64 a2, const char *a3, __int64 a4, __int64 a5)
{
  ...
  __int64 result; // x0
  _BYTE v32[4]; // [xsp+4h] [xbp-2Ch] BYREF
  _QWORD v33[5]; // [xsp+8h] [xbp-28h] BYREF

  v33[4] = *(_QWORD *)(_ReadStatusReg(SP_EL0) + 1808);
  v32[0] = 0;
  memset(v33, 0, 32);
  wlan_hdd_get_rssi(a1, v32);
  scnprintf(v33, 32, "%s %d", a3, v32[0]);
  v8 = *(_DWORD *)(a5 + 12);
  if ( v8 > v7 )
    LOBYTE(v8) = v7 + 1;
