        ...
        double a9)
{
  ...
  if ( v61 )
  {
    ...
    if ( (wmi_service_enabled(*v70, 0xCFu, v114, v115, v116, v117, v118, v119, v120, v121) & 1) != 0 )
      v97 |= 0x20u;
    if ( (wmi_service_enabled(*v70, 0x11Cu, v122, v123, v124, v125, v126, v127, v128, v129) & 1) != 0 )
      v130 = v97 | 0x40;
    else
      v130 = v97;
    if ( (unsigned int)mlme_set_tgt_wpa3_roam_cap(a1, v130) )
      qdf_trace_msg(
        ...
        v138,
        "wma_set_mlme_caps");
    v139 = wmi_service_enabled(*v70, 0x142u, v131, v132, v133, v134, v135, v136, v137, v138);
    ucfg_mlme_set_mrsno_support(a1, v139 & 1);
  }
  v140 = _cds_get_context(54, (__int64)"wma_set_mc_cp_caps", v62, v63, v64, v65, v66, v67, v68, v69);
  if ( v140 )
  {
    v149 = wmi_service_enabled(*v140, 0xF3u, v141, v142, v143, v144, v145, v146, v147, v148);
  ...
  if ( v150 )
  {
    if ( a1 )
    {
      v163[0] = wmi_service_enabled(*v150, 0xFEu, v151, v152, v153, v154, v155, v156, v157, v158) & 1;
      ucfg_fwol_update_fw_cap_info(a1, v163);
    }
    else
    {
      v160 = jiffies;
      if ( wma_set_fwol_caps___last_ticks_218 - jiffies + 125 < 0 )
      {
        qdf_trace_msg(0x36u, 2u, "%s: psoc Null", v151, v152, v153, v154, v155, v156, v157, v158, "wma_set_fwol_caps");
        wma_set_fwol_caps___last_ticks_218 = v160;
      }
    }
  }
  else
