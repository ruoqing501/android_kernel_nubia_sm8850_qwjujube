        ...
        double a11)
{
  ...
  {
    raw_spin_lock(a1 + 159);
  }
  else
  {
    raw_spin_lock_bh(a1 + 159);
    a1[160] |= 1uLL;
  }
  ...
  if ( !v15 || (v16 = *(_QWORD *)(v15 + 80)) == 0 )
  {
    ...
    if ( (v40 & 1) != 0 )
    {
      a1[160] = v40 & 0xFFFFFFFFFFFFFFFELL;
      raw_spin_unlock_bh(a1 + 159);
    }
    else
    {
      raw_spin_unlock(a1 + 159);
    }
    v41 = "%s: psoc NULL";
    goto LABEL_24;
  }
  ...
  if ( (v17 & 1) != 0 )
  {
    a1[160] = v17 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(a1 + 159);
  }
  else
  {
  ...
  peer_by_mac_n_vdev = wlan_objmgr_get_peer_by_mac_n_vdev(v16, *(unsigned __int8 *)(a1[19] + 40LL), &v52, a2, 19);
