__int64 __fastcall scm_scan_get_entry_by_bssid_and_security(__int64 a1, unsigned __int8 *a2, unsigned __int8 a3)
{
  ...
  v72[0] = 0;
  result = _qdf_mem_malloc(0x2D0u, "scm_scan_get_entry_by_bssid_and_security", 2350);
  if ( result )
  {
    v7 = result;
    *(_BYTE *)(result + 16) = 1;
...
LABEL_23:
      ...
      if ( cmpt_obj )
      {
        v28 = *(unsigned __int8 *)(cmpt_obj + 162);
        ...
        *(_BYTE *)(v7 + 100) = v28;
        qdf_mem_copy((void *)(v7 + 101), (const void *)(cmpt_obj + 129), v28);
      }
      if ( *(_BYTE *)(v7 + 100) )
      {
        *(_BYTE *)(v7 + 17) = 1;
