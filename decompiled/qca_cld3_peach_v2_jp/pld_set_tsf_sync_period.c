__int64 __fastcall pld_set_tsf_sync_period(__int64 a1, unsigned int a2)
{
  __int64 v3; // x21
  __int64 v5; // x0
  __int64 v6; // x22
  ...
  if ( a1 && pld_ctx )
  {
    ...
    do
    {
      ...
      if ( v6 == v3 + 16 )
      {
        ...
        return printk(&unk_8EB76B, "pld_set_tsf_sync_period", 2854, v8);
      }
    }
    ...
    if ( (unsigned int)(v9 - 1) >= 7 )
    {
      if ( v9 )
        return printk(&unk_8EB76B, "pld_set_tsf_sync_period", 2854, v8);
      return cnss_update_time_sync_period(a1, a2);
    }
  }
  else
  {
