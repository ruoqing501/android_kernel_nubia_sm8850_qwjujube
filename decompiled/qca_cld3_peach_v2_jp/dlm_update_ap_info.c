__int64 __fastcall dlm_update_ap_info(__int64 a1, _QWORD *a2, __int64 a3)
{
  ...
  v16 = result;
  if ( (v15 & 4) != 0 && result - *(_QWORD *)(a1 + 56) >= (unsigned __int64)(60000LL * *a2) )
  {
    v19 = *(_DWORD *)(a1 + 108) & 0xFFFFFFBF;
    *(_BYTE *)(a1 + 104) = v15 & 0xDB | 0x20;
    *(_DWORD *)(a1 + 108) = v19;
    *(_QWORD *)(a1 + 96) = result;
  ...
  if ( v16 - *(_QWORD *)(a1 + 64) >= (unsigned __int64)(60000LL * *a2) )
  {
    v20 = *(_DWORD *)(a1 + 108) & 0xFFFFFFF8;
    *(_BYTE *)(a1 + 104) = v18 & 0xD7 | 0x20;
    *(_DWORD *)(a1 + 108) = v20;
    *(_QWORD *)(a1 + 96) = v16;
    result = qdf_trace_msg(
               0x6Du,
...
LABEL_8:
  if ( (v18 & 2) != 0 && v16 - *(_QWORD *)(a1 + 80) >= (unsigned __int64)(60000LL * a2[1]) )
  {
    v21 = *(_DWORD *)(a1 + 108);
    *(_BYTE *)(a1 + 104) = v18 & 0xDD | 0x20;
    *(_DWORD *)(a1 + 108) = v21 & 0xFFFFFFF8;
    *(_QWORD *)(a1 + 96) = v16;
    result = qdf_trace_msg(
               0x6Du,
               8u,
  ...
  if ( (v18 & 0x10) != 0 )
  {
    ...
    if ( (_DWORD)v22 && v16 - *(_QWORD *)(a1 + 88) >= v22 )
    {
      LOBYTE(v23) = *(_BYTE *)(a1 + 28);
    }
    else
    {
      if ( !a3 )
    ...
    v24 = *(_DWORD *)(a1 + 108) & 0xFFFFF067;
    *(_BYTE *)(a1 + 104) = v18 & 0xEF;
    *(_DWORD *)(a1 + 108) = v24;
    if ( a3 )
