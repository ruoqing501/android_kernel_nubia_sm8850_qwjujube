__int64 __fastcall lim_notify_channel_switch_started(__int64 a1, __int64 a2)
{
  ...
  double v27; // d6
  double v28; // d7
  __int128 v29; // [xsp+8h] [xbp-48h] BYREF
  ...
  HIDWORD(v29) = 0;
  *(_QWORD *)((char *)&v29 + 4) = 0;
  result = _qdf_mem_malloc(0x2Cu, "lim_notify_channel_switch_started", 11125);
  if ( result )
  {
    v5 = result;
    *(_DWORD *)result = 2888867;
    *(_BYTE *)(result + 4) = *(_BYTE *)(a2 + 10);
    v6 = *(_DWORD *)(a2 + 7204);
    *(_DWORD *)(result + 36) = 0;
    *(_DWORD *)(result + 8) = v6;
    qdf_mem_copy((void *)(result + 28), (const void *)(a2 + 24), 6u);
    v7 = wma_chan_phy_mode(*(unsigned int *)(a2 + 7204), *(unsigned int *)(a2 + 7212), *(unsigned __int8 *)(a2 + 154));
    *(_DWORD *)(v5 + 40) = v8;
    v9 = *(_DWORD *)(a2 + 7204);
    v10 = *(unsigned __int8 *)(a2 + 7211);
    v11 = *(_QWORD *)(*(_QWORD *)(a2 + 16) + 152LL);
    LODWORD(v29) = *(_DWORD *)(a2 + 7212);
