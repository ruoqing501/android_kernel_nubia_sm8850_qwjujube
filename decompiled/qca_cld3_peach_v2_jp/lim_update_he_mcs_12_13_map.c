__int64 __fastcall lim_update_he_mcs_12_13_map(__int64 a1, __int64 a2, __int16 a3)
{
  ...
  {
    raw_spin_lock(v5 + 1272);
  }
  else
  {
    raw_spin_lock_bh(v5 + 1272);
    *(_QWORD *)(v14 + 1280) |= 1uLL;
  }
  cmpt_obj = wlan_vdev_mlme_get_cmpt_obj(v14, v16, v17, v18, v19, v20, v21, v22, v23);
  if ( cmpt_obj )
    *(_WORD *)(cmpt_obj + 264) = a3;
  v25 = *(_QWORD *)(v14 + 1280);
  if ( (v25 & 1) != 0 )
  {
    *(_QWORD *)(v14 + 1280) = v25 & 0xFFFFFFFFFFFFFFFELL;
    raw_spin_unlock_bh(v14 + 1272);
  }
  else
  {
    raw_spin_unlock(v14 + 1272);
  }
