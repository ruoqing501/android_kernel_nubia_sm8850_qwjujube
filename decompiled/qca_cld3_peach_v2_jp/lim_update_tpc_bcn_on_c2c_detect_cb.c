...
LABEL_18:
        ...
        if ( (result & 1) == 0 )
          goto LABEL_5;
        result = policy_mgr_is_vdev_ll_lt_sap(*(_QWORD *)(v19 + 21552), *(unsigned __int8 *)(v32 + 10));
        if ( (result & 1) != 0 )
          goto LABEL_5;
...
LABEL_5:
      ...
      if ( !(unsigned int)wlan_is_tdls_session_present(v33) )
        wlan_tdls_recompute_offchannel_mode(*(_QWORD *)(v19 + 21552), *(_QWORD *)(v32 + 16));
      ...
      if ( v34 == 2 )
      {
        if ( (wlan_reg_is_indoor_ap_detected(*(_QWORD *)(v19 + 21560), v21, v22, v23, v24, v25, v26, v27, v28) & 1) != 0 )
        {
          v34 = 3;
          goto LABEL_28;
        }
