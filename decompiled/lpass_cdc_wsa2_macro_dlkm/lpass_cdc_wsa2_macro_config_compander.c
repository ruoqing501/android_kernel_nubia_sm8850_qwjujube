__int64 __fastcall lpass_cdc_wsa2_macro_config_compander(__int64 a1, int a2, char a3)
{
  __int64 result; // x0
  __int64 v7; // x8
  __int64 v8; // x9
  ...
  if ( result )
  {
    ...
    if ( v7 && *(_QWORD *)(v7 + 248) )
    {
      if ( a2 >= 2 )
        return dev_err(
                 *(_QWORD *)(a1 + 24),
                 ...
                 "lpass_cdc_wsa2_macro_config_compander",
                 a2);
      if ( *(_DWORD *)(v7 + 4LL * (unsigned int)a2 + 8) )
      {
        ...
        if ( !v11 )
          goto LABEL_25;
        v12 = (unsigned __int16)(*(_WORD *)(v7 + 468) + 2 * a2);
        if ( v12 >= 4 )
          return dev_err(*(_QWORD *)(a1 + 24), "%s: Invalid index: %d\n", "lpass_cdc_wsa2_macro_config_compander", v12);
        v13 = *(_DWORD *)(v7 + 4LL * (unsigned __int16)(*(_WORD *)(v7 + 468) + 2 * a2) + 604);
        v14 = 15;
        v15 = -15 * v13 + 210;
        if ( v11 > 3 )
        {
...
LABEL_24:
          *v10 = 2 * v15 / 10;
          v10[1] = v14;
LABEL_25:
          v16 = ((_WORD)a2 << 7) + 17412;
          v17 = 96 * a2;
          v18 = 96 * a2 + 17792;
          if ( (a3 & 3) != 0 )
          {
            lpass_cdc_update_compander_setting(a1, (unsigned int)(v17 + 17824), v10);
