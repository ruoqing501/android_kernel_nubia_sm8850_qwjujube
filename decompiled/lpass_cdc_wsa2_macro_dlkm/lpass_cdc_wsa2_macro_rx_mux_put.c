__int64 __fastcall lpass_cdc_wsa2_macro_rx_mux_put(__int64 a1, __int64 a2)
{
  __int64 v4; // x0
  __int64 v5; // x23
  __int64 v6; // x22
...
LABEL_30:
  ...
  if ( (_DWORD)v8 )
  {
    *(_DWORD *)(v14 + 4 * v13) = v8;
    ...
    v20 = device_ptr;
    if ( (unsigned int)__ratelimit(&lpass_cdc_wsa2_macro_rx_mux_put__rs_150, "lpass_cdc_wsa2_macro_rx_mux_put") )
      dev_err(v20, "%s: Invalid AIF_ID for WSA2 RX MUX %d\n", "lpass_cdc_wsa2_macro_rx_mux_put", v8);
    return 4294967274LL;
  }
  ...
  if ( (_DWORD)v18 )
  {
    if ( (unsigned int)v18 <= 6 )
    {
      ...
      *(_DWORD *)(v14 + 4 * v13) = 0;
      ...
      v25 = 1LL << v23;
      v26 = (_QWORD *)(v22 + 320);
      _X10 = (unsigned __int64 *)(v22 + 264 + 8 * v24);
      __asm { PRFM            #0x11, [X10] }
      do
        v36 = __ldxr(_X10);
...
LABEL_9:
    ...
    v19 = device_ptr;
    result = __ratelimit(&lpass_cdc_wsa2_macro_rx_mux_put__rs_148, "lpass_cdc_wsa2_macro_rx_mux_put");
    if ( (_DWORD)result )
    {
  ...
  {
    v21 = device_ptr;
    result = __ratelimit(&lpass_cdc_wsa2_macro_rx_mux_put__rs, "lpass_cdc_wsa2_macro_rx_mux_put");
    if ( (_DWORD)result )
    {
