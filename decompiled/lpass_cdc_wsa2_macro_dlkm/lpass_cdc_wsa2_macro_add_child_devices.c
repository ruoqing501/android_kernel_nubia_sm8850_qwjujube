__int64 __fastcall lpass_cdc_wsa2_macro_add_child_devices(__int64 a1)
{
  __int64 *v1; // x27
  __int64 v3; // x0
  __int64 result; // x0
  ...
  if ( a1 == 208 )
  {
    result = printk(&unk_F2AE, "lpass_cdc_wsa2_macro_add_child_devices");
    goto LABEL_33;
  }
  v3 = *v1;
  if ( !*v1 || !*(_QWORD *)(v3 + 744) )
  {
    result = dev_err(v3, "%s: DT node for wsa2_priv does not exist\n", "lpass_cdc_wsa2_macro_add_child_devices");
    goto LABEL_33;
  }
  *(_DWORD *)(a1 + 256) = 0;
  ...
  if ( result )
  {
    ...
    do
    {
      if ( strnstr(*v5, "wsa2_swr_master", 15) )
      {
        strcpy((char *)v20, "wsa2_swr_ctrl");
      }
      else
      {
      ...
      *(_QWORD *)(v11 + 760) = v5;
      if ( strnstr(*v5, "wsa2_swr_master", 15) )
      {
        ...
        {
          result = dev_err(v11 + 16, "%s: cannot add plat data ctrl:%d\n", "lpass_cdc_wsa2_macro_add_child_devices", v7);
LABEL_37:
          if ( *(int *)(a1 + 256) >= 1 )
          {
            result = platform_device_put(*(_QWORD *)(a1 + 232));
            if ( *(int *)(a1 + 256) >= 2 )
            {
              result = platform_device_put(*(_QWORD *)(a1 + 240));
              if ( *(int *)(a1 + 256) >= 3 )
              {
