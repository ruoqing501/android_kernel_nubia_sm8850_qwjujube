__int64 __fastcall lpass_cdc_wsa2_macro_rx_mux_get(__int64 a1, __int64 a2)
{
  __int64 v5; // x0
  __int64 v6; // x21
  __int64 v7; // x20
  ...
  if ( v10 >= 9 )
  {
    ...
    return lpass_cdc_wsa2_macro_rx_mux_put();
  }
  else
  {
    *(_QWORD *)(a2 + 72) = *(int *)(v9 + 4 * v10 + 392);
    return 0;
  }
}
