__int64 __fastcall lpass_cdc_wsa2_macro_get_ec_hq(__int64 a1, __int64 a2)
{
  __int64 v4; // x20
  __int64 v6; // x21
  ...
  if ( (unsigned int)v6 >= 2 )
  {
    ...
    return lpass_cdc_wsa2_macro_set_ec_hq();
  }
  else
  {
    *(_QWORD *)(a2 + 72) = *(int *)(v8 + 4 * v6 + 24);
    return 0;
  }
}
