__int64 __fastcall lpass_cdc_wsa2_macro_mclk_event(__int64 a1, __int64 a2, int a3)
{
  __int64 v3; // x21
  ...
  if ( a3 != 8 )
  {
    if ( a3 == 1 )
    {
      result = lpass_cdc_wsa2_macro_mclk_enable(*(_QWORD **)(device_ptr + 152), 1);
      if ( (_DWORD)result )
        *(_BYTE *)(v6 + 40) = 0;
      else
        *(_BYTE *)(v6 + 40) = 1;
    ...
    if ( (unsigned int)__ratelimit(&lpass_cdc_wsa2_macro_mclk_event__rs, "lpass_cdc_wsa2_macro_mclk_event") )
      dev_err(*(_QWORD *)v6, "%s: invalid DAPM event %d\n", "lpass_cdc_wsa2_macro_mclk_event", a3);
    return 4294967274LL;
  }
  if ( *(_BYTE *)(v6 + 40) == 1 )
  {
    lpass_cdc_wsa2_macro_mclk_enable(*(_QWORD **)(device_ptr + 152), 0);
    *(_BYTE *)(v6 + 40) = 0;
  }
  return 0;
}
