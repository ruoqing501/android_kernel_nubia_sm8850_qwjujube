__int64 __fastcall lpass_cdc_wsa2_macro_set_digital_volume(__int64 a1, __int64 a2)
{
  __int64 v2; // x21
  __int64 v3; // x23
...
LABEL_20:
      dev_err(*(_QWORD *)(v3 + 24), v13, "lpass_cdc_wsa2_macro_set_digital_volume");
      return 4294967274LL;
    }
    return 4294967274LL;
  }
  ...
  {
    v10 = v8;
    v11 = snd_soc_component_read(*(_QWORD *)(v7 + 248), 17556);
    v12 = *(_DWORD *)(v7 + 560);
    *(_BYTE *)(v7 + 549) = v11;
    goto LABEL_13;
  }
  if ( v9 != 17428 )
  {
    if ( (unsigned int)__ratelimit(
                         &lpass_cdc_wsa2_macro_set_digital_volume__rs_261,
                         "lpass_cdc_wsa2_macro_set_digital_volume") )
      dev_err(*(_QWORD *)v7, "%s: Incorrect RX Path selected\n", "lpass_cdc_wsa2_macro_set_digital_volume");
    return 4294967274LL;
  }
  v10 = v8;
  v11 = snd_soc_component_read(*(_QWORD *)(v7 + 248), 17428);
  v12 = *(_DWORD *)(v7 + 560);
  *(_BYTE *)(v7 + 548) = v11;
LABEL_13:
  if ( *(_BYTE *)(v7 + 40) == 1 )
