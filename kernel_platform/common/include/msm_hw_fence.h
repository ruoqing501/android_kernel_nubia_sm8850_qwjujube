 ...
 * @HW_FENCE_CLIENT_ID_LSR0: LSR0 Client 0.
 * @HW_FENCE_CLIENT_ID_DCP0: DCP0 Client 0.
 * @HW_FENCE_CLIENT_ID_GPU1: GPU1 Client 0.
 * @HW_FENCE_CLIENT_ID_DPU1: DPU1 Client 0.
 * @HW_FENCE_CLIENT_ID_TEST1: TEST1 Client 0.
 * @HW_FENCE_CLIENT_ID_TEST2: TEST2 Client 0.
 * @HW_FENCE_CLIENT_ID_TEST3: TEST3 Client 0.
 * @HW_FENCE_CLIENT_ID_TEST4: TEST4 Client 0.
 * @HW_FENCE_CLIENT_ID_IPA: IPA Client 0.
...
enum hw_fence_client_id {
	...
	HW_FENCE_CLIENT_ID_CTL0 = HW_FENCE_CLIENT_ID_CTX0 + MSM_HW_FENCE_MAX_SIGNAL_PER_CLIENT,
	HW_FENCE_CLIENT_ID_CTL1,
	HW_FENCE_CLIENT_ID_CTL2,
	HW_FENCE_CLIENT_ID_CTL3,
	HW_FENCE_CLIENT_ID_CTL4,
	HW_FENCE_CLIENT_ID_CTL5,
	HW_FENCE_CLIENT_ID_VAL0 = HW_FENCE_CLIENT_ID_CTL0 + MSM_HW_FENCE_MAX_SIGNAL_PER_CLIENT,
	...
	HW_FENCE_CLIENT_ID_IPE = HW_FENCE_CLIENT_ID_VAL0 + MSM_HW_FENCE_MAX_SIGNAL_PER_CLIENT,
	HW_FENCE_CLIENT_ID_VPU = HW_FENCE_CLIENT_ID_IPE + MSM_HW_FENCE_MAX_SIGNAL_PER_CLIENT,
	HW_FENCE_CLIENT_ID_LSR0 = HW_FENCE_CLIENT_ID_VPU + MSM_HW_FENCE_MAX_SIGNAL_PER_CLIENT,
	HW_FENCE_CLIENT_ID_DCP0 = HW_FENCE_CLIENT_ID_LSR0 + MSM_HW_FENCE_MAX_SIGNAL_PER_CLIENT,
	HW_FENCE_CLIENT_ID_GPU1 = HW_FENCE_CLIENT_ID_DCP0 + MSM_HW_FENCE_MAX_SIGNAL_PER_CLIENT,
	HW_FENCE_CLIENT_ID_DPU1 = HW_FENCE_CLIENT_ID_GPU1 + MSM_HW_FENCE_MAX_SIGNAL_PER_CLIENT,
	HW_FENCE_CLIENT_ID_TEST1 = HW_FENCE_CLIENT_ID_DPU1 + MSM_HW_FENCE_MAX_SIGNAL_PER_CLIENT,
	HW_FENCE_CLIENT_ID_TEST2 = HW_FENCE_CLIENT_ID_TEST1 + MSM_HW_FENCE_MAX_SIGNAL_PER_CLIENT,
	HW_FENCE_CLIENT_ID_TEST3 = HW_FENCE_CLIENT_ID_TEST2 + MSM_HW_FENCE_MAX_SIGNAL_PER_CLIENT,
	HW_FENCE_CLIENT_ID_TEST4 = HW_FENCE_CLIENT_ID_TEST3 + MSM_HW_FENCE_MAX_SIGNAL_PER_CLIENT,
	/* txq only clients start from here */
	HW_FENCE_CLIENT_ID_IPA = HW_FENCE_CLIENT_ID_TEST4 + MSM_HW_FENCE_MAX_SIGNAL_PER_CLIENT,
...
#if IS_ENABLED(CONFIG_QTI_HW_FENCE) || 1
/**
