...
enum llcc_notify_staling_op {
	LLCC_NOTIFY_STALING_WRITEBACK,
	LLCC_NOTIFY_STALING_NO_WRITEBACK,
};

struct llcc_notify_staling_params {
	enum llcc_notify_staling_op op;
	u32 staling_distance;
};

struct llcc_staling_mode_params {
	enum llcc_staling_mode staling_mode;
	struct llcc_notify_staling_params notify_params;
};
...
int llcc_configure_staling_mode(struct llcc_slice_desc *desc, struct llcc_staling_mode_params *params);
...
static inline int llcc_configure_staling_mode(struct llcc_slice_desc *desc, struct llcc_staling_mode_params *params)
{
	return -EOPNOTSUPP;
}
